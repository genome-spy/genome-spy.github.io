import { a as e, x as t } from "./viewSelectors-DYYlOt91.js";
import { i as n, n as r, t as i } from "./viewIdentityRegistry-D4p067HU.js";
...
function m(e, t) {
	...
	return h(e, (e) => {
		let i = e.mark;
		if (!i) return;
		let a = i.getDebugState(), o = e.context.getMarkRenderingDebugState?.(i);
		r.push({
			...
			markUniformsAltered: o?.markUniformsAltered ?? !1,
			...
			allocatedVertices: o?.allocatedVertices,
			rangeCount: o?.rangeCount ?? 0,
