import { $ as e, Q as t, Z as n, ht as r, yt as i } from "./src-EoV59w5q.js";
...
var x = (t) => {
	t.type == e.CHILD && (t._$AP ??= b, t._$AQ ??= y);
}, S = class extends t {
	constructor() {
	...
	disconnected() {}
	reconnected() {}
}, C = () => new w(), w = class {}, T = /* @__PURE__ */ new WeakMap(), E = n(class extends S {
	render(e) {
		return r;
	}
	update(e, [t]) {
