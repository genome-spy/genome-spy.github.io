...
var r = class {
	...
	async _readIndex() {
		let n = await this.filehandle.read(8, 0), r = e(new DataView(n.buffer, n.byteOffset, n.byteLength));
		if (r === 0) return [[0, 0]];
		if (r > (2 ** 53 - 1) / 16) throw TypeError("integer overflow");
		return t(await this.filehandle.read(16 * r, 8), r);
	}
	async getRelevantBlocksForRead(e, t) {
		...
		let r = await this._getIndex(), i = t + e, a = n(r, t) - 1, o = a + 1;
		for (; o < r.length && r[o][1] < i;) o += 1;
		return {
			blocks: r.slice(a, o),
			nextCompressedPosition: r[o]?.[0]
		};
	}
};
//#endregion
...
var s = {
	...
	return l = () => e, e;
}, u = (e, t, n, r, i) => (u = l() ? s.arraySet : c.arraySet, u(e, t, n, r, i)), d = (e) => (d = l() ? s.flattenChunks : c.flattenChunks, d(e)), f = (e) => (f = l() ? s.Buf8 : c.Buf8, f(e)), p = (e) => (p = l() ? s.Buf16 : c.Buf16, p(e)), m = (e) => (m = l() ? s.Buf32 : c.Buf32, m(e)), h = function() {
	let e = !0;
	try {
	...
	for (var t = f(256), n = 0; n < 256; n++) t[n] = n >= 252 ? 6 : n >= 248 ? 5 : n >= 240 ? 4 : n >= 224 ? 3 : n >= 192 ? 2 : 1;
	return t[254] = t[254] = 1, _ = (e) => t[e], t[e];
};
function v(e) {
...
function y(e, t) {
	if (t < 65534 && (e.subarray && g() || !e.subarray && h())) return String.fromCharCode.apply(null, o(e, t));
...
function S(e, t) {
	...
	return n < 0 || n === 0 ? t : n + _(e[n]) > t ? n : t;
}
//#endregion
...
var j = 15, M = 852, N = 592, ee = 0, te = 1, ne = 2, re = [
	3,
	4,
	5,
	6,
...
function P(e, t, n, r, i, a, o, s) {
	var c = s.bits, l = 0, u = 0, d = 0, f = 0, m = 0, h = 0, g = 0, _ = 0, v = 0, y = 0, b, x, S, C, w, T = null, E = 0, D, O = p(j + 1), k = p(j + 1), A = null, P = 0, se, F, I;
	for (l = 0; l <= j; l++) O[l] = 0;
	for (u = 0; u < r; u++) O[t[n + u]]++;
	for (m = c, f = j; f >= 1 && O[f] === 0; f--);
	if (m > f && (m = f), f === 0) return i[a++] = 20971520, i[a++] = 20971520, s.bits = 1, 0;
	for (d = 1; d < f && O[d] === 0; d++);
	for (m < d && (m = d), _ = 1, l = 1; l <= j; l++) if (_ <<= 1, _ -= O[l], _ < 0) return -1;
	if (_ > 0 && (e === ee || f !== 1)) return -1;
	for (k[1] = 0, l = 1; l < j; l++) k[l + 1] = k[l] + O[l];
	for (u = 0; u < r; u++) t[n + u] !== 0 && (o[k[t[n + u]]++] = u);
	if (e === ee ? (T = A = o, D = 19) : e === te ? (T = re, E -= 257, A = ie, P -= 257, D = 256) : (T = ae, A = oe, D = -1), y = 0, u = 0, l = d, w = a, h = m, g = 0, S = -1, v = 1 << m, C = v - 1, e === te && v > M || e === ne && v > N) return 1;
	for (;;) {
		se = l - g, o[u] < D ? (F = 0, I = o[u]) : o[u] > D ? (F = A[P + o[u]], I = T[E + o[u]]) : (F = 96, I = 0), b = 1 << l - g, x = 1 << h, d = x;
		do
			x -= b, i[w + (y >> g) + x] = se << 24 | F << 16 | I | 0;
		while (x !== 0);
		for (b = 1 << l - 1; y & b;) b >>= 1;
		...
		if (l > m && (y & C) !== S) {
			for (g === 0 && (g = m), w += d, h = l - g, _ = 1 << h; h + g < f && (_ -= O[h + g], !(_ <= 0));) h++, _ <<= 1;
			if (v += 1 << h, e === te && v > M || e === ne && v > N) return 1;
...
var se = 0, F = 1, I = 2, ce = 4, le = 5, ue = 6, L = 0, de = 1, fe = 2, R = -2, pe = -3, me = -4, he = -5, ge = 8, _e = 1, ve = 2, ye = 3, be = 4, xe = 5, Se = 6, Ce = 7, we = 8, Te = 9, Ee = 10, z = 11, B = 12, De = 13, Oe = 14, ke = 15, Ae = 16, je = 17, Me = 18, Ne = 19, V = 20, H = 21, Pe = 22, Fe = 23, Ie = 24, Le = 25, Re = 26, ze = 27, Be = 28, Ve = 29, U = 30, He = 31, Ue = 32, We = 852, Ge = 592;
function Ke(e) {
...
function Je(e) {
	var t;
	return !e || !e.state ? R : (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = t.wrap & 1), t.mode = _e, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = m(We), t.distcode = t.distdyn = m(Ge), t.sane = 1, t.back = -1, L);
}
function Ye(e) {
	var t;
	return !e || !e.state ? R : (t = e.state, t.wsize = 0, t.whave = 0, t.wnext = 0, Je(e));
}
function Xe(e, t) {
	var n, r;
	return !e || !e.state || (r = e.state, t < 0 ? (n = 0, t = -t) : (n = (t >> 4) + 1, t < 48 && (t &= 15)), t && (t < 8 || t > 15)) ? R : (r.window !== null && r.wbits !== t && (r.window = null), r.wrap = n, r.wbits = t, Ye(e));
}
function Ze(e, t) {
	var n, r;
	return e ? (r = new qe(), e.state = r, r.window = null, n = Xe(e, t), n !== L && (e.state = null), n) : R;
}
var Qe = !0, $e, et;
function tt(e) {
	if (Qe) {
		var t;
		for ($e = m(512), et = m(32), t = 0; t < 144;) e.lens[t++] = 8;
		for (; t < 256;) e.lens[t++] = 9;
		for (; t < 280;) e.lens[t++] = 7;
		for (; t < 288;) e.lens[t++] = 8;
		for (P(F, e.lens, 0, 288, $e, 0, e.work, { bits: 9 }), t = 0; t < 32;) e.lens[t++] = 5;
		P(I, e.lens, 0, 32, et, 0, e.work, { bits: 5 }), Qe = !1;
	}
	e.lencode = $e, e.lenbits = 9, e.distcode = et, e.distbits = 5;
}
function nt(e, t, n, r) {
	var i, a = e.state;
	return a.window === null && (a.wsize = 1 << a.wbits, a.wnext = 0, a.whave = 0, a.window = f(a.wsize)), r >= a.wsize ? (u(a.window, t, n - a.wsize, a.wsize, 0), a.wnext = 0, a.whave = a.wsize) : (i = a.wsize - a.wnext, i > r && (i = r), u(a.window, t, n - r, i, a.wnext), r -= i, r ? (u(a.window, t, n - r, r, 0), a.wnext = r, a.whave = a.wsize) : (a.wnext += i, a.wnext === a.wsize && (a.wnext = 0), a.whave < a.wsize && (a.whave += i))), 0;
}
function rt(e, t) {
	var n, r, i, a, o, s, c, l, d, p, m, h, g, _, v = 0, y, b, x, S, C, T, E, O, k = f(4), j, M, N = [
		16,
		17,
		18,
		0,
	...
	if (!e || !e.state || !e.output || !e.input && e.avail_in !== 0) return R;
	n = e.state, n.mode === B && (n.mode = De), o = e.next_out, i = e.output, c = e.avail_out, a = e.next_in, r = e.input, s = e.avail_in, l = n.hold, d = n.bits, p = s, m = c, O = L;
	inf_leave: for (;;) switch (n.mode) {
		case _e:
			...
			if (n.wrap & 2 && l === 35615) {
				n.check = 0, k[0] = l & 255, k[1] = l >>> 8 & 255, n.check = D(n.check, k, 2, 0), l = 0, d = 0, n.mode = ve;
				break;
			}
			if (n.flags = 0, n.head && (n.head.done = !1), !(n.wrap & 1) || (((l & 255) << 8) + (l >> 8)) % 31) {
				e.msg = "incorrect header check", n.mode = U;
				break;
			}
			if ((l & 15) !== ge) {
				e.msg = "unknown compression method", n.mode = U;
				break;
			}
			if (l >>>= 4, d -= 4, E = (l & 15) + 8, n.wbits === 0) n.wbits = E;
			else if (E > n.wbits) {
				e.msg = "invalid window size", n.mode = U;
				break;
			}
			n.dmax = 1 << E, e.adler = n.check = 1, n.mode = l & 512 ? Ee : B, l = 0, d = 0;
			break;
		case ve:
			for (; d < 16;) {
				if (s === 0) break inf_leave;
			...
			if (n.flags = l, (n.flags & 255) !== ge) {
				e.msg = "unknown compression method", n.mode = U;
				break;
			}
			if (n.flags & 57344) {
				e.msg = "unknown header flags set", n.mode = U;
				break;
			}
			n.head && (n.head.text = l >> 8 & 1), n.flags & 512 && (k[0] = l & 255, k[1] = l >>> 8 & 255, n.check = D(n.check, k, 2, 0)), l = 0, d = 0, n.mode = ye;
		case ye:
			for (; d < 32;) {
				if (s === 0) break inf_leave;
				s--, l += r[a++] << d, d += 8;
			}
			n.head && (n.head.time = l), n.flags & 512 && (k[0] = l & 255, k[1] = l >>> 8 & 255, k[2] = l >>> 16 & 255, k[3] = l >>> 24 & 255, n.check = D(n.check, k, 4, 0)), l = 0, d = 0, n.mode = be;
		case be:
			for (; d < 16;) {
				if (s === 0) break inf_leave;
				s--, l += r[a++] << d, d += 8;
			}
			n.head && (n.head.xflags = l & 255, n.head.os = l >> 8), n.flags & 512 && (k[0] = l & 255, k[1] = l >>> 8 & 255, n.check = D(n.check, k, 2, 0)), l = 0, d = 0, n.mode = xe;
		case xe:
			if (n.flags & 1024) {
				for (; d < 16;) {
					if (s === 0) break inf_leave;
				...
				n.length = l, n.head && (n.head.extra_len = l), n.flags & 512 && (k[0] = l & 255, k[1] = l >>> 8 & 255, n.check = D(n.check, k, 2, 0)), l = 0, d = 0;
			} else n.head && (n.head.extra = null);
			n.mode = Se;
		case Se:
			if (n.flags & 1024 && (h = n.length, h > s && (h = s), h && (n.head && (E = n.head.extra_len - n.length, n.head.extra || (n.head.extra = Array(n.head.extra_len)), u(n.head.extra, r, a, h, E)), n.flags & 512 && (n.check = D(n.check, r, h, a)), s -= h, a += h, n.length -= h), n.length)) break inf_leave;
		...
		case Ce:
			if (n.flags & 2048) {
				...
				while (E && h < s);
				if (n.flags & 512 && (n.check = D(n.check, r, h, a)), s -= h, a += h, E) break inf_leave;
			} else n.head && (n.head.name = null);
			n.length = 0, n.mode = we;
		case we:
			if (n.flags & 4096) {
				if (s === 0) break inf_leave;
				h = 0;
		...
		case Te:
			if (n.flags & 512) {
				...
				if (l !== (n.check & 65535)) {
					e.msg = "header crc mismatch", n.mode = U;
					break;
				}
				l = 0, d = 0;
			}
		...
		case Ee:
			...
			e.adler = n.check = Ke(l), l = 0, d = 0, n.mode = z;
		case z:
			if (n.havedict === 0) return e.next_out = o, e.avail_out = c, e.next_in = a, e.avail_in = s, n.hold = l, n.bits = d, fe;
			e.adler = n.check = 1, n.mode = B;
		case B: if (t === le || t === ue) break inf_leave;
		case De:
			if (n.last) {
				l >>>= d & 7, d -= d & 7, n.mode = ze;
				break;
			}
			for (; d < 3;) {
				if (s === 0) break inf_leave;
			...
			switch (n.last = l & 1, l >>>= 1, --d, l & 3) {
				case 0:
					n.mode = Oe;
					break;
				case 1:
					if (tt(n), n.mode = V, t === ue) {
						l >>>= 2, d -= 2;
						break inf_leave;
					}
					break;
				case 2:
					n.mode = je;
					break;
				case 3: e.msg = "invalid block type", n.mode = U;
			}
			l >>>= 2, d -= 2;
			break;
		case Oe:
			...
			if ((l & 65535) != (l >>> 16 ^ 65535)) {
				e.msg = "invalid stored block lengths", n.mode = U;
				break;
			}
			if (n.length = l & 65535, l = 0, d = 0, n.mode = ke, t === ue) break inf_leave;
		case ke: n.mode = Ae;
		case Ae:
			if (h = n.length, h) {
				if (h > s && (h = s), h > c && (h = c), h === 0) break inf_leave;
				u(i, r, a, h, o), s -= h, a += h, c -= h, o += h, n.length -= h;
				break;
			}
			n.mode = B;
			break;
		case je:
			...
			if (n.nlen = (l & 31) + 257, l >>>= 5, d -= 5, n.ndist = (l & 31) + 1, l >>>= 5, d -= 5, n.ncode = (l & 15) + 4, l >>>= 4, d -= 4, n.nlen > 286 || n.ndist > 30) {
				e.msg = "too many length or distance symbols", n.mode = U;
				break;
			}
			n.have = 0, n.mode = Me;
		case Me:
			for (; n.have < n.ncode;) {
				...
				n.lens[N[n.have++]] = l & 7, l >>>= 3, d -= 3;
			}
			for (; n.have < 19;) n.lens[N[n.have++]] = 0;
			if (n.lencode = n.lendyn, n.lenbits = 7, j = { bits: n.lenbits }, O = P(se, n.lens, 0, 19, n.lencode, 0, n.work, j), n.lenbits = j.bits, O) {
				e.msg = "invalid code lengths set", n.mode = U;
				break;
			}
			n.have = 0, n.mode = Ne;
		case Ne:
			for (; n.have < n.nlen + n.ndist;) {
				for (; v = n.lencode[l & (1 << n.lenbits) - 1], y = v >>> 24, b = v >>> 16 & 255, x = v & 65535, !(y <= d);) {
					if (s === 0) break inf_leave;
					s--, l += r[a++] << d, d += 8;
				}
				if (x < 16) l >>>= y, d -= y, n.lens[n.have++] = x;
				else {
					if (x === 16) {
						for (M = y + 2; d < M;) {
							if (s === 0) break inf_leave;
						...
						if (l >>>= y, d -= y, n.have === 0) {
							e.msg = "invalid bit length repeat", n.mode = U;
							break;
						}
						E = n.lens[n.have - 1], h = 3 + (l & 3), l >>>= 2, d -= 2;
					} else if (x === 17) {
						for (M = y + 3; d < M;) {
							if (s === 0) break inf_leave;
							s--, l += r[a++] << d, d += 8;
						}
						l >>>= y, d -= y, E = 0, h = 3 + (l & 7), l >>>= 3, d -= 3;
					} else {
						for (M = y + 7; d < M;) {
							if (s === 0) break inf_leave;
							s--, l += r[a++] << d, d += 8;
						}
						l >>>= y, d -= y, E = 0, h = 11 + (l & 127), l >>>= 7, d -= 7;
					}
			...
			if (n.mode === U) break;
			if (n.lens[256] === 0) {
				e.msg = "invalid code -- missing end-of-block", n.mode = U;
				break;
			}
			if (n.lenbits = 9, j = { bits: n.lenbits }, O = P(F, n.lens, 0, n.nlen, n.lencode, 0, n.work, j), n.lenbits = j.bits, O) {
				e.msg = "invalid literal/lengths set", n.mode = U;
				break;
			}
			if (n.distbits = 6, n.distcode = n.distdyn, j = { bits: n.distbits }, O = P(I, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, j), n.distbits = j.bits, O) {
				e.msg = "invalid distances set", n.mode = U;
				break;
			}
			if (n.mode = V, t === ue) break inf_leave;
		case V: n.mode = H;
		case H:
			if (s >= 6 && c >= 258) {
				e.next_out = o, e.avail_out = c, e.next_in = a, e.avail_in = s, n.hold = l, n.bits = d, A(e, m), o = e.next_out, i = e.output, c = e.avail_out, a = e.next_in, r = e.input, s = e.avail_in, l = n.hold, d = n.bits, n.mode === B && (n.back = -1);
				break;
			}
			for (n.back = 0; v = n.lencode[l & (1 << n.lenbits) - 1], y = v >>> 24, b = v >>> 16 & 255, x = v & 65535, !(y <= d);) {
				if (s === 0) break inf_leave;
				s--, l += r[a++] << d, d += 8;
			}
			if (b && !(b & 240)) {
				for (S = y, C = b, T = x; v = n.lencode[T + ((l & (1 << S + C) - 1) >> S)], y = v >>> 24, b = v >>> 16 & 255, x = v & 65535, !(S + y <= d);) {
					if (s === 0) break inf_leave;
					s--, l += r[a++] << d, d += 8;
				}
				l >>>= S, d -= S, n.back += S;
			}
			if (l >>>= y, d -= y, n.back += y, n.length = x, b === 0) {
				n.mode = Re;
				break;
			}
			if (b & 32) {
			...
			if (b & 64) {
				e.msg = "invalid literal/length code", n.mode = U;
				break;
			}
			n.extra = b & 15, n.mode = Pe;
		case Pe:
			if (n.extra) {
				for (M = n.extra; d < M;) {
					if (s === 0) break inf_leave;
				...
				n.length += l & (1 << n.extra) - 1, l >>>= n.extra, d -= n.extra, n.back += n.extra;
			}
			n.was = n.length, n.mode = Fe;
		case Fe:
			for (; v = n.distcode[l & (1 << n.distbits) - 1], y = v >>> 24, b = v >>> 16 & 255, x = v & 65535, !(y <= d);) {
				if (s === 0) break inf_leave;
				s--, l += r[a++] << d, d += 8;
			}
			if (!(b & 240)) {
				for (S = y, C = b, T = x; v = n.distcode[T + ((l & (1 << S + C) - 1) >> S)], y = v >>> 24, b = v >>> 16 & 255, x = v & 65535, !(S + y <= d);) {
					if (s === 0) break inf_leave;
					s--, l += r[a++] << d, d += 8;
				}
				l >>>= S, d -= S, n.back += S;
			}
			if (l >>>= y, d -= y, n.back += y, b & 64) {
				e.msg = "invalid distance code", n.mode = U;
				break;
			}
			n.offset = x, n.extra = b & 15, n.mode = Ie;
		case Ie:
			if (n.extra) {
				for (M = n.extra; d < M;) {
					if (s === 0) break inf_leave;
				...
				n.offset += l & (1 << n.extra) - 1, l >>>= n.extra, d -= n.extra, n.back += n.extra;
			}
			if (n.offset > n.dmax) {
				e.msg = "invalid distance too far back", n.mode = U;
				break;
			}
			n.mode = Le;
		case Le:
		...
		case ze:
			if (n.wrap) {
				...
				if (m -= c, e.total_out += m, n.total += m, m && (e.adler = n.check = n.flags ? D(n.check, i, m, o - m) : w(n.check, i, m, o - m)), m = c, (n.flags ? l : Ke(l)) !== n.check) {
					e.msg = "incorrect data check", n.mode = U;
					break;
				}
				l = 0, d = 0;
			}
		...
		case Be:
			if (n.wrap && n.flags) {
				...
				if (l !== (n.total & 4294967295)) {
					e.msg = "incorrect length check", n.mode = U;
					break;
				}
				l = 0, d = 0;
			}
	...
	return e.next_out = o, e.avail_out = c, e.next_in = a, e.avail_in = s, n.hold = l, n.bits = d, (n.wsize || m !== e.avail_out && n.mode < U && (n.mode < ze || t !== ce)) && nt(e, e.output, e.next_out, m - e.avail_out) ? (n.mode = He, me) : (p -= e.avail_in, m -= e.avail_out, e.total_in += p, e.total_out += m, n.total += m, n.wrap && m && (e.adler = n.check = n.flags ? D(n.check, i, m, e.next_out - m) : w(n.check, i, m, e.next_out - m)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === B ? 128 : 0) + (n.mode === V || n.mode === ke ? 256 : 0), (p === 0 && m === 0 || t === ce) && O === L && (O = he), O);
}
function it(e) {
	if (!e || !e.state) return R;
	var t = e.state;
	return t.window &&= null, e.state = null, L;
}
function at(e, t) {
	var n;
	return !e || !e.state || (n = e.state, !(n.wrap & 2)) ? R : (n.head = t, t.done = !1, L);
}
function ot(e, t) {
	var n = t.length, r, i, a;
	return !e || !e.state || (r = e.state, r.wrap !== 0 && r.mode !== z) ? R : r.mode === z && (i = 1, i = w(i, t, n, 0), i !== r.check) ? pe : (a = nt(e, t, n, n), a ? (r.mode = He, me) : (r.havedict = 1, L));
}
//#endregion
...
var lt = Object.prototype.toString, ut = class e {
	constructor(t) {
		...
		var n = this.options;
		n.raw && n.windowBits >= 0 && n.windowBits < 16 && (n.windowBits = -n.windowBits, n.windowBits === 0 && (n.windowBits = -15)), n.windowBits >= 0 && n.windowBits < 16 && !(t && t.windowBits) && (n.windowBits += 32), n.windowBits > 15 && n.windowBits < 48 && (n.windowBits & 15 || (n.windowBits |= 15)), this.err = 0, this.msg = "", this.ended = !1, this.chunks = [], this.strm = new ct(), this.strm.avail_out = 0;
		var r = Ze(this.strm, n.windowBits);
		if (r !== 0 || (this.header = new C(), at(this.strm, this.header), n.dictionary && (typeof n.dictionary == "string" ? n.dictionary = v(n.dictionary) : lt.call(n.dictionary) === "[object ArrayBuffer]" && (n.dictionary = new Uint8Array(n.dictionary)), n.raw && (r = ot(this.strm, n.dictionary), r !== 0)))) throw Error(st[r]);
	}
	push(e, t) {
		var n = this.strm, r = this.options.chunkSize, i = this.options.dictionary, a, s, c, l, d, p, m = !1;
		if (this.ended) return !1;
		s = t === ~~t ? t : t === !0 ? 4 : 0, typeof e == "string" ? n.input = b(e) : lt.call(e) === "[object ArrayBuffer]" ? n.input = new Uint8Array(e) : n.input = e, n.next_in = 0, n.avail_in = n.input.length;
		do {
			if (n.avail_out === 0 && (n.output = f(r), n.next_out = 0, n.avail_out = r), a = rt(n, 0), a === 2 && i && (p = typeof i == "string" ? v(i) : lt.call(i) === "[object ArrayBuffer]" ? new Uint8Array(i) : i, a = ot(this.strm, p)), a === -5 && m === !0 && (a = 0, m = !1), a !== 1 && a !== 0) return this.onEnd(a), this.ended = !0, !1;
			n.next_out && (n.avail_out === 0 || a === 1 || n.avail_in === 0 && (s === 4 || s === 2)) && (this.options.to === "string" ? (c = S(n.output, n.next_out), l = n.next_out - c, d = x(n.output, c), n.next_out = l, n.avail_out = r - l, l && u(n.output, n.output, c, l, 0), this.onData(d)) : this.onData(o(n.output, n.next_out))), n.avail_in === 0 && n.avail_out === 0 && (m = !0);
		} while ((n.avail_in > 0 || n.avail_out === 0) && a !== 1);
		return a === 1 && (s = 4), s === 4 ? (a = it(this.strm), this.onEnd(a), this.ended = !0, a === 0) : s === 2 ? (this.onEnd(0), n.avail_out = 0, !0) : !0;
	}
	onData(e) {
		this.chunks.push(e);
	}
	onEnd(e) {
		e === 0 && (this.options.to === "string" ? this.result = this.chunks.join("") : this.result = d(this.chunks)), this.chunks = [], this.err = e, this.msg = this.strm.msg;
	}
};
function dt(e, t) {
	var n = new ut(t);
	if (n.push(e, !0), n.err) throw n.msg || st[n.err];
	return n.result;
}
var ft = dt, W = {};
W.d = (e, t) => {
...
var mt = "data:application/wasm;base64,", G = class e {
	...
	take_buffer() {
		try {
			...
			$.chunksliceresult_take_buffer(r, this.__wbg_ptr);
			var e = q().getInt32(r + 0, !0), t = q().getInt32(r + 4, !0), n = Ct(e, t).slice();
	...
	take_cpositions() {
		try {
			let r = $.__wbindgen_add_to_stack_pointer(-16);
			$.chunksliceresult_take_cpositions(r, this.__wbg_ptr);
			var e = q().getInt32(r + 0, !0), t = q().getInt32(r + 4, !0), n = St(e, t).slice();
	...
	take_dpositions() {
		try {
			let r = $.__wbindgen_add_to_stack_pointer(-16);
			$.chunksliceresult_take_dpositions(r, this.__wbg_ptr);
			var e = q().getInt32(r + 0, !0), t = q().getInt32(r + 4, !0), n = St(e, t).slice();
			return $.__wbindgen_export(e, t * 8, 8), n;
		} finally {
			$.__wbindgen_add_to_stack_pointer(16);
...
function ht(e) {
	try {
		let a = $.__wbindgen_add_to_stack_pointer(-16), o = Ot(e, $.__wbindgen_export2), s = Nt;
		$.decompress_all(a, o, s);
		var t = q().getInt32(a + 0, !0), n = q().getInt32(a + 4, !0), r = q().getInt32(a + 8, !0);
		if (q().getInt32(a + 12, !0)) throw kt(r);
		var i = Ct(t, n).slice();
...
function gt(e, t, n, r, i) {
	try {
		let s = $.__wbindgen_add_to_stack_pointer(-16), c = Ot(e, $.__wbindgen_export2), l = Nt;
		$.decompress_chunk_slice(s, c, l, t, n, r, i);
		var a = q().getInt32(s + 0, !0), o = q().getInt32(s + 4, !0);
		if (q().getInt32(s + 8, !0)) throw kt(o);
		return G.__wrap(a);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
	}
...
function _t(e, t) {
	return bt(Error(Tt(e, t)));
}
function vt(e, t) {
	throw Error(Tt(e, t));
}
var yt = typeof FinalizationRegistry > "u" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => $.__wbg_chunksliceresult_free(e, 1));
function bt(e) {
...
function Ct(e, t) {
	return e >>>= 0, Et().subarray(e / 1, e / 1 + t);
}
var K = null;
function q() {
...
function Ot(e, t) {
	...
	return Et().set(e, n / 1), Nt = e.length, n;
}
function kt(e) {
	let t = Dt(e);
	return xt(e), t;
...
Q.decode();
var At = 2146435072, jt = 0;
function Mt(e, t) {
	return jt += t, jt >= At && (Q = new TextDecoder("utf-8", {
		ignoreBOM: !0,
		fatal: !0
	}), Q.decode(), jt = t), Q.decode(Et().subarray(e, e + t));
}
var Nt = 0, $;
function Pt(e) {
	$ = e;
...
async function Lt() {
	return Ft || (It ||= (async () => {
		let e = await (await fetch(mt)).arrayBuffer(), { instance: t } = await WebAssembly.instantiate(e, { "./bgzf_wasm_bg.js": pt });
		return Ft = t.exports, Pt(Ft), Ft;
	})(), It);
}
async function Rt(e) {
	return await Lt(), ht(e);
}
async function zt(e, t, n, r, i) {
	await Lt();
	let a = gt(e, t, n, r, i), o = a.take_buffer(), s = [...a.take_cpositions()], c = [...a.take_dpositions()];
	return a.free(), {
		buffer: o,
		cpositions: s,
		dpositions: c
...
async function Ht(e) {
	...
	} else return ft(e, void 0);
}
function Ut(e) {
	return Vt(e).includes("invalid gzip header") ? Error("problem decompressing block: incorrect gzip header check", { cause: e }) : e;
}
async function Wt(e) {
	try {
		return await Rt(e);
	} catch (t) {
		if (Vt(t).includes("invalid bgzf header")) {
			if (Bt(e)) return Ht(e);
...
async function Gt(e, t) {
	let { minv: n, maxv: r } = t;
	try {
		let t = await zt(e, n.blockPosition, n.dataPosition, r.blockPosition, r.dataPosition);
		return {
			buffer: t.buffer,
...
var Zt = class {
	...
	gzi;
	limit;
	constructor({ filehandle: e, gziFilehandle: t, blockConcurrency: n = qt }) {
		this.filehandle = e, this.gzi = new r({ filehandle: t }), this.limit = Yt(n);
	}
	async _readAndUncompressBlock(e, t) {
		return Wt(await this.filehandle.read(t, e));
	}
	async read(e, t) {
		...
		let i = t + e;
		return Kt(await Promise.all(n.map(([e, a], o) => this.limit(async () => {
			let s = n[o + 1]?.[0] ?? r ?? e + Jt;
			return Xt(await this._readAndUncompressBlock(e, s - e), a, t, i);
		}))));
	}
};
//#endregion
export { Wt as n, Gt as r, Zt as t };
