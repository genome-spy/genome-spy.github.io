...
import { r as t, t as n } from "./browser-kyCRRjQB.js";
import { t as r } from "./AbortablePromiseCache-BTmAcN-t.js";
...
var f = {};
d.r(f), d.d(f, {
	__wbg_Error_ef53bc310eb298a0: () => ee,
	__wbg_set_wasm: () => L,
...
function h(e, t, n, r, i, a) {
	try {
		let u = I.__wbindgen_add_to_stack_pointer(-16), d = j(e, I.__wbindgen_export), f = F, p = A(t, I.__wbindgen_export), m = F, h = A(n, I.__wbindgen_export), g = F;
		I.decompress_and_parse_bigwig(u, d, f, p, m, h, g, r, i, a);
		var o = w().getInt32(u + 0, !0), s = w().getInt32(u + 4, !0), c = w().getInt32(u + 8, !0);
		if (w().getInt32(u + 12, !0)) throw M(c);
		var l = S(o, s).slice();
...
function g(e, t, n, r, i, a, o) {
	try {
		let d = I.__wbindgen_add_to_stack_pointer(-16), f = j(e, I.__wbindgen_export), p = F, m = A(t, I.__wbindgen_export), h = F, g = A(n, I.__wbindgen_export), _ = F;
		I.decompress_and_parse_summary(d, f, p, m, h, g, _, r, i, a, o);
		var s = w().getInt32(d + 0, !0), c = w().getInt32(d + 4, !0), l = w().getInt32(d + 8, !0);
		if (w().getInt32(d + 12, !0)) throw M(l);
		var u = S(s, c).slice();
...
function _(e, t) {
	try {
		let o = I.__wbindgen_add_to_stack_pointer(-16), s = j(e, I.__wbindgen_export), c = F;
		I.inflate_raw(o, s, c, t);
		var n = w().getInt32(o + 0, !0), r = w().getInt32(o + 4, !0), i = w().getInt32(o + 8, !0);
		if (w().getInt32(o + 12, !0)) throw M(i);
		var a = S(n, r).slice();
...
function v(e, t, n, r) {
	try {
		let c = I.__wbindgen_add_to_stack_pointer(-16), l = j(e, I.__wbindgen_export), u = F, d = A(t, I.__wbindgen_export), f = F, p = A(n, I.__wbindgen_export), m = F;
		I.inflate_raw_batch(c, l, u, d, f, p, m, r);
		var i = w().getInt32(c + 0, !0), a = w().getInt32(c + 4, !0), o = w().getInt32(c + 8, !0);
		if (w().getInt32(c + 12, !0)) throw M(o);
		var s = S(i, a).slice();
...
function y(e) {
	try {
		let a = I.__wbindgen_add_to_stack_pointer(-16), o = j(e, I.__wbindgen_export), s = F;
		I.inflate_raw_unknown_size(a, o, s);
		var t = w().getInt32(a + 0, !0), n = w().getInt32(a + 4, !0), r = w().getInt32(a + 8, !0);
		if (w().getInt32(a + 12, !0)) throw M(r);
		var i = S(t, n).slice();
...
function ee(e, t) {
	return b(Error(te(e, t)));
}
function b(e) {
	k === O.length && O.push(O.length + 1);
	let t = k;
	return k = O[t], O[t] = e, t;
}
function x(e) {
	e < 1028 || (O[e] = k, k = e);
}
...
var C = null;
function w() {
	return (C === null || C.buffer.detached === !0 || C.buffer.detached === void 0 && C.buffer !== I.memory.buffer) && (C = new DataView(I.memory.buffer)), C;
}
function te(e, t) {
	return ae(e >>> 0, t);
}
var T = null;
function ne() {
	return (T === null || T.byteLength === 0) && (T = new Uint32Array(I.memory.buffer)), T;
}
var E = null;
function D() {
...
var O = Array(1024).fill(void 0);
O.push(void 0, null, !0, !1);
var k = O.length;
function A(e, t) {
	let n = t(e.length * 4, 4) >>> 0;
	return ne().set(e, n / 4), F = e.length, n;
}
function j(e, t) {
...
N.decode();
var ie = 2146435072, P = 0;
function ae(e, t) {
	return P += t, P >= ie && (N = new TextDecoder("utf-8", {
		ignoreBOM: !0,
		fatal: !0
	}), N.decode(), P = t), N.decode(D().subarray(e, e + t));
}
var F = 0, I;
function L(e) {
	I = e;
...
async function B() {
	return R || (z ||= (async () => {
		...
		return L(t.exports), R = t.exports, R;
	})(), z);
}
...
function se(e) {
	...
	if (t === 0) return {
		starts: /* @__PURE__ */ new Int32Array(),
		ends: /* @__PURE__ */ new Int32Array(),
		scores: /* @__PURE__ */ new Float32Array()
	};
	let n = 4 + t * 4, r = n + t * 4;
	return {
...
function ce(e) {
	...
	if (t === 0) return {
		...
		ends: /* @__PURE__ */ new Int32Array(),
		scores: /* @__PURE__ */ new Float32Array(),
		minScores: /* @__PURE__ */ new Float32Array(),
		maxScores: /* @__PURE__ */ new Float32Array()
	};
...
async function le(e, t, n, r, i, a) {
	return await B(), se(h(e, t, n, r, i, a));
}
async function ue(e, t, n, r, i, a, o) {
	return await B(), ce(g(e, t, n, r, i, a, o));
}
//#endregion
...
async function H(e, t, n) {
	let { inputOffsets: r, inputLengths: i } = V(t);
	return oe(e, r, i, n);
}
async function de(e, t, n, r, i) {
	let { inputOffsets: a, inputLengths: o } = V(t);
	return le(e, a, o, n, r, i);
}
async function fe(e, t, n, r, i, a) {
	let { inputOffsets: o, inputLengths: s } = V(t);
	return ue(e, o, s, n, r, i, a);
}
//#endregion
//#region ../../node_modules/@gmod/bbi/esm/util.js
var U = new TextDecoder("utf8");
function W(e, t = 0) {
	return new DataView(e.buffer, e.byteOffset + t, e.length - t);
}
function G(e, t, n) {
	let r = e.indexOf(0, t), i = r !== -1 && r < t + n ? r : t + n;
	return U.decode(e.subarray(t, i));
}
function K(e) {
...
function me(e, t, n) {
	...
	for (; i < e.byteLength;) {
		...
		i += 4;
		let u = e.indexOf(0, i), d = u === -1 ? e.length : u, f = U.decode(e.subarray(i, d));
...
function he(e, t) {
	let n = W(e), r = n.getInt32(4, !0), i = n.getUint32(12, !0), a = n.getUint32(16, !0), o = n.getUint8(20), s = n.getUint16(22, !0), c = 24, l = [];
	switch (o) {
		case 1:
			for (let e = 0; e < s; e++) {
...
function ge(e, t) {
	let n = W(e), r = n.getInt32(4, !0), i = n.getUint32(12, !0), a = n.getUint32(16, !0), o = n.getUint8(20), s = n.getUint16(22, !0), c = new Int32Array(s), l = new Int32Array(s), u = new Float32Array(s);
	if (!t) {
		switch (o) {
			case 1: {
				let e = 24;
...
function _e(e, t) {
	let n = W(e), r = Math.floor(e.byteLength / 32), i = new Int32Array(r), a = new Int32Array(r), o = new Float32Array(r), s = new Float32Array(r), c = new Float32Array(r), l = 0, u = 0;
	for (; u < e.byteLength;) {
...
function Z(e, t, n, r) {
	switch (e) {
		case "summary": return pe(t, r);
		case "bigwig": return he(t, r);
		case "bigbed": return me(t, n, r);
...
var ve = class {
	...
	async _collectBlocks(e, t, n, r) {
		...
		let a = W(await this.rTreePromise), o = a.getUint32(0, !0);
		if (o !== q) throw Error(`invalid cirTree magic: 0x${o.toString(16)} (expected 0x${q.toString(16)}) at offset ${this.rTreeOffset}, file may be corrupt or unsupported`);
		...
		for (; d.length > 0;) {
			...
			for (let { min: n, max: i } of e) {
				...
				for (let e of d) if (n <= e && e <= i) {
					let n = W(o.subarray(e - a)), r = n.getUint8(0), i = n.getUint16(2, !0);
					if (r === 1 || r === 0) {
						let e = r === 1 ? 32 : 24, a = 4;
						for (let o = 0; o < i; o++) {
	...
	async readWigDataMulti(e, t = {}) {
		...
		let { blockType: a, uncompressBufSize: o } = this, { signal: s, onProgress: c } = t, l = (e, t) => {
			let r = i.get(t);
			if (r) for (let { regionIndex: i, request: o } of r) {
				let r = Z(a, e, t, o);
				for (let e of r) n[i].push(e);
			}
		}, u = K([...r.values()]), d = J(u, c);
		for (let e of u) {
			let t = await this.bbi.read(e.length, e.offset, { signal: s });
			d(e.length);
			let n = e.offset, r = e.blocks;
			if (o > 0) {
				let { data: e, offsets: i } = await H(t, r.map((e) => ({
					offset: e.offset - n,
					length: e.length
				})), o);
				for (let t = 0; t < r.length; t++) l(e.subarray(i[t], i[t + 1]), r[t].offset);
			} else for (let e of r) {
				let r = e.offset - n;
				l(t.subarray(r, r + e.length), e.offset);
			}
		}
		return n;
	}
	...
	async readFeatures(e, t = {}) {
		let { blockType: n, uncompressBufSize: r } = this, { signal: i, request: a, onProgress: o } = t, s = K(e), c = J(s, o), l = [];
		for (let e of s) {
			let t = await this.bbi.read(e.length, e.offset, { signal: i });
			c(e.length);
			let o = e.offset, s = e.blocks;
			if (r > 0) {
				let { data: e, offsets: i } = await H(t, s.map((e) => ({
					offset: e.offset - o,
					length: e.length
				})), r);
				for (let t = 0; t < s.length; t++) {
					let r = Z(n, e.subarray(i[t], i[t + 1]), s[t].offset, a);
					for (let e of r) l.push(e);
				}
			} else for (let e of s) {
				let r = e.offset - o, i = Z(n, t.subarray(r, r + e.length), e.offset, a);
				for (let e of i) l.push(e);
			}
		}
		return l;
	}
	async _readBlocksAsArrays(e, t, n, r, i, a) {
		let o = [], s = K(e), c = J(s, a);
		for (let e of s) {
			let a = await this.bbi.read(e.length, e.offset, { signal: t });
			c(e.length);
			let s = e.blocks.map((t) => ({
			...
			if (this.uncompressBufSize > 0) {
				...
				let t = r(a.subarray(e.offset, e.offset + e.length));
				i(t) > 0 && o.push(t);
			}
		}
		return o;
	...
	async _readBigWigFeaturesAsArrays(e, t, n = {}) {
		let r = await this._readBlocksAsArrays(e, n.signal, (e, n) => de(e, n, this.uncompressBufSize, t.start, t.end), (e) => ge(e, t), (e) => e.starts.length, n.onProgress), i = r.reduce((e, t) => e + t.starts.length, 0);
		return {
	...
	async _readSummaryFeaturesAsArrays(e, t, n = {}) {
		let r = await this._readBlocksAsArrays(e, n.signal, (e, n) => fe(e, n, this.uncompressBufSize, t.chrId, t.start, t.end), (e) => _e(e, t), (e) => e.starts.length, n.onProgress), i = r.reduce((e, t) => e + t.starts.length, 0);
		return {
			starts: X(r.map((e) => e.starts), i, Int32Array),
			ends: X(r.map((e) => e.ends), i, Int32Array),
			scores: X(r.map((e) => e.scores), i, Float32Array),
...
}, ye = -2003829722, Q = -2021002517, $ = class {
	bbi;
	headerP;
	renameRefSeqs;
	getHeader(e) {
	...
	async _getMainHeader(e, t = 2e3) {
		let n = await this.bbi.read(t, 0, e), r = W(n), i = 0, a = r.getInt32(i, !0);
		if (i += 4, a !== ye && a !== Q) throw Error("not a BigWig/BigBed file");
		...
		let v = a === Q ? "bigbed" : "bigwig", y = n.length < t, ee = p !== 0 && !n.includes(0, p);
		if (!y && (p > t || m > t - 40 || ee)) return this._getMainHeader(e, t * 2);
		let b;
		if (m) {
			let e = W(n, m);
			b = {
	...
	async _readChromosomeTree(e, t) {
		let n = [], r = {}, i = e.chromosomeTreeOffset, a = W(await this.bbi.read(32, i, t)), o = a.getUint32(8, !0), s = a.getUint32(12, !0), c = async (e) => {
			let i = W(await this.bbi.read(4, e, t)), a = i.getUint8(0), l = i.getUint16(2, !0);
			if (a) {
				let i = await this.bbi.read(l * (o + s), e + 4, t), a = W(i), c = 0;
				for (let e = 0; e < l; e++) {
					let e = G(i, c, o);
					c += o;
				...
				let n = W(await this.bbi.read(l * (o + 8), e + 4, t)), r = [], i = 0;
				for (let e = 0; e < l; e++) {
					i += o;
	...
	getOrCreateBlockView(e, t, n, r) {
		...
		return a || (a = new ve(this.bbi, e, t, n, r), this.viewCache.set(i, a)), a;
	}
...
async function Se(e, t, n, r, i, a, o, s) {
	let c = 4 + n * (r + i), l = await e.read(c, t, s), u = W(l), d = u.getInt8(0), f = u.getInt16(2, !0), p = 4;
	if (d === 0) {
		let t = [];
		for (let e = 0; e < f; e++) {
			let e = G(l, p, r);
...
var Ce = class extends $ {
	...
	async _readIndices(e) {
		let { extHeaderOffset: t } = await this.getHeader(e), n = W(await this.bbi.read(64, t, e)), r = n.getUint16(2, !0), i = Number(n.getBigUint64(4, !0));
		if (r === 0) return [];
		let a = 20 * r, o = await this.bbi.read(a, i, e), s = [];
		for (let e = 0; e < r; e += 1) {
			let t = W(o, e * 20), n = t.getInt16(0, !0), r = t.getInt16(2, !0), i = Number(t.getBigUint64(4, !0)), a = t.getInt16(16, !0);
			s.push({
				type: n,
				fieldcount: r,
				offset: i,
	...
	async searchExtraIndexBlocks(e, t = {}) {
		...
		let r = n.map(async (n) => {
			let { offset: r, field: i } = n, a = W(await this.bbi.read(32, r, t)), o = a.getInt32(4, !0), s = a.getInt32(8, !0), c = a.getInt32(12, !0);
			return Se(this.bbi, r + 32, o, s, c, e, i, t);
		});
...
//#endregion
export { Ee as ArrayFeatureView, Ce as BigBed, be as BigWig, Te as BigWigFeature, we as parseBigWig };
