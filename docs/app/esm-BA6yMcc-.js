...
var a = class {
	...
	async _readIndex() {
		let e = await this.filehandle.read(8, 0), i = t(new DataView(e.buffer, e.byteOffset, e.byteLength));
		if (i === 0) return [[0, 0]];
		if (i > (2 ** 53 - 1) / n) throw TypeError("integer overflow");
		return r(await this.filehandle.read(n * i, 8), i);
	}
	async getRelevantBlocksForRead(e, t) {
		...
		let n = await this._getIndex(), r = t + e, a = i(n, t) - 1, o = a + 1;
		for (; o < n.length && n[o][1] < r;) o += 1;
		return {
			blocks: n.slice(a, o),
...
var _t = "data:application/wasm;base64,", W = class e {
	...
	take_buffer() {
		try {
			...
			var e = K().getInt32(r + 0, !0), t = K().getInt32(r + 4, !0), n = Et(e, t).slice();
...
function vt(e) {
	try {
		let a = Q.__wbindgen_add_to_stack_pointer(-16), o = jt(e, Q.__wbindgen_export2), s = It;
		Q.decompress_all(a, o, s);
		var t = K().getInt32(a + 0, !0), n = K().getInt32(a + 4, !0), r = K().getInt32(a + 8, !0);
		if (K().getInt32(a + 12, !0)) throw Mt(r);
		var i = Et(t, n).slice();
...
function yt(e, t, n, r, i) {
	try {
		let s = Q.__wbindgen_add_to_stack_pointer(-16), c = jt(e, Q.__wbindgen_export2), l = It;
		Q.decompress_chunk_slice(s, c, l, t, n, r, i);
		var a = K().getInt32(s + 0, !0), o = K().getInt32(s + 4, !0);
		if (K().getInt32(s + 8, !0)) throw Mt(o);
		return W.__wrap(a);
	} finally {
		Q.__wbindgen_add_to_stack_pointer(16);
	}
...
function Tt(e, t) {
	return e >>>= 0, Dt().subarray(e / 8, e / 8 + t);
}
function Et(e, t) {
	return e >>>= 0, kt().subarray(e / 1, e / 1 + t);
}
var G = null;
function K() {
...
function jt(e, t) {
	...
	return kt().set(e, n / 1), It = e.length, n;
}
function Mt(e) {
	let t = At(e);
	return wt(e), t;
...
Z.decode();
var Nt = 2146435072, Pt = 0;
function Ft(e, t) {
	return Pt += t, Pt >= Nt && (Z = new TextDecoder("utf-8", {
		ignoreBOM: !0,
		fatal: !0
	}), Z.decode(), Pt = t), Z.decode(kt().subarray(e, e + t));
}
var It = 0, Q;
function Lt(e) {
	Q = e;
...
async function Bt(e) {
	return await zt(), vt(e);
}
async function Vt(e, t, n, r, i) {
	await zt();
	let a = yt(e, t, n, r, i), o = a.take_buffer(), s = [...a.take_cpositions()], c = [...a.take_dpositions()];
	return a.free(), {
		buffer: o,
		cpositions: s,
		dpositions: c
...
function Gt(e) {
	return Ut(e).includes("invalid gzip header") ? Error("problem decompressing block: incorrect gzip header check", { cause: e }) : e;
}
async function Kt(e) {
	try {
		return await Bt(e);
	} catch (t) {
		if (Ut(t).includes("invalid bgzf header")) {
			if (Ht(e)) return Wt(e);
...
async function qt(e, t) {
	let { minv: n, maxv: r } = t;
	try {
		let t = await Vt(e, n.blockPosition, n.dataPosition, r.blockPosition, r.dataPosition);
		return {
			buffer: t.buffer,
...
var $t = class {
	...
	gzi;
	limit;
	constructor({ filehandle: e, gziFilehandle: t, blockConcurrency: n = Yt }) {
		this.filehandle = e, this.gzi = new a({ filehandle: t }), this.limit = Zt(n);
	}
	async _readAndUncompressBlock(e, t) {
		return Kt(await this.filehandle.read(t, e));
	}
	async read(e, t) {
		...
		let i = t + e;
		return Jt(await Promise.all(n.map(([e, a], o) => this.limit(async () => {
			let s = n[o + 1]?.[0] ?? r ?? e + Xt;
			return Qt(await this._readAndUncompressBlock(e, s - e), a, t, i);
		}))));
	}
}, en = /* @__PURE__ */ e({ unzip: () => Kt });
//#endregion
export { qt as i, $t as n, Kt as r, en as t };
