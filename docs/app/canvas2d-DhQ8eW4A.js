import { ct as e, et as t, hn as n, o as r, s as i } from "./clipOptions-DBJX_W31.js";
import { v as a } from "./vega-scale-BJaDSHBJ.js";
import { t as o } from "./warning-CpIIpk8e.js";
import { t as s } from "./rectangle-DE98gIxF.js";
import { n as c, t as l } from "./layoutResult-D50MSHXR.js";
import { n as u, r as d, t as f } from "./performanceProfiler-CPLEjApa.js";
import { C as p, E as m, F as h, I as g, M as _, N as v, S as y, T as b, _ as x, b as S, c as C, d as w, f as T, g as E, h as ee, i as D, j as O, k, l as te, n as ne, p as re, u as ie, v as ae, x as A } from "./order-DIxlclRN.js";
import { n as j, t as M } from "./renderCanvas2D-2KY9dfd1.js";
import { t as N } from "./canvasSizeHelper-foL2YvGL.js";
import { exportCanvas as P, exportRaster as F } from "./rasterExport-BImWbs27.js";
import { createCanvas2DSvgRasterizer as I } from "./svgRasterizer-C53QUe37.js";
//#region ../core/src/rendering/canvas2d/picking/softwarePickingRasterizer.js
var L = 12, R = .5, z = class {
	#e = [];
	#t = [];
	#n = [
		0,
	...
	setClip(e, t, n, r) {
		...
		this.#r = U(Math.floor(Math.min(e, n)), 0, this.buffer.width), this.#i = U(Math.floor(Math.min(t, r)), 0, this.buffer.height), this.#a = U(Math.ceil(Math.max(e, n)), this.#r, this.buffer.width), this.#o = U(Math.ceil(Math.max(t, r)), this.#i, this.buffer.height);
	}
	fillRect(e, t, n, r, i) {
	...
	strokeSegment(e, t, n, r, i, a, o) {
		...
		this.#u++;
		let s = a / 2, c = this.#n;
		if (!B(t, n, r, i, this.#r - s, this.#i - s, this.#a + s, this.#o + s, c)) return;
	...
	strokeCubic(e, t, n, r, i, a, o, s, c, l, u = R, d) {
...
function G(e, t) {
	let n = e.getType();
	return n == "arrow" ? q(e, t) : n == "rect" ? J(e, t) : n == "point" ? oe(e, t) : n == "rule" || n == "tick" ? se(e, t) : n == "link" ? ce(e, t) : n == "text" ? le(e, t) : 0;
}
function K(e) {
	let t = e.getType();
...
function q(e, t) {
	let n = e, r = y(n), i = Array(8).fill(0);
	return b(n, r, t, (e) => {
		let a = Y(n, e.datum), o = e.strokeWidth / 2;
		r.stem && t.rasterizer.strokeSegment(a, e.tail.x, e.tail.y, e.tip.x, e.tip.y, e.stemHalfWidth * 2 + e.strokeWidth), p(e, (n, r, s, c) => {
			let l = e.headHalfWidth + o, u = n + s.x * o, d = r + s.y * o, f = e.headRepeatFootprint + o, p = n - s.x * f, m = r - s.y * f;
			ue(i, u, d, p, m, c.x, c.y, l), t.rasterizer.fillConvexPolygon(a, i);
		});
	});
}
function J(e, t) {
	let n = e;
	return re(n, T(n), t, (e) => t.rasterizer.fillRect(Y(n, e.datum), e.x, e.y, e.width, e.height));
}
function oe(e, t) {
	let n = e, r = k(n, n.properties.minPickingSize);
	return E(n, ee(n), t, (e) => t.rasterizer.fillSquare(Y(n, e.datum), e.x, e.y, Math.max(e.boundsRadius, r / 2)));
}
function se(e, t) {
	let n = e;
	return w(n, ie(n), t, (e) => t.rasterizer.strokeSegment(Y(n, e.datum), e.x1, e.y1, e.x2, e.y2, Math.max(e.strokeWidth, W)));
}
function ce(e, t) {
	let n = e, r = k(n, n.properties.minPickingSize), i = x(n), a = A(n, i.shape);
	return ae(n, i, t, (e) => {
		let [i, o, s, c] = e.points, l = a && S(i, c, a);
		t.rasterizer.strokeCubic(Y(n, e.datum), i[0], i[1], o[0], o[1], s[0], s[1], c[0], c[1], Math.max(e.strokeWidth, r), void 0, l ? (e, t) => Math.abs(l.normalX * e + l.normalY * t - l.offset) < l.end : void 0);
	});
}
function le(e, t) {
	let n = e, r = t.textMetrics ?? n.unitView.context.textMetrics, i = r.requestFont(n.properties), a = D(r, n.properties);
	return te(n, C(n), {
		...t,
		fontMeasurement: i,
		measureLogoInkBounds: a
	}, (e) => t.rasterizer.fillConvexPolygon(Y(n, e.datum), e.boundsQuad));
}
...
var de = class extends c {
	...
	#a = [0, 0];
	constructor(e) {
		super({ picking: !0 }), this.width = e.width, this.height = e.height, this.devicePixelRatio = e.devicePixelRatio, this.getRasterizer = e.getRasterizer, this.textMetrics = e.textMetrics, this.#n = u(), this.#i = e.xIndexManager;
	}
	getDevicePixelRatio() {
	...
	renderMark(e, t) {
		if (!e.isPickingParticipant() || !K(e)) return;
		let n = t.sampleFacetRenderingOptions;
		if (n && !e.encoders.facetIndex && (this.#n?.addCount("canvasSampleFacetOccurrences"), !j(n))) {
			this.#n?.addCount("canvasCulledSampleFacetOccurrences");
			return;
		}
		let a = e.unitView.getEffectiveOpacity();
		if (a <= 0) return;
		let s = this.currentCoords, c = r(t), l = i(c, e.properties.clip, s), u = _(this.width, this.height, l);
		if (!v(u)) return;
		let d = O(s, c, e.properties.cullByVisibleRange), f = this.#i?.prepare(e) ?? !1;
		g(e, t, s, this.#r, (t, n) => {
			if (n.length == 0) return;
			let r = 0, i = n.length;
			if (f && this.#i.query(n, this.#a) && (r = this.#a[0], i = this.#a[1], r === i)) return;
			let o = this.getRasterizer();
			o.setClip(u.x1, u.y1, u.x2, u.y2), G(e, {
				rasterizer: o,
				coords: t,
				data: n,
				start: r,
		...
		}, (t) => o(`Canvas2D picking could not resolve sample facet index ${t}. View: ${e.unitView.getPathString()}`));
	}
	get currentCoords() {
		let e = n(this.#e);
...
function pe(e, n, r, i = r) {
	let a = Array(e);
	a.fill(X);
	let o = fe, s = -Infinity, c = !1, l = Array(e);
	l.fill(0);
	let u = n[0], d = (n[1] - n[0]) / e, f = (n, r) => {
		let i = (n - u) / d, a = Math.floor(i);
		return t(r && a == i ? a - 1 : a, 0, e - 1);
	};
	function p(e, t, n) {
		if (c) return;
		if (t > o) o = t;
...
function me(e, t, n = 0) {
	if (!t.length) return;
	let r = pe(Math.min(256, Math.ceil(Math.sqrt(t.length))), e.indexDomain, e.xAccessor, e.x2Accessor);
	return t.forEach((e, t) => r(e, n + t, n + t + 1)), r.getIndex();
}
function he(t) {
	let n = t.encoders?.x, r = t.encoders?.x2;
	...
	let o = e(n)?.asNumberAccessor();
	if (!o) return;
	let s;
	if (r && (r.scale !== n.scale || r.branches.length !== 1 || (s = e(r)?.asNumberAccessor(), !s))) return;
	let c = t.unitView.getScaleResolution("x"), l = c?.zoomExtent;
...
var ge = class {
	...
	prepare(e) {
		...
		let a = i.spec;
		return !a || !Z(a, this.#t) ? this.#r() : (this.#n = i, !0);
	}
	query(e, t) {
		let n = this.#n;
		...
		return r === void 0 && (r = me(n.spec, e) ?? null, n.batches.set(e, r), f("canvasXIndexBuilds"), r || f("canvasXIndexRejectedBuilds")), r ? (r(this.#t[0], this.#t[1], t), f("canvasXIndexQueries"), f("canvasXIndexCandidateItems", t[1] - t[0]), t[0] === t[1] && f("canvasXIndexEmptyRanges"), !0) : this.#r();
	}
	#r() {
	...
	constructor(e) {
		this.viewRoot = e.viewRoot, this.context = e.context, this.surface = e.surface, this.textMetrics = e.textMetrics, this.getBackground = e.getBackground, this.broadcast = e.broadcast, this.onLayoutComputed = e.onLayoutComputed, this.layoutResult = void 0, this.pickingRasterizer = void 0, this.dirtyPickingBuffer = !0, this.xIndexManager = new ge(), this.opacityLayers = [];
	}
	computeLayout() {
	...
	renderPickingFramebuffer() {
		...
		let n = this.pickingRasterizer, r = !1, i = new de({
			width: t.width,
			height: t.height,
			devicePixelRatio: this.surface.getDevicePixelRatio(),
			textMetrics: this.textMetrics,
			getRasterizer: () => (n || (n = new z(this.surface.getPickingBuffer()), this.pickingRasterizer = n), r ||= (n.resetClip(), n.resetStatistics(), !0), n),
			xIndexManager: this.xIndexManager
		}), a = u();
		a?.beginFrame("canvas", "picking");
		try {
			d("picking", () => e.collectRenderCommands(i)), this.dirtyPickingBuffer = !1, r && ve(n, a);
		} finally {
			a?.endFrame();
		}
	}
	...
	#e() {
		...
		if (!(isNaN(e.width) || isNaN(e.height))) return l(this.viewRoot, s.create(0, 0, e.width, e.height), {
			devicePixelRatio: this.surface.getDevicePixelRatio(),
...
var Q = /* @__PURE__ */ new Uint32Array(), ye = class {
	#e = Q;
	width = 0;
	height = 0;
	constructor(e = 0, t = 0) {
...
var be = class {
	...
	constructor(e) {
		...
		try {
			this.#e = new N(e.container, t, e.sizeSource, () => {
	...
	getPickingBuffer() {
		...
		return this.#n ??= new ye(e.width, e.height), this.#n;
	}
	clearPickingBuffer() {
		this.#n?.clear();
	}
...
function xe(e) {
	let t = new be(e), n = ne(e.container.ownerDocument);
	return {
		surface: t,
		textMetrics: n,
		createRenderCoordinator: (e) => new _e({
			...e,
			surface: t,
			context: t.context,
			textMetrics: n
		...
		rasterizeSvgRuns: (e) => I()(e),
		readPickingId: (e, n) => t.readPickingId(e, n)
	};
}
//#endregion
export { xe as createCanvas2DRenderingBackend };
