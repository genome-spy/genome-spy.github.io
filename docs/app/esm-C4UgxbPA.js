import { t as e } from "./esm-VvpZ9hsq.js";
import { i as t, r as n } from "./esm-BA6yMcc-.js";
import { r, t as i } from "./browser-kyCRRjQB.js";
...
var b = class extends s {
	...
	async _parse(e = {}) {
		let t = await n(await this.filehandle.readFile(e)), r = new DataView(t.buffer), i;
		...
		let a = 2 ** (this.minShift + this.depth * 3), s = r.getInt32(12, !0), c = s && s >= 30 ? this.parseAuxData(t, 16) : {
			refIdToName: [],
			refNameToId: {},
			metaChar: void 0,
			columnNumbers: {
			...
			for (let a = 0; a < e; a += 1) {
				...
				if (e > this.maxBinNumber) i = this.parsePseudoBin(t, d + 4), d += 48;
				else {
					let i = m(t, d + 4);
					...
					let s = Array(a);
					for (let n = 0; n < a; n += 1) {
						let r = m(t, d), i = m(t, d + 8);
						d += 16, s[n] = new o(r, i, e);
					}
					n[e] = s;
				}
			}
...
var w = class extends s {
	...
	async _parse(e = {}) {
		let t = await n(await this.filehandle.readFile(e)), r = new DataView(t.buffer);
		...
		}, u = r.getInt32(24, !0), d = 2 ** 29, f = u ? String.fromCharCode(u) : void 0, p = r.getInt32(28, !0), h = r.getInt32(32, !0), { refNameToId: g, refIdToName: _ } = this._parseNameBytes(t.slice(36, 36 + h)), v = 36 + h, y;
		return {
			indices: Array(i).fill(0).map(() => {
				...
				for (let a = 0; a < e; a += 1) {
					...
					if (e === 37450) {
						let e = r.getInt32(v, !0);
						v += 4, e === 2 && (i = this.parsePseudoBin(t, v)), v += 16 * e;
					} else {
						let i = r.getInt32(v, !0);
						v += 4;
						let a = Array(i);
						for (let n = 0; n < i; n += 1) {
							let r = m(t, v), i = m(t, v + 8);
							v += 16, y = this._findFirstData(y, r), a[n] = new o(r, i, e);
						}
						n[e] = a;
					}
				}
				...
				v += 4;
				let s = Array(a);
				for (let e = 0; e < a; e += 1) s[e] = m(t, v), v += 8, y = this._findFirstData(y, s[e]);
				return {
					binIndex: n,
					linearIndex: s,
					stats: i
	...
	async getHeaderBuffer(e = {}) {
		let { firstDataLine: t, metaChar: r, maxBlockSize: i } = await this.getMetadata(e), a = (t?.blockPosition || 0) + i, o = await n(await this.filehandle.read(a, 0, e));
		if (r) {
