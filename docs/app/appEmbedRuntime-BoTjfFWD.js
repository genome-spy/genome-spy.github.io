...
import { $ as n, A as r, B as i, C as a, D as o, E as s, F as c, G as l, H as u, I as d, J as f, K as p, M as m, O as h, P as g, Q as _, S as v, T as y, U as b, V as x, W as S, X as C, Y as w, Z as T, _ as E, _t as D, a as O, b as k, c as A, ct as ee, d as j, dt as M, f as te, ft as N, g as P, gt as F, h as ne, i as re, it as ie, j as ae, k as oe, l as se, lt as ce, m as le, mt as I, n as ue, o as de, ot as fe, p as pe, pt as L, q as me, r as he, s as ge, st as _e, u as ve, ut as R, v as ye, w as be, x as xe, y as Se, z as Ce } from "./src-BfnuWIbS.js";
import { A as we, B as Te, C as Ee, D as De, E as Oe, Jt as ke, Kt as Ae, O as je, S as Me, T as Ne, Xt as Pe, Z as Fe, b as Ie, en as Le, f as Re, ht as ze, i as Be, j as Ve, l as He, o as Ue, p as We, rt as Ge, v as Ke, w as qe, y as Je, yt as Ye, z as Xe } from "./clipOptions-taFzEljc.js";
import { D as Ze, T as Qe, b as $e, rt as et, st as tt, tt as nt, v as rt, y as it } from "./vega-scale-D46-iCaL.js";
import { h as at } from "./indexer-qiFctgR3.js";
import { A as ot, E as st, G as ct, I as lt, O as ut, T as dt, W as ft, a as pt, c as mt, f as ht, h as gt, i as _t, m as vt, n as yt, p as bt, r as xt, s as St, t as Ct, v as wt, w as Tt } from "./viewSelectors-D_imtq5Z.js";
import { n as Et, r as Dt } from "./viewIdentityRegistry-CDtVktJD.js";
import { t as Ot } from "./rectangle-DKnrAmKs.js";
import { a as kt, c as At, i as jt, l as Mt, n as Nt, o as Pt, r as Ft, s as It, t as Lt, u as Rt } from "./ref-CDnO4Yza.js";
import { $ as zt, A as Bt, B as Vt, C as Ht, D as Ut, E as Wt, F as Gt, G as Kt, H as qt, I as Jt, J as Yt, K as Xt, L as Zt, M as Qt, N as $t, O as en, P as tn, Q as nn, R as rn, S as an, T as on, U as sn, V as cn, W as ln, X as un, Y as dn, Z as fn, _ as pn, _t as mn, a as hn, at as gn, b as _n, bt as vn, c as yn, ct as bn, d as xn, dt as Sn, et as Cn, f as wn, ft as Tn, g as En, gt as Dn, h as On, ht as kn, i as An, it as jn, j as Mn, k as Nn, l as Pn, lt as Fn, m as In, mt as Ln, n as Rn, nt as zn, o as Bn, ot as Vn, p as Hn, pt as Un, q as Wn, r as Gn, rt as Kn, s as qn, st as Jn, tt as Yn, u as Xn, ut as Zn, v as Qn, vt as $n, w as er, x as tr, xt as nr, y as rr, yt as ir, z as ar } from "./agentApi-BYJcFrZ1.js";
import { r as or, t as sr } from "./performanceProfiler-CPLEjApa.js";
//#region ../../node_modules/d3-array/src/array.js
var cr = Array.prototype, lr = cr.slice;
cr.map;
//#endregion
...
function fr(e) {
	return Math.max(1, Math.ceil(Math.log(ce(e)) / Math.LN2) + 1);
}
//#endregion
...
function pr() {
	...
	function r(r) {
		...
		if (!Array.isArray(f)) {
			let e = d, n = +f;
			if (t === ee && ([u, d] = dr(u, d, n)), f = et(u, d, n), f[0] <= u && (s = nt(u, d, n)), f[f.length - 1] >= d) if (e >= d && t === ee) {
				let e = nt(u, d, n);
		...
		} else for (i = 0; i < a; ++i) (o = c[i]) != null && u <= o && o <= d && g[tt(f, o, 0, p)].push(r[i]);
		return g;
	}
	return r.value = function(t) {
		return arguments.length ? (e = typeof t == "function" ? t : ur(t), r) : e;
	}, r.domain = function(e) {
		return arguments.length ? (t = typeof e == "function" ? e : ur([e[0], e[1]]), r) : t;
	}, r.thresholds = function(e) {
		return arguments.length ? (n = typeof e == "function" ? e : ur(Array.isArray(e) ? lr.call(e) : e), r) : n;
	}, r;
}
//#endregion
...
var yi = () => {}, bi = {}, xi = {}, Si = null, Ci = {
	mark: yi,
	measure: yi
};
try {
	typeof window < "u" && (bi = window), typeof document < "u" && (xi = document), typeof MutationObserver < "u" && (Si = MutationObserver), typeof performance < "u" && (Ci = performance);
} catch {}
var { userAgent: wi = "" } = bi.navigator || {}, Ti = bi, V = xi, Ei = Si, Di = Ci;
Ti.document;
var Oi = !!V.documentElement && !!V.head && typeof V.addEventListener == "function" && typeof V.createElement == "function", ki = ~wi.indexOf("MSIE") || ~wi.indexOf("Trident/"), Ai = /fa(s|r|l|t|d|dr|dl|dt|b|k|kd|ss|sr|sl|st|sds|sdr|sdl|sdt)?[\-\ ]/, ji = /Font ?Awesome ?([56 ]*)(Solid|Regular|Light|Thin|Duotone|Brands|Free|Pro|Sharp Duotone|Sharp|Kit)?.*/i, Mi = {
	classic: {
		fa: "solid",
		fas: "solid",
		"fa-solid": "solid",
	...
	Ji.PRIMARY,
	Ji.SECONDARY
].concat(ia.map((e) => `${e}x`), aa.map((e) => `w-${e}`)), sa = {
	"Font Awesome 5 Free": {
		900: "fas",
		400: "far"
	},
...
}, ca = "___FONT_AWESOME___", la = 16, ua = "fa", da = "svg-inline--fa", fa = "data-fa-i2svg", pa = "data-fa-pseudo-element", ma = "data-fa-pseudo-element-pending", ha = "data-prefix", ga = "data-icon", _a = "fontawesome-i2svg", va = "async", ya = [
	"HTML",
	"HEAD",
	"STYLE",
	"SCRIPT"
...
var Sa = B({}, Mi);
Sa[H] = B(B(B(B({}, { "fa-duotone": "duotone" }), Mi[H]), Hi.kit), Hi["kit-duotone"]);
var Ca = xa(Sa), wa = B({}, Bi);
wa[H] = B(B(B(B({}, { duotone: "fad" }), wa[H]), qi.kit), qi["kit-duotone"]);
var Ta = xa(wa), Ea = B({}, ea);
Ea[H] = B(B({}, Ea[H]), Ki.kit);
var Da = xa(Ea), Oa = B({}, Qi);
Oa[H] = B(B({}, Oa[H]), Wi.kit), xa(Oa);
var ka = Ai, Aa = "fa-layers-text", ja = ji;
xa(B({}, Li));
var Ma = [
	"class",
	"data-prefix",
	...
	"data-fa-transform",
	"data-fa-mask"
], Na = Ni, Pa = [...Ui, ...oa], Fa = Ti.FontAwesomeConfig || {};
function Ia(e) {
...
Object.keys(Ra).forEach((e) => {
	...
	enumerable: !0,
	set: function(e) {
		za.cssPrefix = e, Ba.forEach((e) => e(U));
	},
	get: function() {
		return za.cssPrefix;
	}
}), Ti.FontAwesomeConfig = U;
var Ba = [];
function Va(e) {
	return Ba.push(e), () => {
...
var Ga = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
function Ka() {
	let e = 12, t = "";
	for (; e-- > 0;) t += Ga[Math.random() * 62 | 0];
	return t;
}
function qa(e) {
	let t = [];
...
function Ja(e) {
	return e.classList ? qa(e.classList) : (e.getAttribute("class") || "").split(" ").filter((e) => e);
}
function Ya(e) {
	return `${e}`.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
}
function Xa(e) {
	return Object.keys(e || {}).reduce((t, n) => t + `${n}="${Ya(e[n])}" `, "").trim();
}
function Za(e) {
...
function eo(e) {
	let { transform: t, width: n = la, height: r = la, startCentered: i = !1 } = e, a = "";
	return i && ki ? a += `translate(${t.x / Ha - n / 2}em, ${t.y / Ha - r / 2}em) ` : i ? a += `translate(calc(-50% + ${t.x / Ha}em), calc(-50% + ${t.y / Ha}em)) ` : a += `translate(${t.x / Ha}em, ${t.y / Ha}em) `, a += `scale(${t.size / Ha * (t.flipX ? -1 : 1)}, ${t.size / Ha * (t.flipY ? -1 : 1)}) `, a += `rotate(${t.rotate}deg) `, a;
}
...
function no() {
	let e = ua, t = da, n = U.cssPrefix, r = U.replacementClass, i = to;
	if (n !== e || r !== t) {
...
oo[ca] || (oo[ca] = {}), oo[ca].styles || (oo[ca].styles = {}), oo[ca].hooks || (oo[ca].hooks = {}), oo[ca].shims || (oo[ca].shims = []);
var so = oo[ca], co = [], lo = function() {
	V.removeEventListener("DOMContentLoaded", lo), uo = 1, co.map((e) => e());
}, uo = !1;
Oi && (uo = (V.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(V.readyState), uo || V.addEventListener("DOMContentLoaded", lo));
function fo(e) {
	Oi && (uo ? setTimeout(e, 0) : co.push(e));
}
function po(e) {
	let { tag: t, attributes: n = {}, children: r = [] } = e;
	return typeof e == "string" ? Ya(e) : `<${t} ${Xa(n)}>${r.map(po).join("")}</${t}>`;
}
function mo(e, t, n) {
...
var ho = function(e, t) {
	...
	var i = Object.keys(e), a = i.length, o = r === void 0 ? t : ho(t, r), s, c, l;
...
function xo(e, t) {
	let { skipHooks: n = !1 } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r = bo(t);
	typeof so.hooks.addPack == "function" && !n ? so.hooks.addPack(e, bo(t)) : so.styles[e] = B(B({}, so.styles[e] || {}), r), e === "fas" && xo("fa", t);
}
var { styles: So, shims: Co } = so, wo = Object.keys(Da), To = wo.reduce((e, t) => (e[t] = Object.keys(Da[t]), e), {}), Eo = null, Do = {}, Oo = {}, ko = {}, Ao = {}, jo = {};
function Mo(e) {
	return ~Pa.indexOf(e);
}
function No(e, t) {
	let n = t.split("-"), r = n[0], i = n.slice(1).join("-");
	return r === e && i !== "" && !Mo(i) ? i : null;
}
var Po = () => {
	let e = (e) => go(So, (t, n, r) => (t[r] = go(n, e, {}), t), {});
	Do = e((e, t, n) => (t[3] && (e[t[3]] = n), t[2] && t[2].filter((e) => typeof e == "number").forEach((t) => {
		e[t.toString(16)] = n;
	}), e)), Oo = e((e, t, n) => (e[n] = n, t[2] && t[2].filter((e) => typeof e == "string").forEach((t) => {
		e[t] = n;
	}), e)), jo = e((e, t, n) => {
		let r = t[2];
	...
	let t = "far" in So || U.autoFetchSvg, n = go(Co, (e, n) => {
	...
	ko = n.names, Ao = n.unicodes, Eo = Uo(U.styleDefault, { family: U.familyDefault });
};
Va((e) => {
	Eo = Uo(e.styleDefault, { family: U.familyDefault });
}), Po();
function Fo(e, t) {
	return (Do[e] || {})[t];
}
...
function Ho(e) {
	let t = H, n = wo.reduce((e, t) => (e[t] = `${U.cssPrefix}-${t}`, e), {});
	return Ii.forEach((r) => {
		(e.includes(n[r]) || e.some((e) => To[r].includes(e))) && (t = r);
	}), t;
}
function Uo(e) {
	let { family: t = H } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = Ca[t][e];
	if (t === Fi && !e) return "fad";
	let r = Ta[t][e] || Ta[t][n], i = e in so.styles ? e : null;
	return r || i || null;
}
function Wo(e) {
	let t = [], n = null;
	return e.forEach((e) => {
		let r = No(U.cssPrefix, e);
		r ? n = r : e && t.push(e);
	}), {
		iconName: n,
		rest: t
...
function Ko(e) {
	let { skipLookups: t = !1 } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = null, r = na.concat(Xi), i = Go(e.filter((e) => r.includes(e))), a = Go(e.filter((e) => !na.includes(e))), [o = null] = i.filter((e) => (n = e, !Pi.includes(e))), s = Ho(i), c = B(B({}, Wo(a)), {}, { prefix: Uo(o, { family: s }) });
	return B(B(B({}, c), Xo({
		values: e,
		family: s,
		styles: So,
...
function qo(e, t, n) {
	...
	let a = t === "fa" ? Ro(i) : {}, o = Lo(r, i);
	return i = a.iconName || o || i, r = a.prefix || r, r === "far" && !So.far && So.fas && !U.autoFetchSvg && (r = "fas"), {
		prefix: r,
		iconName: i
	};
}
var Jo = Ii.filter((e) => e !== H || e !== Fi), Yo = Object.keys(ea).filter((e) => e !== H).map((e) => Object.keys(ea[e])).flat();
function Xo(e) {
	let { values: t, family: n, canonical: r, givenPrefix: i = "", styles: a = {}, config: o = {} } = e, s = n === Fi, c = t.includes("fa-duotone") || t.includes("fad"), l = o.familyDefault === "duotone", u = r.prefix === "fad" || r.prefix === "fa-duotone";
	return !s && (c || l || u) && (r.prefix = "fad"), (t.includes("fa-brands") || t.includes("fab")) && (r.prefix = "fab"), !r.prefix && Jo.includes(n) && (Object.keys(a).find((e) => Yo.includes(e)) || o.autoFetchSvg) && (r.prefix = zi.get(n).defaultShortPrefixId, r.iconName = Lo(r.prefix, r.iconName) || r.iconName), (r.prefix === "fa" || i === "fa") && (r.prefix = Bo() || "fas"), r;
}
var Zo = class {
	constructor() {
		this.definitions = {};
	...
	add() {
		...
		Object.keys(e).forEach((t) => {
			this.definitions[t] = B(B({}, this.definitions[t] || {}), e[t]), xo(t, e[t]);
			let n = Da[H][t];
			n && xo(n, e[t]), Po();
		});
	}
...
}, Qo = [], $o = {}, es = {}, ts = Object.keys(es);
function ns(e, t) {
	let { mixoutsTo: n } = t;
	return Qo = e, $o = {}, Object.keys(es).forEach((e) => {
		ts.indexOf(e) === -1 && delete es[e];
	}), Qo.forEach((e) => {
...
function as() {
	...
	return es[e] ? es[e].apply(null, t) : void 0;
}
function os(e) {
	e.prefix === "fa" && (e.prefix = "fas");
	let { iconName: t } = e, n = e.prefix || Bo();
	if (t) return t = Lo(n, t) || t, mo(ss.definitions, n, t) || mo(so.styles, n, t);
}
var ss = new Zo(), cs = {
	noAuto: () => {
		U.autoReplaceSvg = !1, U.observeMutations = !1, is("noAuto");
	},
	config: U,
	dom: {
		i2svg: function() {
			let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
			return Oi ? (is("beforeI2svg", e), as("pseudoElements2svg", e), as("i2svg", e)) : Promise.reject(/* @__PURE__ */ Error("Operation requires a DOM of some kind."));
		},
		watch: function() {
			let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { autoReplaceSvgRoot: t } = e;
			U.autoReplaceSvg === !1 && (U.autoReplaceSvg = !0), U.observeMutations = !0, fo(() => {
				ls({ autoReplaceSvgRoot: t }), is("watch", e);
			});
		}
	},
	parse: { icon: (e) => {
		...
		if (typeof e == "object" && e.prefix && e.iconName) return {
			prefix: e.prefix,
			iconName: Lo(e.prefix, e.iconName) || e.iconName
		};
		if (Array.isArray(e) && e.length === 2) {
			let t = e[1].indexOf("fa-") === 0 ? e[1].slice(3) : e[1], n = Uo(e[0]);
			return {
				prefix: n,
				iconName: Lo(n, t) || t
			};
		}
		if (typeof e == "string" && (e.indexOf(`${U.cssPrefix}-`) > -1 || e.match(ka))) {
			let t = Ko(e.split(" "), { skipLookups: !0 });
			return {
				prefix: t.prefix || Bo(),
				iconName: Lo(t.prefix, t.iconName) || t.iconName
			};
		}
		if (typeof e == "string") {
			let t = Bo();
	...
	(Object.keys(so.styles).length > 0 || U.autoFetchSvg) && Oi && U.autoReplaceSvg && cs.dom.i2svg({ node: e });
};
function us(e, t) {
	return Object.defineProperty(e, "abstract", { get: t }), Object.defineProperty(e, "html", { get: function() {
		return e.abstract.map((e) => po(e));
...
function ds(e) {
	...
	if (Qa(o) && n.found && !r.found) {
		...
		i.style = Za(B(B({}, a), {}, { "transform-origin": `${r.x + o.x / 16}em ${r.y + o.y / 16}em` }));
	}
	return [{
		tag: "svg",
		attributes: i,
...
function ps(e) {
	let { icons: { main: t, mask: n }, prefix: r, iconName: i, transform: a, symbol: o, title: s, maskId: c, titleId: l, extra: u, watchable: d = !1 } = e, { width: f, height: p } = n.found ? n : t, m = Gi.includes(r), h = [U.replacementClass, i ? `${U.cssPrefix}-${i}` : ""].filter((e) => u.classes.indexOf(e) === -1).filter((e) => e !== "" || !!e).concat(u.classes).join(" "), g = {
		children: [],
	...
	d && (g.attributes[fa] = ""), s && (g.children.push({
		tag: "title",
		attributes: { id: g.attributes["aria-labelledby"] || `title-${l || Ka()}` },
		children: [s]
	...
	}), { children: y, attributes: b } = n.found && t.found ? as("generateAbstractMask", v) || {
		children: [],
		attributes: {}
	} : as("generateAbstractIcon", v) || {
		children: [],
		attributes: {}
	};
	return v.children = y, v.attributes = b, o ? fs(v) : ds(v);
}
function ms(e) {
...
function hs(e) {
	let { content: t, title: n, extra: r } = e, i = B(B(B({}, r.attributes), n ? { title: n } : {}), {}, { class: r.classes.join(" ") }), a = Za(r.styles);
...
function _s(e) {
	...
	return i = Array.isArray(r) ? {
		tag: "g",
		attributes: { class: `${U.cssPrefix}-${Na.GROUP}` },
		children: [{
			tag: "path",
			attributes: {
				class: `${U.cssPrefix}-${Na.SECONDARY}`,
				fill: "currentColor",
				d: r[0]
			}
		}, {
...
function ys(e, t) {
	!ba && !U.showMissingIcons && e && console.error(`Icon with name "${e}" and prefix "${t}" is missing.`);
}
function bs(e, t) {
	let n = t;
	return t === "fa" && U.styleDefault !== null && (t = Bo()), new Promise((r, i) => {
		if (n === "fa") {
			let n = Ro(e) || {};
		...
		ys(e, t), r(B(B({}, vs), {}, { icon: U.showMissingIcons && e && as("missingIconAbstract") || {} }));
	});
}
var xs = () => {}, Ss = U.measurePerformance && Di && Di.mark && Di.measure ? Di : {
	mark: xs,
	measure: xs
}, Cs = "FA \"6.7.2\"", ws = (e) => (Ss.mark(`${Cs} ${e} begins`), () => Ts(e)), Ts = (e) => {
	Ss.mark(`${Cs} ${e} ends`), Ss.measure(`${Cs} ${e}`, `${Cs} ${e} begins`, `${Cs} ${e} ends`);
}, Es = {
	begin: ws,
	end: Ts
}, Ds = () => {};
function Os(e) {
	return typeof (e.getAttribute ? e.getAttribute(fa) : null) == "string";
}
function ks(e) {
	let t = e.getAttribute ? e.getAttribute(ha) : null, n = e.getAttribute ? e.getAttribute(ga) : null;
	return t && n;
}
function As(e) {
...
function js() {
	return U.autoReplaceSvg === !0 ? Is.replace : Is[U.autoReplaceSvg] || Is.replace;
}
function Ms(e) {
...
function Ps(e) {
	let { ceFn: t = e.tag === "svg" ? Ms : Ns } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
var Is = {
	replace: function(e) {
		...
		if (t.parentNode) if (e[1].forEach((e) => {
			t.parentNode.insertBefore(Ps(e), t);
		}), t.getAttribute(fa) === null && U.keepOriginalSource) {
			let e = V.createComment(Fs(t));
			t.parentNode.replaceChild(e, t);
		} else t.remove();
	},
	nest: function(e) {
		let t = e[0], n = e[1];
		if (~Ja(t).indexOf(U.replacementClass)) return Is.replace(e);
		...
		let i = n.map((e) => po(e)).join("\n");
		t.setAttribute(fa, ""), t.innerHTML = i;
	}
};
function Ls(e) {
	e();
...
function Rs(e, t) {
	let n = typeof t == "function" ? t : Ds;
	if (e.length === 0) n();
	else {
		let t = Ls;
		U.mutateApproach === va && (t = Ti.requestAnimationFrame || Ls), t(() => {
			let t = js(), r = Es.begin("mutate");
			e.map(t), r(), n();
		});
	}
}
...
var Hs = null;
function Us(e) {
	if (!Ei || !U.observeMutations) return;
	let { treeCallback: t = Ds, nodeCallback: n = Ds, pseudoElementsCallback: r = Ds, observeMutationsRoot: i = V } = e;
	Hs = new Ei((e) => {
		if (zs) return;
		let i = Bo();
		qa(e).forEach((e) => {
			if (e.type === "childList" && e.addedNodes.length > 0 && !Os(e.addedNodes[0]) && (U.searchPseudoElements && r(e.target), t(e.target)), e.type === "attributes" && e.target.parentNode && U.searchPseudoElements && r(e.target.parentNode), e.type === "attributes" && Os(e.target) && ~Ma.indexOf(e.attributeName)) if (e.attributeName === "class" && ks(e.target)) {
				let { prefix: t, iconName: n } = Ko(Ja(e.target));
				e.target.setAttribute(ha, t || i), n && e.target.setAttribute(ga, n);
			} else As(e.target) && n(e.target);
		});
	}), Oi && Hs.observe(i, {
		childList: !0,
		attributes: !0,
...
function Ks(e) {
	let t = e.getAttribute("data-prefix"), n = e.getAttribute("data-icon"), r = e.innerText === void 0 ? "" : e.innerText.trim(), i = Ko(Ja(e));
	return i.prefix ||= Bo(), t && n && (i.prefix = t, i.iconName = n), i.iconName && i.prefix ? i : (i.prefix && r.length > 0 && (i.iconName = Io(i.prefix, e.innerText) || Fo(i.prefix, vo(e.innerText))), !i.iconName && U.autoFetchSvg && e.firstChild && e.firstChild.nodeType === Node.TEXT_NODE && (i.iconName = e.firstChild.data), i);
}
function qs(e) {
	let t = qa(e.attributes).reduce((e, t) => (e.name !== "class" && e.name !== "style" && (e[t.name] = t.value), e), {}), n = e.getAttribute("title"), r = e.getAttribute("data-fa-title-id");
	return U.autoA11y && (n ? t["aria-labelledby"] = `${U.replacementClass}-title-${r || Ka()}` : (t["aria-hidden"] = "true", t.focusable = "false")), t;
}
function Js() {
	return {
		iconName: null,
...
function Ys(e) {
	let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { styleParser: !0 }, { iconName: n, prefix: r, rest: i } = Ks(e), a = qs(e), o = rs("parseNodeAttributes", {}, e), s = t.styleParser ? Gs(e) : [];
	return B({
		iconName: n,
...
var { styles: Xs } = so;
function Zs(e) {
	let t = U.autoReplaceSvg === "nest" ? Ys(e, { styleParser: !1 }) : Ys(e);
	return ~t.extra.classes.indexOf(Aa) ? as("generateLayersText", e, t) : as("generateSvgReplacementMutation", e, t);
}
function Qs() {
	return [...Vi, ...na];
}
function $s(e) {
	...
	if (!Oi) return Promise.resolve();
	let n = V.documentElement.classList, r = (e) => n.add(`${_a}-${e}`), i = (e) => n.remove(`${_a}-${e}`), a = U.autoFetchSvg ? Qs() : Pi.concat(Object.keys(Xs));
	a.includes("fa") || a.push("fa");
	let o = [`.${Aa}:not([${fa}])`].concat(a.map((e) => `.${e}:not([${fa}])`)).join(", ");
	if (o.length === 0) return Promise.resolve();
	let s = [];
	try {
		s = qa(e.querySelectorAll(o));
	} catch {}
	if (s.length > 0) r("pending"), i("complete");
	else return Promise.resolve();
	let c = Es.begin("onTree"), l = s.reduce((e, t) => {
		try {
			let n = Zs(t);
			n && e.push(n);
		} catch (e) {
			ba || e.name === "MissingIcon" && console.error(e);
		}
		return e;
	}, []);
...
function tc(e) {
	return function(t) {
		let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r = (t || {}).icon ? t : os(t || {}), { mask: i } = n;
		return i &&= (i || {}).icon ? i : os(i || {}), e(r, B(B({}, n), {}, { mask: i }));
	};
}
var nc = function(e) {
	let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, { transform: n = Ua, symbol: r = !1, mask: i = null, maskId: a = null, title: o = null, titleId: s = null, classes: c = [], attributes: l = {}, styles: u = {} } = t;
	if (!e) return;
	let { prefix: d, iconName: f, icon: p } = e;
	return us(B({ type: "icon" }, e), () => (is("beforeDOMElementCreation", {
		iconDefinition: e,
		params: t
	}), U.autoA11y && (o ? l["aria-labelledby"] = `${U.replacementClass}-title-${s || Ka()}` : (l["aria-hidden"] = "true", l.focusable = "false")), ps({
		icons: {
			main: _s(p),
			mask: i ? _s(i.icon) : {
				found: !1,
	...
	hooks() {
		return { mutationObserverCallbacks(e) {
			return e.treeCallback = $s, e.nodeCallback = ec, e;
		} };
	},
	provides(e) {
		e.i2svg = function(e) {
			...
			return new Promise((t, d) => {
				Promise.all([bs(n, a), c.iconName ? bs(c.iconName, c.prefix) : Promise.resolve({
					found: !1,
					width: 512,
					height: 512,
					icon: {}
			...
			let { children: t, attributes: n, main: r, transform: i, styles: a } = e, o = Za(a);
			o.length > 0 && (n.style = o);
			let s;
			return Qa(i) && (s = as("generateAbstractTransformGrouping", {
				main: r,
				transform: i,
	...
	return { layer(e) {
		...
		return us({ type: "layer" }, () => {
			is("beforeDOMElementCreation", {
				assembler: e,
				params: t
			});
			let r = [];
	...
	mixout() {
		return { text(e) {
			let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, { transform: n = Ua, title: r = null, classes: i = [], attributes: a = {}, styles: o = {} } = t;
			return us({
				type: "text",
				content: e
			}, () => (is("beforeDOMElementCreation", {
	...
	provides(e) {
		e.generateLayersText = function(e, t) {
			...
			return U.autoA11y && !n && (i.attributes["aria-hidden"] = "true"), Promise.resolve([e, ms({
				content: e.innerHTML,
				width: a,
				height: o,
				transform: r,
...
}, sc = /* @__PURE__ */ RegExp("\"", "ug"), cc = [1105920, 1112319], lc = B(B(B(B({}, { FontAwesome: {
	normal: "fas",
	400: "fas"
} }), Ri), sa), Zi), uc = Object.keys(lc).reduce((e, t) => (e[t.toLowerCase()] = lc[t], e), {}), dc = Object.keys(uc).reduce((e, t) => {
	let n = uc[t];
	return e[t] = n[900] || [...Object.entries(n)][0][1], e;
}, {});
function fc(e) {
	let t = e.replace(sc, ""), n = yo(t, 0), r = n >= cc[0] && n <= cc[1], i = t.length === 2 && t[0] === t[1];
	return {
		value: vo(i ? t[0] : t),
		isSecondary: r || i
	};
...
function mc(e, t) {
	...
	return new Promise((r, i) => {
		...
		let a = qa(e.children).filter((e) => e.getAttribute(pa) === t)[0], o = Ti.getComputedStyle(e, t), s = o.getPropertyValue("font-family"), c = s.match(ja), l = o.getPropertyValue("font-weight"), u = o.getPropertyValue("content");
		if (a && !c) return e.removeChild(a), r();
		if (c && u !== "none" && u !== "") {
			let u = o.getPropertyValue("content"), d = pc(s, l), { value: f, isSecondary: p } = fc(u), m = c[0].startsWith("FontAwesome"), h = Fo(d, f), g = h;
			if (m) {
				let e = zo(f);
				e.iconName && e.prefix && (h = e.iconName, d = e.prefix);
			}
			if (h && !p && (!a || a.getAttribute(ha) !== d || a.getAttribute(ga) !== g)) {
				e.setAttribute(n, g), a && e.removeChild(a);
				let o = Js(), { extra: s } = o;
				s.attributes[pa] = t, bs(h, d).then((i) => {
					let a = ps(B(B({}, o), {}, {
						icons: {
							main: i,
							mask: Vo()
					...
					t === "::before" ? e.insertBefore(c, e.firstChild) : e.appendChild(c), c.outerHTML = a.map((e) => po(e)).join("\n"), e.removeAttribute(n), r();
				}).catch(i);
			} else r();
		} else r();
	});
...
function gc(e) {
	return e.parentNode !== document.head && !~ya.indexOf(e.tagName.toUpperCase()) && !e.getAttribute(pa) && (!e.parentNode || e.parentNode.tagName !== "svg");
}
function _c(e) {
	if (Oi) return new Promise((t, n) => {
		let r = qa(e.querySelectorAll("*")).filter(gc).map(hc), i = Es.begin("searchPseudoElements");
		Bs(), Promise.all(r).then(() => {
			i(), Vs(), t();
		}).catch(() => {
			i(), Vs(), n();
		});
...
var vc = {
	hooks() {
		return { mutationObserverCallbacks(e) {
			return e.pseudoElementsCallback = _c, e;
		} };
	},
	provides(e) {
		e.pseudoElements2svg = function(e) {
			let { node: t = V } = e;
			U.searchPseudoElements && _c(t);
		};
	}
}, yc = !1, bc = {
	mixout() {
	...
	hooks() {
		return {
			bootstrap() {
				Us(rs("mutationObserverCallbacks", {}));
			},
			noAuto() {
				Ws();
			},
			watch(e) {
				...
				yc ? Vs() : Us(rs("mutationObserverCallbacks", { observeMutationsRoot: t }));
			}
		};
	}
}, xc = (e) => e.toLowerCase().split(" ").reduce((e, t) => {
...
ns([
	...
	Sc,
	{
		hooks() {
			return { parseNodeAttributes(e, t) {
				let n = t.getAttribute("data-fa-mask"), r = n ? Ko(n.split(" ").map((e) => e.trim())) : Vo();
				return r.prefix ||= Bo(), e.mask = r, e.maskId = t.getAttribute("data-fa-mask-id"), e;
			} };
		},
		provides(e) {
			e.generateAbstractMask = function(e) {
				let { children: t, attributes: n, main: r, mask: i, maskId: a, transform: o } = e, { width: s, icon: c } = r, { width: l, icon: u } = i, d = $a({
					transform: o,
					containerWidth: l,
					iconWidth: s
				}), f = {
					tag: "rect",
					attributes: B(B({}, Cc), {}, { fill: "white" })
				}, p = c.children ? { children: c.children.map(wc) } : {}, m = {
					tag: "g",
	...
	{ provides(e) {
		let t = !1;
		Ti.matchMedia && (t = Ti.matchMedia("(prefers-reduced-motion: reduce)").matches), e.missingIconAbstract = function() {
...
], { mixoutsTo: cs }), cs.noAuto, cs.config, cs.library;
var Ec = cs.dom;
cs.parse, cs.findIconDefinition, cs.toHtml;
var W = cs.icon;
cs.layer, cs.text, cs.counter;
//#endregion
//#region ../app/src/components/generic/componentStyles.js
var Dc = D(Ec.css()), Oc = F`
    :host {
...
`, kc = /* @__PURE__ */ new Set([
	...
	renderHeader() {
		return I`${this.dialogTitle ? I`${this.dialogTitle}` : M}`;
	}
	renderBody() {
		return I``;
	}
	...
	render() {
		...
		return I`
            ${this.modal ? M : I`<div class="non-modal-backdrop"></div>`}
            <dialog
                @cancel=${(e) => this.#a(e)}
            >
                ${e ? I`<header>${e}</header>` : M}
                <section>${this.renderBody()}</section>
                ${t ? I`<footer>${t}</footer>` : M}
            </dialog>
        `;
	}
};
function K(e, t) {
	return Mc(e, t).promise;
}
function Ac(e, t, n) {
	return K(e, t).then(n);
}
function jc(e, t) {
	return Ac(e, t, (e) => !!e.ok);
}
function Mc(e, t) {
	...
	renderBody() {
		if (this.type) {
			...
			return I`<div class="message-flex">
                ${e ? I`<div class="icon">${W(e).node[0]}</div>` : M}
                <div class="message">${this.message}</div>
            </div>`;
		} else return I`${this.message}`;
	}
};
customElements.define("gs-message-dialog", Pc);
function q(e, t = {}) {
	return jc("gs-message-dialog", (n) => {
...
var Fc = (e, t, n) => {
	...
	update(e, [t, n, r]) {
		...
		else if (l === void 0 && (l = Fc(o, p, m), u = Fc(s, d, f)), l.has(s[d])) if (l.has(s[f])) {
...
`, Rc = class extends G {
	...
	connectedCallback() {
		...
		this.logicalWidth = zc(e), this.logicalHeight = zc(t);
	}
	willUpdate(e) {
		if ([
			"logicalWidth",
	...
	renderBody() {
		return I`
			...
			this.transparentBackground = e.checked;
                        ...
                        Transparent</label
                    >
                    ${this.transparentBackground ? M : I`<input
                                  type="color"
                                  id="pngBackground"
	...
	async #e() {
		...
		try {
			...
			return t.href = await Vc(e), t.download = "genomespy-visualization.png", document.body.appendChild(t), t.click(), t.remove(), this.finish({ ok: !0 }), !1;
		} catch (e) {
			return await q(`PNG export failed: ${e instanceof Error ? e.message : String(e)}`, {
				title: "PNG export",
				type: "error"
			}), !0;
		} finally {
...
customElements.define("gs-save-image-dialog", Rc);
function zc(e) {
...
var Uc = class extends R {
	...
	constructor() {
		super(), this.items = [], this.selectedValues = [], this.placeholder = "Type something to filter the list", this.selectedItemName = "items", this.itemMarker = () => M, this.search = "";
	}
	getFilteredItems() {
	...
	#t(e) {
		...
		t.checked ? n.add(r.value) : n.delete(r.value), this.selectedValues = this.items.map((e) => e.value).filter((e) => n.has(e)), this.dispatchEvent(new Wc(this.selectedValues));
	}
	#n(e) {
		if (e.key == "ArrowDown") this.renderRoot.querySelector(".checkbox-list li:first-child input[type='checkbox']")?.focus(), e.preventDefault(), e.stopPropagation();
			...
			if (t.length == 1) {
				...
				e.add(t[0].value), this.selectedValues = this.items.map((e) => e.value).filter((t) => e.has(t)), this.dispatchEvent(new Wc(this.selectedValues));
			}
			e.stopPropagation();
		}
	}
            ...
            <div class="checkbox-list-wrapper">
                ...
                ${t.length == 0 ? I`<div class="search-note">
                          <div>Nothing found</div>
                            ...
                            <div>
                                ${W(ri).node[0]} Hit enter to select
                                the exact match
                            </div>
                        </div>` : M}
            </div>
...
customElements.define("gs-searchable-checkbox-list", Uc);
var Wc = class extends Event {
	values;
	constructor(e) {
		super("change", {
			bubbles: !0,
	...
	static styles = [Oc, F`
        ...
        `];
	constructor() {
		super(), this.value = "lt", this.options = Gc;
	}
	#e(e) {
		this.value = e, this.dispatchEvent(new qc(e));
	}
	render() {
...
customElements.define("gs-comparison-operator-buttons", Kc);
...
`, Xc = class extends R {
	...
	#r = 0;
	constructor() {
		super(), this.values = [], this.thresholds = [], this.operators = [], this.colors = tl, this.showThresholdNumbers = !1, this.binCount = 40, this.#e = pr().thresholds(this.binCount), this.#t = this.#e([]), this.#n = Ze();
	}
	willUpdate(e) {
		e.has("binCount") && (this.#e = pr().thresholds(this.binCount)), (e.has("values") || e.has("binCount")) && (this.#t = this.#e(this.values), this.#n = Ze().domain(this.domain).range([0, 100]));
	}
	get domain() {
	...
	#o(e, t, n) {
		n = Xe(n, 0, 1), this.dispatchEvent(new Zc(e, t, +this.#n.invert(n * 100).toPrecision(3)));
	}
	#s() {
		...
		for (let c = 0; c < e.length; c++) {
			...
			if (i) for (let e = 0; e <= 1; e++) {
				let t = el(l, this.thresholds[0], e > 0);
				t && r.push({
					x: u,
					y: d * n,
					height: t * n,
				...
				let t = s(e), i = $c(l, a[t], a[t + 1], !o[t], o[t + 1]);
				i && r.push({
					x: u,
					y: d * n,
					height: i * n,
		...
		return I`<div class="histogram-widget">
			...
			return r >= 0 && r <= 100 ? I`<div
                              ...
                              >
                                  ...
                                  >
                                      ${this.showThresholdNumbers ? n + 1 : M}
                                  </div>
                              </div>` : M;
		})}
                </div>
...
customElements.define("gs-histogram", Xc);
var Zc = class extends Event {
	constructor(e, t, n) {
...
var al = class extends R {
	...
	get #e() {
		return this.values.filter(sl);
	}
	#t(e) {
		e.stopPropagation(), this.operator = e.value, this.#a();
	}
	#n(e) {
		let t = e.target.value, n = nl(t);
		(n !== void 0 || t.trim() === "") && (this.operand = n, this.#a());
	}
	#r(e) {
		let t = il(this.operand, e.value);
	...
	#a() {
		this.dispatchEvent(new ol(this.operator, this.operand));
	}
	focus(e) {
		...
		return I`
            <div class="gs-form-group">
                ...
                <input
                    type="number"
                    placeholder=${this.placeholder}
                    .value=${sl(this.operand) ? String(this.operand) : ""}
                    @input=${(e) => this.#n(e)}
                />
            </div>
        `;
...
customElements.define("gs-threshold-comparison-input", al);
var ol = class extends Event {
	operator;
	operand;
	constructor(e, t) {
		super("change", {
...
var cl = class extends G {
	...
	constructor() {
		super(), this.categories = [], this.attributeInfo = null, this.sampleView = null, this.categoryToMarker = () => M, this.selection = [];
	}
	willUpdate(e) {
	...
	renderButtons() {
		return [
			...
			this.makeButton("Remove", () => this.#e(!0), { iconDef: br }),
...
customElements.define("gs-discrete-attribute-filter-dialog", cl);
var ll = class extends G {
	static properties = {
		...super.properties,
		attributeInfo: {},
		sampleView: {},
...
customElements.define("gs-quantitative-attribute-filter-dialog", ll);
function ul(e, t) {
	let n = e.scale?.type;
	it(n) ? fl(e, t) : rt(n) || $e(n) ? ml(e, t) : e.type === "identifier" ? dl(e, t) : q("Not implemented (yet).");
}
function dl(e, t) {
	pl(t.getSamples().map((e) => e.id), e, t);
}
function fl(e, t) {
	let n = e.scale;
	pl(n.domain(), e, t, (e) => I`<span
            class="color"
            style=${f({ backgroundColor: n(e).toString() })}
        ></span>`);
}
function pl(e, t, n, r = (e) => M) {
                    ...
                    ${r.map((e) => I`
                            <tr>
                                <td>
                                    <span
                                        class="group-color"
                                        style="background-color: ${tl[e.index]}"
                                    ></span>
                                    ${e.name}
                                </td>
                                <td>${e.interval}</td>
...
customElements.define("gs-group-by-thresholds-dialog", hl);
function gl(e, t) {
...
customElements.define("gs-retain-first-n-categories-dialog", _l);
function vl(e, t) {
...
var yl = class extends G {
	...
	#r() {
		return this.conditionAttributeInfo?.type === "quantitative" ? !sl(this.operand) : this.values.length === 0;
	}
	#i() {
		let e;
		if (this.conditionAttributeInfo.type === "quantitative") {
			if (!sl(this.operand)) throw Error("Quantitative category condition is missing a value.");
			e = {
	...
	#a() {
		return xl(this.conditionAttributeInfo, this.sampleView).map((e) => ({
			value: e,
			label: `${e}`,
			searchText: `${e}`.toLowerCase()
		}));
	...
	#o() {
		...
		return e ? (t) => I`<span
                class="color"
                style=${f({ backgroundColor: e(t).toString() })}
            ></span>` : () => M;
	}
};
customElements.define("gs-retain-categories-by-attribute-dialog", yl);
function bl(e, t, n) {
...
function xl(e, t) {
	...
	return Array.isArray(n) ? n.filter((n) => Sl(e, t).has(n)) : Array.from(Sl(e, t));
}
function Sl(e, t) {
...
var Al = {
	...
	addMetadataFromSource: ({ template: e, payload: t }) => {
		let n = Array.isArray(t.columnIds) ? t.columnIds : [], r = t.sourceId ? I` from <strong>${t.sourceId}</strong> source` : "", i = n.length === 1 ? "attribute" : "attributes", a = n.length > 0 && n.length <= 3 ? kl(n) : I`<strong>${n.length}</strong> ${i}`;
		return {
			...e,
	...
	filterByNominal: ({ payload: e, template: t, attributeName: n, attributeTitle: r }) => {
		let i = e.values, a = (t) => I`
            ...
            ${i[0] === void 0 || i[0] === null ? I` undefined ${t} ` : I`${t}
                  ${i.length > 1 ? I`in ${Ol(i)}` : I`<span class="operator">=</span>
                            <strong>${i[0]}</strong>`} `}
        `;
		return {
			...t,
	...
	groupCustomCategories: ({ payload: e, template: t, attributeTitle: n }) => {
        ...
        ${n}.
        ${Cl(Object.entries(r), ([e, t], n) => I`${n > 0 ? ", " : ""}<strong>${e}</strong> =
                    ${Ol(t)}`)}`;
		return {
			...t,
	...
	groupByThresholds: ({ payload: e, template: t, attributeTitle: n }) => ({
		...
		provenanceTitle: I`
            Group by thresholds
            ${Ol(e.thresholds.map((e) => `${Dl[e.operator]} ${e.operand}`))}
            ${e.groupTitles ? I` as
                      ${Ol(e.groupTitles)}` : ""}
            on ${n}
        `,
	...
	removeGroup: ({ payload: e }) => ({
		...
		provenanceTitle: I`
            Remove group
            ${wl(e.path.map((e) => I`<strong>${e}</strong>`), " / ")}
        `,
		icon: br
	}),
...
function jl(e) {
	return e.operator === "in" ? I`in ${Ol(e.values)}` : I`
            <span class="operator">${Dl[e.operator]}</span>
            <strong>${El(e.operand)}</strong>
        `;
}
function Ml(e, t) {
	...
	let n = e.payload && typeof e.payload == "object" ? e.payload : {}, r = (e) => {
		if (!e) return {};
		try {
			let n = t(e), r = e && typeof e == "object" && "specifier" in e && typeof e.specifier == "string" ? I` <em>${e.specifier}</em> ` : void 0, i = n ? Tl(n) : r;
			return {
				attributeInfo: n,
				attributeName: i,
	...
	}, { attributeName: i, attributeTitle: a } = r("attribute" in n && n.attribute ? n.attribute : null), { attributeName: o, attributeTitle: s } = r("condition" in n && n.condition && typeof n.condition == "object" && "attribute" in n.condition ? n.condition.attribute : null), c = { attributeName: i }, l = e.type.substring(pn.length + 1), u = Al[l];
	return u ? u({
		payload: n,
		template: c,
		attributeName: i,
...
`, Pl = class extends G {
	...
	#n(e, t = "", n = "") {
		let r = I` <p>
            ...
            <div class="gs-form-group">
                ...
                <label for="paste-group-categories">${Ll(e)}</label>
                <textarea
			...
			if (i.size > 0) return await q(I`The following ${e} were not found:
                    ${Ol(i, !1)}`, {
				title: "There's a problem",
				type: "warning"
			}), !0;
	...
	renderBody() {
		let e = this.attributeInfo, t = e.type == "identifier" ? "Identifier" : "Category", n = e.scale, r = n ? (e) => I`<span
                      class="color"
                      style=${f({ backgroundColor: n(e)?.toString() ?? "inherit" })}
                  ></span>` : () => M, i = un((e) => e, this.groups), a = Object.keys(this.groups);
		return I`
            <div class="gs-alert info">
                ${W(Wr).node[0]}
                <span>
	...
	renderButtons() {
		...
		return [
			this.makeButton("Paste " + e, () => (this.#n(e), !0), { iconDef: Cr }),
			this.makeButton("Cancel", () => this.finish({ ok: !1 })),
...
customElements.define("gs-create-custom-groups-dialog", Pl);
function Fl(e, t) {
	return K("gs-create-custom-groups-dialog", (n) => {
		n.attributeInfo = e, n.sampleView = t, n.values = Il(e, t.leafSamples, t.sampleHierarchy), n.groups = {};
	});
}
function Il(e, t, n) {
...
var Rl = Math.min, zl = Math.max, Bl = Math.round, Vl = Math.floor, Hl = (e) => ({
	x: e,
	y: e
}), Ul = {
	left: "right",
...
function Zl(e, t, n) {
	n === void 0 && (n = !1);
	let r = Kl(e), i = Xl(e), a = Jl(i), o = i === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
	return t.reference[a] > t.floating[a] && (o = ou(o)), [o, ou(o)];
}
function Ql(e) {
	let t = ou(e);
	return [
...
var eu = ["left", "right"], tu = ["right", "left"], nu = ["top", "bottom"], ru = ["bottom", "top"];
function iu(e, t, n) {
	switch (e) {
		case "top":
		case "bottom": return n ? t ? tu : eu : t ? eu : tu;
		case "left":
		case "right": return t ? nu : ru;
		default: return [];
	}
}
function au(e, t, n, r) {
	let i = Kl(e), a = iu(Gl(e), n === "start", r);
	return i && (a = a.map((e) => e + "-" + i), t && (a = a.concat(a.map($l)))), a;
}
function ou(e) {
	let t = Gl(e);
...
function uu(e, t, n) {
	let { reference: r, floating: i } = e, a = Yl(t), o = Xl(t), s = Jl(o), c = Gl(t), l = a === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[s] / 2 - i[s] / 2, p;
	switch (c) {
		case "top":
			p = {
				x: u,
...
async function du(e, t) {
	t === void 0 && (t = {});
	let { x: n, y: r, platform: i, rects: a, elements: o, strategy: s } = e, { boundary: c = "clippingAncestors", rootBoundary: l = "viewport", elementContext: u = "floating", altBoundary: d = !1, padding: f = 0 } = Wl(t, e), p = cu(f), m = o[d ? u === "floating" ? "reference" : "floating" : u], h = lu(await i.getClippingRect({
		...
		x: 1,
		y: 1
	}, y = lu(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
		elements: o,
		rect: g,
		offsetParent: _,
		strategy: s
...
var fu = 50, pu = async (e, t, n) => {
	...
	for (let n = 0; n < a.length; n++) {
		...
		u = v ?? u, d = y ?? d, m[g] = {
			...m[g],
			...b
		}, x && p < fu && (p++, typeof x == "object" && (x.placement && (f = x.placement), x.rects && (l = x.rects === !0 ? await o.getElementRects({
			reference: e,
			floating: t,
			strategy: i
		}) : x.rects), {x: u, y: d} = uu(l, f, c)), n = -1);
	}
	return {
		x: u,
		y: d,
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var n;
			let { placement: r, middlewareData: i, rects: a, initialPlacement: o, platform: s, elements: c } = t, { mainAxis: l = !0, crossAxis: u = !0, fallbackPlacements: d, fallbackStrategy: f = "bestFit", fallbackAxisSideDirection: p = "none", flipAlignment: m = !0, ...h } = Wl(e, t);
			if ((n = i.arrow) != null && n.alignmentOffset) return {};
			let g = Gl(r), _ = Yl(o), v = Gl(o) === o, y = await (s.isRTL == null ? void 0 : s.isRTL(c.floating)), b = d || (v || !m ? [ou(o)] : Ql(o)), x = p !== "none";
			!d && x && b.push(...au(o, m, p, y));
			...
			if (T = [...T, {
				...
				if (t && (!(u === "alignment" && _ !== Yl(t)) || T.every((e) => Yl(e.placement) !== _ || e.overflows[0] > 0))) return {
					data: {
						index: e,
						overflows: T
					},
...
async function gu(e, t) {
	let { placement: n, platform: r, elements: i } = e, a = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), o = Gl(n), s = Kl(n), c = Yl(n) === "y", l = hu.has(o) ? -1 : 1, u = a && c ? -1 : 1, d = Wl(t, e), { mainAxis: f, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
...
var _u = function(e) {
	return e === void 0 && (e = 0), {
		...
		async fn(t) {
			var n;
			let { x: r, y: i, placement: a, middlewareData: o } = t, s = await gu(t, e);
...
function Su(e) {
	return vu() ? e instanceof Node || e instanceof bu(e).Node : !1;
}
function Cu(e) {
	return vu() ? e instanceof Element || e instanceof bu(e).Element : !1;
}
function wu(e) {
	return vu() ? e instanceof HTMLElement || e instanceof bu(e).HTMLElement : !1;
}
function Tu(e) {
	return !vu() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof bu(e).ShadowRoot;
}
function Eu(e) {
...
function Iu(e) {
	return /^(html|body|#document)$/.test(yu(e));
}
function Lu(e) {
...
function Vu(e, t, n) {
	...
	let r = Bu(e), i = r === e.ownerDocument?.body, a = bu(r);
	if (i) {
		let e = Hu(a);
...
function Uu(e) {
	let t = Lu(e), n = parseFloat(t.width) || 0, r = parseFloat(t.height) || 0, i = wu(e), a = i ? e.offsetWidth : n, o = i ? e.offsetHeight : r, s = Bl(n) !== a || Bl(r) !== o;
	return s && (n = a, r = o), {
		width: n,
		height: r,
		$: s
...
function Gu(e) {
	let t = Wu(e);
	if (!wu(t)) return Hl(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = Uu(t), o = (a ? Bl(n.width) : n.width) / r, s = (a ? Bl(n.height) : n.height) / i;
	return (!o || !Number.isFinite(o)) && (o = 1), (!s || !Number.isFinite(s)) && (s = 1), {
		x: o,
		y: s
	};
}
var Ku = /*#__PURE__*/ Hl(0);
function qu(e) {
	let t = bu(e);
...
function Ju(e, t, n) {
	return t === void 0 && (t = !1), !n || t && n !== bu(e) ? !1 : t;
}
function Yu(e, t, n, r) {
	t === void 0 && (t = !1), n === void 0 && (n = !1);
	let i = e.getBoundingClientRect(), a = Wu(e), o = Hl(1);
	t && (r ? Cu(r) && (o = Gu(r)) : o = Gu(e));
	let s = Ju(a, n, r) ? qu(a) : Hl(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a) {
		let e = bu(a), t = r && Cu(r) ? bu(r) : r, n = e, i = Hu(n);
		for (; i && r && t !== n;) {
			...
			c *= e.x, l *= e.y, u *= e.x, d *= e.y, c += a, l += o, n = bu(i), i = Hu(n);
		}
	}
	return lu({
		width: u,
...
function Qu(e) {
	...
	let c = {
		scrollLeft: 0,
		scrollTop: 0
	}, l = Hl(1), u = Hl(0), d = wu(r);
	if ((d || !d && !a) && ((yu(r) !== "body" || Eu(o)) && (c = Ru(r)), d)) {
		let e = Yu(r);
		l = Gu(r), u.x = e.x + r.clientLeft, u.y = e.y + r.clientTop;
	}
	let f = o && !d && !a ? Zu(o, c) : Hl(0);
	return {
		width: n.width * l.x,
		height: n.height * l.y,
...
function ed(e) {
	let t = xu(e), n = Ru(e), r = e.ownerDocument.body, i = zl(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = zl(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + Xu(e), s = -n.scrollTop;
	return Lu(r).direction === "rtl" && (o += zl(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
var td = 25;
function nd(e, t) {
	let n = bu(e), r = xu(e), i = n.visualViewport, a = r.clientWidth, o = r.clientHeight, s = 0, c = 0;
	if (i) {
...
function rd(e, t) {
	let n = Yu(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = wu(e) ? Gu(e) : Hl(1);
	return {
...
function od(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = Vu(e, [], !1).filter((e) => Cu(e) && yu(e) !== "body"), i = null, a = Lu(e).position === "fixed", o = a ? zu(e) : e;
	for (; Cu(o) && !Iu(o);) {
		let t = Lu(o), n = Nu(o);
...
function sd(e) {
	...
	for (let e = 1; e < a.length; e++) {
		let n = id(t, a[e], i);
		s = zl(n.top, s), c = Rl(n.right, c), l = Rl(n.bottom, l), u = zl(n.left, u);
	}
	return {
		width: c - u,
		height: l - s,
...
function ld(e, t, n) {
	...
	if (r || !r && !a) if ((yu(t) !== "body" || Eu(i)) && (s = Ru(t)), r) {
		let e = Yu(t, !0, a, t);
		c.x = e.x + t.clientLeft, c.y = e.y + t.clientTop;
	} else i && l();
	a && !r && i && l();
	let u = i && !r && !a ? Zu(i, s) : Hl(0);
	return {
...
function _d(e, t) {
	...
	function o(s, c) {
		...
		if (s || t(), !f || !p) return;
		let m = Vl(d), h = Vl(i.clientWidth - (u + f)), g = Vl(i.clientHeight - (d + p)), _ = Vl(u), v = {
			rootMargin: -m + "px " + -h + "px " + -g + "px " + -_ + "px",
			threshold: zl(0, Rl(1, c)) || 1
		}, y = !0;
		function b(t) {
...
}, Sd, Cd = [], wd = ie((e) => e(), 150, !1), Td = { type: "divider" };
function Ed(e) {
	if (e?.type == "contextmenu") {
		e.preventDefault();
		return;
	}
	Sd && (Sd.remove(), Sd = void 0, document.body.classList.remove(n), document.body.classList.remove(_));
}
function Dd(e) {
	if (!(e < 1)) {
...
var Md = (e) => I`
	...
	Ed(), e.callback();
        ...
        >
            ...
            >
            ${e.shortcut ? I`<span class="kbd-shortcut">${e.shortcut}</span>` : M}
        </a>
...
function Id(e, t, n, r) {
	...
	i.classList.add("gs-context-menu"), i.style.top = "0", i.addEventListener("mouseenter", () => {
		wd(() => {});
	}), i.addEventListener("mouseup", (e) => e.stopPropagation()), i.addEventListener("click", (e) => e.stopPropagation()), N(e.map((e) => Pd(e, n)), i), Sd.appendChild(i), Dd(n), Cd[n] = i, r ??= "right-start";
...
function Rd() {
	...
	}, { once: !0 }), e.appendChild(Sd), document.body.classList.add(n), document.body.classList.add(_);
}
function zd(e, t, n) {
	n ??= "bottom-start", Sd && Ld !== t && Ed(), Ld = t, Sd ? N(e.items.map((e) => Pd(e, 0)), Cd[0]) : (Rd(), Id(e.items, t, 0, n));
}
function Bd(e, t) {
	...
	return c.push({
		...
		submenu: (() => {
			...
			return s == "quantitative" ? e.push(l(i.groupToQuartiles({ attribute: a }), !1, void 0, "By quartiles"), {
				...
				label: "By thresholds...",
				callback: () => gl(t, r)
			}) : (s != "identifier" && e.push(l(i.groupByNominal({ attribute: a }), !1, void 0, I`By ${Tl(t)}`)), e.push({
				icon: Fr,
...
function $d(e) {
	return e.type === "quantitative" ? si : ti;
}
function ef(e) {
...
var rf = class {
	...
	feedback(e) {
		let t = this.error(e);
		return t ? I`<div class="invalid-feedback">${t}</div>` : M;
	}
	#e(e) {
...
}, af = w(class extends C {
	constructor(e) {
		if (super(e), e.type !== T.ELEMENT) throw Error("formField must be used on an element part.");
	...
	update(e, t) {
		...
		return this._abortController && this._abortController.abort(), this._abortController = new AbortController(), o.addEventListener("input", (e) => {
			...
			c();
		}, { signal: this._abortController.signal }), c(), M;
	}
});
//#endregion
...
var sf = class extends G {
	...
	async #e() {
		...
		let n = !0;
		try {
			this.bookmarkDatabase && !(t && e.name == this.originalName) && await this.bookmarkDatabase.get(e.name) && (n = await q(I`A bookmark with the name
...
function cf(e, t, n) {
	return jc("gs-enter-bookmark-dialog", (r) => {
...
var lf = /* @__PURE__ */ t(((e, t) => {
	...
	}, N = Ff(), P = Uf(), F = N.call(k, Array.prototype.concat), ne = N.call(O, Array.prototype.splice), re = N.call(k, String.prototype.replace), ie = N.call(k, String.prototype.slice), ae = N.call(k, RegExp.prototype.exec), oe = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, se = /\\(\\)?/g, ce = function(e) {
	...
	t.exports = function(e, t) {
		...
		for (var d = 1, f = !0; d < n.length; d += 1) {
			...
			if ((p === "constructor" || !f) && (s = !0), r += "." + p, a = "%" + r + "%", P(j, a)) o = j[a];
			else if (o != null) {
				if (!(p in o)) {
	...
	P.working = typeof ArrayBuffer < "u" && P(/* @__PURE__ */ new ArrayBuffer());
	function F(e) {
		return typeof ArrayBuffer > "u" ? !1 : P.working ? P(e) : e instanceof ArrayBuffer;
	}
	e.isArrayBuffer = F;
	function ne(e) {
	...
	e.isSymbolObject = me;
	function he(e) {
		return de(e) || fe(e) || pe(e) || L(e) || me(e);
	}
	e.isBoxedPrimitive = he;
	function ge(e) {
		return typeof Uint8Array < "u" && (F(e) || oe(e));
	}
	e.isAnyArrayBuffer = ge, [
		"isProxy",
		"isExternal",
	...
	function p(e, t, n, r, i) {
		for (var a = [], o = 0, s = t.length; o < s; ++o) te(t, String(o)) ? a.push(m(e, t, n, r, String(o), !0)) : a.push("");
	...
	function m(e, t, n, r, i, a) {
		...
		if (c.get ? s = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (s = e.stylize("[Setter]", "special")), te(r, i) || (o = "[" + i + "]"), s || (e.seen.indexOf(c.value) < 0 ? (s = v(n) ? u(e, c.value, null) : u(e, c.value, n - 1), s.indexOf("\n") > -1 && (s = a ? s.split("\n").map(function(e) {
			return "  " + e;
		}).join("\n").slice(2) : "\n" + s.split("\n").map(function(e) {
			return "   " + e;
	...
	e.promisify = function(e) {
		...
		if (N && e[N]) {
			...
			return Object.defineProperty(n, N, {
				value: n,
				enumerable: !1,
				writable: !1,
				configurable: !0
		...
		return Object.setPrototypeOf(n, Object.getPrototypeOf(e)), N && Object.defineProperty(n, N, {
			value: n,
			enumerable: !1,
			writable: !1,
			configurable: !0
	...
	function F(e) {
		...
		function n() {
			...
			e.apply(this, t).then(function(e) {
				...
				process.nextTick(P.bind(null, e, a));
			});
		}
...
var Ep = class extends G {
	...
	renderButtons() {
		return this.plot ? [
			...
			this.makeButton("Save PNG", async () => (await Rn(this.renderRoot, this._api, this.plot.filename), !0), { iconDef: Xr }),
...
var Lp = class {
	...
	constructor(e, t) {
		...
		super(r, e.context, t, t, "sample-metadata"), this.#e = e, this._attributeHighlighState = {
			...
			let t = e.target, n = this.#e.findSampleForMouseEvent(e), r = this.#v(t)?.attribute.specifier;
			if (n && e.mouseEvent.buttons === 0) {
				let e = JSON.stringify([n.id, r]);
				this.context.updateTooltip(e, (e) => {
					let [t, n] = JSON.parse(e);
					return Promise.resolve(this.#y(t, n));
				});
			}
			r && this.#c(r);
	...
	handleContextMenu(e) {
		...
		let n = this.#e.sampleHierarchy.sampleMetadata.entities[t.id], r = [this.#e.makePeekMenuItem(e.point.y - this.#e.childCoords.y, t.id), Td], i = this.#v(e.target);
		if (i) {
	...
	async #d(e) {
		...
		try {
			if (this.#f(n) || (await this.#_(), this.#f(n)) || (await this.syncGuideViews(), this.#f(n))) return;
			v(this);
			let r = (e) => e.isConfiguredVisible(), i = this.#p(t, r);
			if (i.updateDynamicData(this.#m(e)), await this.#g(i, r), this.#f(n)) return;
			this.#h(), this.context.requestLayoutReflow();
		} catch (e) {
	...
	async #_() {
		...
		let e = Jt(this.getAttributeNames(), "/"), t = this.#e.sampleHierarchy.sampleMetadata.attributeDefs, n = async (e, r, i) => {
			for (let a of e.children.values()) if (a.children.size == 0) {
				...
				if (!(o instanceof Ce)) throw Error("Cannot find metadata foreground view for " + e);
		...
		await n(e, this, {});
		for (let e of this.getDescendants()) e instanceof Ce && e.name.startsWith("title") && (e.mark.properties.clip = "never");
		c(this);
	}
	getAttributeNames() {
...
function Gp(e) {
	return I`${ln(e, "/").map((e, t) => I`${t > 0 ? I` <span style="color: gray;">&rsaquo;</span> ` : ""}${e}`)}`;
}
function Kp(e) {
...
var Yp = class extends G {
	...
	renderButtons() {
		return [this.makeButton("Cancel", () => this.finish({ ok: !1 })), this.makeButton("Retain", () => this.#t(), {
			iconDef: z,
			isPrimary: !0,
			disabled: !sl(this.operand)
		})];
	}
	#t() {
		if (!sl(this.operand)) throw Error("Group size threshold is missing.");
...
var Zp = { step: 24 }, Qp = class extends Se {
	#e = !0;
	constructor(e, t) {
		let n = {
			name: "sample-groups",
	...
	#o() {
		...
		return [null, ...this.sampleView.sampleHierarchy.groupMetadata].map((t) => {
			...
			return n ? zt(n) ? n : (N(n, e), e.textContent.replace(/\s+/g, " ").trim()) : "unknown";
		});
	}
};
function $p(e, t, n) {
...
function am(e, t) {
	e.dispatch(Wn.clearHistory()), e.dispatch({ type: t + rm });
}
//#endregion
...
var om = class {
	...
	replaceTopology(e, t, n = "disjoint") {
		...
		this.#e = r, this.#t = Object.freeze({
			...
			rectangles: or("placementSourceSnapshot", () => (sr("placementSourceSnapshotBytes", t.byteLength), new Float32Array(t))),
			overlap: n
		});
	}
	replaceGeometry(e, t = this.#t.overlap) {
		this.#i(), cm(e, this.#e.facetIds.length), this.#t = Object.freeze({
			topology: this.#e,
			geometryRevision: this.#t.geometryRevision + 1,
			rectangles: or("placementSourceSnapshot", () => (sr("placementSourceSnapshotBytes", e.byteLength), new Float32Array(e))),
			overlap: t
		});
	}
	onDispose(e) {
...
var lm = 35, um = 5, dm = 15, fm = .2, pm = [], mm = class {
	...
	togglePeek(e, t, n) {
		...
		let r = this.#p.viewContext, a = this.#p.getHeight(), o = {
		...
		if (this.#e == 0) {
			...
			if (e ? this.#t = e - t : this.#t = (this.#n - a) / 2, this.#n > a) return ft({
				...o,
				to: 1,
				duration: 500,
				easingFunction: gr
	...
	getGroupBackgroundRects(e) {
		...
		e = e.flatten();
		let o = this.#p.isStickySummaries() && a > 0 ? e.shrink(new ut(a, 0, 0, 0)) : e;
	...
	#b() {
		...
		!r && this.#v.baseVersion === this.#g && this.#v.height === i && this.#v.peekState === this.#e && this.#v.scrollOffset === this.#t && this.#v.sampleCount === t || (or("placementComputation", () => {
			let e = this.#c;
			sr("placementComputationSamples", t), sr("placementComputationBytes", e.byteLength), e.fill(0);
	...
	#x() {
		...
		let r = rr(t), i = this.#p.sampleLayout ?? {}, a = vm(r, {
			viewHeight: e,
...
function vm(e, { viewHeight: t = 0, sampleHeight: n = 0, groupSpacing: r = 5, sampleSpacingFactor: i = fm, summaryHeight: a = 0 }) {
	...
	for (let [e, t] of s.entries()) {
		...
		lt(r.map((e) => n), Math.max(0, l[e].locSize.size - a), { offset: l[e].locSize.location + a }).forEach((e, t) => {
			let { size: n, location: a } = e, o = n * i * .5 * Te(15, 22, n);
...
function Tm(e) {
	return e && (xe(e) || k(e)) && "aggregateSamples" in e;
}
//#endregion
//#region ../app/src/sampleView/datumLookup.js
function Em(e, t = e.getCollector()) {
	let n = e.getDataAccessor("x"), r = e.getDataAccessor("x2"), i = e.getScaleResolution("x")?.getScale()?.type, a = i ? it(i) : !1;
	return !t || !n ? () => void 0 : a ? (e, r) => t.facetBatches.get(Ae(e))?.find((e) => r == n(e)) : !a && r ? (e, i) => t.facetBatches.get(Ae(e))?.find((e) => i >= n(e) && i < r(e)) : (e, r) => t.facetBatches.get(Ae(e))?.find((e) => r == n(e));
}
//#endregion
...
function Pm(e, t) {
	...
	return (e) => {
		let [t, n] = m(), r = a.facetBatches.get(Ae(e));
...
function Fm(e, t) {
	...
	if (r) {
		let e = t.every(S) ? r.toContinuousInterval(t) : t;
...
function Km(e, t) {
	if (!e || typeof e.visit != "function") return !1;
	let n = 0;
	for (let r of Ct(e)) r.selector.param === t && (n += 1);
	return n > 1;
}
function qm(e) {
	try {
...
function Jm(e, t) {
	let n = t.specifier, r = Lm(e, n.view), i = Um(e, r, String(r.getTitleText() ?? r.name)), a = "aggregation" in n ? Bt(n.aggregation.op, n.field, n.featureFilter) : n.field, o = "aggregation" in n ? Ym(n.aggregation.op, n.field, n.featureFilter) : I`<em class="attribute">${n.field}</em>`, s = "aggregation" in n ? Ym(n.aggregation.op, n.field, n.featureFilter) : I`<em class="attribute">${n.field}</em>`, c = Pm(r, n), l = On(c), u = (e) => {
	...
	let m = f && Fe(f) ? r.getScaleResolution(f).getScale() : void 0, h = p && "scale" in p && p.scale && typeof p.scale == "object" ? p.scale : void 0, g = p && "type" in p ? p.type : void 0, _ = "aggregation" in n ? "quantitative" : g, v, y;
	...
	return {
		...
		title: I`${s}
            ...
            ${(() => {
			if (Vn(n)) {
				if (Jn(n.interval)) return I`in
                    <span class="interval"
                        >${Fm(r, n.interval)}</span
                    >`;
				if (gn(n.interval)) return I`in
                    <span class="interval"
...
function Ym(e, t, n) {
	...
	if (e === "count") {
		...
		return I`${Mn(e)}(<em class="attribute"
                >${t}</em
            >${r})`;
	}
	let r = n ? I` where ${Xm(n)}` : "";
	return I`${Qt(e)}(<em class="attribute">${t}</em
        >${r})`;
}
function Xm(e) {
	return e.operator === "in" ? I`<em class="attribute">${e.field}</em> in
            {${Cl(e.values, (e, t) => I`${t > 0 ? ", " : ""}<strong
                            >${tn(e)}</strong
...
function Zm(e) {
	return S(e) || typeof e == "number" ? l(e) : String(e);
}
//#endregion
...
var Nh = class extends R {
	...
	render() {
		...
		let e = Ut(this.attributeInfo), t = this._scaleConfigured && this._scale ? Ph(this._scale) : "Auto";
		return I`
            <div class="gs-alert info">
                ${W(Er).node[0]}
                <div>
	...
	#t() {
		...
		return this._observedDomain ||= yh(Ut(this.attributeInfo), this.values), this._observedDomain;
	}
	#n() {
...
var zh = class {
	...
	#d() {
		return this.#f() ? this.filterField + " " + $t(this.operator) + " " + (sl(this.operand) ? String(this.operand) : "...") : this.selectedValues.length === 0 ? this.filterField + " in {...}" : this.filterField + " in {" + this.selectedValues.map(String).join(", ") + "}";
	}
	#f() {
	...
	#v() {
		return !this.filterField || !this.aggregationField ? !1 : this.#f() ? sl(this.operand) : this.selectedValues.length > 0;
	}
	#y() {
		if (!this.#f()) return {
		...
		if (!sl(this.operand)) throw Error("Quantitative feature filter is missing a value.");
		return {
			field: this.filterField,
			operator: this.operator,
			value: this.operand
...
function Kh(e, t, n) {
	...
	if (n) try {
		let t = [];
		e.visit((e) => {
			e instanceof Ce && e.isVisible() && $h(e, r) && t.push(e);
		});
		for (let e of t) {
...
function og(e, t, n) {
	...
	return t.type === "locus" ? "Locus: " + (S(n) || typeof n == "number" ? l(n) : String(n)) : (r ? r + ": " : "") + n;
}
function sg(e, t) {
	if (!e || !t || e.selection.intervals.x?.length !== 2 || !Ve(e.selection, t)) return {};
...
function cg({ fieldInfo: e, aggregationFieldInfos: t, selectionIntervalComplex: n, selectionIntervalSource: r, sample: i, sampleHierarchy: a, attributeInfoSource: o, attributeType: s, sampleView: c }) {
	...
	return [
		...
		...e.supportedAggregations.map((t) => {
			let l = Gt(t), u = t === "itemCount" ? I`Using ${l.label.toLowerCase()} over interval...` : I`Using ${l.label.toLowerCase()}(<em
                              class="attribute"
                              >${e.field}</em
                          >) over interval...`, d = r ? {
				view: e.viewSelector,
...
var Dg = 60, Og = "all", kg = 1e-6, Ag = class {
	...
	getHorizontalReserve(e) {
		return new ut(0, this.getRightReserve(e), 0, this.getLeftReserve(e));
	}
...
}, jg = "VALUE_AT_LOCUS", Mg = class extends Et {
	childCoords;
	sidebarCoords;
	locationManager;
	#e = 0;
	...
	#h() {
		...
		this.provenance.addActionInfoSource((e) => Ml(e, t)), this.actions = e.actions;
	}
	#g() {
	...
	#v(e, t, n) {
		if (n && b(e, n)) return Promise.resolve();
		if (n) return x(this.context, e, n, t);
	...
	#w() {
		this.compositeAttributeInfoSource = new om(), this.childCoords = Ot.ZERO, this.sidebarCoords = Ot.ZERO, this.locationManager = new mm({
	...
	async initializeChildren() {
		...
		this.#t = new Pg(n, this, 0, t, this.spec.view), this.#o = (e) => {
			...
			spacing: 8,
			padding: { right: 8 }
		}, this, this, "sample-sidebar"), mt(this.#n, { skipSubtree: !0 }), this.sampleGroupView = new Qp(this, this.#n), this.sampleLabelView = new ih(this, this.#n), this.metadataView = new zp(this, this.#n), this.#n.setChildren([
		...
		this.#n.addInteractionListener("wheel", r, !0), this.#n.addInteractionListener("mousedown", r, !0), this.#n.addInteractionListener("touchgesture", r, !0), this.#t.scrollbars.vertical = new le(this.#t, "vertical", { onViewportOffsetChange: (e) => {
		...
		}, y(this), a(this), be(this), await this.#t.syncGuideViews(), await this.#W(), y(this), a(this), be(this), await this.#t.summaryViews.syncGuideViews(), await this.#t.syncGuideViews(), await this.sampleGroupView.initializeChildren(), await this.metadataView.initializeChildren(), this.#t.view.addInteractionListener("contextmenu", this.#V.bind(this));
	}
	getOverhang() {
		let e = this.#D().px ?? 0, t = this.locationManager.getLocations(), n = this.#t.sampleChromeLayout.getHorizontalReserve(t).add(new ut(0, 0, 0, e)), r = this.#O();
	...
	#O() {
		let e = this.#t.getOverhangWithoutYAxes(), t = this.#n.isConfiguredVisible() ? this.#n.getOverhang().getVertical() : ut.zero();
		return {
			sampleOverhang: e,
	...
	*[Symbol.iterator]() {
	...
	#k() {
		...
		if (e) {
			...
			this.provenance.store.dispatch(this.actions.setSamples({ samples: t })), am(this.provenance.store, pn);
	...
	#A() {
		...
		let { dataSource: t, collector: n } = r(ae(e.data, this), new Ng(e.idField ?? "sample", e.displayNameField)), i = n.observe(() => {
			let e = n.getData();
			this.provenance.store.dispatch(this.actions.setSamples({ samples: e })), am(this.provenance.store, pn);
		});
	...
	#P(e, t, n = {}) {
		...
		let s = Be(this.locationManager.clipBySummary(t), !0, !0), c = this.locationManager.getLocations();
		if (!c) {
			a();
			return;
		}
		...
		for (let [r, i] of c.summaries.entries()) {
			let a = t.modify({
				y: () => {
					...
					return this.#i ? n + Xe(-e, 0, i.locSize.size - m) : n;
				},
				height: m
			}).expand(p);
			f.arrange(e, a, {
	...
	#z() {
		...
		for (let t of e) for (let [e, n] of t.paramRuntime.paramConfigs) {
			...
			let r = Ke(n.select);
			if (!Ne(r) || !r.encodings?.includes("x")) continue;
	...
	propagateInteraction(e) {
		P(this, e, () => {
			...
			for (let t of Object.values(this.#t.scrollbars)) if (E(e, () => t.coords.containsPoint(e.point.x, e.point.y), () => t.propagateInteraction(e)), e.stopped) return;
			n ? E(e, () => !0, () => this.#t.view.propagateInteraction(e), () => ne(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator)) : r && ne(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator), !e.stopped && E(e, () => this.sidebarCoords.containsPoint(e.point.x, e.point.y), () => this.#n.propagateInteraction(e));
		});
	}
	#U(e, t, n) {
	...
	constructor(e, t, n, r, i) {
		...
		let a = ve(i);
		a && (this.groupBackground = new Ce(a, t.context, t, e, "sample-group-background-" + n), mt(this.groupBackground, { skipSubtree: !0 }));
		let o = j(i);
		o && (this.groupBackgroundStroke = new Ce(o, t.context, t, e, "sample-group-background-stroke-" + n), mt(this.groupBackgroundStroke, { skipSubtree: !0 })), this.summaryViews = r;
	}
	allowDuplicateAxes() {
		return !0;
	}
	async syncGuideViews() {
		let e = te(this.summaryViews), t = new Set(e);
		if (await super.syncGuideViews({
			legendOwners: [...te(this.view), ...e],
			legendFilter: (e, n) => !t.has(n) || !pe(e)
	...
	getOverhangWithoutYAxes() {
		let e = (e) => ye(this.axes[e]), t = new ut(0, e("right"), 0, e("left"));
...
var s_ = class {
	...
	update(e, [t, n]) {
		if (Array.isArray(t)) {
			if (Array.isArray(this.ot) && this.ot.length === t.length && t.every((e, t) => e === this.ot[t])) return L;
		} else if (this.ot === t) return L;
	...
	constructor() {
		super(), this.inputRef = Lt(), this.app = void 0, this._focused = !1, this._subscriptions = new f_(this), this.getDefaultValue = () => "";
	}
	get genomeSpy() {
	...
	_initializeGenome() {
		...
		if (e) {
			...
			let n = ie(() => this.requestUpdate(), 60, !1);
...
function g_(e, t, n) {
	...
	for (let i of e) for (let e of p(n, t, i)) if (e != null && r.add(String(e)), r.size >= n) return [...r];
	return [...r];
}
function __(e) {
	let t;
	return e.visit((e) => {
		for (let n of ["x", "y"]) {
			...
			if (r && r.type == "locus" && r.isZoomable()) return t = r, wt;
		}
	}), t;
}
var v_ = {
	...
	devDependencies: {
		"@genome-spy/app-agent": "^0.86.0",
		"@genome-spy/inspector": "^0.86.0"
	}
};
//#endregion
...
var b_ = w(class extends C {
	...
	update(e, [t]) {
		...
		if (e.type === T.PROPERTY) {
			...
			if (!!t === n.hasAttribute(r)) return L;
		} else if (e.type === T.ATTRIBUTE && n.getAttribute(r) === t + "") return L;
		return It(e), t;
	}
});
//#endregion
		...
		return I`
            ...
            >
                <div class="drop-inner">
                    <div class="drop-icon">${W(Qr).node[0]}</div>
...
var E_ = "sample", D_ = class extends R {
	static properties = {
		_pathRoot: { state: !0 },
		metadataRecords: {},
	...
	async #a(e) {
		...
		let r = n.length > 0 ? yh(t, n) : [], i = this._scales.get(e.path), a = await K("gs-configure-scale-dialog", (e) => {
	...
	#o() {
		...
		return Cl(qt(this._pathRoot), (n) => {
			let r = (e) => {
				let t = 0, n = e.parent;
				for (; n;) t++, n = n.parent;
				return t;
			}, i = n.path, a = n.children.size === 0, o = this._scales.get(i), s = o?.type ?? "", c = o?.domain ? JSON.stringify(o.domain) : "", l = o?.range ? JSON.stringify(o.range) : "", u = o?.scheme ?? null, d = this._metadataNodeTypes.get(n.path) ?? "unset", p = n.parent === null, m = p && this.addUnderGroup ? this.addUnderGroup : n.part, h = { marginLeft: `${r(n) * 20}px` };
			p && !this.addUnderGroup && (h.color = "gray");
			let g = { unset: a && d === "unset" }, _ = { invalid: t.has(n.path) };
			return I`<tr>
                <td>
                    <span
                        style=${f(h)}
...
function M_(e) {
	return Ac("gs-upload-metadata-dialog", (t) => {
...
var z_ = class extends R {
	...
	render() {
		let e = this._activeIndex >= 0 ? this.#u(String(this._activeIndex)) : M;
		return I`
            <div
            ...
            >
                ${this._loading ? I`<div class="status">Loading...</div>` : M}
                ${!this._loading && this._suggestions.length === 0 ? I`<div class="status">No matches</div>` : M}
		...
		return I`
            <div class="stack">
                ...
                ${t ? I`<div
                      ...
                      >
                          ${W(t.severity === "info" ? Wr : t.severity === "warning" ? Er : pi).node[0]}
                          <span>
...
}, Q_ = (e) => [...e.paramRuntime.paramConfigs.values()].some((e) => We(e) && e.bind), $_ = (e, t) => {
	let n = [];
	return t && n.push({
		label: "Parameters",
		type: "header"
...
}, ev = (e) => mn(e) && !!e.explicitName || Q_(e) || e instanceof zp;
...
function nv(e) {
	...
	for (let e of tv) e.classList.remove("show"), document.body.classList.remove(n), document.body.classList.remove(_);
	return tv.clear(), e.stopPropagation(), r ? (tv.add(t), t.classList.add("show"), document.body.classList.add(n), document.body.classList.add(_), window.addEventListener("click", (e) => {
		t.classList.contains("show") && (t.classList.remove("show"), document.body.classList.remove(n), document.body.classList.remove(_), e.preventDefault());
	}, { once: !0 })) : window.dispatchEvent(new MouseEvent("click")), r;
}
//#endregion
//#region ../app/src/components/toolbar/provenanceToolbar.js
var rv = class extends R {
	constructor() {
	...
	render() {
		return I`
			...
			if (!n && !r) return M;
			let i = n ? I`${W(li).node[0]} Initial state` : I` ${W(r.icon ?? Ir).node[0]}
...
}, ov = (e) => !Pt(e) && typeof e.then == "function", sv = 1073741823, cv = w(class extends Ft {
	constructor() {
		super(...arguments), this._$Cwt = sv, this._$Cbt = [], this._$CK = new iv(this), this._$CX = new av();
	}
	render(...e) {
		return e.find((e) => !ov(e)) ?? L;
	}
	update(e, t) {
...
function Jy(e, t, n) {
	...
	function d(s) {
		return s === 33 ? (e.consume(s), f) : s === 47 ? (e.consume(s), a = !0, h) : s === 63 ? (e.consume(s), i = 3, r.interrupt ? t : P) : Sv(s) ? (e.consume(s), o = String.fromCharCode(s), g) : n(s);
	}
	function f(a) {
		return a === 45 ? (e.consume(a), i = 2, p) : a === 91 ? (e.consume(a), i = 5, s = 0, m) : Sv(a) ? (e.consume(a), i = 4, r.interrupt ? t : P) : n(a);
	}
	function p(i) {
	...
	function O(t) {
		return t === 45 && i === 2 ? (e.consume(t), j) : t === 60 && i === 1 ? (e.consume(t), M) : t === 62 && i === 4 ? (e.consume(t), F) : t === 63 && i === 3 ? (e.consume(t), P) : t === 93 && i === 5 ? (e.consume(t), N) : Y(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Gy, ne, k)(t)) : t === null || Y(t) ? (e.exit("htmlFlowData"), k(t)) : (e.consume(t), O);
	}
	function k(t) {
	...
	function te(t) {
		if (t === 62) {
			let n = o.toLowerCase();
			return Uy.includes(n) ? (e.consume(t), F) : O(t);
		}
		return Sv(t) && o.length < 8 ? (e.consume(t), o += String.fromCharCode(t), te) : O(t);
	}
	function N(t) {
	...
	function F(t) {
		return t === null || Y(t) ? (e.exit("htmlFlowData"), ne(t)) : (e.consume(t), F);
	}
	function ne(n) {
...
function Qy(e, t, n) {
	...
	function te(t) {
		return Z(t) ? Q(e, N, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(t) : N(t);
	}
	function N(t) {
...
function $b(e, t = {}) {
	...
	for (let e of r.querySelectorAll("a[href]")) e.setAttribute("target", "blank"), e.setAttribute("rel", "noopener noreferrer"), e.setAttribute("href", Tt(e.getAttribute("href"), t.baseUrl));
	for (let e of r.querySelectorAll("img[src]")) e.setAttribute("src", Tt(e.getAttribute("src"), t.baseUrl));
...
async function cx(e, t) {
	try {
		...
		return console.error(e), t.store.getState().intentStatus?.status === "error" ? { plots: [] } : (q(I`<p>Cannot restore the state:</p>
...
var mx = class extends R {
	...
	#i(e, t, n) {
		n.stopPropagation();
		let r = n.target.closest("li"), i = () => q(I`The bookmark <em>${t}</em> will be deleted.`, {
			title: "Are you sure?",
			confirm: !0
		}).then(async (n) => {
	...
	#o() {
		let e = (e, t) => e ? cv(this.#a(e, t), I`Loading...`) : M;
...
var hx = class extends G {
	...
	renderBody() {
		return I` <div style="display: flex; gap: 1em">
            <div style="width: 8em">
                <img title="GenomeSpy" alt="GenomeSpy" src="${_r}" />
            </div>
            ...
            <div style="max-width: 28em">
                ...
                <p>
                    ...
                    ${"commitHash" in v_ ? `(${v_.commitHash})` : M}
                </p>
...
var gx = class extends G {
	...
	async #c() {
		...
		try {
			...
			return await q(`SVG export failed: ${e instanceof Error ? e.message : String(e)}`, {
				title: "SVG export",
				type: "error"
			}), !0;
		} finally {
...
var vx = class extends R {
	...
	_getToolButtons() {
		...
		e.isEnabled() && t.push(I`
            ...
            `);
		let n = this.app.rootSpec.description ? Ae(this.app.rootSpec.description) : [];
		return n.length > 1 && t.push(I`
                <button
                    class="tool-btn"
                    title="Show a description of the visualization"
                    @click=${() => q(I`${n.slice(1).map((e) => I`<p>${e}</p>`)}`, {
			title: n[0],
			type: "info"
		})}
                >
            ...
            ${this.app.ui.toolbarButtons.size ? Array.from(this.app.ui.toolbarButtons).map((e) => this.#n(e)) : M}
	...
	#r() {
		...
		return e.push({
			...
			label: "Save SVG",
			icon: Vr,
			callback: () => K("gs-save-svg-dialog", (e) => {
				e.genomeSpy = this.app.genomeSpy;
			})
...
function xx(e, t, n = (e) => +e) {
	let r = e.length, i = new ct(), a = Array(r).fill(0);
...
var Sx = "sampleCount", Cx = class extends Ye {
	#e = !0;
	#t;
	constructor(e, t) {
		super(), this.view = t;
		...
		}, i = Ap(this.provenance.store, (e) => e.provenance.present[pn], () => {
			r();
		});
	...
	initialize() {
		...
		if (Ge(e)) this.xAccessor = ze(e.field);
	...
	#r() {
		if (this.parent instanceof g) return this.parent;
	...
	#i(e) {
		let t = [...tr(e.rootGroup)].filter((e) => _n(ke(e)));
...
async function Fx(e, t, n) {
	...
	let a = hn(t), o = await a.getSource(r.sourceId), s = await Nx({
		source: o,
		payload: r,
		sampleIds: i,
...
async function Lx(e, t) {
	...
	a.length !== 0 && (await t.submit(a), am(e.provenance.store, Ht.name));
}
//#endregion
...
function Bx(e) {
	return Mc("gs-intent-status-dialog", (t) => {
...
function Hx(e) {
	return Ac("gs-intent-error-dialog", (t) => {
...
function Ux({ store: e, intentPipeline: t, provenance: n, delayMs: r = 800, minVisibleMs: i = 400 }) {
	let a, o, s, c, l = (e = !1) => {
		...
		let t = e?.currentAction ? Gx(n, e.currentAction) : M, r = typeof e?.currentIndex == "number" && typeof e?.totalActions == "number" ? I` (${e.currentIndex + 1} of ${e.totalActions})` : M;
...
var cS = 150, lS = class {
	...
	#g() {
		this.#r = Ct(this.#e), this.#i.clear(), this.#u.clear();
		for (let e of this.#r) {
			let t = St(e.selector);
	...
	#k(e) {
		return He(e.param, e.view.paramRuntime);
	}
	#A(e, t) {
	...
	#I(e, t) {
		return We(e.param) && Object.is(e.view.paramRuntime.getTargetValue(e.selector.param), t);
	}
	#L(e) {
		let t = e.selector.param;
		return We(e.param) ? e.view.paramRuntime.getTargetValue(t) : e.view.paramRuntime.getValue(t);
	}
	async whenApplied(e) {
	...
	#R(e, t) {
		...
		if (Re(n)) {
			...
			if (De(i)) {
				...
				try {
					c = we(s, t, a, (e, t) => o.findDatumByKey(e, t));
				} catch (r) {
		...
		return We(n) ? r.type === "value" ? r.value : this.#j(e, "cannot be restored because the bookmark stored a different value type.") : this.#k(e);
	}
	#z(e, t, n) {
	...
	#B(e) {
		let t = e.origin, n = bt(this.#e, t.view);
		if (!n) {
	...
	#X(e, t) {
		let n = e.param;
		Re(n) && De(Ke(n.select)) && (this.#N(e, "persist") || this.#u.add(t));
	}
	#Z(e, t) {
		let n = Ke(e.select);
		return De(n) ? je(t) ? !t.datum : !Oe(t) || t.data.size === 0 : Ne(n) ? !Ee(t) : !1;
	}
	#Q(e) {
		this.#l.has(e) || (this.#l.add(e), this.#s.add(e), !this.#d && (this.#d = !0, queueMicrotask(() => {
			this.#d = !1;
			let e = Array.from(this.#s);
			this.#s.clear(), e.length && q(I`<p>
...
function fS(e, t) {
	...
	let i = e.payload, a = i.selector, o = r && "rule" in i ? { rule: i.rule } : r ? { predicate: i.predicate } : {}, s = r ? {
		...
		origin: i.origin,
		...o
	} : i.value, c = i.origin, l = SS(ht, t, a), u = l ? l.view : void 0, d = u ? hS(u, t) : null, f = pS(e, u, a, s, c, t);
	return {
		title: d ? I`${f} in ${d}` : f,
		icon: xS(s)
	};
...
function xS(e) {
	switch (e.type) {
		case "point":
		case "pointExpand": return kr;
		case "interval": return mi;
		case "value": return Lr;
		default: return;
	}
}
function SS(e, ...t) {
...
function IS(e) {
	let t = !1;
	return gt(e, (e) => {
		if (mn(e) && (e.explicitName || Dn(e))) return t = !0, wt;
	}), t;
}
function LS(e) {
	return JSON.stringify(e);
...
var qS = class {
	...
	constructor(e, t, n = {}) {
		...
		}), this.genomeSpy = new O(this.appContainer.getElementsByClassName("genome-spy-container")[0], this.rootSpec, this.options), this.debug = {
	...
	getAgentApi() {
		return this.#e ||= import("./agentApi-BYJcFrZ1.js").then((e) => e.t).then((e) => e.createAgentApi(this)), this.#e;
	}
	...
	#a(e) {
		this.appContainer = e, this.isFullPage() ? (this.appContainer.style.margin = "0", this.appContainer.style.padding = "0", this.appContainer.style.overflow = "hidden", YS(vr)) : this.appContainer.style.position = "relative";
	}
	#o() {
	...
	async launch() {
		let e = this.isEmbedded() ? Promise.resolve([]) : this.rootSpec.bookmarks?.remote ? fe({ baseURL: this.rootSpec.baseUrl }).load(this.rootSpec.bookmarks.remote.url).then((e) => Promise.resolve(JSON.parse(e))) : Promise.resolve([]);
		...
		let r = Ae(this.genomeSpy.spec.description ?? []);
	...
	async _restoreStateFromUrl() {
		...
		if (e && e.length > 0) try {
			...
			console.error(e), q(I`<p>Cannot restore the state:</p>
                        <p>${e}</p>`);
		}
		return !1;
	}
	...
	getSampleView() {
		...
		return this.genomeSpy.viewRoot.visit((t) => {
			if (t instanceof Mg) return e = t, wt;
		}), e;
	}
};
function JS(e) {
	let t = e.bookmarks?.remote;
	if (t) return st(dt(e.baseUrl, t.url));
}
function YS(e) {
