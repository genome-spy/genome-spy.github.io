import { C as e, E as t, Ht as n, J as r, S as i, Ut as a, Wt as o, Xt as s, an as c, at as l, b as u, mt as d, o as f, q as p, t as m, y as h, zt as g } from "./clipOptions-H68pJyEZ.js";
import { E as ee, it as te, m as ne, y as _ } from "./vega-scale-BGC53c22.js";
...
function se(e) {
	return typeof e.rank == "number" ? e.rank : oe(e).rank;
}
function ce(e) {
	for (let t of e) t();
}
var le = class {
	...
	createWritable(e, t, n, r, i = {}) {
		...
		return Object.assign(C(s, c), { dispose: l });
	}
	computed(e, t, n, r, i = {}) {
	...
	#b(e) {
		let t = -1, n = 0;
		return () => (t !== this.#n && (n = 1 + e().reduce((e, t) => Math.max(e, se(t)), 0), t = this.#n), n);
	}
	#x(e) {
		if (this.#d.has(e)) {
			this.#w();
...
function pe(e, t, n = {}) {
	let r = {}, i = fe(e, r, n), a = /* @__PURE__ */ new Map();
...
var me = class {
	#e = new ue();
	#t = new le({ lifecycleRegistry: this.#e });
	#n = new de();
	createScope(e) {
	...
	registerDerived(e, t, n, r) {
		let { expression: i, dependencies: a } = pe(n, (t) => this.resolve(r?.expressionScope ?? e, t), r), o = this.#n.getOwnerId(e), s = this.#t.computed(o, t, a, () => i(null));
		return this.#n.register(e, t, s);
	}
	createExpression(e, t, n) {
		let { expression: r } = pe(t, (t) => this.resolve(e, t), n);
		return r;
	}
	resolve(e, t) {
...
function _e(e) {
	...
	return e.delay ? r?.canceled ? Promise.resolve() : n?.aborted ? Promise.reject("aborted") : he(e.delay).then(i) : i();
}
//#endregion
...
function w(e, t, n, r, i) {
	...
	function p(n) {
		l = n, e.transitionsEnabled === !1 ? (c = l, o = !0, s = !1, e.cancelTransition(d), t(c)) : o && (o = !1, a = ye(), d(a));
	}
	return p.stop = () => {
...
var be = class {
	...
	constructor(e, t, n, r = {}) {
		...
		let i = this.#o();
		i ? (this.#e = i.#e, this.#t = this.#e.createScope(i.#t)) : (this.#e = new me(), this.#t = this.#e.createScope());
	}
	registerParam(e, n = {}) {
		let r = e.name;
		if (t(r), this.#i.has(r)) throw Error("Parameter \"" + r + "\" already registered in this scope.");
		if (Se(e), n.defer) {
	...
	#d(e) {
		...
		} else if ("value" in e) r = h(e, this), n = "transition" in e ? this.#p(t, r, e.transition) : this.#f(t, r);
		else if ("expr" in e) {
			if ("transition" in e) this.#m(t, e.expr, e.transition);
			else {
	...
	getTargetValue(e) {
		return t(e), this.#a.get(e)?.target ?? this.getValue(e);
	}
	subscribe(e, n) {
		t(e);
		let r = this.findRuntimeForParam(e);
		if (!r) throw Error("Parameter not found: " + e);
		let i = r.#e.resolve(r.#t, e);
		if (!i) throw Error("Parameter found without local reference: " + e);
	...
	hasLocalParam(e) {
		t(e);
		let n = this.#i.get(e);
		return this.#r.has(e) || n !== void 0 && "expr" in n;
	}
	isPendingParam(e) {
	...
	hasConfiguredParamInScopeChain(e) {
		return t(e), this.#i.has(e) ? !0 : this.#o()?.hasConfiguredParamInScopeChain(e) ?? !1;
	}
	findRuntimeForParam(e) {
		return this.hasLocalParam(e) ? this : this.#o()?.findRuntimeForParam(e);
	}
	getDebugState() {
		let e = [];
	...
	#p(e, t, n) {
		let r = this.#h(e, t, n), i = (t, n) => {
			this.#g(e, r, t, n);
		};
		return this.#n.set(e, i), i;
	}
	#m(e, t, n) {
		let r = this.createExpression(t), i = this.#h(e, r(null), n), a = r.subscribe(() => {
			this.#g(e, i, r(null), { animate: !this.#l });
		});
		this.#e.addScopeDisposer(this.#t, a);
	}
	#h(e, t, n) {
		let r = Ce(e, t), i = this.#e.registerBase(this.#t, e, r);
		this.#r.set(e, i);
		let a = this.#c;
...
var T = class e {
	...
	#e(t, n) {
		return new e(M(this.width, t), M(this.height, n));
	}
	isGrowing() {
...
function je(e) {
	return e && (n(e.px) || n(e.grow) || n(e.minPx) || n(e.maxPx));
}
function Me(e) {
	if (J(e)) throw Error("parseSizeDef does not accept step-based sizes.");
	if (je(e)) return Fe(e), N(e);
	if (n(e)) return {
		px: e,
		grow: 0
	};
...
var P = class e {
	...
	static createFromConfig(e) {
		return typeof e == "number" ? this.createUniformPadding(e) : e ? this.createFromRecord(e) : F;
	}
...
function Le(e, t) {
	return t ? new P(t.top === !1 ? 0 : e.top, t.right === !1 ? 0 : e.right, t.bottom === !1 ? 0 : e.bottom, t.left === !1 ? 0 : e.left) : e;
}
var F = P.createUniformPadding(0);
Object.freeze(F);
//#endregion
...
var Ye = class {
	...
	constructor(e) {
		this.view = e;
		for (let [t, n] of Object.entries(e.spec.datasets ?? {})) this.#e.set(t, new Ye(t, e, () => n));
	}
	getLocalBinding(e) {
		return this.#e.get(e);
	}
	...
	resolve(e) {
		...
		let r = this.#t.get(e);
		return r || (r = new Ye(e, void 0, () => this.view.context.getNamedDataFromProvider(e)), this.#t.set(e, r)), r;
	}
	dispose() {
...
}, G = "VISIT_SKIP", K = "VISIT_STOP", q = (e) => e, Ze = class {
	spec;
	namedDataScope;
	#e;
	#t;
	...
	#p = "none";
	#m = /* @__PURE__ */ new Map();
	facetCoords = new te([], JSON.stringify);
	constructor(e, t, n, r, i, a = {}) {
		if (!e) throw Error("View spec must be defined!");
		if (this.context = t, this.layoutParent = n, this.dataParent = r, this.#t = i, this.spec = e, this.namedDataScope = new Xe(this), r && e.theme !== void 0) throw Error("\"theme\" is only supported at the root specification. Use \"config\" and \"style\" for subtree customization.");
		...
		this.#e = [...o, s].filter((e) => !!e), this.resolutions = {
			...
			x: !1,
			y: !1
		}, this.paramRuntime = new be(() => this.dataParent?.paramRuntime, (e) => this.getScaleResolution(e), t.animator, { snapTransitionedUpdates: !0 });
		let c = [...e.params ?? [], ...Je(e) ?? []];
		for (let e of c) {
			if ("expr" in e) {
				let { usesScaleHelper: t, globals: n } = p(e.expr), r = n.some((e) => this.paramRuntime.isPendingParam(e));
				if (t || r) {
	...
	getCursor() {
		...
		return u(e) ? this.paramRuntime.evaluateAndGet(e.expr) : e;
	}
	watchCursor(e, t) {
		let n = this.getCursorSpec();
		u(n) && this.paramRuntime.watchExpression(n.expr, e, {
			scopeOwned: !1,
			registerDisposer: t
		});
	}
	...
	getPadding() {
		return this._cache("size/padding", () => P.createFromConfig(this.spec.padding));
	}
	getOverhang() {
		return P.zero();
	}
	...
	getSize() {
		return this._cache("size/size", () => this.isConfiguredVisible() ? new T(this.#g("width"), this.#g("height")) : ke);
	}
	getViewportSize() {
	...
	#g(e) {
		let { value: t, implicit: n } = this.#_(e), r = this.resolveSizeValue(e, t), i = J(r), a = e == "viewportWidth" || e == "viewportHeight";
		if (i) {
			...
			if (i) {
				...
				let a = i;
				n = ne(n, a.paddingInner(), a.paddingOuter());
				let o = e == "width" ? "xOffset" : "yOffset", s = this.getScaleResolution(o)?.getScale(), l = r.for ?? (s && _(s.type) ? "offset" : "position"), u = t;
				if (l == "offset") {
					if (!s || !_(s.type)) throw new y(`Cannot use ${e}.step.for = "offset" without a discrete ${o} scale!`, this);
					let t = s, n = ne(s.domain().length, t.paddingInner(), t.paddingOuter());
					u *= n / (1 - a.paddingInner());
				}
				return {
					px: n * u,
					grow: 0
	...
	#b(e) {
		...
		u(t) ? this.#S(e, t.expr) : J(t) && u(t.step) && this.#S(e + ".step", t.step.expr);
	}
	#x(e, t) {
		let n = u(t.step) ? this.#C(e + ".step")() : t.step;
		if (nt(n)) return n;
	...
	configureViewOpacity() {
		(!this.opacityFunction || this.opacityFunction === q) && (this.opacityFunction = $e(this));
	}
	...
	arrange(e, t, n = {}) {
		if (n.firstFacet && this.facetCoords.clear(), this.facetCoords.set(n.facetId, m(t, f(n))), this.#a || this.#o) {
			let e = this.getOverhang(), n = this.layoutParent ? P.zero() : this.getPadding();
	...
	getFacetFields(e) {
		...
		return d(t) ? [t.field] : this.options.inheritEncoding ? this.layoutParent?.getFacetFields(this) : [];
	}
	...
	getBaseUrl() {
		return I(() => this.dataParent?.getBaseUrl(), Ue(this.spec.baseUrl));
	}
	isPickingSupported() {
		return !0;
	}
	getTitleText() {
		...
		if (e) return o(e) ? e : u(e.text) ? this.paramRuntime.evaluateAndGet(e.text.expr) : e.text;
	}
	_cache(e, t) {
		return re(this, e, t);
	}
...
function $e(e) {
	...
	if (t !== void 0) {
		...
		if (Qe(t)) {
			...
			}, r = tt(t.values, "opacity.values", e);
			if (!g(t.unitsPerPixel)) throw new y("\"opacity.unitsPerPixel\" must be an array.", e);
			let i = () => 1, a = [], o = () => {
				let t = et(tt(a.map((e) => e()), "opacity.unitsPerPixel", e), r, e), n = ee().domain(t.unitsPerPixel).range(t.values).clamp(!0);
				i = (e) => n(e);
			};
...
function tt(e, t, r) {
	if (!g(e)) throw new y("\"" + t + "\" must evaluate to an array.", r);
	return e.map((e, i) => {
		if (!n(e) || !Number.isFinite(e)) throw new y("Invalid " + t + " value at index " + i + ". Expected a finite number.", r);
		return e;
	});
}
var J = (e) => !!e && typeof e == "object" && "step" in e;
function nt(e) {
...
function Tt(e, t, n) {
	...
	for (let [e, i] of r) {
		...
		n.push({
			message: "Bookmarkable parameter \"" + e + "\" is not unique within " + wt(t) + ". Found in: " + r + ".",
			scope: t
		});
	}
}
function Et(e, t, n) {
	...
	for (let e of i) {
		let t = Y.get(e), n = t ? t.name : void 0;
		typeof n != "string" || !n.length || a.set(n, (a.get(n) ?? 0) + 1);
	}
	for (let [e, r] of a) r > 1 && n.push({
		message: "Import instance name \"" + e + "\" is used multiple times for addressable instances in " + wt(t) + ".",
		scope: t
	});
}
function Dt(e, t) {
	let n = [];
	return $(e, t, (e) => {
		if (Z(e).length !== t.length + 1) return;
		let r = Y.get(e);
...
function Ot(e) {
	...
	return e.visit((e) => {
		...
		if (n === "excludeSubtree") return G;
		if (n !== "exclude") {
			for (let n of e.paramRuntime.paramConfigs.values()) if (Q(n)) return t = !0, K;
		}
	}), t;
}
function kt(e, t) {
	...
	for (let i of t) {
		...
		if ($(e, r, (e) => {
			let n = Y.get(e);
			if (!(!n || n.name !== i) && Z(e).length === r.length + 1) {
				if (t) return a = !0, K;
				t = e;
			}
...
function $(e, t, n, r = {}) {
	...
	e.visit((e) => {
		let r = Y.get(e), a = X.get(e);
		if (a === "excludeSubtree") return G;
...
//#endregion
export { T as A, be as B, B as C, ze as D, Be as E, A as F, b as G, w as H, we as I, Me as L, De as M, Te as N, P as O, j as P, Oe as R, U as S, I as T, ge as U, ve as V, _e as W, G as _, ut as a, qe as b, ct as c, it as d, gt as f, pt as g, mt as h, Z as i, E as j, Le as k, st as l, yt as m, ot as n, lt as o, ht as p, dt as r, ft as s, vt as t, rt as u, K as v, He as w, H as x, Ze as y, Ee as z };
