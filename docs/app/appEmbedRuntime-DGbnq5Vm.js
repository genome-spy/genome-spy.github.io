...
import { $ as n, A as r, B as i, C as a, D as o, E as s, F as c, G as l, H as u, I as d, J as f, K as p, L as m, M as h, O as g, P as _, Q as v, S as y, T as b, U as x, V as S, W as C, X as w, Y as T, Z as E, _ as D, _t as O, a as k, b as A, bt as j, c as M, d as N, dt as ee, et as P, f as F, ft as te, g as ne, gt as re, h as ie, ht as I, i as ae, j as oe, k as se, l as ce, m as le, mt as L, n as ue, o as de, ot as fe, p as pe, pt as me, q as he, r as ge, s as _e, tt as ve, u as ye, ut as be, v as xe, vt as R, w as Se, x as Ce, xt as we, y as Te } from "./src-EoV59w5q.js";
import { C as Ee, M as De, N as Oe, Ut as ke, Vt as Ae, W as je, X as Me, _ as Ne, a as Pe, b as Fe, ct as Ie, d as Le, f as Re, ft as ze, g as Be, h as Ve, n as He, o as Ue, p as We, qt as Ge, v as Ke, w as qe, x as Je, y as Ye, zt as Xe } from "./paramUtils-BYI4rwyL.js";
import { $t as Ze, B as Qe, D as $e, E as et, J as tt, Jt as nt, M as rt, P as it, Xt as at, Y as ot, a as st, bt as ct, c as lt, f as ut, h as dt, ht as ft, i as pt, m as mt, mt as ht, n as gt, p as _t, pt as vt, r as yt, s as bt, t as xt, v as St, w as Ct, xt as wt } from "./viewSelectors-DGCspRN3.js";
import { w as Tt } from "./framebufferReadback-THWwFqs8.js";
import { a as Et, i as Dt } from "./clipOptions-gqdb3fvW.js";
import { n as Ot, r as kt } from "./viewIdentityRegistry-BUdkK9zT.js";
import { n as At } from "./viewRenderingContext-HtpqwS_x.js";
import { a as jt, c as Mt, i as Nt, l as Pt, n as Ft, o as It, r as Lt, s as Rt, t as zt, u as Bt } from "./ref-DIIlxa5R.js";
import { $ as Vt, A as Ht, B as Ut, C as Wt, D as Gt, E as Kt, F as qt, G as Jt, H as Yt, I as Xt, J as Zt, K as Qt, L as $t, M as en, N as tn, O as nn, P as rn, Q as an, R as on, S as sn, T as cn, U as ln, V as un, W as dn, X as fn, Y as pn, Z as mn, _ as hn, _t as gn, a as _n, at as vn, b as yn, bt as bn, c as xn, ct as Sn, d as Cn, dt as wn, et as Tn, f as En, ft as Dn, g as On, gt as kn, h as An, ht as jn, i as Mn, it as Nn, j as Pn, k as Fn, l as In, lt as Ln, m as Rn, mt as zn, n as Bn, nt as Vn, o as Hn, ot as Un, p as Wn, pt as Gn, q as Kn, r as qn, rt as Jn, s as Yn, st as Xn, tt as Zn, u as Qn, ut as $n, v as er, vt as tr, w as nr, x as rr, xt as ir, y as ar, yt as or, z as sr } from "./agentApi-DFJ1LzrI.js";
...
function fr(e) {
	return Math.max(1, Math.ceil(Math.log(me(e)) / Math.LN2) + 1);
}
//#endregion
...
function pr() {
	...
	function r(r) {
		...
		if (!Array.isArray(f)) {
			let e = d, n = +f;
			if (t === te && ([u, d] = dr(u, d, n)), f = at(u, d, n), f[0] <= u && (s = nt(u, d, n)), f[f.length - 1] >= d) if (e >= d && t === te) {
				let e = nt(u, d, n);
...
`, Xc = class extends L {
	...
	#r = 0;
	constructor() {
		super(), this.values = [], this.thresholds = [], this.operators = [], this.colors = tl, this.showThresholdNumbers = !1, this.binCount = 40, this.#e = pr().thresholds(this.binCount), this.#t = this.#e([]), this.#n = wt();
	}
	willUpdate(e) {
		e.has("binCount") && (this.#e = pr().thresholds(this.binCount)), (e.has("values") || e.has("binCount")) && (this.#t = this.#e(this.values), this.#n = wt().domain(this.domain).range([0, 100]));
	}
	get domain() {
	...
	#o(e, t, n) {
		n = De(n, 0, 1), this.dispatchEvent(new Zc(e, t, +this.#n.invert(n * 100).toPrecision(3)));
	}
	#s() {
...
function ul(e, t) {
	let n = e.scale?.type;
	ht(n) ? fl(e, t) : vt(n) || ft(n) ? ml(e, t) : e.type === "identifier" ? dl(e, t) : q("Not implemented (yet).");
}
function dl(e, t) {
...
}, Sd, Cd = [], wd = fe((e) => e(), 150, !1), Td = { type: "divider" };
function Ed(e) {
	if (e?.type == "contextmenu") {
		e.preventDefault();
		return;
	}
	Sd && (Sd.remove(), Sd = void 0, document.body.classList.remove(ve), document.body.classList.remove(P));
}
function Dd(e) {
	if (!(e < 1)) {
...
function Id(e, t, n, r) {
	...
	i.classList.add("gs-context-menu"), i.style.top = "0", i.addEventListener("mouseenter", () => {
		wd(() => {});
	}), i.addEventListener("mouseup", (e) => e.stopPropagation()), i.addEventListener("click", (e) => e.stopPropagation()), re(e.map((e) => Pd(e, n)), i), Sd.appendChild(i), Dd(n), Cd[n] = i, r ??= "right-start";
...
function Rd() {
	...
	}, { once: !0 }), e.appendChild(Sd), document.body.classList.add(ve), document.body.classList.add(P);
}
function zd(e, t, n) {
	n ??= "bottom-start", Sd && Ld !== t && Ed(), Ld = t, Sd ? re(e.items.map((e) => Pd(e, 0)), Cd[0]) : (Rd(), Id(e.items, t, 0, n));
}
function Bd(e, t) {
...
}, af = E(class extends v {
	constructor(e) {
		if (super(e), e.type !== n.ELEMENT) throw Error("formField must be used on an element part.");
...
var lf = /* @__PURE__ */ t(((e, t) => {
	...
	}() : S, w = jf()(), T = Hf(), E = Nf(), D = Mf(), O = Lf(), k = If(), A = {}, j = typeof Uint8Array > "u" || !T ? n : T(Uint8Array), M = {
		__proto__: null,
	...
	var N = function e(t) {
	...
	}, P = Ff(), F = Uf(), te = P.call(k, Array.prototype.concat), ne = P.call(O, Array.prototype.splice), re = P.call(k, String.prototype.replace), ie = P.call(k, String.prototype.slice), I = P.call(k, RegExp.prototype.exec), ae = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, oe = /\\(\\)?/g, se = function(e) {
		...
		var r = [];
		return re(e, ae, function(e, t, n, i) {
			r[r.length] = n ? re(i, oe, "$1") : t || e;
		}), r;
	}, ce = function(e, t) {
		var n = e, r;
	...
	t.exports = function(e, t) {
		...
		if (I(/^%?[^%]*%?$/, e) === null) throw new c("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
	...
	function ae(e) {
		return ie === void 0 ? !1 : (I.working === void 0 && (I.working = I(new ie())), I.working ? I(e) : e instanceof ie);
	}
...
var Lp = class {
	...
	#f(e, t, n) {
		let { graphicsPromises: r } = g(this, e, t), i = this.flowHandle?.dataSource;
		if (!i) throw Error("Cannot find metadata data source handle!");
		return d(r, () => n === this.#r), i;
	}
	#p(e) {
	...
	async #g() {
		...
		let e = Xt(this.getAttributeNames(), "/"), t = this.#e.sampleHierarchy.sampleMetadata.attributeDefs, n = async (e, r, a) => {
			for (let o of e.children.values()) if (o.children.size == 0) {
				let e = o.path, n = new Te(Bp(e, {
					...a,
					title: o.part,
					...t?.[e] ?? {}
				}, this.#e.spec.metadata), this.context, r, r, `attribute-${e}`);
				await n.initializeChildren();
				let s = n.findDescendantByName(Up(e));
				if (!(s instanceof i)) throw Error("Cannot find metadata foreground view for " + e);
				n.opacityFunction = (t) => t * this.#l(e), r.appendChild(n), this.#n.set(e, s);
				for (let t of n.getDescendants()) this.#a.set(t, e);
			} else {
				let e = t?.[o.path] ?? {}, i = `attributeGroup-${o.path}`, s = new de({
					name: i,
					hconcat: [],
					configurableVisibility: !0,
					title: {
		...
		await n(e, this, {});
		for (let e of this.getDescendants()) e instanceof i && e.name.startsWith("title") && typeof e.spec.mark != "string" && (e.spec.mark.clip = "never");
		c(this);
	}
	getAttributeNames() {
...
var Zp = { step: 24 }, Qp = class extends Te {
	#e = !0;
	constructor(e, t) {
		let n = {
			name: "sample-groups",
	...
	#o() {
		...
		return [null, ...this.sampleView.sampleHierarchy.groupMetadata].map((t) => {
			...
			return n ? Vt(n) ? n : (re(n, e), e.textContent.replace(/\s+/g, " ").trim()) : "unknown";
		});
	}
};
function $p(e, t, n) {
...
var om = class {
	...
	togglePeek(e, t, n) {
		...
		if (this.#e == 0) {
			...
			if (e ? this.#t = e - t : this.#t = (this.#n - i) / 2, this.#n > i) return tt({
				...a,
				to: 1,
				duration: 500,
				easingFunction: gr
	...
	getGroupBackgroundRects(e) {
		...
		e = e.flatten();
		let o = this.#u.isStickySummaries() && a > 0 ? e.shrink(new rt(a, 0, 0, 0)) : e;
	...
	updateFacetTexture() {
		...
		let e = this.#u.viewContext.glHelper;
		if (!e) return;
		let t = e.gl;
		this.#r = f(t, {
			internalFormat: t.RG32F,
			format: t.RG,
			height: 1
...
function hm(e, { viewHeight: t = 0, sampleHeight: n = 0, groupSpacing: r = 5, sampleSpacingFactor: i = um, summaryHeight: a = 0 }) {
	...
	Qe(s.map((e) => c(e.samples)), t, { spacing: r }).forEach((e, t) => {
		l.push({
			key: s[t].path,
			locSize: e
		});
	...
	for (let [e, t] of s.entries()) {
		...
		Qe(r.map((e) => n), Math.max(0, l[e].locSize.size - a), { offset: l[e].locSize.location + a }).forEach((e, t) => {
			let { size: n, location: a } = e, o = n * i * .5 * Oe(15, 22, n);
...
function Sm(e) {
	return e && (Ce(e) || A(e)) && "aggregateSamples" in e;
}
//#endregion
//#region ../app/src/sampleView/datumLookup.js
function Cm(e, t = e.getCollector()) {
	let n = e.getDataAccessor("x"), r = e.getDataAccessor("x2"), i = e.getScaleResolution("x")?.getScale()?.type, a = i ? ht(i) : !1;
	return !t || !n ? () => void 0 : a ? (e, r) => t.facetBatches.get(Xe(e))?.find((e) => r == n(e)) : !a && r ? (e, i) => t.facetBatches.get(Xe(e))?.find((e) => i >= n(e) && i < r(e)) : (e, r) => t.facetBatches.get(Xe(e))?.find((e) => r == n(e));
}
//#endregion
...
function jm(e, t) {
	...
	return (e) => {
		let [t, n] = m(), r = a.facetBatches.get(Xe(e));
...
function Mm(e, t) {
	...
	if (r) {
		let e = t.every(l) ? r.toContinuousInterval(t) : t;
...
function Um(e, t) {
	if (!e || typeof e.visit != "function") return !1;
	let n = 0;
	for (let r of xt(e)) r.selector.param === t && (n += 1);
	return n > 1;
}
function Wm(e) {
	try {
...
function Gm(e, t) {
	...
	let m = f && je(f) ? r.getScaleResolution(f).getScale() : void 0, h = p && "scale" in p && p.scale && typeof p.scale == "object" ? p.scale : void 0, g = p && "type" in p ? p.type : void 0, _ = "aggregation" in n ? "quantitative" : g, v, y;
...
function Jm(e) {
	return l(e) || typeof e == "number" ? p(e) : String(e);
}
//#endregion
...
function Uh(e, t, n) {
	let r = Im(t), a = qh(e).filter((e) => Xh(e.view, r));
	if (n) try {
		let t = [];
		e.visit((e) => {
			e instanceof i && e.isVisible() && Xh(e, r) && t.push(e);
		});
		for (let e of t) {
	...
	return n || (a = a.filter(Zh)), $h(a.map((e) => {
...
function rg(e, t, n) {
	...
	return t.type === "locus" ? "Locus: " + (l(n) || typeof n == "number" ? p(n) : String(n)) : (r ? r + ": " : "") + n;
}
function ig(e, t) {
	if (!e || !t || e.selection.intervals.x?.length !== 2 || !qe(e.selection, t)) return {};
...
var yg = bn({
	...
	reducers: {
		paramChange: (e, t) => {
			let n = bt(t.payload.selector);
			e.entries[n] = t.payload;
		},
		expandPointSelection: (e, t) => {
			let n = t.payload, r = bt(n.selector), i;
...
function bg(e) {
	...
	return !n || !Array.isArray(n.scope) || !n.param || t?.value?.type === "pointExpand" ? null : bt(n);
}
//#endregion
...
var wg = 60, Tg = "all", Eg = 1e-6, Dg = class {
	...
	getHorizontalReserve(e) {
		return new rt(0, this.getRightReserve(e), 0, this.getLeftReserve(e));
	}
	...
	#v(e, t, n) {
		...
		if (n) return u(this.context, e, n, t);
	...
	async initializeChildren() {
		...
		this.#t = new jg(n, this, 0, t, this.spec.view), this.#o = (e) => {
			...
			spacing: 8,
			padding: { right: 8 }
		}, this, this, "sample-sidebar"), lt(this.#n, { skipSubtree: !0 }), this.sampleGroupView = new Qp(this, this.#n), this.sampleLabelView = new th(this, this.#n), this.metadataView = new zp(this, this.#n), this.#n.setChildren([
		...
		}, b(this), a(this), Se(this), await this.#t.syncGuideViews(), await this.#W(), b(this), a(this), Se(this), await this.#t.summaryViews.syncGuideViews(), await this.#t.syncGuideViews(), await this.sampleGroupView.initializeChildren(), await this.metadataView.initializeChildren(), this.#t.view.addInteractionListener("contextmenu", this.#V.bind(this));
	}
	getOverhang() {
		let e = this.#D().px ?? 0, t = this.locationManager.getLocations(), n = this.#t.sampleChromeLayout.getHorizontalReserve(t).add(new rt(0, 0, 0, e)), r = this.#O();
	...
	#O() {
		let e = this.#t.getOverhangWithoutYAxes(), t = this.#n.isConfiguredVisible() ? this.#n.getOverhang().getVertical() : rt.zero();
		return {
			sampleOverhang: e,
	...
	*[Symbol.iterator]() {
	...
	#A() {
		...
		let { dataSource: t, collector: n } = r(oe(e.data, this), new Ag(e.idField ?? "sample", e.displayNameField)), i = n.observe(() => {
			let e = n.getData();
	...
	#P(e, t, n = {}) {
		let r = this.#t, i = n, a = () => {
			M(r.legends, r.axes, t, e, i, (e, t, n) => n(), 0), r.renderTitle(e, t, i);
		...
		for (let [n, i] of Object.entries(r.axes)) n === "left" || n === "right" || i.render(e, _e(t, n, i));
		...
		for (let [r, i] of c.summaries.entries()) {
			let a = t.modify({
				y: () => {
					...
					return this.#i ? n + De(-e, 0, i.locSize.size - m) : n;
				},
				height: m
			}).expand(p);
			f.render(e, a, {
	...
	render(e, t, n = {}) {
		...
		let i = Qe([this.#D(), { grow: 1 }], t.width), a = (e) => t.modify({
			x: e.location + t.x,
			width: e.size
		});
	...
	#z() {
		...
		for (let t of e) for (let [e, n] of t.paramRuntime.paramConfigs) {
			...
			let r = Le(n.select);
			if (!Ke(r) || !r.encodings?.includes("x")) continue;
	...
	propagateInteraction(e) {
		ne(this, e, () => {
			...
			n ? D(e, () => !0, () => this.#t.view.propagateInteraction(e), () => ie(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator)) : r && ie(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator), !e.stopped && D(e, () => this.sidebarCoords.containsPoint(e.point.x, e.point.y), () => this.#n.propagateInteraction(e));
		});
	}
	#U(e, t, n) {
	...
	constructor(e, t, n, r, a) {
		...
		let o = ye(a);
		o && (this.groupBackground = new i(o, t.context, t, e, "sample-group-background-" + n), lt(this.groupBackground, { skipSubtree: !0 }));
		let s = N(a);
		s && (this.groupBackgroundStroke = new i(s, t.context, t, e, "sample-group-background-stroke-" + n), lt(this.groupBackgroundStroke, { skipSubtree: !0 })), this.summaryViews = r;
	}
	allowDuplicateAxes() {
		return !0;
	}
	async syncGuideViews() {
		let e = F(this.summaryViews), t = new Set(e);
		if (await super.syncGuideViews({
			legendOwners: [...F(this.view), ...e],
	...
	getOverhangWithoutYAxes() {
		let e = (e) => xe(this.axes[e]), t = new rt(0, e("right"), 0, e("left"));
...
var i_ = class {
	...
	update(e, [t, n]) {
		if (Array.isArray(t)) {
			if (Array.isArray(this.ot) && this.ot.length === t.length && t.every((e, t) => e === this.ot[t])) return O;
	...
	_initializeGenome() {
		...
		if (e) {
			...
			let n = fe(() => this.requestUpdate(), 60, !1);
...
function p_(e, t, n) {
	...
	for (let i of e) for (let e of he(n, t, i)) if (e != null && r.add(String(e)), r.size >= n) return [...r];
	return [...r];
}
function m_(e) {
	let t;
	return e.visit((e) => {
		for (let n of ["x", "y"]) {
			...
			if (r && r.type == "locus" && r.isZoomable()) return t = r, St;
		}
	}), t;
}
var h_ = {
...
var __ = E(class extends v {
	...
	update(e, [t]) {
		...
		} else if (e.type === n.ATTRIBUTE && r.getAttribute(i) === t + "") return O;
		return Rt(e), t;
	}
});
//#endregion
...
}, Y_ = (e) => [...e.paramRuntime.paramConfigs.values()].some((e) => Ue(e) && e.bind), X_ = (e, t) => {
	let n = [];
	return t && n.push({
		label: "Parameters",
		type: "header"
...
function $_(e) {
	...
	for (let e of Q_) e.classList.remove("show"), document.body.classList.remove(ve), document.body.classList.remove(P);
	return Q_.clear(), e.stopPropagation(), n ? (Q_.add(t), t.classList.add("show"), document.body.classList.add(ve), document.body.classList.add(P), window.addEventListener("click", (e) => {
		t.classList.contains("show") && (t.classList.remove("show"), document.body.classList.remove(ve), document.body.classList.remove(P), e.preventDefault());
...
}, rv = (e) => !It(e) && typeof e.then == "function", iv = 1073741823, av = E(class extends Lt {
	constructor() {
		super(...arguments), this._$Cwt = iv, this._$Cbt = [], this._$CK = new tv(this), this._$CX = new nv();
	}
	render(...e) {
		return e.find((e) => !rv(e)) ?? O;
	}
	update(e, t) {
...
function Gy(e, t, n) {
	...
	function d(s) {
		return s === 33 ? (e.consume(s), f) : s === 47 ? (e.consume(s), a = !0, h) : s === 63 ? (e.consume(s), i = 3, r.interrupt ? t : F) : yv(s) ? (e.consume(s), o = String.fromCharCode(s), g) : n(s);
	}
	function f(a) {
		return a === 45 ? (e.consume(a), i = 2, p) : a === 91 ? (e.consume(a), i = 5, s = 0, m) : yv(a) ? (e.consume(a), i = 4, r.interrupt ? t : F) : n(a);
	}
	function p(i) {
	...
	function O(t) {
		return t === 45 && i === 2 ? (e.consume(t), M) : t === 60 && i === 1 ? (e.consume(t), N) : t === 62 && i === 4 ? (e.consume(t), te) : t === 63 && i === 3 ? (e.consume(t), F) : t === 93 && i === 5 ? (e.consume(t), P) : Y(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Hy, ne, k)(t)) : t === null || Y(t) ? (e.exit("htmlFlowData"), k(t)) : (e.consume(t), O);
	}
	function k(t) {
	...
	function ee(t) {
		if (t === 62) {
			let n = o.toLowerCase();
			return By.includes(n) ? (e.consume(t), te) : O(t);
		}
		return yv(t) && o.length < 8 ? (e.consume(t), o += String.fromCharCode(t), ee) : O(t);
	}
	function P(t) {
...
function Yy(e, t, n) {
	...
	function T(t) {
		return t === 47 ? (e.consume(t), M) : t === 58 || t === 95 || yv(t) ? (e.consume(t), E) : Y(t) ? (o = T, N(t)) : Z(t) ? (e.consume(t), T) : M(t);
	}
	function E(t) {
...
function Xb(e, t = {}) {
	...
	for (let e of r.querySelectorAll("a[href]")) e.setAttribute("target", "blank"), e.setAttribute("rel", "noopener noreferrer"), e.setAttribute("href", Ct(e.getAttribute("href"), t.baseUrl));
	for (let e of r.querySelectorAll("img[src]")) e.setAttribute("src", Ct(e.getAttribute("src"), t.baseUrl));
...
var hx = class extends L {
	...
	_getToolButtons() {
		...
		e.isEnabled() && t.push(R`
            ...
            `);
		let n = this.app.rootSpec.description ? Xe(this.app.rootSpec.description) : [];
...
var yx = "sampleCount", bx = class extends ze {
	#e = !0;
	#t;
	constructor(e, t) {
		super(), this.view = t;
	...
	initialize() {
		...
		if (Me(e)) this.xAccessor = Ie(e.field);
	...
	#r() {
		if (this.parent instanceof _) return this.parent;
	...
	#i(e) {
		let t = [...rr(e.rootGroup)].filter((e) => yn(Ae(e)));
...
var aS = 150, oS = class {
	...
	#g() {
		this.#r = xt(this.#e), this.#i.clear(), this.#u.clear();
		for (let e of this.#r) {
			let t = bt(e.selector);
	...
	#b(e) {
		...
		let n = this.#L(e);
		if (n === void 0 || Pe(e.param) && this.#Z(e.param, n) && this.#C(e, t)) return;
		let r = this.#P(e, n);
		if (r) {
			if (this.#x(e, n, t)) {
	...
	#x(e, t, n) {
		if (!Pe(e.param) || !this.#Z(e.param, t)) return !1;
	...
	#R(e, t) {
		...
		if (Pe(n)) {
			...
			if (Fe(i)) {
				...
				try {
					c = Ee(s, t, a, (e, t) => o.findDatumByKey(e, t));
				} catch (r) {
	...
	#X(e, t) {
		let n = e.param;
		Pe(n) && Fe(Le(n.select)) && (this.#N(e, "persist") || this.#u.add(t));
	}
	#Z(e, t) {
		let n = Le(e.select);
		return Fe(n) ? Je(t) ? !t.datum : !Ye(t) || t.data.size === 0 : Ke(n) ? !Be(t) : !1;
	}
	#Q(e) {
...
function lS(e, t) {
	...
	let i = e.payload, a = i.selector, o = r && "rule" in i ? { rule: i.rule } : r ? { predicate: i.predicate } : {}, s = r ? {
		...
		origin: i.origin,
		...o
	} : i.value, c = i.origin, l = yS(ut, t, a), u = l ? l.view : void 0, d = u ? fS(u, t) : null, f = uS(e, u, a, s, c, t);
	return {
		title: d ? R`${f} in ${d}` : f,
		icon: vS(s)
	};
...
function NS(e) {
	let t = !1;
	return dt(e, (e) => {
		if (gn(e) && (e.explicitName || kn(e))) return t = !0, St;
	}), t;
}
function PS(e) {
	return JSON.stringify(e);
...
var WS = class {
	...
	constructor(e, t, n = {}) {
		...
		}, this.ui = new US(), this.#r(), this.#a(e), this.#i(), re(R`<div class="genome-spy-app">
		...
		}), this.genomeSpy = new k(this.appContainer.getElementsByClassName("genome-spy-container")[0], this.rootSpec, this.options), this.debug = {
	...
	getAgentApi() {
		return this.#e ||= import("./agentApi-DFJ1LzrI.js").then((e) => e.t).then((e) => e.createAgentApi(this)), this.#e;
	}
	...
	async launch() {
		let e = this.isEmbedded() ? Promise.resolve([]) : this.rootSpec.bookmarks?.remote ? be({ baseURL: this.rootSpec.baseUrl }).load(this.rootSpec.bookmarks.remote.url).then((e) => Promise.resolve(JSON.parse(e))) : Promise.resolve([]);
		...
		let r = Xe(this.genomeSpy.spec.description ?? []);
	...
	getSampleView() {
		...
		return this.genomeSpy.viewRoot.visit((t) => {
			if (t instanceof kg) return e = t, St;
		}), e;
	}
};
function GS(e) {
	let t = e.bookmarks?.remote;
	if (t) return $e(et(e.baseUrl, t.url));
}
function KS(e) {
