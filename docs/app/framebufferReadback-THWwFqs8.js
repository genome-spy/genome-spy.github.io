import { d as e, i as t } from "./color-W5zffv-z.js";
import { a as n, n as r, o as i } from "./clipOptions-gqdb3fvW.js";
...
var Za = class extends a {
	...
	#u;
	constructor(e, n) {
		if (super(e), this.#i = n.webGLHelper, this.#r = n.framebufferInfo, this.#c = n.devicePixelRatio, this.#l = n.canvasSize, this.#o = n.markPredicate ?? (() => !0), this.#u = n.pixelOffset, n.clearColor) {
			let e = t(n.clearColor).rgb();
			this.#e = [
				e.r / 255,
				e.g / 255,
				e.b / 255,
	...
	renderMark(e, t) {
		...
		if (r) {
			...
			this.#n.push({
				...
				callback: r,
				coords: this.#s,
				clip: i(a, e.properties.clip, this.#s),
				cullClip: a
			});
		}
	}
	...
	#d() {
		...
		for (let [o, s] of [...a.entries()].reverse()) {
			...
			}), this.#t.push(...o.prepareRender(this.globalOptions).map((e) => n(e)));
			let a, c, l;
			for (let e of s) {
				let s = e.coords;
				(!s.equals(a) || !r(e.clip, c) || !r(e.cullClip, l)) && this.#t.push(n(() => {
