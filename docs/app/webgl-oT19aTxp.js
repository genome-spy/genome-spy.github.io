import { A as e, E as t, Gt as n, H as r, Kt as i, L as a, Tt as o, Wt as s, Yt as c, _t as l, b as u, cn as d, ct as f, d as p, dt as m, et as h, fn as g, gn as _, gt as v, ht as y, it as b, n as x, o as ee, ot as S, pt as te, qt as C, s as ne, un as re, ut as ie, vt as ae, yt as oe, z as se } from "./clipOptions-BWHr3aTa.js";
import { T as ce, b as w, g as le, it as ue, v as T, x as de, y as fe } from "./vega-scale-CypF85iS.js";
import { i as pe, n as me, p as he, r as ge, t as _e } from "./indexer-DAH_ruVn.js";
...
var nt = 35044, E = 34962, rt = 34963, it = 34660, at = 5120, ot = 5121, st = 5122, ct = 5123, lt = 5124, ut = 5125, dt = 5126, ft = { attribPrefix: "" };
		...
		if (!ht(r)) {
			...
			if (i.value) {
				...
				if (i.buffer && i.buffer instanceof WebGLBuffer) t = i.buffer, c = i.numComponents || i.size, o = i.type, s = i.normalize;
					...
					o = qe(a), s = i.normalize === void 0 ? _t(a) : i.normalize, c = i.numComponents || i.size || xt(r, n), t = e.createBuffer(), e.bindBuffer(E, t), e.bufferData(E, l, i.drawType || nt);
				} else {
					let n = Ct(i, r);
...
function Tt(e, t, n, r) {
	n = Ct(n), r === void 0 ? pt(e, E, t.buffer, n, t.drawType) : (e.bindBuffer(E, t.buffer), e.bufferSubData(E, r, n));
}
function Et(e, t) {
...
function Ot(e, t) {
	...
	let a = e.getBufferParameter(E, it);
	e.bindBuffer(E, null);
...
function Lr(e, t) {
	t.colorspaceConversion !== void 0 && e.pixelStorei(un, t.colorspaceConversion), t.premultiplyAlpha !== void 0 && e.pixelStorei(dn, t.premultiplyAlpha), t.flipY !== void 0 && e.pixelStorei(fn, t.flipY);
}
function Rr(e) {
	e.pixelStorei(rn, 4), At(e) && (e.pixelStorei(an, 0), e.pixelStorei(on, 0), e.pixelStorei(sn, 0), e.pixelStorei(cn, 0), e.pixelStorei(ln, 0));
}
function zr(e, t, n, r) {
	r.minMag && (n.call(e, t, Jt, r.minMag), n.call(e, t, Yt, r.minMag)), r.min && n.call(e, t, Jt, r.min), r.mag && n.call(e, t, Yt, r.mag), r.wrap && (n.call(e, t, Xt, r.wrap), n.call(e, t, Zt, r.wrap), (t === M || tt(e, t)) && n.call(e, t, Qt, r.wrap)), r.wrapR && n.call(e, t, Qt, r.wrapR), r.wrapS && n.call(e, t, Xt, r.wrapS), r.wrapT && n.call(e, t, Zt, r.wrapT), r.minLod && n.call(e, t, $t, r.minLod), r.maxLod && n.call(e, t, en, r.maxLod), r.baseLevel && n.call(e, t, tn, r.baseLevel), r.maxLevel && n.call(e, t, nn, r.maxLevel);
}
function Br(e, t, n) {
	let r = n.target || A;
	e.bindTexture(r, t), zr(e, r, e.texParameteri, n);
}
function Vr(e) {
	return e ||= D.textureColor, Mt(e) ? e : new Uint8Array([
		e[0] * 255,
		e[1] * 255,
		e[2] * 255,
		e[3] * 255
...
function Hr(e, t, n, r, i, a) {
	...
	let o = n.target || A;
	if (r ||= n.width, i ||= n.height, e.bindTexture(o, t), Nr(e, r, i, a)) e.generateMipmap(o);
	else {
		let t = Pr(a) ? Vt : Bt;
		e.texParameteri(o, Jt, t), e.texParameteri(o, Yt, t), e.texParameteri(o, Xt, zt), e.texParameteri(o, Zt, zt);
	}
}
function Ur(e) {
...
function Kr(e, t, n, r) {
	r ||= D.textureOptions;
	let i = r.target || A, a = r.level || 0, o = n.width, s = n.height, c = r.internalFormat || r.format || k, l = jr(c), u = r.format || l.format, d = r.type || l.type;
	if (Lr(e, r), e.bindTexture(i, t), i === j) {
		...
		let h = Nt();
		h ? (h.canvas.width = p, h.canvas.height = p, o = p, s = p, Gr(e, r).forEach(function(t) {
			let r = m[t.ndx * 2 + 0] * p, i = m[t.ndx * 2 + 1] * p;
			h.drawImage(n, r, i, p, p, 0, 0, p, p), e.texImage2D(t.face, a, c, u, d, h.canvas);
		}), h.canvas.width = 1, h.canvas.height = 1) : typeof createImageBitmap < "u" && (o = p, s = p, Gr(e, r).forEach(function(l) {
			let f = m[l.ndx * 2 + 0] * p, h = m[l.ndx * 2 + 1] * p;
			e.texImage2D(l.face, a, c, p, p, 0, u, d, null), createImageBitmap(n, f, h, p, p, {
				premultiplyAlpha: "none",
				colorSpaceConversion: "none"
			}).then(function(n) {
				Lr(e, r), e.bindTexture(i, t), e.texImage2D(l.face, a, c, u, d, n), Ur(r) && Hr(e, t, r, o, s, c);
			});
		}));
	} else if (i === M || i === N) {
		...
		e.pixelStorei(rn, 1), e.pixelStorei(an, n.width), e.pixelStorei(on, 0), e.pixelStorei(ln, 0), e.texImage3D(i, a, c, t, t, t, 0, u, d, null);
		for (let r = 0; r < o; ++r) {
			let o = r * t * s, c = r * t * l;
			e.pixelStorei(sn, o), e.pixelStorei(cn, c), e.texSubImage3D(i, a, 0, 0, r, t, t, 1, u, d, n);
		}
		Rr(e);
	} else e.texImage2D(i, a, c, u, d, n);
	Ur(r) && Hr(e, t, r, o, s, c), Br(e, t, r);
}
function qr() {}
function Jr(e) {
...
function Yr(e, t) {
	return t === void 0 && !Jr(e) ? "anonymous" : t;
}
function Xr(e, t, n) {
	n ||= qr;
	let r;
	if (t = t === void 0 ? D.crossOrigin : t, t = Yr(e, t), typeof Image < "u") {
...
function Qr(e, t, n) {
	return Zr(e) ? (setTimeout(function() {
		n(null, e);
	}), e) : Xr(e, t, n);
}
function $r(e, t, n) {
	...
	let i = Vr(n.color);
	if (r === j) for (let t = 0; t < 6; ++t) e.texImage2D(Ht + t, 0, k, 1, 1, 0, k, F, i);
	else r === M || r === N ? e.texImage3D(r, 0, k, 1, 1, 1, 0, k, F, i) : e.texImage2D(r, 0, k, 1, 1, 0, k, F, i);
}
function ei(e, t, n, r) {
	return r ||= qr, n ||= D.textureOptions, $r(e, t, n), n = Object.assign({}, n), Qr(n.src, n.crossOrigin, function(i, a) {
		i ? r(i, t, a) : (Kr(e, t, a, n), r(null, t, a));
	});
}
function ti(e, t, n, r) {
	r ||= qr;
	...
	let a = n.level || 0, o = n.internalFormat || n.format || k, s = jr(o), c = n.format || s.format, l = n.type || F, u = n.target || A;
	if (u !== j) throw "target must be TEXTURE_CUBE_MAP";
	$r(e, t, n), n = Object.assign({}, n);
	let d = 6, f = [], p = Wr(e, n), m;
	function h(i) {
		return function(s, p) {
			--d, s ? f.push(s) : p.width === p.height ? (Lr(e, n), e.bindTexture(u, t), d === 5 ? Wr().forEach(function(t) {
				e.texImage2D(t, a, o, c, l, p);
			}) : e.texImage2D(i, a, o, c, l, p), Ur(n) && e.generateMipmap(u)) : f.push("cubemap face img is not a square: " + p.src), d === 0 && r(f.length ? f : void 0, t, m);
		};
	}
	m = i.map(function(e, t) {
		return Qr(e, n.crossOrigin, h(p[t]));
	});
}
function ni(e, t, n, r) {
	r ||= qr;
	let i = n.src, a = n.internalFormat || n.format || k, o = jr(a), s = n.format || o.format, c = n.type || F, l = n.target || N;
	...
	function v(i) {
		return function(o, v) {
			if (--u, o) d.push(o);
				...
				Ur(n) && e.generateMipmap(l);
			}
			u === 0 && r(d.length ? d : void 0, t, f);
		};
	}
	f = i.map(function(e, t) {
		return Qr(e, n.crossOrigin, v(t));
	});
}
function ri(e, t, n, r) {
	r ||= D.textureOptions;
	let i = r.target || A;
	e.bindTexture(i, t);
	let a = r.width, o = r.height, s = r.depth, c = r.level || 0, l = r.internalFormat || r.format || k, u = jr(l), d = r.format || u.format, f = r.type || Fr(e, n, u.type);
	Mt(n) ? n instanceof Uint8ClampedArray && (n = new Uint8Array(n.buffer)) : n = new (Je(f))(n);
	let p = Ar(l, f), m = n.byteLength / p;
	...
	if (i === M || i === N) if (!a && !o && !s) {
		...
		a = e, o = e, s = e;
	} else a && (!o || !s) ? (h = Ir(e, i, o, s, m / a), o = h.width, s = h.height) : o && (!a || !s) ? (h = Ir(e, i, a, s, m / o), a = h.width, s = h.height) : (h = Ir(e, i, a, o, m / s), a = h.width, o = h.height);
	else h = Ir(e, i, a, o, m), a = h.width, o = h.height;
	if (Rr(e), e.pixelStorei(rn, r.unpackAlignment || 1), Lr(e, r), i === j) {
...
function ii(e, t, n) {
	let r = n.target || A;
	e.bindTexture(r, t);
	let i = n.level || 0, a = n.internalFormat || n.format || k, o = jr(a), s = n.format || o.format, c = n.type || o.type;
	if (Lr(e, n), r === j) for (let t = 0; t < 6; ++t) e.texImage2D(Ht + t, i, a, n.width, n.height, 0, s, c, null);
	else r === M || r === N ? e.texImage3D(r, i, a, n.width, n.height, n.depth, 0, s, c, null) : e.texImage2D(r, i, a, n.width, n.height, 0, s, c, null);
}
function ai(e, t, n) {
	n ||= qr, t ||= D.textureOptions;
	let r = e.createTexture(), i = t.target || A, a = t.width || 1, o = t.height || 1, s = t.internalFormat || k;
	e.bindTexture(i, r), i === j && (e.texParameteri(i, Xt, zt), e.texParameteri(i, Zt, zt));
	let c = t.src;
	if (c) if (typeof c == "function" && (c = c(e, t)), typeof c == "string") ei(e, r, t, n);
	else if (Mt(c) || Array.isArray(c) && (typeof c[0] == "number" || Array.isArray(c[0]) || Mt(c[0]))) {
		let n = ri(e, r, c, t);
		a = n.width, o = n.height;
	} else Array.isArray(c) && (typeof c[0] == "string" || Zr(c[0])) ? i === j ? ti(e, r, t, n) : ni(e, r, t, n) : (Kr(e, r, c, t), a = c.width, o = c.height);
	else ii(e, r, t);
	return Ur(t) && Hr(e, r, t, a, o, s), Br(e, r, t), r;
}
function oi(e, t, n, r, i, a) {
	r ||= n.width, i ||= n.height, a ||= n.depth;
	let o = n.target || A;
	e.bindTexture(o, t);
	let s = n.level || 0, c = n.internalFormat || n.format || k, l = jr(c), u = n.format || l.format, d, f = n.src;
	if (d = f && (Mt(f) || Array.isArray(f) && typeof f[0] == "number") ? n.type || Fr(e, f, l.type) : n.type || l.type, o === j) for (let t = 0; t < 6; ++t) e.texImage2D(Ht + t, s, c, r, i, 0, u, d, null);
	else o === M || o === N ? e.texImage3D(o, s, c, r, i, a, 0, u, d, null) : e.texImage2D(o, s, c, r, i, 0, u, d, null);
}
var si = Ze, ci = 33984, li = 35048, ui = 34962, di = 34963, fi = 35345, pi = 35718, mi = 35721, hi = 35971, gi = 35382, _i = 35396, vi = 35398, yi = 35392, bi = 35395, xi = 5126, Si = 35664, Ci = 35665, wi = 35666, Ti = 5124, Ei = 35667, Di = 35668, Oi = 35669, ki = 35670, Ai = 35671, ji = 35672, Mi = 35673, Ni = 35674, Pi = 35675, Fi = 35676, Ii = 35678, Li = 35680, Ri = 35679, zi = 35682, Bi = 35685, Vi = 35686, Hi = 35687, Ui = 35688, Wi = 35689, Gi = 35690, Ki = 36289, qi = 36292, Ji = 36293, Yi = 5125, Xi = 36294, Zi = 36295, Qi = 36296, $i = 36298, ea = 36299, ta = 36300, na = 36303, ra = 36306, ia = 36307, aa = 36308, oa = 36311, sa = 3553, ca = 34067, la = 32879, ua = 35866, U = {};
function da(e, t) {
...
function W(e, t, n, r) {
	...
	return At(e) ? function(t) {
		let a, o;
		et(e, t) ? (a = t, o = null) : (a = t.texture, o = t.sampler), e.uniform1i(r, n), e.activeTexture(ci + n), e.bindTexture(i, a), e.bindSampler(n, o);
	} : function(t) {
		e.uniform1i(r, n), e.activeTexture(ci + n), e.bindTexture(i, t);
	};
}
function G(e, t, n, r, i) {
	let a = da(e, t), o = new Int32Array(i);
	for (let e = 0; e < i; ++e) o[e] = n + e;
	return At(e) ? function(t) {
		e.uniform1iv(r, o), t.forEach(function(t, r) {
			e.activeTexture(ci + o[r]);
			let i, s;
			et(e, t) ? (i = t, s = null) : (i = t.texture, s = t.sampler), e.bindSampler(n, s), e.bindTexture(a, i);
		});
	} : function(t) {
		e.uniform1iv(r, o), t.forEach(function(t, n) {
			e.activeTexture(ci + o[n]), e.bindTexture(a, t);
		});
	};
}
U[xi] = {
...
function Ia(e, t) {
	return function(n) {
		...
		else e.bindBuffer(ui, n.buffer), e.enableVertexAttribArray(t), e.vertexAttribPointer(t, n.numComponents || n.size, n.type || xi, n.normalize || !1, n.stride || 0, n.offset || 0), n.divisor !== void 0 && e.vertexAttribDivisor(t, n.divisor);
	};
}
function K(e, t) {
	return function(n) {
		...
		else e.bindBuffer(ui, n.buffer), e.enableVertexAttribArray(t), e.vertexAttribIPointer(t, n.numComponents || n.size, n.type || Ti, n.stride || 0, n.offset || 0), n.divisor !== void 0 && e.vertexAttribDivisor(t, n.divisor);
	};
}
function La(e, t) {
	return function(n) {
		...
		else e.bindBuffer(ui, n.buffer), e.enableVertexAttribArray(t), e.vertexAttribIPointer(t, n.numComponents || n.size, n.type || Yi, n.stride || 0, n.offset || 0), n.divisor !== void 0 && e.vertexAttribDivisor(t, n.divisor);
	};
}
function Ra(e, t, n) {
	let r = n.size, i = n.count;
	return function(n) {
		e.bindBuffer(ui, n.buffer);
		let a = n.size || n.numComponents || r, o = a / i, s = n.type || xi, c = U[s].size * a, l = n.normalize || !1, u = n.offset || 0, d = c / i;
...
var Ba = /(\.|\[|]|\w+)/g, Va = (e) => e >= "0" && e <= "9";
function Ha(e, t, n, r) {
	let i = e.split(Ba).filter((e) => e !== ""), a = 0, o = "";
	for (;;) {
		let e = i[a++];
		o += e;
		let s = Va(e[0]), c = s ? parseInt(e) : e;
...
function Ua(e, t) {
	...
	let i = {}, a = {}, o = e.getProgramParameter(t, pi);
	for (let n = 0; n < o; ++n) {
...
function Ga(e, t) {
	let n = e.getProgramParameter(t, pi), r = [], i = [];
	for (let a = 0; a < n; ++a) {
		i.push(a), r.push({});
	...
	let a = {}, o = e.getProgramParameter(t, gi);
	for (let n = 0; n < o; ++n) {
		let r = e.getActiveUniformBlockName(t, n), i = {
			index: e.getUniformBlockIndex(t, r),
			usedByVertexShader: e.getActiveUniformBlockParameter(t, n, _i),
			usedByFragmentShader: e.getActiveUniformBlockParameter(t, n, vi),
			size: e.getActiveUniformBlockParameter(t, n, yi),
			uniformIndices: e.getActiveUniformBlockParameter(t, n, bi)
		};
...
function Ya(e, t, n, r) {
	...
	if (!o) return si("no uniform block object named:", r), {
		name: r,
		uniforms: {}
	};
	let s = new ArrayBuffer(o.size), c = e.createBuffer(), l = o.index;
	e.bindBuffer(fi, c), e.uniformBlockBinding(t, o.index, l);
	let u = r + ".";
	Ka.test(u) && (u = u.replace(Ka, "."));
	let d = {}, f = {}, p = {};
	return o.uniformIndices.forEach(function(e) {
		...
		let i = U[t.type], o = i.Type, c = r ? qa(i.size, 16) * t.size : i.size * t.size, l = new o(s, t.offset, c / o.BYTES_PER_ELEMENT);
		d[n] = l;
		let m = Ja(l, r, i.rows, i.cols);
		f[n] = m, Ha(n, m, p, f);
	}), {
		name: r,
		array: s,
...
function Xa(e, t, n) {
	return Ya(e, t.program, t.uniformBlockSpec, n);
}
function Za(e, t, n) {
	let r = (t.uniformBlockSpec || t).blockSpecs[n.name];
	if (r) {
		let t = r.index;
		return e.bindBufferRange(fi, t, n.buffer, n.offset || 0, n.array.byteLength), !0;
	}
	return !1;
}
function Qa(e, t, n) {
	Za(e, t, n) && e.bufferData(fi, n.array, li);
}
function $a(e, t) {
	let n = e.setters;
	for (let e in t) {
...
function eo(e, t) {
	for (let n in t) {
		let r = e[n];
		typeof r == "function" ? r(t[n]) : eo(e[n], t[n]);
	}
}
function J(e, ...t) {
...
function Y(e, t, n) {
	n.vertexArrayObject ? e.bindVertexArray(n.vertexArrayObject) : (no(t.attribSetters || t, n.attribs), n.indices && e.bindBuffer(di, n.indices));
}
function ro(e, t) {
	let n = {
		program: t,
		uniformSetters: Ua(e, t),
		attribSetters: to(e, t)
	};
	return At(e) && (n.uniformBlockSpec = Ga(e, t), n.transformFeedbackInfo = Wa(e, t)), n;
}
var io = 4, ao = 5123;
function oo(e, t, n, r, i, a) {
	n = n === void 0 ? io : n;
	let o = t.indices, s = t.elementType, c = r === void 0 ? t.numElements : r;
	i = i === void 0 ? 0 : i, s || o ? a === void 0 ? e.drawElements(n, c, s === void 0 ? ao : t.elementType, i) : e.drawElementsInstanced(n, c, s === void 0 ? ao : t.elementType, i, a) : a === void 0 ? e.drawArrays(n, i, c) : e.drawArraysInstanced(n, i, c, a);
}
var so = 36160, X = 36161, co = 3553, lo = 5121, uo = 6402, fo = 6408, po = 33190, mo = 36012, ho = 35056, go = 36013, _o = 32854, vo = 32855, yo = 36194, bo = 33189, xo = 6401, So = 36168, Co = 34041, wo = 36064, To = 36096, Eo = 36128, Do = 33306, Oo = 33071, ko = 9729, Ao = [{
	format: fo,
	type: lo,
	min: ko,
	wrap: Oo
}, { format: Co }], Z = {};
Z[Co] = Do, Z[xo] = Eo, Z[So] = Eo, Z[uo] = To, Z[bo] = To, Z[po] = To, Z[mo] = To, Z[ho] = Do, Z[go] = Do;
function jo(e, t) {
	return Z[e] || Z[t];
}
var Q = {};
Q[_o] = !0, Q[vo] = !0, Q[yo] = !0, Q[Co] = !0, Q[bo] = !0, Q[xo] = !0, Q[So] = !0;
function Mo(e) {
	return Q[e];
}
function No(e) {
...
function Po(e, t, n, r) {
	let i = so, a = e.createFramebuffer();
	e.bindFramebuffer(i, a), n ||= e.drawingBufferWidth, r ||= e.drawingBufferHeight, t ||= Ao;
	let o = [], s = {
		framebuffer: a,
		attachments: [],
		width: n,
	...
	return t.forEach(function(t, a) {
		let c = t.attachment, l = t.samples, u = t.format, d = t.attachmentPoint || jo(u, t.internalFormat);
		if (d ||= wo + a, No(d) && o.push(d), !c) if (l !== void 0 || Mo(u)) c = e.createRenderbuffer(), e.bindRenderbuffer(X, c), l > 1 ? e.renderbufferStorageMultisample(X, l, u, n, r) : e.renderbufferStorage(X, u, n, r);
		else {
			let i = Object.assign({}, t);
			i.width = n, i.height = r, i.auto === void 0 && (i.auto = !1, i.min = i.min || i.minMag || ko, i.mag = i.mag || i.minMag || ko, i.wrapS = i.wrapS || i.wrap || Oo, i.wrapT = i.wrapT || i.wrap || Oo), c = ai(e, i);
		}
		if ($e(e, c)) e.framebufferRenderbuffer(i, d, X, c);
		else if (et(e, c)) t.layer === void 0 ? e.framebufferTexture2D(i, d, t.target || co, c, t.level || 0) : e.framebufferTextureLayer(i, d, c, t.level || 0, t.layer);
		else throw Error("unknown attachment type");
		s.attachments.push(c);
	}), e.drawBuffers && e.drawBuffers(o), s;
}
function Fo(e, t, n, r, i) {
	r ||= e.drawingBufferWidth, i ||= e.drawingBufferHeight, t.width = r, t.height = i, n ||= Ao, n.forEach(function(n, a) {
...
var Lo = { addExtensionsToContext: !0 }, Ro = /^(.*?)_/;
function zo(e, t) {
	jt(e, 0);
	let n = e.getExtension(t);
	if (n) {
		let r = {}, i = Ro.exec(t)[1], a = "_" + i;
		for (let t in n) {
...
function Vo(e) {
	for (let t = 0; t < Bo.length; ++t) zo(e, Bo[t]);
}
function Ho(e, t) {
	let n = [
		"webgl2",
	...
	for (let i = 0; i < n.length; ++i) if (r = e.getContext(n[i], t), r) {
		Lo.addExtensionsToContext && Vo(r);
		break;
	}
	return r;
}
...
function Wo(e, t, n, r, a = !1) {
	let o = c(e) ? e : e.name, l = !c(e) && e.extent || [0, 1];
	if (n === void 0 && !c(e) && (n = e.count), o) {
		...
		} else if (s(e)) return qo(a ? Array.from(e).reverse() : e, t, n, r);
		else throw Error("Unknown scheme: " + o);
	}
}
function Go(e, t = "rgb", n, r) {
	let i = Jo(le(e, c(t) ? t : t.type, c(t) ? void 0 : t.gamma));
	return Ws(n, {
		minMag: n.LINEAR,
		format: n.RGB,
		height: 1,
...
function Jo(e, { extent: t = [0, 1], reverse: n = !1, count: r = 256 } = {}) {
	let i = t[0], a = re(t) - i, o = _(r).map((e) => e / (r - 1)).map((e) => i + e / a).map(e);
	return n && o.reverse(), Yo(o);
}
function Yo(e, t) {
	let n = Math.max(e.length, t || 0), r = new Uint8Array(n * 3);
	for (let t = 0; t < n; t++) {
		let n = e[t % e.length], i = p(n);
...
var Zo = "attr_", Qo = "uDomain_", $o = "range_", es = "accessor_", ts = "scale_", ns = "getScaled_", rs = "uRangeTexture_", $ = "uParam_", is = "checkSelection_", as = "isSelectionMember_", os = "isSelectionEmpty_";
function ss(e) {
	let t = e.match(/^(?:(\w+)-)?(\w+)$/);
...
function fs(e, t) {
	let n = "float", r = (e) => e;
	y(e) ? (n = "vec3", r = (e) => Xo(e)) : l(e) && (r = S(e));
	let i = `u${js(e)}_${t}`, a = `    // Dynamic value\n    uniform ${n} ${i};`, o = us(e, t);
	return {
		channel: e,
		uniformName: i,
		uniformGlsl: a,
...
function ps(e, t, n, r = [e]) {
	let { attributeType: i } = ws(t, e), a = As(r), o = `in highp ${i} ${a};`, s = us(e, n);
	return {
		channel: e,
		attributeName: a,
		attributeGlsl: o,
...
function ms(e, t, n) {
	let { attributeType: r } = ws(t, e), i = As(e), a = `    uniform highp ${r} ${i};`, o = us(e, n);
	return {
		channel: e,
		uniformName: i,
		uniformGlsl: a,
...
function hs(e, t, n) {
	t ??= me();
	let r = ie(e), i = Qo + r, a = $o + r, { hp: o, attributeType: s } = ws(t, e), c = t.domain ? w(t.type) ? cs(t).length : t.domain().length : void 0, l, d = [];
	d.push(""), d.push("/".repeat(70)), d.push(`// Channel: ${e}`), d.push("");
	let { transform: f } = ss(t.type), p = (e, ...t) => Cs.apply(null, [
		e,
		"value",
		...t
	]), m;
	switch (f) {
		case "linear":
			m = p("scaleLinear", "domain", a);
			break;
		case "log":
			m = p("scaleLog", "domain", a, t.base());
			break;
		case "symlog":
			m = p("scaleSymlog", "domain", a, t.constant());
			break;
		case "pow":
		case "sqrt":
			m = p("scalePow", "domain", a, t.exponent());
			break;
		case "index":
		case "locus":
			m = p("scaleBandHp", "domain", a, t.paddingInner(), t.paddingOuter(), t.align(), n.band ?? .5);
			break;
		case "point":
		case "band":
			m = p("scaleBand", "domain", a, t.paddingInner(), t.paddingOuter(), t.align(), n.band ?? .5);
			break;
		case "ordinal":
		case "null":
		case "identity":
	...
	if (h && e == r) {
		...
		if (u(e) || e.some(u)) {
			...
			g = `    uniform ${ys(h.length)} ${a};`;
		} else if (h.length && h.every(C)) {
			let e = Ss(h);
			d.push(`const ${e.type} ${a} = ${e};`);
		}
	}
	let _ = bs(e), v;
	if (y(e)) {
		let n = rs + r;
		if (e == r && d.push(`uniform sampler2D ${n};`), T(t.type)) v = `getInterpolatedColor(${n}, transformed)`;
		else if (fe(t.type) || w(t.type)) v = `getDiscreteColor(${n}, int(transformed))`;
		else throw Error("Problem with color scale!");
	} else if (t.type === "ordinal" || w(t.type)) {
		let t = rs + r;
		e == r && d.push(`uniform sampler2D ${t};`), v = `getDiscreteColor(${t}, int(transformed)).r`;
	}
	let b = [], x = T(t.type) && c > 2, ee = w(t.type) || x;
	if (b.push("int slot = 0;"), ee) {
		let e = i;
		b.push(x ? `while (slot < ${e}.length() - 2 && value >= ${e}[slot + 1]) { slot++; }` : `while (slot < ${e}.length() && value >= ${e}[slot]) { slot++; }`);
	}
	let S = T(t.type) || w(t.type) || ["band", "point"].includes(t.type);
	if (m) {
		let e = i;
		S && (o ? b.push(`vec3 domain = ${e};`) : b.push(`vec2 domain = vec2(${e}[slot], ${e}[slot + 1]);`)), b.push(`float transformed = ${m};`), x && b.push(`transformed = (float(slot) + transformed) / (float(${e}.length() - 1));`);
	} else b.push("float transformed = float(slot);");
	"clamp" in t && t.clamp() && b.push(`transformed = clampToRange(transformed, ${Ss(h)});`), b.push(`return ${v ?? "transformed"};`), d.push(`
${_} ${ts}${e}(${s} value) {
${b.map((e) => `    ${e}\n`).join("")}
}`);
	let te = d.join("\n");
	if (S && e == r) {
		let e = T(t.type) || w(t.type) ? c : 2;
...
function gs(e, t) {
	...
	for (let n = 0; n < t.length; n++) {
		let { accessor: a, predicate: o } = t[n], s = us(e, n), { selection: c } = o;
		if (c && !c.singleParam) {
			let e = c.empty, t = c.params.map((e) => `${as}${e}()`), n = c.params.map((e) => `${os}${e}()`);
			r.push(`(${t.join(" || ")}${e ? ` || (${n.join(" && ")})` : ""})`);
		} else r.push(c ? `${is}${c.params[0]}(${c.empty})` : null);
		i.push(a.scaleChannel ? `return ${ts}${e}(${s}());` : `return ${s}();`);
	}
	return `${n} ${ns}${e}() {
${Ns(r, i)}
}
...
function _s(e) {
	if (!C(e)) throw Error(`Not a number: ${e}`);
...
function bs(e) {
	return y(e) ? "vec3" : e == "uniqueId" ? "uint" : "float";
}
function xs(e) {
	return vs(Xo(e));
}
...
function Cs(e, ...t) {
	let n = [];
	for (let e of t) C(e) ? n.push(_s(e)) : s(e) ? n.push(vs(e)) : n.push(e);
	return `${e}(${n.join(", ")})`;
}
function ws(e, t) {
...
function As(e) {
	return Zo + d(e).toSorted().join("_");
}
function js(e) {
	return e[0].toUpperCase() + e.slice(1);
}
var Ms = (e, t) => de(e.type) || T(e.type) && y(t) ? [0, 1] : e.range ? e.range() : void 0;
function Ns(e, t) {
...
function zs(e, t) {
	if (!Number.isSafeInteger(e) || e < 0 || e > Fs) throw Error(t + " must be a non-negative u32.");
	return e >>> 0;
}
function Bs(e) {
	let t = Math.max(1, e);
...
var Vs = class {
	...
	constructor(e, t, n = {}, r) {
		...
		let a = document.createElement("canvas"), o = Uo(a, {
			antialias: !0,
			depth: !1,
		...
		if (!At(o)) throw Error("Your web browser does not support WebGL 2.0. Chrome, Firefox, and Safari Tech Preview should work.");
		Vo(o);
		...
		}], this._pickingBufferInfo = Po(o, this._pickingAttachmentOptions), o.bindFramebuffer(o.FRAMEBUFFER, null), e.appendChild(a);
		try {
	...
	adjustGl() {
		...
		return this._appliedCanvasSize && this._appliedCanvasSize.logicalWidth == e.width && this._appliedCanvasSize.logicalHeight == e.height && this._appliedCanvasSize.physicalWidth == t.width && this._appliedCanvasSize.physicalHeight == t.height ? !1 : (this.canvas.style.width = `${e.width}px`, this.canvas.style.height = `${e.height}px`, this.canvas.width = t.width, this.canvas.height = t.height, Fo(this.gl, this._pickingBufferInfo, this._pickingAttachmentOptions), this._appliedCanvasSize = {
	...
	createRangeTexture(e, t = !1) {
		...
		if (!t && n) return;
		function r(e, t) {
			return fe(t.type) ? t.domain().length : t.type == "threshold" || t.type == "quantize" ? ls(t) : t.type == "quantile" ? e ?? 4 : e;
		}
		let i = e.channel;
		if (y(i)) {
			let t = e.getScale(), i = t.props, a = t.range(), o;
			if (i.scheme) if (fe(t.type) || w(t.type)) o = qo(a, this.gl, ls(t), n);
			else {
				let e = c(i.scheme) ? void 0 : i.scheme.count;
				e = r(e, t), o = Wo(i.scheme, this.gl, e, n, !!i.reverse);
			}
			else o = de(t.type) || T(t.type) && a.length > 1 ? Go(a, i.interpolate, this.gl, n) : qo(a, this.gl, w(t.type) ? ls(t) : t.domain().length, n);
			this.rangeTextures.set(t, o), this._ownedTextures.add(o);
		} else {
			let t = e.getScale();
			if (t.type === "ordinal" || w(t.type)) {
				let e = l(i) ? S(i) : (e) => e, r = Ko(t.range().map(e), this.gl, w(t.type) ? ls(t) : t.domain().length, n);
				this.rangeTextures.set(t, r), this._ownedTextures.add(r);
			}
		}
	}
	createSelectionTexture(e, t = !0) {
		if (!se(e)) throw Error("Not a multi-point selection, cannot create texture");
		let { table: n, capacity: r } = Ls(e.data.keys()), { width: i, height: a } = Rs(r, this.gl.getParameter(this.gl.MAX_TEXTURE_SIZE)), o = this.selectionTextures.get(e), s = this.gl, c = Ws(this.gl, {
			auto: !1,
			level: 0,
			min: s.NEAREST,
			mag: s.NEAREST,
...
function Us(e, t, n) {
	...
	function i() {
		...
		if (!e.getProgramParameter(r, e.LINK_STATUS)) {
			...
			for (let r of [t, n]) e.getShaderParameter(r, e.COMPILE_STATUS) || (i = e.getShaderInfoLog(r), a = Hs(e.getShaderSource(r), i, 0) + `\nError compiling: ${i}`, e.deleteShader(r));
			e.deleteProgram(r);
		}
		if (i) return {
			message: i,
...
var Ks = class extends xe {
	...
	renderMark(e, t) {
		...
		this.#n.push({
			...
			clip: ne(n, e.properties.clip, this.#l),
			cullClip: n
		});
	}
	render() {
	...
	#p() {
		...
		for (let [o, s] of [...a.entries()].reverse()) {
			...
			for (let e of u) {
				let a = e.coords;
				(!a.equals(m) || !x(e.clip, h) || !x(e.cullClip, g)) && this.#t.push(r(() => {
	...
	#u({ layoutResult: e, canvasSize: t, devicePixelRatio: n }) {
		...
		we("layoutReplay", () => e.collectRenderCommands(new qs(i, a))), i.finish(), a.finish(), this.#o = i, this.#s = a;
	}
	renderAll() {
		let e = Ce();
...
function Ys(e, t, n = {}) {
	...
	return {
		pixels: $s(s, a, o, n.unpremultiplyAlpha ?? !1),
		width: a,
		height: o
	};
}
function Xs(e, t, n = "image/png", r = {}) {
	return Qs(e, t, r).toDataURL(n);
}
...
function Qs(e, t, n) {
	let { pixels: r, width: i, height: a } = Ys(e, t, n), o = document.createElement("canvas");
...
function tc({ glHelper: e, markAdapter: t, viewRoot: n, logicalWidth: r, logicalHeight: i, devicePixelRatio: a, clearColor: o = "white" }) {
	let { gl: s, framebufferInfo: c } = rc({
		glHelper: e,
		markAdapter: t,
		viewRoot: n,
		logicalWidth: r,
	...
	try {
		return Xs(s, c, "image/png");
	} finally {
		ic(s, c);
	}
}
async function nc({ glHelper: e, markAdapter: t, viewRoot: n, logicalWidth: r, logicalHeight: i, pixelRatio: a, clearColor: o = "white", mimeType: s = "image/png" }) {
	if (s != "image/png") throw Error(`Unsupported raster export MIME type: ${s}`);
	let { gl: c, framebufferInfo: l } = rc({
		glHelper: e,
		markAdapter: t,
		viewRoot: n,
		logicalWidth: r,
	...
	try {
		return await Zs(c, l, s);
	} finally {
		ic(c, l);
	}
}
function rc({ glHelper: e, markAdapter: t, viewRoot: n, logicalWidth: r, logicalHeight: i, pixelRatio: a, clearColor: o }) {
	r ??= e.getLogicalCanvasSize().width, i ??= e.getLogicalCanvasSize().height, a ??= window.devicePixelRatio ?? 1;
	let s = e.gl, c = Math.floor(r * a), l = Math.floor(i * a), u = Po(s, [{
		format: s.RGBA,
...
var ac = "flat out lowp vec4 vFillColor;\nflat out lowp vec4 vStrokeColor;\nflat out float vHalfStrokeWidth;\nflat out float vArrowHalfLengthInPixels;\nflat out float vHeadHalfWidth;\nflat out float vStemHalfWidth;\nflat out float vHeadStrokeWidth;\nflat out float vRHeadSlope;\nflat out float vRHeadNotchSlope;\nflat out float vRStartNotchSlope;\nflat out float vHeadRepeatFootprintLength;\nflat out float vHeadSpacing;\nflat out float vDirection;\n\nout vec2 vPosInPixels;\n\n/** Position along the arrow centerline. */\nin float pos;\n\n/** Which side of the extruded strip: -0.5 or 0.5. */\nin float side;\n\nfloat resolveStemHalfWidth(float arrowSize) {\n    if (uStem) {\n        return arrowSize * 0.5;\n    } else {\n        // The negative sign hides stem geometry; the magnitude remains\n        // available for open-head thickness.\n        return -arrowSize * 0.5;\n    }\n}\n\nfloat resolveHeadHalfWidth(float arrowSize) {\n    float headWidth = uHeadWidth * arrowSize;\n    return max(headWidth, 0.0) * 0.5;\n}\n\n// Width along the arrow axis needed by one repeated head, including stroke.\nfloat headRepeatFootprintLength(\n    float halfWidth,\n    float rHeadSlope,\n    float headStrokeWidth,\n    float halfStrokeWidth\n) {\n    float headAxisLength = halfWidth * rHeadSlope;\n    float headStrokeLength = headStrokeWidth / length(vec2(rHeadSlope, 1.0));\n    return headAxisLength + headStrokeLength + halfStrokeWidth * 2.0;\n}\n\n// Distance from the head tip to its centerline notch/join point.\nfloat headNotchOffset(\n    float headHalfWidth,\n    float rHeadSlope,\n    float rHeadNotchSlope,\n    float headStrokeWidth\n) {\n    if (headHalfWidth <= 0.0) {\n        return 0.0;\n    }\n\n    float headAxisLength = headHalfWidth * rHeadSlope;\n    vec2 topOuter = vec2(headAxisLength, headHalfWidth);\n    vec2 normalOffset = headStrokeWidth\n        * normalize(vec2(headHalfWidth, -headAxisLength));\n    vec2 topInner = topOuter + normalOffset;\n    return topInner.x - topInner.y * rHeadNotchSlope;\n}\n\n// Distance from the arrow tip to where the stem outer edge meets a filled\n// triangle head's notch edge. This is the effective occupied head length for\n// deciding when a short inside arrow needs to blunt its head angle.\nfloat triangleHeadStemJoinLength(\n    float stemHalfWidth,\n    float headHalfWidth,\n    float rHeadSlope,\n    float rHeadNotchSlope\n) {\n    float clampedRHeadNotchSlope = min(rHeadNotchSlope, rHeadSlope);\n    return headHalfWidth * rHeadSlope\n        - (headHalfWidth - stemHalfWidth) * clampedRHeadNotchSlope;\n}\n\n// Blunt non-repeated heads toward 90 degrees to preserve visible stem length.\nfloat effectiveHeadSlope(\n    float halfLength,\n    float headHalfWidth,\n    float stemHalfWidth,\n    float configuredRHeadSlope,\n    float configuredRHeadNotchSlope,\n    bool headRepeat\n) {\n    if (\n        headRepeat ||\n        stemHalfWidth < 0.0\n    ) {\n        return configuredRHeadSlope;\n    }\n\n    if (uHeadPlacement == HEAD_PLACEMENT_OUTSIDE) {\n        if (!uStartNotch || stemHalfWidth <= 0.0) {\n            return configuredRHeadSlope;\n        }\n\n        // Outside heads start at the encoded endpoint. The preserved length is\n        // therefore the encoded arrow length minus the start notch depth.\n        float maxStartNotchLength = max(\n            halfLength * 2.0 - uMinStemLength,\n            0.0\n        );\n        return min(\n            configuredRHeadSlope,\n            maxStartNotchLength / stemHalfWidth\n        );\n    }\n\n    if (uHeadShape != HEAD_SHAPE_TRIANGLE) {\n        return configuredRHeadSlope;\n    }\n\n    float maxJoinLength = max(\n        halfLength * 2.0 - uMinStemLength,\n        0.0\n    );\n    float configuredJoinLength = triangleHeadStemJoinLength(\n        stemHalfWidth,\n        headHalfWidth,\n        configuredRHeadSlope,\n        configuredRHeadNotchSlope\n    );\n\n    if (configuredJoinLength <= maxJoinLength) {\n        return configuredRHeadSlope;\n    }\n\n    float boundaryJoinLength = stemHalfWidth * configuredRHeadNotchSlope;\n    if (maxJoinLength < boundaryJoinLength) {\n        return stemHalfWidth > 0.0\n            ? clamp(maxJoinLength / stemHalfWidth, 0.0, configuredRHeadSlope)\n            : 0.0;\n    } else {\n        return clamp(\n            (\n                maxJoinLength +\n                (headHalfWidth - stemHalfWidth) * configuredRHeadNotchSlope\n            ) / headHalfWidth,\n            0.0,\n            configuredRHeadSlope\n        );\n    }\n}\n\n// Outside placement extends the vertex quad so the head can protrude past the\n// encoded interval while its notch/join point stays on the endpoint.\nfloat getOutsideHeadOffset(\n    float headHalfWidth,\n    float rHeadSlope,\n    float rHeadNotchSlope,\n    float headStrokeWidth\n) {\n    if (uHeadPlacement != HEAD_PLACEMENT_OUTSIDE) {\n        return 0.0;\n    }\n\n    return headNotchOffset(\n        headHalfWidth,\n        rHeadSlope,\n        rHeadNotchSlope,\n        headStrokeWidth\n    );\n}\n\nvec2 getOutsideHeadExpansion(float outsideHeadOffset, float direction) {\n    // Expansion is stored as negative/positive arrow-axis growth. In the\n    // canonical reverse direction, the head is on the negative side.\n    return direction == DIRECTION_REVERSE\n        ? vec2(outsideHeadOffset, 0.0)\n        : vec2(0.0, outsideHeadOffset);\n}\n\nvoid main(void) {\n#pragma orderGuard\n\n    vec2 a = applyOffset(\n        applySampleFacet(vec2(getScaled_x(), getScaled_y())),\n        vec2(getScaled_xOffset(), getScaled_yOffset())\n    );\n    vec2 b = applyOffset(\n        applySampleFacet(vec2(getScaled_x2(), getScaled_y2())),\n        vec2(getScaled_x2Offset(), getScaled_y2Offset())\n    );\n    float direction = getScaled_direction();\n\n    vec2 segmentInPixels = (b - a) * uViewportSize;\n    float segmentLength = length(segmentInPixels);\n    if (segmentLength <= 0.0) {\n        gl_Position = vec4(0.0, 0.0, 0.0, 1.0);\n        return;\n    }\n\n    float strokeWidth = getScaled_strokeWidth();\n    float strokeOpacity = getScaled_strokeOpacity() * uViewOpacity;\n    vHalfStrokeWidth = strokeWidth / 2.0;\n\n    float arrowSize = max(getScaled_size(), uMinSize);\n    float headHalfWidth = resolveHeadHalfWidth(arrowSize);\n    float stemHalfWidth = resolveStemHalfWidth(arrowSize);\n    float physicalStemHalfWidth = abs(stemHalfWidth);\n    float headStrokeWidth = uHeadShape == HEAD_SHAPE_OPEN\n        ? physicalStemHalfWidth * 2.0\n        : 0.0;\n    float configuredRHeadSlope = 1.0 / uHeadSlope;\n    float configuredRHeadNotchSlope = 1.0 / uHeadNotchSlope;\n    float rHeadSlope = effectiveHeadSlope(\n        segmentLength * 0.5,\n        headHalfWidth,\n        stemHalfWidth,\n        configuredRHeadSlope,\n        configuredRHeadNotchSlope,\n        uHeadSpacing >= 0.0\n    );\n    float rHeadNotchSlope = uHeadShape == HEAD_SHAPE_OPEN\n        ? rHeadSlope\n        : min(configuredRHeadNotchSlope, rHeadSlope);\n\n    // Grow only the head side of the vertex quad for outside placement.\n    float outsideHeadOffset = getOutsideHeadOffset(\n        headHalfWidth,\n        rHeadSlope,\n        rHeadNotchSlope,\n        headStrokeWidth\n    );\n    vec2 outsideHeadExpansion = getOutsideHeadExpansion(\n        outsideHeadOffset,\n        direction\n    );\n\n    float aaPadding = 1.0 / uDevicePixelRatio;\n    float stripHalfWidth = max(headHalfWidth, physicalStemHalfWidth)\n        + vHalfStrokeWidth\n        + aaPadding;\n\n    float reverseExpansion = outsideHeadExpansion.x;\n    float forwardExpansion = outsideHeadExpansion.y;\n    float geometryStart = -segmentLength * 0.5 - reverseExpansion;\n    float geometryEnd = segmentLength * 0.5 + forwardExpansion;\n    float geometryCenter = (geometryStart + geometryEnd) * 0.5;\n    float geometryHalfLength = (geometryEnd - geometryStart) * 0.5;\n\n    // The SDF geometry still uses the encoded arrow length, but the vertex\n    // strip needs room for stroke and antialiasing beyond both endpoints.\n    float axisPadding = vHalfStrokeWidth + aaPadding;\n    float drawStart = geometryStart - axisPadding;\n    float drawEnd = geometryEnd + axisPadding;\n    float localAxisPosition = mix(drawStart, drawEnd, pos);\n    float localX = localAxisPosition - geometryCenter;\n    float localY = side * stripHalfWidth * 2.0;\n\n    vec2 tangentInPixels = segmentInPixels / segmentLength;\n    vec2 normalInPixels = vec2(-tangentInPixels.y, tangentInPixels.x);\n    vec2 segmentCenter = (a + b) * 0.5;\n    vec2 p = segmentCenter\n        + (tangentInPixels * localAxisPosition + normalInPixels * localY)\n            / uViewportSize;\n\n    vPosInPixels = vec2(localX, localY);\n    vArrowHalfLengthInPixels = geometryHalfLength;\n\n    // These flat varyings are per-arrow geometry constants used by the fragment\n    // SDF. Keeping them here avoids repeating this math per fragment.\n    vHeadHalfWidth = headHalfWidth;\n    vStemHalfWidth = stemHalfWidth;\n    vHeadStrokeWidth = headStrokeWidth;\n    vRHeadSlope = rHeadSlope;\n    vRHeadNotchSlope = rHeadNotchSlope;\n    vRStartNotchSlope = uStartNotch ? vRHeadSlope : 0.0;\n    vDirection = direction;\n    vHeadRepeatFootprintLength = headRepeatFootprintLength(\n        vHeadHalfWidth,\n        vRHeadSlope,\n        vHeadStrokeWidth,\n        vHalfStrokeWidth\n    );\n    vHeadSpacing = uHeadSpacing >= 0.0 ? uHeadSpacing * arrowSize : -1.0;\n    vStrokeColor = vec4(getScaled_stroke() * strokeOpacity, strokeOpacity);\n\n    gl_Position = unitToNdc(p);\n\n    float fillOpacity = getScaled_fillOpacity() * uViewOpacity;\n    vFillColor = vec4(getScaled_fill() * fillOpacity, fillOpacity);\n\n    setupPicking();\n}\n", oc = "in vec2 vPosInPixels;\n\nflat in lowp vec4 vFillColor;\nflat in lowp vec4 vStrokeColor;\nflat in float vHalfStrokeWidth;\nflat in float vArrowHalfLengthInPixels;\nflat in float vHeadHalfWidth;\nflat in float vStemHalfWidth;\nflat in float vHeadStrokeWidth;\nflat in float vRHeadSlope;\nflat in float vRHeadNotchSlope;\nflat in float vRStartNotchSlope;\nflat in float vHeadRepeatFootprintLength;\nflat in float vHeadSpacing;\nflat in float vDirection;\n\nout lowp vec4 fragColor;\n\nconst int N = 6;\nconst float FAR_OUTSIDE = 1e20;\n\n// Adapted from: https://iquilezles.org/articles/distfunctions2d/\nfloat sdPolygon(vec2[N] v, vec2 p) {\n    float d = dot(p-v[0],p-v[0]);\n    float s = 1.0;\n    for( int i=0, j=N-1; i<N; j=i, i++ ) {\n        vec2 e = v[j] - v[i];\n        vec2 w =    p - v[i];\n        vec2 b = w - e*clamp( dot(w,e)/dot(e,e), 0.0, 1.0 );\n        d = min( d, dot(b,b) );\n        bvec3 c = bvec3(p.y>=v[i].y,p.y<v[j].y,e.x*w.y>e.y*w.x);\n        if( all(c) || all(not(c)) ) s*=-1.0;  \n    }\n    return s*sqrt(d);\n}\n\nfloat sdStem(\n    vec2 p,\n    float halfLength,\n    float halfWidth,\n    float rHeadSlope,\n    float rStartNotchSlope\n) {\n    if (halfWidth < 0.0) {\n        return FAR_OUTSIDE;\n    }\n\n    float headSideLength = halfWidth * rHeadSlope;\n    float startNotchLength = halfWidth * rStartNotchSlope;\n    vec2 vertices[6] = vec2[6](\n        vec2(-halfLength, 0.0),\n        vec2(-halfLength + headSideLength, halfWidth),\n        vec2(halfLength, halfWidth),\n        vec2(halfLength - startNotchLength, 0.0),\n        vec2(halfLength, -halfWidth),\n        vec2(-halfLength + headSideLength, -halfWidth)\n    );\n\n    return sdPolygon(vertices, p);\n}\n\n// Inner corner of an open head, offset perpendicular to the outer edge.\nvec2 headInnerCorner(float halfWidth, float rHeadSlope, float headStrokeWidth) {\n    float headAxisLength = halfWidth * rHeadSlope;\n    vec2 topOuter = vec2(headAxisLength, halfWidth);\n    vec2 normalOffset = headStrokeWidth\n        * normalize(vec2(halfWidth, -headAxisLength));\n    return topOuter + normalOffset;\n}\n\n// X coordinate where the arrowhead notch edge crosses the centerline.\nfloat headNotchX(\n    float halfWidth,\n    float rHeadSlope,\n    float rHeadNotchSlope,\n    float headStrokeWidth\n) {\n    vec2 topInner = headInnerCorner(halfWidth, rHeadSlope, headStrokeWidth);\n    return topInner.x - topInner.y * rHeadNotchSlope;\n}\n\nfloat sdArrowHead(\n    vec2 p,\n    float halfWidth,\n    float rHeadSlope,\n    float rHeadNotchSlope,\n    float headStrokeWidth\n) {\n    float headAxisLength = halfWidth * rHeadSlope;\n    vec2 topOuter = vec2(headAxisLength, halfWidth);\n    vec2 bottomOuter = vec2(headAxisLength, -halfWidth);\n    vec2 topInner = headInnerCorner(halfWidth, rHeadSlope, headStrokeWidth);\n    vec2 normalOffset = topInner - topOuter;\n    vec2 bottomInner = bottomOuter + vec2(normalOffset.x, -normalOffset.y);\n    float notchX = headNotchX(\n        halfWidth,\n        rHeadSlope,\n        rHeadNotchSlope,\n        headStrokeWidth\n    );\n\n    vec2 vertices[6] = vec2[6](\n        vec2(0.0, 0.0),\n        topOuter,\n        topInner,\n        vec2(notchX, 0.0),\n        bottomInner,\n        bottomOuter\n    );\n\n    return sdPolygon(vertices, p);\n}\n\nfloat repeat(float x, float spacing) {\n    return x >= spacing ? x - floor(x / spacing) * spacing : x;\n}\n\nfloat sdArrow(vec2 arrowPos, float arrowHalfLength) {\n    float stemDistance = sdStem(\n        arrowPos,\n        arrowHalfLength,\n        vStemHalfWidth,\n        vRHeadSlope,\n        vRStartNotchSlope\n    );\n\n    bool headRepeat = vHeadSpacing >= 0.0;\n    float spacing = headRepeat\n        ? max(vHeadSpacing, vHeadRepeatFootprintLength)\n        : 1.0 / 0.0;\n    float distanceFromStart = arrowPos.x + arrowHalfLength;\n\n    // Keep the stroked tip inside the repeated head's local window.\n    float arrowHeadX = repeat(\n        distanceFromStart + vHalfStrokeWidth,\n        spacing\n    ) - vHalfStrokeWidth;\n\n    float headDistance = sdArrowHead(\n        vec2(arrowHeadX, arrowPos.y),\n        vHeadHalfWidth,\n        vRHeadSlope,\n        vRHeadNotchSlope,\n        vHeadStrokeWidth\n    );\n\n    if (headRepeat) {\n        // Cull heads that would be partially clipped.\n        float headTipDistance = distanceFromStart - arrowHeadX;\n        float headEndDistance = headTipDistance\n            + vHeadRepeatFootprintLength\n            - vHalfStrokeWidth;\n\n        if (headTipDistance > 0.0 && headEndDistance > arrowHalfLength * 2.0) {\n            headDistance = FAR_OUTSIDE;\n        }\n    }\n\n    return min(stemDistance, headDistance);\n}\n\nvoid main(void) {\n    vec2 arrowPos = vPosInPixels;\n    if (vDirection == DIRECTION_FORWARD) {\n        arrowPos.x = -arrowPos.x;\n    }\n    float d = sdArrow(arrowPos, vArrowHalfLengthInPixels);\n\n    fragColor = distanceToColor(\n        d,\n        vFillColor,\n        vStrokeColor,\n        vec4(0.0),\n        vHalfStrokeWidth\n    );\n\n    if (uPickingEnabled) {\n        if (d < vHalfStrokeWidth) {\n            fragColor = vPickingColor;\n        }\n    } else if (fragColor.a == 0.0) {\n        discard;\n    }\n}\n", sc = "layout(std140) uniform Mark {\n    uniform int uHeadShape;\n\n    uniform float uHeadSlope;\n    uniform float uHeadNotchSlope;\n\n    uniform float uMinSize;\n    uniform float uHeadWidth;\n    uniform bool uStartNotch;\n    uniform float uMinStemLength;\n    uniform float uHeadSpacing;\n    uniform bool uStem;\n\n    uniform int uHeadPlacement;\n\n#pragma markUniforms\n};\n\nconst float DIRECTION_FORWARD = 0.0;\nconst float DIRECTION_REVERSE = 1.0;\n\nconst int HEAD_SHAPE_TRIANGLE = 0;\nconst int HEAD_SHAPE_OPEN = 1;\n\nconst int HEAD_PLACEMENT_INSIDE = 0;\nconst int HEAD_PLACEMENT_OUTSIDE = 1;\n\n// Arrow space uses x for arrow length and y for width perpendicular to it.\n// Negative x points toward the arrowhead in the canonical \"reverse\" direction.\n", cc = 1e4, lc = class {
	...
	createUpdater(e, t, n = Float32Array, r = void 0) {
		if (!C(this.size)) throw Error("The number of vertices must be defined!");
...
function fc(e, t, n, r = n, i = 0, a = i) {
	...
	let l = t[0], u = (t[1] - t[0]) / e, d = (t, n) => {
		...
		return h(n && i == r ? i - 1 : i, 0, e - 1);
	}, f = dc, p = -Infinity, m = !1, g = (e, t, n = [0, 0]) => {
	...
	let _ = !0;
	for (let e = s.length - 1; e > 0; e--) _ && s[e] == uc ? (s[e] = c[e], _ = !1) : s[e - 1] > s[e] && (s[e - 1] = s[e]);
	return g;
}
//#endregion
...
var pc = class {
	constructor({ encoders: e, numVertices: t = void 0, attributes: n = [] }) {
		...
		let r = [...ks(e).entries()].filter(([e, t]) => e[1] && t.length > 1).map(([e, t]) => t);
		this.allocatedVertices = t, this.variableBuilder = new lc(t), this.attributeNames = {};
		for (let [e, t] of Object.entries(this.variableEncoders)) {
			let n = f(t);
			if (!n) continue;
			let i = r.find((t) => t.find((t) => t == e)), a = n.asNumberAccessor(), o = t.scale, { largeHp: s, arrayConstructor: c, discrete: l, numComponents: u } = ws(o, e), d = [0, 0], p;
			if (o && l) if ("props" in o && o.props.domainIndexer) p = o.props.domainIndexer;
			else if ("domain" in o) p = _e(), p.addAll(o.domain());
			else throw Error("Missing domain indexer for discrete scale.");
			let m = p ? (e) => p(n(e)) : s ? (e) => Es(a(e), d) : a, h = As(i ?? e);
	...
	constructor({ encoders: e, attributes: t, fontMetrics: n, properties: r, numCharacters: i = void 0 }) {
		...
		this.numberFormat = !o(a) && "format" in a && a.format ? g(a.format) : (e) => e, this.updateVertexCoord = this.variableBuilder.createUpdater("vertexCoord", 2), this.updateTextureCoord = this.variableBuilder.createUpdater("textureCoord", 2), this.updateWidth = this.variableBuilder.createUpdater("width", 1), this.variableBuilder.configure();
	}
	addBatch(e, t, n = 0, r = t.length) {
...
var Ac = class {
	...
	getSampleFacetMode() {
		if (this.encoders.facetIndex) return Ec;
		if (this.unitView.usesSampleFacetRendering()) return Tc;
	}
	createAndLinkShaders(n, i, s = []) {
		let c = this.getAttributes(), l = this.encoders, d = this.mark.getOrder(), f = this.getSampleFacetMode(), p = !!this.properties.cullByVisibleRange;
		f && s.push(`#define ${f}`), p && s.push("#define VISIBLE_RANGE_CULLING");
		let h = "// view: " + this.unitView.getPathString(), g = [], _ = /* @__PURE__ */ new Set(), y = ks(l), x = [], ee = e(l), S = new Set(ee.keys());
		for (let e of d?.params ?? []) S.add(e);
		let C = new Set(ee.keys().filter((e) => ee.get(e)));
		if (d && !d.predicate.selection.singleParam) for (let e of d.params) C.add(e);
		d && (s.push("#define CONDITIONAL_ORDER"), x.push("    // Conditional order pass"), x.push("    uniform int uOrderMode;"));
		for (let e of S) {
			let n = this.unitView.paramRuntime, i = n.findValue(e);
			if (!i) throw Error(`Cannot infer selection type as the parameter "${e}" has no value. Please ensure that the parameter is properly defined!`);
			let o = As("uniqueId");
			if (r(i)) {
				let n = $ + t(e);
				x.push("    // Selection parameter"), x.push(`    uniform highp uint ${n};`), this.#e.push(() => {
					this.registerMarkUniformValue(n, { expr: e }, (e) => e.uniqueId ?? 0);
				}), g.push(`bool ${is}${e}(bool empty) {\n    return ${$}${e} == ${o} || (empty && ${$}${e} == 0u);\n}`), C.has(e) && (g.push(`bool ${as}${e}() {\n    return ${$}${e} != 0u && ${$}${e} == ${o};\n}`), g.push(`bool ${os}${e}() {\n    return ${$}${e} == 0u;\n}`));
			} else if (se(i)) {
				let r = Dc + t(e);
				g.push(`// Selection texture\nuniform highp usampler2D ${r};`);
				let a = this.glHelper, s = a.selectionTextures;
				this.selectionTextureOps.push(() => {
					let t = n.getValue(e), i = s.get(t);
					if (!i) throw Error(`Bug: no selection texture found for "${e}"!`);
					J(this.programInfo, { [r]: i });
				});
				let c = Dc + e;
				g.push(`bool ${is}${e}(bool empty) {\n   return hashContainsTexture(${c}, ${o}) || (empty && isEmptyHashTexture(${c}));\n}`), C.has(e) && (g.push(`bool ${as}${e}() {\n    return hashContainsTexture(${c}, ${o});\n}`), g.push(`bool ${os}${e}() {\n    return isEmptyHashTexture(${c});\n}`)), a.createSelectionTexture(i), n.watchExpression(e, () => {
					let t = n.getValue(e);
					a.createSelectionTexture(t), this.unitView.context.animator.requestRender();
				});
			} else if (a(i)) {
				let n = Object.keys(i.intervals).filter((e) => ["x", "y"].includes(e));
				if (n.length == 0) throw new ye(`Interval selection "${e}" has no supported x or y targets.`, this.unitView);
				let r = [], a = [];
				for (let i of n) {
					let n = $ + t(e) + `_${i}`, { attributeType: o } = ws(this.unitView.getScaleResolution(i).getScale(), i);
					x.push("    // Selection parameter"), x.push(`    uniform highp ${o}[2] ${n};`), this.#e.push(() => {
						this.registerMarkUniformValue(n, { expr: e }, (e) => e.intervals[i] ?? [1, 0]);
					});
					let s = (e) => {
						for (let [t, n] of y.entries()) if (t[1] && n.includes(e)) return As(n);
						return As(e);
					}, c = s(i), l = n + "[0]", u = n + "[1]", d = m(i);
					if (this.encoding[d]) {
						let e = s(d), t = this.defaultHitTestMode;
						if (t == "endpoints") r.push(`((${l} <= ${c} && ${c} <= ${u}) || (${l} <= ${e} && ${e} <= ${u}))`);
						else if (t == "encloses") r.push(`(${l} <= ${c} && ${e} <= ${u})`);
						else if (t == "intersects") r.push(`(${l} <= ${e} && ${c} <= ${u})`);
						else throw new ye(`Unsupported hit test mode "${t}" for interval selection!`, this.unitView);
					} else r.push(`(${l} <= ${c} && ${c} <= ${u})`);
					a.push(`${l} > ${u}`);
				}
				if (g.push(`bool ${is}${e}(bool empty) {\n    return ${r.join(" && ")} || (empty && (${a.join(" || ")}));\n}`), !C.has(e)) continue;
				let o = r.map((e, t) => `(${a[t]} || ${e})`);
				g.push(`bool ${as}${e}() {\n    return (!(${a.join(" && ")})) && (${o.join(" && ")});\n}`), g.push(`bool ${os}${e}() {\n    return ${a.join(" && ")};\n}`);
			} else throw new ye(`Unsupported selection type "${i.type}" for WebGL conditional encoding.`, this.unitView);
		}
		let ne = (e, t, n, r) => {
			let i = t.channelDef;
			if (o(i)) if (u(i.value)) {
				let { uniformName: t, uniformGlsl: r, accessorGlsl: a, adjuster: o } = fs(e, n);
				g.push(a), x.push(r), this.#e.push(() => {
					this.registerMarkUniformValue(t, i.value, o);
				});
			} else g.push(ds(e, n, i.value).accessorGlsl);
			else if (v(i)) {
				let { uniformName: t, uniformGlsl: a, accessorGlsl: o } = ms(e, r, n);
				x.push(a), g.push(o);
				let { largeHp: s, discrete: c } = ws(r, e), l = c && "domain" in r ? (e) => r.domain().indexOf(e) : s ? Es : (e) => +e;
				this.#e.push(() => {
					this.registerMarkUniformValue(t, i.datum, l);
				});
			} else if (oe(i)) {
				let t = y.get([i.field, !0]), { attributeGlsl: a, accessorGlsl: o } = ps(e, r, n, t?.includes(e) ? t : void 0);
				_.add(a), g.push(o);
			} else if (ae(i)) {
				let { attributeGlsl: t, accessorGlsl: i } = ps(e, r, n);
				_.add(t), g.push(i);
		...
		for (let [e, t] of Object.entries(l)) {
			...
			for (let t = 0; t < n.length; t++) ne(e, n[t].accessor, t, i);
			if (i) {
				let t = b(r), n = t && t.resolutionChannel || e, a = te(n) ? this.unitView.getScaleResolution(n) : null, { glsl: o, domainUniform: s, domainUniformName: c, rangeUniform: l, rangeUniformName: u } = hs(e, i, r);
				g.push(o), x.push(s), x.push(l), l && this.#e.push(() => {
					let t = this.createMarkUniformSetter(u), n = () => t(Ms(i, e));
					this.registerScaleResolutionListener(a, "range", n), n();
				}), s && this.#e.push(() => {
					let e = this.createMarkUniformSetter(c), t = () => {
						let t;
						t = fe(i.type) ? [0, i.domain().length] : w(i.type) ? cs(i) : i.domain(), e(ge(i.type) ? Os(t) : t);
					};
		...
		let re = Array.from(ee, ([e, t]) => `${t ? as : is}${e}(${t ? "" : "false"})`);
		if (g.push("bool isDatumSelected() {\n" + (this.encoders.uniqueId && re.length > 0 ? `    return ${re.join(" || ")};` : "    return false;") + "\n}"), d) {
			let e = d.params.map((e) => {
				let t = !d.predicate.selection.singleParam;
				return `${t ? as : is}${e}(${t ? "" : String(d.predicate.selection.empty)})`;
			});
			g.push(`bool isOrderMatch() {
    return ${e.join(" || ")};\n}`);
		}
		let ie = "precision highp float;\nprecision highp int;", ce = (e) => e.replace("#pragma markUniforms", x.join("\n"));
		s = s.map(ce), n = ce(n), i = ce(i), n = ((e) => kc(e, d ? "    if (uOrderMode != 0 &&\n        (((uOrderMode & 3) == 1) != isOrderMatch())) {\n        gl_Position = vec4(100.0, 0.0, 0.0, 0.0);\n        return;\n    }" : ""))(n);
		let le = [
			ie,
			h,
			...s,
		...
		this.programStatus = Us(T, this.glHelper.compileShader(T.VERTEX_SHADER, le), this.glHelper.compileShader(T.FRAGMENT_SHADER, ue));
	}
	finalizeGraphicsInitialization() {
		...
		this.programInfo = ro(this.gl, this.programStatus.program), delete this.programStatus, this.viewUniformInfo = Xa(this.gl, this.programInfo, "View"), this.markUniformInfo = Xa(this.gl, this.programInfo, "Mark"), this.gl.useProgram(this.programInfo.program), J(this.programInfo, {
			uSampleFacet: [0, 1],
			uZero: 0
		});
	...
	registerMarkUniformValue(e, t, n = (e) => e) {
		let r = this.createMarkUniformSetter(e), i = (n) => {
			if (n == null) throw Error(`Trying to set null/undefined value for uniform: ${e}${u(t) ? `Expr: ${t.expr}` : ""}`);
			r(n);
		};
		if (u(t)) {
			let e, r = () => i(n(e(null)));
	...
	bindOrSetMarkUniformBlock() {
		this.markUniformsAltered ? (Qa(this.gl, this.programInfo, this.markUniformInfo), this.markUniformsAltered = !1) : Za(this.gl, this.programInfo, this.markUniformInfo);
	}
	setOrderPass(e, t = !1) {
		$a(this.markUniformInfo, { uOrderMode: Oc[e] | (t ? 4 : 0) }), this.markUniformsAltered = !0;
	}
	prepareRender(e) {
		let t = this.glHelper, n = this.gl, r = [];
		r.push(() => {
			this.vertexArrayInfo ||= Io(this.gl, this.programInfo, this.bufferInfo), n.useProgram(this.programInfo.program);
		});
		for (let [e, n] of Object.entries(this.encoders)) {
			let i = t.rangeTextures.get(n.scale);
			i && r.push(() => J(this.programInfo, { [rs + e]: i }));
		}
		r.push(...this.selectionTextureOps), this.getSampleFacetMode() == Ec && r.push(() => {
		...
		return r.push(() => $a(this.viewUniformInfo, {
	...
	setViewport(e, t, n, r, i, a = wc) {
		n = n.flatten();
		let o = this.gl, s = this.properties, c = a, l = a, u, d = Mc(e, n, s.clip === "never" ? void 0 : r, !1), f = d.coords;
...
var Pc = Math.PI / 180, Fc = 1e-6, Ic = 1, Lc = 90, Rc = ["triangle", "open"], zc = ["inside", "outside"], Bc = class extends Ac {
	getAttributes() {
		return [
			"uniqueId",
			"facetIndex",
	...
	render(e) {
		...
		return this.createRenderCallback((e, n) => {
			oo(t, this.vertexArrayInfo, t.TRIANGLE_STRIP, n, e);
		}, e);
	}
};
function Vc(e, t) {
...
function Hc(e) {
	return Math.max(Math.tan(Math.min(Math.max(e, Ic), Lc) * Pc), Fc);
}
function Uc(e) {
	return e ?? -1;
}
...
var Wc = "flat out vec4 vColor;\n\n/** Stroke width */\nflat out float vSize;\n\n/** The distance from the line center to the direction of normal in pixels */\nout float vNormalLengthInPixels;\n\nflat out float vGamma;\n\n// Centerline distance from the rendered endpoint baseline; negative disables fading.\nout float vFadeDistance;\n\nconst int SHAPE_ARC = 0;\nconst int SHAPE_DOME = 1;\nconst int SHAPE_DIAGONAL = 2;\nconst int SHAPE_LINE = 3;\nconst int ORIENT_VERTICAL = 0;\nconst int ORIENT_HORIZONTAL = 1;\n\nfloat distanceFromLine(vec2 pointOnLine1, vec2 pointOnLine2, vec2 point) {\n    vec2 a = point - pointOnLine1;\n    vec2 b = pointOnLine2 - pointOnLine1;\n    vec2 proj = dot(a, b) / dot(b, b) * b;\n    return length(a - proj);\n}\n\nbool isInsideViewport(vec2 point, float marginFactor) {\n    vec2 margin = uViewportSize * vec2(marginFactor);\n    return point.x >= -margin.x\n        && point.x <= uViewportSize.x + margin.x\n        && point.y >= -margin.y\n        && point.y <= uViewportSize.y + margin.y;\n}\n\nfloat inverseSmoothstep(float t) {\n    t = clamp(t, 0.0, 1.0);\n    // The chord-axis coordinate of ARC/DOME follows the smoothstep curve.\n    return 0.5 - sin(asin(1.0 - 2.0 * t) / 3.0);\n}\n\n/**\n * Remaps the parameter t to concentrate vertices to the part that is visible in the viewport.\n * This keeps the tightly bent endpoints smooth even when zooming in very close.\n */\nfloat remapVisibleChordParameter(\n    float stripT,\n    float chordStart,\n    float chordEnd,\n    float viewportLength\n) {\n    // Concentrate samples in the viewport-visible chord interval without dropping the rest.\n    float chordMin = min(chordStart, chordEnd);\n    float chordMax = max(chordStart, chordEnd);\n    float chordSpan = chordMax - chordMin;\n\n    if (chordSpan <= 0.0) {\n        return 0.0;\n    }\n\n    float visibleChordMin = max(chordMin, 0.0);\n    float visibleChordMax = min(chordMax, viewportLength);\n\n    if (visibleChordMax <= visibleChordMin) {\n        return stripT;\n    }\n\n    float visibleTMin = inverseSmoothstep((visibleChordMin - chordMin) / chordSpan);\n    float visibleTMax = inverseSmoothstep((visibleChordMax - chordMin) / chordSpan);\n    float visibleTSpan = visibleTMax - visibleTMin;\n    float offscreenTSpan = visibleTMin + (1.0 - visibleTMax);\n\n    if (offscreenTSpan <= 0.0) {\n        return stripT;\n    }\n\n    float visibleShare = clamp(0.75 + (1.0 - visibleTSpan) * 0.2, 0.75, 0.95);\n    float offscreenShare = 1.0 - visibleShare;\n    float leftShare = offscreenShare * visibleTMin / offscreenTSpan;\n    float rightShare = offscreenShare * (1.0 - visibleTMax) / offscreenTSpan;\n\n    if (stripT <= leftShare) {\n        return leftShare > 0.0 ? mix(0.0, visibleTMin, stripT / leftShare) : visibleTMin;\n    }\n\n    float visibleStart = leftShare;\n    float visibleEnd = visibleStart + visibleShare;\n\n    if (stripT <= visibleEnd) {\n        return visibleShare > 0.0\n            ? mix(visibleTMin, visibleTMax, (stripT - visibleStart) / visibleShare)\n            : visibleTMin;\n    }\n\n    return rightShare > 0.0\n        ? mix(visibleTMax, 1.0, (stripT - visibleEnd) / rightShare)\n        : visibleTMax;\n}\n\nvoid clampChordToViewport(inout vec2 p1, inout vec2 p4, inout float chordLength) {\n    if (chordLength > uMaxChordLength) {\n        vec2 chordVector = p4 - p1;\n        vec2 unitChordVector = normalize(chordVector);\n\n        if (isInsideViewport(p1, 2.0)) {\n            chordLength = uMaxChordLength;\n            p4 = p1 + unitChordVector * uMaxChordLength;\n        } else if (isInsideViewport(p4, 2.0)) {\n            chordLength = uMaxChordLength;\n            p1 = p4 - unitChordVector * uMaxChordLength;\n        }\n    }\n}\n\nvoid clampDomeApex(inout vec2 p1, inout vec2 p4, int orient) {\n    if (orient == ORIENT_VERTICAL) {\n        if (p4.x > 0.0) {\n            p1.x = max(p1.x, -p4.x);\n        }\n        if (p1.x < uViewportSize.x) {\n            p4.x = min(p4.x, 2.0 * uViewportSize.x - p1.x);\n        }\n    } else {\n        if (p4.y > 0.0) {\n            p1.y = max(p1.y, -p4.y);\n        }\n        if (p1.y < uViewportSize.y) {\n            p4.y = min(p4.y, 2.0 * uViewportSize.y - p1.y);\n        }\n    }\n}\n\nvoid main(void) {\n#pragma orderGuard\n\n    float pixelSize = 1.0 / uDevicePixelRatio;\n    float opacity = getScaled_opacity() * uViewOpacity;\n\n    // The bezier's control points\n    vec2 p1, p2, p3, p4;\n\n    vec2 a = applyOffset(\n        applySampleFacet(vec2(getScaled_x(), getScaled_y())),\n        vec2(getScaled_xOffset(), getScaled_yOffset())\n    ) * uViewportSize;\n    vec2 b = applyOffset(\n        applySampleFacet(vec2(getScaled_x2(), getScaled_y2())),\n        vec2(getScaled_x2Offset(), getScaled_y2Offset())\n    ) * uViewportSize;\n\n    if (uShape <= SHAPE_DOME) {\n        if (uShape == SHAPE_DOME) {\n            vec2 height = vec2(0.0);\n            if (uOrient == ORIENT_VERTICAL) {\n                p1 = vec2(min(a.x, b.x), b.y);\n                p4 = vec2(max(a.x, b.x), b.y);\n                height = vec2(0.0, a.y - b.y);\n\n                float chordLength = length(p4 - p1);\n                clampChordToViewport(p1, p4, chordLength);\n                if (uClampApex) {\n                    clampDomeApex(p1, p4, ORIENT_VERTICAL);\n                }\n\n            } else {\n                p1 = vec2(b.x, min(a.y, b.y));\n                p4 = vec2(b.x, max(a.y, b.y));\n                height = vec2(a.x - b.x, 0.0);\n\n                float chordLength = length(p4 - p1);\n                clampChordToViewport(p1, p4, chordLength);\n                if (uClampApex) {\n                    clampDomeApex(p1, p4, ORIENT_HORIZONTAL);\n                }\n            }\n\n            vec2 controlOffset = height / 0.75;\n            p2 = p1 + controlOffset;\n            p3 = p4 + controlOffset;\n\n        } if (uShape == SHAPE_ARC) {\n            p1 = a;\n            p4 = b;\n\n            vec2 chordVector = p4 - p1;\n            vec2 unitChordVector = normalize(chordVector);\n            vec2 chordNormal = vec2(-unitChordVector.y, unitChordVector.x);\n            float chordLength = length(chordVector);\n            clampChordToViewport(p1, p4, chordLength);\n\n            float height = max(\n                chordLength / 2.0 * uArcHeightFactor,\n                uMinArcHeight\n            );\n\n            // This is a bit poor approximation of a circular arc, but it's probably enough for most purposes.\n            // TODO: Consider a more sophisticated approach: https://stackoverflow.com/a/44829356/1547896\n            vec2 controlOffset = chordNormal * height / 0.75;\n            p2 = p1 + controlOffset;\n            p3 = p4 + controlOffset;\n        }\n\n    } else if (uShape == SHAPE_DIAGONAL) {\n        if (uOrient == ORIENT_VERTICAL) {\n            p1 = a;\n            p2 = vec2(a.x, (a.y + b.y) / 2.0);\n            p3 = vec2(b.x, (a.y + b.y) / 2.0);\n            p4 = b;\n        } else {\n            p1 = a;\n            p2 = vec2((a.x + b.x) / 2.0, a.y);\n            p3 = vec2((a.x + b.x) / 2.0, b.y);\n            p4 = b;\n        }\n    } else if (uShape == SHAPE_LINE) {\n        p1 = a;\n        p2 = (a + b) / 2.0;\n        p3 = p2;\n        p4 = b;\n    }\n\n    vec2 strip = vec2(\n        float(gl_VertexID / 2) / float(uSegmentBreaks),\n        float(gl_VertexID % 2) - 0.5\n    );\n\n    float t = strip.x;\n\n    if (uShape == SHAPE_DOME) {\n        if (uOrient == ORIENT_VERTICAL) {\n            t = remapVisibleChordParameter(strip.x, p1.x, p4.x, uViewportSize.x);\n        } else {\n            t = remapVisibleChordParameter(strip.x, p1.y, p4.y, uViewportSize.y);\n        }\n    } else if (uShape == SHAPE_ARC) {\n        if (a.y == b.y) {\n            t = remapVisibleChordParameter(strip.x, p1.x, p4.x, uViewportSize.x);\n        } else if (a.x == b.x) {\n            t = remapVisibleChordParameter(strip.x, p1.y, p4.y, uViewportSize.y);\n        }\n    }\n\n    vec2 p;\n    vec2 tangent;\n\n    // de Casteljau evaluation keeps the cubic stable for long chords.\n    vec2 q1 = mix(p1, p2, t);\n    vec2 q2 = mix(p2, p3, t);\n    vec2 q3 = mix(p3, p4, t);\n\n    vec2 r1 = mix(q1, q2, t);\n    vec2 r2 = mix(q2, q3, t);\n\n    p = mix(r1, r2, t);\n    tangent = 3.0 * (r2 - r1);\n\n    tangent = normalize(tangent);\n    vec2 normal = vec2(-tangent.y, tangent.x);\n\n    float size = getScaled_size();\n\n    // Avoid artifacts in very thin lines by clamping the size and adjusting opacity respectively\n    if (size < pixelSize) {\n        opacity *= size / pixelSize;\n        size = pixelSize;\n    }\n\n    // Handle minimum picking size or add an extra pixel to the stroke width to accommodate edge antialiasing\n    float paddedSize = uPickingEnabled\n        ? max(size, uMinPickingSize)\n        : size + pixelSize;\n\n    vNormalLengthInPixels = strip.y * paddedSize;\n    \n    vFadeDistance = -1.0;\n    if ((uShape == SHAPE_ARC || uShape == SHAPE_DOME) &&\n        uArcFadingDistance[0] > 0.0 &&\n        uArcFadingDistance[1] > 0.0\n#ifdef CONDITIONAL_ORDER\n        && (!uNoFadingOnSecondPass || (uOrderMode & 4) == 0)\n#endif\n        )\n    {\n        vFadeDistance = distanceFromLine(p1, p4, p);\n        // Keep fully faded triangles collapsed to avoid fragment processing.\n        if (1.0 - smoothstep(uArcFadingDistance[0], uArcFadingDistance[1], vFadeDistance) <= 0.0) {\n            vNormalLengthInPixels = 0.0;\n        }\n    }\n\n    // Extrude\n    p += normal * vNormalLengthInPixels;\n\n    gl_Position = pixelsToNdc(p);\n\n    vec3 color = getScaled_color();\n\n    vColor = vec4(color * opacity, opacity);\n\n    vGamma = getGammaForColor(color);\n\n    vSize = paddedSize;\n\n    setupPicking();\n}\n", Gc = "flat in vec4 vColor;\nflat in float vSize;\nin float vNormalLengthInPixels;\nflat in float vGamma;\nin float vFadeDistance;\n\nout lowp vec4 fragColor;\n\nvoid main(void) {\n    float dpr = uDevicePixelRatio;\n\n    float distance = abs(vNormalLengthInPixels);\n    float opacity = clamp(((vSize / 2.0 - distance) * dpr), 0.0, 1.0);\n\n    opacity = pow(opacity, vGamma);\n\n    if (vFadeDistance >= 0.0) {\n        opacity *= 1.0 - smoothstep(uArcFadingDistance[0], uArcFadingDistance[1], vFadeDistance);\n    }\n    if (opacity <= 0.0) {\n        discard;\n    }\n\n    fragColor = vColor * opacity;\n\n    if (uPickingEnabled) {\n        fragColor = vPickingColor;\n    }\n}\n", Kc = "layout(std140) uniform Mark {\n    uniform float uArcHeightFactor;\n\n    /** Make very small arcs visible */\n    uniform float uMinArcHeight;\n\n    /** The minimum stroke width in pixels when rendering into the picking buffer */\n    uniform float uMinPickingSize;\n\n    uniform int uShape;\n    uniform int uOrient;\n    uniform bool uClampApex;\n\n    // In pixels\n    uniform float uMaxChordLength;\n    // In pixels\n    uniform vec2 uArcFadingDistance;\n    uniform bool uNoFadingOnSecondPass;\n\n    uniform int uSegmentBreaks;\n\n#pragma markUniforms\n};\n", qc = [
	...
	initializeGraphics() {
		super.initializeGraphics(), this._baseInstanceExt = this.gl.getExtension("WEBGL_draw_instanced_base_vertex_base_instance"), this.createAndLinkShaders(Wc, Gc, [Kc]);
	}
	finalizeGraphicsInitialization() {
		super.finalizeGraphicsInitialization(), this.gl.useProgram(this.programInfo.program);
		let e = this.properties;
	...
	initializeGraphics() {
		super.initializeGraphics(), this.createAndLinkShaders(Xc, Zc, [Qc]);
	}
	finalizeGraphicsInitialization() {
		super.finalizeGraphicsInitialization(), this.gl.useProgram(this.programInfo.program);
		let e = this.properties;
	...
	get opaque() {
		return ve(this, "opaque", () => !this.#e() && !this.#t() && !this.properties.shadowOpacity && o(this.encoding.fillOpacity) && this.encoding.fillOpacity.value == 1 && this.properties.minOpacity == 1) && this.unitView.getEffectiveOpacity() == 1;
	}
	getAttributes() {
		return [
			"uniqueId",
	...
	#t() {
		...
		return !(o(e) && !e.value) || "condition" in e;
	}
	initializeGraphics() {
		super.initializeGraphics();
		let e = [];
		this.#e() && e.push("ROUNDED_CORNERS"), this.#t() && e.push("STROKED"), this.properties.shadowOpacity && e.push("SHADOW"), this.createAndLinkShaders(el, tl, [nl, ...e.map((e) => "#define " + e)]);
	}
	finalizeGraphicsInitialization() {
		super.finalizeGraphicsInitialization(), this.gl.useProgram(this.programInfo.program);
		let e = this.properties;
	...
	initializeGraphics() {
		super.initializeGraphics();
		let e = this.gl, t = ll(this.properties.strokeDash);
		this.dashTexture = ai(e, {
			level: 0,
			mag: e.NEAREST,
			min: e.NEAREST,
			internalFormat: e.R8,
			...
			src: t,
			height: 1
		}), this.dashTextureSize = t.length, this.createAndLinkShaders(al, ol, [sl]);
	}
	finalizeGraphicsInitialization() {
		super.finalizeGraphicsInitialization(), this.gl.useProgram(this.programInfo.program);
		let e = this.properties;
		this.registerMarkUniformValue("uMinLength", e.minLength), this.registerMarkUniformValue("uStrokeCap", e.strokeCap ?? "butt", (e) => [
			...
			"square",
			"round"
		].indexOf(e)), $a(this.markUniformInfo, { uDashTextureSize: +this.dashTextureSize }), this.markUniformsAltered = !0;
	}
	updateGraphicsData(e) {
		let t = e.getItemCount(), n = new hc({
			encoders: this.encoders,
	...
	render(e) {
		let t = this.gl;
		return this.createRenderCallback((e, n) => oo(t, this.vertexArrayInfo, t.TRIANGLE_STRIP, n, e), e);
	}
	dispose() {
...
var ul = "in mediump vec2 vertexCoord;\nin lowp vec2 textureCoord;\n\n// Width of the text (all letters)\nin float width;\n\nout vec2 vTexCoord;\nout float vEdgeFadeOpacity;\nflat out vec4 vColor;\nflat out float vSlope;\nflat out float vGamma;\n\nstruct RangeResult {\n    float pos;\n    float scale;\n};\n\nfloat minValue(vec4 v) {\n    return min(min(v.x, v.y), min(v.z, v.w));\n}\n\nfloat maxValue(vec4 v) {\n    return max(max(v.x, v.y), max(v.z, v.w));\n}\n\n/**\n * All measures are in [0, 1]\n */\nRangeResult positionInsideRange(float a, float b, float width, float padding,\n                                int align, bool flush) {\n    float span = b - a;\n    float paddedWidth = width + 2.0 * padding;\n\n    // Is the text clearly outside the viewport\n    if (a > 1.0 || b < 0.0) {\n        return RangeResult(0.0, 0.0);\n    }\n\n    // How much extra space we have for adjusting the position so that the\n    // text stays inside the range.\n    float extra = max(0.0, span - paddedWidth);\n\n    float pos;\n\n    // Align the text and try to keep it inside the range and the viewport\n    if (align == 0) {\n        float centre = a + b;\n\n        if (flush) {\n            float leftOver = max(0.0, paddedWidth - centre);\n            centre += min(leftOver, extra);\n\n            float rightOver = max(0.0, paddedWidth + centre - 2.0);\n            centre -= min(rightOver, extra);\n        }\n\n        pos = centre / 2.0;\n\n    } else if (align < 0) {\n        float edge = a;\n\n        if (flush) {\n            float over = max(0.0, -edge);\n            edge += min(over, extra);\n        }\n\n        pos = edge + padding;\n\n    } else {\n        float edge = b;\n\n        if (flush) {\n            float over = max(0.0, edge - 1.0);\n            edge -= min(over, extra);\n        }\n\n		// TODO: If the text spans the whole viewport, try to keep it centered if possible.\n\n        pos = edge - padding;\n    }\n\n    // How the text should be scaled to make it fit inside the range (if it didn't fit).\n    float scale = clamp((span - padding) / paddedWidth, 0.0, 1.0);\n\n    // TODO: Fix padding in scale factor. Padding should stay constant\n    return RangeResult(pos, scale);\n}\n\nvec2 calculateRotatedDimensions(float width, mat2 rotationMatrix) {\n    vec2 a = abs(rotationMatrix * vec2(width / 2.0, 0.5));\n    vec2 b = abs(rotationMatrix * vec2(width / 2.0, -0.5));\n    return vec2(max(a.x, b.x), max(a.y, b.y)) * 2.0;\n}\n\n/** Needed when using ranged text */\nivec2 fixAlignForAngle(ivec2 align, float angleInDegrees) {\n    float a = mod(angleInDegrees + 45.0, 360.0);\n    int x = align.x;\n    int y = -align.y;\n\n    // TODO: Optimize by avoiding branching\n    if (a < 90.0) {\n        return ivec2(x, y);\n    } else if (a < 180.0) {\n        return ivec2(y, -x);\n    } else if (a < 270.0) {\n        return ivec2(-x, y);\n    } else {\n        return ivec2(-y, x);\n    }\n}\n\nvoid main(void) {\n#pragma orderGuard\n\n    float opacity = getScaled_opacity() * uViewOpacity;\n    vec2 size = vec2(getScaled_size());\n    float x = getScaled_x() + getScaled_xOffset() / uViewportSize.x;\n    float y = getScaled_y();\n\n    float scale = 1.0;\n\n	float angleInDegrees = getScaled_angle();\n	float angle = -angleInDegrees * PI / 180.0;\n	\n    float sinTheta = sin(angle);\n    float cosTheta = cos(angle);\n    mat2 rotationMatrix = mat2(cosTheta, sinTheta, -sinTheta, cosTheta);\n\n    vec2 flushSize = calculateRotatedDimensions(width, rotationMatrix);\n\n#if defined(x2_DEFINED) || defined(y2_DEFINED)\n    ivec2 align = fixAlignForAngle(uAlign, angleInDegrees);\n#else\n    ivec2 align = uAlign;\n#endif\n\n#ifdef x2_DEFINED\n    float x2 = getScaled_x2() + getScaled_x2Offset() / uViewportSize.x;\n\n    if (uLogoLetter) {\n        size.x = (x2 - x) * uViewportSize.x;\n        x += (x2 - x) / 2.0;\n\n    } else {\n        RangeResult result = positionInsideRange(\n            min(x, x2), max(x, x2),\n            size.x * scale * flushSize.x / uViewportSize.x, uPaddingX / uViewportSize.x,\n            align.x, uFlushX);\n        \n        x = result.pos;\n        scale *= result.scale;\n    }\n#endif\n\n    // Position of the text origo \n    vec2 pos = applyOffset(\n        applySampleFacet(vec2(x, y)),\n        vec2(0.0, getScaled_yOffset())\n    );\n\n#ifdef y2_DEFINED\n    float y2 = getScaled_y2();\n    vec2 pos2 = applyOffset(\n        applySampleFacet(vec2(x, y2)),\n        vec2(0.0, getScaled_y2Offset())\n    );\n\n    if (uLogoLetter) {\n        size.y = (pos2.y - pos.y) * uViewportSize.y;\n        pos.y += (pos2.y - pos.y) / 2.0;\n\n    } else {\n        RangeResult result = positionInsideRange(\n            min(pos.y, pos2.y), max(pos.y, pos2.y),\n            size.y * scale * flushSize.y / uViewportSize.y, uPaddingY / uViewportSize.y,\n            align.y, uFlushY);\n        \n        pos.y = result.pos;\n        scale *= result.scale;\n    }\n#endif\n\n#ifdef VISIBLE_RANGE_CULLING\n    if (isOutsideVisibleRange(pos)) {\n        gl_Position = vec4(0.0);\n        return;\n    }\n#endif\n\n    if (scale < 1.0) {\n        if (uSqueeze) {\n            vec2 scaleFadeExtent = vec2(3.0, 6.0) / size;\n\n            if (scale  < scaleFadeExtent[0]) {\n                gl_Position = vec4(0.0);\n                return;\n            }\n\n            size *= scale;\n            opacity *= linearstep(scaleFadeExtent[0], scaleFadeExtent[1], scale);\n\n        } else if (scale < 1.0) {\n            // Eliminate the text\n            gl_Position = vec4(0.0);\n            return;\n        }\n    }\n\n    // Position of the character vertex in relation to the text origo\n    vec2 charPos = rotationMatrix * (vertexCoord * size + uD);\n\n    // Position of the character vertex inside the unit viewport\n    vec2 unitPos = pos + charPos / uViewportSize;\n\n    gl_Position = unitToNdc(unitPos);\n\n    // Controls antialiasing of the SDF\n    vSlope = max(1.0, min(size.x, size.y) / uSdfNumerator * uDevicePixelRatio);\n\n    vec3 color = getScaled_color();\n\n    // Premultiply alpha\n    vColor = vec4(color * opacity, opacity);\n\n    // Do something like gamma correction for text when the color is close to black or white.\n    vGamma = getGammaForColor(color);\n\n    vTexCoord = textureCoord;\n\n    // Edge fading. The implementation is simplistic and fails with primitives that\n    // span the whole viewport. However, it works just fine with reasonable font sizes.\n    // x: top, y: right, z: bottom, w: left\n    if (maxValue(uViewportEdgeFadeDistance) > -pow(10.0, 10.0)) { // -Infinity would be nice\n        vEdgeFadeOpacity = minValue(\n            ((vec4(1.0, 1.0, 0.0, 0.0) + vec4(-1.0, -1.0, 1.0, 1.0) * unitPos.yxyx) *\n                uViewportSize.yxyx - uViewportEdgeFadeDistance) / uViewportEdgeFadeWidth);\n    } else {\n        vEdgeFadeOpacity = 1.0;\n    }\n\n    setupPicking();\n}\n", dl = "uniform sampler2D uTexture;\n\nin vec2 vTexCoord;\nin float vEdgeFadeOpacity;\nflat in vec4 vColor;\nflat in float vSlope;\nflat in float vGamma;\n\nout lowp vec4 fragColor;\n\nfloat median(float r, float g, float b) {\n    return max(min(r, g), min(max(r, g), b));\n}\n\nfloat getDist(vec2 uv) {\n    vec3 c = texture(uTexture, uv).rgb;\n    return 1.0 - median(c.r, c.g, c.b);\n}\n\n/**\n * Calculates the super-sampled distance to the edge.\n * This is used to avoid aliasing when rendering small text,\n * as mip-mapping cannot be used here.\n * The distance is averaged over a grid of n x n samples.\n */\nfloat getSuperDist(vec2 uv) {\n    vec2 dx = dFdx(uv);\n    vec2 dy = dFdy(uv);\n\n    float n = 2.0;\n\n    float sum = 0.0;\n    for (float x = 0.5; x < n; x++){\n        for (float y = 0.5; y < n; y++) {\n            sum += getDist(\n                uv +\n                x / n * dx +\n                y / n * dy\n            ); \n        }\n    }\n\n    return sum / (n * n);\n}\n\nvoid main() {\n    float sigDist = getSuperDist(vTexCoord);\n\n    float slope = vSlope;\n    if (uLogoLetter) {\n        // Using screen-space derivatives for logo letters because skewed aspect ratios\n        // result in blurry edges otherwise. However, use of screen-space derivatives\n        // results in crappy looking text with regular letters text.\n        slope = 0.7 / length(vec2(dFdy(sigDist), dFdx(sigDist)));\n    }\n\n    float opa = clamp((sigDist - 0.5) * slope + 0.5, 0.0, 1.0);\n    opa *= clamp(vEdgeFadeOpacity, 0.0, 1.0);\n\n    opa = pow(opa, vGamma);\n\n    fragColor = vColor * opa;\n\n    if (uPickingEnabled) {\n        fragColor = vPickingColor;\n    }\n}\n", fl = "layout(std140) uniform Mark {\n    uniform mediump float uSdfNumerator;\n\n    uniform mediump vec2 uD; // dx & dy\n\n    uniform mediump vec4 uViewportEdgeFadeWidth;\n    uniform mediump vec4 uViewportEdgeFadeDistance;\n        \n    uniform bool uSqueeze;\n    uniform bool uLogoLetter;\n\n    // x: -1, 0, 1 = left, center, right\n    // y: -1, 0, 1 = top, middle, bottom \n    uniform lowp ivec2 uAlign;\n\n    uniform mediump float uPaddingX;\n    uniform bool uFlushX;\n    uniform mediump float uPaddingY;\n    uniform bool uFlushY;\n\n#pragma markUniforms\n};\n", pl = 1024, ml = {
	...
	text: class extends Ac {
		...
		initializeGraphics() {
			super.initializeGraphics(), this.createAndLinkShaders(ul, dl, [fl]);
		}
		finalizeGraphicsInitialization() {
			super.finalizeGraphicsInitialization(), this.gl.useProgram(this.programInfo.program);
			let e = this.properties;
			this.registerMarkUniformValue("uPaddingX", e.paddingX), this.registerMarkUniformValue("uPaddingY", e.paddingY), this.registerMarkUniformValue("uFlushX", e.flushX, (e) => !!e), this.registerMarkUniformValue("uFlushY", e.flushY, (e) => !!e), this.registerMarkUniformValue("uSqueeze", e.squeeze, (e) => !!e), this.registerMarkUniformValue("uLogoLetter", e.logoLetters, (e) => !!e), this.registerMarkUniformValue("uSdfNumerator", e.logoLetters, (e) => this.font.metrics.common.base * .35 * (e ? .5 : 1)), this.registerMarkUniformVector("uViewportEdgeFadeWidth", [
				...
				uAlign: [ml[e.align], hl[e.baseline]],
				uD: [e.dx, -e.dy]
			});
		}
		registerMarkUniformVector(e, t) {
			let n = this.createMarkUniformSetter(e), r = [], i = () => n(r.map((e) => e()));
			for (let e of t) r.push(u(e) ? this.unitView.paramRuntime.watchExpression(e.expr, i) : () => e);
			i();
		}
		updateGraphicsData(e) {
			let t = e.getData(), n = this.encoding, r = this.properties, i = u(r.logoLetters) ? this.unitView.paramRuntime.evaluateAndGet(r.logoLetters.expr) : r.logoLetters, a = this.encoders.text, o = 0, s = "format" in n.text ? g(n.text.format) : (e) => e;
			for (let e of t) {
			...
			let l = new vc({
				...
				numCharacters: Math.max(o, pl)
			});
			l.addBatches(e.facetBatches);
			let d = l.toArrays();
			this.rangeMap.migrateEntries(d.rangeMap), this.updateBufferInfo(d);
		}
		prepareRender(e) {
			let t = super.prepareRender(e);
			return t.push(() => {
		...
		render(e) {
			let t = this.gl;
			return this.createRenderCallback((e, n) => oo(t, this.vertexArrayInfo, t.TRIANGLES, n, e), e);
		}
	}
};
function _l(e, t, n) {
...
var vl = class {
	...
	#i(e) {
		this.#s();
		let t = _l(e, this.glHelper, this), n = {
			mark: e,
			graphics: t,
			state: "compiling",
			collector: void 0,
	...
	#l(e) {
		for (let [t, n] of Object.entries(e.mark.encoders)) {
			if (!n.scale) continue;
			let r = b(n.channelDef)?.resolutionChannel ?? t;
			if (!te(r)) continue;
...
function yl({ runs: e, viewRoot: t, layoutResult: n, webGLHelper: r, markAdapter: i, logicalWidth: a, logicalHeight: o, pixelRatio: s }) {
...
function xl(e) {
	let t = new Vs(e.container, e.sizeSource, { powerPreference: e.powerPreference }, e.onCanvasResize), n = new vl(t);
	return {
		surface: t,
		...
		createRenderCoordinator: (e) => new Js({
			...e,
			glHelper: t,
			markAdapter: n
		}),
		...
		rasterizeSvgRuns: (e) => yl({
			...e,
			webGLHelper: t,
			markAdapter: n
		}),
		readPickingId: (e, n) => {
			let r = t.getDevicePixelRatio(), i = Gs(t.gl, t._pickingBufferInfo, e * r, n * r);
			return i[0] | i[1] << 8 | i[2] << 16 | i[3] << 24;
		}
	};
}
//#endregion
export { xl as createWebGLRenderingBackend };
