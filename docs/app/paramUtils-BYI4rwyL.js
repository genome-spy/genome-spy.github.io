...
function He(e, t, n, r, i) {
	let a = r(e[0]), o = r(C(e)), s = t == null ? (a + o) / 2 : r(t);
...
function st(e) {
	return Ae(e) ? `[${e.map((e) => e === null ? "null" : st(e))}]` : je(e) || w(e) ? JSON.stringify(e).replaceAll("\u2028", "\\u2028").replaceAll("\u2029", "\\u2029") : e;
}
function ct(e) {
	let t = {}, n = e.length;
	for (let r = 0; r < n; ++r) t[e[r]] = !0;
...
var lt = class {
	...
	getDebugState() {
		...
		return {
			...
			view: ut(e, this.paramRuntimeProvider),
...
var mt = class extends lt {
...
}, T = "__uniqueId", ht = 1e4, gt = [null], _t = class extends mt {
	get behavior() {
		return 2;
	}
	constructor(e) {
	...
	#e() {
		return ++this._id % 1e4 == 0 && (this._id = this.#t() * ht), this._id;
	}
	#t() {
	...
	#n() {
		let e = gt.length;
		return gt[e] = this, this._blocks.push(e), this._usedBlocks++, e;
	}
};
//#endregion
...
function bt(e, t, n) {
	...
	function r(n) {
		let r = n;
		return r.fields ??= [], r.constant = r.fields.length === 0, r.channelDef = t, r.channel = e, r.sourceKey = Ct(t), r.scaleChannel = ((Lt(t) && t.resolutionChannel) ?? (cn(e) && e)) || void 0, r.scaleChannel !== void 0 && (r.domainKeyBase = wt({
	...
	else if (D(t)) return i(t.datum);
	else if (It(t)) return i(t.value);
...
function Ct(e) {
	let t = St(e);
	return t.kind === "datum" || t.kind === "value" ? "constant|" + Dt(t.value) : t.kind + "|" + Et(t);
}
function wt({ scaleChannel: e, source: t, type: n }) {
...
function Tt(e, t) {
	let { domainKey: n, domainKeyBase: r } = wt({
		scaleChannel: e.scaleChannel,
		source: St(e.channelDef),
		type: t
	});
...
function kt(e, t, n, r) {
	let i = Ut(t) || Wt(t) ? Array.isArray(t.condition) ? t.condition : [t.condition] : [], a = [...i, t], o = a.map((t, o) => {
		...
		return {
			accessor: bt(e, t, r),
			predicate: s?.param ? Ot(s.param, n, r, s.empty) : Object.assign(Vi(o === a.length - 1), { empty: !1 })
		};
	});
...
function At(e, t) {
	...
	for (let [i, a] of Object.entries(t)) {
		if (!a) continue;
		let o = i;
		jt(o) || (n[o] = Pt(kt(o, a, t, e.paramRuntime), r));
	}
	return n;
}
function jt(e) {
...
function Pt(e, t) {
	if (e.length === 1) {
		let n = Ft(e[0].accessor, t);
		return Object.assign(n, { branches: e });
	}
	let n = e.map((e) => e.predicate), r = e.map((e) => Ft(e.accessor, t));
	return Object.assign((e) => {
...
function Ut(e) {
	return (E(e) || D(e)) && "condition" in e;
}
function Wt(e) {
	return It(e) && "condition" in e;
}
...
function ei(e) {
	return Ae(e) || ArrayBuffer.isView(e) ? e : null;
}
function ti(e) {
	return ei(e) || (w(e) ? e : null);
}
var ni = {
	clamp: Qr,
	format(e, t) {
	...
	reverse(e) {
		return w(e) ? Array.from(e).reverse().join("") : ei(e).slice().reverse();
	},
	slice(e, t, n) {
...
function yi(e, t) {
	...
	let n = t.map((e) => vt(e)), r = (e) => n.map((t) => t(e));
...
function Ci(e, t) {
	...
	if (Ti(t)) return `${r}.uniqueId == null ? ${n} : ${r}.uniqueId === datum[${JSON.stringify(T)}]`;
	if (Ei(t)) return `${r}.data.size == 0 ? ${n} : mapHasKey(${r}.data, datum[${JSON.stringify(T)}])`;
	if (wi(t)) {
...
//#endregion
export { Xt as $, d as $t, di as A, Ve as At, Qt as B, be as Bt, bi as C, Ye as Ct, hi as D, at as Dt, mi as E, w as Et, Rt as F, Ue as Ft, Vt as G, y as Gt, rn as H, _e as Ht, Bt as I, We as It, sn as J, g as Jt, on as K, te as Kt, un as L, Ge as Lt, Qr as M, ot as Mt, Zr as N, De as Nt, gi as O, ze as Ot, At as P, ct as Pt, Zt as Q, f as Qt, Mt as R, Ke as Rt, Ci as S, nt as St, Si as T, je as Tt, Lt as U, me as Ut, an as V, ye as Vt, cn as W, he as Wt, E as X, m as Xt, Ht as Y, h as Yt, zt as Z, p as Zt, wi as _, xe as _t, Fi as a, bt as at, Oi as b, Ee as bt, Li as c, vt as ct, Di as d, mt as dt, u as en, Yt as et, xi as f, lt as ft, Ai as g, st as gt, yi as h, ft as ht, Ii as i, i as in, $t as it, $r as j, C as jt, ri as k, Be as kt, Ni as l, _t as lt, _i as m, pt as mt, Ri as n, s as nn, It as nt, Pi as o, Tt as ot, vi as p, dt as pt, D as q, _ as qt, $ as r, o as rn, Gt as rt, Bi as s, xt as st, zi as t, l as tn, nn as tt, Mi as u, T as ut, ki as v, Je as vt, ji as w, rt as wt, Ti as x, Ae as xt, Ei as y, Ze as yt, Nt as z, ve as zt };
