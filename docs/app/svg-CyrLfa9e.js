import { o as e, s as t, un as n } from "./clipOptions-BWHr3aTa.js";
import { v as r } from "./vega-scale-CypF85iS.js";
import { x as i } from "./viewSelectors-DNiDip5e.js";
...
import { A as l, C as u, D as d, E as f, M as p, N as m, O as h, T as g, _, a as v, c as y, d as b, f as x, g as S, h as C, i as w, j as ee, k as T, l as E, m as D, n as te, o as ne, p as re, r as O, s as ie, t as ae, u as oe, v as se, w as ce, x as le, y as ue } from "./order-C5CzA37O.js";
import { n as k, t as A } from "./svgNumber-DNxESJQB.js";
//#region ../core/src/rendering/svg/svgElement.js
var j = "http://www.w3.org/2000/svg";
function M(e, t) {
	let n = document.createElementNS(j, e);
...
function N(e, t) {
	let n = Object.entries(t).filter(([t, n]) => n.encoder.constant ? (e.setAttribute(t, "" + P(n, {})), !1) : !0);
	return (e) => Object.fromEntries(n.map(([t, n]) => [t, P(n, e)]));
}
function P(e, t) {
	let n = e.encoder(t);
...
function de(e, t) {
	let n = e, { coords: r, data: i, group: a, viewOpacity: o, visibleBounds: s } = t, c = n.encoders, l = N(a, {
		fill: {
			encoder: c.fill,
			transform: d
		},
	...
	return le(n, u, {
		...
		t.countOnly || (e.headShapeFallback && t.warn(`SVG export rendered unsupported arrow headShape "${u.headShape}" as a triangle.`), a.appendChild(M("path", {
...
function me(e, t) {
	let n = e, r = D(n), { coords: i, data: a, group: o, viewOpacity: s, visibleBounds: c } = t, l = n.encoders, u = se(n, r.shape, t.secondOrderPass), f = N(o, {
		stroke: {
			encoder: l.color,
			transform: d
		},
	...
	return C(n, r, {
		...
		let c = f(e), l = u ? t.getLinkArcFadeMaskUrl({
			p1: r,
			p4: s,
			distances: u
		}) : void 0;
		l !== m && (m = l, p = l ? M("g", { mask: l }) : o, l && o.appendChild(p)), p.appendChild(M("path", {
			d: `M ${F(r)} C ${F(i)} ${F(a)} ${F(s)}`,
			...c
		}));
	});
}
...
function I(e, t) {
	let n = e;
	f(n, n.properties.fillGradientStrength) && t.warn("SVG export ignored unsupported point property fillGradientStrength."), n.properties.geometricZoomBound && t.warn("SVG export ignored unsupported point property geometricZoomBound.");
	let r = x(n), { inwardStroke: i } = r, { group: a, viewOpacity: o } = t, s = n.encoders, c = N(a, {
		fill: {
			encoder: s.fill,
			transform: d
		},
	...
	return re(n, r, t, (e) => {
		...
		let { datum: n, shape: r, x: u, y: d, geometryRadius: f, angle: p, strokeWidth: m, lineShape: h } = e, g = {
			...c(n),
			...i && !h ? { "stroke-width": A(m) } : {},
			...h ? z(s, n, o) : {}
		}, _ = L(r, u, d, f, g, l);
		_ ? (p && _.setAttribute("transform", `rotate(${A(p)} ${A(u)} ${A(d)})`), a.appendChild(_)) : (t.warn(`SVG export rendered unsupported point shape "${r}" as a circle.`), a.appendChild(M("circle", {
			cx: A(u),
			cy: A(d),
			r: A(f),
			...g
...
function L(e, t, n, r, i, a) {
	let o = A(t), s = A(n), c = A(r);
	if (e == "circle") return M("circle", {
		cx: o,
		cy: s,
		r: c,
		...i
	});
	if (e == "square") return M("rect", {
		x: A(t - r),
		y: A(n - r),
		width: A(r * 2),
		height: A(r * 2),
...
function R() {
	...
	return { build(t, r, i, a) {
		return e = "", b(t, r, i, a, n) ? e : void 0;
	} };
}
function z(e, t, n) {
	let r = e.stroke(t), i = u(e.strokeOpacity, t), a = r == null || i <= 0;
	return {
		fill: "none",
		stroke: d(a ? e.fill(t) : r),
		"stroke-opacity": (a ? u(e.fillOpacity, t) : i) * n,
		"stroke-width": A(u(e.strokeWidth, t)),
		"stroke-linecap": "butt"
	};
}
//#endregion
...
function he(e, t) {
	let n = e, r = E(n), { shadow: i, hatch: a } = r, { group: o, viewOpacity: s } = t, c = n.encoders, l = N(o, {
		fill: {
			encoder: c.fill,
			transform: d
		},
	...
	return oe(n, r, t, (e) => {
		...
		if (a != "none" && _ > 0 && (b.fill = t.getRectHatchPatternUrl({
			type: a,
			fill: d(c.fill(n)),
			fillOpacity: u(c.fillOpacity, n) * s,
			stroke: d(c.stroke(n)),
			strokeOpacity: u(c.strokeOpacity, n) * s,
			strokeWidth: _
		}), b["fill-opacity"] = 1), f) {
			let e = B(r, i, p, m, h, {
				...f,
			...
			if (a == "none" && v != "none" && y == 1 && g == 1) o.appendChild(e);
				...
				let n = _ / 2, a = Object.fromEntries(Object.entries(h).map(([e, t]) => [e, t + n])), s = V(r - n, i - n, p + n * 2, m + n * 2, a), c = M("g", { "clip-path": t.getShadowClipPathUrl(s) });
...
function B(e, t, n, r, i, a) {
	if (ge(i)) {
		let o = i.topLeft, s = A(e), c = A(t), l = A(e + n), u = A(t + r);
		return M("rect", {
			x: s,
			y: c,
			width: A(l - s),
...
function H(e, t, n, r, i) {
	return e ? `A ${A(e)} ${A(e)} 0 0 1 ${U(t, n)}` : `L ${U(r, i)}`;
}
function U(e, t) {
	return `${A(e)} ${A(t)}`;
}
...
function W(e, t) {
	let n = e, r = ie(n), { coords: i, data: a, group: o, viewOpacity: s, visibleBounds: c } = t, l = n.encoders, u = n.properties.strokeDash, f = N(o, {
		stroke: {
			encoder: l.color,
			transform: d
		},
	...
	return o.setAttribute("stroke-linecap", "" + n.properties.strokeCap), u && (o.setAttribute("stroke-dasharray", u.map(A).join(" ")), o.setAttribute("stroke-dashoffset", "" + A(n.properties.strokeDashOffset))), y(n, r, {
		coords: i,
		data: a,
		visibleBounds: c
	}, (e) => {
		t.countOnly || o.appendChild(M("line", {
			x1: A(e.x1),
			y1: A(e.y1),
			x2: A(e.x2),
			y2: A(e.y2),
...
function _e(e, t) {
	let n = e, r = n.properties, i = v(n), { coords: a, data: o, group: s, viewOpacity: c, visibleBounds: l, anchorCullBounds: u } = t, p = n.encoders, m = N(s, {
		fill: {
			encoder: p.color,
			transform: d
		},
	...
	s.setAttribute("font-family", te(r.font)), s.setAttribute("font-style", r.fontStyle ?? "normal"), s.setAttribute("font-weight", "" + w(r.fontWeight ?? "normal")), s.setAttribute("text-anchor", ve[i.align]);
	let h = {
		top: {
			width: f(n, r.viewportEdgeFadeWidthTop),
			distance: f(n, r.viewportEdgeFadeDistanceTop)
		},
		right: {
			width: f(n, r.viewportEdgeFadeWidthRight),
			distance: f(n, r.viewportEdgeFadeDistanceRight)
		},
		bottom: {
			width: f(n, r.viewportEdgeFadeWidthBottom),
			distance: f(n, r.viewportEdgeFadeDistanceBottom)
		},
		left: {
			width: f(n, r.viewportEdgeFadeWidthLeft),
			distance: f(n, r.viewportEdgeFadeDistanceLeft)
		}
	}, g = ne(n, i, {
		coords: a,
		data: o,
		...
		if (e.logoScale) {
			...
			let n = [`translate(${A(e.x)} ${A(e.y)})`];
			e.angle && n.push(`rotate(${A(e.angle)})`), (e.dx || e.dy) && n.push(`translate(${A(e.dx)} ${A(e.dy)})`), n.push(`scale(${A(e.logoScale.width)} ${A(e.logoScale.heightScale)})`);
			let r = M("text", {
				x: 0,
				y: 0,
				dy: O("middle", 1),
		...
		let n = A(e.x), r = A(e.y), a = M("text", {
			x: n,
			y: r,
			dx: A(e.dx),
			dy: A(e.dy + O(i.baseline, e.size)),
			lengthAdjust: "spacingAndGlyphs",
			textLength: A(e.width),
			...m(e.datum),
			...e.scale == 1 ? {} : { "font-size": A(e.size) },
			...e.fadeOpacity == 1 ? {} : { opacity: k(e.fadeOpacity) }
		});
		a.textContent = e.text, e.angle && a.setAttribute("transform", `rotate(${A(e.angle)} ${n} ${r})`), s.appendChild(a);
	});
	if (!t.countOnly && s.childElementCount > 0) {
		let e = t.getViewportEdgeFadeMaskUrl(h);
...
function ye(e, t) {
	...
	let u = e.encoders, f = n.channel == "stroke" ? u.stroke : u.fill, p = Se(e.unitView.spec.encoding.x), m = Infinity, h = Infinity, _ = -Infinity, v = -Infinity, y = o.map((e) => {
		let [t, n] = ce(a, u, e), [r, i] = g(a, u, e);
		return m = Math.min(m, t, n), h = Math.min(h, r, i), _ = Math.max(_, t, n), v = Math.max(v, r, i), {
			offset: Number(e.position),
			color: d(f(e))
		};
	}).sort((e, t) => e.offset - t.offset);
	if (!ee(l, m, h, _, v)) return 0;
	...
	let b = be(y), x = [
		...
		y2: h,
		stops: x
	}), C = A(m), w = A(h), T = A(_), E = A(v), D = Number(u.fillOpacity(o[0])) * c;
	return s.appendChild(M("rect", {
		x: C,
		y: w,
		width: A(T - C),
		height: A(E - w),
...
function Te(e, t) {
	let n = t.strokeWidth, r = [
		...
		"horizontal",
		"grid"
	].includes(t.type), o = r ? n * 7 : n * (i ? 6 : 4), s = a ? n * 2 : n, c = o, l = r ? o * 2 : o, u = M("pattern", {
		id: e,
		x: 0,
		y: 0,
		width: A(c),
	...
	u.appendChild(M("rect", {
		width: A(c),
		height: A(l),
		fill: t.fill,
		"fill-opacity": k(t.fillOpacity)
	}));
	let d = M("g", {
		fill: "none",
		stroke: t.stroke,
		"stroke-opacity": k(t.strokeOpacity),
		"stroke-width": A(s),
		"stroke-linecap": "square"
	});
	return Ee(d, t.type, o, s), u.appendChild(d), u;
}
function Ee(e, t, n, r) {
	let i = (t) => e.appendChild(M("path", { d: t })), a = (e) => A(e), o = (e) => {
		for (let t of [
			-n,
			0,
			n
	...
	switch (t) {
		...
		case "rings":
		case "ringsLarge": {
			let r = n * (t == "dots" ? .07 : t == "rings" ? .2 : .35), i = (t, n) => e.appendChild(M("circle", {
				cx: A(t),
				cy: A(n),
				r: A(r)
			}));
...
function De(e, t, n, r) {
	let { normalX: i, normalY: a, offset: o, start: s, end: c } = r, l = i * o, u = a * o, d = e + "-gradient", f = M("linearGradient", {
		id: d,
	...
	for (let { offset: e, opacity: t } of S(s, c)) f.appendChild(M("stop", {
		offset: K(e, 3),
		"stop-color": "white",
		"stop-opacity": K(t, 3)
	}));
...
var q = class extends s {
	...
	constructor(e, t) {
		...
		let n = A(t.width), r = A(t.height);
		this.#e = M("svg", {
			xmlns: j,
			width: n,
			height: r,
			viewBox: `0 0 ${n} ${r}`
		}), this.#t = M("defs"), this.#e.appendChild(this.#t), t.background != null && this.#e.appendChild(M("rect", {
			width: n,
			height: r,
			fill: t.background,
	...
	pushView(e, t) {
		...
		if (n(this.#n)?.exportExcluded || i(e) && e.name.startsWith("scrollbar-")) {
			this.#n.push({
				view: e,
	...
	renderMark(r, i) {
		if (n(this.#n)?.exportExcluded || r.unitView.getEffectiveOpacity() <= 0) return;
		let a = e(i), o = t(a, r.properties.clip, this.currentCoords), s = T(this.width, this.height, o);
		if (!l(s)) return;
		...
		let u = !this.#u && this.#m != null, d = u ? this.getClipPathUrl(o) : void 0, f = u ? this.#m.markGroups.get(r)?.get(d ?? "") : void 0;
		!this.#u && !f && this.#E();
		let p = this.#u ? this.#p : this.#O(r, d), g = h(this.currentCoords, a, r.properties.cullByVisibleRange), _ = r.getOrder?.(), v = !this.#u && _ && _.isActive();
		if (m(r, i, this.currentCoords, this.#f, (e, t) => {
			let n = (t, n = !1) => {
				let i = we(r, {
					coords: e,
					data: t,
			...
			let i = ae(t, 0, t.length, _.predicate, _.passes);
			for (let [e, t] of i.entries()) t.length !== 0 && n(t, e === 1);
		}, (e) => this.#l.add(`SVG export could not resolve sample facet index ${e}. View: ${r.unitView.getPathString()}`)), !this.#u && !u && p.childElementCount > 0) {
			let e = this.getClipPathUrl(o);
			e && p.setAttribute("clip-path", e), this.currentNode.appendChild(p);
		}
	}
	#T(e, t) {
	...
	#D(e) {
		let t = ke(e.viewNodes), n = e.targets.map((e) => e.mark.getType()), r = M("g", {
			id: `rasterized-${n.join("-")}-${this.#w++}`,
			"data-name": `Rasterized ${n.join(", ")}`,
			"data-rasterized": ""
		}), i = M("image", { preserveAspectRatio: "none" });
		r.appendChild(i);
		let a = e.anchor.parentNode;
		t == a ? t.insertBefore(r, e.anchor) : t.insertBefore(r, Ae(a, t)), e.anchor.remove();
		for (let n of e.viewNodes) je(n, t);
		e.image = i;
	}
	#O(e, t) {
		let n = this.#m;
		if (!n) return M("g", { "data-mark-type": e.getType() });
		...
		} else a = M("g", { "data-mark-type": e.getType() }), t && a.setAttribute("clip-path", t), this.currentNode.appendChild(a), r.set(i, a), n.markGroupElements.add(a);
		return a;
	}
	getClipPathUrl(e) {
		if (!e) return;
	...
	getShadowFilterUrl(e) {
		let t = A(Math.max(e.blur / 2.5, .25)), n = A(e.offsetX), r = A(e.offsetY), i = [
			t,
			n,
			r
		].join(","), a = this.#a.get(i);
		if (!a) {
			...
			e.appendChild(M("feGaussianBlur", {
				in: "SourceGraphic",
				stdDeviation: t,
				result: "blur"
			})), e.appendChild(M("feOffset", {
				in: "blur",
				dx: n,
				dy: r,
				result: "offsetBlur"
	...
	getShadowClipPathUrl(e) {
		...
		if (!t) {
			...
			n.appendChild(M("path", {
				d: `M 0 0 V ${A(this.height)} H ${A(this.width)} V 0 Z ${e}`,
				"clip-rule": "evenodd",
				"fill-rule": "evenodd"
	...
	getRectHatchPatternUrl(e) {
		...
		return n || (n = "rect-hatch-" + this.#S++, this.#t.appendChild(Te(n, e)), this.#s.set(t, n)), `url(#${n})`;
	}
	getLegendGradientUrl(e) {
		let t = "legend-gradient-" + this.#C++, n = M("linearGradient", {
			id: t,
			gradientUnits: "userSpaceOnUse",
			x1: A(e.x1),
			y1: A(e.y1),
		...
		for (let t of e.stops) n.appendChild(M("stop", {
			offset: k(t.offset),
			"stop-color": t.color
		}));
	...
	getLinkArcFadeMaskUrl(e) {
		...
		if (!n) {
			...
			let { gradient: e, mask: r } = De(n, this.width, this.height, t);
	...
	getViewportEdgeFadeMaskUrl(e) {
		...
		if (!i) {
			i = "edge-fade-" + this.#b++;
			let e = A(this.width), n = A(this.height), a = M("mask", {
				id: i,
				x: 0,
				y: 0,
				width: e,
			...
			a.appendChild(M("rect", {
				width: e,
				height: n,
				fill: "white"
			}));
			for (let [o, s] of t) {
				let t = i + "-" + o, c = Me(t, o, s, r.coords);
				this.#t.appendChild(c), a.appendChild(M("rect", {
					width: e,
					height: n,
					fill: `url(#${t})`
				}));
...
function Me(e, t, n, r) {
	let i = t == "top" ? r.y + n.distance : t == "right" ? r.x2 - n.distance : t == "bottom" ? r.y2 - n.distance : r.x + n.distance, a = t == "left" || t == "right", o = i + (t == "top" || t == "left" ? 1 : -1) * n.width, s = M("linearGradient", {
		id: e,
		gradientUnits: "userSpaceOnUse",
		x1: A(a ? i : 0),
		y1: A(a ? 0 : i),
	...
	return s.appendChild(M("stop", {
		offset: 0,
		"stop-color": "black",
		"stop-opacity": 1
	})), s.appendChild(M("stop", {
		offset: 1,
		"stop-color": "black",
		"stop-opacity": 0
	})), s;
...
function Y({ viewRoot: e, logicalWidth: t, logicalHeight: n, background: r = "white" }) {
	let i = new q({ picking: !1 }, {
		width: t,
		height: n,
		background: r
	});
...
function Ne({ viewRoot: e, logicalWidth: t, logicalHeight: n }) {
...
//#endregion
export { Ne as analyzeSvgExport, Z as createRasterizedSvg, Y as createSvg, X as createSvgExport };
