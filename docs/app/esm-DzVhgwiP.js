...
function x(t, n = 5) {
	let r = new e({ maxSize: n });
	return (e) => {
		if (r.has(e)) return r.get(e);
		let n = t(e);
		return n && r.set(e, n), n;
	};
}
var S = class {
	filehandle;
...
var L = class extends S {
	...
	async _parse(e) {
		let t = await n(await this.filehandle.readFile(e)), r = new DataView(t.buffer), i, o = r.getUint32(0, !0);
		if (o === M) i = 1;
		else if (o === N) i = 2;
		...
		let s = this.maxBinNumber, c = r.getInt32(12, !0), l = c >= 30 ? this.parseAuxData(t, 16) : void 0, f = r.getInt32(16 + c, !0), m = 16 + c + 4, h, g = [];
		for (let e = 0; e < f; e++) {
			g.push(m);
...
var Z = class {
	...
	htsget = !1;
	headerP;
	chunkFeatureCache = new e({ maxSize: 100 });
	RecordClass;
	...
	async getHeaderPre(e = {}) {
		...
		let t = await this.index.parse(e), r = t.firstDataLine === void 0 ? void 0 : t.firstDataLine.blockPosition + J, i = await n(r === void 0 ? await this.bam.readFile() : await this.bam.read(r, 0)), a = new DataView(i.buffer);
		...
		if (c ||= (i = await n(await this.bam.readFile()), f(i, s, this.renameRefSeq)), !c) throw Error("Insufficient data for reference sequences");
...
async function $(e, t) {
	return h(await Promise.all(e.map(async (e) => n(await re(e, t)))));
}
