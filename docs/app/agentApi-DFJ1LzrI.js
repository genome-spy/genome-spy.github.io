...
import { G as t, N as n, R as r, at as i, dt as a, gt as o, it as s, lt as c, nt as l, rt as u, t as d, z as f } from "./src-EoV59w5q.js";
import { Ut as p, Vt as m, _ as h, g, qt as _ } from "./paramUtils-BYI4rwyL.js";
import { E as ee, Gt as te, O as v, Wt as ne, Zt as re, a as ie, f as ae, h as oe, n as se, p as ce } from "./viewSelectors-DGCspRN3.js";
import { i as le } from "./color-W5zffv-z.js";
import { S as ue } from "./framebufferReadback-THWwFqs8.js";
...
var S = Object, C = S.getPrototypeOf, Ce = "constructor", we = "prototype", Te = "configurable", Ee = "enumerable", De = "writable", Oe = "value", w = (e) => !!e && !!e[b];
function T(e) {
	return e ? je(e) || ze(e) || !!e[Se] || !!e[Ce]?.[Se] || Be(e) || Ve(e) : !1;
}
var ke = S[we][Ce].toString(), Ae = /* @__PURE__ */ new WeakMap();
function je(e) {
	if (!e || !He(e)) return !1;
	let t = C(e);
...
var Fe = (e, t, n = Pe(e)) => n === 2 ? e.has(t) : S[we].hasOwnProperty.call(e, t), Ie = (e, t, n = Pe(e)) => n === 2 ? e.get(t) : e[t], Le = (e, t, n, r = Pe(e)) => {
	r === 2 ? e.set(t, n) : r === 3 ? e.add(n) : e[t] = n;
};
function Re(e, t) {
	return e === t ? e !== 0 || 1 / e == 1 / t : e !== e && t !== t;
}
var ze = Array.isArray, Be = (e) => e instanceof Map, Ve = (e) => e instanceof Set, He = (e) => typeof e == "object", E = (e) => typeof e == "function", Ue = (e) => typeof e == "boolean";
function We(e) {
	let t = +e;
	return Number.isInteger(t) && String(t) === e;
}
var D = (e) => e.copy_ || e.base_, Ge = (e) => e.modified_ ? e.copy_ : e.base_;
function Ke(e, t) {
	if (Be(e)) return new Map(e);
	if (Ve(e)) return new Set(e);
	if (ze(e)) return Array[we].slice.call(e);
	let n = je(e);
...
function O(e, t = !1) {
	return Ye(e) || w(e) || !T(e) ? e : (Pe(e) > 1 && S.defineProperties(e, {
		set: Je,
		add: Je,
		clear: Je,
		delete: Je
...
var Xe = "MapSet", Ze = "Patches", Qe = "ArrayMethods", $e = {};
function k(e) {
	let t = $e[e];
	return t || x(0, e), t;
}
var et = (e) => !!$e[e], A, tt = () => A, nt = (e, t) => ({
	drafts_: [],
	parent_: e,
	immer_: t,
	canAutoFreeze_: !0,
	...
	mapSetPlugin_: et(Xe) ? k(Xe) : void 0,
	arrayMethodsPlugin_: et(Qe) ? k(Qe) : void 0
});
function rt(e, t) {
	t && (e.patchPlugin_ = k(Ze), e.patches_ = [], e.inversePatches_ = [], e.patchListener_ = t);
}
function it(e) {
...
function ct(e, t) {
	...
	let n = t.drafts_[0];
	if (e !== void 0 && e !== n) {
		n[b].modified_ && (it(t), x(4)), T(e) && (e = lt(t, e));
...
function _t(e, t, n) {
	...
	} else T(n) && e.callbacks_.push(function() {
		let i = D(e);
		e.type_ === 3 ? i.has(n) && vt(n, r.handledSet_, r) : Ie(i, t, e.type_) === n && r.drafts_.length > 1 && (e.assigned_.get(t) ?? !1) === !0 && e.copy_ && vt(Ie(e.copy_, t, e.type_), r.handledSet_, r);
	});
}
function vt(e, t, n) {
	return !n.immer_.autoFreeze_ && n.unfinalizedDrafts_ < 1 || w(e) || t.has(e) || !T(e) || Ye(e) ? e : (t.add(e), Ne(e, (r, i) => {
		if (w(i)) {
			let t = i[b];
			ft(t, n) && (Le(e, r, Ge(t), e.type_), dt(t));
		} else T(i) && vt(i, t, n);
	}), e);
}
function yt(e, t) {
...
var bt = {
	get(e, t) {
		...
		let i = D(e);
		if (!Fe(i, t, e.type_)) return St(e, i, t);
		let a = i[t];
		if (e.finalized_ || !T(a) || r && e.operationMethod && n?.isMutatingArrayMethod(e.operationMethod) && We(t)) return a;
		if (a === xt(e.base_, t)) {
			Tt(e);
	...
	getOwnPropertyDescriptor(e, t) {
		let n = D(e), r = Reflect.getOwnPropertyDescriptor(n, t);
		return r && {
			[De]: !0,
...
function St(e, t, n) {
	let r = Ct(t, n);
	return r ? Oe in r ? r[Oe] : r.get?.call(e.draft_) : void 0;
}
function Ct(e, t) {
	if (!(t in e)) return;
	let n = C(e);
...
var Et = class {
	constructor(e) {
		this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.useStrictIteration_ = !1, this.produce = (e, t, n) => {
			...
			if (T(e)) {
				...
				if (r = t(e), r === void 0 && (r = e), r === xe && (r = void 0), this.autoFreeze_ && O(r, !0), n) {
					let t = [], i = [];
					k(Ze).generateReplacementPatches_(e, r, {
						patches_: t,
						inversePatches_: i
					}), n(t, i);
				}
			...
			if (E(e)) return (t, ...n) => this.produceWithPatches(t, (t) => e(t, ...n));
			let n, r;
			return [
	...
	applyPatches(e, t) {
		...
		n > -1 && (t = t.slice(n + 1));
		let r = k(Ze).applyPatches_;
		return w(e) ? r(e, t) : this.produce(e, (e) => r(e, t));
	}
};
function Dt(e, t, n, r) {
	let [i, a] = Be(t) ? k(Xe).proxyMap_(t, n) : Ve(t) ? k(Xe).proxySet_(t, n) : yt(t, n);
...
function Ot(e) {
	return w(e) || x(10, e), kt(e);
}
function kt(e) {
	if (!T(e) || Ye(e)) return e;
	let t = e[b], n, r = !0;
	if (t) {
	...
	function o(e = a(), t) {
		...
		return o.filter((e) => !!e).length === 0 && (o = [i]), o.reduce((e, n) => {
			if (n) if (w(e)) {
				let r = n(e, t);
				return r === void 0 ? e : r;
			} else if (T(e)) return At(e, (e) => n(e, t));
			else {
				let r = n(e, t);
				if (r === void 0) {
					if (e === null) return e;
...
function In(e) {
	if (e.explicitName) return N(ie(e));
}
function Ln(e, t) {
	let n = In(t);
...
function Wn(e) {
	...
	return oe(e, (e) => {
		...
		let n = Mn(e);
		if (!n) return;
		let r = ie(e), i = N(r), a = se(e)?.name && r.scope.length ? r.scope.slice(0, r.scope.length - 1) : r.scope, o = JSON.stringify({
			scope: a,
			group: n
		}), s = t.get(o);
		s ? s.push({
...
function Yn(e, t) {
	...
	if (!r || !h(r) || !g(r)) throw Error(`Interval source selection "${t.selector.param}" is empty. Create a brush selection before running this action.`);
	let i = r.intervals.x;
...
function Qn(e, n) {
	if (!t(n)) return n;
	let r = e.getScale(), i = "genome" in r ? r.genome() : void 0;
	if (!i) throw Error("Encountered a chromosomal locus but no genome is available.");
	return i.toContinuous(n.chrom, n.pos);
}
function $n(e, t, n) {
...
function Sr(e, t, n, r, i) {
	...
	let a = ue(e.samples, t), o = n ? n.map((e, t) => ({
		name: e,
		title: r ? r[t] : void 0,
...
function wr(e, t, n, r) {
	let i = (e) => `Group ${e + 1}`, a = _(n.length - 1).reverse(), o = _(n.length - 1).map((e) => Rr(n[e], n[e + 1])), s = Cr(r, o.length), c = Pr(t, n.slice(1, n.length - 1));
...
function jr(e) {
	return K(e) ? e.groups.flatMap((e) => jr(e)) : e.samples;
}
function Mr(e) {
	return K(e) ? e.groups.reduce((e, t) => e + Mr(t), 0) : e.samples.length;
}
function Nr(e, t, n) {
...
function Fr(e, t, n) {
	let r = re(e.map(t).filter((e) => vr(e) && !isNaN(e)));
...
var Lr = p(".3~r"), Rr = (e, t) => `${e.operator == "lt" ? "[" : "("}${Lr(e.operand)}, ${Lr(t.operand)}${t.operator == "lte" ? "]" : ")"}`;
function zr(e, t) {
	let n = /* @__PURE__ */ new Map();
...
function Ur(e, t) {
	let n = (e) => e.copy().range(_(0, e.domain().length)).unknown(-1), r = (e) => e ?? "";
	switch (t.type) {
		case "quantitative":
...
function Sa(e) {
	return typeof e == "string" && le(e) != null;
}
function Ca(e, t) {
...
function Fa(e, t) {
	...
	e.sampleMetadata = t.replace ? O(o) : O(c);
}
var Ia = hn({
	name: Aa,
	initialState: ja(),
	reducers: {
		...
		retainCategoriesByAttribute: (e, t) => {
			let { categoryAccessor: n, conditionAccessor: r } = Ma(t), i = Kr(za(e).flatMap((e) => e.samples), n, r, t.payload.condition);
		...
		removeGroup: (e, t) => {
			let n = e.rootGroup;
			if (K(n)) Dr(n, t.payload.path);
			else throw Error("Cannot remove sample groups before grouping.");
		},
		retainGroupsByRank: (e, t) => {
			let n = e.rootGroup;
			if (K(n)) Or(n, Na(t.payload.level), t.payload.measure, t.payload.limit, t.payload.order);
			else throw Error("Cannot retain sample groups before grouping.");
		},
		retainGroupsBySize: (e, t) => {
			let n = e.rootGroup;
			if (K(n)) kr(n, Na(t.payload.level), t.payload.measure, t.payload.operator, t.payload.operand);
			else throw Error("Cannot retain sample groups before grouping.");
		},
		ungroup: (e, t) => {
			let n = e.rootGroup;
		...
		retainMatched: (e, t) => {
			let n = W(t), r = $r(za(e).map((e) => e.samples), n);
...
function* Ha(e) {
	if (yield [e], K(e)) for (let t of e.groups) for (let n of Ha(t)) yield [e, ...n];
}
var Ua = Wt((e) => e.sampleData?.entities, (e) => e && Object.values(e));
function Wa(e, t, n) {
...
function Ja(e) {
	...
	if (Array.isArray(e)) return e.map((e) => Ja(e)).join("");
	if (typeof e == "object" && "strings" in e && "values" in e && Array.isArray(e.strings) && Array.isArray(e.values)) {
		let t = e.strings[0] ?? "";
		for (let n = 0; n < e.values.length; n++) t += Ja(e.values[n]) + (e.strings[n + 1] ?? "");
		return t;
	}
	return typeof e == "object" && Symbol.iterator in e && typeof e[Symbol.iterator] == "function" ? Array.from(e, (e) => Ja(e)).join("") : "";
}
function Ya(e) {
...
function no(e, t, n = {}) {
	...
	let r = {
		...
		...n
	}, i = [], a = [], o = /* @__PURE__ */ new Set(), s = [], c = [], l = Za(t), u = 0, d = 0, f = 0;
	for (let n of Ba(e)) {
		let p = Qa(n, r.groupLabelSeparator), m = $a(n);
		u += m.length;
		let h = qa(t, m, e, l);
...
function ro(e, t, n = {}) {
	...
	a.sort((e, t) => e.v - t.v);
	let o = a.map((e) => e.v), s = ne(o, .25), c = ne(o, .5), l = ne(o, .75);
...
function ao(e, t, n = {}) {
	...
	let i = {
		...io,
		...n
	}, a = [], o = [], s = [], c = [], l = Za(t), u = 0, d = 0, f = 0;
	for (let n of Ba(e)) {
		let r = Qa(n, i.groupLabelSeparator), p = $a(n);
		u += p.length;
		let m = qa(t, p, e, l);
		...
		let { statistics: g, outliers: _ } = ro(h, (e) => e[i.valueField], {
			coef: i.coef,
			dropNaN: i.dropNaN
		});
...
function so(e, t, n, r = {}) {
	...
	let i = {
		...oo,
		...r
	}, a = [], o = [], s = [], c = Za(t), l = Za(n), u = 0, d = 0;
	for (let r of Ba(e)) {
		let f = Qa(r, i.groupLabelSeparator), p = $a(r);
		u += p.length;
		let m = qa(t, p, e, c), h = qa(n, p, e, l);
...
var co = 15, lo = new Intl.Collator("en", {
	numeric: !0,
	sensitivity: "base"
});
function uo(e, t, n, r = co) {
	let i = Array.from(e.entries()).sort(po), a = i.slice(0, r).map(([e, n]) => ({
		value: e,
		count: n,
		share: t > 0 ? n / t : 0
...
function fo(e, t) {
	let n = Array.from(e.entries()).sort(po)[0];
	return n ? {
		value: n[0],
		count: n[1],
		share: t > 0 ? n[1] / t : 0
...
function po(e, t) {
	return t[1] === e[1] ? lo.compare(String(e[0]), String(t[0])) : t[1] - e[1];
}
//#endregion
...
var _o = "hierarchy_barplot", vo = "hierarchy_boxplot_stats", yo = "hierarchy_boxplot_outliers", bo = "hierarchy_scatterplot_points";
function xo(e) {
	let t = e.attributeInfoSource.getAttributeInfo(e.attributeInfo.attribute), n = q(t.title), r = q(t.emphasizedName), i = t.type, a = eo(e.attributeInfoSource, e.sampleHierarchy.groupMetadata) ?? "Group", o = "Count", { rows: s, categoryDomain: c, groupDomain: l, grouped: u, sampleCount: d, nonMissingCount: f, missingCount: p, groupSummaries: m } = no(e.sampleHierarchy, e.attributeInfo, {
		categoryField: n,
		groupField: a,
		countField: o
	}), h = jo(t, c), g = u ? a : n, _ = u ? a : r, ee = u ? l : c, te = u ? "nominal" : i, v = {
		data: { name: _o },
		mark: { type: "rect" },
		encoding: {
			x: {
...
function So(e) {
	let t = e.attributeInfoSource.getAttributeInfo(e.attributeInfo.attribute), n = eo(e.attributeInfoSource, e.sampleHierarchy.groupMetadata), r = q(t.emphasizedName), i = n ?? "Group", a = q(t.title), { statsRows: o, outlierRows: s, groupDomain: c, sampleCount: l, nonMissingCount: u, groupSummaries: d } = ao(e.sampleHierarchy, e.attributeInfo, {
		groupField: i,
		valueField: a,
		sampleField: "sample"
	}), f = ar({
...
function Co(e) {
	...
	}, h = e.colorScaleDomain ?? u, g = Mo(u, c, s ?? "Group", h, e.colorScaleRange), _ = {
		data: { name: bo },
		mark: {
			type: "point",
			filled: !1,
...
function wo(e) {
	...
	let n = uo(t, e.nonMissingCount, e.missingCount), r = ho(n.categories, (e) => e.value, e.colorScale.domain, e.colorScale.range);
	return {
...
function Eo(e) {
	let t = e.rows.map((t) => Number(t[e.xFieldName])), n = e.rows.map((t) => Number(t[e.yFieldName])), r = ko(t, n);
	return {
		...
		x: Oo(t),
		y: Oo(n),
		...r === void 0 ? {} : { correlation: Ao(r) },
		...e.groupSummaries.length > 1 ? { groups: ho(e.groupSummaries, (e) => e.title, e.colorScaleDomain, e.colorScaleRange) } : {}
	};
}
function Do(e, t) {
	let n = fo(e, t);
...
function Po(e, t) {
	...
	for (let e of t) {
		...
		a.has(t) && r(Lo, 1, t), a.add(t);
	}
	return a.size === 0 && r(Ro), n.size > 0 ? { error: Array.from(n.values()) } : { statistics: {
		unknownSamples: a.difference(i),
		notCoveredSamples: i.difference(a),
		samplesInBoth: a.intersection(i)
	} };
}
var Fo = "Missing sample field in metadata record", Io = "Empty sample field in metadata record", Lo = "Duplicate sample IDs found in metadata", Ro = "No valid samples found in metadata";
//#endregion
...
function Vo(e, t) {
	return n(e.map((e) => String(e ?? "").trim()).filter(Boolean), t, Ho);
}
function Ho(e) {
	let t = 2166136261;
...
var Uo = class {
	...
	async listIdentifierExamples(e, t) {
		return [{
			name: "column",
			primary: !0,
			examples: Vo((await this.listColumns(t)).map((e) => e.id), e)
		}];
	}
	...
	async fetchColumns(e, t) {
		...
		let s = Bo(this.#e, e.columnIds), c = e.groupPath ?? this.#e.groupPath, l = Ii(a, s, this.#e.attributeGroupSeparator, c);
	...
	async #s(e, t) {
		...
		let n = ee(this.#n, e.url), r = l(e, n), o = s(r.type), c;
		try {
			c = await fetch(n, { signal: t });
		} catch (e) {
			throw Error("Could not load metadata source: " + e.message, { cause: e });
		}
		if (!c.ok) throw Error("Could not load metadata source: " + c.status + " " + c.statusText);
		let u;
		return u = typeof c[o] == "function" ? await c[o]() : await c.text(), a(u, i(r));
	}
	async #c(e) {
		let t = e.values, n = [];
		if (Array.isArray(t)) {
		...
		else if (typeof t == "string") n = a(t, i(l(e)));
...
var Yo = class {
	...
	async get(e, t = {}) {
		let n = Ko(this.url, e).href;
		return qo(await fetch(n, this.#n(t)));
	}
	async getRange(e, t, n = {}) {
		let r = Ko(this.url, e), i = this.#n(n), a;
		return a = "suffixLength" in t ? await Jo(r, t.suffixLength, i, this.#t) : await Wo(r, t.offset, t.length, i), qo(a);
	}
}, Xo = class {
	#e;
	constructor(e, t, n) {
...
function es(e) {
	...
	if (t) {
		let [, e, n] = t;
		return (e === "U" ? Qo : Zo).bind(null, Number(n));
	}
...
function bs(e) {
	return e instanceof Xo || e instanceof Zo || e instanceof Qo ? new Proxy(e, {
		get(e, t) {
...
function xs(e, t) {
	let n;
	return n = e.data instanceof Zo || e.data instanceof Qo ? new e.constructor(e.data.length, e.data.chars) : new e.constructor(e.data.length), {
		data: n,
		shape: e.shape,
		stride: X(e.shape, t)
	};
...
async function bc(e, t) {
	...
	return gc.increment(e.store, "v2"), new Us(e.store, e.path, rs(Y(r), t));
}
async function xc(e, t) {
	let { path: n } = e.resolve(".zgroup"), r = await e.store.get(n);
	if (!r) throw new Ns("v2 group", { cause: new Ps(n) });
	return gc.increment(e.store, "v2"), new zs(e.store, e.path, is(Y(r), t));
}
async function Sc(e) {
...
var Dc = class {
	...
	#s;
	constructor(e, t = {}) {
		this.#e = e, this.#t = e.backend, this.#n = new Yo(ee(t.baseUrl, this.#t.url)), this.#s = new Set(e.excludeColumns ?? []);
	}
	async listColumns(e) {
	...
	async listIdentifierExamples(e, t) {
		...
		return Promise.all(n.map(async (n) => {
			let r = Vo(await this.#h(n.path, t), e);
			return Oc({
				name: n.name,
				primary: n.primary,
	...
	async fetchColumns(e, t) {
		...
		let c = Po(e.sampleIds, s);
		if ("error" in c) {
			let e = c.error[0];
			throw Error("Invalid metadata source payload: " + String(e.message));
		}
		let l = Bo(this.#e, e.columnIds), u = e.groupPath ?? this.#e.groupPath, d = Ii(s, l, this.#e.attributeGroupSeparator, u);
...
async function kc(e, t) {
	try {
		return await f(e, { signal: t });
	} catch (t) {
		if (t instanceof r && t.kind === "json") throw Error("Invalid JSON in metadata source import " + e + ": " + t.message, { cause: t });
...
async function Nc(e, t = {}) {
	...
	return Promise.all(n.map(async (e) => {
		...
		let n = v(t.baseUrl, e.import.url), i = Mc(jc(await r(n, t.signal), n), n);
		return Ac(i), i;
	}));
}
function Pc(e, t) {
...
function Fc(e, t = {}) {
	if (e.backend.backend === "data") return new Uo(e, t);
...
//#endregion
export { yr as $, aa as A, Gi as B, Ia as C, ha as D, ba as E, $i as F, B as G, Ai as H, ki as I, Pr as J, bi as K, Ri as L, ea as M, ra as N, xa as O, U as P, pr as Q, Oi as R, Ua as S, Ca as T, ji as U, Ki as V, H as W, zr as X, Rr as Y, xr as Z, Aa as _, Nn as _t, qc as a, Jn as at, Va as b, hn as bt, Lc as c, Bn as ct, No as d, In as dt, _r as et, xo as f, Ln as ft, qa as g, Pn as gt, Ka as h, jn as ht, Jc as i, Yn as it, ta as j, ga as k, Fc as l, Hn as lt, Co as m, Un as mt, Yc as n, Qn as nt, Rc as o, Kn as ot, So as p, Rn as pt, ei as q, Xc as r, Xn as rt, Ic as s, qn as st, Zc as t, tr as tt, Po as u, Vn as ut, Wa as v, An as vt, va as w, Ha as x, _e as xt, Ba as y, sn as yt, Mi as z };
