...
import { B as we, C as Te, Ft as Ee, G as De, H as Oe, I as ke, K as Ae, L as je, M as Me, P as Ne, R as Pe, S as Fe, cn as Ie, et as Le, fn as Re, gn as ze, i as Be, j as Ve, jt as He, k as Ue, o as We, pt as Ge, tt as Ke, un as qe, y as Je, yt as Ye, z as Xe } from "./clipOptions-BWHr3aTa.js";
import { D as Ze, T as Qe, b as $e, et, nt as tt, ot as nt, v as rt, y as it } from "./vega-scale-CypF85iS.js";
import { h as at } from "./indexer-DAH_ruVn.js";
import { A as ot, E as st, G as ct, I as lt, O as ut, T as dt, W as ft, a as pt, c as mt, f as ht, h as gt, i as _t, m as vt, n as yt, p as bt, r as xt, s as St, t as Ct, v as wt, w as Tt } from "./viewSelectors-DNiDip5e.js";
import { n as Et, r as Dt } from "./viewIdentityRegistry-Dl-vMN9I.js";
import { t as Ot } from "./rectangle-DKnrAmKs.js";
import { a as kt, c as At, i as jt, l as Mt, n as Nt, o as Pt, r as Ft, s as It, t as Lt, u as Rt } from "./ref-Cz5268Ay.js";
import { $ as zt, A as Bt, B as Vt, C as Ht, D as Ut, E as Wt, F as Gt, G as Kt, H as qt, I as Jt, J as Yt, K as Xt, L as Zt, M as Qt, N as $t, O as en, P as tn, Q as nn, R as rn, S as an, T as on, U as sn, V as cn, W as ln, X as un, Y as dn, Z as fn, _ as pn, _t as mn, a as hn, at as gn, b as _n, bt as vn, c as yn, ct as bn, d as xn, dt as Sn, et as Cn, f as wn, ft as Tn, g as En, gt as Dn, h as On, ht as kn, i as An, it as jn, j as Mn, k as Nn, l as Pn, lt as Fn, m as In, mt as Ln, n as Rn, nt as zn, o as Bn, ot as Vn, p as Hn, pt as Un, q as Wn, r as Gn, rt as Kn, s as qn, st as Jn, tt as Yn, u as Xn, ut as Zn, v as Qn, vt as $n, w as er, x as tr, xt as nr, y as rr, yt as ir, z as ar } from "./agentApi-B36V-T_7.js";
...
function pr() {
	...
	function r(r) {
		...
		if (!Array.isArray(f)) {
			let e = d, n = +f;
			if (t === A && ([u, d] = dr(u, d, n)), f = tt(u, d, n), f[0] <= u && (s = et(u, d, n)), f[f.length - 1] >= d) if (e >= d && t === A) {
				let e = et(u, d, n);
...
`, Yc = class extends L {
	...
	#r = 0;
	constructor() {
		super(), this.values = [], this.thresholds = [], this.operators = [], this.colors = el, this.showThresholdNumbers = !1, this.binCount = 40, this.#e = pr().thresholds(this.binCount), this.#t = this.#e([]), this.#n = Ze();
	}
	willUpdate(e) {
	...
	#o(e, t, n) {
		n = Le(n, 0, 1), this.dispatchEvent(new Xc(e, t, +this.#n.invert(n * 100).toPrecision(3)));
	}
	#s() {
...
function ll(e, t) {
	let n = e.scale?.type;
	it(n) ? dl(e, t) : rt(n) || $e(n) ? pl(e, t) : e.type === "identifier" ? ul(e, t) : q("Not implemented (yet).");
}
function ul(e, t) {
...
function _m(e, { viewHeight: t = 0, sampleHeight: n = 0, groupSpacing: r = 5, sampleSpacingFactor: i = dm, summaryHeight: a = 0 }) {
	...
	for (let [e, t] of s.entries()) {
		...
		lt(r.map((e) => n), Math.max(0, l[e].locSize.size - a), { offset: l[e].locSize.location + a }).forEach((e, t) => {
			let { size: n, location: a } = e, o = n * i * .5 * Ke(15, 22, n);
...
function Tm(e, t = e.getCollector()) {
	...
	return !t || !n ? () => void 0 : a ? (e, r) => t.facetBatches.get(Ie(e))?.find((e) => r == n(e)) : !a && r ? (e, i) => t.facetBatches.get(Ie(e))?.find((e) => i >= n(e) && i < r(e)) : (e, r) => t.facetBatches.get(Ie(e))?.find((e) => r == n(e));
}
//#endregion
...
function Nm(e, t) {
	...
	return (e) => {
		let [t, n] = m(), r = a.facetBatches.get(Ie(e));
...
function qm(e, t) {
	...
	let m = f && Ge(f) ? r.getScaleResolution(f).getScale() : void 0, h = p && "scale" in p && p.scale && typeof p.scale == "object" ? p.scale : void 0, g = p && "type" in p ? p.type : void 0, _ = "aggregation" in n ? "quantitative" : g, v, y;
...
function og(e, t) {
	if (!e || !t || e.selection.intervals.x?.length !== 2 || !Ae(e.selection, t)) return {};
	...
	*[Symbol.iterator]() {
		...
		for (let [r, i] of c.summaries.entries()) {
			let a = t.modify({
				y: () => {
					...
					return this.#i ? n + Le(-e, 0, i.locSize.size - m) : n;
				},
				height: m
			}).expand(p);
			f.arrange(e, a, {
	...
	#z() {
		...
		for (let t of e) for (let [e, n] of t.paramRuntime.paramConfigs) {
			...
			let r = Ue(n.select);
			if (!Pe(r) || !r.encodings?.includes("x")) continue;
...
var __ = {
	...
	devDependencies: {
		"@genome-spy/app-agent": "^0.88.0",
		"@genome-spy/inspector": "^0.88.0"
	}
};
//#endregion
...
}, Z_ = (e) => [...e.paramRuntime.paramConfigs.values()].some((e) => Te(e) && e.bind), Q_ = (e, t) => {
	let n = [];
	return t && n.push({
		label: "Parameters",
		type: "header"
...
var _x = class extends L {
	...
	_getToolButtons() {
		...
		e.isEnabled() && t.push(I`
            ...
            `);
		let n = this.app.rootSpec.description ? Ie(this.app.rootSpec.description) : [];
...
var xx = "sampleCount", Sx = class extends Ee {
	#e = !0;
	#t;
	constructor(e, t) {
		super(), this.view = t;
	...
	initialize() {
		...
		if (Ye(e)) this.xAccessor = He(e.field);
	...
	#i(e) {
		let t = [...tr(e.rootGroup)].filter((e) => _n(qe(e)));
...
var sS = 150, cS = class {
	...
	#k(e) {
		return Je(e.param, e.view.paramRuntime);
	}
	#A(e, t) {
	...
	#I(e, t) {
		return Te(e.param) && Object.is(e.view.paramRuntime.getTargetValue(e.selector.param), t);
	}
	#L(e) {
		let t = e.selector.param;
		return Te(e.param) ? e.view.paramRuntime.getTargetValue(t) : e.view.paramRuntime.getValue(t);
	}
	async whenApplied(e) {
	...
	#R(e, t) {
		...
		return Te(n) ? r.type === "value" ? r.value : this.#j(e, "cannot be restored because the bookmark stored a different value type.") : this.#k(e);
	}
	#z(e, t, n) {
	...
	#X(e, t) {
		let n = e.param;
		Fe(n) && we(Ue(n.select)) && (this.#N(e, "persist") || this.#u.add(t));
	}
	#Z(e, t) {
		let n = Ue(e.select);
		return we(n) ? Oe(t) ? !t.datum : !Xe(t) || t.data.size === 0 : Pe(n) ? !ke(t) : !1;
	}
	#Q(e) {
...
var KS = class {
	...
	getAgentApi() {
		return this.#e ||= import("./agentApi-B36V-T_7.js").then((e) => e.t).then((e) => e.createAgentApi(this)), this.#e;
	}
	...
	async launch() {
		...
		let r = Ie(this.genomeSpy.spec.description ?? []);
