import { ct as e, et as t, o as n, s as r, un as i } from "./clipOptions-BWHr3aTa.js";
import { v as a } from "./vega-scale-CypF85iS.js";
import { t as o } from "./warning-CpIIpk8e.js";
import { t as s } from "./rectangle-DKnrAmKs.js";
import { n as c, t as l } from "./layoutResult-D50MSHXR.js";
import { n as u, r as d, t as f } from "./performanceProfiler-CPLEjApa.js";
import { A as p, C as m, E as h, M as g, N as _, O as v, S as y, _ as b, a as x, b as S, c as C, f as w, h as T, k as E, l as D, m as O, o as ee, p as te, s as ne, u as re, v as ie, y as k } from "./order-C5CzA37O.js";
import { n as A, t as j } from "./renderCanvas2D-DqvBWTey.js";
import { t as M } from "./canvasSizeHelper-7h_8rOcx.js";
import { exportCanvas as N, exportRaster as P } from "./rasterExport-BqJdWrpR.js";
import { createCanvas2DSvgRasterizer as F } from "./svgRasterizer-B65WR7Vh.js";
...
function K(e, t) {
	let n = e, r = k(n), i = Array(8).fill(0);
	return y(n, r, t, (e) => {
		let a = Y(n, e.datum), o = e.strokeWidth / 2;
		r.stem && t.rasterizer.strokeSegment(a, e.tail.x, e.tail.y, e.tip.x, e.tip.y, e.stemHalfWidth * 2 + e.strokeWidth), S(e, (n, r) => {
...
function q(e, t) {
	let n = e;
	return re(n, D(n), t, (e) => t.rasterizer.fillRect(Y(n, e.datum), e.x, e.y, e.width, e.height));
}
function J(e, t) {
	let n = e, r = h(n, n.properties.minPickingSize);
	return te(n, w(n), t, (e) => t.rasterizer.fillSquare(Y(n, e.datum), e.x, e.y, Math.max(e.boundsRadius, r / 2)));
}
function ae(e, t) {
	let n = e;
	return C(n, ne(n), t, (e) => t.rasterizer.strokeSegment(Y(n, e.datum), e.x1, e.y1, e.x2, e.y2, Math.max(e.strokeWidth, U)));
}
function oe(e, t) {
	let n = e, r = h(n, n.properties.minPickingSize), i = O(n), a = ie(n, i.shape);
	return T(n, i, t, (e) => {
		let [i, o, s, c] = e.points, l = a && b(i, c, a);
...
function se(e, t) {
	let n = e;
	return ee(n, x(n), t, (e) => t.rasterizer.fillConvexPolygon(Y(n, e.datum), e.boundsQuad));
}
...
var le = class extends c {
	...
	renderMark(e, t) {
		...
		if (i && !e.encoders.facetIndex && (this.#n?.addCount("canvasSampleFacetOccurrences"), !A(i))) {
			this.#n?.addCount("canvasCulledSampleFacetOccurrences");
			return;
		}
		let a = e.unitView.getEffectiveOpacity();
		if (a <= 0) return;
		let s = this.currentCoords, c = n(t), l = r(c, e.properties.clip, s), u = E(this.width, this.height, l);
		if (!p(u)) return;
		let d = v(s, c, e.properties.cullByVisibleRange), f = this.#i?.prepare(e) ?? !1;
		_(e, t, s, this.#r, (t, n) => {
...
function de(e, n, r, i = r) {
	let a = Array(e);
	a.fill(X);
	let o = ue, s = -Infinity, c = !1, l = Array(e);
	l.fill(0);
