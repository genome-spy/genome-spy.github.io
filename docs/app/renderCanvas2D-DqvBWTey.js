import { a as e, m as t, o as n, s as r, un as i } from "./clipOptions-BWHr3aTa.js";
...
import { A as c, C as l, D as u, E as d, M as f, N as p, O as m, _ as h, a as g, c as _, d as v, f as y, g as b, h as x, i as S, k as C, l as w, m as ee, n as T, o as E, p as D, r as O, s as k, t as A, u as j, v as M, x as N, y as P } from "./order-C5CzA37O.js";
...
function F(e, t) {
	...
	return N(n, a, t, (e) => {
		...
		let n = u(i.fill(e.datum)), c = l(i.fillOpacity, e.datum) * t.viewOpacity;
		n != "none" && c > 0 && (o != n && (r.fillStyle = n, o = n), r.globalAlpha = c, r.fill());
		let d = u(i.stroke(e.datum)), f = l(i.strokeOpacity, e.datum) * t.viewOpacity;
...
function I(e, n) {
	let r = e, i = n.context, a = r.encoders, o = ee(r), s = M(r, o.shape, n.secondOrderPass);
	i.lineCap = "butt";
	let c;
	return x(r, o, n, (e) => {
		let r = u(a.color(e.datum)), o = l(a.opacity, e.datum) * n.viewOpacity;
		if (r == "none" || o <= 0 || e.strokeWidth <= 0) return;
		let d = s && h(e.points[0], e.points[3], s);
		if (d) {
			let { normalX: e, normalY: n, offset: a, start: o, end: s } = d, l = i.createLinearGradient(e * (a - s), n * (a - s), e * (a + s), n * (a + s)), u = t(r), f = u.opacity;
			for (let e of b(o, s)) u.opacity = f * e.opacity, l.addColorStop(e.offset, u.formatRgb());
			i.strokeStyle = l, c = void 0;
		} else c != r && (i.strokeStyle = r, c = r);
		i.globalAlpha = o, i.lineWidth = e.strokeWidth;
		let [f, p, m, g] = e.points;
		i.beginPath(), i.moveTo(f[0], f[1]), i.bezierCurveTo(p[0], p[1], m[0], m[1], g[0], g[1]), i.stroke();
	});
}
//#endregion
...
function L(e, t) {
	let n = e;
	d(n, n.properties.fillGradientStrength) && t.warn("Canvas2D ignored unsupported point property fillGradientStrength."), n.properties.geometricZoomBound && t.warn("Canvas2D ignored unsupported point property geometricZoomBound.");
	let r = y(n), i = t.context, a = n.encoders, o, s;
	return D(n, r, t, (e) => {
		let n = e.datum, r = e.lineShape, c = u(a.fill(n)), d = l(a.fillOpacity, n) * t.viewOpacity, f = u(a.stroke(n)), p = l(a.strokeOpacity, n) * t.viewOpacity;
		r && (f == "none" || p <= 0) && (f = c, p = d), i.beginPath();
		...
		} else _ = v(e.shape, h, g, e.geometryRadius, i);
		m && i.restore(), _ || (t.warn(`Canvas2D rendered unsupported point shape "${e.shape}" as a circle.`), i.arc(e.x, e.y, e.geometryRadius, 0, Math.PI * 2)), !r && c != "none" && d > 0 && (o != c && (i.fillStyle = c, o = c), R(i, d), i.fill()), f != "none" && p > 0 && e.strokeWidth > 0 && (r && i.lineCap != "butt" && (i.lineCap = "butt"), s != f && (i.strokeStyle = f, s = f), R(i, p), z(i, e.strokeWidth), i.stroke());
	});
}
function R(e, t) {
...
function B(e, t) {
	...
	let a = t.context, o = n.encoders, s, c, d = [
		0,
		0,
		0,
		0
	], f = o.stroke.constant, p = o.strokeOpacity.constant, m = f ? u(o.stroke(t.data[i])) : "none", h = f && m == "none", g = !h && p ? l(o.strokeOpacity, t.data[i]) : 0;
	return j(n, r, t, (e) => {
		r.shadow.opacity > 0 && V(e, r.shadow, t, d);
		let n = e.opacityFactor, i = e.fill != "none" && e.fillOpacity > 0, _ = f ? m : u(o.stroke(e.datum)), v = (p ? g : l(o.strokeOpacity, e.datum)) * t.viewOpacity * n, y = !h && _ != "none" && v > 0 && e.strokeWidth > 0, b = r.hasCornerRadii && (e.radii.topLeft != 0 || e.radii.topRight != 0 || e.radii.bottomRight != 0 || e.radii.bottomLeft != 0);
		b && (i || y) && (d[0] = e.radii.topLeft, d[1] = e.radii.topRight, d[2] = e.radii.bottomRight, d[3] = e.radii.bottomLeft, a.beginPath(), a.roundRect(e.x, e.y, e.width, e.height, d)), i && (s != e.fill && (a.fillStyle = e.fill, s = e.fill), H(a, e.fillOpacity * n), b ? a.fill() : a.fillRect(e.x, e.y, e.width, e.height)), y && (c != _ && (a.strokeStyle = _, c = _), H(a, v), U(a, e.strokeWidth), b ? a.stroke() : a.strokeRect(e.x, e.y, e.width, e.height));
	});
}
function V(e, t, n, r) {
...
function W(e, t) {
	...
	r.lineCap = d(n, n.properties.strokeCap), r.setLineDash(d(n, n.properties.strokeDash) ?? []), r.lineDashOffset = d(n, n.properties.strokeDashOffset);
	let a;
	return _(n, k(n), t, (e) => {
		let n = u(i.color(e.datum)), o = l(i.opacity, e.datum) * t.viewOpacity;
...
function G(e, t) {
	let n = e, r = n.properties, i = g(n), a = t.context, o = n.encoders, s = T(r.font), c = `${r.fontStyle ?? "normal"} ${S(r.fontWeight ?? "normal")} `, f = i.baseline == "baseline" ? "alphabetic" : i.baseline;
	[
		r.viewportEdgeFadeWidthTop,
		r.viewportEdgeFadeWidthRight,
		r.viewportEdgeFadeWidthBottom,
		r.viewportEdgeFadeWidthLeft
	].some((e) => d(n, e) > 0) && t.warn("Canvas2D ignored unsupported text viewport edge fading.");
	let p, m;
	return i.logoLetters || (a.textAlign = i.align, a.textBaseline = f), E(n, i, t, (e) => {
		e.multiCharacterLogo && t.warn("Canvas2D stretches multi-character logo text as a single glyph cell.");
		let n = u(o.color(e.datum)), r = l(o.opacity, e.datum) * t.viewOpacity * e.fadeOpacity;
		if (!(n == "none" || r <= 0)) if (p != n && (a.fillStyle = n, p = n), a.globalAlpha = r, m != e.size && (a.font = `${c}${e.size}px ${s}`, m = e.size), e.logoScale) {
			...
			a.scale(e.logoScale.width / t, e.logoScale.heightScale), a.textAlign = "center", a.textBaseline = "alphabetic", a.fillText(e.text, 0, O("middle", 1)), a.restore();
...
var J = 8, Y = 16777216, X = class extends o {
	...
	renderMark(e, t) {
		...
		let i = this.#n.get(e.unitView);
		if (i === void 0 && (i = e.unitView.getEffectiveOpacity(), this.#n.set(e.unitView, i)), i <= 0) return;
		...
		let s = this.currentCoords, l = n(t), u = r(l, e.properties.clip, s), d = C(this.width, this.height, u);
		if (!c(d)) return;
		let f = m(s, l, e.properties.cullByVisibleRange), h = this.#o?.prepare(e) ?? !1, g = this.context;
		if (g.save(), u) {
		...
		try {
			...
			p(e, t, s, this.#a, (t, i) => {
				...
				if (!r) return c(i, o, s);
				let l = 0, u = A(i, o, s, n.predicate, n.passes);
				for (let [e, t] of u.entries()) t.length > 0 && (l += c(t, 0, t.length, e === 1));
				return l;
