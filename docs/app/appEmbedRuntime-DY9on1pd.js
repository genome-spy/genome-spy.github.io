...
var RS = class {
	...
	getAgentApi() {
		return this.#e ||= import("./agentApi-pm8-b3gw.js").then((e) => e.t).then((e) => e.createAgentApi(this)), this.#e;
	}
