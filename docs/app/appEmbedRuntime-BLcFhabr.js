...
import { $ as n, A as r, B as i, C as a, D as o, E as s, H as c, J as l, K as u, L as d, N as f, O as p, P as m, Q as h, R as g, S as _, T as v, U as y, V as b, W as x, X as S, Y as C, Z as w, _ as T, _t as E, a as D, b as O, c as k, ct as A, d as ee, dt as j, f as M, ft as N, g as P, gt as F, h as te, i as ne, it as re, j as ie, k as ae, l as oe, lt as se, m as ce, mt as I, n as le, o as ue, ot as de, p as fe, pt as pe, q as me, r as he, s as ge, st as _e, u as ve, ut as L, v as ye, w as be, x as xe, y as Se, z as Ce } from "./src-B7-27E-E.js";
import { B as we, Bt as Te, C as Ee, G as De, H as Oe, I as ke, It as Ae, K as je, L as Me, M as Ne, P as Pe, R as Fe, S as Ie, Sn as Le, _n as Re, et as ze, hn as Be, i as Ve, j as He, k as Ue, o as We, pn as Ge, pt as Ke, tt as qe, wn as Je, xn as Ye, y as Xe, yt as Ze, z as Qe } from "./clipOptions-DBJX_W31.js";
import { D as $e, T as et, b as tt, nt, v as rt, y as it } from "./vega-scale-BJaDSHBJ.js";
import { h as at } from "./indexer-Cdt_U05k.js";
import { A as ot, E as st, G as ct, I as lt, O as ut, T as dt, W as ft, a as pt, c as mt, f as ht, h as gt, i as _t, m as vt, n as yt, p as bt, r as xt, s as St, t as Ct, v as wt, w as Tt } from "./viewSelectors-C5q3qBiR.js";
import { n as Et, r as Dt } from "./viewIdentityRegistry-BvCJajXG.js";
import { t as Ot } from "./rectangle-DE98gIxF.js";
import { a as kt, c as At, i as jt, l as Mt, n as Nt, o as Pt, r as Ft, s as It, t as Lt, u as Rt } from "./ref-XwcGNu5_.js";
import { $ as zt, A as Bt, B as Vt, C as Ht, D as Ut, E as Wt, F as Gt, G as Kt, H as qt, I as Jt, J as Yt, K as Xt, L as Zt, M as Qt, N as $t, O as en, P as tn, Q as nn, R as rn, S as an, T as on, U as sn, V as cn, W as ln, X as un, Y as dn, Z as fn, _ as pn, _t as mn, a as hn, at as gn, b as _n, bt as vn, c as yn, ct as bn, d as xn, dt as Sn, et as Cn, f as wn, ft as Tn, g as En, gt as Dn, h as On, ht as kn, i as An, it as jn, j as Mn, k as Nn, l as Pn, lt as Fn, m as In, mt as Ln, n as Rn, nt as zn, o as Bn, ot as Vn, p as Hn, pt as Un, q as Wn, r as Gn, rt as Kn, s as qn, st as Jn, tt as Yn, u as Xn, ut as Zn, v as Qn, vt as $n, w as er, x as tr, xt as nr, y as rr, yt as ir, z as ar } from "./agentApi-Be0_6FqM.js";
...
function pr() {
	...
	function r(r) {
		...
		if (!Array.isArray(f)) {
			let e = d, n = +f;
			if (t === A && ([u, d] = dr(u, d, n)), f = Je(u, d, n), f[0] <= u && (s = Le(u, d, n)), f[f.length - 1] >= d) if (e >= d && t === A) {
				let e = Le(u, d, n);
		...
		} else for (i = 0; i < a; ++i) (o = c[i]) != null && u <= o && o <= d && g[nt(f, o, 0, p)].push(r[i]);
		return g;
	}
...
var { userAgent: wi = "" } = bi.navigator || {}, Ti = bi, B = xi, Ei = Si, Di = Ci;
Ti.document;
var Oi = !!B.documentElement && !!B.head && typeof B.addEventListener == "function" && typeof B.createElement == "function", ki = ~wi.indexOf("MSIE") || ~wi.indexOf("Trident/"), Ai = /fa(s|r|l|t|d|dr|dl|dt|b|k|kd|ss|sr|sl|st|sds|sdr|sdl|sdt)?[\-\ ]/, ji = /Font ?Awesome ?([56 ]*)(Solid|Regular|Light|Thin|Duotone|Brands|Free|Pro|Sharp Duotone|Sharp|Kit)?.*/i, Mi = {
	classic: {
		fa: "solid",
		fas: "solid",
		"fa-solid": "solid",
...
var Sa = z({}, Mi);
Sa[V] = z(z(z(z({}, { "fa-duotone": "duotone" }), Mi[V]), Hi.kit), Hi["kit-duotone"]);
var Ca = xa(Sa), wa = z({}, Bi);
wa[V] = z(z(z(z({}, { duotone: "fad" }), wa[V]), qi.kit), qi["kit-duotone"]);
var Ta = xa(wa), Ea = z({}, ea);
Ea[V] = z(z({}, Ea[V]), Ki.kit);
var Da = xa(Ea), Oa = z({}, Qi);
Oa[V] = z(z({}, Oa[V]), Wi.kit), xa(Oa);
...
B && typeof B.querySelector == "function" && [
...
Object.keys(Ra).forEach((e) => {
	...
	enumerable: !0,
	set: function(e) {
		za.cssPrefix = e, Ba.forEach((e) => e(H));
	},
	get: function() {
		return za.cssPrefix;
	}
}), Ti.FontAwesomeConfig = H;
var Ba = [];
function Va(e) {
	return Ba.push(e), () => {
...
function Wa(e) {
	if (!e || !Oi) return;
	let t = B.createElement("style");
	t.setAttribute("type", "text/css"), t.innerHTML = e;
	let n = B.head.childNodes, r = null;
...
function no() {
	let e = ua, t = da, n = H.cssPrefix, r = H.replacementClass, i = to;
	if (n !== e || r !== t) {
...
var so = oo[ca], co = [], lo = function() {
	B.removeEventListener("DOMContentLoaded", lo), uo = 1, co.map((e) => e());
}, uo = !1;
Oi && (uo = (B.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(B.readyState), uo || B.addEventListener("DOMContentLoaded", lo));
function fo(e) {
...
function xo(e, t) {
	...
	typeof so.hooks.addPack == "function" && !n ? so.hooks.addPack(e, bo(t)) : so.styles[e] = z(z({}, so.styles[e] || {}), r), e === "fas" && xo("fa", t);
}
...
var Po = () => {
	...
	let t = "far" in So || H.autoFetchSvg, n = go(Co, (e, n) => {
	...
	ko = n.names, Ao = n.unicodes, Eo = Uo(H.styleDefault, { family: H.familyDefault });
};
Va((e) => {
	Eo = Uo(e.styleDefault, { family: H.familyDefault });
}), Po();
function Fo(e, t) {
	return (Do[e] || {})[t];
}
...
function Ho(e) {
	let t = V, n = wo.reduce((e, t) => (e[t] = `${H.cssPrefix}-${t}`, e), {});
	return Ii.forEach((r) => {
		(e.includes(n[r]) || e.some((e) => To[r].includes(e))) && (t = r);
	}), t;
}
function Uo(e) {
	let { family: t = V } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = Ca[t][e];
...
function Ko(e) {
	let { skipLookups: t = !1 } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = null, r = na.concat(Xi), i = Go(e.filter((e) => r.includes(e))), a = Go(e.filter((e) => !na.includes(e))), [o = null] = i.filter((e) => (n = e, !Pi.includes(e))), s = Ho(i), c = z(z({}, Wo(a)), {}, { prefix: Uo(o, { family: s }) });
	return z(z(z({}, c), Xo({
		values: e,
		family: s,
		styles: So,
...
function qo(e, t, n) {
	...
	return i = a.iconName || o || i, r = a.prefix || r, r === "far" && !So.far && So.fas && !H.autoFetchSvg && (r = "fas"), {
		prefix: r,
		iconName: i
	};
}
var Jo = Ii.filter((e) => e !== V || e !== Fi), Yo = Object.keys(ea).filter((e) => e !== V).map((e) => Object.keys(ea[e])).flat();
function Xo(e) {
...
var Zo = class {
	...
	add() {
		...
		Object.keys(e).forEach((t) => {
			this.definitions[t] = z(z({}, this.definitions[t] || {}), e[t]), xo(t, e[t]);
			let n = Da[V][t];
			n && xo(n, e[t]), Po();
		});
	}
...
var ss = new Zo(), U = {
	noAuto: () => {
		H.autoReplaceSvg = !1, H.observeMutations = !1, is("noAuto");
	},
	config: H,
	dom: {
		i2svg: function() {
		...
		watch: function() {
			...
			H.autoReplaceSvg === !1 && (H.autoReplaceSvg = !0), H.observeMutations = !0, fo(() => {
				cs({ autoReplaceSvgRoot: t }), is("watch", e);
			});
		}
	},
	parse: { icon: (e) => {
		...
		if (typeof e == "string" && (e.indexOf(`${H.cssPrefix}-`) > -1 || e.match(ka))) {
	...
	let { autoReplaceSvgRoot: e = B } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
	(Object.keys(so.styles).length > 0 || H.autoFetchSvg) && Oi && H.autoReplaceSvg && U.dom.i2svg({ node: e });
};
function ls(e, t) {
...
function us(e) {
	...
	if (Qa(o) && n.found && !r.found) {
		...
		i.style = Za(z(z({}, a), {}, { "transform-origin": `${r.x + o.x / 16}em ${r.y + o.y / 16}em` }));
	}
	return [{
		tag: "svg",
		attributes: i,
...
function ds(e) {
	let { prefix: t, iconName: n, children: r, attributes: i, symbol: a } = e, o = a === !0 ? `${t}-${H.cssPrefix}-${n}` : a;
	return [{
		tag: "svg",
		attributes: { style: "display: none;" },
		children: [{
			tag: "symbol",
			attributes: z(z({}, i), {}, { id: o }),
			children: r
		}]
	}];
}
function fs(e) {
	let { icons: { main: t, mask: n }, prefix: r, iconName: i, transform: a, symbol: o, title: s, maskId: c, titleId: l, extra: u, watchable: d = !1 } = e, { width: f, height: p } = n.found ? n : t, m = Gi.includes(r), h = [H.replacementClass, i ? `${H.cssPrefix}-${i}` : ""].filter((e) => u.classes.indexOf(e) === -1).filter((e) => e !== "" || !!e).concat(u.classes).join(" "), g = {
		children: [],
	...
	return v.children = y, v.attributes = b, o ? ds(v) : us(v);
}
function ps(e) {
	let { content: t, width: n, height: r, transform: i, title: a, extra: o, watchable: s = !1 } = e, c = z(z(z({}, o.attributes), a ? { title: a } : {}), {}, { class: o.classes.join(" ") });
	s && (c[fa] = "");
	let l = z({}, o.styles);
	Qa(i) && (l.transform = eo({
		transform: i,
...
function ms(e) {
	let { content: t, title: n, extra: r } = e, i = z(z(z({}, r.attributes), n ? { title: n } : {}), {}, { class: r.classes.join(" ") }), a = Za(r.styles);
...
function gs(e) {
	...
	return i = Array.isArray(r) ? {
		tag: "g",
		attributes: { class: `${H.cssPrefix}-${Na.GROUP}` },
		children: [{
			tag: "path",
			attributes: {
				class: `${H.cssPrefix}-${Na.SECONDARY}`,
				fill: "currentColor",
				d: r[0]
			}
		}, {
...
function vs(e, t) {
	!ba && !H.showMissingIcons && e && console.error(`Icon with name "${e}" and prefix "${t}" is missing.`);
}
function ys(e, t) {
	let n = t;
	return t === "fa" && H.styleDefault !== null && (t = Bo()), new Promise((r, i) => {
		if (n === "fa") {
			let n = Ro(e) || {};
		...
		vs(e, t), r(z(z({}, _s), {}, { icon: H.showMissingIcons && e && as("missingIconAbstract") || {} }));
	});
}
var bs = () => {}, xs = H.measurePerformance && Di && Di.mark && Di.measure ? Di : {
	mark: bs,
	measure: bs
}, Ss = "FA \"6.7.2\"", Cs = (e) => (xs.mark(`${Ss} ${e} begins`), () => ws(e)), ws = (e) => {
	xs.mark(`${Ss} ${e} ends`), xs.measure(`${Ss} ${e}`, `${Ss} ${e} begins`, `${Ss} ${e} ends`);
}, Ts = {
	begin: Cs,
	end: ws
}, Es = () => {};
...
function As() {
	return H.autoReplaceSvg === !0 ? Fs.replace : Fs[H.autoReplaceSvg] || Fs.replace;
}
function js(e) {
...
function Ns(e) {
	let { ceFn: t = e.tag === "svg" ? js : Ms } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
var Fs = {
	replace: function(e) {
		...
		if (t.parentNode) if (e[1].forEach((e) => {
			t.parentNode.insertBefore(Ns(e), t);
		}), t.getAttribute(fa) === null && H.keepOriginalSource) {
			let e = B.createComment(Ps(t));
			t.parentNode.replaceChild(e, t);
		} else t.remove();
	},
	nest: function(e) {
		let t = e[0], n = e[1];
		if (~Ja(t).indexOf(H.replacementClass)) return Fs.replace(e);
		let r = RegExp(`${H.cssPrefix}-.*`);
		if (delete n[0].attributes.id, n[0].attributes.class) {
			let e = n[0].attributes.class.split(" ").reduce((e, t) => (t === H.replacementClass || t.match(r) ? e.toSvg.push(t) : e.toNode.push(t), e), {
				toNode: [],
				toSvg: []
			});
...
function Ls(e, t) {
	let n = typeof t == "function" ? t : Es;
	if (e.length === 0) n();
	else {
		let t = Is;
		H.mutateApproach === va && (t = Ti.requestAnimationFrame || Is), t(() => {
			let t = As(), r = Ts.begin("mutate");
			e.map(t), r(), n();
		});
	}
}
...
var Vs = null;
function Hs(e) {
	if (!Ei || !H.observeMutations) return;
	let { treeCallback: t = Es, nodeCallback: n = Es, pseudoElementsCallback: r = Es, observeMutationsRoot: i = B } = e;
	Vs = new Ei((e) => {
		if (Rs) return;
		let i = Bo();
		qa(e).forEach((e) => {
			if (e.type === "childList" && e.addedNodes.length > 0 && !Ds(e.addedNodes[0]) && (H.searchPseudoElements && r(e.target), t(e.target)), e.type === "attributes" && e.target.parentNode && H.searchPseudoElements && r(e.target.parentNode), e.type === "attributes" && Ds(e.target) && ~Ma.indexOf(e.attributeName)) if (e.attributeName === "class" && Os(e.target)) {
				let { prefix: t, iconName: n } = Ko(Ja(e.target));
				e.target.setAttribute(ha, t || i), n && e.target.setAttribute(ga, n);
			} else ks(e.target) && n(e.target);
		});
	}), Oi && Vs.observe(i, {
		childList: !0,
		attributes: !0,
...
function Gs(e) {
	...
	return i.prefix ||= Bo(), t && n && (i.prefix = t, i.iconName = n), i.iconName && i.prefix ? i : (i.prefix && r.length > 0 && (i.iconName = Io(i.prefix, e.innerText) || Fo(i.prefix, vo(e.innerText))), !i.iconName && H.autoFetchSvg && e.firstChild && e.firstChild.nodeType === Node.TEXT_NODE && (i.iconName = e.firstChild.data), i);
}
function Ks(e) {
	...
	return H.autoA11y && (n ? t["aria-labelledby"] = `${H.replacementClass}-title-${r || Ka()}` : (t["aria-hidden"] = "true", t.focusable = "false")), t;
}
function qs() {
	return {
		iconName: null,
...
function Js(e) {
	let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { styleParser: !0 }, { iconName: n, prefix: r, rest: i } = Gs(e), a = Ks(e), o = rs("parseNodeAttributes", {}, e), s = t.styleParser ? Ws(e) : [];
	return z({
		iconName: n,
...
var { styles: Ys } = so;
function Xs(e) {
	let t = H.autoReplaceSvg === "nest" ? Js(e, { styleParser: !1 }) : Js(e);
...
function Qs(e) {
	...
	let n = B.documentElement.classList, r = (e) => n.add(`${_a}-${e}`), i = (e) => n.remove(`${_a}-${e}`), a = H.autoFetchSvg ? Zs() : Pi.concat(Object.keys(Ys));
	...
	let c = Ts.begin("onTree"), l = s.reduce((e, t) => {
		try {
			let n = Xs(t);
			n && e.push(n);
		} catch (e) {
...
function ec(e) {
	return function(t) {
		...
		return i &&= (i || {}).icon ? i : os(i || {}), e(r, z(z({}, n), {}, { mask: i }));
	};
}
var tc = function(e) {
	...
	return ls(z({ type: "icon" }, e), () => (is("beforeDOMElementCreation", {
		iconDefinition: e,
		params: t
	}), H.autoA11y && (o ? l["aria-labelledby"] = `${H.replacementClass}-title-${s || Ka()}` : (l["aria-hidden"] = "true", l.focusable = "false")), fs({
		icons: {
			main: gs(p),
			mask: i ? gs(i.icon) : {
				found: !1,
	...
	hooks() {
		return { mutationObserverCallbacks(e) {
			return e.treeCallback = Qs, e.nodeCallback = $s, e;
		} };
	},
	provides(e) {
		e.i2svg = function(e) {
			let { node: t = B, callback: n = () => {} } = e;
			return Qs(t, n);
		}, e.generateSvgReplacementMutation = function(e, t) {
			let { iconName: n, title: r, titleId: i, prefix: a, transform: o, symbol: s, mask: c, maskId: l, extra: u } = t;
			return new Promise((t, d) => {
				Promise.all([ys(n, a), c.iconName ? ys(c.iconName, c.prefix) : Promise.resolve({
					found: !1,
					width: 512,
					height: 512,
					icon: {}
	...
	return { layer(e) {
		...
		return ls({ type: "layer" }, () => {
			...
			return e((e) => {
				...
				tag: "span",
				attributes: { class: [`${H.cssPrefix}-layers`, ...n].join(" ") },
				children: r
			}];
		});
	} };
	...
	return { counter(e) {
		...
		return ls({
			...
			extra: {
				attributes: i,
				styles: a,
				classes: [`${H.cssPrefix}-layers-counter`, ...r]
			}
		})));
	} };
} }, ac = {
		...
		return { text(e) {
			...
			return ls({
				...
				extra: {
					attributes: a,
					styles: o,
					classes: [`${H.cssPrefix}-layers-text`, ...i]
				}
			})));
		} };
	},
	provides(e) {
		e.generateLayersText = function(e, t) {
			...
			return H.autoA11y && !n && (i.attributes["aria-hidden"] = "true"), Promise.resolve([e, ps({
				content: e.innerHTML,
				width: a,
				height: o,
				transform: r,
...
}, oc = /* @__PURE__ */ RegExp("\"", "ug"), sc = [1105920, 1112319], cc = z(z(z(z({}, { FontAwesome: {
	normal: "fas",
	400: "fas"
} }), Ri), sa), Zi), lc = Object.keys(cc).reduce((e, t) => (e[t.toLowerCase()] = cc[t], e), {}), uc = Object.keys(lc).reduce((e, t) => {
	let n = lc[t];
	return e[t] = n[900] || [...Object.entries(n)][0][1], e;
}, {});
function dc(e) {
	let t = e.replace(oc, ""), n = yo(t, 0), r = n >= sc[0] && n <= sc[1], i = t.length === 2 && t[0] === t[1];
	return {
		value: vo(i ? t[0] : t),
		isSecondary: r || i
	};
...
function pc(e, t) {
	...
	return new Promise((r, i) => {
		...
		if (c && u !== "none" && u !== "") {
			let u = o.getPropertyValue("content"), d = fc(s, l), { value: f, isSecondary: p } = dc(u), m = c[0].startsWith("FontAwesome"), h = Fo(d, f), g = h;
			if (m) {
				let e = zo(f);
			...
			if (h && !p && (!a || a.getAttribute(ha) !== d || a.getAttribute(ga) !== g)) {
				...
				let o = qs(), { extra: s } = o;
				s.attributes[pa] = t, ys(h, d).then((i) => {
					let a = fs(z(z({}, o), {}, {
						icons: {
							main: i,
							mask: Vo()
...
function mc(e) {
	return Promise.all([pc(e, "::before"), pc(e, "::after")]);
}
function hc(e) {
...
function gc(e) {
	if (Oi) return new Promise((t, n) => {
		let r = qa(e.querySelectorAll("*")).filter(hc).map(mc), i = Ts.begin("searchPseudoElements");
		zs(), Promise.all(r).then(() => {
			i(), Bs(), t();
		}).catch(() => {
			i(), Bs(), n();
		});
...
var _c = {
	hooks() {
		return { mutationObserverCallbacks(e) {
			return e.pseudoElementsCallback = gc, e;
		} };
	},
	provides(e) {
		e.pseudoElements2svg = function(e) {
			let { node: t = B } = e;
			H.searchPseudoElements && gc(t);
		};
	}
}, vc = !1, yc = {
	mixout() {
	...
	hooks() {
		return {
			bootstrap() {
				Hs(rs("mutationObserverCallbacks", {}));
			},
			noAuto() {
				Us();
			},
			watch(e) {
				...
				vc ? Bs() : Hs(rs("mutationObserverCallbacks", { observeMutationsRoot: t }));
			}
		};
	}
}, bc = (e) => e.toLowerCase().split(" ").reduce((e, t) => {
	...
	provides(e) {
		e.generateAbstractTransformGrouping = function(e) {
			...
			return {
				tag: "g",
				attributes: z({}, a.outer),
				children: [{
					tag: "g",
					attributes: z({}, a.inner),
					children: [{
						tag: t.icon.tag,
						children: t.icon.children,
						attributes: z(z({}, t.icon.attributes), a.path)
					}]
				}]
			};
		};
		...
		provides(e) {
			e.generateAbstractMask = function(e) {
				let { children: t, attributes: n, main: r, mask: i, maskId: a, transform: o } = e, { width: s, icon: c } = r, { width: l, icon: u } = i, d = $a({
					...
					tag: "rect",
					attributes: z(z({}, Sc), {}, { fill: "white" })
				}, p = c.children ? { children: c.children.map(Cc) } : {}, m = {
					tag: "g",
					attributes: z({}, d.inner),
					children: [Cc(z({
						tag: c.tag,
						attributes: z(z({}, c.attributes), d.path)
					}, p))]
				}, h = {
					tag: "g",
	...
	{ provides(e) {
		...
		Ti.matchMedia && (t = Ti.matchMedia("(prefers-reduced-motion: reduce)").matches), e.missingIconAbstract = function() {
			...
			return t || a.children.push({
				...
				tag: "animate",
				attributes: z(z({}, i), {}, { values: "1;0;1;1;0;1;" })
			}), e.push(a), e.push({
				tag: "path",
				attributes: z(z({}, n), {}, {
					opacity: "1",
				...
				children: t ? [] : [{
					tag: "animate",
					attributes: z(z({}, i), {}, { values: "1;0;0;0;0;1;" })
				}]
			}), t || e.push({
				tag: "path",
				attributes: z(z({}, n), {}, {
				...
				children: [{
					tag: "animate",
					attributes: z(z({}, i), {}, { values: "0;0;1;1;0;0;" })
				}]
			}), {
				tag: "g",
...
], { mixoutsTo: U }), U.noAuto, U.config, U.library;
var Tc = U.dom;
U.parse, U.findIconDefinition, U.toHtml;
var W = U.icon;
U.layer, U.text, U.counter;
//#endregion
//#region ../app/src/components/generic/componentStyles.js
var Ec = E(Tc.css()), Dc = F`
    :host {
...
`, Oc = /* @__PURE__ */ new Set([
	...
	renderHeader() {
		return I`${this.dialogTitle ? I`${this.dialogTitle}` : j}`;
	}
	renderBody() {
		return I``;
	}
	...
	render() {
		...
		return I`
            ${this.modal ? j : I`<div class="non-modal-backdrop"></div>`}
            <dialog
                @cancel=${(e) => this.#a(e)}
            >
                ${e ? I`<header>${e}</header>` : j}
                <section>${this.renderBody()}</section>
                ${t ? I`<footer>${t}</footer>` : j}
            </dialog>
        `;
	}
};
function K(e, t) {
	return jc(e, t).promise;
}
function kc(e, t, n) {
	return K(e, t).then(n);
}
function Ac(e, t) {
	return kc(e, t, (e) => !!e.ok);
}
function jc(e, t) {
	...
	renderBody() {
		if (this.type) {
			...
			return I`<div class="message-flex">
                ${e ? I`<div class="icon">${W(e).node[0]}</div>` : j}
                <div class="message">${this.message}</div>
            </div>`;
		} else return I`${this.message}`;
	}
};
customElements.define("gs-message-dialog", Nc);
function q(e, t = {}) {
	return Ac("gs-message-dialog", (n) => {
...
var Pc = (e, t, n) => {
	...
	update(e, [t, n, r]) {
		...
		else if (l === void 0 && (l = Pc(o, p, m), u = Pc(s, d, f)), l.has(s[d])) if (l.has(s[f])) {
...
`, Lc = class extends G {
	...
	connectedCallback() {
		...
		this.logicalWidth = Rc(e), this.logicalHeight = Rc(t);
	}
	willUpdate(e) {
		if ([
			"logicalWidth",
	...
	renderBody() {
		return I`
			...
			this.transparentBackground = e.checked;
                        ...
                        Transparent</label
                    >
                    ${this.transparentBackground ? j : I`<input
                                  type="color"
                                  id="pngBackground"
	...
	async #e() {
		...
		try {
			...
			return t.href = await Bc(e), t.download = "genomespy-visualization.png", document.body.appendChild(t), t.click(), t.remove(), this.finish({ ok: !0 }), !1;
		} catch (e) {
...
customElements.define("gs-save-image-dialog", Lc);
function Rc(e) {
...
var Hc = class extends L {
	...
	constructor() {
		super(), this.items = [], this.selectedValues = [], this.placeholder = "Type something to filter the list", this.selectedItemName = "items", this.itemMarker = () => j, this.search = "";
	}
	getFilteredItems() {
	...
	#t(e) {
		...
		t.checked ? n.add(r.value) : n.delete(r.value), this.selectedValues = this.items.map((e) => e.value).filter((e) => n.has(e)), this.dispatchEvent(new Uc(this.selectedValues));
	}
	#n(e) {
		if (e.key == "ArrowDown") this.renderRoot.querySelector(".checkbox-list li:first-child input[type='checkbox']")?.focus(), e.preventDefault(), e.stopPropagation();
			...
			if (t.length == 1) {
				...
				e.add(t[0].value), this.selectedValues = this.items.map((e) => e.value).filter((t) => e.has(t)), this.dispatchEvent(new Uc(this.selectedValues));
			}
			e.stopPropagation();
		}
	}
...
customElements.define("gs-searchable-checkbox-list", Hc);
var Uc = class extends Event {
	...
	static styles = [Dc, F`
        ...
        `];
	constructor() {
		super(), this.value = "lt", this.options = Wc;
	}
	#e(e) {
		this.value = e, this.dispatchEvent(new Kc(e));
	}
	render() {
...
customElements.define("gs-comparison-operator-buttons", Gc);
...
`, Yc = class extends L {
	...
	#r = 0;
	constructor() {
		super(), this.values = [], this.thresholds = [], this.operators = [], this.colors = el, this.showThresholdNumbers = !1, this.binCount = 40, this.#e = pr().thresholds(this.binCount), this.#t = this.#e([]), this.#n = $e();
	}
	willUpdate(e) {
		e.has("binCount") && (this.#e = pr().thresholds(this.binCount)), (e.has("values") || e.has("binCount")) && (this.#t = this.#e(this.values), this.#n = $e().domain(this.domain).range([0, 100]));
	}
	get domain() {
	...
	#o(e, t, n) {
		n = ze(n, 0, 1), this.dispatchEvent(new Xc(e, t, +this.#n.invert(n * 100).toPrecision(3)));
	}
	#s() {
		...
		for (let c = 0; c < e.length; c++) {
			...
			if (i) for (let e = 0; e <= 1; e++) {
				let t = $c(l, this.thresholds[0], e > 0);
				t && r.push({
					x: u,
					y: d * n,
					height: t * n,
				...
				let t = s(e), i = Qc(l, a[t], a[t + 1], !o[t], o[t + 1]);
				i && r.push({
					x: u,
					y: d * n,
					height: i * n,
		...
		return I`<div class="histogram-widget">
			...
			return r >= 0 && r <= 100 ? I`<div
                              ...
                              >
                                  ...
                                  >
                                      ${this.showThresholdNumbers ? n + 1 : j}
                                  </div>
                              </div>` : j;
		})}
                </div>
...
customElements.define("gs-histogram", Yc);
var Xc = class extends Event {
	constructor(e, t, n) {
...
var il = class extends L {
	...
	get #e() {
		return this.values.filter(ol);
	}
	#t(e) {
		e.stopPropagation(), this.operator = e.value, this.#a();
	}
	#n(e) {
		let t = e.target.value, n = tl(t);
		(n !== void 0 || t.trim() === "") && (this.operand = n, this.#a());
	}
	#r(e) {
		let t = rl(this.operand, e.value);
	...
	#a() {
		this.dispatchEvent(new al(this.operator, this.operand));
	}
	focus(e) {
		...
		return I`
            <div class="gs-form-group">
                ...
                <input
                    type="number"
                    placeholder=${this.placeholder}
                    .value=${ol(this.operand) ? String(this.operand) : ""}
                    @input=${(e) => this.#n(e)}
                />
            </div>
        `;
...
customElements.define("gs-threshold-comparison-input", il);
var al = class extends Event {
	operator;
	operand;
	constructor(e, t) {
		super("change", {
...
var sl = class extends G {
	...
	constructor() {
		super(), this.categories = [], this.attributeInfo = null, this.sampleView = null, this.categoryToMarker = () => j, this.selection = [];
	}
	willUpdate(e) {
...
customElements.define("gs-discrete-attribute-filter-dialog", sl);
...
customElements.define("gs-quantitative-attribute-filter-dialog", cl);
function ll(e, t) {
	let n = e.scale?.type;
	it(n) ? dl(e, t) : rt(n) || tt(n) ? pl(e, t) : e.type === "identifier" ? ul(e, t) : q("Not implemented (yet).");
}
function ul(e, t) {
	fl(t.getSamples().map((e) => e.id), e, t);
}
function dl(e, t) {
	let n = e.scale;
	fl(n.domain(), e, t, (e) => I`<span
            class="color"
            style=${l({ backgroundColor: n(e).toString() })}
        ></span>`);
}
function fl(e, t, n, r = (e) => j) {
                    ...
                    ${r.map((e) => I`
                            <tr>
                                <td>
                                    <span
                                        class="group-color"
                                        style="background-color: ${el[e.index]}"
                                    ></span>
                                    ${e.name}
                                </td>
                                <td>${e.interval}</td>
...
customElements.define("gs-group-by-thresholds-dialog", ml);
function hl(e, t) {
...
customElements.define("gs-retain-first-n-categories-dialog", gl);
function _l(e, t) {
...
var vl = class extends G {
	...
	#r() {
		return this.conditionAttributeInfo?.type === "quantitative" ? !ol(this.operand) : this.values.length === 0;
	}
	#i() {
		let e;
		if (this.conditionAttributeInfo.type === "quantitative") {
			if (!ol(this.operand)) throw Error("Quantitative category condition is missing a value.");
			e = {
	...
	#a() {
		return bl(this.conditionAttributeInfo, this.sampleView).map((e) => ({
			value: e,
			label: `${e}`,
			searchText: `${e}`.toLowerCase()
		}));
	...
	#o() {
		...
		return e ? (t) => I`<span
                class="color"
                style=${l({ backgroundColor: e(t).toString() })}
            ></span>` : () => j;
	}
};
customElements.define("gs-retain-categories-by-attribute-dialog", vl);
function yl(e, t, n) {
...
function bl(e, t) {
	...
	return Array.isArray(n) ? n.filter((n) => xl(e, t).has(n)) : Array.from(xl(e, t));
}
function xl(e, t) {
...
var kl = {
	...
	addMetadataFromSource: ({ template: e, payload: t }) => {
		let n = Array.isArray(t.columnIds) ? t.columnIds : [], r = t.sourceId ? I` from <strong>${t.sourceId}</strong> source` : "", i = n.length === 1 ? "attribute" : "attributes", a = n.length > 0 && n.length <= 3 ? Ol(n) : I`<strong>${n.length}</strong> ${i}`;
		return {
			...e,
	...
	filterByNominal: ({ payload: e, template: t, attributeName: n, attributeTitle: r }) => {
		let i = e.values, a = (t) => I`
            ...
            ${i[0] === void 0 || i[0] === null ? I` undefined ${t} ` : I`${t}
                  ${i.length > 1 ? I`in ${Dl(i)}` : I`<span class="operator">=</span>
                            <strong>${i[0]}</strong>`} `}
        `;
		return {
			...t,
	...
	groupCustomCategories: ({ payload: e, template: t, attributeTitle: n }) => {
        ...
        ${n}.
        ${Sl(Object.entries(r), ([e, t], n) => I`${n > 0 ? ", " : ""}<strong>${e}</strong> =
                    ${Dl(t)}`)}`;
		return {
			...t,
	...
	groupByThresholds: ({ payload: e, template: t, attributeTitle: n }) => ({
		...
		provenanceTitle: I`
            Group by thresholds
            ${Dl(e.thresholds.map((e) => `${El[e.operator]} ${e.operand}`))}
            ${e.groupTitles ? I` as
                      ${Dl(e.groupTitles)}` : ""}
            on ${n}
        `,
	...
	removeGroup: ({ payload: e }) => ({
		...
		provenanceTitle: I`
            Remove group
            ${Cl(e.path.map((e) => I`<strong>${e}</strong>`), " / ")}
        `,
		icon: br
	}),
...
function Al(e) {
	return e.operator === "in" ? I`in ${Dl(e.values)}` : I`
            <span class="operator">${El[e.operator]}</span>
            <strong>${Tl(e.operand)}</strong>
        `;
}
function jl(e, t) {
	...
	let n = e.payload && typeof e.payload == "object" ? e.payload : {}, r = (e) => {
		if (!e) return {};
		try {
			let n = t(e), r = e && typeof e == "object" && "specifier" in e && typeof e.specifier == "string" ? I` <em>${e.specifier}</em> ` : void 0, i = n ? wl(n) : r;
			return {
				attributeInfo: n,
				attributeName: i,
	...
	}, { attributeName: i, attributeTitle: a } = r("attribute" in n && n.attribute ? n.attribute : null), { attributeName: o, attributeTitle: s } = r("condition" in n && n.condition && typeof n.condition == "object" && "attribute" in n.condition ? n.condition.attribute : null), c = { attributeName: i }, l = e.type.substring(pn.length + 1), u = kl[l];
	return u ? u({
		payload: n,
		template: c,
		attributeName: i,
...
`, Nl = class extends G {
	...
	#n(e, t = "", n = "") {
		let r = I` <p>
            ...
            <div class="gs-form-group">
                ...
                <label for="paste-group-categories">${Il(e)}</label>
                <textarea
	...
	renderBody() {
		let e = this.attributeInfo, t = e.type == "identifier" ? "Identifier" : "Category", n = e.scale, r = n ? (e) => I`<span
                      class="color"
                      style=${l({ backgroundColor: n(e)?.toString() ?? "inherit" })}
                  ></span>` : () => j, i = un((e) => e, this.groups), a = Object.keys(this.groups);
		return I`
            <div class="gs-alert info">
                ${W(Wr).node[0]}
                <span>
...
customElements.define("gs-create-custom-groups-dialog", Nl);
function Pl(e, t) {
	return K("gs-create-custom-groups-dialog", (n) => {
		n.attributeInfo = e, n.sampleView = t, n.values = Fl(e, t.leafSamples, t.sampleHierarchy), n.groups = {};
	});
}
function Fl(e, t, n) {
...
var Ll = Math.min, Rl = Math.max, zl = Math.round, Bl = Math.floor, Vl = (e) => ({
	x: e,
	y: e
}), Hl = {
	left: "right",
...
function Xl(e, t, n) {
	n === void 0 && (n = !1);
	let r = Gl(e), i = Yl(e), a = ql(i), o = i === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
	return t.reference[a] > t.floating[a] && (o = au(o)), [o, au(o)];
}
function Zl(e) {
	let t = au(e);
	return [
...
var $l = ["left", "right"], eu = ["right", "left"], tu = ["top", "bottom"], nu = ["bottom", "top"];
function ru(e, t, n) {
	switch (e) {
		case "top":
		case "bottom": return n ? t ? eu : $l : t ? $l : eu;
		case "left":
		case "right": return t ? tu : nu;
		default: return [];
	}
}
function iu(e, t, n, r) {
	let i = Gl(e), a = ru(Wl(e), n === "start", r);
	return i && (a = a.map((e) => e + "-" + i), t && (a = a.concat(a.map(Ql)))), a;
}
function au(e) {
	let t = Wl(e);
...
function lu(e, t, n) {
	let { reference: r, floating: i } = e, a = Jl(t), o = Yl(t), s = ql(o), c = Wl(t), l = a === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[s] / 2 - i[s] / 2, p;
	switch (c) {
		case "top":
			p = {
				x: u,
...
async function uu(e, t) {
	t === void 0 && (t = {});
	let { x: n, y: r, platform: i, rects: a, elements: o, strategy: s } = e, { boundary: c = "clippingAncestors", rootBoundary: l = "viewport", elementContext: u = "floating", altBoundary: d = !1, padding: f = 0 } = Ul(t, e), p = su(f), m = o[d ? u === "floating" ? "reference" : "floating" : u], h = cu(await i.getClippingRect({
...
var du = 50, fu = async (e, t, n) => {
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var n;
			let { placement: r, middlewareData: i, rects: a, initialPlacement: o, platform: s, elements: c } = t, { mainAxis: l = !0, crossAxis: u = !0, fallbackPlacements: d, fallbackStrategy: f = "bestFit", fallbackAxisSideDirection: p = "none", flipAlignment: m = !0, ...h } = Ul(e, t);
			if ((n = i.arrow) != null && n.alignmentOffset) return {};
			let g = Wl(r), _ = Jl(o), v = Wl(o) === o, y = await (s.isRTL == null ? void 0 : s.isRTL(c.floating)), b = d || (v || !m ? [au(o)] : Zl(o)), x = p !== "none";
			!d && x && b.push(...iu(o, m, p, y));
			...
			if (T = [...T, {
				...
				if (t && (!(u === "alignment" && _ !== Jl(t)) || T.every((e) => Jl(e.placement) !== _ || e.overflows[0] > 0))) return {
					data: {
						index: e,
						overflows: T
					},
...
async function hu(e, t) {
	let { placement: n, platform: r, elements: i } = e, a = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), o = Wl(n), s = Gl(n), c = Jl(n) === "y", l = mu.has(o) ? -1 : 1, u = a && c ? -1 : 1, d = Ul(t, e), { mainAxis: f, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
...
function xu(e) {
	return _u() ? e instanceof Node || e instanceof yu(e).Node : !1;
}
function Su(e) {
	return _u() ? e instanceof Element || e instanceof yu(e).Element : !1;
}
function Cu(e) {
	return _u() ? e instanceof HTMLElement || e instanceof yu(e).HTMLElement : !1;
}
function wu(e) {
	return !_u() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof yu(e).ShadowRoot;
}
function Tu(e) {
	let { overflow: t, overflowX: n, overflowY: r, display: i } = Iu(e);
...
var Ou = /transform|translate|scale|rotate|perspective|filter/, ku = /paint|layout|strict|content/, Au = (e) => !!e && e !== "none", ju;
function Mu(e) {
	let t = Su(e) ? Iu(e) : e;
	return Au(t.transform) || Au(t.translate) || Au(t.scale) || Au(t.rotate) || Au(t.perspective) || !Pu() && (Au(t.backdropFilter) || Au(t.filter)) || Ou.test(t.willChange || "") || ku.test(t.contain || "");
}
function Nu(e) {
	let t = Ru(e);
	for (; Cu(t) && !Fu(t);) {
...
function Pu() {
	return ju ??= typeof CSS < "u" && CSS.supports && CSS.supports("-webkit-backdrop-filter", "none"), ju;
}
function Fu(e) {
	return /^(html|body|#document)$/.test(vu(e));
}
function Iu(e) {
	return yu(e).getComputedStyle(e);
}
function Lu(e) {
	return Su(e) ? {
...
function Ru(e) {
	...
	let t = e.assignedSlot || e.parentNode || wu(e) && e.host || bu(e);
	return wu(t) ? t.host : t;
}
function zu(e) {
	let t = Ru(e);
	return Fu(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Cu(t) && Tu(t) ? t : zu(t);
}
function Bu(e, t, n) {
	t === void 0 && (t = []), n === void 0 && (n = !0);
	let r = zu(e), i = r === e.ownerDocument?.body, a = yu(r);
	if (i) {
		let e = Vu(a);
		return t.concat(a, a.visualViewport || [], Tu(r) ? r : [], e && n ? Bu(e) : []);
	} else return t.concat(r, Bu(r, [], n));
}
function Vu(e) {
...
function Hu(e) {
	let t = Iu(e), n = parseFloat(t.width) || 0, r = parseFloat(t.height) || 0, i = Cu(e), a = i ? e.offsetWidth : n, o = i ? e.offsetHeight : r, s = zl(n) !== a || zl(r) !== o;
	return s && (n = a, r = o), {
		width: n,
		height: r,
		$: s
...
function Wu(e) {
	let t = Uu(e);
	if (!Cu(t)) return Vl(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = Hu(t), o = (a ? zl(n.width) : n.width) / r, s = (a ? zl(n.height) : n.height) / i;
	return (!o || !Number.isFinite(o)) && (o = 1), (!s || !Number.isFinite(s)) && (s = 1), {
		x: o,
		y: s
	};
}
var Gu = /*#__PURE__*/ Vl(0);
function Ku(e) {
	let t = yu(e);
	return !Pu() || !t.visualViewport ? Gu : {
		x: t.visualViewport.offsetLeft,
		y: t.visualViewport.offsetTop
	};
}
function qu(e, t, n) {
	return t === void 0 && (t = !1), !n || t && n !== yu(e) ? !1 : t;
}
function Ju(e, t, n, r) {
	t === void 0 && (t = !1), n === void 0 && (n = !1);
	let i = e.getBoundingClientRect(), a = Uu(e), o = Vl(1);
	t && (r ? Su(r) && (o = Wu(r)) : o = Wu(e));
	let s = qu(a, n, r) ? Ku(a) : Vl(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a) {
		let e = yu(a), t = r && Su(r) ? yu(r) : r, n = e, i = Vu(n);
		for (; i && r && t !== n;) {
			let e = Wu(i), t = i.getBoundingClientRect(), r = Iu(i), a = t.left + (i.clientLeft + parseFloat(r.paddingLeft)) * e.x, o = t.top + (i.clientTop + parseFloat(r.paddingTop)) * e.y;
			c *= e.x, l *= e.y, u *= e.x, d *= e.y, c += a, l += o, n = yu(i), i = Vu(n);
		}
	}
	return cu({
		width: u,
...
function Yu(e, t) {
	let n = Lu(e).scrollLeft;
	return t ? t.left + n : Ju(bu(e)).left + n;
}
function Xu(e, t) {
	let n = e.getBoundingClientRect();
	return {
		x: n.left + t.scrollLeft - Yu(e, n),
		y: n.top + t.scrollTop
	};
}
function Zu(e) {
	let { elements: t, rect: n, offsetParent: r, strategy: i } = e, a = i === "fixed", o = bu(r), s = t ? Du(t.floating) : !1;
	if (r === o || s && a) return n;
	let c = {
		scrollLeft: 0,
		scrollTop: 0
	}, l = Vl(1), u = Vl(0), d = Cu(r);
	if ((d || !d && !a) && ((vu(r) !== "body" || Tu(o)) && (c = Lu(r)), d)) {
		let e = Ju(r);
		l = Wu(r), u.x = e.x + r.clientLeft, u.y = e.y + r.clientTop;
	}
	let f = o && !d && !a ? Xu(o, c) : Vl(0);
	return {
		width: n.width * l.x,
		height: n.height * l.y,
...
function $u(e) {
	let t = bu(e), n = Lu(e), r = e.ownerDocument.body, i = Rl(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = Rl(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + Yu(e), s = -n.scrollTop;
	return Iu(r).direction === "rtl" && (o += Rl(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
var ed = 25;
function td(e, t) {
	let n = yu(e), r = bu(e), i = n.visualViewport, a = r.clientWidth, o = r.clientHeight, s = 0, c = 0;
	if (i) {
...
function nd(e, t) {
	let n = Ju(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = Cu(e) ? Wu(e) : Vl(1);
	return {
...
function rd(e, t, n) {
	let r;
	if (t === "viewport") r = td(e, n);
	else if (t === "document") r = $u(bu(e));
	else if (Su(t)) r = nd(t, n);
	else {
		let n = Ku(e);
		r = {
			x: t.x - n.x,
...
function id(e, t) {
	let n = Ru(e);
	return n === t || !Su(n) || Fu(n) ? !1 : Iu(n).position === "fixed" || id(n, t);
}
function ad(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = Bu(e, [], !1).filter((e) => Su(e) && vu(e) !== "body"), i = null, a = Iu(e).position === "fixed", o = a ? Ru(e) : e;
	for (; Su(o) && !Fu(o);) {
		let t = Iu(o), n = Mu(o);
		!n && t.position === "fixed" && (i = null), (a ? !n && !i : !n && t.position === "static" && i && (i.position === "absolute" || i.position === "fixed") || Tu(o) && !n && id(e, o)) ? r = r.filter((e) => e !== o) : i = t, o = Ru(o);
	}
	return t.set(e, r), r;
}
function od(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? Du(t) ? [] : ad(t, this._c) : [].concat(n), r], o = rd(t, a[0], i), s = o.top, c = o.right, l = o.bottom, u = o.left;
	for (let e = 1; e < a.length; e++) {
		let n = rd(t, a[e], i);
		s = Rl(n.top, s), c = Ll(n.right, c), l = Ll(n.bottom, l), u = Rl(n.left, u);
	}
	return {
		width: c - u,
		height: l - s,
...
function cd(e, t, n) {
	let r = Cu(t), i = bu(t), a = n === "fixed", o = Ju(e, !0, a, t), s = {
		scrollLeft: 0,
		scrollTop: 0
	}, c = Vl(0);
	function l() {
	...
	if (r || !r && !a) if ((vu(t) !== "body" || Tu(i)) && (s = Lu(t)), r) {
		let e = Ju(t, !0, a, t);
		c.x = e.x + t.clientLeft, c.y = e.y + t.clientTop;
	} else i && l();
	a && !r && i && l();
	let u = i && !r && !a ? Xu(i, s) : Vl(0);
	return {
...
function ld(e) {
	return Iu(e).position === "static";
}
function ud(e, t) {
	if (!Cu(e) || Iu(e).position === "fixed") return null;
	if (t) return t(e);
	let n = e.offsetParent;
	return bu(e) === n && (n = n.ownerDocument.body), n;
}
function dd(e, t) {
	let n = yu(e);
	if (Du(e)) return n;
	if (!Cu(e)) {
		let t = Ru(e);
		for (; t && !Fu(t);) {
			if (Su(t) && !ld(t)) return t;
			t = Ru(t);
		}
		return n;
	}
	let r = ud(e, t);
	for (; r && Eu(r) && ld(r);) r = ud(r, t);
	return r && Fu(r) && ld(r) && !Mu(r) ? n : r || Nu(e) || n;
}
var fd = async function(e) {
	let t = this.getOffsetParent || dd, n = this.getDimensions, r = await n(e.floating);
	return {
...
function gd(e, t) {
	...
	function o(s, c) {
		...
		if (s || t(), !f || !p) return;
		let m = Bl(d), h = Bl(i.clientWidth - (u + f)), g = Bl(i.clientHeight - (d + p)), _ = Bl(u), v = {
			rootMargin: -m + "px " + -h + "px " + -g + "px " + -_ + "px",
			threshold: Rl(0, Ll(1, c)) || 1
		}, y = !0;
		function b(t) {
			...
			n === 1 && !hd(l, e.getBoundingClientRect()) && o(), y = !1;
		}
		try {
...
function _d(e, t, n, r) {
	r === void 0 && (r = {});
	let { ancestorScroll: i = !0, ancestorResize: a = !0, elementResize: o = typeof ResizeObserver == "function", layoutShift: s = typeof IntersectionObserver == "function", animationFrame: c = !1 } = r, l = Uu(e), u = i || a ? [...l ? Bu(l) : [], ...t ? Bu(t) : []] : [];
	u.forEach((e) => {
	...
	function g() {
		let t = Ju(e);
		h && !hd(h, t) && n(), h = t, m = requestAnimationFrame(g);
	}
	return n(), () => {
		var e;
		u.forEach((e) => {
...
}, xd, Sd = [], Cd = re((e) => e(), 150, !1), wd = { type: "divider" };
function Td(e) {
	if (e?.type == "contextmenu") {
		e.preventDefault();
		return;
	}
	xd && (xd.remove(), xd = void 0, document.body.classList.remove(n), document.body.classList.remove(h));
}
function Ed(e) {
	if (!(e < 1)) {
		for (let t = e; t < Sd.length; t++) Sd[t]?.remove(), Sd[t] = void 0;
		for (let t of Sd[e - 1].querySelectorAll("li.active")) t.classList.remove("active");
	}
}
var Dd = () => I`<li class="menu-divider"></li>`, Od = (e) => I`
...
`, kd = (e, t) => I`
    <li>
        <div
            class="submenu-item"
            @mouseenter=${(n) => Cd(() => {
	Ad(e, n.target.closest("li"), t + 1), n.stopPropagation();
})}
            @mouseleave=${() => Cd(() => Ed(t + 1))}
        >
            ${e.customContent ? e.customContent : I`<span
                      >${e.icon ? W(e.icon).node[0] : j}
                      ${e.label}</span
                  >`}
        </div>
    </li>
...
async function Ad(e, t, n) {
	try {
		...
		Pd([{ label: "Could not open submenu." }], t, n);
	}
}
var jd = (e) => I`
    <li>
	...
	Td(), e.callback();
        ...
        >
            ...
            >
            ${e.shortcut ? I`<span class="kbd-shortcut">${e.shortcut}</span>` : j}
        </a>
...
function Nd(e, t = 1) {
	switch (e.type) {
		case "divider": return Dd();
		case "header": return Od(e);
		default: return e.submenu ? kd(e, t) : e.customContent ? e.customContent : e.callback ? jd(e) : Md(e);
	}
}
function Pd(e, t, n) {
	Fd(e, t, n, "right-start"), t.classList.add("active");
}
function Fd(e, t, n, r) {
	let i = document.createElement("ul");
	i.classList.add("gs-context-menu"), i.style.top = "0", i.addEventListener("mouseenter", () => {
		Cd(() => {});
	}), i.addEventListener("mouseup", (e) => e.stopPropagation()), i.addEventListener("click", (e) => e.stopPropagation()), N(e.map((e) => Nd(e, n)), i), xd.appendChild(i), Ed(n), Sd[n] = i, r ??= "right-start";
	let a = !/^(top|bottom)/.test(r);
	bd(t, i, {
		strategy: "fixed",
		placement: r,
		middleware: n < 1 && a ? [vd(2), yd()] : [yd()]
	}).then(({ x: e, y: t }) => {
...
function Ld() {
	...
	xd = document.createElement("div"), xd.classList.add("gs-context-menu-backdrop"), xd.addEventListener("click", Td), xd.addEventListener("contextmenu", Td), xd.addEventListener("mouseup", () => {
		performance.now() - t > 500 && Td();
	}, { once: !0 }), e.appendChild(xd), document.body.classList.add(n), document.body.classList.add(h);
}
function Rd(e, t, n) {
	n ??= "bottom-start", xd && Id !== t && Td(), Id = t, xd ? N(e.items.map((e) => Nd(e, 0)), Sd[0]) : (Ld(), Fd(e.items, t, 0, n));
}
function zd(e, t) {
	Rd(e, Bd(t), "right-start"), t.preventDefault();
}
function Bd(e) {
...
function Ud(e, t, n, r) {
	...
	return c.push({
		...
		submenu: (() => {
			...
			if (s === "quantitative") {
				let r = Number(n);
				if (tf(n) && Number.isFinite(r)) {
					for (let { operator: o, label: s } of Wd) e.push(l(i.filterByQuantitative({
						attribute: a,
						operator: o,
						operand: r
					}), !1, void 0, I`${wl(t)}
			...
			} else tf(n) && e.push(l(i.filterByNominal({
				attribute: a,
				values: [n]
				...
				remove: !0,
				values: [n]
			}), !1, void 0, I`Remove <strong>${n}</strong>`), wd);
		...
		submenu: (() => {
			...
			return s == "quantitative" ? e.push(l(i.groupToQuartiles({ attribute: a }), !1, void 0, "By quartiles"), {
				...
				label: "By thresholds...",
				callback: () => hl(t, r)
			}) : (s != "identifier" && e.push(l(i.groupByNominal({ attribute: a }), !1, void 0, I`By ${wl(t)}`)), e.push({
				icon: Fr,
...
function Gd(e, t) {
	let n = e.attribute;
	if (n.type !== Vd || typeof n.specifier != "string") return [];
...
function Kd(e, t, n) {
	...
	return Array.from(i.children.values()).map((t) => qd(e, r, t, n));
}
function qd(e, t, n, r) {
	if (n.children.size > 0) return {
		label: n.part,
		submenu: () => Array.from(n.children.values()).map((n) => qd(e, t, n, r))
	};
	let i = t.get(n.path);
...
function Yd(e, t, n) {
	if (t.type === "quantitative") {
		let r = Xd(t).map(({ label: t, condition: r }) => Zd(e, n, t, r));
		return r.push({
			label: "Choose custom threshold...",
			callback: () => yl(e, t, n)
		}), r;
	} else {
		let { values: r, availableCount: i, unavailableCount: a } = ef(t, n), o = r.map((r) => Zd(e, n, "= " + String(r), {
...
var nf = class {
	...
	feedback(e) {
		let t = this.error(e);
		return t ? I`<div class="invalid-feedback">${t}</div>` : j;
	}
	#e(e) {
...
}, rf = C(class extends S {
	constructor(e) {
		if (super(e), e.type !== w.ELEMENT) throw Error("formField must be used on an element part.");
	...
	update(e, t) {
		...
		return this._abortController && this._abortController.abort(), this._abortController = new AbortController(), o.addEventListener("input", (e) => {
			...
			c();
		}, { signal: this._abortController.signal }), c(), j;
	}
});
//#endregion
...
var of = class extends G {
	...
	static styles = [...super.styles, F`
        ...
        `];
	constructor() {
		super(), this.bookmarkDatabase = null, this.bookmark = null, this.mode = "add", this.originalName = void 0, this.bookmarkName = "", this.bookmarkNotes = "", this.dialogTitle = "", this._form = new nf(this), this._form.defineField("name", {
	...
	async #e() {
		...
		e.name = af(this.bookmarkName), e.notes = af(this.bookmarkNotes);
		let n = !0;
		try {
...
customElements.define("gs-enter-bookmark-dialog", of);
function sf(e, t, n) {
	return Ac("gs-enter-bookmark-dialog", (r) => {
...
var cf = /* @__PURE__ */ t(((e, t) => {
	...
	var n = typeof Symbol < "u" && Symbol, r = lf();
	t.exports = function() {
	...
	t.exports = df().getPrototypeOf || null;
})), Nf = /* @__PURE__ */ t(((e, t) => {
	...
	var n = Pf(), r = If(), i = Ff();
	t.exports = Lf() || n.call(i, r);
})), zf = /* @__PURE__ */ t(((e, t) => {
	var n = Pf(), r = _f(), i = Ff(), a = Rf();
	t.exports = function(e) {
	...
	t.exports = Pf().call(n, r);
})), Uf = /* @__PURE__ */ t(((e, t) => {
	var n, r = df(), i = ff(), a = pf(), o = mf(), s = hf(), c = gf(), l = _f(), u = vf(), d = yf(), f = bf(), p = xf(), m = Sf(), h = Cf(), g = wf(), _ = Ef(), v = Function, y = function(e) {
		try {
			return v("\"use strict\"; return (" + e + ").constructor;")();
		} catch {}
	}, b = Of(), x = kf(), S = function() {
		throw new l();
	}, C = b ? function() {
		try {
	...
	}() : S, w = Af()(), T = Vf(), E = Mf(), D = jf(), O = If(), k = Ff(), A = {}, ee = typeof Uint8Array > "u" || !T ? n : T(Uint8Array), j = {
		__proto__: null,
	...
	}, P = Pf(), F = Hf(), te = P.call(k, Array.prototype.concat), ne = P.call(O, Array.prototype.splice), re = P.call(k, String.prototype.replace), ie = P.call(k, String.prototype.slice), ae = P.call(k, RegExp.prototype.exec), oe = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, se = /\\(\\)?/g, ce = function(e) {
	...
	t.exports = function(e, t) {
		...
		var n = ce(e), r = n.length > 0 ? n[0] : "", i = I("%" + r + "%", t), a = i.name, o = i.value, s = !1, u = i.alias;
	...
	var n = Uf(), r = zf(), i = r([n("%String.prototype.indexOf%")]);
	t.exports = function(e, t) {
		var a = n(e, !!t);
		return typeof a == "function" && i(e, ".prototype.") > -1 ? r([a]) : a;
	};
})), Gf = /* @__PURE__ */ t(((e, t) => {
	var n = uf()(), r = Wf()("Object.prototype.toString"), i = function(e) {
	...
	var n = Wf(), r = Kf(), i = n("RegExp.prototype.exec"), a = _f();
	t.exports = function(e) {
	...
	var n = Wf(), r = qf()(/^\s*(?:function)?\*/), i = uf()(), a = Vf(), o = n("Object.prototype.toString"), s = n("Function.prototype.toString"), c = Jf();
	t.exports = function(e) {
	...
	var n = Xf(), r = Object.prototype.toString, i = Object.prototype.hasOwnProperty, a = function(e, t, n) {
	...
	var n = Qf(), r = typeof globalThis > "u" ? global : globalThis;
	t.exports = function() {
		for (var e = [], t = 0; t < n.length; t++) typeof r[n[t]] == "function" && (e[e.length] = n[t]);
		return e;
	};
})), ep = /* @__PURE__ */ t(((e, t) => {
	var n = kf(), r = gf(), i = _f(), a = Of();
	...
	var n = Uf(), r = ep(), i = tp()(), a = Of(), o = _f(), s = n("%Math.floor%");
	t.exports = function(e, t) {
	...
	var n = np(), r = kf(), i = zf(), a = rp();
	t.exports = function(e) {
		var t = i(arguments), r = 1 + e.length - (arguments.length - 1);
		return n(t, r > 0 ? r : 0, !0);
	}, r ? r(t.exports, "apply", { value: a }) : t.exports.apply = a;
})), ap = /* @__PURE__ */ t(((e, t) => {
	var n = Zf(), r = $f(), i = ip(), a = Wf(), o = Of(), s = Vf(), c = a("Object.prototype.toString"), l = uf()(), u = typeof globalThis > "u" ? global : globalThis, d = r(), f = a("String.prototype.slice"), p = a("Array.prototype.indexOf", !0) || function(e, t) {
	...
	}, e.inherits = lp(), e._extend = function(e, t) {
		if (!t || !T(t)) return e;
...
function fp() {
	return typeof process < "u" ? new (up()).TextEncoder() : new TextEncoder();
}
var pp;
function mp() {
	let e, t = [];
...
function hp(e) {
	pp ??= mp();
	let t = -1, n = fp().encode(e);
	for (let e = 0; e < n.length; e++) t = t >>> 8 ^ pp[(t ^ n[e]) & 255];
	return (t ^ -1) >>> 0;
}
function gp(e) {
	return ("00000000" + hp(e).toString(16)).slice(-8);
}
//#endregion
//#region ../app/src/utils/urlHash.js
function _p(e) {
	let t = (0, dp.compressToEncodedURIComponent)(JSON.stringify(e));
	return "#" + t + gp(t);
}
function vp(e) {
	if (!e || e.length < 10) throw Error("The state string in the URL is too short.");
	let t = e.slice(1, -8), n = e.slice(-8);
	if (gp(t) !== n) throw Error("The state string in the URL is corrupted.");
	return JSON.parse((0, dp.decompressFromEncodedURIComponent)(t));
}
//#endregion
...
var bp = class extends G {
	...
	renderBody() {
		let e = this.bookmark ?? { name: "" }, t = JSON.stringify(e, void 0, 2), n = window.location, r = n.origin + n.pathname + n.search + (this.global ? "#bookmark:" + e.name.replaceAll(" ", "-") : _p(e));
		return I`
            <div class="gs-tabs" style="width: 600px">
                <ul class="tabs" @click=${yp}>
...
customElements.define("gs-share-bookmark-dialog", bp);
function xp(e, t) {
...
async function Cp(e, t) {
	...
	if (!n) return;
	let r = e.createBookmark([Sp(t)]);
	if (await sf(n, r, "add")) try {
...
async function wp(e, t) {
	let n = e.createBookmark([Sp(t)]);
	await sf(void 0, n, "share") && xp(n, !1);
}
//#endregion
...
var Tp = class extends G {
	...
	async #t() {
		!this.bookmarkContext || !this.plot || await Cp(this.bookmarkContext, this.plot);
	}
	async #n() {
		!this.bookmarkContext || !this.plot || await wp(this.bookmarkContext, this.plot);
	}
};
customElements.define("gs-sample-attribute-plot-dialog", Tp);
function Ep(e, t = {}) {
...
var Pp = class {
	...
	wait(e) {
		return Np(this.#t.promise, this.#e, e);
	}
};
function Fp(e) {
	let t = !1;
...
var Ip = class {
	...
	wait(e, t) {
		...
		return this.#e.add(i), Np(r, this.#t, t, () => {
			this.#e.delete(i);
		});
	}
	resolveMatching(e) {
...
}, Lp = "SAMPLE_ATTRIBUTE", Rp = class extends D {
	#e;
	#t;
	#n = /* @__PURE__ */ new Map();
	#r = 0;
	#i = Promise.resolve();
	#a = new Pp("Metadata readiness was aborted.");
	...
	constructor(e, t) {
		...
		}, this.#s = (e) => this.getAttributeInfo(e.specifier), this.#e.compositeAttributeInfoSource.addAttributeInfoSource(Lp, this.#s), this.registerDisposer(kp(this.#e.provenance.store, (e) => e.provenance.present.sampleView.sampleMetadata, (e) => {
			this.#d(e);
	...
	handleContextMenu(e) {
		...
		let n = this.#e.sampleHierarchy.sampleMetadata.entities[t.id], r = [this.#e.makePeekMenuItem(e.point.y - this.#e.childCoords.y, t.id), wd], i = this.#_(e.target);
		if (i) {
			let e = i.attribute.specifier, t = n?.[e];
			r.push(...Ud(I`Attribute: <strong>${e}</strong>`, i, t, this.#e)), Op(r, i, this.#e);
		}
		zd({ items: r }, e.mouseEvent);
	}
	async #d(e) {
		this.#t = e.entities;
		let t = this.context.dataFlow, n = ++this.#r, r = Fp(this.#a.reset()), i = this.#i, a = () => void 0;
	...
	async #g() {
		...
		await n(e, this, {});
		for (let e of this.getDescendants()) e instanceof d && e.name.startsWith("title") && (e.mark.properties.clip = "never");
		f(this);
	}
	getAttributeNames() {
	...
	#v(e, t) {
		let n = this.#n, r = (e, t) => Gp(t) ? this.getAttributeInfo(e).scale(t) : "transparent", i = this.#t[e];
		return I`
            <div class="title">
                <strong>${e}</strong>
            </div>
		...
		for (let e of this.getAttributeNames()) {
			...
			if ((r.type == "ordinal" || r.type == "nominal") && n.find((e) => e[r.attribute.specifier] == t)) {
				let n = this.#e.actions.filterByNominal({
					...
					values: [t]
				}), r = this.#e.provenance.getPresentState().lastAction, i = this.#e.actions.filterByNominal.match(r) && !r.payload.remove && r.payload.attribute.type == Lp && r.payload.attribute.specifier == e && r.payload.values.length == 1, a = this.#e.provenance.store;
	...
	dispose() {
		super.dispose(), this.#e.compositeAttributeInfoSource.removeAttributeInfoSource(Lp, this.#s), this._attributeHighlighState.abortController.abort();
	}
};
function zp(e, t, n) {
	if (!t) throw Error("No attribute definition for " + e);
	let r = n?.titleReserve ?? !1, i = Up(e), a = `datum[${JSON.stringify(e)}]`, o = {
		name: Hp(e),
		transform: [{
			type: "filter",
			expr: `${a} != null`
...
customElements.define("gs-retain-groups-by-rank-dialog", Kp);
function qp(e, t) {
...
var Jp = class extends G {
	...
	renderButtons() {
		return [this.makeButton("Cancel", () => this.finish({ ok: !1 })), this.makeButton("Retain", () => this.#t(), {
			iconDef: R,
			isPrimary: !0,
			disabled: !ol(this.operand)
		})];
	}
	#t() {
		if (!ol(this.operand)) throw Error("Group size threshold is missing.");
...
customElements.define("gs-retain-groups-by-size-dialog", Jp);
function Yp(e, t) {
...
var Xp = { step: 24 }, Zp = class extends ye {
	#e = !0;
	constructor(e, t) {
		let n = {
			name: "sample-groups",
	...
	#t(e) {
		...
		zd({ items: this.#i(n, t) }, e.mouseEvent);
	}
	#n() {
	...
	#r(e) {
		...
		return Qp(e.x - this.coords.x, this.coords.width, t);
	}
	#i(e, t) {
		...
		return s.push({
			...
			...o(n.actions.ungroup({ level: e }), tm(i)),
			icon: Fr
		}), s;
	}
...
function im(e, t) {
	e.dispatch(Wn.clearHistory()), e.dispatch({ type: t + nm });
}
//#endregion
...
var am = class {
	...
	replaceGeometry(e, t = this.#t.overlap) {
		this.#i(), sm(e, this.#e.facetIds.length), this.#t = Object.freeze({
			topology: this.#e,
			geometryRevision: this.#t.geometryRevision + 1,
...
var cm = 35, lm = 5, um = 15, dm = .2, fm = [], pm = class {
	#e = 0;
	#t = 0;
	#n = 0;
	#r = new om();
	...
	togglePeek(e, t, n) {
		...
		if (this.#e == 0) {
			...
			if (e ? this.#t = e - t : this.#t = (this.#n - i) / 2, this.#n > i) return ft({
				...a,
				to: 1,
				duration: 500,
				easingFunction: gr
	...
	#b() {
		let e = this.#p.getSampleHierarchy().sampleData?.ids ?? fm, t = e.length;
		this.#l = t;
	...
	getSummaryAt(e) {
		let t = this.getLocations().summaries, n = t.findIndex((t) => xm(t.locSize, e));
		return n >= 0 ? {
			index: n,
			location: t[n]
		} : void 0;
	...
	#x() {
		...
		let r = rr(t), i = this.#p.sampleLayout ?? {}, a = _m(r, {
			viewHeight: e,
			groupSpacing: i.groupSpacing ?? lm,
			sampleSpacingFactor: i.sampleSpacingFactor ?? dm,
			summaryHeight: n
		}), o = _m(r, {
			sampleHeight: i.sampleHeight ?? cm,
			groupSpacing: i.peekGroupSpacing ?? um,
			sampleSpacingFactor: i.sampleSpacingFactor ?? dm,
			summaryHeight: n
		});
		return this.#d = {
	...
	#S() {
		if (!this.#x()) return !1;
		this.#u || (this.#u = mm(this.#d.fitted), this.#_.baseVersion = -1);
		let e = this.#e, t = this.#t, n = this.#g, r = this.#_.baseVersion !== n, i = this.#_.peekState !== e, a = this.#_.scrollOffset !== t;
		return !r && !i && !a ? !0 : (hm(this.#u, this.#d, e, -t), this.#_.peekState = e, this.#_.scrollOffset = t, this.#_.baseVersion = n, (r || i) && this.#y(), !0);
	}
};
function mm(e) {
	let t = {
...
function hm(e, t, n, r) {
	...
	gm(e.samples, i.samples, a.samples, n, r), gm(e.summaries, i.summaries, a.summaries, n, r), gm(e.groups, i.groups, a.groups, n, r);
}
...
function _m(e, { viewHeight: t = 0, sampleHeight: n = 0, groupSpacing: r = 5, sampleSpacingFactor: i = dm, summaryHeight: a = 0 }) {
	if (!t && !n) throw Error("viewHeight or sampleHeight must be provided!");
	let o = (e) => Be(e), s = e.map((e) => ({
		path: e,
		sampleGroup: o(e),
		samples: o(e).samples
	...
	for (let [e, t] of s.entries()) {
		...
		lt(r.map((e) => n), Math.max(0, l[e].locSize.size - a), { offset: l[e].locSize.location + a }).forEach((e, t) => {
			let { size: n, location: a } = e, o = n * i * .5 * qe(15, 22, n);
...
function vm(e, t) {
	return t.find((t) => xm(t.locSize, e));
}
function ym(e, t) {
	if (!t?.length || !Number.isFinite(e)) return;
	let n = vm(e, t);
	if (n) return n;
	let r = t[0], i = Sm(e, r.locSize);
	for (let n = 1; n < t.length; n++) {
		let a = t[n], o = Sm(e, a.locSize);
		o < i && (r = a, i = o);
	}
	return r;
}
function bm({ viewportHeight: e, scrollableHeight: t, scrollOffset: n, peekState: r, summaryHeight: i = 0 }) {
...
function Sm(e, t) {
	return xm(t, e) ? 0 : e < t.location ? t.location - e : e - (t.location + t.size);
}
//#endregion
...
function wm(e) {
	return e && (O(e) || Se(e)) && "aggregateSamples" in e;
}
//#endregion
//#region ../app/src/sampleView/datumLookup.js
function Tm(e, t = e.getCollector()) {
	let n = e.getDataAccessor("x"), r = e.getDataAccessor("x2"), i = e.getScaleResolution("x")?.getScale()?.type, a = i ? it(i) : !1;
	return !t || !n ? () => void 0 : a ? (e, r) => t.facetBatches.get(Ge(e))?.find((e) => r == n(e)) : !a && r ? (e, i) => t.facetBatches.get(Ge(e))?.find((e) => i >= n(e) && i < r(e)) : (e, r) => t.facetBatches.get(Ge(e))?.find((e) => r == n(e));
}
//#endregion
...
function Nm(e, t) {
	...
	let d = (e) => e[t.field], f = t.featureFilter ? Em(t.featureFilter) : () => !0, p, m = () => {
		if (!p) {
			let e = u();
	...
	return (e) => {
		let [t, n] = m(), r = a.facetBatches.get(Ge(e));
		...
		switch (Kn(r, o, c, s, t, n, (e, t) => {
			...
			case "count": return jm(i);
			case "min": return Dm(i);
			case "max": return Om(i);
			case "weightedMean": return km(i, l);
			case "variance": return Am(i, l);
...
function Pm(e, t) {
	...
	if (r) {
		let e = t.every(g) ? r.toContinuousInterval(t) : t;
...
function Im(e, t) {
	return typeof t == "string" ? Vm(e, t) : Bm(e, t);
}
function Lm(e) {
...
function Bm(e, t) {
	let n = bt(e, t);
	if (!n) throw Error("Cannot resolve view selector: " + zm(t));
	return n;
}
function Vm(e, t) {
	let n = [];
...
function Um(e, t) {
	return !Gm(e, t.param) || !Array.isArray(t.scope) || t.scope.length === 0 ? t.param : t.scope.join("/") + "/" + t.param;
}
function Wm(e, t) {
...
function qm(e, t) {
	let n = t.specifier, r = Im(e, n.view), i = Hm(e, r, String(r.getTitleText() ?? r.name)), a = "aggregation" in n ? Bt(n.aggregation.op, n.field, n.featureFilter) : n.field, o = "aggregation" in n ? Jm(n.aggregation.op, n.field, n.featureFilter) : I`<em class="attribute">${n.field}</em>`, s = "aggregation" in n ? Jm(n.aggregation.op, n.field, n.featureFilter) : I`<em class="attribute">${n.field}</em>`, c = Nm(r, n), l = On(c), u = (e) => {
	...
	let m = f && Ke(f) ? r.getScaleResolution(f).getScale() : void 0, h = p && "scale" in p && p.scale && typeof p.scale == "object" ? p.scale : void 0, g = p && "type" in p ? p.type : void 0, _ = "aggregation" in n ? "quantitative" : g, v, y;
		...
		title: I`${s}
			...
			if (Vn(n)) {
				if (Jn(n.interval)) return I`in
                    <span class="interval"
                        >${Pm(r, n.interval)}</span
                    >`;
				if (gn(n.interval)) return I`in
                    <span class="interval"
                        >selection <strong>${Um(e, n.interval.selector)}</strong></span
                    >`;
...
function Jm(e, t, n) {
	if (e === "itemCount") {
		let t = n ? I`(where ${Ym(n)})` : "";
		return I`${Mn(e)}${t}`;
	}
	if (e === "count") {
		let r = n ? I` where ${Ym(n)}` : "";
...
function Xm(e) {
	return g(e) || typeof e == "number" ? Ce(e) : String(e);
}
//#endregion
//#region ../app/src/sampleView/sampleLabelView.js
var Zm = "SAMPLE_NAME", Qm = "_indexNumber", $m = "_labelWidth", eh = "_labelTitle", th = "_labelTitleWidth", nh = Object.freeze({
	name: "sample",
	...
	#r = [];
	constructor(e, t) {
		super(ih(e.spec.samples, e.spec.metadata), e.context, t, t, "metadata-sample-label"), this.#e = e, this.#t = e.spec.samples.labelLength == null, this.#n = () => nh, e.compositeAttributeInfoSource.addAttributeInfoSource(Zm, this.#n), this.addInteractionListener("contextmenu", this.handleContextMenu.bind(this)), this.registerDisposer(kp(e.provenance.store, (e) => e.provenance.present.sampleView.sampleData, (e) => {
	...
	handleContextMenu(e) {
		...
		let n = [this.#e.makePeekMenuItem(e.point.y - this.#e.childCoords.y, t.id), wd];
		n.push(...Ud(I`Sample: <strong>${t.displayName}</strong>`, nh, t.id, this.#e)), zd({ items: n }, e.mouseEvent);
	}
	dispose() {
		super.dispose(), this.#e.compositeAttributeInfoSource.removeAttributeInfoSource(Zm, this.#n);
	}
};
function ih(e, t) {
	let n = oh(e), r = {
...
function ah(e) {
	...
	return e.visitData((e) => {
		t = Math.max(t, Number(e[$m]) || 0, Number(e[th]) || 0);
	}), Math.ceil(t);
}
function oh(e) {
...
var sh = "The samples.data, samples.attributeGroupSeparator, and samples.attributes properties are deprecated. Use metadata.sources instead.", ch = "samples.metadataSources is deprecated. Use metadata.sources instead.", lh = "Metadata layout properties under samples are deprecated. Use metadata layout properties instead.", uh = "samples.labelTitleText is deprecated. Use samples.labelTitle instead.";
function dh(e) {
...
function mh(e) {
	let t = e.data;
	if (!dh(t)) throw Error("Legacy samples.data must be UrlData or InlineData when mapping to metadata.sources.");
	let n = {
		initialLoad: "*",
...
function hh(e) {
	let t = e.samples ?? {}, n = e.metadata ?? {}, r = [], i = n.sources !== void 0, a = t.metadataSources !== void 0, o = fh(t);
	...
	let s = ph(t), c = Object.keys(s).length > 0, l = { ...t }, u = { ...n }, d = !1;
	return t.labelTitleText !== void 0 && t.labelTitle === void 0 && (l.labelTitle = t.labelTitleText, d = !0, r.push(uh)), o ? (l.identity = t.identity ?? {
		data: t.data,
		idField: "sample",
		displayNameField: "displayName"
	}, u.sources = [mh(t)], d = !0, r.push(sh)) : a && (u.sources = t.metadataSources, d = !0, r.push(ch)), c && (Object.assign(u, s, n), d = !0, r.push(lh)), d ? {
		spec: {
			...e,
			samples: l,
			metadata: u
...
var yh = class extends L {
	...
	#c() {
		...
		if (!e || !t) return;
		let n = e.getBoundingClientRect();
		t.style.minWidth = `${n.width}px`, bd(e, t, {
	...
	#l() {
		let e = this.#t(), t = this.#e();
		!e || !t || (this.#u(), this.#c(), this._cleanupAutoUpdate = _d(e, t, () => this.#c()));
	}
	#u() {
...
customElements.define("gs-custom-select", yh);
var bh = class extends Event {
	value;
	option;
	constructor(e, t) {
		super("change", {
...
function Th(e, t, n, r) {
	...
	let c = [s[0] ?? a, s[s.length - 1] ?? o], l = Sh(r), u = Array.isArray(t) ? [...t] : [];
	if (u.length < l) {
...
function Oh(e) {
	...
	if (e.scaleType && (t.type = e.scaleType), e.domainMid != null && (t.domainMid = e.domainMid), e.colorMode === "scheme") return e.scheme && (t.scheme = e.scheme), e.domainMode === "explicit" && (t.domain = e.quantDomain), Ah(t);
	let n = Sh(e.domainMid);
	if (e.quantRange.length !== n) return null;
	if (e.domainMode === "explicit") {
		if (e.quantDomain.length !== 2) return null;
		t.domain = e.quantDomain;
	}
	return t.range = e.quantRange, Ah(t);
}
function kh(e) {
	let t = {};
	return e.colorMode === "scheme" ? (e.scheme && (t.scheme = e.scheme), e.domainMode === "explicit" && (t.domain = e.domainPairs.map((e) => e.domain)), Ah(t)) : e.domainMode === "explicit" ? (t.domain = e.domainPairs.map((e) => e.domain), t.range = e.domainPairs.map((e) => e.range), Ah(t)) : null;
}
function Ah(e) {
...
var jh = class extends G {
	...
	#e() {
		let e = wh(this.scale, this.dataType, this.observedDomain, {
			scheme: this.scheme,
	...
	#l() {
		...
		let e = Th(this.quantDomain, this.quantRange, this.observedDomain, this.domainMid);
	...
	#u() {
		let e = Eh(this.thresholds, this.thresholdRange);
		...
		return I`
            <div class="gs-form-group">
                ...
                <gs-custom-select
                    ...
                    .value=${this.scheme}
                    .getLabel=${(e) => e || "Auto"}
                    .renderOption=${(e) => e ? I`<img src=${_h(e)} />
...
customElements.define("gs-configure-scale-dialog", jh);
//#endregion
...
var Mh = class extends L {
	...
	constructor() {
		super(), this.attributeInfo = null, this.values = null, this.existingAttributeNames = [], this.attributeName = "", this.groupPath = "", this._scale = null, this._scaleConfigured = !1, this._form = new nf(this), this._form.defineField("name", {
	...
	render() {
		...
		let e = Ut(this.attributeInfo), t = this._scaleConfigured && this._scale ? Nh(this._scale) : "Auto";
		return I`
            <div class="gs-alert info">
                ${W(Er).node[0]}
                <div>
	...
	getConfig() {
		return this._form.validateAll() ? null : {
			...
			...this._scaleConfigured ? this._scale && Ph(this._scale) ? { scale: this._scale } : { scale: null } : {}
		};
	}
	async #e() {
	...
	#t() {
		...
		return this._observedDomain ||= vh(Ut(this.attributeInfo), this.values), this._observedDomain;
	}
	#n() {
		return Nn(this.attributeName, this.groupPath, this.existingAttributeNames, this.attributeInfo);
	}
};
customElements.define("gs-derived-metadata-configurator", Mh);
function Nh(e) {
	if (!e) return I`Auto`;
	let t = [];
	if (e.scheme) {
...
customElements.define("gs-derived-metadata-dialog", Fh);
function Ih({ attributeInfo: e, values: t, existingAttributeNames: n, defaultName: r }) {
...
var Rh = class {
	...
	#e;
	constructor() {
		super(), this.fieldInfo = null, this.aggregationFieldInfos = [], this.selectionIntervalComplex = null, this.selectionIntervalSource = null, this.aggregation = "count", this.aggregationField = "", this.filterField = "", this.operator = "in", this.operand = void 0, this.selectedValues = [], this._filterFieldValues = [], this.sampleHierarchy = null, this.attributeInfoSource = null, this.attributeType = null, this.sampleView = null, this._page = 0, this._attributeInfo = null, this._values = null, this._attributeName = "", this._metadataConfigHasErrors = !1, this.dialogTitle = "Create sample metadata from features", this.#e = new Rh(this, [{
			render: () => this.#t(),
			canAdvance: () => this.#v(),
			onAdvance: () => this.#b()
		}, {
	...
	#d() {
		return this.#f() ? this.filterField + " " + $t(this.operator) + " " + (ol(this.operand) ? String(this.operand) : "...") : this.selectedValues.length === 0 ? this.filterField + " in {...}" : this.filterField + " in {" + this.selectedValues.map(String).join(", ") + "}";
	}
	#f() {
	...
	#v() {
		return !this.filterField || !this.aggregationField ? !1 : this.#f() ? ol(this.operand) : this.selectedValues.length > 0;
	}
	#y() {
		if (!this.#f()) return {
		...
		if (!ol(this.operand)) throw Error("Quantitative feature filter is missing a value.");
		return {
			field: this.filterField,
			operator: this.operator,
			value: this.operand
	...
	#C() {
		...
		return Array.from(new Set(e.filter(Vh))).map((e) => ({
			value: e,
			label: `${e}`,
			searchText: `${e}`.toLowerCase()
		}));
...
customElements.define("gs-feature-filtered-aggregation-dialog", zh);
async function Bh({ fieldInfo: e, aggregationFieldInfos: t, selectionIntervalComplex: n, selectionIntervalSource: r, sampleHierarchy: i, attributeInfoSource: a, attributeType: o, sampleView: s }) {
...
function Gh(e, t, n) {
	let r = Rm(t), i = Yh(e).filter((e) => Qh(e.view, r));
	if (n) try {
		let t = [];
		e.visit((e) => {
			e instanceof d && e.isVisible() && Qh(e, r) && t.push(e);
		});
		for (let e of t) {
			...
			n && !r && i.push({
				...
				type: "nominal",
				description: void 0,
				supportedAggregations: Uh,
				candidateId: rg(Fm(e), "Items")
			});
		}
	} catch {}
	return n || (i = i.filter($h)), tg(i.map((e) => {
		let t = e.viewSelector ?? Fm(e.view);
		return {
			view: e.view,
			viewSelector: t,
			...
			supportedAggregations: e.supportedAggregations ?? eg(e.type),
			candidateId: e.candidateId ?? rg(t, e.field),
			filterableFields: e.filterableFields ?? qh(e.view)
		};
	}));
}
var Kh = Gh;
function qh(e) {
	return ng(Yh(e).map((e) => ({
		channel: e.channel,
		field: e.field,
		type: e.type,
		description: e.description
...
function Jh(e, t) {
	let n = Rm(t);
	return Array.from(new Set(Yh(e).filter((e) => !Qh(e.view, n)).filter($h).map((e) => e.view)));
}
function Yh(e) {
	try {
		return m(e).filter((e) => ![
			...
			...e,
			description: Zh(e.view, e.channel, e.field)
		}));
	} catch {
		return Xh(e);
	}
...
var ig = "SAMPLE_ATTRIBUTE";
function ag(e, t, n) {
	let r = e.getAxisResolution("x")?.getTitle();
	return t.type === "locus" ? "Locus: " + (g(n) || typeof n == "number" ? Ce(n) : String(n)) : (r ? r + ": " : "") + n;
}
function og(e, t) {
	...
	return {
		...
		selectionIntervalLabel: Pm(e.view, r)
	};
}
function sg({ fieldInfo: e, aggregationFieldInfos: t, selectionIntervalComplex: n, selectionIntervalSource: r, sample: i, sampleHierarchy: a, attributeInfoSource: o, attributeType: s, sampleView: c }) {
	...
	return [
		...
		...e.supportedAggregations.map((t) => {
			let l = Gt(t), u = t === "itemCount" ? I`Using ${l.label.toLowerCase()} over interval...` : I`Using ${l.label.toLowerCase()}(<em
				...
				type: s,
				specifier: d
			}), p = Ud(u, f, i ? f.accessor(i.id, a) : void 0, c);
			return ug(p, f, a, c), {
				label: l.label,
				submenu: p
			};
...
function cg({ fieldInfo: e, complexX: t, sample: n, sampleHierarchy: r, attributeInfoSource: i, attributeType: a, sampleView: o }) {
	let s = {
		view: e.viewSelector,
		field: e.field,
		locus: t
		...
		type: a,
		specifier: s
	}), l = Ud(null, c, n ? c.accessor(n.id, r) : void 0, o);
	return ug(l, c, r, o), l;
}
function lg(e, t, n, r) {
	if (!n.sampleData) throw Error("Sample data has not been initialized.");
	t.attribute.type !== ig && e.push({
...
function ug(e, t, n, r) {
	let i = t.attribute.type !== ig, a = t.type === "quantitative" || t.type === "nominal" || t.type === "ordinal";
	!i && !a || (e.push(wd), lg(e, t, n, r), Op(e, t, r, { includeDivider: !1 }));
}
//#endregion
//#region ../app/src/state/selectionExpansionContext.js
var dg = "multiplePointSelectionParams";
function fg(e, t) {
...
function pg(e) {
	let { hoveredView: t, hoveredDatum: n, selector: r, originViewSelector: i, originKeyFields: a, originKeyTuple: o, defaultPartitionBy: s, defaultScopeLabel: c } = e, l = /* @__PURE__ */ new Set([...a, ...s ?? []]), u = mg(t), d = hg(t, n, l), f = gg(n, l).filter((e) => !u.has(e)), p = [...d];
	for (let e of f) p.includes(e) || p.push(e);
	let m = [];
	for (let e of p) {
		let t = n[e], a = vg(t), l = yg(c), u = bg(c), d = [];
		d.push({
			label: "In " + l,
			payload: {
				selector: r,
...
function hg(e, t, n) {
	let r = e.getEncoding(), i = [], a = /* @__PURE__ */ new Set(), o = (e) => {
		if (!e || typeof e != "object" || Array.isArray(e)) return;
		let r = e;
		if (typeof r.field == "string" && (r.type === "nominal" || r.type === "ordinal") && !a.has(r.field) && _g(r.field, t, n) && (a.add(r.field), i.push(r.field)), "condition" in r) {
			let { condition: e } = r;
...
function gg(e, t) {
	return Object.keys(e).filter((n) => _g(n, e, t));
}
function _g(e, t, n) {
...
function Sg(e) {
	if (xg.actions.expandPointSelection.match(e) || !xg.actions.paramChange.match(e)) return null;
...
function wg(e, t) {
	...
	for (let e of n) {
		let n = Tg(e.fieldName, e.valueLabel);
		if (e.operations.length === 1) {
			let i = e.operations[0];
			r.push({
				label: n,
				callback: () => t(xg.actions.expandPointSelection(i.payload))
			});
			continue;
		}
		r.push({
			...
			submenu: () => {
				...
				for (let n of e.operations) r.push({
					label: n.label,
					callback: () => t(xg.actions.expandPointSelection(n.payload))
				});
				return r;
			}
		});
...
var Eg = 60, Dg = "all", Og = 1e-6, kg = class {
	#e;
	#t;
	#n;
	constructor(e = {}) {
	...
	#a(e) {
		...
		let t = this.#e?.minSampleHeight ?? Eg;
		return e?.samples.some((e) => e.locSize.size >= t) ?? !1;
	}
	#o(e) {
		let t = this.#e?.minSampleHeight ?? Eg, n = e.samples.filter((e) => e.locSize.size >= t);
		switch (this.#e?.mode ?? Dg) {
			case "all": return n;
...
}, Ag = "VALUE_AT_LOCUS", jg = class extends Et {
	childCoords;
	sidebarCoords;
	locationManager;
	#e = 0;
	...
	#r = -1;
	#i = !1;
	#a = new Ip("Subtree data readiness was aborted.");
	#o;
	#s;
	#c = [];
	#l;
	...
	constructor(e, t, n, r, i, a, o, s = void 0) {
		...
		this.spec = c.spec, this.#i = e.stickySummaries ?? !0, this.#w(), this.#g(), this.#C(), this.#h(), this.#T(o), this.#E(), this.#s = this.paramRuntime.allocateSetter("visibleSamples", []), this.#l = this.paramRuntime.allocateSetter("visibleSampleMetadata", Fg(this.sampleHierarchy, [])), this.getSamples = () => an(this.sampleHierarchy), this.spec.samples.identity?.data && this.#A();
	}
	#h() {
		let e = Ht;
		this.compositeAttributeInfoSource.addAttributeInfoSource(Ag, (e) => qm(this, e));
		let t = (e) => this.compositeAttributeInfoSource.getAttributeInfo(e);
		this.provenance.addActionInfoSource((e) => jl(e, t)), this.actions = e.actions;
	}
	#g() {
	...
	#v(e, t, n) {
		if (n && c(e, n)) return Promise.resolve();
		if (n) return i(this.context, e, n, t);
		let r = e.getDataAncestors();
		return this.#a.wait((t) => t === e || r.includes(t), t);
	}
	#y(e) {
		return Im(this, e.view);
	}
	#b(e) {
	...
	#w() {
		this.compositeAttributeInfoSource = new am(), this.childCoords = Ot.ZERO, this.sidebarCoords = Ot.ZERO, this.locationManager = new pm({
	...
	#E() {
		this.registerDisposer(kp(this.provenance.store, () => this.sampleHierarchy.rootGroup, Ap(() => {
		...
		}))), this.registerDisposer(kp(this.provenance.store, () => this.sampleHierarchy.sampleMetadata, Ap(() => this.#M())));
	}
	async initializeChildren() {
		...
		this.#t = new Ng(n, this, 0, t, this.spec.view), this.#o = (e) => {
			...
			spacing: 8,
			padding: { right: 8 }
		}, this, this, "sample-sidebar"), mt(this.#n, { skipSubtree: !0 }), this.sampleGroupView = new Zp(this, this.#n), this.sampleLabelView = new rh(this, this.#n), this.metadataView = new Rp(this, this.#n), this.#n.setChildren([
		...
		this.#n.addInteractionListener("wheel", r, !0), this.#n.addInteractionListener("mousedown", r, !0), this.#n.addInteractionListener("touchgesture", r, !0), this.#t.scrollbars.vertical = new fe(this.#t, "vertical", { onViewportOffsetChange: (e) => {
	...
	*[Symbol.iterator]() {
	...
	#k() {
		...
		if (e) {
			...
			this.provenance.store.dispatch(this.actions.setSamples({ samples: t })), im(this.provenance.store, pn);
	...
	#A() {
		...
		let { dataSource: t, collector: n } = ae(r(e.data, this), new Mg(e.idField ?? "sample", e.displayNameField)), i = n.observe(() => {
			let e = n.getData();
			this.provenance.store.dispatch(this.actions.setSamples({ samples: e })), im(this.provenance.store, pn);
		});
	...
	#j() {
		...
		Pg(e, this.#c) || (this.#c = e, this.#s(e));
	}
	#M() {
		this.#l && this.#l(Fg(this.sampleHierarchy, this.leafSamples));
	}
	getSampleAt(e) {
		let t = vm(e, this.locationManager.getLocations().samples);
	...
	#P(e, t, n = {}) {
		let r = this.#t, i = n, a = () => {
			ge(r.legends, r.axes, t, e, i, (e, t, n) => n(), 0), r.arrangeTitle(e, t, i);
		...
		let s = Ve(this.locationManager.clipBySummary(t), !0, !0), c = this.locationManager.getLocations();
		if (!c) {
			a();
			return;
		}
		...
		for (let [n, i] of Object.entries(r.axes)) n === "left" || n === "right" || i.arrange(e, ue(t, n, i));
	...
	#F(e) {
		...
		let t = this.locationManager.getLocations().samples, n = ym(e, t);
	...
	#z() {
		...
		for (let t of e) for (let [e, n] of t.paramRuntime.paramConfigs) {
			...
			let r = Ue(n.select);
			if (!Fe(r) || !r.encodings?.includes("x")) continue;
	...
	#V(e) {
		let t = e.uiEvent, n = this.getLayoutAncestors().at(-1), r = this.childCoords.normalizePoint(e.point.x, e.point.y).x, i = this.findSampleForMouseEvent(e), a = this.#t.view, o = a.getScaleResolution("x"), s = o.invertToComplex(r), c = this.#z(), { selectionInterval: l, selectionIntervalComplex: u, selectionIntervalLabel: d } = og(c, c ? this.#B(c.view, e) : void 0), f;
		...
		let p = Kh(a, n, !!l), m = l ? [] : Jh(a, n), h = [
			this.makePeekMenuItem(e.point.y - this.childCoords.y, i?.id),
			wd,
			{
				label: d ? `Interval: ${d}` : ag(a, o, s),
				type: "header"
			},
			wd
		], g = fg(this, this.context.getCurrentHover()), _;
		...
		for (let [e, t] of p.entries()) {
			...
			let r = p[e + 1];
			_ && !x && t.view === _.hoveredView && (!r || r.view !== t.view) && (h.push(Cg(_, (e) => this.intentExecutor.dispatch(e))), x = !0);
		}
		_ && !x && (h.at(-1)?.type !== "divider" && h.push(wd), h.push({
			label: S(_.hoveredView),
			type: "header"
		}), h.push(Cg(_, (e) => this.intentExecutor.dispatch(e))));
		for (let e of m) h.at(-1)?.type !== "divider" && h.push(wd), h.push({
			label: S(e),
			type: "header"
	...
	propagateInteraction(e) {
		te(this, e, () => {
			...
			for (let t of Object.values(this.#t.scrollbars)) if (P(e, () => t.coords.containsPoint(e.point.x, e.point.y), () => t.propagateInteraction(e)), e.stopped) return;
			n ? P(e, () => !0, () => this.#t.view.propagateInteraction(e), () => ce(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator)) : r && ce(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator), !e.stopped && P(e, () => this.sidebarCoords.containsPoint(e.point.x, e.point.y), () => this.#n.propagateInteraction(e));
		});
	}
	#U(e, t, n) {
	...
	async #W() {
		...
		for (let t of this.#t.view.getDescendants()) {
			let n = t.spec;
			if (wm(n)) for (let r of n.aggregateSamples) {
	...
	constructor(e, t, n, r, i) {
		super(e, t, n), this.groupBackground = void 0, this.groupBackgroundStroke = void 0, this.sampleChromeLayout = new kg({
		...
		let a = oe(i);
		a && (this.groupBackground = new d(a, t.context, t, e, "sample-group-background-" + n), mt(this.groupBackground, { skipSubtree: !0 }));
		let o = ve(i);
		o && (this.groupBackgroundStroke = new d(o, t.context, t, e, "sample-group-background-stroke-" + n), mt(this.groupBackgroundStroke, { skipSubtree: !0 })), this.summaryViews = r;
	}
	allowDuplicateAxes() {
		return !0;
	}
	async syncGuideViews() {
		let e = ee(this.summaryViews), t = new Set(e);
		if (await super.syncGuideViews({
			legendOwners: [...ee(this.view), ...e],
			legendFilter: (e, n) => !t.has(n) || !M(e)
	...
	getOverhangWithoutYAxes() {
		let e = (e) => T(this.axes[e]), t = new ut(0, e("right"), 0, e("left"));
...
function Fg(e, t, n = "", r = /* @__PURE__ */ new Map()) {
	...
	return new Proxy({}, { get(a, c) {
		...
		let l = n ? n + "/" + c : c;
		return i.includes(l) ? s(l) : o(l) ? Fg(e, t, l, r) : Ig;
	} });
}
var Ig = new Proxy([], { get(e, t, n) {
	return t in e || typeof t != "string" ? Reflect.get(e, t, n) : Ig;
} }), Lg = (e, t) => t.some((t) => e instanceof t), Rg, zg;
function Bg() {
	return Rg ||= [
		IDBDatabase,
		IDBObjectStore,
...
var Hg = /* @__PURE__ */ new WeakMap(), Ug = /* @__PURE__ */ new WeakMap(), Wg = /* @__PURE__ */ new WeakMap(), Gg = /* @__PURE__ */ new WeakMap(), Kg = /* @__PURE__ */ new WeakMap();
function qg(e) {
	...
	return t.then((t) => {
		t instanceof IDBCursor && Hg.set(t, e);
	}).catch(() => {}), Kg.set(t, e), t;
}
function Jg(e) {
	if (Ug.has(e)) return;
...
var Yg = {
	get(e, t, n) {
		if (e instanceof IDBTransaction) {
			if (t === "done") return Ug.get(e);
			if (t === "objectStoreNames") return e.objectStoreNames || Wg.get(e);
...
function Zg(e) {
	return e === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(t, ...n) {
		let r = e.call(e_(this), t, ...n);
		return Wg.set(r, t.sort ? t.sort() : [t]), $g(r);
	} : Vg().includes(e) ? function(...t) {
		return e.apply(e_(this), t), $g(Hg.get(this));
	} : function(...t) {
		return $g(e.apply(e_(this), t));
	};
}
function Qg(e) {
	return typeof e == "function" ? Zg(e) : (e instanceof IDBTransaction && Jg(e), Lg(e, Bg()) ? new Proxy(e, Yg) : e);
}
function $g(e) {
	if (e instanceof IDBRequest) return qg(e);
	if (Gg.has(e)) return Gg.get(e);
	let t = Qg(e);
	return t !== e && (Gg.set(e, t), Kg.set(t, e)), t;
}
var e_ = (e) => Kg.get(e);
//#endregion
//#region ../../node_modules/idb/build/index.js
function t_(e, t, { blocked: n, upgrade: r, blocking: i, terminated: a } = {}) {
...
function a_(e, t) {
	...
	if (i_.get(t)) return i_.get(t);
	let n = t.replace(/FromIndex$/, ""), r = t !== n, i = r_.includes(n);
	if (!(n in (r ? IDBIndex : IDBObjectStore).prototype) || !(i || n_.includes(n))) return;
...
Xg((e) => ({
	...e,
	get: (t, n, r) => a_(t, n) || e.get(t, n, r),
	has: (t, n) => !!a_(t, n) || e.has(t, n)
}));
//#endregion
...
var o_ = class {
...
}, s_ = "bookmarks", c_ = class extends o_ {
	constructor(e) {
	...
	async _getDB() {
		if (!this._db) {
			...
			this._db = t_(e, 1, {
				upgrade(e, t, n, r) {
					e.createObjectStore(s_, { keyPath: "name" });
				},
				blocked() {},
				blocking() {},
				terminated() {}
	...
	async put(e, t) {
		let n = (await this._getDB()).transaction(s_, "readwrite");
		try {
	...
	async delete(e) {
		(await this._getDB()).delete(s_, e);
	}
	async getNames() {
		return (await this._getDB()).getAllKeys(s_);
	}
	async get(e) {
		return (await this._getDB()).get(s_, e);
	}
}, l_ = {}, u_ = C(class extends S {
	constructor() {
		super(...arguments), this.ot = l_;
	}
	render(e, t) {
		return t();
	}
	update(e, [t, n]) {
		if (Array.isArray(t)) {
			if (Array.isArray(this.ot) && this.ot.length === t.length && t.every((e, t) => e === this.ot[t])) return pe;
		} else if (this.ot === t) return pe;
	...
	constructor() {
		super(), this.inputRef = Lt(), this.app = void 0, this._focused = !1, this._subscriptions = new d_(this), this.getDefaultValue = () => "";
	}
	get genomeSpy() {
	...
	_initializeGenome() {
		let e = g_(this.genomeSpy.viewRoot);
		if (e) {
			...
			let n = re(() => this.requestUpdate(), 60, !1);
	...
	async searchViews(e) {
		...
		for (let n of this.genomeSpy.getSearchableViews()) {
			...
			if (!(!i || !a || !o?.isZoomable())) {
				for (let s of n.getCollector()?.getData() ?? []) if (m_(s, r, e, t)) {
		...
		await (async () => {
			if (this._genomeResolution && this._genome) {
				...
				this.genomeSpy.viewRoot.visit((t) => {
					t instanceof Rp && t.handleVerboseCommand(e);
				});
			}
	...
	_getSearchHelp() {
		...
		for (let t of this.genomeSpy?.getSearchableViews() || []) {
			let n = t.getTitleText() ?? t.spec.name, r = t.getSearchAccessors(), i = r.flatMap((e) => e.fields).join(", "), a = h_(r, t.getCollector().getData(), 3);
			e.push(I`
	...
	render() {
		return I`
			...
			this._focused || (this._inputField.focus(), e.preventDefault(), e.stopPropagation());
                    ...
                    ${Nt(this.inputRef)}
                />
                ${u_([123], () => this._getSearchHelp())}
            </div>
        `;
	}
};
customElements.define("genome-spy-search-field", f_);
function p_(e, t) {
...
function h_(e, t, n) {
	...
	for (let i of e) for (let e of u(n, t, i)) if (e != null && r.add(String(e)), r.size >= n) return [...r];
	return [...r];
}
function g_(e) {
	let t;
...
var __ = {
	...
	devDependencies: {
		"@genome-spy/app-agent": "^0.89.0",
		"@genome-spy/inspector": "^0.89.0"
	}
};
//#endregion
...
var y_ = C(class extends S {
	...
	update(e, [t]) {
		if (t === pe || t === j) return t;
		let n = e.element, r = e.name;
		if (e.type === w.PROPERTY) {
			if (t === n[r]) return pe;
		} else if (e.type === w.BOOLEAN_ATTRIBUTE) {
			if (!!t === n.hasAttribute(r)) return pe;
		} else if (e.type === w.ATTRIBUTE && n.getAttribute(r) === t + "") return pe;
		return It(e), t;
	}
});
//#endregion
...
function x_(e) {
	...
	for (let n of e) {
		...
		for (let t of n) {
			...
			n || (n = S_(t), e.children.push(n)), e = n;
		}
	}
	return t.children[0];
}
...
customElements.define("gs-data-grid", C_);
//#endregion
//#region ../app/src/components/generic/uploadDropZone.js
var w_ = class extends L {
	static properties = {
		accept: { type: String },
...
customElements.define("gs-upload-drop-zone", w_);
//#endregion
//#region ../app/src/sampleView/metadata/metadataHierarchyConfigurator.js
var T_ = "sample", E_ = class extends L {
	static properties = {
		_pathRoot: { state: !0 },
		metadataRecords: {},
	...
	#e() {
		...
		this._columns = Array.from(e).filter((e) => e !== T_);
	}
	#t() {
	...
	async #a(e) {
		...
		let r = n.length > 0 ? vh(t, n) : [], i = this._scales.get(e.path), a = await K("gs-configure-scale-dialog", (e) => {
	...
	#o() {
		...
		return Sl(qt(this._pathRoot), (n) => {
			let r = (e) => {
				let t = 0, n = e.parent;
				for (; n;) t++, n = n.parent;
				return t;
			}, i = n.path, a = n.children.size === 0, o = this._scales.get(i), s = o?.type ?? "", c = o?.domain ? JSON.stringify(o.domain) : "", u = o?.range ? JSON.stringify(o.range) : "", d = o?.scheme ?? null, f = this._metadataNodeTypes.get(n.path) ?? "unset", p = n.parent === null, m = p && this.addUnderGroup ? this.addUnderGroup : n.part, h = { marginLeft: `${r(n) * 20}px` };
			p && !this.addUnderGroup && (h.color = "gray");
			let g = { unset: a && f === "unset" }, _ = { invalid: t.has(n.path) };
			return I`<tr>
                <td>
                    <span
                        style=${l(h)}
                ...
                <td>${c}</td>
                <td>
                    ${u || (d ? I`<span class="scheme-preview"
                                ><img
                                    src="${_h(d)}"
                                    alt="${d}"
                                    title="${d}"
...
customElements.define("gs-metadata-hierarchy-configurator", E_);
//#endregion
...
var k_ = class extends G {
	...
	#n;
	constructor() {
		super(), this.existingSampleIds = /* @__PURE__ */ new Set(), this.dialogTitle = "Load Custom Metadata", this._parsedItems = null, this._fileName = null, this._page = 0, this.#n = new Rh(this, [
			{
				render: () => this.#o(),
	...
	async #i(e) {
		let t = await D_(e), n = O_(t, e.name);
	...
	#s() {
		if (this.#e.error) return I`<div class="gs-alert danger">
                ...
                <div>
                    ...
                    <ul>
                        ${this.#e.error.map((e) => I`<li>${N_(e)}</li>`)}
                    </ul>
...
customElements.define("gs-upload-metadata-dialog", k_);
var A_ = I`<p>
...
function j_(e) {
	return kc("gs-upload-metadata-dialog", (t) => {
...
function N_(e) {
	return e.cases.length > 0 ? I`${e.message}${M_(e.cases)}` : e.count > 1 ? I`${e.message} (occurred ${e.count} times)` : e.message;
}
//#endregion
...
var R_ = class extends L {
	...
	#f() {
		...
		t.style.minWidth = String(n) + "px", bd(e, t, {
			placement: "bottom-start",
			strategy: "fixed",
			middleware: [vd(4), yd()]
		}).then(({ x: e, y: n }) => {
	...
	#p() {
		let e = this.#c(), t = this.#l();
		!e || !t || (this.#m(), this.#f(), this.#r = _d(e, t, () => this.#f()));
	}
	#m() {
		this.#r &&= (this.#r(), null);
	}
	...
	#_() {
		this.dispatchEvent(new z_(Array.from(this.selectedValues)));
	}
	#v(e) {
	...
	async #A() {
		...
		if (!n && this.search) try {
			n = (await this.search(e)).map((e) => F_(e)).find((e) => e.id.toLowerCase() === t) ?? null;
		} catch {
			return;
		}
	...
	render() {
		let e = this._activeIndex >= 0 ? this.#u(String(this._activeIndex)) : j;
		return I`
            <div
            ...
            >
                ${this._loading ? I`<div class="status">Loading...</div>` : j}
                ${!this._loading && this._suggestions.length === 0 ? I`<div class="status">No matches</div>` : j}
...
customElements.define("gs-multi-select", R_);
var z_ = class extends Event {
	values;
	constructor(e) {
		super("change", {
			bubbles: !0,
...
function V_({ queries: e, resolved: t }) {
...
}, U_ = "Type to search or paste one id per line", W_ = 100, G_ = [",", " "];
function K_(e, t) {
	if ("error" in e) {
...
var q_ = class extends G {
	...
	static styles = [...super.styles, F`
        ...
        `];
	constructor() {
		super(), this.sampleView = null, this.intentPipeline = null, this.source = null, this.columnInput = "", this.groupPath = "", this._loading = !1, this._error = "", this._preview = null, this._columnPlaceholder = U_, this._availableColumnCount = void 0, this._columnSearchIndex = new H_([], (e) => e.id), this._previewVersion = 0, this._sourceContextVersion = 0, this._previewQueryKey = "", this._alignmentIssue = null, this._showAlignmentDetails = !1, this._columnValidationEnabled = !1, this._adapter = null, this._form = new nf(this), this._form.defineField("columns", {
            ...
            <div class="stack">
                ...
                <div class="gs-form-group">
                    ...
                    <gs-multi-select
                        ...
                        .debounceMs=${50}
                        .selectedValues=${B_(this.columnInput)}
	...
	async #s() {
		...
		let e = ++this._previewVersion, t = B_(this.columnInput), n = this.#g(t);
		if (t.length === 0) {
			let e = V_({
				queries: t,
				resolved: {
	...
	#c() {
		...
		t.listColumns().then((t) => {
			...
			e === this._sourceContextVersion && (this._columnPlaceholder = U_, this._availableColumnCount = void 0, this._columnSearchIndex.replace([]));
	...
	#l(e) {
		this._columnSearchIndex.replace(e), this._availableColumnCount = e.length, this._columnPlaceholder = U_, this.updateComplete.then(() => {
	...
	#u(e) {
		...
		this._alignmentIssue = K_(n, (e) => this.#v(e));
	}
	#d(e) {
...
customElements.define("gs-import-metadata-source-dialog", q_);
function J_(e, t, n) {
...
var Y_ = class {
	...
	#i = new Y_();
	constructor() {
		super(), this.subscriptionController = new d_(this), this.style.display = "none";
	}
	connectedCallback() {
		super.connectedCallback(), this.dispatchEvent(b_("app", (e) => {
			this.#e = e;
		})), this.subscriptionController.addUnsubscribeCallback(kp(this.#e.store, (e) => e.lifecycle.appInitialized, (e) => this.#a(e))), this.subscriptionController.addUnsubscribeCallback(kp(this.#e.store, (e) => e.viewSettings, () => this.requestUpdate()));
	}
	createRenderRoot() {
		return this;
	}
	...
	#u() {
		...
		let n = t.filter($_).map((t) => [...t.getDataAncestors()].filter((t) => t === e || $_(t)).reverse());
		if (!n.length) {
			this.#t = void 0;
			return;
		}
	...
	#d() {
		let e = this.#e.genomeSpy.viewRoot, t = this.getVisibilities(), n = e ? Ln(e, t) : t, r = e ? Zn(e) : /* @__PURE__ */ new Set(), i = e ? Fn(e) : /* @__PURE__ */ new Map(), a = [], o = (t, s = -1) => {
			...
			c !== e && Z_(c) && m.push(...Q_(c, !0)), c instanceof Rp && (m.length && m.push({ type: "divider" }), m.push({
	...
	#f() {
		...
		}, { type: "divider" }, ...t)), Rd({ items: r }, this.#r.value, "bottom-start");
	}
	#p() {
		this.#f();
	}
...
}, Z_ = (e) => [...e.paramRuntime.paramConfigs.values()].some((e) => Ee(e) && e.bind), Q_ = (e, t) => {
	let n = [];
	return t && n.push({
		label: "Parameters",
		type: "header"
...
}, $_ = (e) => mn(e) && !!e.explicitName || Z_(e) || e instanceof Rp;
customElements.define("genome-spy-view-visibility", X_);
//#endregion
//#region ../app/src/utils/ui/dropdown.js
var ev = /* @__PURE__ */ new Set();
function tv(e) {
	let t = e.currentTarget.parentNode, r = !t.classList.contains("show");
	for (let e of ev) e.classList.remove("show"), document.body.classList.remove(n), document.body.classList.remove(h);
	return ev.clear(), e.stopPropagation(), r ? (ev.add(t), t.classList.add("show"), document.body.classList.add(n), document.body.classList.add(h), window.addEventListener("click", (e) => {
		t.classList.contains("show") && (t.classList.remove("show"), document.body.classList.remove(n), document.body.classList.remove(h), e.preventDefault());
	}, { once: !0 })) : window.dispatchEvent(new MouseEvent("click")), r;
}
//#endregion
//#region ../app/src/components/toolbar/provenanceToolbar.js
var nv = class extends L {
	constructor() {
		super(), this.provenance = void 0, this._subscriptions = new d_(this);
	}
	connectedCallback() {
		super.connectedCallback();
	...
	render() {
		return I`
			...
			if (!e) return j;
			let n = rm(e), r = n ? void 0 : this.provenance.getActionInfo(e);
			if (!n && !r) return j;
...
customElements.define("genome-spy-provenance-buttons", nv);
//#endregion
...
}, av = (e) => !Pt(e) && typeof e.then == "function", ov = 1073741823, sv = C(class extends Ft {
	constructor() {
		super(...arguments), this._$Cwt = ov, this._$Cbt = [], this._$CK = new rv(this), this._$CX = new iv();
	}
	render(...e) {
		return e.find((e) => !av(e)) ?? pe;
	}
	update(e, t) {
		...
		for (let e = 0; e < t.length && !(e > this._$Cwt); e++) {
			let o = t[e];
			if (!av(o)) return this._$Cwt = e, o;
			e < r && o === n[e] || (this._$Cwt = ov, r = 0, Promise.resolve(o).then(async (e) => {
...
}), cv = document.createElement("i");
function lv(e) {
	let t = "&" + e + ";";
	cv.innerHTML = t;
	let n = cv.textContent;
...
function J(e, t) {
	return e.length > 0 ? (uv(e, e.length, 0, t), e) : t;
}
//#endregion
//#region ../../node_modules/micromark-util-combine-extensions/index.js
var dv = {}.hasOwnProperty;
function fv(e) {
	let t = {}, n = -1;
	for (; ++n < e.length;) pv(t, e[n]);
	return t;
}
function pv(e, t) {
	let n;
	for (n in t) {
		let r = (dv.call(e, n) ? e[n] : void 0) || (e[n] = {}), i = t[n], a;
		if (i) for (a in i) {
			dv.call(r, a) || (r[a] = []);
			let e = i[a];
			mv(r[a], Array.isArray(e) ? e : e ? [e] : []);
		}
	}
}
function mv(e, t) {
...
var xv = Av(/[A-Za-z]/), Sv = Av(/[\dA-Za-z]/), Cv = Av(/[#-'*+\--9=?A-Z^-~]/);
function wv(e) {
	return e !== null && (e < 32 || e === 127);
}
var Tv = Av(/\d/), Ev = Av(/[\dA-Fa-f]/), Dv = Av(/[!-/:-@[-`{-~]/);
function Y(e) {
	return e !== null && e < -2;
}
function X(e) {
...
function Mv(e) {
	...
	for (; ++n < e.length;) {
		...
		if (a === 37 && Sv(e.charCodeAt(n + 1)) && Sv(e.charCodeAt(n + 2))) i = 2;
...
var Nv = {}.hasOwnProperty, Pv = /^(https?|ircs?|mailto|xmpp)$/i, Fv = /^https?$/i;
function Iv(e) {
	let t = e || {}, n = !0, r = {}, i = [[]], a = [], o = [], s = hv([{
		enter: {
			blockQuote: A,
			codeFenced: N,
	...
	function de() {
		let e = a.length - 1, i = a[e], o = i.referenceId || i.labelId, s = i.destination === void 0 ? r[bv(o)] : i;
		for (n = !0; e--;) if (a[e].image) {
			n = void 0;
			break;
		}
		i.image ? (_("<img src=\"" + jv(s.destination, t.allowDangerousProtocol ? void 0 : Fv) + "\" alt=\""), v(i.label), _("\"")) : _("<a href=\"" + jv(s.destination, t.allowDangerousProtocol ? void 0 : Pv) + "\""), _(s.title ? " title=\"" + s.title + "\"" : ""), i.image ? _(" />") : (_(">"), v(i.label), _("</a>")), a.pop();
	}
	function fe() {
		h(), a.push({});
	}
	...
	function _e() {
		let e = a[a.length - 1], t = bv(e.labelId);
		g(), Nv.call(r, t) || (r[t] = a[a.length - 1]), a.pop();
	}
	function ve() {
	...
	function ze(e) {
		...
		v(x(m("characterReferenceType") ? _v(t, m("characterReferenceType") === "characterReferenceMarkerNumeric" ? 10 : 16) : lv(t))), p("characterReferenceType");
	}
	function Be(e) {
		let n = this.sliceSerialize(e);
		_("<a href=\"" + jv(n, t.allowDangerousProtocol ? void 0 : Pv) + "\">"), v(x(n)), _("</a>");
	}
	function Ve(e) {
		let t = this.sliceSerialize(e);
		_("<a href=\"" + jv("mailto:" + t) + "\">"), v(x(t)), _("</a>");
	}
}
//#endregion
...
var zv = { tokenize: Vv }, Bv = { tokenize: Hv };
function Vv(e) {
	...
	function c(e) {
		if (r++, t.containerState._closeFlow) {
			...
			return uv(t.events, a + 1, 0, t.events.slice(n)), t.events.length = s, l(e);
		}
		return s(e);
	}
	function l(a) {
		...
		return t.containerState = {}, e.check(Bv, u, d)(a);
	}
	function u(e) {
		return i && v(), _(r), f(e);
	}
	...
	function f(n) {
		return t.containerState = {}, e.attempt(Bv, p, m)(n);
	}
	function p(e) {
	...
	function g(e, n) {
		...
		if (n && s.push(null), e.previous = a, a && (a.next = e), a = e, i.defineSkip(e.start), i.write(s), t.parser.lazy[e.start.line]) {
			...
			uv(t.events, a + 1, 0, t.events.slice(n)), t.events.length = e;
		}
	}
	function _(r) {
		let i = n.length;
...
function Kv(e, t) {
	...
	for (; ++n < e.length;) if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
		for (r = n; r--;) if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
			...
			Jv(d, -c), Jv(f, c), o = {
			...
			]), l = J(l, Wv(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t)), l = J(l, [
				[
					"exit",
					a,
					t
				...
				e[n][1],
				t
			]])) : u = 0, uv(e, r - 1, n - r + 3, l), n = r + l.length - u - 2;
			break;
		}
	}
...
function qv(e, t) {
	let n = this.parser.constructs.attentionMarkers.null, r = this.previous, i = Uv(r), a;
	return o;
	function o(t) {
	...
	function s(o) {
		...
		let c = e.exit("attentionSequence"), l = Uv(o), u = !l || l === 2 && i || n.includes(o), d = !i || i === 2 && l || n.includes(r);
...
function Xv(e, t, n) {
	...
	function a(t) {
		return xv(t) ? (e.consume(t), o) : t === 64 ? n(t) : l(t);
	}
	function o(e) {
		return e === 43 || e === 45 || e === 46 || Sv(e) ? (r = 1, s(e)) : l(e);
	}
	function s(t) {
		return t === 58 ? (e.consume(t), r = 0, c) : (t === 43 || t === 45 || t === 46 || Sv(t)) && r++ < 32 ? (e.consume(t), s) : (r = 0, l(t));
	}
	function c(r) {
		return r === 62 ? (e.exit("autolinkProtocol"), e.enter("autolinkMarker"), e.consume(r), e.exit("autolinkMarker"), e.exit("autolink"), t) : r === null || r === 32 || r === 60 || wv(r) ? n(r) : (e.consume(r), c);
	}
	function l(t) {
		return t === 64 ? (e.consume(t), u) : Cv(t) ? (e.consume(t), l) : n(t);
	}
	function u(e) {
		return Sv(e) ? d(e) : n(e);
	}
...
function iy(e, t, n) {
	...
	function i(r) {
		return Dv(r) ? (e.enter("characterEscapeValue"), e.consume(r), e.exit("characterEscapeValue"), e.exit("characterEscape"), t) : n(r);
	}
}
//#endregion
...
function oy(e, t, n) {
	...
	function c(t) {
		return t === 35 ? (e.enter("characterReferenceMarkerNumeric"), e.consume(t), e.exit("characterReferenceMarkerNumeric"), l) : (e.enter("characterReferenceValue"), a = 31, o = Sv, u(t));
	}
	function l(t) {
		return t === 88 || t === 120 ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(t), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), a = 6, o = Ev, u) : (e.enter("characterReferenceValue"), a = 7, o = Tv, u(t));
	}
	function u(s) {
		if (s === 59 && i) {
			let i = e.exit("characterReferenceValue");
			return o === Sv && !lv(r.sliceSerialize(i)) ? n(s) : (e.enter("characterReferenceMarker"), e.consume(s), e.exit("characterReferenceMarker"), e.exit("characterReference"), t);
		}
...
function ly(e, t, n) {
	...
	function d(n) {
		return n === null || Y(n) ? (e.exit("codeFencedFence"), r.interrupt ? t(n) : e.check(sy, h, b)(n)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", { contentType: "string" }), f(n));
	}
	function f(t) {
	...
	function v(t) {
		return t === null || Y(t) ? e.check(sy, h, b)(t) : (e.enter("codeFlowValue"), y(t));
	}
	function y(t) {
...
function py(e, t, n) {
	...
	function o(t) {
		return t === null ? c(t) : Y(t) ? e.attempt(fy, o, c)(t) : (e.enter("codeFlowValue"), s(t));
	}
	function s(t) {
...
var yy = class {
	...
	splice(e, t, n) {
		...
		return n && by(this.left, n), i.reverse();
	}
	pop() {
...
function xy(e) {
	let t = {}, n = -1, r, i, a, o, s, c, l, u = new yy(e);
	for (; ++n < u.length;) {
		for (; n in t;) n = t[n];
		...
		if (r[0] === "enter") r[1].contentType && (Object.assign(t, Sy(u, n)), n = t[n], l = !0);
	...
	return uv(e, 0, Infinity, u.slice(0)), !l;
}
function Sy(e, t) {
...
function Ey(e, t) {
	...
	function i(t) {
		return t === null ? a(t) : Y(t) ? e.check(wy, o, a)(t) : (e.consume(t), i);
	}
	function a(n) {
...
function Oy(e, t, n, r, i, a, o, s, c) {
	...
	return d;
	function d(t) {
		return t === 60 ? (e.enter(r), e.enter(i), e.enter(a), e.consume(t), e.exit(a), f) : t === null || t === 32 || t === 41 || wv(t) ? n(t) : (e.enter(r), e.enter(o), e.enter(s), e.enter("chunkString", { contentType: "string" }), h(t));
	}
	function f(n) {
	...
	function h(i) {
		return !u && (i === null || i === 41 || X(i)) ? (e.exit("chunkString"), e.exit(s), e.exit(o), e.exit(r), t(i)) : u < l && i === 40 ? (e.consume(i), u++, h) : i === 41 ? (e.consume(i), u--, h) : i === null || i === 32 || i === 40 || wv(i) ? n(i) : (e.consume(i), i === 92 ? g : h);
	}
	function g(t) {
...
function Py(e, t, n) {
	...
	function o(t) {
		return ky.call(r, e, s, n, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(t);
	}
	function s(t) {
		return i = bv(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)), t === 58 ? (e.enter("definitionMarker"), e.consume(t), e.exit("definitionMarker"), c) : n(t);
	}
	function c(t) {
		return X(t) ? jy(e, l)(t) : l(t);
	}
	function l(t) {
		return Oy(e, u, n, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(t);
	}
	function u(t) {
		return e.attempt(Ny, d, d)(t);
	}
	function d(t) {
...
function Fy(e, t, n) {
	return r;
	function r(t) {
		return X(t) ? jy(e, i)(t) : n(t);
	}
	function i(t) {
		return Ay(e, a, n, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(t);
	}
	function a(t) {
...
var Vy = /* @__PURE__ */ "address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul".split("."), Hy = [
	"pre",
	"script",
	"style",
	"textarea"
...
function qy(e, t, n) {
	...
	function d(s) {
		return s === 33 ? (e.consume(s), f) : s === 47 ? (e.consume(s), a = !0, h) : s === 63 ? (e.consume(s), i = 3, r.interrupt ? t : F) : xv(s) ? (e.consume(s), o = String.fromCharCode(s), g) : n(s);
	}
	function f(a) {
		return a === 45 ? (e.consume(a), i = 2, p) : a === 91 ? (e.consume(a), i = 5, s = 0, m) : xv(a) ? (e.consume(a), i = 4, r.interrupt ? t : F) : n(a);
	}
	function p(i) {
	...
	function h(t) {
		return xv(t) ? (e.consume(t), o = String.fromCharCode(t), g) : n(t);
	}
	function g(s) {
		if (s === null || s === 47 || s === 62 || X(s)) {
			let c = s === 47, l = o.toLowerCase();
			return !c && !a && Hy.includes(l) ? (i = 1, r.interrupt ? t(s) : O(s)) : Vy.includes(o.toLowerCase()) ? (i = 6, c ? (e.consume(s), _) : r.interrupt ? t(s) : O(s)) : (i = 7, r.interrupt && !r.parser.lazy[r.now().line] ? n(s) : a ? v(s) : y(s));
		}
		return s === 45 || Sv(s) ? (e.consume(s), o += String.fromCharCode(s), g) : n(s);
	}
	function _(i) {
	...
	function y(t) {
		return t === 47 ? (e.consume(t), E) : t === 58 || t === 95 || xv(t) ? (e.consume(t), b) : Z(t) ? (e.consume(t), y) : E(t);
	}
	function b(t) {
		return t === 45 || t === 46 || t === 58 || t === 95 || Sv(t) ? (e.consume(t), b) : x(t);
	}
	function x(t) {
	...
	function O(t) {
		return t === 45 && i === 2 ? (e.consume(t), j) : t === 60 && i === 1 ? (e.consume(t), M) : t === 62 && i === 4 ? (e.consume(t), te) : t === 63 && i === 3 ? (e.consume(t), F) : t === 93 && i === 5 ? (e.consume(t), P) : Y(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Wy, ne, k)(t)) : t === null || Y(t) ? (e.exit("htmlFlowData"), k(t)) : (e.consume(t), O);
	}
	function k(t) {
		return e.check(Gy, A, ne)(t);
	}
	function A(t) {
	...
	function N(t) {
		if (t === 62) {
			let n = o.toLowerCase();
			return Hy.includes(n) ? (e.consume(t), te) : O(t);
		}
		return xv(t) && o.length < 8 ? (e.consume(t), o += String.fromCharCode(t), N) : O(t);
	}
	function P(t) {
...
function Yy(e, t, n) {
	return r;
	function r(r) {
		return e.enter("lineEnding"), e.consume(r), e.exit("lineEnding"), e.attempt(Zv, t, n);
	}
}
//#endregion
...
function Zy(e, t, n) {
	...
	function c(t) {
		return t === 33 ? (e.consume(t), l) : t === 47 ? (e.consume(t), x) : t === 63 ? (e.consume(t), y) : xv(t) ? (e.consume(t), w) : n(t);
	}
	function l(t) {
		return t === 45 ? (e.consume(t), u) : t === 91 ? (e.consume(t), a = 0, m) : xv(t) ? (e.consume(t), v) : n(t);
	}
	function u(t) {
	...
	function x(t) {
		return xv(t) ? (e.consume(t), S) : n(t);
	}
	function S(t) {
		return t === 45 || Sv(t) ? (e.consume(t), S) : C(t);
	}
	function C(t) {
		return Y(t) ? (o = C, M(t)) : Z(t) ? (e.consume(t), C) : j(t);
	}
	function w(t) {
		return t === 45 || Sv(t) ? (e.consume(t), w) : t === 47 || t === 62 || X(t) ? T(t) : n(t);
	}
	function T(t) {
		return t === 47 ? (e.consume(t), j) : t === 58 || t === 95 || xv(t) ? (e.consume(t), E) : Y(t) ? (o = T, M(t)) : Z(t) ? (e.consume(t), T) : j(t);
	}
	function E(t) {
		return t === 45 || t === 46 || t === 58 || t === 95 || Sv(t) ? (e.consume(t), E) : D(t);
	}
	function D(t) {
...
var Qy = {
	...
	resolveTo: rb,
	tokenize: ib
}, $y = { tokenize: ab }, eb = { tokenize: ob }, tb = { tokenize: sb };
function nb(e) {
	let t = -1, n = [];
	for (; ++t < e.length;) {
		let r = e[t][1];
	...
	return e.length !== n.length && uv(e, 0, e.length, n), e;
}
function rb(e, t) {
	...
	return s = [[
		...
		u,
		t
	]]), s = J(s, Wv(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t)), s = J(s, [
		[
			"exit",
			u,
			t
...
function ib(e, t, n) {
	...
	return s;
	function s(t) {
		return a ? a._inactive ? d(t) : (o = r.parser.defined.includes(bv(r.sliceSerialize({
			start: a.end,
			end: r.now()
		}))), e.enter("labelEnd"), e.enter("labelMarker"), e.consume(t), e.exit("labelMarker"), e.exit("labelEnd"), c) : n(t);
	}
	function c(t) {
		return t === 40 ? e.attempt($y, u, o ? u : d)(t) : t === 91 ? e.attempt(eb, u, o ? l : d)(t) : o ? u(t) : d(t);
	}
	function l(t) {
		return e.attempt(tb, u, d)(t);
	}
	function u(e) {
		return t(e);
	}
...
function ab(e, t, n) {
	...
	function i(t) {
		return X(t) ? jy(e, a)(t) : a(t);
	}
	function a(t) {
		return t === 41 ? u(t) : Oy(e, o, s, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(t);
	}
	function o(t) {
		return X(t) ? jy(e, c)(t) : u(t);
	}
	function s(e) {
		return n(e);
	}
	function c(t) {
		return t === 34 || t === 39 || t === 40 ? Ay(e, l, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(t) : u(t);
	}
	function l(t) {
		return X(t) ? jy(e, u)(t) : u(t);
	}
	function u(r) {
...
function ob(e, t, n) {
	...
	return i;
	function i(t) {
		return ky.call(r, e, a, o, "reference", "referenceMarker", "referenceString")(t);
	}
	function a(e) {
		return r.parser.defined.includes(bv(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))) ? t(e) : n(e);
	}
	function o(e) {
		return n(e);
	}
...
function vb(e, t, n) {
	...
	function s(t) {
		...
		if (i === "listUnordered" ? !r.containerState.marker || t === r.containerState.marker : Tv(t)) {
			if (r.containerState.type || (r.containerState.type = i, e.enter(i, { _container: !0 })), i === "listUnordered") return e.enter("listItemPrefix"), t === 42 || t === 45 ? e.check(mb, n, l)(t) : l(t);
			if (!r.interrupt || t === 49) return e.enter("listItemPrefix"), e.enter("listItemValue"), c(t);
		}
		return n(t);
	}
	function c(t) {
		return Tv(t) && ++o < 10 ? (e.consume(t), c) : (!r.interrupt || o < 2) && (r.containerState.marker ? t === r.containerState.marker : t === 41 || t === 46) ? (e.exit("listItemValue"), l(t)) : n(t);
	}
	function l(t) {
		return e.enter("listItemMarker"), e.consume(t), e.exit("listItemMarker"), r.containerState.marker = r.containerState.marker || t, e.check(Zv, r.interrupt ? n : u, e.attempt(gb, f, d));
	}
	function u(e) {
...
function yb(e, t, n) {
	let r = this;
	return r.containerState._closeFlow = void 0, e.check(Zv, i, a);
	function i(n) {
	...
	function a(n) {
		return r.containerState.furtherBlankLines || !Z(n) ? (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, o(n)) : (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, e.attempt(_b, t, o)(n));
	}
	function o(i) {
...
var Eb = { tokenize: Db };
function Db(e) {
	let t = this, n = e.attempt(Zv, r, e.attempt(this.parser.constructs.flowInitial, i, Q(e, e.attempt(this.parser.constructs.flow, i, e.attempt(Cy, i)), "linePrefix")));
	return n;
	function r(r) {
		if (r === null) {
			e.consume(r);
...
var Ob = { resolveAll: Mb() }, kb = jb("string"), Ab = jb("text");
function jb(e) {
	return {
		resolveAll: Mb(e === "text" ? Nb : void 0),
		tokenize: t
	};
	function t(t) {
...
var Pb = /* @__PURE__ */ e({
	...
	95: Gv,
	96: hy
}, Vb = { null: [Gv, Ob] }, Hb = { null: [42, 95] }, Ub = { null: [] };
//#endregion
...
function Wb(e, t, n) {
	...
	function d(e) {
		return o = J(o, e), g(), o[o.length - 1] === null ? (w(t, 0), l.events = Wv(a, l.events, l), l.events) : [];
	}
	function f(e, t) {
		return Kb(p(e), t);
	}
	...
	function w(e, t) {
		e.resolveAll && !a.includes(e) && a.push(e), e.resolve && uv(l.events, t, l.events.length - t, e.resolve(l.events.slice(t), l)), e.resolveTo && (l.events = e.resolveTo(l.events, l));
	}
	function T() {
...
function Xb() {
	...
	function i(i, a, o) {
		...
		for (i = t + (typeof i == "string" ? i.toString() : new TextDecoder(a || void 0).decode(i)), u = 0, t = "", n &&= (i.charCodeAt(0) === 65279 && u++, void 0); u < i.length;) {
			if (Yb.lastIndex = u, c = Yb.exec(i), d = c && c.index !== void 0 ? c.index : i.length, f = i.charCodeAt(d), !c) {
				t = i.slice(u);
				break;
			}
...
function Zb(e, t, n) {
	return typeof t != "string" && (n = t, t = void 0), Iv(n)(Jb(qb(n).document().write(Xb()(e, t, !0))));
}
//#endregion
//#region ../app/src/utils/safeMarkdown.js
function Qb(e, t = {}) {
	let n = Zb(e), r = new DOMParser().parseFromString(`<!DOCTYPE html><html><body><div>${n}</div></body></html>`, "text/html");
	r.normalize(), $b(r.body);
...
function $b(e) {
	if (e.nodeType !== 3) {
		...
		for (let t = e.childNodes.length; t--;) $b(e.childNodes[t]);
	}
}
//#endregion
...
`, tx = class extends G {
	...
	renderBody() {
		let e = this.entry;
		return I`<div class="notes">${e.notes ? Qb(e.notes, { baseUrl: this.baseUrl }) : I`<span class="no-notes">No notes provided</span>`}</div>
            ${this.#r()}`;
	}
	#r() {
            ...
            ${this.plotResults.map((e, t) => e.error || !e.plot ? I`<div class="bookmark-plot bookmark-plot-error">
                    ...
                    <div class="bookmark-plot-title">
                        ...
                        <button
                            class="btn"
                            type="button"
                            @click=${() => Ep(e.plot, { bookmarkContext: this.plotBookmarkContext })}
                        >
...
customElements.define("gs-bookmark-info-box", tx);
//#endregion
...
function rx(e, t) {
	let n = {};
	for (let [r, i] of e.getNamedScaleResolutions().entries()) t(i) && nx(i) && (n[r] = i.getComplexDomain());
	return n;
}
//#endregion
...
function ix(e, t = {}) {
	...
	return n.scaleDomains = rx(e.genomeSpy, (e) => e.isZoomable()), t.plots?.length && (n.plots = t.plots.slice()), n;
}
function ax(e) {
	return {
		getLocalBookmarkDatabase: () => e.localBookmarkDatabase,
		createBookmark: (t) => ix(e, { plots: t }),
...
async function sx(e, t) {
	try {
		...
		return await Promise.all(r), { plots: await cx(e, t) };
	} catch (e) {
...
async function lx(e, t) {
	if (await sf(t.localBookmarkDatabase, e, "add")) try {
...
async function dx(e, t, n = {}) {
	...
	if (r) r.baseUrl = fx(t, n), r.entry = e, r.mode = n.mode ?? "default", r.plotResults = n.plotResults ?? [], r.plotBookmarkContext = ax(t);
	else {
		K("gs-bookmark-info-box", async (r) => {
			r.baseUrl = fx(t, n), r.entry = e, r.mode = n.mode ?? "default", r.plotResults = n.plotResults ?? [], r.plotBookmarkContext = ax(t), r.allowImport = !!n.database, n.database && (r.names = await n.database.getNames());
		}).then(async () => {
			if (n.mode == "tour") {
...
var px = class extends L {
	...
	async #t() {
		let e = this.#e();
		await sf(void 0, e, "share") && xp(e, !1);
	}
	async #n(e, t) {
		let n = t ? await e.get(t) : void 0, r = !!n, i = this.#e();
		if (i.name ??= n?.name, i.notes ??= n?.notes, i.plots ??= n?.plots, await sf(e, i, r ? "edit" : "add")) try {
	...
	#i(e, t, n) {
		...
		o || (a.push({
			...
			label: "Share...",
			icon: fi,
			callback: async () => xp(await e.get(t), o)
		}), Rd({ items: a }, r, "right-start");
	}
	async #a(e, t) {
	...
	#o() {
		let e = (e, t) => e ? sv(this.#a(e, t), I`Loading...`) : j;
...
customElements.define("genome-spy-bookmark-button", px);
//#endregion
		...
		return I` <div style="display: flex; gap: 1em">
            ...
            <div style="max-width: 28em">
                <p>
                    ...
                    <a href="${__.homepage}" target="_blank"
                        >${__.homepage}</a
                    >.
                </p>
                <p>
                    Copyright 2026 ${__.author?.name ?? "The author"}
                    and contributors.<br />
                    ${__.license} license.
                </p>
                <p>
                    Version: ${v_(__.version)}
                    ${"commitHash" in __ ? `(${__.commitHash})` : j}
                </p>
...
customElements.define("gs-about-dialog", mx);
//#endregion
...
var _x = class extends L {
	...
	connectedCallback() {
		super.connectedCallback(), this.#e = kp(this.app.store, (e) => e.lifecycle.appInitialized, () => this.requestUpdate()), this.app.ui.addEventListener("change", this.#t);
	}
	disconnectedCallback() {
	...
	_getToolButtons() {
		...
		e.isEnabled() && t.push(I`
            ...
            `);
		let n = this.app.rootSpec.description ? Ge(this.app.rootSpec.description) : [];
		return n.length > 1 && t.push(I`
            ...
            ${this.app.ui.toolbarButtons.size ? Array.from(this.app.ui.toolbarButtons).map((e) => this.#n(e)) : j}
	...
	render() {
		...
		return I`
            <nav class="gs-toolbar">
                ...
                ${this.app.store.getState().lifecycle.appInitialized && g_(e.viewRoot) ? I`
...
customElements.define("genome-spy-toolbar", _x);
//#endregion
...
var yx = class {
	...
	isEmpty() {
		let e = this._provenanceState, t = e.present?.lastAction, n = !!t && !rm(t);
	...
	getBookmarkableActionHistory() {
		return this.getActionHistory().filter((e) => !rm(e)).map((e) => {
...
var xx = "sampleCount", Sx = class extends Te {
	#e = !0;
	#t;
	constructor(e, t) {
		super(), this.view = t;
		let n = t.context.animator;
		if (this.provenance = Cx(t), !this.provenance) throw Error("No SampleView was found!");
		let r = () => {
			this.#n && (this.#e && (this.#e = !1, this.reset(), this.complete()), n.requestTransition(() => {
				this.reset(), this.complete();
			}));
		}, i = kp(this.provenance.store, (e) => e.provenance.present[pn], () => {
			r();
		});
	...
	initialize() {
		this.#t = this.paramRuntime.allocateSetter(xx, 0, !0);
		let e = this.view.getEncoding().x;
		if (Ze(e)) this.xAccessor = Ae(e.field);
	...
	#r() {
		if (this.parent instanceof y) return this.parent;
	...
	#i(e) {
		let t = [...tr(e.rootGroup)].filter((e) => _n(Be(e)));
		for (let [e, n] of t.entries()) {
			...
			if (_n(t)) {
				...
				bx(n.map((e) => r.facetBatches.get([e]) ?? []), (e) => this._propagate(e), this.xAccessor);
			}
		}
	}
	beginBatch(e, t) {
...
function Cx(e) {
	for (let t of e.getLayoutAncestors()) if (t instanceof jg) return t.provenance;
}
//#endregion
//#region ../app/src/bookmark/simpleBookmarkDatabase.js
var wx = class extends o_ {
	constructor(e, t = {}) {
...
function kx() {
	let e = Xt({
		...
		lifecycle: Ex.reducer,
		viewSettings: $n.reducer,
		intentStatus: Ox.reducer,
		provenance: e
	});
	return ir({
		middleware: (e) => e({
		...
		reducer: (n, r) => {
			let i = t(n, r);
			if (r.type === Ox.actions.setError.type) {
			...
			if (r.type === Ox.actions.resolveError.type && r.payload.decision === "rollbackBatch") {
	...
	async #l() {
		...
		try {
			for (; this.#r.length;) {
				...
				this.#e.dispatch(Ox.actions.setRunning({
					startIndex: r,
				...
				let a;
				try {
					for (let [e, n] of t.actions.entries()) a = n, this.#e.dispatch(Ox.actions.setProgress({
						currentIndex: e,
						currentAction: n
					...
					this.#e.dispatch(Ox.actions.setError({
						startIndex: r,
						lastSuccessfulIndex: i,
						failedAction: a,
						submissionKind: s,
						error: o.message
					})), s === "agent" && this.#e.dispatch(Ox.actions.clearStatus()), t.reject(o);
					let c = this.#r;
					this.#r = [];
			...
			this.#i = !1, this.#a = !1, this.#c = void 0, e || this.#e.dispatch(Ox.actions.clearStatus());
		}
	}
	async #u(e, t) {
		let n = this.createContext(t);
		if (n.signal?.aborted) throw Error("Action processing was aborted.");
		let r = jx(e), i = r && n.getAttributeInfo ? n.getAttributeInfo(r) : void 0;
...
async function Mx(e) {
	...
	if (s) {
		...
		if (e.columnIds.length === 0) throw Error(Nx(t, e));
		l = e.columnIds;
	}
...
async function Px(e, t, n) {
	...
	let a = hn(t), o = await a.getSource(r.sourceId), s = await Mx({
		source: o,
		payload: r,
		sampleIds: i,
...
async function Fx(e) {
	...
	return t && t.length > 0 ? t : (await new Promise((t, n) => {
		...
		}, 1e4), i = kp(e.provenance.store, () => e.sampleHierarchy.sampleData?.ids, (e) => {
...
async function Ix(e, t) {
	...
	a.length !== 0 && (await t.submit(a), im(e.provenance.store, Ht.name));
}
//#endregion
...
async function Lx(e, t) {
	...
	let n = t.registerActionHook({
		...
		augment: (t, n) => Px(n, e, t.signal)
	});
	e.registerDisposer(n), e.registerDisposer(r), await Ix(e, t);
}
//#endregion
//#region ../app/src/components/dialogs/intentStatusDialog.js
var Rx = class extends G {
	static properties = {
		...super.properties,
		message: {},
...
customElements.define("gs-intent-status-dialog", Rx);
function zx(e) {
	return jc("gs-intent-status-dialog", (t) => {
...
customElements.define("gs-intent-error-dialog", Bx);
function Vx(e) {
	return kc("gs-intent-error-dialog", (t) => {
...
function Hx({ store: e, intentPipeline: t, provenance: n, delayMs: r = 800, minVisibleMs: i = 400 }) {
	let a, o, s, c, l = (e = !1) => {
		if (!o) return;
		...
		let t = e?.currentAction ? Wx(n, e.currentAction) : j, r = typeof e?.currentIndex == "number" && typeof e?.totalActions == "number" ? I` (${e.currentIndex + 1} of ${e.totalActions})` : j;
		...
		if (o) return;
		let n = e.getState().intentStatus, { element: r, promise: i } = zx({
			title: "Working…",
			message: u(n),
			cancelLabel: "Cancel"
		});
		...
		let i = t ? Wx(n, t) : "action", a = Ux(r), o = I`
            <p>
                ${a ? "Canceled while performing:" : "Failed to perform:"}
                ${i}
            </p>
            <p>
                ${r ? I`<p>Details:<br />${r}</p>` : j}
            </p>
            <p>
		...
		e.dispatch(Ox.actions.resolveError({ decision: s }));
	}, p = kp(e, (e) => e.intentStatus, (t, n) => {
		if (t?.status === "running") {
			a ||= setTimeout(() => {
...
function Yx(e, t) {
	return Jx(e) ? { not: Yx(e.not, t) } : qx(e) ? { and: e.and.map((e) => Yx(e, t)) } : Kx(e) ? { or: e.or.map((e) => Yx(e, t)) } : tS(e, t);
}
function Xx(e, t) {
	return Yx(Zx(e), t);
}
...
function aS(e, t) {
	return !t || typeof t != "object" || t.type !== "interval" ? t : {
		type: "interval",
		intervals: oS(e, "intervals" in t && t.intervals ? t.intervals : "value" in t && Array.isArray(t.value) ? { x: t.value } : {})
	};
}
function oS(e, t) {
	let n = {};
...
var sS = 150, cS = class {
	...
	#v() {
		let e = kp(this.#t, (e) => e.provenance.present.paramProvenance.entries, Ap((e) => {
			this.#F(e);
		}));
		this.#o.push(e);
	}
	...
	#b(e) {
		...
		let n = this.#L(e);
		if (n === void 0 || Ie(e.param) && this.#Z(e.param, n) && this.#C(e, t)) return;
		let r = this.#P(e, n);
		if (r) {
			if (this.#x(e, n, t)) {
	...
	#x(e, t, n) {
		if (!Ie(e.param) || !this.#Z(e.param, t)) return !1;
		let { past: r, present: i } = this.#t.getState().provenance;
		if (r.length === 0) return !1;
		let a = i.lastAction;
		if (!a || !xg.actions.paramChange.match(a)) return !1;
	...
	#w(e) {
		return Ie(e) ? !0 : Ee(e) && !!e.bind;
	}
	#T(e, t) {
		let n = xg.actions.paramChange({
			selector: e.selector,
			value: t
		});
		this.#n.dispatch(n);
	...
	#k(e) {
		return Xe(e.param, e.view.paramRuntime);
	}
	#A(e, t) {
	...
	#I(e, t) {
		return Ee(e.param) && Object.is(e.view.paramRuntime.getTargetValue(e.selector.param), t);
	}
	#L(e) {
		let t = e.selector.param;
		return Ee(e.param) ? e.view.paramRuntime.getTargetValue(t) : e.view.paramRuntime.getValue(t);
	}
	async whenApplied(e) {
	...
	#R(e, t) {
		...
		if (Ie(n)) {
			...
			if (we(i)) {
				...
				try {
					c = De(s, t, a, (e, t) => o.findDatumByKey(e, t));
				} catch (r) {
		...
		return Ee(n) ? r.type === "value" ? r.value : this.#j(e, "cannot be restored because the bookmark stored a different value type.") : this.#k(e);
	}
	#z(e, t, n) {
	...
	#X(e, t) {
		let n = e.param;
		Ie(n) && we(Ue(n.select)) && (this.#N(e, "persist") || this.#u.add(t));
	}
	#Z(e, t) {
		let n = Ue(e.select);
		return we(n) ? Oe(t) ? !t.datum : !Qe(t) || t.data.size === 0 : Fe(n) ? !ke(t) : !1;
	}
	#Q(e) {
...
function dS(e, t) {
	let n = xg.actions.paramChange.match(e), r = xg.actions.expandPointSelection.match(e);
	if (!n && !r) return;
	let i = e.payload, a = i.selector, o = r && "rule" in i ? { rule: i.rule } : r ? { predicate: i.predicate } : {}, s = r ? {
		...
		origin: i.origin,
		...o
	} : i.value, c = i.origin, l = xS(ht, t, a), u = l ? l.view : void 0, d = u ? mS(u, t) : null, f = fS(e, u, a, s, c, t);
	return {
		title: d ? I`${f} in ${d}` : f,
		icon: bS(s)
	};
...
function fS(e, t, n, r, i, a) {
	...
	if (r.type === "value") return I`Set <strong>${o}</strong> =
            <strong>${hS(r.value)}</strong>${pS(i, a)}`;
	if (r.type === "point") return r.keys.length === 0 ? I`Clear selection
                <strong>${o}</strong> ${pS(i, a)}` : r.keys.length === 1 ? I`Select <strong>${o}</strong> =
                ${gS(_S(r.keys[0]))}${pS(i, a)}` : I`Select <strong>${o}</strong> (${gS(r.keys.length)}
            points)${pS(i, a)}`;
	if (r.type === "pointExpand") {
		let t = SS(r.operation), n = CS(AS(r), {
			action: e,
			root: a,
			origin: r.origin
		});
		return I`${t}
            <strong>${o}</strong>
            ${kS(r.partitionBy)} by ${n}`;
	}
	if (r.type === "interval") {
		let e = r.intervals ?? {}, n = e.x, s = e.y, c = yS(n && t ? Pm(t, n) : vS(n), s ? vS(s) : null);
		return c ? I`Brush
            <strong>${o}</strong>
            ${c}${pS(i, a)}` : I`Clear selection
                <strong>${o}</strong> ${pS(i, a)}`;
	}
	return I`Update <strong>${o}</strong>`;
}
function pS(e, t) {
	if (!e || e.type !== "datum") return I``;
	let n = t ? xS(bt, t, e.view) : null;
	return n ? I` from ${mS(n, t)}` : I``;
}
function mS(e, t) {
	let n = (e.getTitleText ? e.getTitleText() : void 0) || e.explicitName || e.spec && e.spec.name || e.name || "view";
	return I`<strong>${Hm(t, e, String(n))}</strong>`;
}
function hS(e) {
...
function _S(e) {
	return e.length === 1 ? hS(e[0]) : "(" + e.map((e) => hS(e)).join(", ") + ")";
}
function vS(e) {
...
function wS(e, t) {
	if (Jx(e)) return I`not (${wS(e.not, t)})`;
	if (qx(e)) return DS(e.and.map((e) => wS(e, t)), " and ");
	if (Kx(e)) return DS(e.or.map((e) => wS(e, t)), " or ");
	if (e.op === "eq") {
		if ("value" in e) return I`${TS(e.field)}
                <span class="operator">=</span>
                <strong>${hS(e.value)}</strong>`;
		if ("valueFromField" in e) {
			let n = OS(t.action, t.root, t.origin, e.valueFromField);
			if (n !== void 0) return I`${TS(e.field)}
                    <span class="operator">=</span>
                    <strong>${hS(n)}</strong>
                    (from clicked item)`;
			{
	...
	} else if (e.op === "in") return I`${TS(e.field)}
...
function ES(e) {
	return I`{${e.map((e, t) => I`${t > 0 ? ", " : ""}<strong>${hS(e)}</strong>`)}}`;
}
function DS(e, t) {
...
function OS(e, t, n, r) {
	...
	if (!s) return;
	let c = eS(r)(s);
	if (c !== void 0) return i || (i = /* @__PURE__ */ new Map(), uS.set(e, i)), i.set(r, c), c;
}
function kS(e) {
...
function MS(e, t) {
	gt(e, (e) => {
		...
		if (!(!n || typeof n != "object") && (typeof n.group != "string" || n.group.length === 0)) {
			let n = _t(e);
			t.push({
				message: "Configurable visibility group must be a non-empty string in " + LS(n) + " for " + e.getPathString() + ".",
				scope: n
			});
		}
	});
...
function NS(e, t) {
	...
	gt(e, (e) => {
		...
		if (!o) {
			if (!Dn(e)) return;
			t.push({
				message: "Configurable view must have an explicit name in " + LS(i) + ".",
				scope: i
			});
			return;
		}
	...
	for (let [e, i] of r) {
		...
		for (let [e, n] of i) {
			...
			t.push({
				message: "Configurable view name \"" + e + "\" is not unique within " + LS(r) + ". Found in: " + i + ".",
				scope: r
			});
		}
	}
...
function PS(e, t) {
	...
	gt(e, (e) => {
		...
		if (typeof i != "string" || !i.length || !FS(e)) return;
		let a = _t(e);
		if (!a.length) return;
		let o = a.slice(0, a.length - 1), s = IS(o);
	...
	for (let [e, i] of r) {
		...
		for (let [e, n] of i) n <= 1 || t.push({
			message: "Import instance name \"" + e + "\" is used multiple times for addressable instances in " + LS(r) + ".",
			scope: r
		});
	}
}
...
function RS({ viewRoot: e, intentExecutor: t }) {
	let n = !1, r = (r) => {
		if (r.stopped || zS(r.target)) return;
		let i = fg(e, e.context.getCurrentHover());
		...
		i.status === "available" && (zd({ items: [Cg(i.context, (e) => t.dispatch(e))] }, r.mouseEvent), r.stopPropagation());
	};
	return e.addInteractionListener("contextmenu", r), () => e.removeInteractionListener("contextmenu", r);
}
function zS(e) {
	return e ? e.getLayoutAncestors().some((e) => e instanceof jg) : !1;
}
//#endregion
//#region ../app/src/appKeyboardShortcuts.js
function BS({ viewRoot: e, shortcuts: t }) {
	e.context.addKeyboardListener("keydown", (e) => HS(e, t));
}
function VS({ provenance: e, focusSearchField: t }) {
	return [{
		code: "KeyZ",
...
function HS(e, t) {
	...
	for (let n of t) if (US(e, n.code) && !(n.allowEditableTarget !== !0 && WS(e.target)) && !(n.isEnabled && !n.isEnabled()) && n.run(e) !== !1) return e.preventDefault(), !0;
	return !1;
}
function US(e, t) {
...
var GS = class extends EventTarget {
	constructor() {
...
var KS = class {
	...
	constructor(e, t, n = {}) {
		...
		}), this.genomeSpy = new ne(this.appContainer.getElementsByClassName("genome-spy-container")[0], this.rootSpec, this.options), this.debug = {
			getViewRoot: () => this.genomeSpy?.viewRoot,
			getModules: () => this.getDebugModules()
		}, this.genomeSpy.viewFactory.addViewType(Cm, ((e, t, n, r, i) => new jg(e, t, n, r, i, this.provenance, this.intentExecutor, ax(this)))), this.#o();
	}
	getAgentApi() {
		return this.#e ||= import("./agentApi-Be0_6FqM.js").then((e) => e.t).then((e) => e.createAgentApi(this)), this.#e;
	}
	async getDebugModules() {
		return import("./debug-DQj_7mFm.js");
	}
	#r() {
		this.store = kx(), this.intentExecutor = new Tx(this.store), this.provenance = new yx(this.store), this.intentPipeline = new Ax({
			store: this.store,
			provenance: this.provenance,
			intentExecutor: this.intentExecutor
		}), im(this.store, xg.name);
	}
	#i() {
		this.localBookmarkDatabase = this.isEmbedded() ? void 0 : typeof this.rootSpec.specId == "string" ? new c_(this.rootSpec.specId) : void 0, this.globalBookmarkDatabase = void 0;
	}
	#a(e) {
		this.appContainer = e, this.isFullPage() ? (this.appContainer.style.margin = "0", this.appContainer.style.padding = "0", this.appContainer.style.overflow = "hidden", JS(vr)) : this.appContainer.style.position = "relative";
	}
	#o() {
	...
	async launch() {
		let e = this.isEmbedded() ? Promise.resolve([]) : this.rootSpec.bookmarks?.remote ? de({ baseURL: this.rootSpec.baseUrl }).load(this.rootSpec.bookmarks.remote.url).then((e) => Promise.resolve(JSON.parse(e))) : Promise.resolve([]);
		...
		this.paramProvenanceBridge = new cS({
			root: t,
			store: this.store,
			intentExecutor: this.intentExecutor
		}), t.registerDisposer(() => {
			this.paramProvenanceBridge.dispose();
		}), this.provenance.addActionInfoSource((e) => dS(e, t)), BS({
			viewRoot: t,
			shortcuts: VS({
				provenance: this.provenance,
				focusSearchField: () => {
		...
		}), t.registerDisposer(RS({
			viewRoot: t,
			intentExecutor: this.intentExecutor
		}));
		let n = this.getSampleView();
		if (n) try {
			await Lx(n, this.intentPipeline);
		} catch (e) {
		...
		if (this.appContainer.querySelector("canvas").setAttribute("tabindex", "-1"), this.#c(kp(this.store, (e) => e.viewSettings?.visibilities, Ap(() => {
			if (this.#n) return;
			...
			YS(this.genomeSpy.viewRoot), e.highlightView(null), e.requestLayoutReflow();
		}))), this.#c(Hx({
			store: this.store,
		...
		let r = Ge(this.genomeSpy.spec.description ?? []);
		this.isFullPage() && r.length > 0 && (document.title = "GenomeSpy - " + r), this.store.dispatch(Ex.actions.setInitialized());
	}
	async #l(e) {
	...
	_updateStateToUrl() {
		...
		t?.length && (e.actions = t), e.scaleDomains = rx(this.genomeSpy, (e) => e.isZoomed());
		let n = this.store.getState().viewSettings, r = this.genomeSpy.viewRoot;
		if (r) {
			let t = bn(r, n);
			t && (e.viewSettings = t);
		}
		let i = e.actions.length || Object.keys(e.scaleDomains).length || e.viewSettings ? _p(e) : "";
	...
	async #f(e) {
		let t = await e;
		if (t.length) return this.globalBookmarkDatabase ||= new wx(t, { baseUrl: qS(this.rootSpec) }), this.globalBookmarkDatabase;
	}
	getSampleView() {
		if (!this.genomeSpy?.viewRoot) return;
		let e;
		return this.genomeSpy.viewRoot.visit((t) => {
			if (t instanceof jg) return e = t, wt;
		}), e;
	}
};
function qS(e) {
...
async function XS(e, t, n = {}) {
	...
	let o, s, c = [];
	try {
		let e = nn(t) ? t : await le(t);
		e.baseUrl ??= "", e.padding ??= 10;
		let { plugins: r = [], ...i } = {
			powerPreference: "high-performance",
			...n
		};
		s = new KS(a, e, i), o = s.genomeSpy, c = await QS(s, r), ZS(o, i), await s.launch();
	} catch (e) {
	...
	return he({
		...
		finalize() {
			...
			s?.finalize(), o?.destroy(), o = void 0, a.replaceChildren();
		}
	});
}
function ZS(e, t) {
