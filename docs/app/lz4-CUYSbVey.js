...
var t = (typeof document < "u" && document.currentScript && document.currentScript.src, function(e = {}) {
	var t = e, n, r;
	t.ready = new Promise((e, t) => {
		n = e, r = t;
	});
	var i = Object.assign({}, t), a = t.printErr || console.error.bind(console);
	Object.assign(t, i), i = null;
	var o;
	t.wasmBinary && (o = t.wasmBinary), typeof WebAssembly != "object" && w("no native wasm support detected");
	var s, c = !1, l, u, d, f, p, m, h, g;
	function _() {
		var e = s.buffer;
		t.HEAP8 = l = new Int8Array(e), t.HEAP16 = d = new Int16Array(e), t.HEAPU8 = u = new Uint8Array(e), t.HEAPU16 = f = new Uint16Array(e), t.HEAP32 = p = new Int32Array(e), t.HEAPU32 = m = new Uint32Array(e), t.HEAPF32 = h = new Float32Array(e), t.HEAPF64 = g = new Float64Array(e);
	}
	var v = [], y = [], b = [];
	function ee() {
	...
	var x = 0, S = null, C = null;
	function w(e) {
		throw t.onAbort?.(e), e = "Aborted(" + e + ")", a(e), c = !0, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), r(e), e;
	}
	var te = (e) => e.startsWith("data:application/octet-stream;base64,"), ne = (e) => e.startsWith("file://"), T = "lz4_codec.wasm";
	if (!te(T)) {
		var re = T;
		T = t.locateFile ? t.locateFile(re, "") : "" + re;
	}
	function ie(e) {
		return Promise.resolve().then(() => {
			if (e == T && o) var t = new Uint8Array(o);
			else throw "both async and sync fetching of the wasm failed";
			return t;
		});
	}
	function ae(e, t, n) {
		return ie(e).then((e) => WebAssembly.instantiate(e, t)).then((e) => e).then(n, (e) => {
			a(`failed to asynchronously prepare wasm: ${e}`), w(e);
		});
	}
	function oe(e, t) {
		var n = T;
		return o || typeof WebAssembly.instantiateStreaming != "function" || te(n) || ne(n) || typeof fetch != "function" ? ae(n, e, t) : fetch(n, { credentials: "same-origin" }).then((r) => WebAssembly.instantiateStreaming(r, e).then(t, function(r) {
			return a(`wasm streaming compile failed: ${r}`), a("falling back to ArrayBuffer instantiation"), ae(n, e, t);
		}));
	}
	var E = (e) => {
	...
	function se(e) {
		this.D = e - 24, this.K = function(e) {
			m[this.D + 4 >> 2] = e;
		}, this.J = function(e) {
			m[this.D + 8 >> 2] = e;
		}, this.F = function(e, t) {
			this.G(), this.K(e), this.J(t);
		}, this.G = function() {
			m[this.D + 16 >> 2] = 0;
		};
	}
	var D = 0, ce = 0, O, k = (e) => {
		for (var t = ""; u[e];) t += O[u[e++]];
		return t;
	}, A = {}, j = {}, M = {}, N, le = (e) => {
		throw new N(e);
	}, P, ue = (e, t) => {
		function n(e) {
			if (e = t(e), e.length !== r.length) throw new P("Mismatched type converter count");
			for (var n = 0; n < r.length; ++n) F(r[n], e[n]);
		}
		var r = [];
		r.forEach(function(t) {
			M[t] = e;
		});
		var i = Array(e.length), a = [], o = 0;
		e.forEach((e, t) => {
			j.hasOwnProperty(e) ? i[t] = j[e] : (a.push(e), A.hasOwnProperty(e) || (A[e] = []), A[e].push(() => {
				i[t] = j[e], ++o, o === a.length && n(i);
			}));
		}), a.length === 0 && n(i);
	};
	function de(e, t, n = {}) {
		var r = t.name;
		if (!e) throw new N(`type "${r}" must have a positive integer typeid pointer`);
		if (j.hasOwnProperty(e)) {
			if (n.M) return;
			throw new N(`Cannot register type '${r}' twice`);
		}
		j[e] = t, delete M[e], A.hasOwnProperty(e) && (t = A[e], delete A[e], t.forEach((e) => e()));
	}
	function F(e, t, n = {}) {
	...
	}, V = (e, t) => Object.defineProperty(t, "name", { value: e }), pe = (e) => {
		for (; e.length;) {
			var t = e.pop();
			e.pop()(t);
		}
	...
	function H(e) {
		for (var t = 1; t < e.length; ++t) if (e[t] !== null && e[t].C === void 0) return !0;
		return !1;
	}
	function me(e) {
		var t = Function;
		if (!(t instanceof Function)) throw TypeError(`new_ called with constructor type ${typeof t} which is not a function`);
		var n = V(t.name || "unknownFunctionName", function() {});
		return n.prototype = t.prototype, n = new n(), e = t.apply(n, e), e instanceof Object ? e : n;
	}
	var he = (e, n) => {
		if (t[e].A === void 0) {
			var r = t[e];
			t[e] = function() {
				if (!t[e].A.hasOwnProperty(arguments.length)) throw new N(`Function '${n}' called with an invalid number of arguments (${arguments.length}) - expects one of (${t[e].A})!`);
				return t[e].A[arguments.length].apply(this, arguments);
			}, t[e].A = [], t[e].A[r.L] = r;
		}
	}, ge = (e, n, r) => {
		if (t.hasOwnProperty(e)) {
			if (r === void 0 || t[e].A !== void 0 && t[e].A[r] !== void 0) throw new N(`Cannot register public name '${e}' twice`);
			if (he(e, e), t.hasOwnProperty(r)) throw new N(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
			t[e].A[r] = n;
		} else t[e] = n, r !== void 0 && (t[e].O = r);
	}, _e = (e, t) => {
		for (var n = [], r = 0; r < e; r++) n.push(m[t + 4 * r >> 2]);
		return n;
	}, U, ve = (e, n) => {
		var r = [];
		return function() {
			if (r.length = 0, Object.assign(r, arguments), e.includes("j")) {
				var i = t["dynCall_" + e];
				i = r && r.length ? i.apply(null, [n].concat(r)) : i.call(null, n);
			} else i = U.get(n).apply(null, r);
			return i;
		};
	}, ye = (e, t) => {
		e = k(e);
		var n = e.includes("j") ? ve(e, t) : U.get(t);
		if (typeof n != "function") throw new N(`unknown function pointer with signature ${e}: ${t}`);
		return n;
	}, W, G = (e) => {
		e = Me(e);
		var t = k(e);
		...
		function n(e) {
			i[e] || j[e] || (M[e] ? M[e].forEach(n) : (r.push(e), i[e] = !0));
		}
		var r = [], i = {};
		throw t.forEach(n), new W(`${e}: ` + r.map(G).join([", "]));
	}, xe = (e) => {
		e = e.trim();
		let t = e.indexOf("(");
		...
		switch (t) {
			case 1: return n ? (e) => l[e >> 0] : (e) => u[e >> 0];
			case 2: return n ? (e) => d[e >> 1] : (e) => f[e >> 1];
			case 4: return n ? (e) => p[e >> 2] : (e) => m[e >> 2];
	...
	for (var K = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, q = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, we = (e, t) => {
		for (var n = e >> 1, r = n + t / 2; !(n >= r) && f[n];) ++n;
		if (n <<= 1, 32 < n - e && q) return q.decode(u.subarray(e, n));
		for (n = "", r = 0; !(r >= t / 2); ++r) {
			var i = d[e + 2 * r >> 1];
			if (i == 0) break;
		...
		for (var i = 0; i < n; ++i) d[t >> 1] = e.charCodeAt(i), t += 2;
		return d[t >> 1] = 0, t - r;
	}, Ee = (e) => 2 * e.length, De = (e, t) => {
		for (var n = 0, r = ""; !(n >= t / 4);) {
			var i = p[e + 4 * n >> 2];
			if (i == 0) break;
		...
		return t;
	}, Ae = Array(256), J = 0; 256 > J; ++J) Ae[J] = String.fromCharCode(J);
	O = Ae, N = t.BindingError = class extends Error {
		constructor(e) {
			super(e), this.name = "BindingError";
		}
	}, P = t.InternalError = class extends Error {
		constructor(e) {
		...
		has(e) {
			return this.B[e] !== void 0;
		},
		F(e) {
			var t = this.H.pop() || this.B.length;
			return this.B[t] = e, t;
		},
		G(e) {
			this.B[e] = void 0, this.H.push(e);
		}
	}), L.B.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), L.D = L.B.length, t.count_emval_handles = () => {
		for (var e = 0, t = L.D; t < L.B.length; ++t) L.B[t] !== void 0 && ++e;
		return e;
	}, W = t.UnboundTypeError = ((e, t) => {
		var n = V(t, function(e) {
			this.name = t, this.message = e, e = Error(e).stack, e !== void 0 && (this.stack = this.toString() + "\n" + e.replace(/^Error(:[^\n]*)?\n/, ""));
		});
	...
	var je = {
		...
		k: (e, t) => {
			t = k(t), F(e, {
				name: t,
				fromWireType: (e) => {
					if (!e) throw new N("Cannot use deleted val. handle = " + e);
					var t = L.get(e).value;
					return R(e), t;
				},
				toWireType: (e, t) => z(t),
		...
		d: (e, n, r, i, a, o, s) => {
			var c = _e(n, r);
			e = k(e), e = xe(e), a = ye(i, a), ge(e, function() {
				be(`Cannot call ${e} due to unbound types`, c);
			}, n - 1), ue(c, function(r) {
				var i = e, c = e;
				r = [r[0], null].concat(r.slice(1));
				var l = a, u = r.length;
				if (2 > u) throw new N("argTypes array size mismatch! Must at least get return value and 'this' types!");
				var d = r[1] !== null && !1, f = H(r), p = r[0].name !== "void";
				l = [
					le,
					l,
					o,
				...
				for (var m = 0; m < u - 2; ++m) l.push(r[m + 2]);
				if (!f) for (m = d ? 1 : 2; m < r.length; ++m) r[m].C !== null && l.push(r[m].C);
				f = H(r), m = r.length;
				var h = "", g = "";
				for (u = 0; u < m - 2; ++u) h += (u === 0 ? "" : ", ") + "arg" + u, g += (u === 0 ? "" : ", ") + "arg" + u + "Wired";
				h = `
        return function (${h}) {
        if (arguments.length !== ${m - 2}) {
          throwBindingError('function ${c} called with ' + arguments.length + ' arguments, expected ${m - 2}');
        }`, f && (h += "var destructors = [];\n");
				var _ = f ? "destructors" : "null", v = "throwBindingError invoker fn runDestructors retType classParam".split(" ");
				for (d && (h += "var thisWired = classParam['toWireType'](" + _ + ", this);\n"), u = 0; u < m - 2; ++u) h += "var arg" + u + "Wired = argType" + u + "['toWireType'](" + _ + ", arg" + u + "); // " + r[u + 2].name + "\n", v.push("argType" + u);
				if (d && (g = "thisWired" + (0 < g.length ? ", " : "") + g), h += (p || s ? "var rv = " : "") + "invoker(fn" + (0 < g.length ? ", " : "") + g + ");\n", f) h += "runDestructors(destructors);\n";
				else for (u = d ? 1 : 2; u < r.length; ++u) d = u === 1 ? "thisWired" : "arg" + (u - 2) + "Wired", r[u].C !== null && (h += d + "_dtor(" + d + "); // " + r[u].name + "\n", v.push(d + "_dtor"));
				p && (h += "var ret = retType['fromWireType'](rv);\nreturn ret;\n");
				let [y, b] = [v, h + "}\n"];
				if (y.push(b), r = me(y).apply(null, l), c = V(c, r), r = n - 1, !t.hasOwnProperty(i)) throw new P("Replacing nonexistant public symbol");
				return t[i].A !== void 0 && r !== void 0 ? t[i].A[r] = c : (t[i] = c, t[i].L = r), [];
			});
		},
		b: (e, t, n, r, i) => {
			if (t = k(t), i === -1 && (i = 4294967295), i = (e) => e, r === 0) {
				var a = 32 - 8 * n;
				i = (e) => e << a >>> a;
			}
			...
			F(e, {
				...
				toWireType: o,
				argPackAdvance: 8,
				readValueFromPointer: Se(t, n, r !== 0),
				C: null
			});
		},
		a: (e, t, n) => {
			function r(e) {
				return new i(l.buffer, m[e + 4 >> 2], m[e >> 2]);
			}
			var i = [
				Int8Array,
				Uint8Array,
		...
		e: (e, t) => {
			...
			F(e, {
					...
					if (n) for (var i = r, a = 0; a <= t; ++a) {
						...
						if (a == t || u[o] == 0) {
							if (i) {
								var s = i, c = u, l = s + (o - i);
								for (i = s; c[i] && !(i >= l);) ++i;
								if (16 < i - s && c.buffer && K) s = K.decode(c.subarray(s, i));
								else {
									for (l = ""; s < i;) {
										var d = c[s++];
										if (d & 128) {
											var f = c[s++] & 63;
											if ((d & 224) == 192) l += String.fromCharCode((d & 31) << 6 | f);
											else {
												var p = c[s++] & 63;
												d = (d & 240) == 224 ? (d & 15) << 12 | f << 6 | p : (d & 7) << 18 | f << 12 | p << 6 | c[s++] & 63, 65536 > d ? l += String.fromCharCode(d) : (d -= 65536, l += String.fromCharCode(55296 | d >> 10, 56320 | d & 1023));
											}
						...
						for (h = Array(t), a = 0; a < t; ++a) h[a] = String.fromCharCode(u[r + a]);
						h = h.join("");
					}
					return Z(e), h;
				},
				toWireType: function(e, t) {
					...
					if (!(i || t instanceof Uint8Array || t instanceof Uint8ClampedArray || t instanceof Int8Array)) throw new N("Cannot pass non-string to std::string");
					var a;
					if (n && i) for (r = a = 0; r < t.length; ++r) {
						var o = t.charCodeAt(r);
						127 >= o ? a++ : 2047 >= o ? a += 2 : 55296 <= o && 57343 >= o ? (a += 4, ++r) : a += 3;
					}
					else a = t.length;
					if (r = a, a = X(4 + r + 1), o = a + 4, m[a >> 2] = r, n && i) {
						if (i = o, o = r + 1, r = u, 0 < o) {
							o = i + o - 1;
					...
					} else if (i) for (i = 0; i < r; ++i) {
						if (s = t.charCodeAt(i), 255 < s) throw Z(o), new N("String has UTF-16 code units that do not fit in 8 bits");
						u[o + i] = s;
					}
					else for (i = 0; i < r; ++i) u[o + i] = t[i];
		...
		c: (e, t, n) => {
			if (n = k(n), t === 2) var r = we, i = Te, a = Ee, o = () => f, s = 1;
			else t === 4 && (r = De, i = Oe, a = ke, o = () => m, s = 2);
			F(e, {
				name: n,
				fromWireType: (e) => {
					for (var n = m[e >> 2], i = o(), a, c = e + 4, l = 0; l <= n; ++l) {
						var u = e + 4 + l * t;
				...
				toWireType: (e, r) => {
					if (typeof r != "string") throw new N(`Cannot pass non-string to C++ string type ${n}`);
					var o = a(r), c = X(4 + o + t);
					return m[c >> 2] = o >> s, i(r, c + 4, o + t), e !== null && e.push(Z, c), c;
				},
				argPackAdvance: 8,
				readValueFromPointer: B,
				C(e) {
		...
		f: (e, t) => {
			var n = j[e];
			if (n === void 0) throw e = "_emval_take_value has unknown type " + G(e), new N(e);
			return e = n, e = e.readValueFromPointer(t), z(e);
		},
		h: () => {
			w("");
		},
		q: (e, t, n) => u.copyWithin(e, t, t + n),
		p: (e) => {
			var t = u.length;
			...
			for (var n = 1; 4 >= n; n *= 2) {
				...
				r = Math.max(e, r);
				a: {
					i = (i.min.call(i, 2147483648, r + (65536 - r % 65536) % 65536) - s.buffer.byteLength + 65535) / 65536;
					try {
						s.grow(i), _();
						var a = 1;
						break a;
		...
		function e(e) {
			return Y = e.exports, s = Y.r, _(), U = Y.w, y.unshift(Y.s), x--, t.monitorRunDependencies?.(x), x == 0 && (S !== null && (clearInterval(S), S = null), C && (e = C, C = null, e())), Y;
		}
		var n = { a: je };
		if (x++, t.monitorRunDependencies?.(x), t.instantiateWasm) try {
			return t.instantiateWasm(n, e);
		} catch (e) {
			a(`Module.instantiateWasm callback failed with error: ${e}`), r(e);
		}
		return oe(n, function(t) {
			e(t.instance);
		}).catch(r), {};
	}(), X = (e) => (X = Y.t)(e), Z = (e) => (Z = Y.u)(e), Me = (e) => (Me = Y.v)(e), Q;
	C = function e() {
		Q || $(), Q || (C = e);
	};
	function $() {
		function e() {
			if (!Q && (Q = !0, t.calledRun = !0, !c)) {
				if (E(y), n(t), t.onRuntimeInitialized && t.onRuntimeInitialized(), t.postRun) for (typeof t.postRun == "function" && (t.postRun = [t.postRun]); t.postRun.length;) {
		...
		if (!(0 < x)) {
			if (t.preRun) for (typeof t.preRun == "function" && (t.preRun = [t.preRun]); t.preRun.length;) ee();
			E(v), 0 < x || (t.setStatus ? (t.setStatus("Running..."), setTimeout(function() {
				setTimeout(function() {
					t.setStatus("");
				}, 1), e();
			}, 1)) : e());
