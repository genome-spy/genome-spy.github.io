//#region ../core/src/rendering/canvasSizeHelper.js
var e = class {
	constructor(e, t, n, r) {
	...
	invalidate() {
		this._logicalCanvasSize = void 0;
	}
	finalize() {
	...
	getPhysicalCanvasSize(e) {
		...
		let t = window.devicePixelRatio ?? 1, n = this._devicePixelContentBoxSize;
		return n && n.logical.width == e.width && n.logical.height == e.height && n.dpr == t ? n.physical : {
	...
	_observeDevicePixelContentBox() {
		...
		let e = new ResizeObserver((e) => {
			...
			}, a = this._devicePixelContentBoxSize;
			this._devicePixelContentBoxSize = i, !(a && a.physical.width == i.physical.width && a.physical.height == i.physical.height && a.logical.width == i.logical.width && a.logical.height == i.logical.height && a.dpr == i.dpr) && this._onPhysicalSizeChange();
		});
		try {
