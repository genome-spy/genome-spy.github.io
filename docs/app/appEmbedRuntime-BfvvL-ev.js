...
import { $ as n, A as r, B as i, C as a, D as o, E as s, F as c, J as l, L as u, M as d, N as f, O as p, P as m, Q as h, R as g, S as _, T as v, U as y, W as b, X as x, Y as S, Z as C, _ as w, _t as T, a as E, b as D, bt as O, c as k, ct as A, d as ee, dt as j, et as M, f as te, ft as N, g as P, gt as F, h as ne, ht as I, i as re, j as ie, k as ae, l as oe, m as se, mt as L, n as ce, nt as le, o as ue, p as de, pt as fe, q as pe, r as me, rt as he, s as ge, tt as _e, u as ve, ut as ye, v as be, vt as R, w as xe, x as Se, xt as Ce, y as we, z as Te } from "./src-CIMk3rVN.js";
import { $t as Ee, At as De, B as Oe, Bt as ke, D as Ae, E as je, Et as Me, Ft as Ne, Gt as Pe, Hr as Fe, Ht as Ie, It as Le, J as Re, Jt as ze, Lr as Be, Lt as Ve, M as He, Mr as Ue, Nn as We, P as Ge, Ut as Ke, Vt as qe, Wt as Je, Y as Ye, _n as Xe, a as Ze, bt as Qe, c as $e, cr as et, dn as tt, en as nt, f as rt, h as it, ht as at, i as ot, kn as st, kr as ct, kt as lt, m as ut, mt as dt, n as ft, or as pt, p as mt, pt as ht, qt as gt, r as _t, s as vt, t as yt, v as bt, w as xt, xt as St, zr as Ct, zt as wt } from "./viewSelectors-BhW4mTR1.js";
import { a as Tt, i as Et } from "./clipOptions-Dqco1p8b.js";
import { w as Dt } from "./framebufferReadback-Bje9lHb7.js";
import { n as Ot, r as kt } from "./viewIdentityRegistry-AEQpJTDm.js";
import { n as At } from "./viewRenderingContext-HtpqwS_x.js";
import { a as jt, c as Mt, i as Nt, l as Pt, n as Ft, o as It, r as Lt, s as Rt, t as zt, u as Bt } from "./ref-ACl2UeMe.js";
import { $ as Vt, A as Ht, B as Ut, C as Wt, D as Gt, E as Kt, F as qt, G as Jt, H as Yt, I as Xt, J as Zt, K as Qt, L as $t, M as en, N as tn, O as nn, P as rn, Q as an, R as on, S as sn, T as cn, U as ln, V as un, W as dn, X as fn, Y as pn, Z as mn, _ as hn, _t as gn, a as _n, at as vn, b as yn, bt as bn, c as xn, ct as Sn, d as Cn, dt as wn, et as Tn, f as En, ft as Dn, g as On, gt as kn, h as An, ht as jn, i as Mn, it as Nn, j as Pn, k as Fn, l as In, lt as Ln, m as Rn, mt as zn, n as Bn, nt as Vn, o as Hn, ot as Un, p as Wn, pt as Gn, q as Kn, r as qn, rt as Jn, s as Yn, st as Xn, tt as Zn, u as Qn, ut as $n, v as er, vt as tr, w as nr, x as rr, xt as ir, y as ar, yt as or, z as sr } from "./agentApi-DyjqiiX_.js";
...
function fr(e) {
	return Math.max(1, Math.ceil(Math.log(fe(e)) / Math.LN2) + 1);
}
//#endregion
...
function pr() {
	...
	function r(r) {
		...
		if (!Array.isArray(f)) {
			let e = d, n = +f;
			if (t === N && ([u, d] = dr(u, d, n)), f = Ct(u, d, n), f[0] <= u && (s = Be(u, d, n)), f[f.length - 1] >= d) if (e >= d && t === N) {
				let e = Be(u, d, n);
		...
		} else for (i = 0; i < a; ++i) (o = c[i]) != null && u <= o && o <= d && g[Fe(f, o, 0, p)].push(r[i]);
		return g;
	}
...
`, kc = /* @__PURE__ */ new Set([
	...
	renderHeader() {
		return R`${this.dialogTitle ? R`${this.dialogTitle}` : I}`;
	}
	renderBody() {
		return R``;
	}
	...
	render() {
		...
		return R`
            ${this.modal ? I : R`<div class="non-modal-backdrop"></div>`}
            <dialog
                @cancel=${(e) => this.#a(e)}
            >
                ${e ? R`<header>${e}</header>` : I}
                <section>${this.renderBody()}</section>
                ${t ? R`<footer>${t}</footer>` : I}
            </dialog>
        `;
	}
};
	...
	renderBody() {
		if (this.type) {
			...
			return R`<div class="message-flex">
                ${e ? R`<div class="icon">${W(e).node[0]}</div>` : I}
	...
	renderBody() {
		return R`
			...
			this.transparentBackground = e.checked;
                        ...
                        Transparent</label
                    >
                    ${this.transparentBackground ? I : R`<input
                                  type="color"
                                  id="pngBackground"
...
`, Xc = class extends L {
	...
	#r = 0;
	constructor() {
		super(), this.values = [], this.thresholds = [], this.operators = [], this.colors = tl, this.showThresholdNumbers = !1, this.binCount = 40, this.#e = pr().thresholds(this.binCount), this.#t = this.#e([]), this.#n = St();
	}
	willUpdate(e) {
		e.has("binCount") && (this.#e = pr().thresholds(this.binCount)), (e.has("values") || e.has("binCount")) && (this.#t = this.#e(this.values), this.#n = St().domain(this.domain).range([0, 100]));
	}
	get domain() {
	...
	#o(e, t, n) {
		n = Ee(n, 0, 1), this.dispatchEvent(new Zc(e, t, +this.#n.invert(n * 100).toPrecision(3)));
	}
	#s() {
		...
		return R`<div class="histogram-widget">
			...
			return r >= 0 && r <= 100 ? R`<div
                              ...
                              >
                                  ...
                                  >
                                      ${this.showThresholdNumbers ? n + 1 : I}
                                  </div>
                              </div>` : I;
		})}
                </div>
...
function ul(e, t) {
	let n = e.scale?.type;
	dt(n) ? fl(e, t) : ht(n) || at(n) ? ml(e, t) : e.type === "identifier" ? dl(e, t) : q("Not implemented (yet).");
}
function dl(e, t) {
...
function fl(e, t) {
	let n = e.scale;
	pl(n.domain(), e, t, (e) => R`<span
            class="color"
            style=${h({ backgroundColor: n(e).toString() })}
        ></span>`);
}
function pl(e, t, n, r = (e) => I) {
...
var yl = class extends G {
	...
	#o() {
		...
		return e ? (t) => R`<span
                class="color"
                style=${h({ backgroundColor: e(t).toString() })}
            ></span>` : () => I;
	}
};
...
var Al = {
	...
	addMetadataFromSource: ({ template: e, payload: t }) => {
		let n = Array.isArray(t.columnIds) ? t.columnIds : [], r = t.sourceId ? R` from <strong>${t.sourceId}</strong> source` : "", i = n.length === 1 ? "attribute" : "attributes", a = n.length > 0 && n.length <= 3 ? kl(n) : R`<strong>${n.length}</strong> ${i}`;
		return {
			...e,
	...
	filterByNominal: ({ payload: e, template: t, attributeName: n, attributeTitle: r }) => {
		let i = e.values, a = (t) => R`
            ...
            ${i[0] === void 0 || i[0] === null ? R` undefined ${t} ` : R`${t}
                  ${i.length > 1 ? R`in ${Ol(i)}` : R`<span class="operator">=</span>
                            <strong>${i[0]}</strong>`} `}
        `;
		return {
			...t,
	...
	groupCustomCategories: ({ payload: e, template: t, attributeTitle: n }) => {
        ...
        ${n}.
        ${Cl(Object.entries(r), ([e, t], n) => R`${n > 0 ? ", " : ""}<strong>${e}</strong> =
                    ${Ol(t)}`)}`;
		return {
			...t,
	...
	removeGroup: ({ payload: e }) => ({
		...
		provenanceTitle: R`
            Remove group
            ${wl(e.path.map((e) => R`<strong>${e}</strong>`), " / ")}
        `,
		icon: br
	}),
...
function jl(e) {
	return e.operator === "in" ? R`in ${Ol(e.values)}` : R`
...
function Ml(e, t) {
	...
	let n = e.payload && typeof e.payload == "object" ? e.payload : {}, r = (e) => {
		if (!e) return {};
		try {
			let n = t(e), r = e && typeof e == "object" && "specifier" in e && typeof e.specifier == "string" ? R` <em>${e.specifier}</em> ` : void 0, i = n ? Tl(n) : r;
			return {
				attributeInfo: n,
				attributeName: i,
	...
	}, { attributeName: i, attributeTitle: a } = r("attribute" in n && n.attribute ? n.attribute : null), { attributeName: o, attributeTitle: s } = r("condition" in n && n.condition && typeof n.condition == "object" && "attribute" in n.condition ? n.condition.attribute : null), c = { attributeName: i }, l = e.type.substring(hn.length + 1), u = Al[l];
	return u ? u({
		payload: n,
		template: c,
		attributeName: i,
...
`, Pl = class extends G {
	...
	renderBody() {
		let e = this.attributeInfo, t = e.type == "identifier" ? "Identifier" : "Category", n = e.scale, r = n ? (e) => R`<span
                      class="color"
                      style=${h({ backgroundColor: n(e)?.toString() ?? "inherit" })}
                  ></span>` : () => I, i = fn((e) => e, this.groups), a = Object.keys(this.groups);
		return R`
            <div class="gs-alert info">
                ${W(Wr).node[0]}
                <span>
...
}, Sd, Cd = [], wd = A((e) => e(), 150, !1), Td = { type: "divider" };
function Ed(e) {
	if (e?.type == "contextmenu") {
		e.preventDefault();
		return;
	}
	Sd && (Sd.remove(), Sd = void 0, document.body.classList.remove(he), document.body.classList.remove(le));
}
function Dd(e) {
	if (!(e < 1)) {
...
var Od = () => R`<li class="menu-divider"></li>`, kd = (e) => R`
...
var Md = (e) => R`
	...
	Ed(), e.callback();
        ...
        >
            ...
            >
            ${e.shortcut ? R`<span class="kbd-shortcut">${e.shortcut}</span>` : I}
        </a>
...
function Id(e, t, n, r) {
	...
	i.classList.add("gs-context-menu"), i.style.top = "0", i.addEventListener("mouseenter", () => {
		wd(() => {});
	}), i.addEventListener("mouseup", (e) => e.stopPropagation()), i.addEventListener("click", (e) => e.stopPropagation()), F(e.map((e) => Pd(e, n)), i), Sd.appendChild(i), Dd(n), Cd[n] = i, r ??= "right-start";
...
function Rd() {
	...
	}, { once: !0 }), e.appendChild(Sd), document.body.classList.add(he), document.body.classList.add(le);
}
function zd(e, t, n) {
	n ??= "bottom-start", Sd && Ld !== t && Ed(), Ld = t, Sd ? F(e.items.map((e) => Pd(e, 0)), Cd[0]) : (Rd(), Id(e.items, t, 0, n));
}
function Bd(e, t) {
	...
	return c.push({
		...
		submenu: (() => {
			...
			if (s === "quantitative") {
				...
				remove: !0,
				values: [n]
			}), !1, void 0, R`Remove <strong>${n}</strong>`), Td);
		...
		submenu: (() => {
			...
			return s == "quantitative" ? e.push(l(i.groupToQuartiles({ attribute: a }), !1, void 0, "By quartiles"), {
				...
				label: "By thresholds...",
				callback: () => gl(t, r)
			}) : (s != "identifier" && e.push(l(i.groupByNominal({ attribute: a }), !1, void 0, R`By ${Tl(t)}`)), e.push({
				icon: Fr,
...
var rf = class {
	...
	feedback(e) {
		let t = this.error(e);
		return t ? R`<div class="invalid-feedback">${t}</div>` : I;
	}
	#e(e) {
...
}, af = n(class extends M {
	constructor(e) {
		if (super(e), e.type !== _e.ELEMENT) throw Error("formField must be used on an element part.");
...
var lf = /* @__PURE__ */ t(((e, t) => {
	...
	}, N = Ff(), P = Uf(), F = N.call(k, Array.prototype.concat), ne = N.call(O, Array.prototype.splice), I = N.call(k, String.prototype.replace), re = N.call(k, String.prototype.slice), ie = N.call(k, RegExp.prototype.exec), ae = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, oe = /\\(\\)?/g, se = function(e) {
	...
	t.exports = function(e, t) {
		...
		var n = se(e), r = n.length > 0 ? n[0] : "", i = L("%" + r + "%", t), a = i.name, o = i.value, s = !1, u = i.alias;
	...
	e.isWebAssemblyCompiledModule = le;
	function ue(e) {
		return m(e, l);
	}
	e.isNumberObject = ue;
	...
	e.isSymbolObject = me;
	function he(e) {
		return ue(e) || de(e) || fe(e) || pe(e) || me(e);
	}
	e.isBoxedPrimitive = he;
	function ge(e) {
		return typeof Uint8Array < "u" && (F(e) || ae(e));
	}
...
var Ep = class extends G {
	...
	renderButtons() {
		return this.plot ? [
			...
			this.makeButton("Save PNG", () => (Bn(this.renderRoot, this._api, this.plot.filename), !0), { iconDef: Xr }),
...
var Lp = class {
...
}, Rp = "SAMPLE_ATTRIBUTE", zp = class extends oe {
	#e;
	#t;
	#n = /* @__PURE__ */ new Map();
	#r = 0;
	#i = new Fp("Metadata readiness was aborted.");
	...
	constructor(e, t) {
		...
		}, this.#o = (e) => this.getAttributeInfo(e.specifier), this.#e.compositeAttributeInfoSource.addAttributeInfoSource(Rp, this.#o), this.registerDisposer(Ap(this.#e.provenance.store, (e) => e.provenance.present.sampleView.sampleMetadata, (e) => {
			this.#u(e);
	...
	handleContextMenu(e) {
		...
		if (i) {
			...
			r.push(...Wd(R`Attribute: <strong>${e}</strong>`, i, t, this.#e)), kp(r, i, this.#e);
		}
		Bd({ items: r }, e.mouseEvent);
	}
	async #u(e) {
		this.#t = e.entities;
		let t = this.context.dataFlow, n = ++this.#r, r = Ip(this.#i.reset());
		try {
	...
	#f(e, t, n) {
		let { graphicsPromises: r } = ie(this, e, t), i = this.flowHandle?.dataSource;
		if (!i) throw Error("Cannot find metadata data source handle!");
		return Te(r, () => n === this.#r), i;
	}
	#p(e) {
	...
	async #g() {
		...
		let e = Xt(this.getAttributeNames(), "/"), t = this.#e.sampleHierarchy.sampleMetadata.attributeDefs, n = async (e, r, i) => {
			for (let a of e.children.values()) if (a.children.size == 0) {
				...
				if (!(o instanceof y)) throw Error("Cannot find metadata foreground view for " + e);
				n.opacityFunction = (t) => t * this.#l(e), r.appendChild(n), this.#n.set(e, o);
				for (let t of n.getDescendants()) this.#a.set(t, e);
			} else {
				let e = t?.[a.path] ?? {}, o = `attributeGroup-${a.path}`, s = new oe({
					name: o,
					hconcat: [],
					configurableVisibility: !0,
					title: {
		...
		await n(e, this, {});
		for (let e of this.getDescendants()) e instanceof y && e.name.startsWith("title") && typeof e.spec.mark != "string" && (e.spec.mark.clip = "never");
		g(this);
	}
	getAttributeNames() {
	...
	dispose() {
		super.dispose(), this.#e.compositeAttributeInfoSource.removeAttributeInfoSource(Rp, this.#o), this._attributeHighlighState.abortController.abort();
	}
};
function Bp(e, t, n) {
...
function Gp(e) {
	return R`${dn(e, "/").map((e, t) => R`${t > 0 ? R` <span style="color: gray;">&rsaquo;</span> ` : ""}${e}`)}`;
}
function Kp(e) {
...
var Zp = { step: 24 }, Qp = class extends _ {
	#e = !0;
	constructor(e, t) {
		let n = {
			name: "sample-groups",
	...
	#o() {
		...
		return [null, ...this.sampleView.sampleHierarchy.groupMetadata].map((t) => {
			...
			return n ? Vt(n) ? n : (F(n, e), e.textContent.replace(/\s+/g, " ").trim()) : "unknown";
		});
	}
};
function $p(e, t, n) {
...
var om = class {
...
}, sm = 35, cm = 5, lm = 15, um = .2, dm = class {
	#e = 0;
	#t = 0;
	#n = 0;
	#r = void 0;
	...
	resetLocations() {
		this.#f = !0, this.#s = void 0, this.#c = void 0, this.#l = void 0, this.#p += 1, this.#m.baseVersion = -1;
	}
	reset() {
	...
	setScrollOffset(e) {
		let t = Math.max(0, this.#n - this.#u.getHeight());
		this.#t = Ee(e, 0, t);
	}
	getScrollableHeight() {
		return this.#n;
	...
	#g() {
		let e = this.#s.samples[0]?.locSize.size ?? 0;
		this.#u.onLocationUpdate({ sampleHeight: e });
	}
	togglePeek(e, t, n) {
		if (this.#e > 0 && this.#e < 1 || e !== void 0 && e == !!this.#e || !this.getLocations()) return Promise.resolve();
		let r = this.#u.viewContext, i = this.#u.getHeight(), a = {
			requestAnimationFrame: (e) => r.animator.requestTransition(e),
			onUpdate: (e) => {
				this.#e = e ** 2, this.#y(), r.animator.requestRender();
			},
			from: this.#e
		};
		if (this.#e == 0) {
			let e;
			if (n) e = ((e) => e.location + e.size / 2)(this.#l.samples.find((e) => e.key == n).locSize);
			else {
				let n = this.getSummaryAt(t);
				n && (e = this.#l.summaries[n.index].locSize.location - (n.location.locSize.location - t));
			}
			if (e ? this.#t = e - t : this.#t = (this.#n - i) / 2, this.#n > i) return Re({
				...a,
				to: 1,
				duration: 500,
				easingFunction: gr
	...
	getLocations() {
		if (this.#y()) return this.#s;
	}
	getGroupBackgroundRects(e) {
		let t = this.getLocations();
		if (!t) return [];
		let n = t.groups, r = n.map((e) => e.key.depth).reduce((e, t) => Math.max(e, t), 0), i = n.filter((e) => e.key.depth == r), a = this.#u.getSummaryHeight();
		e = e.flatten();
		let o = this.#u.isStickySummaries() && a > 0 ? e.shrink(new He(a, 0, 0, 0)) : e;
	...
	#_() {
		let e = this.#u.getSampleHierarchy().sampleData, t = e?.ids?.length ?? 0;
		this.#a = t;
		let n = Math.max(4, Math.ceil(t * 2 / 4) * 4);
		(!this.#i || this.#i.length !== n) && (this.#i = new Float32Array(n));
		let r = this.#u.getHeight(), i = this.#y();
		if (this.#h.baseVersion === this.#p && this.#h.height === r && this.#h.peekState === this.#e && this.#h.scrollOffset === this.#t && this.#h.sampleCount === t) return;
		let a = this.#i;
		a.fill(0);
		let o = e?.entities;
		if (i && o) {
			let e = this.#s.samples;
			for (let t of e) {
				let e = o[t.key].indexNumber;
				a[e * 2 + 0] = t.locSize.location / r, a[e * 2 + 1] = t.locSize.size / r;
			}
		}
		this.#o = !0, this.#h.baseVersion = this.#p, this.#h.height = r, this.#h.peekState = this.#e, this.#h.scrollOffset = this.#t, this.#h.sampleCount = t;
	}
	updateFacetTexture() {
		if (this.#_(), !this.#o && this.#r) return;
		let e = this.#u.viewContext.glHelper.gl;
		this.#r = x(e, {
			internalFormat: e.RG32F,
			format: e.RG,
			height: 1
		}, this.#i, this.#r), this.#o = !1;
	}
	getFacetTexture() {
		return this.#r;
	}
	getSampleFacetPosition(e) {
		if (this.#_(), !(!Number.isInteger(e) || e < 0 || e >= this.#a)) return {
			location: this.#i[e * 2],
			size: this.#i[e * 2 + 1]
		};
	}
	getSummaryAt(e) {
		let t = this.getLocations().summaries, n = t.findIndex((t) => ym(t.locSize, e));
		return n >= 0 ? {
			index: n,
			location: t[n]
		} : void 0;
	...
	clipBySummary(e) {
		if (this.#u.isStickySummaries()) {
			let t = this.#u.getSummaryHeight();
	...
	#v() {
		let e = this.#u.getHeight();
		if (!e) return !1;
		let t = this.#u.getSampleHierarchy(), n = this.#u.getSummaryHeight();
		if (!this.#f && this.#d.height === e && this.#d.summaryHeight === n && this.#d.sampleHierarchy === t) return !0;
		let r = ar(t), i = this.#u.sampleLayout ?? {}, a = hm(r, {
			viewHeight: e,
			groupSpacing: i.groupSpacing ?? cm,
			sampleSpacingFactor: i.sampleSpacingFactor ?? um,
			summaryHeight: n
		}), o = hm(r, {
			sampleHeight: i.sampleHeight ?? sm,
			groupSpacing: i.peekGroupSpacing ?? lm,
			sampleSpacingFactor: i.sampleSpacingFactor ?? um,
			summaryHeight: n
		});
		return this.#c = {
			fitted: a,
			scrollable: o
		}, this.#l = o, this.#n = o.summaries.map((e) => e.locSize.location + e.locSize.size).reduce((e, t) => Math.max(e, t), 0), this.setScrollOffset(this.#t), this.#d = {
			height: e,
			summaryHeight: n,
			sampleHierarchy: t
		}, this.#f = !1, this.#s = void 0, this.#p += 1, !0;
	}
	#y() {
		if (!this.#v()) return !1;
		this.#s || (this.#s = fm(this.#c.fitted), this.#m.baseVersion = -1);
		let e = this.#e, t = this.#t, n = this.#p, r = this.#m.baseVersion !== n, i = this.#m.peekState !== e, a = this.#m.scrollOffset !== t;
		return !r && !i && !a ? !0 : (pm(this.#s, this.#c, e, -t), this.#m.peekState = e, this.#m.scrollOffset = t, this.#m.baseVersion = n, (r || i) && this.#g(), !0);
	}
};
function fm(e) {
	let t = {
...
function pm(e, t, n, r) {
	...
	mm(e.samples, i.samples, a.samples, n, r), mm(e.summaries, i.summaries, a.summaries, n, r), mm(e.groups, i.groups, a.groups, n, r);
}
...
function hm(e, { viewHeight: t = 0, sampleHeight: n = 0, groupSpacing: r = 5, sampleSpacingFactor: i = um, summaryHeight: a = 0 }) {
	if (!t && !n) throw Error("viewHeight or sampleHeight must be provided!");
	let o = (e) => et(e), s = e.map((e) => ({
		path: e,
		sampleGroup: o(e),
		samples: o(e).samples
	...
	Oe(s.map((e) => c(e.samples)), t, { spacing: r }).forEach((e, t) => {
		l.push({
			key: s[t].path,
			locSize: e
		});
	...
	for (let [e, t] of s.entries()) {
		...
		Oe(r.map((e) => n), Math.max(0, l[e].locSize.size - a), { offset: l[e].locSize.location + a }).forEach((e, t) => {
			let { size: n, location: a } = e, o = n * i * .5 * nt(15, 22, n);
...
function gm(e, t) {
	return t.find((t) => ym(t.locSize, e));
}
function _m(e, t) {
	if (!t?.length || !Number.isFinite(e)) return;
	let n = gm(e, t);
	if (n) return n;
	let r = t[0], i = bm(e, r.locSize);
	for (let n = 1; n < t.length; n++) {
		let a = t[n], o = bm(e, a.locSize);
		o < i && (r = a, i = o);
	}
	return r;
}
function vm({ viewportHeight: e, scrollableHeight: t, scrollOffset: n, peekState: r, summaryHeight: i = 0 }) {
...
function bm(e, t) {
	return ym(t, e) ? 0 : e < t.location ? t.location - e : e - (t.location + t.size);
}
//#endregion
...
function Sm(e) {
	return e && (xe(e) || a(e)) && "aggregateSamples" in e;
}
//#endregion
//#region ../app/src/sampleView/datumLookup.js
function Cm(e, t = e.getCollector()) {
	let n = e.getDataAccessor("x"), r = e.getDataAccessor("x2"), i = e.getScaleResolution("x")?.getScale()?.type, a = i ? dt(i) : !1;
...
function jm(e, t) {
	...
	let d = (e) => e[t.field], f = t.featureFilter ? wm(t.featureFilter) : () => !0, p, m = () => {
		if (!p) {
			let e = u();
	...
	return (e) => {
		...
		switch (Jn(r, o, c, s, t, n, (e, t) => {
			...
			case "count": return km(i);
			case "min": return Tm(i);
			case "max": return Em(i);
			case "weightedMean": return Dm(i, l);
			case "variance": return Om(i, l);
...
function Mm(e, t) {
	...
	if (r) {
		let e = t.every(pe) ? r.toContinuousInterval(t) : t;
...
function Pm(e, t) {
	return typeof t == "string" ? zm(e, t) : Rm(e, t);
}
function Fm(e) {
...
function Rm(e, t) {
	let n = mt(e, t);
	if (!n) throw Error("Cannot resolve view selector: " + Lm(t));
	return n;
}
function zm(e, t) {
	let n = [];
...
function Vm(e, t) {
	return !Um(e, t.param) || !Array.isArray(t.scope) || t.scope.length === 0 ? t.param : t.scope.join("/") + "/" + t.param;
}
function Hm(e, t) {
...
function Gm(e, t) {
	let n = t.specifier, r = Pm(e, n.view), i = Bm(e, r, String(r.getTitleText() ?? r.name)), a = "aggregation" in n ? Ht(n.aggregation.op, n.field, n.featureFilter) : n.field, o = "aggregation" in n ? Km(n.aggregation.op, n.field, n.featureFilter) : R`<em class="attribute">${n.field}</em>`, s = "aggregation" in n ? Km(n.aggregation.op, n.field, n.featureFilter) : R`<em class="attribute">${n.field}</em>`, c = jm(r, n), l = An(c), u = (e) => {
	...
	return {
		...
		title: R`${s}
            ...
            ${(() => {
			if (Un(n)) {
				if (Xn(n.interval)) return R`in
                    <span class="interval"
                        >${Mm(r, n.interval)}</span
                    >`;
				if (vn(n.interval)) return R`in
                    <span class="interval"
                        >selection <strong>${Vm(e, n.interval.selector)}</strong></span
                    >`;
...
function Km(e, t, n) {
	if (e === "itemCount") {
		let t = n ? R`(where ${qm(n)})` : "";
		return R`${Pn(e)}${t}`;
	}
	if (e === "count") {
		let r = n ? R` where ${qm(n)}` : "";
		return R`${Pn(e)}(<em class="attribute"
                >${t}</em
            >${r})`;
	}
	let r = n ? R` where ${qm(n)}` : "";
	return R`${en(e)}(<em class="attribute">${t}</em
        >${r})`;
}
function qm(e) {
	return e.operator === "in" ? R`<em class="attribute">${e.field}</em> in
            {${Cl(e.values, (e, t) => R`${t > 0 ? ", " : ""}<strong
                            >${rn(e)}</strong
...
function Jm(e) {
	return pe(e) || typeof e == "number" ? l(e) : String(e);
}
//#endregion
//#region ../app/src/sampleView/sampleLabelView.js
var Ym = "SAMPLE_NAME", Xm = "_indexNumber", Zm = "_labelWidth", Qm = "_labelTitle", $m = "_labelTitleWidth", eh = Object.freeze({
	name: "sample",
	...
	#r = [];
	constructor(e, t) {
		super(nh(e.spec.samples, e.spec.metadata), e.context, t, t, "metadata-sample-label"), this.#e = e, this.#t = e.spec.samples.labelLength == null, this.#n = () => eh, e.compositeAttributeInfoSource.addAttributeInfoSource(Ym, this.#n), this.addInteractionListener("contextmenu", this.handleContextMenu.bind(this)), this.registerDisposer(Ap(e.provenance.store, (e) => e.provenance.present.sampleView.sampleData, (e) => {
	...
	handleContextMenu(e) {
		...
		n.push(...Wd(R`Sample: <strong>${t.displayName}</strong>`, eh, t.id, this.#e)), Bd({ items: n }, e.mouseEvent);
	}
	dispose() {
		super.dispose(), this.#e.compositeAttributeInfoSource.removeAttributeInfoSource(Ym, this.#n);
	}
};
function nh(e, t) {
	let n = ih(e), r = {
...
function rh(e) {
	...
	return e.visitData((e) => {
		t = Math.max(t, Number(e[Zm]) || 0, Number(e[$m]) || 0);
	}), Math.ceil(t);
}
function ih(e) {
...
var ah = "The samples.data, samples.attributeGroupSeparator, and samples.attributes properties are deprecated. Use metadata.sources instead.", oh = "samples.metadataSources is deprecated. Use metadata.sources instead.", sh = "Metadata layout properties under samples are deprecated. Use metadata layout properties instead.", ch = "samples.labelTitleText is deprecated. Use samples.labelTitle instead.";
function lh(e) {
...
function fh(e) {
	let t = e.data;
	if (!lh(t)) throw Error("Legacy samples.data must be UrlData or InlineData when mapping to metadata.sources.");
	let n = {
		initialLoad: "*",
...
function ph(e) {
	let t = e.samples ?? {}, n = e.metadata ?? {}, r = [], i = n.sources !== void 0, a = t.metadataSources !== void 0, o = uh(t);
	...
	let s = dh(t), c = Object.keys(s).length > 0, l = { ...t }, u = { ...n }, d = !1;
	return t.labelTitleText !== void 0 && t.labelTitle === void 0 && (l.labelTitle = t.labelTitleText, d = !0, r.push(ch)), o ? (l.identity = t.identity ?? {
		data: t.data,
		idField: "sample",
		displayNameField: "displayName"
	}, u.sources = [fh(t)], d = !0, r.push(ah)) : a && (u.sources = t.metadataSources, d = !0, r.push(oh)), c && (Object.assign(u, s, n), d = !0, r.push(sh)), d ? {
		spec: {
			...e,
			samples: l,
			metadata: u
...
customElements.define("gs-custom-select", _h);
var vh = class extends Event {
	value;
	option;
	constructor(e, t) {
		super("change", {
...
function Ch(e, t, n, r) {
	...
	let c = [s[0] ?? a, s[s.length - 1] ?? o], l = bh(r), u = Array.isArray(t) ? [...t] : [];
	if (u.length < l) {
...
function Eh(e) {
	...
	if (e.scaleType && (t.type = e.scaleType), e.domainMid != null && (t.domainMid = e.domainMid), e.colorMode === "scheme") return e.scheme && (t.scheme = e.scheme), e.domainMode === "explicit" && (t.domain = e.quantDomain), Oh(t);
	let n = bh(e.domainMid);
	if (e.quantRange.length !== n) return null;
	if (e.domainMode === "explicit") {
		if (e.quantDomain.length !== 2) return null;
		t.domain = e.quantDomain;
	}
	return t.range = e.quantRange, Oh(t);
}
function Dh(e) {
	let t = {};
	return e.colorMode === "scheme" ? (e.scheme && (t.scheme = e.scheme), e.domainMode === "explicit" && (t.domain = e.domainPairs.map((e) => e.domain)), Oh(t)) : e.domainMode === "explicit" ? (t.domain = e.domainPairs.map((e) => e.domain), t.range = e.domainPairs.map((e) => e.range), Oh(t)) : null;
}
function Oh(e) {
...
var kh = class extends G {
	...
	#e() {
		let e = Sh(this.scale, this.dataType, this.observedDomain, {
			scheme: this.scheme,
	...
	#l() {
		...
		let e = Ch(this.quantDomain, this.quantRange, this.observedDomain, this.domainMid);
	...
	#u() {
		let e = wh(this.thresholds, this.thresholdRange);
		...
		return R`
            <div class="gs-form-group">
                ...
                <gs-custom-select
                    ...
                    .value=${this.scheme}
                    .getLabel=${(e) => e || "Auto"}
                    .renderOption=${(e) => e ? R`<img src=${hh(e)} />
...
customElements.define("gs-configure-scale-dialog", kh);
//#endregion
...
var Ah = class extends L {
	...
	render() {
		...
		let e = Gt(this.attributeInfo), t = this._scaleConfigured && this._scale ? jh(this._scale) : "Auto";
		return R`
            <div class="gs-alert info">
                ${W(Er).node[0]}
                <div>
	...
	getConfig() {
		return this._form.validateAll() ? null : {
			...
			...this._scaleConfigured ? this._scale && Mh(this._scale) ? { scale: this._scale } : { scale: null } : {}
		};
	}
	async #e() {
		if (!this.attributeInfo || !this.values) throw Error("Scale configuration requires attribute data.");
		let e = Gt(this.attributeInfo), t = this.#t(), n = await K("gs-configure-scale-dialog", (n) => {
	...
	#t() {
		...
		return this._observedDomain ||= gh(Gt(this.attributeInfo), this.values), this._observedDomain;
	}
	#n() {
		return Fn(this.attributeName, this.groupPath, this.existingAttributeNames, this.attributeInfo);
	}
};
customElements.define("gs-derived-metadata-configurator", Ah);
function jh(e) {
	if (!e) return R`Auto`;
	let t = [];
	if (e.scheme) {
...
customElements.define("gs-derived-metadata-dialog", Nh);
function Ph({ attributeInfo: e, values: t, existingAttributeNames: n, defaultName: r }) {
...
var Ih = class {
	...
	#e;
	constructor() {
		super(), this.fieldInfo = null, this.aggregationFieldInfos = [], this.selectionIntervalComplex = null, this.selectionIntervalSource = null, this.aggregation = "count", this.aggregationField = "", this.filterField = "", this.operator = "in", this.operand = void 0, this.selectedValues = [], this._filterFieldValues = [], this.sampleHierarchy = null, this.attributeInfoSource = null, this.attributeType = null, this.sampleView = null, this._page = 0, this._attributeInfo = null, this._values = null, this._attributeName = "", this._metadataConfigHasErrors = !1, this.dialogTitle = "Create sample metadata from features", this.#e = new Ih(this, [{
			render: () => this.#t(),
			canAdvance: () => this.#v(),
			onAdvance: () => this.#b()
		}, {
	...
	#d() {
		return this.#f() ? this.filterField + " " + tn(this.operator) + " " + (sl(this.operand) ? String(this.operand) : "...") : this.selectedValues.length === 0 ? this.filterField + " in {...}" : this.filterField + " in {" + this.selectedValues.map(String).join(", ") + "}";
	}
	#f() {
	...
	#C() {
		...
		return Array.from(new Set(e.filter(zh))).map((e) => ({
			value: e,
			label: `${e}`,
			searchText: `${e}`.toLowerCase()
		}));
...
customElements.define("gs-feature-filtered-aggregation-dialog", Lh);
async function Rh({ fieldInfo: e, aggregationFieldInfos: t, selectionIntervalComplex: n, selectionIntervalSource: r, sampleHierarchy: i, attributeInfoSource: a, attributeType: o, sampleView: s }) {
...
function Uh(e, t, n) {
	let r = Im(t), i = qh(e).filter((e) => Xh(e.view, r));
	if (n) try {
		let t = [];
		e.visit((e) => {
			e instanceof y && e.isVisible() && Xh(e, r) && t.push(e);
		});
		for (let e of t) {
			...
			n && !r && i.push({
				...
				type: "nominal",
				description: void 0,
				supportedAggregations: Vh,
				candidateId: tg(Nm(e), "Items")
			});
		}
	} catch {}
	return n || (i = i.filter(Zh)), $h(i.map((e) => {
		let t = e.viewSelector ?? Nm(e.view);
		return {
			view: e.view,
			viewSelector: t,
			...
			supportedAggregations: e.supportedAggregations ?? Qh(e.type),
			candidateId: e.candidateId ?? tg(t, e.field),
			filterableFields: e.filterableFields ?? Gh(e.view)
		};
	}));
}
var Wh = Uh;
function Gh(e) {
	return eg(qh(e).map((e) => ({
		channel: e.channel,
		field: e.field,
		type: e.type,
		description: e.description
...
function Kh(e, t) {
	let n = Im(t);
	return Array.from(new Set(qh(e).filter((e) => !Xh(e.view, n)).filter(Zh).map((e) => e.view)));
}
function qh(e) {
	try {
		return i(e).filter((e) => ![
			...
			...e,
			description: Yh(e.view, e.channel, e.field)
		}));
	} catch {
		return Jh(e);
	}
...
var ng = "SAMPLE_ATTRIBUTE";
function rg(e, t, n) {
	let r = e.getAxisResolution("x")?.getTitle();
	return t.type === "locus" ? "Locus: " + (pe(n) || typeof n == "number" ? l(n) : String(n)) : (r ? r + ": " : "") + n;
}
function ig(e, t) {
	if (!e || !t || e.selection.intervals.x?.length !== 2 || !ze(e.selection, t)) return {};
	...
	return {
		...
		selectionIntervalLabel: Mm(e.view, r)
	};
}
function ag({ fieldInfo: e, aggregationFieldInfos: t, selectionIntervalComplex: n, selectionIntervalSource: r, sample: i, sampleHierarchy: a, attributeInfoSource: o, attributeType: s, sampleView: c }) {
	...
	return [
		...
		...e.supportedAggregations.map((t) => {
			let l = qt(t), u = t === "itemCount" ? R`Using ${l.label.toLowerCase()} over interval...` : R`Using ${l.label.toLowerCase()}(<em
                              class="attribute"
                              >${e.field}</em
                          >) over interval...`, d = r ? {
				view: e.viewSelector,
...
function og({ fieldInfo: e, complexX: t, sample: n, sampleHierarchy: r, attributeInfoSource: i, attributeType: a, sampleView: o }) {
	let s = {
		view: e.viewSelector,
		field: e.field,
		locus: t
...
function cg(e, t, n, r) {
	let i = t.attribute.type !== ng, a = t.type === "quantitative" || t.type === "nominal" || t.type === "ordinal";
	!i && !a || (e.push(Td), sg(e, t, n, r), kp(e, t, r, { includeDivider: !1 }));
}
//#endregion
//#region ../app/src/state/selectionExpansionContext.js
var lg = "multiplePointSelectionParams";
function ug(e, t) {
...
function dg(e) {
	let { hoveredView: t, hoveredDatum: n, selector: r, originViewSelector: i, originKeyFields: a, originKeyTuple: o, defaultPartitionBy: s, defaultScopeLabel: c } = e, l = /* @__PURE__ */ new Set([...a, ...s ?? []]), u = fg(t), d = pg(t, n, l), f = mg(n, l).filter((e) => !u.has(e)), p = [...d];
	for (let e of f) p.includes(e) || p.push(e);
	let m = [];
	for (let e of p) {
		let t = n[e], a = gg(t), l = _g(c), u = vg(c), d = [];
		d.push({
			label: "In " + l,
			payload: {
				selector: r,
...
function pg(e, t, n) {
	let r = e.getEncoding(), i = [], a = /* @__PURE__ */ new Set(), o = (e) => {
		if (!e || typeof e != "object" || Array.isArray(e)) return;
		let r = e;
		if (typeof r.field == "string" && (r.type === "nominal" || r.type === "ordinal") && !a.has(r.field) && hg(r.field, t, n) && (a.add(r.field), i.push(r.field)), "condition" in r) {
			let { condition: e } = r;
...
function mg(e, t) {
	return Object.keys(e).filter((n) => hg(n, e, t));
}
function hg(e, t, n) {
...
var yg = bn({
	...
	reducers: {
		paramChange: (e, t) => {
			let n = vt(t.payload.selector);
			e.entries[n] = t.payload;
		},
		expandPointSelection: (e, t) => {
			let n = t.payload, r = vt(n.selector), i;
...
function bg(e) {
	if (yg.actions.expandPointSelection.match(e) || !yg.actions.paramChange.match(e)) return null;
	let t = e.payload, n = t?.selector;
	return !n || !Array.isArray(n.scope) || !n.param || t?.value?.type === "pointExpand" ? null : vt(n);
}
//#endregion
...
function Sg(e, t) {
	...
	for (let e of n) {
		let n = Cg(e.fieldName, e.valueLabel);
		if (e.operations.length === 1) {
			let i = e.operations[0];
			r.push({
				label: n,
				callback: () => t(yg.actions.expandPointSelection(i.payload))
			});
			continue;
		}
		r.push({
			...
			submenu: () => {
				...
				for (let n of e.operations) r.push({
					label: n.label,
					callback: () => t(yg.actions.expandPointSelection(n.payload))
				});
				return r;
			}
		});
...
var wg = 60, Tg = "all", Eg = 1e-6, Dg = class {
	#e;
	#t;
	#n;
	constructor(e = {}) {
	...
	getHorizontalReserve(e) {
		return new He(0, this.getRightReserve(e), 0, this.getLeftReserve(e));
	}
	...
	#a(e) {
		...
		let t = this.#e?.minSampleHeight ?? wg;
		return e?.samples.some((e) => e.locSize.size >= t) ?? !1;
	}
	#o(e) {
		let t = this.#e?.minSampleHeight ?? wg, n = e.samples.filter((e) => e.locSize.size >= t);
		switch (this.#e?.mode ?? Tg) {
			case "all": return n;
...
}, Og = "VALUE_AT_LOCUS", kg = class extends Ot {
	childCoords;
	sidebarCoords;
	locationManager;
	#e = 0;
	...
	constructor(e, t, n, r, i, a, o, s = void 0) {
		...
		this.spec = c.spec, this.#i = e.stickySummaries ?? !0, this.#w(), this.#g(), this.#C(), this.#h(), this.#T(o), this.#E(), this.#s = this.paramRuntime.allocateSetter("visibleSamples", []), this.#l = this.paramRuntime.allocateSetter("visibleSampleMetadata", Ng(this.sampleHierarchy, [])), this.getSamples = () => sn(this.sampleHierarchy), this.spec.samples.identity?.data && this.#A();
	}
	#h() {
		let e = Wt;
		this.compositeAttributeInfoSource.addAttributeInfoSource(Og, (e) => Gm(this, e));
	...
	async awaitViewAttributeProcessed(e, t = {}) {
		let n = this.#y(e);
		await this.#v(n, t.signal, ge(n, ["x"]));
	}
	awaitMetadataReady(e) {
	...
	#w() {
		this.compositeAttributeInfoSource = new om(), this.childCoords = At.ZERO, this.sidebarCoords = At.ZERO, this.locationManager = new dm({
	...
	async initializeChildren() {
		...
		this.#t = new jg(n, this, 0, t, this.spec.view), this.#o = (e) => {
			...
			spacing: 8,
			padding: { right: 8 }
		}, this, this, "sample-sidebar"), $e(this.#n, { skipSubtree: !0 }), this.sampleGroupView = new Qp(this, this.#n), this.sampleLabelView = new th(this, this.#n), this.metadataView = new zp(this, this.#n), this.#n.setChildren([
		...
		this.#n.addInteractionListener("wheel", r, !0), this.#n.addInteractionListener("mousedown", r, !0), this.#n.addInteractionListener("touchgesture", r, !0), this.#t.scrollbars.vertical = new w(this.#t, "vertical", { onViewportOffsetChange: (e) => {
		...
		}, p(this), s(this), o(this), await this.#t.syncGuideViews(), await this.#W(), p(this), s(this), o(this), await this.#t.summaryViews.syncGuideViews(), await this.#t.syncGuideViews(), await this.sampleGroupView.initializeChildren(), await this.metadataView.initializeChildren(), this.#t.view.addInteractionListener("contextmenu", this.#V.bind(this));
	}
	getOverhang() {
		let e = this.#D().px ?? 0, t = this.locationManager.getLocations(), n = this.#t.sampleChromeLayout.getHorizontalReserve(t).add(new He(0, 0, 0, e)), r = this.#O();
	...
	#O() {
		let e = this.#t.getOverhangWithoutYAxes(), t = this.#n.isConfiguredVisible() ? this.#n.getOverhang().getVertical() : He.zero();
		return {
			sampleOverhang: e,
	...
	*[Symbol.iterator]() {
	...
	#A() {
		...
		let { dataSource: t, collector: n } = f(m(e.data, this), new Ag(e.idField ?? "sample", e.displayNameField)), r = n.observe(() => {
			let e = n.getData();
	...
	#j() {
		...
		Mg(e, this.#c) || (this.#c = e, this.#s(e));
	}
	#M() {
		this.#l && this.#l(Ng(this.sampleHierarchy, this.leafSamples));
	}
	getSampleAt(e) {
		let t = gm(e, this.locationManager.getLocations().samples);
	...
	#P(e, t, n = {}) {
		let r = this.#t, i = n, a = () => {
			ee(r.legends, r.axes, t, e, i, (e, t, n) => n(), 0), r.renderTitle(e, t, i);
		...
		let s = Et(this.locationManager.clipBySummary(t), !0, !0), c = this.locationManager.getLocations();
		if (!c) {
			a();
			return;
		}
		...
		for (let [r, i] of c.summaries.entries()) {
			let a = t.modify({
				y: () => {
					...
					return this.#i ? n + Ee(-e, 0, i.locSize.size - m) : n;
				},
				height: m
			}).expand(p);
			f.render(e, a, {
	...
	render(e, t, n = {}) {
		...
		let i = Oe([this.#D(), { grow: 1 }], t.width), a = (e) => t.modify({
			x: e.location + t.x,
			width: e.size
		});
	...
	getSampleFacetPosition(e) {
		return this.locationManager.getSampleFacetPosition(e);
	}
	...
	#F(e) {
		...
		let t = this.locationManager.getLocations().samples, n = _m(e, t);
	...
	#z() {
		...
		for (let t of e) for (let [e, n] of t.paramRuntime.paramConfigs) {
			...
			let r = Ne(n.select);
			if (!Ie(r) || !r.encodings?.includes("x")) continue;
	...
	#V(e) {
		let t = e.uiEvent, n = this.getLayoutAncestors().at(-1), r = this.childCoords.normalizePoint(e.point.x, e.point.y).x, i = this.findSampleForMouseEvent(e), a = this.#t.view, o = a.getScaleResolution("x"), s = o.invertToComplex(r), c = this.#z(), { selectionInterval: l, selectionIntervalComplex: u, selectionIntervalLabel: d } = ig(c, c ? this.#B(c.view, e) : void 0), f;
		if (c && c.bookmarkable) try {
			let e = _t(c.view, c.paramName);
			rt(this, e), f = {
				type: "selection",
				selector: e
			};
		...
		let p = Wh(a, n, !!l), m = l ? [] : Kh(a, n), h = [
			this.makePeekMenuItem(e.point.y - this.childCoords.y, i?.id),
			Td,
			{
				label: d ? `Interval: ${d}` : rg(a, o, s),
				type: "header"
			},
			Td
		], g = ug(this, this.context.getCurrentHover()), _;
		...
		for (let [e, t] of p.entries()) {
			...
			let r = p[e + 1];
			_ && !x && t.view === _.hoveredView && (!r || r.view !== t.view) && (h.push(xg(_, (e) => this.intentExecutor.dispatch(e))), x = !0);
		}
		_ && !x && (h.at(-1)?.type !== "divider" && h.push(Td), h.push({
			label: S(_.hoveredView),
			type: "header"
		}), h.push(xg(_, (e) => this.intentExecutor.dispatch(e))));
	...
	propagateInteraction(e) {
		we(this, e, () => {
			...
			for (let t of Object.values(this.#t.scrollbars)) if (D(e, () => t.coords.containsPoint(e.point.x, e.point.y), () => t.propagateInteraction(e)), e.stopped) return;
			n ? D(e, () => !0, () => this.#t.view.propagateInteraction(e), () => be(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator)) : r && be(e, t, (e) => this.#U(t, this.#t.view, e), this.context.getCurrentHover(), this.context.animator), !e.stopped && D(e, () => this.sidebarCoords.containsPoint(e.point.x, e.point.y), () => this.#n.propagateInteraction(e));
		});
	}
	#U(e, t, n) {
	...
	async #W() {
		...
		for (let t of this.#t.view.getDescendants()) {
			let n = t.spec;
			if (Sm(n)) for (let r of n.aggregateSamples) {
	...
	constructor(e, t, n, r, i) {
		super(e, t, n), this.groupBackground = void 0, this.groupBackgroundStroke = void 0, this.sampleChromeLayout = new Dg({
		...
		let a = de(i);
		a && (this.groupBackground = new y(a, t.context, t, e, "sample-group-background-" + n), $e(this.groupBackground, { skipSubtree: !0 }));
		let o = se(i);
		o && (this.groupBackgroundStroke = new y(o, t.context, t, e, "sample-group-background-stroke-" + n), $e(this.groupBackgroundStroke, { skipSubtree: !0 })), this.summaryViews = r;
	}
	allowDuplicateAxes() {
		return !0;
	}
	async syncGuideViews() {
		let e = ne(this.summaryViews), t = new Set(e);
		if (await super.syncGuideViews({
			legendOwners: [...ne(this.view), ...e],
			legendFilter: (e, n) => !t.has(n) || !P(e)
	...
	getOverhangWithoutYAxes() {
		let e = (e) => Se(this.axes[e]), t = new He(0, e("right"), 0, e("left"));
...
function Ng(e, t, n = "", r = /* @__PURE__ */ new Map()) {
	...
	return new Proxy({}, { get(a, c) {
		...
		let l = n ? n + "/" + c : c;
		return i.includes(l) ? s(l) : o(l) ? Ng(e, t, l, r) : Pg;
	} });
}
var Pg = new Proxy([], { get(e, t, n) {
	return t in e || typeof t != "string" ? Reflect.get(e, t, n) : Pg;
} }), Fg = (e, t) => t.some((t) => e instanceof t), Ig, Lg;
function Rg() {
	return Ig ||= [
		IDBDatabase,
		IDBObjectStore,
...
var Bg = /* @__PURE__ */ new WeakMap(), Vg = /* @__PURE__ */ new WeakMap(), Hg = /* @__PURE__ */ new WeakMap(), Ug = /* @__PURE__ */ new WeakMap(), Wg = /* @__PURE__ */ new WeakMap();
function Gg(e) {
	...
	return t.then((t) => {
		t instanceof IDBCursor && Bg.set(t, e);
	}).catch(() => {}), Wg.set(t, e), t;
}
function Kg(e) {
	if (Vg.has(e)) return;
...
function Yg(e) {
	return e === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(t, ...n) {
		let r = e.call(Qg(this), t, ...n);
		return Hg.set(r, t.sort ? t.sort() : [t]), Zg(r);
	} : zg().includes(e) ? function(...t) {
		return e.apply(Qg(this), t), Zg(Bg.get(this));
	} : function(...t) {
		return Zg(e.apply(Qg(this), t));
	};
}
function Xg(e) {
	return typeof e == "function" ? Yg(e) : (e instanceof IDBTransaction && Kg(e), Fg(e, Rg()) ? new Proxy(e, qg) : e);
}
function Zg(e) {
	if (e instanceof IDBRequest) return Gg(e);
	if (Ug.has(e)) return Ug.get(e);
	let t = Xg(e);
	return t !== e && (Ug.set(e, t), Wg.set(t, e)), t;
}
var Qg = (e) => Wg.get(e);
//#endregion
//#region ../../node_modules/idb/build/index.js
function $g(e, t, { blocked: n, upgrade: r, blocking: i, terminated: a } = {}) {
	let o = indexedDB.open(e, t), s = Zg(o);
	return r && o.addEventListener("upgradeneeded", (e) => {
		r(Zg(o.result), e.oldVersion, e.newVersion, Zg(o.transaction), e);
...
function r_(e, t) {
	...
	if (n_.get(t)) return n_.get(t);
	let n = t.replace(/FromIndex$/, ""), r = t !== n, i = t_.includes(n);
...
Jg((e) => ({
	...e,
	get: (t, n, r) => r_(t, n) || e.get(t, n, r),
	has: (t, n) => !!r_(t, n) || e.has(t, n)
}));
//#endregion
...
var i_ = class {
...
}, a_ = "bookmarks", o_ = class extends i_ {
	constructor(e) {
	...
	async _getDB() {
		if (!this._db) {
			...
			this._db = $g(e, 1, {
				upgrade(e, t, n, r) {
					e.createObjectStore(a_, { keyPath: "name" });
				},
				blocked() {},
				blocking() {},
				terminated() {}
	...
	async put(e, t) {
		let n = (await this._getDB()).transaction(a_, "readwrite");
		try {
	...
	async delete(e) {
		(await this._getDB()).delete(a_, e);
	}
	async getNames() {
		return (await this._getDB()).getAllKeys(a_);
	}
	async get(e) {
		return (await this._getDB()).get(a_, e);
	}
}, s_ = {}, c_ = n(class extends M {
	constructor() {
		super(...arguments), this.ot = s_;
	}
	render(e, t) {
		return t();
	}
	...
	constructor() {
		super(), this.inputRef = zt(), this.app = void 0, this._focused = !1, this._subscriptions = new l_(this), this.getDefaultValue = () => "";
	}
	get genomeSpy() {
	...
	_initializeGenome() {
		let e = m_(this.genomeSpy.viewRoot);
		if (e) {
			...
			let n = A(() => this.requestUpdate(), 60, !1);
	...
	async searchViews(e) {
		...
		for (let n of this.genomeSpy.getSearchableViews()) {
			...
			if (!(!i || !a || !o?.isZoomable())) {
				for (let s of n.getCollector()?.getData() ?? []) if (f_(s, r, e, t)) {
	...
	_getSearchHelp() {
		...
		for (let t of this.genomeSpy?.getSearchableViews() || []) {
			let n = t.getTitleText() ?? t.spec.name, r = t.getSearchAccessors(), i = r.flatMap((e) => e.fields).join(", "), a = p_(r, t.getCollector().getData(), 3);
			e.push(R`
	...
	render() {
		return R`
			...
			this._focused || (this._inputField.focus(), e.preventDefault(), e.stopPropagation());
                    ...
                    ${Ft(this.inputRef)}
                />
                ${c_([123], () => this._getSearchHelp())}
            </div>
        `;
	}
};
customElements.define("genome-spy-search-field", u_);
function d_(e, t) {
...
function p_(e, t, n) {
	...
	for (let i of e) for (let e of S(n, t, i)) if (e != null && r.add(String(e)), r.size >= n) return [...r];
	return [...r];
}
function m_(e) {
	let t;
	return e.visit((e) => {
		for (let n of ["x", "y"]) {
			...
			if (r && r.type == "locus" && r.isZoomable()) return t = r, bt;
		}
	}), t;
}
var h_ = {
	...
	devDependencies: {
		"@genome-spy/app-agent": "^0.84.0",
		"@genome-spy/inspector": "^0.84.0"
	}
};
//#endregion
...
var __ = n(class extends M {
	...
	update(e, [t]) {
		...
		} else if (e.type === _e.ATTRIBUTE && n.getAttribute(r) === t + "") return T;
		return Rt(e), t;
	}
});
//#endregion
...
function y_(e) {
	...
	for (let n of e) {
		...
		for (let t of n) {
			...
			n || (n = b_(t), e.children.push(n)), e = n;
		}
	}
	return t.children[0];
}
...
customElements.define("gs-data-grid", x_);
//#endregion
...
customElements.define("gs-upload-drop-zone", S_);
//#endregion
//#region ../app/src/sampleView/metadata/metadataHierarchyConfigurator.js
var C_ = "sample", w_ = class extends L {
	static properties = {
		_pathRoot: { state: !0 },
		metadataRecords: {},
	...
	#e() {
		...
		this._columns = Array.from(e).filter((e) => e !== C_);
	}
	#t() {
	...
	async #a(e) {
		...
		let r = n.length > 0 ? gh(t, n) : [], i = this._scales.get(e.path), a = await K("gs-configure-scale-dialog", (e) => {
...
customElements.define("gs-metadata-hierarchy-configurator", w_);
//#endregion
...
var D_ = class extends G {
	...
	#n;
	constructor() {
		super(), this.existingSampleIds = /* @__PURE__ */ new Set(), this.dialogTitle = "Load Custom Metadata", this._parsedItems = null, this._fileName = null, this._page = 0, this.#n = new Ih(this, [
			{
				render: () => this.#o(),
	...
	async #i(e) {
		let t = await T_(e), n = E_(t, e.name);
		this._parsedItems = j(t, {
			type: n,
			parse: "auto"
	...
	#s() {
		if (this.#e.error) return R`<div class="gs-alert danger">
                ...
                <div>
                    ...
                    <ul>
                        ${this.#e.error.map((e) => R`<li>${j_(e)}</li>`)}
                    </ul>
...
customElements.define("gs-upload-metadata-dialog", D_);
var O_ = R`<p>
...
function j_(e) {
	return e.cases.length > 0 ? R`${e.message}${A_(e.cases)}` : e.count > 1 ? R`${e.message} (occurred ${e.count} times)` : e.message;
}
//#endregion
...
var I_ = class extends L {
	...
	#_() {
		this.dispatchEvent(new L_(Array.from(this.selectedValues)));
	}
	#v(e) {
	...
	async #A() {
		...
		if (!n && this.search) try {
			n = (await this.search(e)).map((e) => N_(e)).find((e) => e.id.toLowerCase() === t) ?? null;
		} catch {
			return;
		}
	...
	render() {
		...
		return R`
            ...
            >
                ${this._loading ? R`<div class="status">Loading...</div>` : I}
                ${!this._loading && this._suggestions.length === 0 ? R`<div class="status">No matches</div>` : I}
...
customElements.define("gs-multi-select", I_);
...
function z_({ queries: e, resolved: t }) {
...
}, V_ = "Type to search or paste one id per line", H_ = 100, U_ = [",", " "];
function W_(e, t) {
	if ("error" in e) {
...
var G_ = class extends G {
	...
	static styles = [...super.styles, O`
        ...
        `];
	constructor() {
		super(), this.sampleView = null, this.intentPipeline = null, this.source = null, this.columnInput = "", this.groupPath = "", this._loading = !1, this._error = "", this._preview = null, this._columnPlaceholder = V_, this._availableColumnCount = void 0, this._columnSearchIndex = new B_([], (e) => e.id), this._previewVersion = 0, this._sourceContextVersion = 0, this._previewQueryKey = "", this._alignmentIssue = null, this._showAlignmentDetails = !1, this._columnValidationEnabled = !1, this._adapter = null, this._form = new rf(this), this._form.defineField("columns", {
            ...
            <div class="stack">
                ...
                <div class="gs-form-group">
                    ...
                    <gs-multi-select
                        ...
                        .debounceMs=${50}
                        .selectedValues=${R_(this.columnInput)}
	...
	async #s() {
		...
		let e = ++this._previewVersion, t = R_(this.columnInput), n = this.#g(t);
		if (t.length === 0) {
			let e = z_({
				queries: t,
				resolved: {
	...
	#c() {
		...
		t.listColumns().then((t) => {
			...
			e === this._sourceContextVersion && (this._columnPlaceholder = V_, this._availableColumnCount = void 0, this._columnSearchIndex.replace([]));
	...
	#l(e) {
		this._columnSearchIndex.replace(e), this._availableColumnCount = e.length, this._columnPlaceholder = V_, this.updateComplete.then(() => {
	...
	#u(e) {
		...
		this._alignmentIssue = W_(n, (e) => this.#v(e));
	}
	#d(e) {
...
customElements.define("gs-import-metadata-source-dialog", G_);
function K_(e, t, n) {
...
var q_ = class {
	...
	#i = new q_();
	constructor() {
		super(), this.subscriptionController = new l_(this), this.style.display = "none";
	}
	connectedCallback() {
		super.connectedCallback(), this.dispatchEvent(v_("app", (e) => {
			this.#e = e;
	...
	#u() {
		...
		let n = t.filter(Z_).map((t) => [...t.getDataAncestors()].filter((t) => t === e || Z_(t)).reverse());
		if (!n.length) {
			this.#t = void 0;
			return;
		}
	...
	#d() {
		let e = this.#e.genomeSpy.viewRoot, t = this.getVisibilities(), n = e ? zn(e, t) : t, r = e ? $n(e) : /* @__PURE__ */ new Set(), i = e ? Ln(e) : /* @__PURE__ */ new Map(), a = [], o = (t, s = -1) => {
			...
			c !== e && Y_(c) && m.push(...X_(c, !0)), c instanceof zp && (m.length && m.push({ type: "divider" }), m.push({
...
}, Y_ = (e) => [...e.paramRuntime.paramConfigs.values()].some((e) => De(e) && e.bind), X_ = (e, t) => {
	let n = [];
	return t && n.push({
		label: "Parameters",
		type: "header"
...
}, Z_ = (e) => gn(e) && !!e.explicitName || Y_(e) || e instanceof zp;
customElements.define("genome-spy-view-visibility", J_);
//#endregion
//#region ../app/src/utils/ui/dropdown.js
var Q_ = /* @__PURE__ */ new Set();
function $_(e) {
	let t = e.currentTarget.parentNode, n = !t.classList.contains("show");
	for (let e of Q_) e.classList.remove("show"), document.body.classList.remove(he), document.body.classList.remove(le);
	return Q_.clear(), e.stopPropagation(), n ? (Q_.add(t), t.classList.add("show"), document.body.classList.add(he), document.body.classList.add(le), window.addEventListener("click", (e) => {
		t.classList.contains("show") && (t.classList.remove("show"), document.body.classList.remove(he), document.body.classList.remove(le), e.preventDefault());
...
var ev = class extends L {
	constructor() {
		super(), this.provenance = void 0, this._subscriptions = new l_(this);
	}
	connectedCallback() {
		super.connectedCallback();
	...
	render() {
		return R`
			...
			if (!n && !r) return I;
			let i = n ? R`${W(li).node[0]} Initial state` : R` ${W(r.icon ?? Ir).node[0]}
...
customElements.define("genome-spy-provenance-buttons", ev);
//#endregion
...
}, rv = (e) => !It(e) && typeof e.then == "function", iv = 1073741823, av = n(class extends Lt {
	constructor() {
		super(...arguments), this._$Cwt = iv, this._$Cbt = [], this._$CK = new tv(this), this._$CX = new nv();
	}
	render(...e) {
		return e.find((e) => !rv(e)) ?? T;
	}
	update(e, t) {
		...
		for (let e = 0; e < t.length && !(e > this._$Cwt); e++) {
			let o = t[e];
			if (!rv(o)) return this._$Cwt = e, o;
			e < r && o === n[e] || (this._$Cwt = iv, r = 0, Promise.resolve(o).then(async (e) => {
...
}), ov = document.createElement("i");
function sv(e) {
	let t = "&" + e + ";";
	ov.innerHTML = t;
	let n = ov.textContent;
...
function J(e, t) {
	return e.length > 0 ? (cv(e, e.length, 0, t), e) : t;
}
//#endregion
//#region ../../node_modules/micromark-util-combine-extensions/index.js
var lv = {}.hasOwnProperty;
function uv(e) {
	let t = {}, n = -1;
	for (; ++n < e.length;) dv(t, e[n]);
	return t;
}
function dv(e, t) {
	let n;
	for (n in t) {
		let r = (lv.call(e, n) ? e[n] : void 0) || (e[n] = {}), i = t[n], a;
		if (i) for (a in i) {
			lv.call(r, a) || (r[a] = []);
			let e = i[a];
			fv(r[a], Array.isArray(e) ? e : e ? [e] : []);
		}
	}
}
function fv(e, t) {
...
var yv = Ov(/[A-Za-z]/), bv = Ov(/[\dA-Za-z]/), xv = Ov(/[#-'*+\--9=?A-Z^-~]/);
function Sv(e) {
	return e !== null && (e < 32 || e === 127);
}
var Cv = Ov(/\d/), wv = Ov(/[\dA-Fa-f]/), Tv = Ov(/[!-/:-@[-`{-~]/);
function Y(e) {
	return e !== null && e < -2;
}
function X(e) {
...
function Av(e) {
	...
	for (; ++n < e.length;) {
		...
		if (a === 37 && bv(e.charCodeAt(n + 1)) && bv(e.charCodeAt(n + 2))) i = 2;
...
var jv = {}.hasOwnProperty, Mv = /^(https?|ircs?|mailto|xmpp)$/i, Nv = /^https?$/i;
function Pv(e) {
	let t = e || {}, n = !0, r = {}, i = [[]], a = [], o = [], s = pv([{
		enter: {
			blockQuote: A,
			codeFenced: te,
	...
	function ue() {
		let e = a.length - 1, i = a[e], o = i.referenceId || i.labelId, s = i.destination === void 0 ? r[vv(o)] : i;
		for (n = !0; e--;) if (a[e].image) {
			n = void 0;
			break;
		}
		i.image ? (_("<img src=\"" + kv(s.destination, t.allowDangerousProtocol ? void 0 : Nv) + "\" alt=\""), v(i.label), _("\"")) : _("<a href=\"" + kv(s.destination, t.allowDangerousProtocol ? void 0 : Mv) + "\""), _(s.title ? " title=\"" + s.title + "\"" : ""), i.image ? _(" />") : (_(">"), v(i.label), _("</a>")), a.pop();
	}
	function de() {
		h(), a.push({});
	}
	...
	function ge() {
		let e = a[a.length - 1], t = vv(e.labelId);
		g(), jv.call(r, t) || (r[t] = a[a.length - 1]), a.pop();
	}
	function _e() {
	...
	function Re(e) {
		...
		v(x(m("characterReferenceType") ? hv(t, m("characterReferenceType") === "characterReferenceMarkerNumeric" ? 10 : 16) : sv(t))), p("characterReferenceType");
	}
	function ze(e) {
		let n = this.sliceSerialize(e);
		_("<a href=\"" + kv(n, t.allowDangerousProtocol ? void 0 : Mv) + "\">"), v(x(n)), _("</a>");
	}
	function Be(e) {
		let t = this.sliceSerialize(e);
		_("<a href=\"" + kv("mailto:" + t) + "\">"), v(x(t)), _("</a>");
	}
}
//#endregion
...
var Lv = { tokenize: zv }, Rv = { tokenize: Bv };
function zv(e) {
	...
	function c(e) {
		if (r++, t.containerState._closeFlow) {
			...
			return cv(t.events, a + 1, 0, t.events.slice(n)), t.events.length = s, l(e);
		}
		return s(e);
	}
	function l(a) {
		...
		return t.containerState = {}, e.check(Rv, u, d)(a);
	}
	function u(e) {
		return i && v(), _(r), f(e);
	}
	...
	function f(n) {
		return t.containerState = {}, e.attempt(Rv, p, m)(n);
	}
	function p(e) {
	...
	function g(e, n) {
		...
		if (n && s.push(null), e.previous = a, a && (a.next = e), a = e, i.defineSkip(e.start), i.write(s), t.parser.lazy[e.start.line]) {
			...
			cv(t.events, a + 1, 0, t.events.slice(n)), t.events.length = e;
		}
	}
	function _(r) {
		let i = n.length;
...
function Wv(e, t) {
	...
	for (; ++n < e.length;) if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
		for (r = n; r--;) if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
			...
			Kv(d, -c), Kv(f, c), o = {
			...
			]), l = J(l, Hv(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t)), l = J(l, [
				[
					"exit",
					a,
					t
				...
				e[n][1],
				t
			]])) : u = 0, cv(e, r - 1, n - r + 3, l), n = r + l.length - u - 2;
			break;
		}
	}
...
function Gv(e, t) {
	let n = this.parser.constructs.attentionMarkers.null, r = this.previous, i = Vv(r), a;
	return o;
	function o(t) {
	...
	function s(o) {
		...
		let c = e.exit("attentionSequence"), l = Vv(o), u = !l || l === 2 && i || n.includes(o), d = !i || i === 2 && l || n.includes(r);
...
function Jv(e, t, n) {
	...
	function a(t) {
		return yv(t) ? (e.consume(t), o) : t === 64 ? n(t) : l(t);
	}
	function o(e) {
		return e === 43 || e === 45 || e === 46 || bv(e) ? (r = 1, s(e)) : l(e);
	}
	function s(t) {
		return t === 58 ? (e.consume(t), r = 0, c) : (t === 43 || t === 45 || t === 46 || bv(t)) && r++ < 32 ? (e.consume(t), s) : (r = 0, l(t));
	}
	function c(r) {
		return r === 62 ? (e.exit("autolinkProtocol"), e.enter("autolinkMarker"), e.consume(r), e.exit("autolinkMarker"), e.exit("autolink"), t) : r === null || r === 32 || r === 60 || Sv(r) ? n(r) : (e.consume(r), c);
	}
	function l(t) {
		return t === 64 ? (e.consume(t), u) : xv(t) ? (e.consume(t), l) : n(t);
	}
	function u(e) {
		return bv(e) ? d(e) : n(e);
	}
...
function ny(e, t, n) {
	...
	function i(r) {
		return Tv(r) ? (e.enter("characterEscapeValue"), e.consume(r), e.exit("characterEscapeValue"), e.exit("characterEscape"), t) : n(r);
	}
}
//#endregion
...
function iy(e, t, n) {
	...
	function c(t) {
		return t === 35 ? (e.enter("characterReferenceMarkerNumeric"), e.consume(t), e.exit("characterReferenceMarkerNumeric"), l) : (e.enter("characterReferenceValue"), a = 31, o = bv, u(t));
	}
	function l(t) {
		return t === 88 || t === 120 ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(t), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), a = 6, o = wv, u) : (e.enter("characterReferenceValue"), a = 7, o = Cv, u(t));
	}
	function u(s) {
		if (s === 59 && i) {
			let i = e.exit("characterReferenceValue");
			return o === bv && !sv(r.sliceSerialize(i)) ? n(s) : (e.enter("characterReferenceMarker"), e.consume(s), e.exit("characterReferenceMarker"), e.exit("characterReference"), t);
		}
...
function sy(e, t, n) {
	...
	function d(n) {
		return n === null || Y(n) ? (e.exit("codeFencedFence"), r.interrupt ? t(n) : e.check(ay, h, b)(n)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", { contentType: "string" }), f(n));
	}
	function f(t) {
	...
	function v(t) {
		return t === null || Y(t) ? e.check(ay, h, b)(t) : (e.enter("codeFlowValue"), y(t));
	}
	function y(t) {
...
function dy(e, t, n) {
	...
	function o(t) {
		return t === null ? c(t) : Y(t) ? e.attempt(uy, o, c)(t) : (e.enter("codeFlowValue"), s(t));
	}
	function s(t) {
...
var _y = class {
	...
	splice(e, t, n) {
		...
		return n && vy(this.left, n), i.reverse();
	}
	pop() {
...
function yy(e) {
	let t = {}, n = -1, r, i, a, o, s, c, l, u = new _y(e);
	for (; ++n < u.length;) {
		for (; n in t;) n = t[n];
		...
		if (r[0] === "enter") r[1].contentType && (Object.assign(t, by(u, n)), n = t[n], l = !0);
	...
	return cv(e, 0, Infinity, u.slice(0)), !l;
}
function by(e, t) {
...
function wy(e, t) {
	...
	function i(t) {
		return t === null ? a(t) : Y(t) ? e.check(Sy, o, a)(t) : (e.consume(t), i);
	}
	function a(n) {
...
function Ey(e, t, n, r, i, a, o, s, c) {
	let l = c || Infinity, u = 0;
	return d;
	function d(t) {
		return t === 60 ? (e.enter(r), e.enter(i), e.enter(a), e.consume(t), e.exit(a), f) : t === null || t === 32 || t === 41 || Sv(t) ? n(t) : (e.enter(r), e.enter(o), e.enter(s), e.enter("chunkString", { contentType: "string" }), h(t));
	}
	function f(n) {
	...
	function h(i) {
		return !u && (i === null || i === 41 || X(i)) ? (e.exit("chunkString"), e.exit(s), e.exit(o), e.exit(r), t(i)) : u < l && i === 40 ? (e.consume(i), u++, h) : i === 41 ? (e.consume(i), u--, h) : i === null || i === 32 || i === 40 || Sv(i) ? n(i) : (e.consume(i), i === 92 ? g : h);
	}
	function g(t) {
...
function My(e, t, n) {
	...
	function o(t) {
		return Dy.call(r, e, s, n, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(t);
	}
	function s(t) {
		return i = vv(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)), t === 58 ? (e.enter("definitionMarker"), e.consume(t), e.exit("definitionMarker"), c) : n(t);
	}
	function c(t) {
		return X(t) ? ky(e, l)(t) : l(t);
	}
	function l(t) {
...
function Ny(e, t, n) {
	return r;
	function r(t) {
		return X(t) ? ky(e, i)(t) : n(t);
	}
	function i(t) {
		return Oy(e, a, n, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(t);
	}
	function a(t) {
...
var zy = /* @__PURE__ */ "address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul".split("."), By = [
	"pre",
	"script",
	"style",
	"textarea"
...
function Gy(e, t, n) {
	...
	function d(s) {
		return s === 33 ? (e.consume(s), f) : s === 47 ? (e.consume(s), a = !0, h) : s === 63 ? (e.consume(s), i = 3, r.interrupt ? t : P) : yv(s) ? (e.consume(s), o = String.fromCharCode(s), g) : n(s);
	}
	function f(a) {
		return a === 45 ? (e.consume(a), i = 2, p) : a === 91 ? (e.consume(a), i = 5, s = 0, m) : yv(a) ? (e.consume(a), i = 4, r.interrupt ? t : P) : n(a);
	}
	function p(i) {
	...
	function h(t) {
		return yv(t) ? (e.consume(t), o = String.fromCharCode(t), g) : n(t);
	}
	function g(s) {
		if (s === null || s === 47 || s === 62 || X(s)) {
			let c = s === 47, l = o.toLowerCase();
			return !c && !a && By.includes(l) ? (i = 1, r.interrupt ? t(s) : O(s)) : zy.includes(o.toLowerCase()) ? (i = 6, c ? (e.consume(s), _) : r.interrupt ? t(s) : O(s)) : (i = 7, r.interrupt && !r.parser.lazy[r.now().line] ? n(s) : a ? v(s) : y(s));
		}
		return s === 45 || bv(s) ? (e.consume(s), o += String.fromCharCode(s), g) : n(s);
	}
	function _(i) {
	...
	function y(t) {
		return t === 47 ? (e.consume(t), E) : t === 58 || t === 95 || yv(t) ? (e.consume(t), b) : Z(t) ? (e.consume(t), y) : E(t);
	}
	function b(t) {
		return t === 45 || t === 46 || t === 58 || t === 95 || bv(t) ? (e.consume(t), b) : x(t);
	}
	function x(t) {
	...
	function O(t) {
		return t === 45 && i === 2 ? (e.consume(t), j) : t === 60 && i === 1 ? (e.consume(t), M) : t === 62 && i === 4 ? (e.consume(t), F) : t === 63 && i === 3 ? (e.consume(t), P) : t === 93 && i === 5 ? (e.consume(t), N) : Y(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Hy, ne, k)(t)) : t === null || Y(t) ? (e.exit("htmlFlowData"), k(t)) : (e.consume(t), O);
	}
	function k(t) {
		return e.check(Uy, A, ne)(t);
	}
	function A(t) {
	...
	function te(t) {
		if (t === 62) {
			let n = o.toLowerCase();
			return By.includes(n) ? (e.consume(t), F) : O(t);
		}
		return yv(t) && o.length < 8 ? (e.consume(t), o += String.fromCharCode(t), te) : O(t);
	}
	function N(t) {
...
function qy(e, t, n) {
	return r;
	function r(r) {
		return e.enter("lineEnding"), e.consume(r), e.exit("lineEnding"), e.attempt(Yv, t, n);
	}
}
//#endregion
...
function Yy(e, t, n) {
	...
	function c(t) {
		return t === 33 ? (e.consume(t), l) : t === 47 ? (e.consume(t), x) : t === 63 ? (e.consume(t), y) : yv(t) ? (e.consume(t), w) : n(t);
	}
	function l(t) {
		return t === 45 ? (e.consume(t), u) : t === 91 ? (e.consume(t), a = 0, m) : yv(t) ? (e.consume(t), v) : n(t);
	}
	function u(t) {
	...
	function x(t) {
		return yv(t) ? (e.consume(t), S) : n(t);
	}
	function S(t) {
		return t === 45 || bv(t) ? (e.consume(t), S) : C(t);
	}
	function C(t) {
		return Y(t) ? (o = C, M(t)) : Z(t) ? (e.consume(t), C) : j(t);
	}
	function w(t) {
		return t === 45 || bv(t) ? (e.consume(t), w) : t === 47 || t === 62 || X(t) ? T(t) : n(t);
	}
	function T(t) {
		return t === 47 ? (e.consume(t), j) : t === 58 || t === 95 || yv(t) ? (e.consume(t), E) : Y(t) ? (o = T, M(t)) : Z(t) ? (e.consume(t), T) : j(t);
	}
	function E(t) {
		return t === 45 || t === 46 || t === 58 || t === 95 || bv(t) ? (e.consume(t), E) : D(t);
	}
	function D(t) {
...
var Xy = {
	...
	resolveTo: tb,
	tokenize: nb
}, Zy = { tokenize: rb }, Qy = { tokenize: ib }, $y = { tokenize: ab };
function eb(e) {
	let t = -1, n = [];
	for (; ++t < e.length;) {
		let r = e[t][1];
	...
	return e.length !== n.length && cv(e, 0, e.length, n), e;
}
function tb(e, t) {
	...
	return s = [[
		...
		u,
		t
	]]), s = J(s, Hv(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t)), s = J(s, [
		[
			"exit",
			u,
			t
...
function nb(e, t, n) {
	...
	return s;
	function s(t) {
		return a ? a._inactive ? d(t) : (o = r.parser.defined.includes(vv(r.sliceSerialize({
			start: a.end,
			end: r.now()
		}))), e.enter("labelEnd"), e.enter("labelMarker"), e.consume(t), e.exit("labelMarker"), e.exit("labelEnd"), c) : n(t);
	}
	function c(t) {
		return t === 40 ? e.attempt(Zy, u, o ? u : d)(t) : t === 91 ? e.attempt(Qy, u, o ? l : d)(t) : o ? u(t) : d(t);
	}
	function l(t) {
		return e.attempt($y, u, d)(t);
	}
	function u(e) {
		return t(e);
	}
...
function rb(e, t, n) {
	...
	function i(t) {
		return X(t) ? ky(e, a)(t) : a(t);
	}
	function a(t) {
		return t === 41 ? u(t) : Ey(e, o, s, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(t);
	}
	function o(t) {
		return X(t) ? ky(e, c)(t) : u(t);
	}
	function s(e) {
		return n(e);
	}
	function c(t) {
		return t === 34 || t === 39 || t === 40 ? Oy(e, l, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(t) : u(t);
	}
	function l(t) {
		return X(t) ? ky(e, u)(t) : u(t);
	}
	function u(r) {
...
function ib(e, t, n) {
	...
	return i;
	function i(t) {
		return Dy.call(r, e, a, o, "reference", "referenceMarker", "referenceString")(t);
	}
	function a(e) {
		return r.parser.defined.includes(vv(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))) ? t(e) : n(e);
	}
	function o(e) {
		return n(e);
	}
...
function gb(e, t, n) {
	...
	function s(t) {
		...
		if (i === "listUnordered" ? !r.containerState.marker || t === r.containerState.marker : Cv(t)) {
			if (r.containerState.type || (r.containerState.type = i, e.enter(i, { _container: !0 })), i === "listUnordered") return e.enter("listItemPrefix"), t === 42 || t === 45 ? e.check(fb, n, l)(t) : l(t);
			if (!r.interrupt || t === 49) return e.enter("listItemPrefix"), e.enter("listItemValue"), c(t);
		}
		return n(t);
	}
	function c(t) {
		return Cv(t) && ++o < 10 ? (e.consume(t), c) : (!r.interrupt || o < 2) && (r.containerState.marker ? t === r.containerState.marker : t === 41 || t === 46) ? (e.exit("listItemValue"), l(t)) : n(t);
	}
	function l(t) {
		return e.enter("listItemMarker"), e.consume(t), e.exit("listItemMarker"), r.containerState.marker = r.containerState.marker || t, e.check(Yv, r.interrupt ? n : u, e.attempt(mb, f, d));
	}
	function u(e) {
...
function _b(e, t, n) {
	let r = this;
	return r.containerState._closeFlow = void 0, e.check(Yv, i, a);
	function i(n) {
	...
	function a(n) {
		return r.containerState.furtherBlankLines || !Z(n) ? (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, o(n)) : (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, e.attempt(hb, t, o)(n));
	}
	function o(i) {
...
var wb = { tokenize: Tb };
function Tb(e) {
	let t = this, n = e.attempt(Yv, r, e.attempt(this.parser.constructs.flowInitial, i, Q(e, e.attempt(this.parser.constructs.flow, i, e.attempt(xy, i)), "linePrefix")));
	return n;
	function r(r) {
		if (r === null) {
			e.consume(r);
...
var Eb = { resolveAll: Ab() }, Db = kb("string"), Ob = kb("text");
function kb(e) {
	return {
		resolveAll: Ab(e === "text" ? jb : void 0),
		tokenize: t
	};
	function t(t) {
...
var Mb = /* @__PURE__ */ e({
	...
	95: Uv,
	96: py
}, zb = { null: [Uv, Eb] }, Bb = { null: [42, 95] }, Vb = { null: [] };
//#endregion
...
function Hb(e, t, n) {
	...
	function d(e) {
		return o = J(o, e), g(), o[o.length - 1] === null ? (w(t, 0), l.events = Hv(a, l.events, l), l.events) : [];
	}
	function f(e, t) {
		return Wb(p(e), t);
	}
	...
	function w(e, t) {
		e.resolveAll && !a.includes(e) && a.push(e), e.resolve && cv(l.events, t, l.events.length - t, e.resolve(l.events.slice(t), l)), e.resolveTo && (l.events = e.resolveTo(l.events, l));
	}
	function T() {
...
function Jb() {
	...
	function i(i, a, o) {
		...
		for (i = t + (typeof i == "string" ? i.toString() : new TextDecoder(a || void 0).decode(i)), u = 0, t = "", n &&= (i.charCodeAt(0) === 65279 && u++, void 0); u < i.length;) {
			if (qb.lastIndex = u, c = qb.exec(i), d = c && c.index !== void 0 ? c.index : i.length, f = i.charCodeAt(d), !c) {
				t = i.slice(u);
				break;
			}
...
function Yb(e, t, n) {
	return typeof t != "string" && (n = t, t = void 0), Pv(n)(Kb(Gb(n).document().write(Jb()(e, t, !0))));
}
//#endregion
//#region ../app/src/utils/safeMarkdown.js
function Xb(e, t = {}) {
	let n = Yb(e), r = new DOMParser().parseFromString(`<!DOCTYPE html><html><body><div>${n}</div></body></html>`, "text/html");
	r.normalize(), Zb(r.body);
	for (let e of r.querySelectorAll("a[href]")) e.setAttribute("target", "blank"), e.setAttribute("rel", "noopener noreferrer"), e.setAttribute("href", xt(e.getAttribute("href"), t.baseUrl));
	for (let e of r.querySelectorAll("img[src]")) e.setAttribute("src", xt(e.getAttribute("src"), t.baseUrl));
...
function Zb(e) {
	if (e.nodeType !== 3) {
		...
		for (let t = e.childNodes.length; t--;) Zb(e.childNodes[t]);
	}
}
//#endregion
...
`, $b = class extends G {
	...
	renderBody() {
		let e = this.entry;
		return R`<div class="notes">${e.notes ? Xb(e.notes, { baseUrl: this.baseUrl }) : R`<span class="no-notes">No notes provided</span>`}</div>
            ${this.#r()}`;
	}
	#r() {
...
customElements.define("gs-bookmark-info-box", $b);
//#endregion
...
function tx(e, t) {
	let n = {};
	for (let [r, i] of e.getNamedScaleResolutions().entries()) t(i) && ex(i) && (n[r] = i.getComplexDomain());
	return n;
}
//#endregion
...
function nx(e, t = {}) {
	...
	return n.scaleDomains = tx(e.genomeSpy, (e) => e.isZoomable()), t.plots?.length && (n.plots = t.plots.slice()), n;
}
function rx(e) {
	return {
		getLocalBookmarkDatabase: () => e.localBookmarkDatabase,
		createBookmark: (t) => nx(e, { plots: t }),
...
async function ax(e, t) {
	try {
		...
		return await Promise.all(r), { plots: await ox(e, t) };
	} catch (e) {
...
async function lx(e, t, n = {}) {
	...
	if (r) r.baseUrl = ux(t, n), r.entry = e, r.mode = n.mode ?? "default", r.plotResults = n.plotResults ?? [], r.plotBookmarkContext = rx(t);
	else {
		K("gs-bookmark-info-box", async (r) => {
			r.baseUrl = ux(t, n), r.entry = e, r.mode = n.mode ?? "default", r.plotResults = n.plotResults ?? [], r.plotBookmarkContext = rx(t), r.allowImport = !!n.database, n.database && (r.names = await n.database.getNames());
		}).then(async () => {
			if (n.mode == "tour") {
...
var dx = class extends L {
	...
	#o() {
		let e = (e, t) => e ? av(this.#a(e, t), R`Loading...`) : I;
...
customElements.define("genome-spy-bookmark-button", dx);
//#endregion
//#region ../app/src/components/dialogs/aboutDialog.js
var fx = class extends G {
	constructor() {
		...
		return R` <div style="display: flex; gap: 1em">
            ...
            <div style="max-width: 28em">
                <p>
                    ...
                    <a href="${h_.homepage}" target="_blank"
                        >${h_.homepage}</a
                    >.
                </p>
                <p>
                    Copyright 2026 ${h_.author?.name ?? "The author"}
                    and contributors.<br />
                    ${h_.license} license.
                </p>
                <p>
                    Version: ${g_(h_.version)}
                    ${"commitHash" in h_ ? `(${h_.commitHash})` : I}
                </p>
...
customElements.define("gs-about-dialog", fx);
//#endregion
//#region ../app/src/components/dialogs/saveSvgDialog.js
var px = class extends G {
	static properties = {
		...super.properties,
		genomeSpy: { type: Object },
		logicalWidth: { type: Number },
	...
	#o() {
		if (!this.rasterizeDenseMarks) return R`<div class="raster-preview">
                All layers will remain vector.
            </div>`;
		if (this.analyzing) return R`<div class="raster-preview">
                Analyzing visible layers…
            </div>`;
		if (this.analysisError) return R`<div class="raster-preview">
	...
	render() {
		...
		return R`
            <nav class="gs-toolbar">
                ...
                ${this.app.store.getState().lifecycle.appInitialized && m_(e.viewRoot) ? R`
...
customElements.define("genome-spy-toolbar", hx);
//#endregion
...
function vx(e, t, n = (e) => +e) {
	let r = e.length, i = new Ye(), a = Array(r).fill(0);
...
var yx = "sampleCount", bx = class extends We {
	#e = !0;
	#t;
	constructor(e, t) {
		super(), this.view = t;
		let n = t.context.animator;
		if (this.provenance = xx(t), !this.provenance) throw Error("No SampleView was found!");
		let r = () => {
	...
	initialize() {
		this.#t = this.paramRuntime.allocateSetter(yx, 0, !0);
		let e = this.view.getEncoding().x;
		if (Xe(e)) this.xAccessor = st(e.field);
	...
	#r() {
		if (this.parent instanceof u) return this.parent;
	...
	#i(e) {
		let t = [...rr(e.rootGroup)].filter((e) => yn(et(e)));
		for (let [e, n] of t.entries()) {
			...
			if (yn(t)) {
				...
				vx(n.map((e) => r.facetBatches.get([e]) ?? []), (e) => this._propagate(e), this.xAccessor);
			}
		}
	}
	beginBatch(e, t) {
...
function xx(e) {
	for (let t of e.getLayoutAncestors()) if (t instanceof kg) return t.provenance;
}
//#endregion
//#region ../app/src/bookmark/simpleBookmarkDatabase.js
var Sx = class extends i_ {
	constructor(e, t = {}) {
...
function Dx() {
	let e = Qt({
		...
		lifecycle: wx.reducer,
		viewSettings: tr.reducer,
		intentStatus: Ex.reducer,
		provenance: e
	});
	return or({
		middleware: (e) => e({
		...
		reducer: (n, r) => {
			let i = t(n, r);
			if (r.type === Ex.actions.setError.type) {
			...
			if (r.type === Ex.actions.resolveError.type && r.payload.decision === "rollbackBatch") {
	...
	async #l() {
		...
		try {
			for (; this.#r.length;) {
				...
				this.#e.dispatch(Ex.actions.setRunning({
					startIndex: r,
				...
				let a;
				try {
					for (let [e, n] of t.actions.entries()) a = n, this.#e.dispatch(Ex.actions.setProgress({
						currentIndex: e,
						currentAction: n
					...
					this.#e.dispatch(Ex.actions.setError({
						startIndex: r,
						lastSuccessfulIndex: i,
						failedAction: a,
						submissionKind: s,
						error: o.message
					})), s === "agent" && this.#e.dispatch(Ex.actions.clearStatus()), t.reject(o);
					let c = this.#r;
					this.#r = [];
			...
			this.#i = !1, this.#a = !1, this.#c = void 0, e || this.#e.dispatch(Ex.actions.clearStatus());
		}
	}
	async #u(e, t) {
		let n = this.createContext(t);
		if (n.signal?.aborted) throw Error("Action processing was aborted.");
		let r = kx(e), i = r && n.getAttributeInfo ? n.getAttributeInfo(r) : void 0;
...
async function Ax(e) {
	...
	if (s) {
		...
		if (e.columnIds.length === 0) throw Error(jx(t, e));
		l = e.columnIds;
	}
...
async function Mx(e, t, n) {
	...
	let a = _n(t), o = await a.getSource(r.sourceId), s = await Ax({
		source: o,
		payload: r,
		sampleIds: i,
...
async function Fx(e, t) {
	...
	let n = t.registerActionHook({
		...
		augment: (t, n) => Mx(n, e, t.signal)
	});
	e.registerDisposer(n), e.registerDisposer(r), await Px(e, t);
}
//#endregion
//#region ../app/src/components/dialogs/intentStatusDialog.js
var Ix = class extends G {
	static properties = {
		...super.properties,
		message: {},
...
customElements.define("gs-intent-status-dialog", Ix);
function Lx(e) {
...
customElements.define("gs-intent-error-dialog", Rx);
function zx(e) {
...
function Bx({ store: e, intentPipeline: t, provenance: n, delayMs: r = 800, minVisibleMs: i = 400 }) {
	let a, o, s, c, l = (e = !1) => {
		if (!o) return;
		...
		let t = e?.currentAction ? Hx(n, e.currentAction) : I, r = typeof e?.currentIndex == "number" && typeof e?.totalActions == "number" ? R` (${e.currentIndex + 1} of ${e.totalActions})` : I;
		...
		if (o) return;
		let n = e.getState().intentStatus, { element: r, promise: i } = Lx({
			title: "Working…",
			message: u(n),
			cancelLabel: "Cancel"
		});
		...
		let i = t ? Hx(n, t) : "action", a = Vx(r), o = R`
            <p>
                ${a ? "Canceled while performing:" : "Failed to perform:"}
                ${i}
            </p>
            <p>
                ${r ? R`<p>Details:<br />${r}</p>` : I}
            </p>
            <p>
		...
		e.dispatch(Ex.actions.resolveError({ decision: s }));
...
function qx(e, t) {
	return Kx(e) ? { not: qx(e.not, t) } : Gx(e) ? { and: e.and.map((e) => qx(e, t)) } : Wx(e) ? { or: e.or.map((e) => qx(e, t)) } : $x(e, t);
}
function Jx(e, t) {
	return qx(Yx(e), t);
}
...
function rS(e, t) {
	return !t || typeof t != "object" || t.type !== "interval" ? t : {
		type: "interval",
		intervals: iS(e, "intervals" in t && t.intervals ? t.intervals : "value" in t && Array.isArray(t.value) ? { x: t.value } : {})
	};
}
function iS(e, t) {
	let n = {};
...
var aS = 150, oS = class {
	...
	#b(e) {
		...
		let n = this.#L(e);
		if (n === void 0 || lt(e.param) && this.#Z(e.param, n) && this.#C(e, t)) return;
		let r = this.#P(e, n);
		if (r) {
			if (this.#x(e, n, t)) {
	...
	#x(e, t, n) {
		if (!lt(e.param) || !this.#Z(e.param, t)) return !1;
		let { past: r, present: i } = this.#t.getState().provenance;
		if (r.length === 0) return !1;
		let a = i.lastAction;
		if (!a || !yg.actions.paramChange.match(a)) return !1;
	...
	#w(e) {
		return lt(e) ? !0 : De(e) && !!e.bind;
	}
	#T(e, t) {
		let n = yg.actions.paramChange({
			selector: e.selector,
			value: t
		});
		this.#n.dispatch(n);
	...
	#k(e) {
		return Me(e.param, e.view.paramRuntime);
	}
	#A(e, t) {
	...
	#I(e, t) {
		return De(e.param) && Object.is(e.view.paramRuntime.getTargetValue(e.selector.param), t);
	}
	#L(e) {
		let t = e.selector.param;
		return De(e.param) ? e.view.paramRuntime.getTargetValue(t) : e.view.paramRuntime.getValue(t);
	}
	async whenApplied(e) {
	...
	#R(e, t) {
		...
		if (lt(n)) {
			...
			if (Je(i)) {
				...
				try {
					c = gt(s, t, a, (e, t) => o.findDatumByKey(e, t));
				} catch (r) {
		...
		return De(n) ? r.type === "value" ? r.value : this.#j(e, "cannot be restored because the bookmark stored a different value type.") : this.#k(e);
	}
	#z(e, t, n) {
	...
	#B(e) {
		let t = e.origin, n = mt(this.#e, t.view);
		if (!n) {
	...
	#X(e, t) {
		let n = e.param;
		lt(n) && Je(Ne(n.select)) && (this.#N(e, "persist") || this.#u.add(t));
	}
	#Z(e, t) {
		let n = Ne(e.select);
		return Je(n) ? Pe(t) ? !t.datum : !Ke(t) || t.data.size === 0 : Ie(n) ? !ke(t) : !1;
	}
	#Q(e) {
...
function lS(e, t) {
	let n = yg.actions.paramChange.match(e), r = yg.actions.expandPointSelection.match(e);
	if (!n && !r) return;
	let i = e.payload, a = i.selector, o = r && "rule" in i ? { rule: i.rule } : r ? { predicate: i.predicate } : {}, s = r ? {
		...
		origin: i.origin,
		...o
	} : i.value, c = i.origin, l = yS(rt, t, a), u = l ? l.view : void 0, d = u ? fS(u, t) : null, f = uS(e, u, a, s, c, t);
	return {
		title: d ? R`${f} in ${d}` : f,
		icon: vS(s)
	};
...
function uS(e, t, n, r, i, a) {
	...
	if (r.type === "value") return R`Set <strong>${o}</strong> =
            <strong>${pS(r.value)}</strong>${dS(i, a)}`;
	if (r.type === "point") return r.keys.length === 0 ? R`Clear selection
                <strong>${o}</strong> ${dS(i, a)}` : r.keys.length === 1 ? R`Select <strong>${o}</strong> =
                ${mS(hS(r.keys[0]))}${dS(i, a)}` : R`Select <strong>${o}</strong> (${mS(r.keys.length)}
            points)${dS(i, a)}`;
	if (r.type === "pointExpand") {
		let t = bS(r.operation), n = xS(OS(r), {
			action: e,
			root: a,
			origin: r.origin
		});
		return R`${t}
            <strong>${o}</strong>
            ${DS(r.partitionBy)} by ${n}`;
	}
	if (r.type === "interval") {
		let e = r.intervals ?? {}, n = e.x, s = e.y, c = _S(n && t ? Mm(t, n) : gS(n), s ? gS(s) : null);
		return c ? R`Brush
            <strong>${o}</strong>
            ${c}${dS(i, a)}` : R`Clear selection
                <strong>${o}</strong> ${dS(i, a)}`;
	}
	return R`Update <strong>${o}</strong>`;
}
function dS(e, t) {
	if (!e || e.type !== "datum") return R``;
	let n = t ? yS(mt, t, e.view) : null;
	return n ? R` from ${fS(n, t)}` : R``;
}
function fS(e, t) {
	let n = (e.getTitleText ? e.getTitleText() : void 0) || e.explicitName || e.spec && e.spec.name || e.name || "view";
	return R`<strong>${Bm(t, e, String(n))}</strong>`;
}
function pS(e) {
...
function hS(e) {
	return e.length === 1 ? pS(e[0]) : "(" + e.map((e) => pS(e)).join(", ") + ")";
}
function gS(e) {
...
function SS(e, t) {
	if (Kx(e)) return R`not (${SS(e.not, t)})`;
	if (Gx(e)) return TS(e.and.map((e) => SS(e, t)), " and ");
	if (Wx(e)) return TS(e.or.map((e) => SS(e, t)), " or ");
	if (e.op === "eq") {
		if ("value" in e) return R`${CS(e.field)}
                <span class="operator">=</span>
                <strong>${pS(e.value)}</strong>`;
		if ("valueFromField" in e) {
			let n = ES(t.action, t.root, t.origin, e.valueFromField);
			if (n !== void 0) return R`${CS(e.field)}
                    <span class="operator">=</span>
                    <strong>${pS(n)}</strong>
                    (from clicked item)`;
			{
	...
	} else if (e.op === "in") return R`${CS(e.field)}
...
function wS(e) {
	return R`{${e.map((e, t) => R`${t > 0 ? ", " : ""}<strong>${pS(e)}</strong>`)}}`;
}
function TS(e, t) {
...
function ES(e, t, n, r) {
	...
	if (!s) return;
	let c = Qx(r)(s);
	if (c !== void 0) return i || (i = /* @__PURE__ */ new Map(), cS.set(e, i)), i.set(r, c), c;
}
function DS(e) {
...
function AS(e, t) {
	it(e, (e) => {
		...
		if (!(!n || typeof n != "object") && (typeof n.group != "string" || n.group.length === 0)) {
			let n = ot(e);
			t.push({
				message: "Configurable visibility group must be a non-empty string in " + FS(n) + " for " + e.getPathString() + ".",
				scope: n
			});
		}
	});
...
function jS(e, t) {
	...
	it(e, (e) => {
		...
		if (!o) {
			if (!kn(e)) return;
			t.push({
				message: "Configurable view must have an explicit name in " + FS(i) + ".",
				scope: i
			});
			return;
		}
	...
	for (let [e, i] of r) {
		...
		for (let [e, n] of i) {
			...
			t.push({
				message: "Configurable view name \"" + e + "\" is not unique within " + FS(r) + ". Found in: " + i + ".",
				scope: r
			});
		}
	}
...
function MS(e, t) {
	let n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map();
	it(e, (e) => {
		let t = ft(e), i = t ? t.name : void 0;
		if (typeof i != "string" || !i.length || !NS(e)) return;
		let a = ot(e);
		if (!a.length) return;
		let o = a.slice(0, a.length - 1), s = PS(o);
	...
	for (let [e, i] of r) {
		...
		for (let [e, n] of i) n <= 1 || t.push({
			message: "Import instance name \"" + e + "\" is used multiple times for addressable instances in " + FS(r) + ".",
			scope: r
		});
	}
}
function NS(e) {
	let t = !1;
	return it(e, (e) => {
		if (gn(e) && (e.explicitName || kn(e))) return t = !0, bt;
	}), t;
}
function PS(e) {
	return JSON.stringify(e);
...
function IS({ viewRoot: e, intentExecutor: t }) {
	let n = !1, r = (r) => {
		if (r.stopped || LS(r.target)) return;
		let i = ug(e, e.context.getCurrentHover());
		...
		i.status === "available" && (Bd({ items: [xg(i.context, (e) => t.dispatch(e))] }, r.mouseEvent), r.stopPropagation());
	};
	return e.addInteractionListener("contextmenu", r), () => e.removeInteractionListener("contextmenu", r);
}
function LS(e) {
	return e ? e.getLayoutAncestors().some((e) => e instanceof kg) : !1;
}
//#endregion
//#region ../app/src/appKeyboardShortcuts.js
function RS({ viewRoot: e, shortcuts: t }) {
	e.context.addKeyboardListener("keydown", (e) => BS(e, t));
}
function zS({ provenance: e, focusSearchField: t }) {
	return [{
		code: "KeyZ",
...
function BS(e, t) {
	...
	for (let n of t) if (VS(e, n.code) && !(n.allowEditableTarget !== !0 && HS(e.target)) && !(n.isEnabled && !n.isEnabled()) && n.run(e) !== !1) return e.preventDefault(), !0;
	return !1;
}
function VS(e, t) {
...
var US = class extends EventTarget {
	constructor() {
...
var WS = class {
	...
	constructor(e, t, n = {}) {
		...
		}, this.ui = new US(), this.#r(), this.#a(e), this.#i(), F(R`<div class="genome-spy-app">
                <genome-spy-toolbar .app=${this}></genome-spy-toolbar>
                <div class="genome-spy-workspace">
                    <div class="genome-spy-container"></div>
                    ${this.isEmbedded() ? I : R`<div class="genome-spy-side-panel-host"></div>`}
                </div>
		...
		}), this.genomeSpy = new E(this.appContainer.getElementsByClassName("genome-spy-container")[0], this.rootSpec, this.options), this.debug = {
			getViewRoot: () => this.genomeSpy?.viewRoot,
			getModules: () => this.getDebugModules()
		}, this.genomeSpy.viewFactory.addViewType(xm, ((e, t, n, r, i) => new kg(e, t, n, r, i, this.provenance, this.intentExecutor, rx(this)))), this.#o();
	}
	getAgentApi() {
		return this.#e ||= import("./agentApi-DyjqiiX_.js").then((e) => e.t).then((e) => e.createAgentApi(this)), this.#e;
	}
	async getDebugModules() {
		return import("./debug-aHQsa6hU.js");
	}
	#r() {
		this.store = Dx(), this.intentExecutor = new Cx(this.store), this.provenance = new _x(this.store), this.intentPipeline = new Ox({
			store: this.store,
			provenance: this.provenance,
			intentExecutor: this.intentExecutor
		}), am(this.store, yg.name);
	}
	#i() {
		this.localBookmarkDatabase = this.isEmbedded() ? void 0 : typeof this.rootSpec.specId == "string" ? new o_(this.rootSpec.specId) : void 0, this.globalBookmarkDatabase = void 0;
	}
	#a(e) {
		this.appContainer = e, this.isFullPage() ? (this.appContainer.style.margin = "0", this.appContainer.style.padding = "0", this.appContainer.style.overflow = "hidden", KS(vr)) : this.appContainer.style.position = "relative";
	}
	#o() {
	...
	async launch() {
		let e = this.isEmbedded() ? Promise.resolve([]) : this.rootSpec.bookmarks?.remote ? ye({ baseURL: this.rootSpec.baseUrl }).load(this.rootSpec.bookmarks.remote.url).then((e) => Promise.resolve(JSON.parse(e))) : Promise.resolve([]);
		...
		this.paramProvenanceBridge = new oS({
			root: t,
			store: this.store,
			intentExecutor: this.intentExecutor
		}), t.registerDisposer(() => {
			this.paramProvenanceBridge.dispose();
		}), this.provenance.addActionInfoSource((e) => lS(e, t)), RS({
			viewRoot: t,
			shortcuts: zS({
				provenance: this.provenance,
				focusSearchField: () => {
		...
		}), t.registerDisposer(IS({
			viewRoot: t,
			intentExecutor: this.intentExecutor
		}));
		let n = this.getSampleView();
		if (n) try {
			await Fx(n, this.intentPipeline);
		} catch (e) {
		...
		if (this.appContainer.querySelector("canvas").setAttribute("tabindex", "-1"), this.#c(Ap(this.store, (e) => e.viewSettings?.visibilities, jp(() => {
			...
			qS(this.genomeSpy.viewRoot), e.highlightView(null), e.requestLayoutReflow();
		}))), this.#c(Bx({
			store: this.store,
		...
		this.isFullPage() && r.length > 0 && (document.title = "GenomeSpy - " + r), this.store.dispatch(wx.actions.setInitialized());
	}
	async #l(e) {
	...
	_updateStateToUrl() {
		...
		t?.length && (e.actions = t), e.scaleDomains = tx(this.genomeSpy, (e) => e.isZoomed());
	...
	async #f(e) {
		let t = await e;
		if (t.length) return this.globalBookmarkDatabase ||= new Sx(t, { baseUrl: GS(this.rootSpec) }), this.globalBookmarkDatabase;
	}
	getSampleView() {
		if (!this.genomeSpy?.viewRoot) return;
		let e;
		return this.genomeSpy.viewRoot.visit((t) => {
			if (t instanceof kg) return e = t, bt;
		}), e;
	}
};
function GS(e) {
	let t = e.bookmarks?.remote;
	if (t) return Ae(je(e.baseUrl, t.url));
}
function KS(e) {
...
async function JS(e, t, n = {}) {
	...
	let o, s, c = [];
	try {
		let e = an(t) ? t : await ce(t);
		e.baseUrl ??= "", e.padding ??= 10;
		let { plugins: r = [], ...i } = {
			powerPreference: "high-performance",
			...n
		};
		s = new WS(a, e, i), o = s.genomeSpy, c = await XS(s, r), YS(o, i), await s.launch();
	} catch (e) {
