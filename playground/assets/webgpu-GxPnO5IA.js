...
`),expr:`unit`})}function $e({name:e,domainLength:t,outputComponents:n,outputScalarType:r}){let i=n===1?r:`vec4<f32>`,a=n===1?`params.${A}${e}[slot].x`:`params.${A}${e}[slot]`;return n=>({...Ge(n,`
    let value = ${n.expr};
    const DOMAIN_LEN: u32 = ${t}u;
    var slot: u32 = 0u;
    ...
    let out: ${i} = ${a};
`),expr:`out`})}function et({name:e,rangeLength:t,outputComponents:n,outputScalarType:r}){let i=n===1?r:`vec4<f32>`,a=n===1?`params.${A}${e}[slot].x`:`params.${A}${e}[slot]`;return n=>({...Ge(n,`
    let value = ${n.expr};
    ...
    let out: ${i} = ${a};
`),expr:`out`})}function tt(e,t,n=e){return`fn ${ke}${n}(i: u32) -> ${t}`}function M(e){return`readPacked2(params.${k}${e})`}function nt(e){return`readPacked3(params.${k}${e})`}function N(e){return`readPacked2(params.${A}${e})`}function rt(e,t){return t===`u32`?e:`u32(f32(${e}))`}function it({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,clamp:i,round:a,useRangeTexture:o},s){let c=[];return r!==`f32`&&c.push(Je(r)),i&&c.push(Ye(M(e))),c.push(Xe(e,s)),a&&!o&&c.push(Ze()),qe({name:e,functionName:t,rawValueExpr:n,steps:c,returnType:o?`vec4<f32>`:`f32`,useRangeTexture:o})}var at={type:`identity`,input:`any`,output:`same`,params:[],continuous:!1,vectorOutput:`always`,resources:{stopKind:null,needsDomainMap:!1,needsOrdinalRange:!1},emit:ot};Object.freeze(at);function ot({name:e,functionName:t,rawValueExpr:n,outputComponents:r,outputScalarType:i}){return`${tt(e,r===1?i:`vec${r}<f32>`,t)} { return ${n}; }`}function st(e){if(!e||e.type==`identity`)return at;if(!e.definition)throw Error(`Scale "${e.type}" has no definition. Import and use its scale factory.`);return e.definition}function ct(e){return st(e).type}function lt(e,t){let n=e.resources;return{stopKind:n.stopKind&&n.supportsPiecewise&&t?`piecewise`:n.stopKind,needsDomainMap:!!n.needsDomainMap,needsOrdinalRange:!!n.needsOrdinalRange}}function ut(e){return{stopArrays:e.resources.stopKind!==null,params:e.params}}function dt(e,t){return e.output===`same`?t:`f32`}function ft(e,t){let n=typeof e==`function`||Array.isArray(e)?{scheme:e}:e;if(n.count===void 0&&t!==void 0&&(n.count=t),typeof n.scheme==`function`)return ht(n.scheme,n);if(Array.isArray(n.scheme))return n.mode===`interpolate`||n.interpolate?pt(n.scheme,n):mt(n.scheme,n.count)}function pt(e,t={}){return ht(vt(e,t.interpolate),t)}function mt(e,t){return gt(e.map(_t),t)}function ht(e,{extent:t=[0,1],reverse:n=!1,count:r=256}={}){let i=t[0],a=t[t.length-1]-i,o=a===0?1:a,s=Array(r);for(let t=0;t<r;t++)s[t]=e(i+(r>1?t/(r-1):0)/o);return n&&s.reverse(),gt(s)}function gt(e,t){let n=Math.max(e.length,t||0),r=new Uint8Array(n*4);for(let t=0;t<n;t++){let n=e[t%e.length],i=l(n);if(!i)throw Error(`Invalid color "${n}" in the scheme ${JSON.stringify(e)}!`);let a=i.rgb(),o=t*4;r[o]=a.r,r[o+1]=a.g,r[o+2]=a.b,r[o+3]=255}return{data:r,format:`rgba8unorm`,width:n,height:1}}function _t(e){if(typeof e==`string`)return e;if(!Array.isArray(e))throw Error(`Invalid color stop: ${String(e)}`);let[t=0,n=0,r=0,i=1]=e,a=Math.max(t,n,r,i),o=a<=1?255:1,s=a<=1?i:i/255;return`rgba(${t*o}, ${n*o}, ${r*o}, ${s})`}function vt(e,t){let n=e.map(_t),r=t??u,i=n.slice(0,-1).map((e,t)=>r(e,n[t+1]));return e=>{let t=e*i.length,n=Math.max(0,Math.min(i.length-1,Math.floor(t)));return i[n](t-n)}}function yt(e){let t=l(e).rgb();return[t.r,t.g,t.b].map(e=>e/255)}function bt(e){if(!e||!st(e).resources.supportsPiecewise)return!1;let t=Array.isArray(e.domain)?e.domain.length:0,n=Array.isArray(e.range)?e.range.length:0;return t>2||n>2}var xt={continuous:{label:`Continuous`,getLengths:()=>({domainLength:2,rangeLength:2}),normalizeStops:({name:e,scale:t,getDefaultScaleRange:n,domainLength:r,rangeLength:i})=>{let a=Array.isArray(t.domain)?t.domain:[0,1],o=Array.isArray(t.range)?t.range:n(e)??[0,1];if(typeof o[0]!=`number`||typeof o[1]!=`number`)throw Error(`Scale range for "${e}" must be numeric.`);let s=o;return{domain:[a[0]??0,a[1]??1],range:[s[0]??0,s[1]??1],domainLength:r,rangeLength:i}}},threshold:{label:`Threshold`,getLengths:({name:e,scale:t})=>{let n=Array.isArray(t.domain)?t.domain:[],r=Array.isArray(t.range)?t.range:[];if(n.length===0)throw Error(`Threshold scale on "${e}" must define a non-empty domain.`);if(r.length<2)throw Error(`Threshold scale on "${e}" must define at least two range entries.`);if(r.length!==n.length+1)throw Error(`Threshold scale on "${e}" requires range length of ${n.length+1}, got ${r.length}.`);return{domainLength:n.length,rangeLength:r.length}},normalizeStops:({name:e,scale:t,channel:n,domainLength:r,rangeLength:i})=>({domain:t.domain??[],range:wt(e,t.range,n.components??1,`threshold`),domainLength:r,rangeLength:i})},piecewise:{label:`Piecewise`,getLengths:({name:e,scale:t})=>{let n=Array.isArray(t.domain)?t.domain:[],r=Array.isArray(t.range)?t.range:[];if(n.length<2)throw Error(`Piecewise scale on "${e}" must define at least two domain entries.`);if(r.length<2)throw Error(`Piecewise scale on "${e}" must define at least two range entries.`);if(r.length!==n.length)throw Error(`Piecewise scale on "${e}" requires range length of ${n.length}, got ${r.length}.`);return{domainLength:n.length,rangeLength:r.length}},normalizeStops:({name:e,scale:t,channel:n,domainLength:r,rangeLength:i})=>({domain:t.domain??[],range:wt(e,t.range,n.components??1,`piecewise`),domainLength:r,rangeLength:i})}};function St(e){return xt[e]}function Ct(e,t,n){let r=st(n);if(r.getStopLengths){let i=r.getStopLengths({name:e,kind:t,scale:n});if(i)return i}return St(t).getLengths({name:e,scale:n})}function wt(e,t,n,r){let i=r===`threshold`?`Threshold`:`Piecewise`;if(!Array.isArray(t)||t.length<2)throw Error(`${i} scale on "${e}" must define at least two range entries.`);return t.map(t=>Tt(e,t,n,i))}function Tt(e,t,n,r){if(n===1){if(typeof t==`number`)return t;throw Error(`${r} scale on "${e}" expects numeric range values.`)}if(Array.isArray(t)){if(t.length===4)return t;if(t.length===3)return[...t,1]}if(typeof t==`string`)return[...yt(t),1];throw Error(`${r} scale on "${e}" expects vec4 range values or CSS colors.`)}function Et(e,t,n){if(!Array.isArray(t)||t.length===0)throw Error(`Ordinal scale on "${e}" must define at least one range entry.`);return t.map(t=>Tt(e,t,n,`Ordinal`))}function Dt(e){return!Array.isArray(e)||e.length===0?!1:e.every(e=>typeof e==`string`||Array.isArray(e)&&(e.length===3||e.length===4))}function Ot(e){if(e<=0)return[];if(e===1)return[0];let t=e-1,n=Array(e);for(let r=0;r<e;r++)n[r]=r/t;return n}function kt(e){return typeof e==`function`}function At(e,t){if(!e)return!1;let n=st(e),r=kt(e.range),i=Dt(e.range);return!(r||e.interpolate!==void 0||i)||t!==4?!1:n.continuous}var jt=4294967295,Mt=4294967295;function Nt(e){let t=e>>>0;return t^=t>>>16,t=Math.imul(t,2146121005),t^=t>>>15,t=Math.imul(t,2221713035),t^=t>>>16,t>>>0}function Pt(e,t){let n=[];for(let t of e)n.push([t,1]);return Ft(n,t)}function Ft(e,t={}){let n=Array.from(e),r=n.length,i=t.maxLoadFactor??.6;if(!(i>0&&i<1))throw Error(`maxLoadFactor must be between 0 and 1.`);let a=t.capacity??Lt(Math.ceil(r/i));if(!Number.isSafeInteger(a)||a<1)throw Error(`capacity must be a positive power of two.`);if(a&a-1)throw Error(`capacity must be a power of two.`);let o=new Uint32Array(a*2);for(let e=0;e<a;e+=1)o[e*2]=jt;let s=a-1;for(let[e,t]of n){let n=It(e,`key`);if(n===4294967295)throw Error(`Hash table keys must not equal the empty sentinel (0xffffffff).`);let r=It(t,`value`),i=Nt(n)&s,c=!1;for(let e=0;e<a;e+=1){let e=i*2,t=o[e];if(t===4294967295||t===n){o[e]=n,o[e+1]=r,c=!0;break}i=i+1&s}if(!c)throw Error(`Hash table insertion failed. Increase capacity or lower load factor.`)}return{table:o,capacity:a,size:r}}function It(e,t){if(!Number.isSafeInteger(e)||e<0||e>Mt)throw Error(`${t} must be a non-negative u32.`);return e>>>0}function Lt(e){let t=Math.max(1,e);return--t,t|=t>>>1,t|=t>>>2,t|=t>>>4,t|=t>>>8,t|=t>>>16,t+1}var Rt=class{constructor({device:e,channels:t,analysisByChannel:n,label:r=`mark`,getDefaultScaleRange:i,setUniformValue:a}){this._device=e,this._channels=t,this._label=r,this._getDefaultScaleRange=i,this._setUniformValue=a,this._analysisByChannel=n,this._channelResources=new Map,this._scaleUpdaters=new Map}_getAnalysis(e){let t=this._analysisByChannel.get(e);if(!t)throw Error(`Missing channel analysis for "${e}".`);return t}getChannelResources(e){return this._channelResources.get(e)}_ensureChannelResources(e){let t=this._channelResources.get(e);return t||(t={},this._channelResources.set(e,t)),t}_getScaleStopInfo(e){return this._channelResources.get(e)?.scaleStops}addScaleUniforms(e,t,n){let r=this._getAnalysis(t),i=lt(r.scaleDef,r.isPiecewise),a=i.stopKind;if(a){let{domainLength:i,rangeLength:o}=Ct(t,a,n.scale),s=r.outputComponents,c=r.useRangeTexture,l=s===1?r.outputScalarType:`f32`,u=c?1:s,d=c?`f32`:l;e.push({name:k+t,type:`f32`,components:1,arrayLength:i}),e.push({name:A+t,type:d,components:u,arrayLength:o})}let o=ut(r.scaleDef);for(let n of o.params)e.push({name:`${n.prefix}${t}`,type:`f32`,components:1});i.needsOrdinalRange&&e.push({name:j+t,type:`f32`,components:1}),i.needsDomainMap&&e.push({name:Ee+t,type:`f32`,components:1})}initializeScale(e,t,n){let r=this._getAnalysis(e),i=lt(r.scaleDef,r.isPiecewise),a=i.stopKind;if(a){let{domainLength:t,rangeLength:i}=Ct(e,a,n);this._ensureChannelResources(e).scaleStops={kind:a,domainLength:t,rangeLength:i},r.useRangeTexture&&i&&this._setUniformValue(A+e,Ot(i))}let o=ut(r.scaleDef);for(let t of o.params){let r=t.defaultValue;t.prop&&n[t.prop]!==void 0&&(r=n[t.prop]),this._setUniformValue(`${t.prefix}${e}`,r)}this._registerScaleUpdaters(e,t,n,r,i,a)}getScaleUpdater(e){let t=this._scaleUpdaters.get(e);if(!t)throw Error(`Missing scale updater for "${e}".`);return t}_registerScaleUpdaters(e,t,n,r,i,a){this._scaleUpdaters.set(e,this._buildScaleUpdater({name:e,channel:t,scale:n,analysis:r,requirements:i,kind:a}))}_buildScaleUpdater({name:e,channel:t,scale:n,analysis:r,requirements:i,kind:a}){let o=r.useRangeTexture,s=i.needsDomainMap,c=i.needsOrdinalRange,l=r.scaleDef,u=a,d=u?this._getScaleStopInfo(e):void 0,f=k+e,p=A+e,m=u===`continuous`?this._getDefaultScaleRange(e):void 0,h=r.outputComponents??1,g=h===1?r.outputScalarType:`f32`,_=t.scale?.interpolate,v=(e,t)=>{if(Array.isArray(e)||ArrayBuffer.isView(e))return e;throw Error(t)},y=e=>{if(!Array.isArray(e))return!1;for(let t=0;t<e.length;t++)if(typeof e[t]!=`number`)return!1;return!0},b=s?t=>{if(!l.normalizeDomainMap)throw Error(`Scale "${r.scaleType}" does not provide domain map normalization.`);if(!Array.isArray(t)&&!ArrayBuffer.isView(t))throw Error(`Scale on "${e}" requires an explicit domain array.`);let i=t,a=l.normalizeDomainMap({name:e,scale:n,domain:i});return a?{needsRebind:this._updateDomainMap(e,a.domainMap),domainUniform:a.domainUniform}:{needsRebind:!1}}:null,x=null,S=null;if(u)if(u===`continuous`){let t=d?.domainLength??2,r=l.normalizeDomain??(({name:e,domain:t,domainLength:n})=>{let r=v(t,`Scale on "${e}" expects a domain array.`);if(n&&r.length!==n)throw Error(`Scale domain for "${e}" expects ${n} entries, got ${r.length}.`);return r}),i=d?.rangeLength;x=i=>{let a=r({name:e,scale:n,domain:i,domainLength:t});a&&this._setUniformValue(f,a)},S=t=>{if(!Array.isArray(t))throw Error(`Scale on "${e}" expects a range array.`);if(i&&t.length!==i)throw Error(`Scale range for "${e}" expects ${i} entries, got ${t.length}.`);this._setUniformValue(p,t)}}else{if(!d)throw Error(`Scale on "${e}" has no recorded stop sizes.`);let t=d.domainLength,n=d.rangeLength,r=u===`threshold`?`Threshold`:`Piecewise`;x=n=>{let i=v(n,`${r} scale on "${e}" expects a domain array.`);if(i.length!==t)throw Error(`${r} scale on "${e}" expects ${t} domain entries, got ${i.length}.`);this._setUniformValue(f,i)},S=t=>{if(!Array.isArray(t))throw Error(`${r} scale on "${e}" expects a range array.`);if(t.length!==n)throw Error(`${r} scale on "${e}" expects ${n} range entries, got ${t.length}.`);if(h===1&&y(t)){this._setUniformValue(p,t);return}let i=wt(e,t,h,u);this._setUniformValue(p,i)}}return{updateDomain:x&&b?e=>{let t=b(e);return x(t.domainUniform??e),t.needsRebind}:x?e=>(x(e),!1):b?e=>{let t=b(e);return t.domainUniform&&this._setUniformValue(f,t.domainUniform),t.needsRebind}:()=>!1,updateRange:o?t=>this._updateRangeTexture(e,t,d?.rangeLength,_):c?t=>{if(kt(t))throw Error(`Ordinal scale on "${e}" does not support interpolator ranges.`);if(!Array.isArray(t))throw Error(`Ordinal scale on "${e}" expects a range array.`);let n=t,r=h===1&&y(n)?n:Et(e,n,h),i=this._buildOrdinalRangeBufferData(r,h,g);return this._setOrdinalRangeBuffer(e,i,r.length)}:u?t=>{if(kt(t))throw Error(`Scale on "${e}" does not support interpolator ranges.`);let n=t??(u===`continuous`?m??t:t);if(!Array.isArray(n))throw Error(`Scale on "${e}" expects a range array.`);return S(n),!1}:()=>!1}}_updateRangeTexture(e,t,n,r){let i=t,a;if(kt(i))a=ft(i);else{if(!Dt(i))throw Error(`Interpolated color scale on "${e}" requires a color range.`);let t=i;if(n!==void 0&&t.length!==n)throw Error(`Scale on "${e}" expects ${n} range entries, got ${t.length}.`);a=ft({scheme:t,mode:`interpolate`,interpolate:r})}if(!a)throw Error(`Failed to build range texture for "${e}".`);return this._setRangeTexture(e,a)}_setRangeTexture(e,t){let n=ve(t),r=this._ensureChannelResources(e),i=r.rangeTexture,a=!i||i.width!==n.width||i.height!==n.height||i.format!==n.format,o=a?this._device.createTexture({label:O(this._label,`scale ${e} range texture`),size:{width:n.width,height:n.height,depthOrArrayLayers:1},format:n.format,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}):i.texture;return this._device.queue.writeTexture({texture:o},E(n.data),{bytesPerRow:n.bytesPerRow},{width:n.width,height:n.height}),r.rangeTexture={texture:o,sampler:i?.sampler??this._device.createSampler({label:O(this._label,`scale ${e} range sampler`)}),width:n.width,height:n.height,format:n.format},a&&i?.texture.destroy(),a}_updateDomainMap(e,t){let n=this._buildDomainMapBufferData(t);return this._setDomainMapBuffer(e,n.table,n.length)}_buildDomainMapBufferData(e){if(e.length===0)return{table:new Uint32Array([jt,0]),length:0};let{table:t}=Ft(e.map((e,t)=>[e,t]));return{table:t,length:e.length}}_setDomainMapBuffer(e,t,n){let r=this._ensureChannelResources(e),i=r.domainMap,a=t.byteLength,o=r.domainMap?.buffer,s=!o||!i||i.size.byteLength!==a;if(s){let t=o;o=this._device.createBuffer({label:O(this._label,`scale ${e} domain map`),size:a,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),t?.destroy()}return this._device.queue.writeBuffer(o,0,E(t)),r.domainMap={buffer:o,size:{length:n,byteLength:a}},this._setUniformValue(Ee+e,n),s}_buildOrdinalRangeBufferData(e,t,n){if(t===1){let t=e;return n===`u32`?new Uint32Array(t):n===`i32`?new Int32Array(t):new Float32Array(t)}let r=new Float32Array(e.length*4);for(let t=0;t<e.length;t++)r.set(e[t],t*4);return r}_setOrdinalRangeBuffer(e,t,n){let r=this._ensureChannelResources(e),i=r.ordinalRange,a=t.byteLength,o=r.ordinalRange?.buffer,s=!o||!i||i.size.byteLength!==a;if(s){let t=o;o=this._device.createBuffer({label:O(this._label,`scale ${e} ordinal range`),size:a,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),t?.destroy()}return this._device.queue.writeBuffer(o,0,E(t)),r.ordinalRange={buffer:o,size:{length:n,byteLength:a}},this._setUniformValue(j+e,n),s}destroy(){for(let e of this._channelResources.values())e.ordinalRange?.buffer.destroy(),e.domainMap?.buffer.destroy(),e.rangeTexture?.texture.destroy();this._channelResources.clear(),this._scaleUpdaters.clear()}};function zt(e){return e===`u32`?`u32`:e===`i32`?`i32`:`f32`}function Bt(e){return e.data==null?e.value!=null||e.default!=null?`value`:`missing`:`series`}function Vt(e,t){let n=Bt(t),r=st(t.scale),i=ct(t.scale),a=t.components??1,o=zt(t.type),s=a===1?dt(r,o):`f32`,c=n===`series`||i===`identity`?a:1,l=t.inputComponents??c,u=t.scale?.range,d=kt(u),f=Dt(u),p=d||t.scale?.interpolate!==void 0||f,m=At(t.scale,a),h=bt(t.scale),g=lt(r,h),_=i!==`identity`||h||m||a!==l,v=g.needsOrdinalRange,y=g.needsDomainMap,b=r.continuous,x=r.vectorOutput??`never`,S=a>1&&l===1&&i!==`identity`&&(x===`always`||x===`interpolated`&&p);return{name:e,channel:t,sourceKind:n,scaleType:i,scaleDef:r,outputComponents:a,inputComponents:l,scalarType:o,outputScalarType:s,useRangeTexture:m,isPiecewise:h,needsScaleFunction:_,needsOrdinalRange:v,needsDomainMap:y,stopKind:g.stopKind,interpolateEnabled:p,allowsScalarToVector:S,isContinuousScale:b,rangeIsFunction:d,rangeIsColor:f}}function Ht(e){return e===`f32`||e===`u32`||e===`i32`}function Ut(e,t,n){let{scaleType:r,outputComponents:i,inputComponents:a,allowsScalarToVector:o,isContinuousScale:s,rangeIsFunction:c,rangeIsColor:l,isPiecewise:u,needsDomainMap:d,scalarType:f,outputScalarType:p,scaleDef:m,interpolateEnabled:h}=n,g=m?.vectorOutput??`never`,_=g===`always`||g===`interpolated`&&h,v=_&&o;if(i>1&&!(i===1||(r===`identity`?a===i:_)))return`Channel "${e}" uses vector components but scale "${r}" only supports scalars.`;if(c&&!s)return`Channel "${e}" only supports function ranges with continuous scales.`;if(c&&i!==4)return`Channel "${e}" requires vec4 outputs when using function ranges.`;if(t.scale?.interpolate!==void 0){if(!l)return`Channel "${e}" requires a color range when interpolate is set.`;if(!s)return`Channel "${e}" only supports color interpolation with continuous scales.`;if(i!==4)return`Channel "${e}" requires vec4 outputs when interpolate is set.`}if(s&&!c&&l&&i!==4)return`Channel "${e}" requires vec4 outputs when using color ranges.`;let y=m?.input??`any`;if(y===`numeric`&&!Ht(f))return`Channel "${e}" requires numeric input for "${r}" scale.`;if(y===`u32`&&f!==`u32`)return`Channel "${e}" requires u32 input for "${r}" scale.`;if(i>1&&f!==`f32`&&!v)return`Only f32 vectors are supported for "${e}" right now.`;let b=a===2&&i===1&&f===`u32`&&!!m?.allowsPackedScalarInput;return a>1&&f!==`f32`&&!b?`Only f32 vectors are supported for "${e}" input data.`:a!==i&&!v&&!b?`Channel "${e}" only supports mismatched input/output components when mapping scalars to vectors.`:m?.validate?.({name:e,channel:t,scaleType:r,outputComponents:i,inputComponents:a,scalarType:f,outputScalarType:p,isPiecewise:u,needsDomainMap:d,allowsScalarToVector:o,isContinuousScale:s,rangeIsFunction:c,rangeIsColor:l})||null}function Wt({channels:e,context:t}){let n={},r=new Map,{channelOrder:i}=t;for(let a of i){let i=Gt({name:a,configChannel:e?.[a],context:t});i&&(n[a]=i.channel,r.set(a,i.analysis))}return Kt(n,r,t),{channels:n,analysisByChannel:r}}function Gt({name:e,configChannel:t,context:n}){let{channelOrder:r,optionalChannels:i,defaultChannelConfigs:a,defaultValues:o,channelSpecs:s}=n,c={...a[e]??{},...t??{}};if(c.components||=1,w(c)&&!c.inputComponents&&(c.inputComponents=(c.scale?.type??`identity`)===`identity`?c.components:1),w(c)&&(t?.value!==void 0||t?.default!==void 0))throw Error(`Channel "${e}" must not specify both data and value.`);return w(c)&&(delete c.value,delete c.default),!w(c)&&c.value===void 0&&(c.default===void 0?o[e]!==void 0&&(c.value=o[e]):c.value=c.default),i.includes(e)&&!w(c)&&!T(c)?null:{channel:c,analysis:Yt(e,c,{channelOrder:r,optionalChannels:i,channelSpecs:s})}}function Kt(e,t,n){let r=0;for(let[i,a]of Object.entries(e)){let o=a.conditions??[];if(!o.length)continue;let s=[];for(let a of o){let o={...a,when:qt(a.when)};if(!(`channel`in a)||!a.channel){s.push(o);continue}let c=`${i}__cond${r++}`,l=Jt({name:i,analysisName:c,configChannel:a.channel,context:n});e[c]=l.channel,t.set(c,l.analysis),s.push({...o,channelName:c})}a.conditions=s}}function qt(e){return e.type===`interval`?{...e,targets:e.targets.map(e=>({...e,...e.secondaryInput!==void 0&&e.hitTest===void 0?{hitTest:`intersects`}:{}}))}:{...e}}function Jt({name:e,analysisName:t,configChannel:n,context:r}){let{channelOrder:i,channelSpecs:a}=r,o={...n??{}};if(o.conditions!==void 0)throw Error(`Channel "${e}" conditions must not nest other conditions.`);if(o.default!==void 0)throw Error(`Channel "${e}" conditions must not include defaults.`);if(o.components||=a[e]?.components??1,w(o)&&!o.inputComponents&&(o.inputComponents=(o.scale?.type??`identity`)===`identity`?o.components:1),w(o)&&o.value!==void 0)throw Error(`Channel "${e}" conditions must not specify both data and value.`);if(!w(o)&&o.value===void 0)throw Error(`Channel "${e}" conditions must specify either data or value.`);return w(o)&&(delete o.value,delete o.default),{channel:o,analysis:Yt(e,o,{channelOrder:i,optionalChannels:[],channelSpecs:a},t)}}function Yt(e,t,n,r=e){let{channelOrder:i,optionalChannels:a,channelSpecs:o}=n;if(!i.includes(e))throw Error(`Unknown channel: ${e}`);let s=o[e];if(s?.components&&t.components!==s.components)throw Error(`Channel "${e}" must use ${s.components} components`);let c=Vt(r,t),{scaleDef:l,outputComponents:u}=c,d=(l.allowsU32InputOverride===!0&&s?.type===`f32`&&t.type===`u32`||l.allowsF32InputOverride===!0&&s?.type===`u32`&&t.type===`f32`)&&(u===1||u===4);if(s?.type&&t.type&&t.type!==s.type&&!d)throw Error(`Channel "${e}" must use type "${s.type}"`);if(!a.includes(e)&&!w(t)&&!T(t))throw Error(`Channel "${e}" must specify either data or value.`);if(w(t)&&!t.type)throw Error(`Channel "${e}" requires a series data type.`);if(a.includes(e)&&!w(t)&&!T(t))return c;if(t.components&&![1,2,4].includes(t.components))throw Error(`Invalid component count for "${e}"`);if(t.inputComponents&&![1,2,4].includes(t.inputComponents))throw Error(`Invalid input component count for "${e}"`);let f=Ut(e,t,c);if(f)throw Error(f);if(t.conditions!==void 0&&!Array.isArray(t.conditions))throw Error(`Channel "${e}" conditions must be an array.`);if(Array.isArray(t.conditions))for(let n of t.conditions){if(!n||typeof n!=`object`)throw Error(`Channel "${e}" has an invalid condition entry.`);if(!n.when||typeof n.when!=`object`)throw Error(`Channel "${e}" conditions require a "when" predicate.`);let{when:t,value:r}=n;if(typeof t.selection!=`string`||t.selection.length<1)throw Error(`Channel "${e}" conditions require a selection name.`);if(t.type!==`single`&&t.type!==`multi`&&t.type!==`interval`)throw Error(`Channel "${e}" has invalid selection type "${t.type}".`);if(Object.hasOwn(t,`channel`))throw Error(`Selection "${t.selection}" uses the obsolete "channel" form; specify targets.`);if(Object.hasOwn(t,`secondaryChannel`))throw Error(`Selection "${t.selection}" uses the obsolete "secondaryChannel" form; specify secondaryInput.`);if(t.type===`interval`){if(!Array.isArray(t.targets)||t.targets.length===0)throw Error(`Interval selection "${t.selection}" must specify a non-empty targets array.`);let n=new Set;for(let r of t.targets){if(!r||typeof r!=`object`)throw Error(`Interval selection "${t.selection}" has an invalid target.`);if(typeof r.input!=`string`||r.input.length===0)throw Error(`Interval selection "${t.selection}" targets require an input name.`);if(n.has(r.input))throw Error(`Interval selection "${t.selection}" cannot target "${r.input}" more than once.`);if(n.add(r.input),r.secondaryInput!==void 0&&(typeof r.secondaryInput!=`string`||r.secondaryInput.length===0))throw Error(`Interval selection "${t.selection}" has an invalid secondary input.`);if(r.hitTest!==void 0&&r.hitTest!==`intersects`&&r.hitTest!==`encloses`&&r.hitTest!==`endpoints`)throw Error(`Interval selection "${t.selection}" has invalid hit-test mode "${r.hitTest}".`);if(r.hitTest!==void 0&&r.secondaryInput===void 0)throw Error(`Interval selection "${t.selection}" cannot specify a hit-test mode without a secondary input.`);if(r.input!==void 0&&!i.includes(r.input))throw Error(`Channel "${e}" references unknown selection input "${r.input}".`);if(r.secondaryInput!==void 0&&!i.includes(r.secondaryInput))throw Error(`Channel "${e}" references unknown selection input "${r.secondaryInput}".`)}}else if(Object.hasOwn(t,`targets`))throw Error(`Selection "${t.selection}" may only specify targets for interval selections.`);if(t.empty!==void 0&&typeof t.empty!=`boolean`)throw Error(`Selection "${t.selection}" empty flag must be boolean.`);if(n.channel){if(r!==void 0)throw Error(`Channel "${e}" conditions must not specify both channel and value.`);let t=n.channel;if(!t||typeof t!=`object`)throw Error(`Channel "${e}" conditions must include a channel config.`);if(`conditions`in t&&t.conditions!==void 0)throw Error(`Channel "${e}" conditions must not nest other conditions.`);if(`default`in t&&t.default!==void 0)throw Error(`Channel "${e}" conditions must not include defaults.`);if(!w(t)&&!T(t))throw Error(`Channel "${e}" conditions must supply data or value.`);if(w(t)&&!t.type)throw Error(`Channel "${e}" conditions require a series data type.`);continue}if(r===void 0)throw Error(`Channel "${e}" conditions require a value.`);if(c.outputComponents===1){if(typeof r!=`number`)throw Error(`Channel "${e}" conditions require scalar values.`)}else if(!Array.isArray(r)||r.length!==c.outputComponents)throw Error(`Channel "${e}" conditions require ${c.outputComponents}-component values.`)}return c}var Xt=`
...
`;function Zt(e){let t=new Set,n=new Set,r=[];function i(e){if(!n.has(e)){if(t.has(e))throw Error(`Scale WGSL dependency cycle: ${e.type}`);t.add(e);for(let t of e.wgslDeps??[])i(t);e.wgsl&&r.push(e.wgsl),t.delete(e),n.add(e)}}for(let t of e)i(t);return`${Xt}\n${r.join(`
`)}`}var Qt=`
...
`;function $t(e){return`hashLookup_${e}`}function en(e){return`
fn ${$t(e)}(key: u32, maxProbes: u32) -> u32 {
...
`}function tn(e,t){let n=[],r=!0,i=[];for(let[a,o]of e.split(/\r?\n/).entries()){let e=o.trim();if(!e.startsWith(`#`)){r&&i.push(o);continue}let s=e.match(/^#([A-Za-z]+)\b(.*)$/);if(!s)throw P(a,`Malformed directive`);let[,c,l]=s,u=l.trim();if(c===`if`){let e=nn(u,t);n.push({parentActive:r,condition:e,elseSeen:!1}),r&&=e}else if(c===`else`){if(u)throw P(a,`#else does not accept an argument`);let e=n.at(-1);if(!e)throw P(a,`#else has no matching #if`);if(e.elseSeen)throw P(a,`#if block contains more than one #else`);e.elseSeen=!0,r=e.parentActive&&!e.condition}else if(c===`endif`){if(u)throw P(a,`#endif does not accept an argument`);let e=n.pop();if(!e)throw P(a,`#endif has no matching #if`);r=e.parentActive}else throw P(a,`Unsupported directive #${c}`)}if(n.length)throw Error(`Unterminated shader #if block.`);return i.join(`
`)}function nn(e,t){let n=rn(e),r=0,i=()=>n[r],a=()=>n[r++];function o(){if(i()===`!`)return a(),!o();if(i()===`(`){a();let e=c();if(a()!==`)`)throw Error(`Expected ")" in shader condition.`);return e}if(a()!==`defined`||a()!==`(`)throw Error(`Expected defined(NAME) in shader condition.`);let e=a();if(!e||!/^[A-Za-z_][A-Za-z0-9_]*$/.test(e))throw Error(`Expected a symbol name in defined(NAME).`);if(a()!==`)`)throw Error(`Expected ")" after shader symbol name.`);return t.has(e)}function s(){let e=o();for(;i()===`&&`;){a();let t=o();e&&=t}return e}function c(){let e=s();for(;i()===`||`;){a();let t=s();e||=t}return e}if(!n.length)throw Error(`Shader #if requires a condition.`);let l=c();if(r!==n.length)throw Error(`Unexpected token "${n[r]}" in shader condition.`);return l}function rn(e){let t=[],n=/defined|[A-Za-z_][A-Za-z0-9_]*|&&|\|\||!|\(|\)/gy,r=0;for(;r<e.length;){if(/\s/.test(e[r])){r+=1;continue}n.lastIndex=r;let i=n.exec(e);if(!i)throw Error(`Unexpected token near "${e.slice(r)}" in shader condition.`);t.push(i[0]),r=n.lastIndex}return t}function P(e,t){return Error(`${t} at shader line ${e+1}.`)}function an(e,t,n){let r=e===`u32`?`u32`:e===`i32`?`i32`:`f32`,i=t=>{let n=Number(t??0);return e===`u32`?`u32(${Math.trunc(n)})`:e===`i32`?`i32(${Math.trunc(n)})`:Number.isInteger(n)?`${n}.0`:`${n}`};if(t===1)return i(Array.isArray(n)?n[0]:n);let a=(Array.isArray(n)?n:[n]).slice(0,t);for(;a.length<t;)a.push(0);return`vec${t}<${r}>(${a.map(i).join(`, `)})`}var F={BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1}.DEV??!1;function on({name:e,scaleDef:t,functionName:n,rawValueExpr:r,scalarType:i,inputComponents:a,outputComponents:o,outputScalarType:s,scaleConfig:c,domainMapName:l=null,useRangeTexture:u=!1}){let d=Array.isArray(c?.domain)?c.domain.length:0,f=Array.isArray(c?.range)?c.range.length:0,p=bt(c);if(u&&o!==4)throw Error(`Channel "${e}" requires vec4 output when using interpolate textures.`);let m=c?.round===!0&&o===1&&!u;return t.emit({name:e,functionName:n,scaleConfig:c,rawValueExpr:r,inputScalarType:i,inputComponents:a,outputComponents:o,outputScalarType:s,clamp:c?.clamp===!0,round:m,domainLength:d,rangeLength:f,isPiecewise:p,domainMapName:l,useRangeTexture:u})}function sn(e){return`u_scalar_${e}`}function cn(e){if(e===void 0)return;function t(e){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`Visibility predicate nodes must be objects.`);let n=e,r=[`compare`,`selection`,`all`,`any`].filter(e=>Object.hasOwn(n,e));if(r.length!==1)throw Error(`Visibility predicate nodes must specify exactly one of compare, selection, all, or any.`);let i=r[0];if(i===`all`||i===`any`){let e=n[i];if(!Array.isArray(e)||e.length===0)throw Error(`Visibility predicate ${i} nodes must not be empty.`);e.forEach(t)}return e}return t(e)}function ln({predicate:e,channelIRs:t,channelNames:n,inputNames:r,scalarSlots:i,selectionDefs:a}){e=cn(e);let o=new Map(t.map(e=>[e.name,e])),s=new Set(a.map(e=>e.name));function c(e){if(!e||typeof e!=`object`)throw Error(`Visibility predicate operands must be objects.`);let t=Object.keys(e);if(t.length!==1)throw Error(`Visibility predicate operands must specify exactly one namespace.`);let a=t[0],s=e[a];if(typeof s!=`string`||s.length===0)throw Error(`Visibility predicate ${a} operands require a name.`);if(a===`channel`){if(!n.has(s))throw Error(`Visibility predicate references unknown channel "${s}".`);return l(s,o.get(s))}if(a===`input`){if(!r.has(s))throw Error(`Visibility predicate references unknown input "${s}".`);return l(s,o.get(s))}if(a===`slot`){let e=i[s];if(!e)throw Error(`Visibility predicate references unknown slot "${s}".`);return{expression:`params.${sn(s)}`,type:e.type}}throw Error(`Visibility predicate has unsupported operand namespace "${a}".`)}function l(e,t){if(!t)throw Error(`Visibility predicate references unavailable input "${e}".`);if(t.inputComponents!==1)throw Error(`Visibility predicate input "${e}" must be scalar, got ${t.inputComponents} components.`);return{expression:t.rawValueExpr,type:t.scalarType}}function u(e){if(`compare`in e){if(e.compare!==`<`&&e.compare!==`<=`&&e.compare!==`>`&&e.compare!==`>=`)throw Error(`Visibility predicate has unsupported comparison "${e.compare}".`);let t=c(e.left),n=c(e.right);if(t.type!==n.type)throw Error(`Visibility predicate comparison types must match: ${t.type} and ${n.type}.`);return`(${t.expression} ${e.compare} ${n.expression})`}if(`selection`in e){if(typeof e.selection!=`string`||!s.has(e.selection))throw Error(`Visibility predicate references unknown selection "${e.selection}".`);if(e.empty!==void 0&&typeof e.empty!=`boolean`)throw Error(`Visibility predicate selection "${e.selection}" empty policy must be boolean.`);return`${Be}${e.selection}(i, ${e.empty===!0?`true`:`false`})`}if(`all`in e||`any`in e){let t=`all`in e?`&&`:`||`;return`(${(`all`in e?e.all:e.any).map(u).join(` ${t} `)})`}throw Error(`Visibility predicate has an unsupported node shape.`)}return`
fn isInstanceVisible(i: u32) -> bool {
    return ${e?u(e):`true`};
}
`}function un({compiledChannels:e,uniformLayout:t,shaderBody:n,packedSeriesLayout:r,selectionDefs:i=[],visibleWhen:a,scalarSlots:o={},extraResources:s=[],placementIndex:c}){let{channels:l,channelIRs:u,channelNames:d,inputNames:f}=e,p=c&&`source`in c&&c.source===`draw`,m=[],h=[],g={},_=[],v=[],y=[],b=[],x=[];function S(e,t=e.name){return`fn ${ke}${t}(i: u32) -> ${e.outputComponents===1?e.outputScalarType:`vec${e.outputComponents}<f32>`} { return ${e.rawValueExpr}; }`}let C=1,ee=GPUShaderStage.VERTEX|GPUShaderStage.COMPUTE,te=u.filter(e=>e.sourceKind===`series`),ne=u.filter(e=>e.sourceKind===`uniform`||e.sourceKind===`literal`),re=u.filter(e=>e.needsOrdinalRange),ie=u.filter(e=>e.needsDomainMap),ae=u.filter(e=>e.useRangeTexture),oe=new Set(t.map(({name:e})=>e)),se=new Map(u.map(e=>[e.name,e])),ce=new Map(i.map(e=>[e.name,e])),le=ln({predicate:a,channelIRs:u,channelNames:d,inputNames:f,scalarSlots:o,selectionDefs:i}),ue=e=>(g[e]||(g[e]={}),g[e]);function de(e){let t=`${Be}${e.name}`,n=se.get(`uniqueId`);if(F&&(e.type===`single`||e.type===`multi`)&&!n)throw Error(`Selection "${e.name}" requires a uniqueId channel.`);switch(e.type){case`single`:return`
...
`;case`multi`:{let r=ze+e.name,i=$t(r);return`
fn ${t}(i: u32, allowEmpty: bool) -> bool {
...
`}case`interval`:{let n=e.targets??[];if(F&&n.length===0)throw Error(`Interval selection "${e.name}" must have at least one target.`);return`
fn ${t}(i: u32, allowEmpty: bool) -> bool {
    var matches = true;
${n.map((t,n)=>{let r=se.get(t.input),i=t.secondaryInput?se.get(t.secondaryInput):null;if(F&&!r)throw Error(`Selection "${e.name}" references missing input "${t.input}".`);if(F&&t.secondaryInput&&!i)throw Error(`Selection "${e.name}" references missing input "${t.secondaryInput}".`);if(F&&t.hitTest!==void 0&&t.hitTest!==`intersects`&&!t.secondaryInput)throw Error(`Selection "${e.name}" cannot specify a hit-test mode without a secondary input.`);let a=Ve(e.name,n),o=He(e.name,n),s=r?.rawValueExpr??`0.0`,c=i?.rawValueExpr??null,l=t.hitTest??`intersects`,u;if(!c)u=`${o}_lo <= ${s} && ${s} <= ${o}_hi`;else if(l===`encloses`)u=`${o}_lo <= ${o}_dLo && ${o}_dHi <= ${o}_hi`;else if(l===`endpoints`)u=`(${o}_lo <= ${o}_d0 && ${o}_d0 <= ${o}_hi) || (${o}_lo <= ${o}_d1 && ${o}_d1 <= ${o}_hi)`;else if(l===`intersects`)u=`${o}_dHi >= ${o}_lo && ${o}_dLo <= ${o}_hi`;else throw Error(`Selection "${e.name}" has unsupported hit-test mode "${l}".`);return`
    if (params.${a} == 0u) {
...
${(e.channel.conditions??[]).map(e=>{let t=e.when.selection,a=ce.get(t);if(F&&!a)throw Error(`Channel "${n}" references unknown selection "${t}".`);let o=e.when.empty===!0?`true`:`false`;return e.channelName?`    if (${Be}${t}(i, ${o})) { return ${ke}${e.channelName}(i); }`:`    if (${Be}${t}(i, ${o})) { return ${an(r===1?i:`f32`,r,e.value)}; }`}).join(`
`)}
    return ${ke}${t}(i);
}
`}let T=new Set;for(let e of Object.keys(l))T.add(`${e}_DEFINED`);c&&(T.add(`PLACEMENT_ENABLED`),p&&T.add(`DRAW_PLACEMENT`));let fe=new Set,pe=r??new Map;if(F&&te.length>0&&pe.size===0)throw Error(`Packed series layout is required for series channels.`);for(let e of pe.values())if(e.scalarType===`f32`||e.scalarType===`u32`||e.scalarType===`i32`)fe.add(e.scalarType);else if(F)throw Error(`Packed series only supports f32/u32/i32. Found "${e.scalarType}".`);if(fe.has(`f32`)){let e=C++;m.push({binding:e,visibility:ee,buffer:{type:`read-only-storage`}}),h.push({name:`seriesF32`,role:`series`}),_.push(`@group(1) @binding(${e}) var<storage, read> seriesF32: array<f32>;`)}if(fe.has(`u32`)){let e=C++;m.push({binding:e,visibility:ee,buffer:{type:`read-only-storage`}}),h.push({name:`seriesU32`,role:`series`}),_.push(`@group(1) @binding(${e}) var<storage, read> seriesU32: array<u32>;`)}if(fe.has(`i32`)){let e=C++;m.push({binding:e,visibility:ee,buffer:{type:`read-only-storage`}}),h.push({name:`seriesI32`,role:`series`}),_.push(`@group(1) @binding(${e}) var<storage, read> seriesI32: array<i32>;`)}for(let e of te){let{name:t}=e;if(e.inputComponents>1&&e.scalarType!==`f32`&&!(e.scalarType===`u32`&&e.inputComponents===2&&e.scaleType===`index`))throw Error(`Channel "${t}" does not support non-f32 vector inputs.`);let n=pe.get(t);if(F&&!n)throw Error(`Packed series layout is missing entry for "${t}".`);if(F&&n.scalarType!==e.scalarType)throw Error(`Packed series type mismatch for "${t}". Expected ${e.scalarType}, got ${n.scalarType}.`);if(F&&n.components!==e.inputComponents)throw Error(`Packed series component mismatch for "${t}". Expected ${e.inputComponents}, got ${n.components}.`);let r=n.scalarType===`f32`?`seriesF32`:n.scalarType===`u32`?`seriesU32`:`seriesI32`,i=n.offset,a=n.stride;n.components===1?v.push(`fn read_${t}(i: u32) -> ${n.scalarType} {
    return ${r}[${i}u + i * ${a}u];
...
`,Xn=class extends On{_resolveAntialiasing(){return Jn(this._channels)}get channelOrder(){return Un}get optionalChannels(){return Kn}get channelSpecs(){return Hn}get defaultChannelConfigs(){return Gn}get defaultValues(){return Wn}get shaderBody(){return`const USE_MULTISAMPLE_EDGE_COVERAGE = ${this.antialiasing===`multisample`};\n${Yn}`}getDefaultScaleRange(e){if(this.renderer?._globals){if(e===`x`||e===`x2`)return[0,this.renderer._globals.width];if(e===`y`||e===`y2`)return[0,this.renderer._globals.height]}}},Zn=Object.freeze({type:`rect`,createProgram(e,t,n){return new Xn(e,t,n)}}),Qn=`
...
`,resources:{stopKind:`continuous`,needsDomainMap:!0,needsOrdinalRange:!1},normalizeDomainMap:li,normalizeStops:ci,validate:si,emit:oi};Object.freeze(ai);function oi({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,domainMapName:i}){let a=rt(n,r),o=Ee+e;return i?`${tt(e,`f32`,t)} {
    let raw = ${a};
    ...
    let mapped = ${$t(i)}(raw, arrayLength(&${i}));
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},getStopLengths:()=>({domainLength:3,rangeLength:2}),normalizeStops:gi,normalizeDomain:_i,emit:hi};Object.freeze(mi);function hi({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,inputComponents:i}){let a=i===2?n:rt(n,r),o=i===2?`scaleBandHpU`:`scaleBandHp`;return`${tt(e,`f32`,t)} {
    let v = ${a};
    return ${o}(
        v,
        ${nt(e)},
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:ji};Object.freeze(Ai);function ji(e){return it(e,({name:e,valueExpr:t})=>`scalePow(${t}, ${M(e)}, ${N(e)}, params.${je}${e})`)}var Mi=Ai;function Ni(e={}){return I(Mi,e)}var Pi={type:`quantize`,input:`numeric`,output:`same`,params:[],continuous:!1,vectorOutput:`always`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},getStopLengths:Li,normalizeStops:Ri,validate:Ii,emit:Fi};Object.freeze(Pi);function Fi({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,outputComponents:i,outputScalarType:a,rangeLength:o}){if(o<1)throw Error(`Quantize scale on "${e}" must define at least one range entry.`);let s=i===1?a:`vec${i}<f32>`,c=[];return r!==`f32`&&c.push(Je(r)),c.push(et({name:e,rangeLength:o,outputComponents:i,outputScalarType:a})),qe({name:e,functionName:t,rawValueExpr:n,steps:c,returnType:s})}function Ii({name:e,channel:t,outputComponents:n,inputComponents:r}){if(n!==1&&n!==4)return`Channel "${e}" uses ${n} components but quantize scales only support scalars or vec4 outputs.`;if(r!==1)return`Quantize scale on "${e}" requires scalar input values.`;let i=t.scale?.domain;if(Array.isArray(i)&&i.length!==2)return`Quantize scale on "${e}" requires a domain with exactly two entries.`;let a=t.scale?.range;return a!==void 0&&!Array.isArray(a)?`Quantize scale on "${e}" requires an explicit array range.`:Array.isArray(a)&&a.length<1?`Quantize scale on "${e}" requires at least one range entry.`:null}function Li({scale:e}){let t=Array.isArray(e.range)?e.range:[0,1];if(t.length<1)throw Error(`Quantize scale on "${e.type}" requires at least one range entry.`);return{domainLength:2,rangeLength:t.length}}function Ri({name:e,scale:t,channel:n,getDefaultScaleRange:r}){let i=Array.isArray(t.domain)?t.domain:[0,1];if(i.length!==2)throw Error(`Quantize scale on "${e}" requires a domain with exactly two entries.`);if(kt(t.range))throw Error(`Quantize scale on "${e}" does not support interpolator ranges.`);let a=n.components??1,o=Array.isArray(t.range)?t.range:r(e)??[0,1];if(!Array.isArray(o)||o.length<1)throw Error(`Quantize scale on "${e}" requires at least one range entry.`);let s=o.map(t=>Tt(e,t,a,`Quantize`));return{domain:[i[0]??0,i[1]??1],range:s,domainLength:2,rangeLength:s.length}}var zi=Pi;function Bi(e={}){return I(zi,e)}var Vi={type:`sqrt`,input:`numeric`,output:`f32`,params:[{prefix:je,defaultValue:.5,prop:`exponent`}],continuous:!0,vectorOutput:`interpolated`,wgslDeps:[Ai],resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:Hi};Object.freeze(Vi);function Hi(e){return it(e,({name:e,valueExpr:t})=>`scalePow(${t}, ${M(e)}, ${N(e)}, params.${je}${e})`)}var Ui=Vi;function Wi(e={}){return I(Ui,e)}var Gi={type:`symlog`,input:`numeric`,output:`f32`,params:[{prefix:Me,defaultValue:1,prop:`constant`}],continuous:!0,vectorOutput:`interpolated`,wgslDeps:[An],wgsl:`
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:Ki};Object.freeze(Gi);function Ki(e){return it(e,({name:e,valueExpr:t})=>`scaleSymlog(${t}, ${M(e)}, ${N(e)}, params.${Me}${e})`)}var qi=Gi;function Ji(e={}){return I(qi,e)}var Yi={type:`threshold`,input:`numeric`,output:`same`,params:[],continuous:!1,vectorOutput:`always`,allowsF32InputOverride:!0,resources:{stopKind:`threshold`,needsDomainMap:!1,needsOrdinalRange:!1},validate:Zi,emit:Xi};Object.freeze(Yi);function Xi({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,outputComponents:i,outputScalarType:a,domainLength:o,rangeLength:s}){if(o<1||s!==o+1)throw Error(`Threshold scale on "${e}" requires domain length N and range length N+1.`);let c=i===1?a:`vec${i}<f32>`,l=[];return r!==`f32`&&l.push(Je(r)),l.push($e({name:e,domainLength:o,outputComponents:i,outputScalarType:a})),qe({name:e,functionName:t,rawValueExpr:n,steps:l,returnType:c})}function Zi({name:e,channel:t,outputComponents:n,inputComponents:r}){if(n!==1&&n!==4)return`Channel "${e}" uses ${n} components but threshold scales only support scalars or vec4 outputs.`;let i=t.scale?.domain,a=t.scale?.range;return!Array.isArray(i)||i.length===0?`Threshold scale on "${e}" requires a non-empty domain.`:!Array.isArray(a)||a.length<2?`Threshold scale on "${e}" requires at least two range entries.`:a.length===i.length+1?r===1?null:`Threshold scale on "${e}" requires scalar input values.`:`Threshold scale on "${e}" requires range length of ${i.length+1}, got ${a.length}.`}var Qi=Yi;function $i(e={}){return I(Qi,e)}var ea=new Map([`circle`,`square`,`cross`,`diamond`,`triangle-up`,`triangle-right`,`triangle-down`,`triangle-left`,`tick-up`,`tick-right`,`tick-down`,`tick-left`,`x`,`+`].map((e,t)=>[e,t])),ta=new Map([[`left`,0],[`center`,1],[`right`,2]]),na=new Map([[`alphabetic`,0],[`baseline`,0],[`middle`,1],[`top`,2],[`bottom`,3]]),ra=new Map([[`butt`,0],[`square`,1],[`round`,2]]),ia=new Map([[`forward`,0],[`reverse`,1]]),aa=new Map([`none`,`diagonal`,`antiDiagonal`,`cross`,`vertical`,`horizontal`,`grid`,`dots`,`rings`,`ringsLarge`].map((e,t)=>[e,t])),oa=[`viewportEdgeFadeWidthTop`,`viewportEdgeFadeWidthRight`,`viewportEdgeFadeWidthBottom`,`viewportEdgeFadeWidthLeft`],sa=[`viewportEdgeFadeDistanceTop`,`viewportEdgeFadeDistanceRight`,`viewportEdgeFadeDistanceBottom`,`viewportEdgeFadeDistanceLeft`],ca=new WeakMap,la=new WeakMap;function ua(e,t,n,r=1,i,a){ma(e);let o=typeof r==`function`?r:()=>r,s=i??y(e,t);if(s.length==0)return;let c=e.encoders.facetIndex?{data:ha(e,s),type:`u32`}:a,l=e.getType();if(l==`point`)return da(Vn,R(xa(e,s,n,o),c));if(l==`rect`)return da(Zn,R(ba(e,s,n,o,typeof r!=`function`),c));if(l==`rule`||l==`tick`)return da(sr,R(wa(e,s,n,o),c));if(l==`text`)return da(ri,R(Ta(e,s,n,o),c));if(l==`link`)return da(br,R(Ea(e,s,n,o),c));if(l==`arrow`)return da(Nr,R(Da(e,s,n,o),c));throw X(e,`Mark type "${l}" is not supported.`)}function da(e,t){let n=t.retainedProperties??{};return delete t.retainedProperties,{definition:e,config:t,properties:n}}function fa(e){return ma(e),e.getRenderingRevision(`configuration`)}function pa(e){return ma(e),e.getRenderingRevision(`resources`)}function ma(e){e.initializeRenderingRevisions([])}function R(e,t){return t?{...e,placementIndex:t}:e}function ha(e,t){let n=e.encoders.facetIndex,r=la.get(e);if(r?.data===t&&r.encoder===n)return r.values;let i=new Uint32Array(t.length);for(let r=0;r<t.length;r++){let a=Number(n(t[r]));if(!Number.isInteger(a)||a<0||a>4294967295)throw X(e,`Facet indices must be non-negative integers.`);i[r]=a}return la.set(e,{data:t,encoder:n,values:i}),i}function ga(e,t,n,r){let i=to(e,t),a=i.branches,o=a.at(-1);if(!o)throw X(e,`Channel "${t}" has no fallback branch.`);let s=r(_a(e,i,o),o);return a.length==1||(s.conditions=a.slice(0,-1).map(n=>{let a=r(_a(e,i,n),n);return{when:va(e,t,n.predicate),channel:a}})),s}function _a(e,t,n){let r=n.accessor,i=r.scaleChannel?e.unitView.getScaleResolution(r.scaleChannel)?.getScale():t.scale;if(r.scaleChannel&&!i)throw X(e,`Missing scale for conditional channel "${r.channel}".`);return Object.assign(e=>r(e),{constant:r.constant??t.constant,branches:[n],scale:i,channelDef:r.channelDef??t.channelDef})}function va(e,n,r){if(!r.param)throw X(e,`Conditional channel "${n}" has no selection parameter.`);let i=e.unitView.paramRuntime.findValue(r.param);if(!i||![`single`,`multi`,`interval`].includes(i.type))throw X(e,`Selection "${r.param}" is not available for WebGPU.`);let a={selection:r.param,type:i.type,empty:r.empty??!0};if(i.type==`interval`){let n=a;return n.targets=Object.keys(i.intervals).map(n=>{if(n!=`x`&&n!=`y`)throw X(e,`Interval selection "${r.param}" has unsupported target "${String(n)}".`);ya(e,r.param,n);let i=t(n),a={input:n};return e.encoders[i]?(ya(e,r.param,i),{...a,secondaryInput:i,hitTest:e.defaultHitTestMode}):a}),n}return a}function ya(e,t,n){let r=e.encoders[n]?.scale;if(r&&(r.type==`index`||r.type==`locus`)&&d(r.domain().map(Number)))throw X(e,`Interval selection "${t}" cannot target two-component channel "${n}".`)}function ba(e,t,n,r,i){return e.initializeRenderingRevisions([`cornerRadius`,`cornerRadiusTopRight`,`cornerRadiusBottomRight`,`cornerRadiusTopLeft`,`cornerRadiusBottomLeft`,`minWidth`,`minHeight`,`minOpacity`,`shadowOffsetX`,`shadowOffsetY`,`shadowBlur`,`shadowOpacity`,`shadowColor`,`hatch`]),{count:t.length,channels:{...$a(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),fill:H(e,`fill`,t),stroke:H(e,`stroke`,t),fillOpacity:V(e,`fillOpacity`,t,r),strokeOpacity:V(e,`strokeOpacity`,t,r),strokeWidth:B(e,`strokeWidth`,t,!0),cornerRadiusTopRight:mo(e,[`cornerRadius`,`cornerRadiusTopRight`],()=>fo(e).topRight),cornerRadiusBottomRight:mo(e,[`cornerRadius`,`cornerRadiusBottomRight`],()=>fo(e).bottomRight),cornerRadiusTopLeft:mo(e,[`cornerRadius`,`cornerRadiusTopLeft`],()=>fo(e).topLeft),cornerRadiusBottomLeft:mo(e,[`cornerRadius`,`cornerRadiusBottomLeft`],()=>fo(e).bottomLeft),minWidth:Y(()=>K(e,`minWidth`)),minHeight:Y(()=>K(e,`minHeight`)),minOpacity:Y(()=>K(e,`minOpacity`)),shadowOffsetX:Y(()=>q(e,`shadowOffsetX`,0)),shadowOffsetY:Y(()=>q(e,`shadowOffsetY`,0)),shadowBlur:Y(()=>q(e,`shadowBlur`,0)),shadowOpacity:mo(e,[`shadowOpacity`],()=>q(e,`shadowOpacity`,0)*r(),void 0,!i),shadowColor:Y(()=>yo(e,J(e,`shadowColor`)??`black`)),hatchPattern:mo(e,[`hatch`],()=>po(e,`hatch`,aa,`none`),`u32`)}}}function xa(e,t,n,r){e.initializeRenderingRevisions([`fillGradientStrength`,`inwardStroke`,`semanticZoomFraction`]);let i=Sa(e,t);return{count:t.length,channels:{...$a(e,t),x:z(e,`x`,t,n),y:z(e,`y`,t,n),size:B(e,`size`,t),shape:Ia(e,`shape`,t,ea),strokeWidth:B(e,`strokeWidth`,t),xOffset:B(e,`xOffset`,t),yOffset:B(e,`yOffset`,t),dx:Ua(e,`x`,t),dy:Ua(e,`y`,t),fill:H(e,`fill`,t),stroke:H(e,`stroke`,t),fillOpacity:V(e,`fillOpacity`,t,r),strokeOpacity:V(e,`strokeOpacity`,t,r),angle:B(e,`angle`,t),gradientStrength:Y(()=>K(e,`fillGradientStrength`)),inwardStroke:Y(()=>+!!J(e,`inwardStroke`),`u32`)},...i}}function Sa(e,t){let n=e.encoders.semanticScore;if(!n||(no(e,`semanticScore`,n),n.constant))return{};let r=n.branches[0].accessor,i=W(e,`semanticScore`,t,r),a=Ca(e),o={compare:`>=`,left:{input:`semanticScoreInput`},right:{slot:`semanticThreshold`}},s=a.length>0?{any:[...a,o]}:o;return{inputs:{semanticScoreInput:{data:i,type:`f32`}},scalarSlots:{semanticThreshold:ho(()=>e.getSemanticThreshold(),`f32`)},visibleWhen:s}}function Ca(e){if(!e.encoders.uniqueId)return[];let t=[],n=new Set;for(let r of Object.values(e.encoders))for(let i of r.branches??[]){let r=i.predicate;if(!r?.param||n.has(r.param))continue;let a=va(e,`semanticScore`,r);t.push({...a,empty:!1}),n.add(r.param)}return t}function wa(e,t,n,r){e.initializeRenderingRevisions([`minLength`,`strokeCap`,`strokeDashOffset`]);let i=J(e,`strokeDash`);return{count:t.length,channels:{...$a(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),size:B(e,`size`,t),color:H(e,`color`,t),opacity:V(e,`opacity`,t,r),minLength:Y(()=>K(e,`minLength`)),strokeCap:Y(()=>po(e,`strokeCap`,ra),`u32`),strokeDashOffset:Y(()=>K(e,`strokeDashOffset`)),strokeDash:{value:0,type:`u32`}},dashPatterns:i==null?null:[i]}}function Ta(e,t,n,r){let i=Wa(e,`size`,t[0]),a=e.encoders,o=e.font;return{count:t.length,channels:{...$a(e,t),x:z(e,`x`,t,n,Ka),...e.encoders.x2?{x2:z(e,`x2`,t,n,Ka)}:{},y:z(e,`y`,t,n,Ka),...e.encoders.y2?{y2:z(e,`y2`,t,n,Ka)}:{},text:Ha(e,t),size:B(e,`size`,t),angle:B(e,`angle`,t),xOffset:B(e,`xOffset`,t),yOffset:B(e,`yOffset`,t),dx:Ua(e,`x`,t),dy:Ua(e,`y`,t),...a.x2Offset?{x2Offset:B(e,`x2Offset`,t)}:{},...a.y2Offset?{y2Offset:B(e,`y2Offset`,t)}:{},align:{value:po(e,`align`,ta),type:`u32`},baseline:{value:po(e,`baseline`,na),type:`u32`},fill:H(e,`color`,t),opacity:V(e,`opacity`,t,r)},font:Oa(e),...o?.metrics&&o.bitmapUrl?{fontResource:{metrics:o.metrics,bitmap:o.bitmapUrl}}:{},fontStyle:J(e,`fontStyle`),fontWeight:J(e,`fontWeight`),fontSize:i,viewport:[n.x,n.y,n.x2,n.y2],viewportEdgeFadeWidth:co(e,oa,[0,0,0,0]),viewportEdgeFadeDistance:co(e,sa,[-1/0,-1/0,-1/0,-1/0]),paddingX:K(e,`paddingX`),paddingY:K(e,`paddingY`),flushX:!!J(e,`flushX`),flushY:!!J(e,`flushY`),squeeze:!!J(e,`squeeze`),logoLetters:!!J(e,`logoLetters`),retainedProperties:{viewport:go(()=>[n.x,n.y,n.x2,n.y2]),...vo(e,`viewportEdgeFadeWidth`,oa,[0,0,0,0]),...vo(e,`viewportEdgeFadeDistance`,sa,[-1/0,-1/0,-1/0,-1/0]),..._o(e,{paddingX:e=>e,paddingY:e=>e,flushX:e=>!!e,flushY:e=>!!e,squeeze:e=>!!e,logoLetters:e=>!!e})}}}function Ea(e,t,n,r){return{count:t.length,channels:{...$a(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),size:B(e,`size`,t),color:H(e,`color`,t),opacity:V(e,`opacity`,t,r)},linkShape:J(e,`linkShape`)??`arc`,orient:J(e,`orient`)??`vertical`,arcFadingDistance:uo(e,`arcFadingDistance`),arcHeightFactor:q(e,`arcHeightFactor`,1),minArcHeight:q(e,`minArcHeight`,1.5),clampApex:!!J(e,`clampApex`),maxChordLength:q(e,`maxChordLength`,5e4),segments:q(e,`segments`,101),retainedProperties:_o(e,{arcFadingDistance:e=>e??[0,0],arcHeightFactor:e=>e,minArcHeight:e=>e,linkShape:e=>e??`arc`,orient:e=>e??`vertical`,clampApex:e=>!!e,maxChordLength:e=>e,segments:e=>e})}}function Da(e,t,n,r){let i=q(e,`headAngle`,45),a=q(e,`headNotchAngle`,90);return{count:t.length,channels:{...$a(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),fill:H(e,`fill`,t),stroke:H(e,`stroke`,t),fillOpacity:V(e,`fillOpacity`,t,r),strokeOpacity:V(e,`strokeOpacity`,t,r),strokeWidth:B(e,`strokeWidth`,t),size:B(e,`size`,t),direction:Ia(e,`direction`,t,ia)},headAngle:i,headNotchAngle:a,minSize:q(e,`minSize`,1),headWidth:q(e,`headWidth`,3),startNotch:!!J(e,`startNotch`),minStemLength:q(e,`minStemLength`,0),headSpacing:lo(e,`headSpacing`),stem:J(e,`stem`)!==!1,headShape:J(e,`headShape`)??`triangle`,headPlacement:J(e,`headPlacement`)??`inside`,retainedProperties:_o(e,{headAngle:e=>e,headNotchAngle:e=>e,minSize:e=>e,headWidth:e=>e,startNotch:e=>!!e,minStemLength:e=>e,headSpacing:e=>e,stem:e=>e!==!1,headShape:e=>e??`triangle`,headPlacement:e=>e??`inside`})}}function Oa(e){let t=J(e,`font`);if(t==null||t==`sans-serif`)return`Lato`;if(typeof t==`string`)return t;throw X(e,`Font "${String(t)}" is not supported.`)}function z(e,t,n,r,i=Ga){return ga(e,t,n,a=>ka(e,t,n,r,a,i))}function ka(e,t,n,r,i,o){let s=i.branches[0].accessor,c=a(i.channelDef)?void 0:i.scale,l=o(t,r,c),u=i.channelDef.band??.5;if(c?.type==`band`||c?.type==`point`||c?.type==`ordinal`){let{intern:a,readDomain:d}=so(e,t,c),f=i.constant?Y(()=>a(s(n[0])),`u32`):{data:G(e,t,n,s,()=>Uint32Array.from(n,e=>a(s(e)))),type:`u32`};return Object.assign(f,{scale:c.type==`ordinal`?ja(c,o(t,r,void 0),d):Aa(c,l,d,u)})}else if(c?.type==`index`||c?.type==`locus`){let r=d(c.domain().map(Number)),a=i.constant?ao(e,t,()=>s(n[0]),r):{data:ro(e,t,n,s,r),type:`u32`};return Object.assign(a,{...r?{inputComponents:2}:{},scale:Ma(c,l,u)})}let f=i.constant?Y(()=>{let r=Number(s(n[0]));if(!Number.isFinite(r))throw X(e,`Channel "${t}" is not finite.`);return r},`f32`):{data:W(e,t,n,s),type:`f32`};return Object.assign(f,{scale:qa(e,t,c,l)})}function Aa(e,t,n,r){let i=e;return U(di({domain:n(),range:t,paddingInner:e.type==`point`?1:i.paddingInner(),paddingOuter:i.paddingOuter(),align:i.align(),band:r}),n)}function ja(e,t,n){let r=()=>e.range().map(e=>t[0]+Number(e)*(t[1]-t[0]));return U(ki({domain:n(),range:r()}),n,r)}function Ma(e,t,n){let r=e;return U(yi({domain:e.domain().map(Number),range:t,paddingInner:r.paddingInner(),paddingOuter:r.paddingOuter(),align:r.align(),band:n}),()=>e.domain().map(Number))}function B(e,t,n,r=!1){return ga(e,t,n,i=>r&&Na(i)?{value:Number(i(n[0]))}:Pa(e,t,n,i))}function Na(e){let t=e.channelDef;return e.constant&&!e.scale&&(a(t)&&!c(t.value)||n(t)&&!c(t.datum))}function Pa(e,t,n,r){if(r.constant)return Y(()=>Number(r(n[0])));let i=r.branches[0].accessor;if(r.scale?.type==`ordinal`||r.scale?.type==`band`||r.scale?.type==`point`){let{values:a,readDomain:o}=oo(e,t,n,i,r.scale);return{data:a,type:`u32`,scale:r.scale.type==`ordinal`?Ja(e,t,r.scale,1,o):Aa(r.scale,r.scale.range(),o,r.channelDef.band??.5)}}let a={data:W(e,t,n,i),type:`f32`},o=Ja(e,t,r.scale);return o?{...a,scale:o}:a}function V(e,t,n,r){return ga(e,t,n,i=>Fa(e,t,n,r,i))}function Fa(e,t,n,r,i){if(i.constant)return Y(()=>Number(i(n[0]))*r());let a=i.branches[0].accessor;if(i.scale?.type==`ordinal`){let{values:o,readDomain:s}=oo(e,t,n,a,i.scale);return{data:o,type:`u32`,scale:Ja(e,t,i.scale,r,s)}}let o=i.scale?.type==`identity`?void 0:Ja(e,t,i.scale,r);return o?{data:W(e,t,n,a),type:`f32`,scale:o}:{data:W(e,t,n,a),type:`f32`,scale:U(L({domain:[0,1],range:[0,r()]}),void 0,()=>[0,r()])}}function Ia(e,t,n,r){return ga(e,t,n,i=>La(e,t,n,r,i))}function La(e,t,n,r,i){if(i.constant)return Y(()=>Za(e,t,r,i(n[0])),`u32`);let a=i.branches[0].accessor;if(i.scale?.type==`ordinal`){let{values:o,readDomain:s}=oo(e,t,n,a,i.scale);return{data:o,type:`u32`,scale:U(ki({domain:s(),range:i.scale.range().map(n=>Za(e,t,r,n))}),s,()=>i.scale.range().map(n=>Za(e,t,r,n)))}}return i.scale?.type==`threshold`?{data:W(e,t,n,a),type:`f32`,scale:U($i({domain:i.scale.domain().map(Number),range:Qa(e,t,r,i.scale)}),()=>i.scale.domain().map(Number),()=>Qa(e,t,r,i.scale))}:{data:G(e,t,n,a,()=>Uint32Array.from(n,n=>Za(e,t,r,a(n)))),type:`u32`}}function H(e,t,n){return ga(e,t,n,r=>Ra(e,t,n,r))}function Ra(e,t,n,r){if(r.constant)return Y(()=>yo(e,r(n[0])));let i=r.branches[0].accessor,a=r.scale;if(!a)return{data:G(e,t,n,i,()=>{let t=new Float32Array(n.length*4);return n.forEach((n,r)=>{t.set(yo(e,i(n)),r*4)}),t}),type:`f32`,inputComponents:4};if(a.type==`ordinal`){let{values:r,readDomain:o}=oo(e,t,n,i,a);return{data:r,type:`u32`,inputComponents:1,scale:za(e,t,a,o)}}return{data:W(e,t,n,i),type:`f32`,inputComponents:1,scale:za(e,t,a)}}function za(e,t,n,r){let i=n;if(n.type==`ordinal`)return U(ki({domain:r?.(),range:n.range()}),r,()=>n.range());if(n.type==`sequential-linear`||n.type==`diverging-linear`)return U(L({domain:Va(n),range:i.interpolator(),clamp:i.clamp()}),()=>Va(n),()=>i.interpolator());if(n.type==`sequential-log`)return U(Ci({domain:Va(n),range:i.interpolator(),base:i.base(),clamp:i.clamp()}),()=>Va(n),()=>i.interpolator());if(n.type==`linear`)return U(L({domain:n.domain().map(Number),range:n.range(),interpolate:i.interpolate(),clamp:i.clamp()}),()=>n.domain().map(Number),()=>n.range());if(n.type==`threshold`)return U($i({domain:n.domain().map(Number),range:Ba(e,n.range())}),()=>n.domain().map(Number),()=>Ba(e,n.range()));if(n.type==`quantize`)return U(Bi({domain:n.domain().map(Number),range:Ba(e,n.range())}),()=>n.domain().map(Number),()=>Ba(e,n.range()));throw X(e,`Scale type "${n.type}" on channel "${t}" is not supported.`)}function Ba(e,t){return t.map(t=>typeof t==`string`?yo(e,t):t)}function Va(e){let t=e.domain().map(Number);return[t[0],t.at(-1)]}function Ha(e,t){let n=to(e,`text`);no(e,`text`,n);let r=n.channelDef,i=`format`in r?o(r.format):e=>e,a=e=>{let t=i(n(e));return t==null?``:String(t)};return n.constant?{value:a(t[0])}:{data:G(e,`text`,t,n.branches[0].accessor,()=>t.map(a))}}function Ua(e,t,n){let r=t==`x`?`dx`:`dy`,i=e.encoders[r];if(!i)return Y(()=>K(e,r));no(e,r,i);let a=_a(e,i,i.branches[0]),o=e=>Number(a(e));return a.constant?Y(()=>o(n[0])):{data:Float32Array.from(n,o),type:`f32`}}function Wa(e,t,n){let r=to(e,t),i=Number(r(n));if(!Number.isFinite(i))throw X(e,`Channel "${t}" is not finite.`);return i}function Ga(e,t,n){let r=n?.props?.reverse;return e[0]==`x`?r?[t.x2,t.x]:[t.x,t.x2]:r?[t.y,t.y2]:[t.y2,t.y]}function Ka(e,t,n){let r=n?.props?.reverse;return e[0]==`x`?r?[t.width,0]:[0,t.width]:r?[0,t.height]:[t.height,0]}function qa(e,t,n,r){return!n||n.type==`null`?L({domain:[0,1],range:r}):Ya(e,t,n,r)}function Ja(e,t,n,r=1,i){if(!n||n.type==`null`)return;if(n.type==`identity`)return pi();let a=typeof r==`function`?r:()=>r;return Ya(e,t,n,()=>n.range().map(e=>Number(e)*a()),i)}function Ya(e,t,n,r,i){let a=n,o=typeof i==`function`?i:i?()=>i:()=>n.domain().map(Number),s=typeof r==`function`?r:()=>r,c={domain:o(),range:s(),clamp:Xa(a,`clamp`,!1)};Xa(a,`round`,!1)&&(c.round=!0);let l;switch(n.type){case`linear`:case`sequential-linear`:case`diverging-linear`:l=L(c);break;case`log`:l=Ci({...c,base:Xa(a,`base`,10)});break;case`pow`:l=Ni({...c,exponent:Xa(a,`exponent`,1)});break;case`sqrt`:l=Wi(c);break;case`symlog`:l=Ji({...c,constant:Xa(a,`constant`,1)});break;case`quantize`:l=Bi(c);break;case`threshold`:l=$i(c);break;case`ordinal`:l=ki(c);break;default:throw X(e,`Scale type "${n.type}" on channel "${t}" is not supported.`)}return U(l,o,s)}function U(e,t,n){return Object.defineProperties(e,{...t?{domain:{enumerable:!0,get:t}}:{},...n?{range:{enumerable:!0,get:n}}:{}}),e}function Xa(e,t,n){let r=e[t];return typeof r==`function`?r():r??n}function Za(e,t,n,r){let i=n.get(String(r));if(i===void 0)throw X(e,`Unsupported ${t}: ${String(r)}`);return i}function Qa(e,t,n,r){let i=r.domain(),a=r.range().map(r=>Za(e,t,n,r));for(;a.length<i.length+1;)a.push(a.at(-1));return a}function $a(e,t){let n=e.encoders.uniqueId;if(!n)return{};if(no(e,`uniqueId`,n),n.constant)return{uniqueId:Y(()=>eo(e,`uniqueId`,n(t[0])),`u32`)};let r=n.branches[0].accessor;return{uniqueId:{data:G(e,`uniqueId`,t,r,()=>Uint32Array.from(t,t=>eo(e,`uniqueId`,r(t)))),type:`u32`}}}function eo(e,t,n){let r=Number(n);if(!Number.isSafeInteger(r)||r<0||r>4294967295)throw X(e,`Channel "${t}" must contain u32 integers.`);return r}function to(e,t){let n=e.encoders[t];if(!n)throw X(e,`Missing encoder for channel "${t}".`);return n}function no(e,t,n){if(n.branches.length!=1)throw X(e,`Conditional channel "${t}" is not supported.`)}function W(e,t,n,r){return G(e,t,n,r,()=>Float32Array.from(n,n=>{let i=Number(r(n));if(!Number.isFinite(i)&&!Number.isNaN(i))throw X(e,`Channel "${t}" contains an infinite value.`);return i}))}function ro(e,t,n,r,i){return G(e,`${t}:${i?`large`:`regular`}`,n,r,()=>{let a=Array.from(n,n=>io(e,t,r(n)));return i?le(a):Uint32Array.from(a)})}function io(e,t,n){let r=Math.floor(Number(n));if(!Number.isSafeInteger(r)||r<0)throw X(e,`Channel "${t}" must contain finite non-negative values within the safe integer range.`);return r}function ao(e,t,n,r){if(!r)return Y(()=>io(e,t,n()),`u32`);let i=[0],a=new Uint32Array(2),o=[0,0];return Y(()=>(i[0]=io(e,t,n()),ue(i,a),o[0]=a[0],o[1]=a[1],o),`u32`)}function oo(e,t,n,r,i){let{intern:a,readDomain:o}=so(e,t,i);return{values:G(e,t,n,r,()=>Uint32Array.from(n,e=>a(r(e)))),readDomain:o}}function so(e,t,n){let r=n.props?.domainIndexer,i=n=>eo(e,t,r?r(n):n);return{intern:i,readDomain:()=>n.domain().map(i)}}function G(e,t,n,r,i){if(!(`field`in r.channelDef))return i();let a=ca.get(e);(!a||a.data!==n)&&(a={data:n,channels:new Map},ca.set(e,a));let o=a.channels.get(t);if(o?.accessor===r)return o.series;let s=i();return a.channels.set(t,{accessor:r,series:s}),s}function K(e,t){let n=J(e,t);if(typeof n!=`number`)throw X(e,`Property "${t}" must be a number for the WebGPU renderer.`);return n}function co(e,t,n){return t.map((t,r)=>q(e,t,n[r]))}function q(e,t,n){let r=J(e,t)??n;if(typeof r!=`number`)throw X(e,`Property "${t}" must be a number for the WebGPU renderer.`);return r}function lo(e,t){let n=J(e,t);if(n==null)return null;if(typeof n!=`number`)throw X(e,`Property "${t}" must be a number for the WebGPU renderer.`);return n}function uo(e,t){let n=J(e,t);if(n==null||n===!1)return[0,0];if(!Array.isArray(n)||n.length!=2||!n.every(e=>typeof e==`number`))throw X(e,`Property "${t}" must be a pair.`);return n}function fo(e){let t=K(e,`cornerRadius`);return{topRight:q(e,`cornerRadiusTopRight`,t),bottomRight:q(e,`cornerRadiusBottomRight`,t),topLeft:q(e,`cornerRadiusTopLeft`,t),bottomLeft:q(e,`cornerRadiusBottomLeft`,t)}}function po(e,t,n,r){let i=String(J(e,t)??r),a=n.get(i);if(a===void 0)throw X(e,`Unsupported ${t}: ${i}`);return a}function J(e,t){let n=e.properties[t];return b(e,n)}function Y(e,t){return Object.assign(ho(e,t),{dynamic:!0})}function mo(e,t,n,r,i=!1){let a=e.properties;return i||t.some(e=>c(a[e]))?Y(n,r):{value:n(),...r?{type:r}:{}}}function ho(e,t){return{get value(){return e()},...t?{type:t}:{}}}function go(e){return{get value(){return e()}}}function _o(e,t){e.initializeRenderingRevisions(Object.keys(t));let n={};for(let[r,i]of Object.entries(t)){let t=e.properties[r];c(t)&&(n[r]=go(()=>i(J(e,r))))}return n}function vo(e,t,n,r){let i=e.properties,a=n.filter(e=>c(i[e]));return e.initializeRenderingRevisions(a),a.length==0?{}:{[t]:go(()=>co(e,n,r))}}function yo(e,t){if(t==null)return[0,0,0,0];let n=l(String(t));if(!n)throw X(e,`Invalid color: ${String(t)}`);let r=n.rgb();return[r.r/255,r.g/255,r.b/255,r.opacity]}function X(e,t){let n=Error(`${t} Mark: ${e.getType()}. View: ${e.unitView.getPathString()}`);return n.view=e.unitView,n}var bo=new WeakMap;function xo(e,t){let n=e.unitView.getCollector();if(!n)throw Error(`Cannot render an uninitialized mark. View: ${e.unitView.getPathString()}`);let r=t?.getSnapshot().topology,i=e.encoders?.x,a=e.encoders?.x2,o=i?e.unitView.getScaleResolution(`x`):void 0,s=o?.zoomExtent,c=bo.get(e);if(c?.collector===n&&c.revision===n.dataRevision&&c.topology===r&&c.xEncoder===i&&c.x2Encoder===a&&c.xScaleResolution===o&&c.xIndexDomainStart===s?.[0]&&c.xIndexDomainEnd===s?.[1])return c;let l=n.facetBatches.get(void 0),u=x(e),d=new Map,f,p;if(l?.length)p=l,d.set(l,So(u,p,0));else{let e=r?r.facetIds.map(e=>e?n.facetBatches.get(e)??[]:[]):Array.from(n.facetBatches.values());p=Array(e.reduce((e,t)=>e+t.length,0)),r&&(f=[]);let t=0;for(let n=0;n<e.length;n++){let r=e[n],i=So(u,r,t);f?.push(i),d.set(r,i);for(let e of r)p[t++]=e}}let m={collector:n,revision:n.dataRevision,topology:r,xEncoder:i,x2Encoder:a,xScaleResolution:o,xIndexDomainStart:s?.[0],xIndexDomainEnd:s?.[1],xIndexSpec:u,data:p,ranges:d,placementRanges:f};return bo.set(e,m),m}function So(e,t,n){let r={firstInstance:n,instanceCount:t.length};if(!e||!t.length)return r;v(`webgpuXIndexBuilds`);let i=C(e,t,n);return i?(r.xIndex=i,r):(v(`webgpuXIndexRejectedBuilds`),r)}function Co(e,t,n){let r=t.placement?.index;return(r===void 0?void 0:n.placementRanges?.[r])??n.ranges.get(y(e,t))??{firstInstance:0,instanceCount:0}}var wo=class extends m{#e=[];#t=new Set;#n=new Map;#r=[];#i=[];#a=0;#o=!1;#s;#c;constructor(e){if(super({}),this.surface=e.surface,e.target)this.#c=e.target;else{let t=e.surface.getLogicalCanvasSize();this.#c={width:t.width,height:t.height,dpr:e.surface.getDevicePixelRatio()}}this.#s=e.markPredicate}getDevicePixelRatio(){return this.#c.dpr}beginSampleFacetBatch(){if(this.#a)throw Error(`Nested sample facet batches are not supported.`);this.#a++,this.#r.push({type:`beginSampleFacetBatch`})}endSampleFacetBatch(){if(!this.#a)throw Error(`Unbalanced sample facet batch scope.`);this.#a--,this.#r.push({type:`endSampleFacetBatch`})}pushView(e,t){this.#t.add(e),this.#e.push({view:e,coords:t}),this.#r.push({type:`pushView`,view:e,coords:[t],localOpacity:!1,clipX:!1,clipY:!1,bounds:Mo()})}popView(e){if(this.#e.pop()?.view!==e)throw Error(`Unbalanced WebGPU view rendering context stack.`);this.#r.push({type:`popView`})}renderMark(e,t){if(this.#o)throw Error(`Cannot collect WebGPU marks after finishing.`);if(this.#s&&!this.#s(e))return;let n=this.currentCoords,r=n.translate(ie,ie),a=this.#n.get(e);a||(a={mark:e,occurrences:[],packed:void 0,source:void 0,generatedSource:!1,facetIndexed:e.encoders.facetIndex!==void 0,xQueryDomain:[0,0],xIndexedRange:[0,0],xQueryEnabled:!1,updated:!1,active:!1,ownerCoords:void 0,definition:void 0,config:void 0,properties:void 0,configRevision:-1,resourceRevision:-1,resourcesDirty:!0,configX:NaN,configY:NaN,configWidth:NaN,configHeight:NaN,viewport:void 0,generatedRectangles:void 0},this.#n.set(e,a));let o=i(t),c={state:a,options:t,coords:n,markCoords:r,clip:s(o,e.properties.clip,n),cullClip:o,cull:e.properties.cullByVisibleRange,range:{firstInstance:0,instanceCount:0},placementIndex:a.occurrences.length,draw:void 0};a.occurrences.push(c),this.#r.push({type:`occurrence`,occurrence:c}),v(`markOccurrences`)}finish(){if(this.#o)throw Error(`The WebGPU rendering context is already finished.`);if(this.#e.length)throw Error(`Cannot finish with an open WebGPU view scope.`);if(this.#a)throw Error(`Cannot finish with an open sample facet batch.`);this.#o=!0;let e=p.create(0,0,this.#c.width,this.#c.height);for(let t of this.#n.values())this.#f(t,e);this.#i=To(this.#r),this.#u()}render(){return this.#l(!1)}renderPicking(){return this.#l(!0)}#l(e){if(!this.#o)throw Error(`Cannot render an unfinished WebGPU frame plan.`);for(let e of this.#t)_(`onBeforeRender`,()=>e.onBeforeRender()),v(`viewsVisited`);e||this.#d();let t=this.#c;for(let n of this.#n.values())n.updated=!1,n.active=!1,this.#p(n,e,t);let n=[],r=[],i=n,a=0,o=0,s=0;for(let n of e?this.#r:this.#i)if(n.type===`occurrence`){let r=this.#h(n.occurrence,e,t,i);r!==void 0&&(a++,o+=+(r>0),s+=r)}else if(n.type===`pushView`)if(e)r.push(void 0);else{let e=jo(n);i.push(e),r.push(i),i=e.items}else if(n.type===`popView`){let e=r.pop();e&&(i=e)}return v(`retainedMarkSyncChecks`,a),v(`retainedMarkSyncChanges`,o),v(`retainedResourceWrites`,s),n}#u(){let e,t=``;for(let n of this.#i)if(n.type===`pushView`){n.view!==e&&(e=n.view,t=n.view.getPathString()),n.label=t;let i=r(n.view);n.localOpacity=n.view.hasLocalOpacity(),n.clipX=i.clipX,n.clipY=i.clipY}}#d(){for(let e of this.#i)e.type===`pushView`&&zo(e,this.#c)}#f(e,t){let n=new Set(e.occurrences.map(t=>{let n=t.options.placement;return e.facetIndexed||n?.index!==void 0?n?.source:void 0}).filter(Boolean));if(n.size>1)throw Bo(e.mark,`One logical mark cannot use several placement sources.`);let r=n.values().next().value;if(e.generatedSource=!r&&e.occurrences.length>1,e.generatedSource){let n=e.generatedRectangles=new Float32Array(e.occurrences.length*4);Lo(e,t,n),e.source=this.surface.updateOccurrencePlacements(e.mark,n),e.ownerCoords=t}else e.source=r,e.ownerCoords=e.occurrences[0].markCoords;if(e.facetIndexed&&!e.source)throw Bo(e.mark,`Indexed placement requires a placement source.`);e.source&&(e.viewport=Mo());for(let t of e.occurrences)t.draw=No(t,e);this.#m(e)}#p(e,t,n){if(e.generatedRectangles&&(Lo(e,n,e.generatedRectangles),this.surface.updateOccurrencePlacements(e.mark,e.generatedRectangles)),e.viewport&&Io(e.viewport,e.ownerCoords),e.mark.unitView.getEffectiveOpacity()<=0||t&&!e.mark.isPickingParticipant())return;this.#m(e);let r=xo(e.mark,e.facetIndexed||!e.generatedSource?e.source:void 0);if(!r.data.length)return;e.xQueryEnabled=!e.facetIndexed&&!!r.xIndexSpec&&S(r.xIndexSpec,e.xQueryDomain),e.xQueryEnabled||v(`webgpuXIndexFallbackQueries`);let i=fa(e.mark),a=e.packed!==r,o=e.configRevision!==i,s=e.source?0:e.ownerCoords.x,c=e.source?0:e.ownerCoords.y,l=e.ownerCoords.width,u=e.ownerCoords.height,d=e.configX!==s||e.configY!==c||e.configWidth!==l||e.configHeight!==u;if(a||o||d){v(a?`markConfigurationPackedMiss`:o?`markConfigurationExpressionMiss`:`markConfigurationGeometryMiss`);let t=e.occurrences[0],n=e.source?p.create(0,0,e.ownerCoords.width,e.ownerCoords.height):e.ownerCoords,d=_(`markConfiguration`,()=>ua(e.mark,t.options,n,1,r.data,Po(e)));e.packed=r,e.definition=d?.definition,e.config=d?.config,e.properties=d?.properties,e.configRevision=i,e.configX=s,e.configY=c,e.configWidth=l,e.configHeight=u}if(a)for(let t of e.occurrences)t.range=Co(e.mark,t.options,r);let f=pa(e.mark);e.resourcesDirty||=f===void 0||a||o||d||e.resourceRevision!==f,e.resourceRevision=f??-1,e.active=!!e.config}#m(e){if(!e.source||e.generatedSource)return;let t=e.source.getSnapshot().topology.revision;for(let n of e.occurrences){let r=n.options.placement?.topologyRevision;if(r!==void 0&&r!==t)throw Bo(e.mark,`Placement topology changed after layout completion.`)}}#h(e,t,n,r){let i=e.state;if(!i.active||!i.config||!i.definition||!i.packed)return;let a=e.range;if(!a.instanceCount)return;let o=e.draw;if(!o)throw Error(`Occurrence draw has not been compiled.`);Fo(e,i,o,n);let s=i.generatedSource?e.placementIndex:e.options.placement?.index,c=i.facetIndexed?void 0:s;if(i.source&&!i.facetIndexed&&c===void 0)throw Bo(i.mark,`Draw-level placement requires a resolved placement index.`);if(i.source&&s!==void 0&&!Ro(i.source,s,i.viewport,o.scissor,n))return;let l=a.firstInstance,u=a.instanceCount;if(i.xQueryEnabled&&a.xIndex){if(a.xIndex(i.xQueryDomain[0],i.xQueryDomain[1],i.xIndexedRange),l=i.xIndexedRange[0],u=i.xIndexedRange[1]-l,v(`webgpuXIndexQueries`),v(`webgpuXIndexNativeItems`,a.instanceCount),v(`webgpuXIndexCandidateItems`,u),!u){v(`webgpuXIndexEmptyRanges`);return}}else i.xQueryEnabled&&v(`webgpuXIndexFallbackQueries`);let d;return i.updated||(i.updated=!0,i.resourcesDirty&&=(d=_(`retainedResourceSynchronization`,()=>this.surface.updateMark(i.mark,i.definition,i.config,i.properties??{})),!1)),o.firstInstance=l,o.instanceCount=u,o.placement&&(o.placement.index=c),this.surface.prepareDraw(i.mark,o,i.source),r.push(o),v(`drawCommands`),d}get currentCoords(){let t=e(this.#e);if(!t)throw Error(`No current view in WebGPU rendering context.`);return t.coords}};function To(e){let t=[],n,r=[];for(let i of e)i.type===`beginSampleFacetBatch`?n=Eo():i.type===`endSampleFacetBatch`?(Ao(n,t),n=void 0):n?i.type===`occurrence`?Oo(n,i.occurrence.state.mark,i):i.type===`pushView`?(r.push(n),n=ko(n,i)):n=r.pop():t.push(i);return t}function Eo(){return{slots:new Map,ordered:[]}}function Do(e,t){let n=e.slots.get(t);return n||(n={items:[]},e.slots.set(t,n),e.ordered.push(n)),n}function Oo(e,t,n){Do(e,t).items.push(n)}function ko(e,t){let n=Do(e,t.view);return n.command?n.command.coords.push(...t.coords):(n.command=t,n.collector=Eo()),n.collector}function Ao(e,t){for(let n of e.ordered)n.command&&n.collector?(t.push(n.command),Ao(n.collector,t),t.push({type:`popView`})):t.push(...n.items)}function jo(e){let t={bounds:e.bounds,items:[],label:e.label};return e.localOpacity&&(t.opacity=e.view.getOpacity()),t}function Mo(){return{x:0,y:0,width:0,height:0}}function No(e,t){let n={mark:{markId:-1},firstInstance:0,instanceCount:0};return t.viewport&&(n.viewport=t.viewport),e.clip&&(n.scissor=Mo()),e.cull&&(n.visibleRange={x1:0,y1:0,x2:0,y2:0,cullX:e.cull===!0||e.cull===`x`,cullY:e.cull===!0||e.cull===`y`}),t.source&&(n.placement={set:{placementSetId:-1},...e.options.placement?.clipToPlacement?{clipToPlacement:e.options.placement.clipToPlacement}:{}}),n}function Po(e){if(!e.facetIndexed&&e.source)return{source:`draw`}}function Fo(e,t,n,r){if(n.scissor){let t=e.clip;n.scissor.x=t.clipX?t.rect.x:0,n.scissor.y=t.clipY?t.rect.y:0,n.scissor.width=t.clipX?t.rect.width:r.width,n.scissor.height=t.clipY?t.rect.height:r.height}if(n.visibleRange){let r=e.coords,i=e.cullClip,a=r.x,o=r.y;if(n.visibleRange.x1=0,n.visibleRange.x2=a+r.width,n.visibleRange.y1=0,n.visibleRange.y2=o+r.height,n.visibleRange.cullX)if(i?.clipX){let e=i.rect.x;n.visibleRange.x1=e,n.visibleRange.x2=e+i.rect.width}else n.visibleRange.x1=a;if(n.visibleRange.cullY)if(i?.clipY){let e=i.rect.y;n.visibleRange.y1=e,n.visibleRange.y2=e+i.rect.height}else n.visibleRange.y1=o;t.viewport&&(n.visibleRange.x1-=t.viewport.x,n.visibleRange.x2-=t.viewport.x,n.visibleRange.y1-=t.viewport.y,n.visibleRange.y2-=t.viewport.y)}}function Io(e,t){e.x=t.x,e.y=t.y,e.width=t.width,e.height=t.height}function Lo(e,t,n){for(let r of e.occurrences){let e=r.markCoords,i=r.placementIndex*4;n[i]=e.x/t.width,n[i+1]=e.y/t.height,n[i+2]=Math.max(e.width,1)/t.width,n[i+3]=Math.max(e.height,1)/t.height}}function Ro(e,t,n,r,i){let a=e.getSnapshot().rectangles,o=t*4;if(o+3>=a.length)return!1;let s=n.x+a[o]*n.width,c=n.y+a[o+1]*n.height,l=a[o+2]*n.width,u=a[o+3]*n.height;if(l<=0||u<=0)return!1;let d=Math.max(0,r?.x??0),f=Math.max(0,r?.y??0),p=Math.min(i.width,r?r.x+r.width:i.width),m=Math.min(i.height,r?r.y+r.height:i.height);return s<p&&c<m&&s+l>d&&c+u>f}function zo(e,t){let n=e.coords[0],r=n.x,i=n.y,a=r+n.width,o=i+n.height;for(let t=1;t<e.coords.length;t++){let n=e.coords[t];r=Math.min(r,n.x),i=Math.min(i,n.y),a=Math.max(a,n.x+n.width),o=Math.max(o,n.y+n.height)}e.bounds.x=e.clipX?r:0,e.bounds.y=e.clipY?i:0,e.bounds.width=e.clipX?a-r:t.width,e.bounds.height=e.clipY?o-i:t.height}function Bo(e,t){let n=Error(`${t} Mark: ${e.getType()}. View: ${e.unitView.getPathString()}`);return n.view=e.unitView,n}var Vo={r:0,g:0,b:0,a:0};function Ho(e){if(e==null)return Vo;let t=l(e);if(!t)throw Error(`Invalid WebGPU canvas background color: ${e}`);let n=t.rgb();return{r:n.r/255,g:n.g/255,b:n.b/255,a:n.opacity}}var Uo=class{#e=!0;#t;constructor(e){this.viewRoot=e.viewRoot,this.surface=e.surface,this.getBackground=e.getBackground,this.broadcast=e.broadcast,this.onLayoutComputed=e.onLayoutComputed}computeLayout(){this.broadcast(`layout`),this.surface.invalidateSize();let e=5;for(;;){let t=this.#n();if(!t)return;if(!this.surface.invalidateSize()){this.#t=this.#r(t),this.#e=!0,this.onLayoutComputed(),this.broadcast(`layoutComputed`);return}if(e--,e==0)throw Error(`Layout did not settle: canvas size kept changing.`)}}renderAll(){let e=this.#t;if(!e)return;let t=g();t?.beginFrame(`webgpu`);let n=_(`markTranslation`,()=>e.render());_(`surfaceRender`,()=>this.surface.render(n,Ho(this.getBackground()))),this.#e=!0,t?.endFrame()}renderPickingFramebuffer(){let e=this.#t;if(!e||!this.#e)return;let t=g();t?.beginFrame(`webgpu`,`picking`);let n=_(`markTranslation`,()=>e.renderPicking());_(`surfaceRender`,()=>this.surface.renderPicking(n)),this.#e=!1,t?.endFrame()}#n(){let e=this.surface.getLogicalCanvasSize();if(!(isNaN(e.width)||isNaN(e.height)))return _(`layout`,()=>h(this.viewRoot,p.create(0,0,e.width,e.height),{devicePixelRatio:this.surface.getDevicePixelRatio(),renderingOptions:{firstFacet:!0}}))}#r(e){let t=new wo({surface:this.surface});return _(`framePlanCompilation`,()=>{e.collectRenderCommands(t),t.finish()}),t}},Wo=class{constructor(e){this._count=e,this._templatesByShader=new Map,this._nextId=1}getOrCreate(e,t,n){let r=this._templatesByShader.get(e),i=r?.get(t);if(i)return this._count(`programTemplateCacheHits`),i;r||(r=new Map,this._templatesByShader.set(e,r));let a=n(this._nextId++);return r.set(t,a),this._count(`programTemplateCacheMisses`),a}},Go=`
