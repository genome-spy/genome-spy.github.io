import{A as e,St as t,a as n,b as r,ct as i,d as a,ln as o,o as s,pt as c,s as l,sn as u}from"./clipOptions-BtlnCFCO.js";import{k as d}from"./vega-scale-CL4J5wYL.js";import{n as f}from"./indexLikeDomainUtils-CtCqYOrV.js";import{t as p}from"./rasterization-25yc2Doo.js";import{t as m}from"./rectangle-CAPGOw2x.js";import{n as h,t as g}from"./layoutResult-BbpHOHQN.js";import{n as _,r as v,t as y}from"./performanceProfiler-t6gLo5-8.js";import{l as b,o as x}from"./markEncoding-D7YQHl9p.js";import{n as S,r as ee,t as C}from"./markXIndex-CN5Usd_v.js";import{t as te}from"./canvasSizeHelper-DjbYDXFa.js";import{n as ne,t as re}from"./rasterImage-CSBco7OJ.js";import{n as ie,t as ae}from"./renderingConstants-BWHEP8gH.js";var oe=4096,se=4294967295;function ce(e){if(!Number.isSafeInteger(e)||e<0)throw Error(`High-precision values must be non-negative safe integers.`);let t=e%oe,n=(e-t)/oe;if(n>se)throw Error(`High-precision value exceeds the supported range for packed u32.`);return[n>>>0,t>>>0]}function le(e){if(!Number.isFinite(e)||e<0)throw Error(`High-precision domain values must be finite and non-negative.`);let t=e%oe;return[e-t,t]}function ue(e){let t=new Uint32Array(e.length*2);for(let n=0;n<e.length;n+=1){let[r,i]=ce(e[n]),a=n*2;t[a]=r,t[a+1]=i}return t}function de(e,t){let n=e.length*2;if(t.length!==n)throw Error(`Packed target length (${t.length}) does not match ${n}.`);for(let n=0;n<e.length;n+=1){let[r,i]=ce(e[n]),a=n*2;t[a]=r,t[a+1]=i}return t}function fe(e,t){let[n,r]=le(e);return[n,r,Number(t)-Number(e)]}function w(e){return!!e&&`data`in e&&e.data!=null}function T(e){return!!e&&`value`in e&&e.value!=null}function pe(e){let t=new Map,n=0;for(let r of e){let e=r.arrayLength!=null,i=e?16:r.components===1?4:r.components===2?8:16,a=e?16*r.arrayLength:r.components===1?4:r.components===2?8:16,o=e?16:void 0;n=me(n,i),t.set(r.name,{...r,offset:n,stride:o}),n+=a}return{entries:t,byteLength:me(n,16)}}function me(e,t){return Math.ceil(e/t)*t}var he=class{constructor(e){let t=pe(e);this.entries=t.entries,this.byteLength=t.byteLength,this.data=new ArrayBuffer(this.byteLength),this.view=new DataView(this.data)}setValue(e,t){let n=this.entries.get(e);if(!n)return;if(n.arrayLength!=null){if(!(Array.isArray(t)||ArrayBuffer.isView(t)))throw Error(`Uniform "${e}" expects an array value`);let r=t;if(r.length!==n.arrayLength)throw Error(`Uniform "${e}" expects ${n.arrayLength} elements`);let i=n.stride??16;for(let e=0;e<n.arrayLength;e++){let t=r[e],a=n.offset+e*i;this._writeElement(n,a,t)}return}let r=n.components;if(Array.isArray(t)||ArrayBuffer.isView(t)){let i=t;if(i.length!==r)throw Error(`Uniform "${e}" expects ${r} components`);for(let t=0;t<r;t++){let a=i[t];if(typeof a!=`number`)throw Error(`Uniform "${e}" expects ${r} components`);this._writeScalar(n,n.offset+t*4,a??0)}}else{if(r!==1)throw Error(`Uniform "${e}" expects ${r} components`);let i=t;this._writeScalar(n,n.offset,i??0);for(let e=1;e<r;e++)this._writeScalar(n,n.offset+e*4,0)}}_writeElement(e,t,n){if(e.components===1){if(typeof n!=`number`)throw Error(`Uniform "${e.name}" expects scalar elements`);this._writeScalar(e,t,n);return}if(!Array.isArray(n)||n.length!==e.components)throw Error(`Uniform "${e.name}" expects ${e.components} components`);for(let r=0;r<e.components;r++)this._writeScalar(e,t+r*4,n[r]??0)}_writeScalar(e,t,n){e.type===`u32`?this.view.setUint32(t,n>>>0,!0):e.type===`i32`?this.view.setInt32(t,n|0,!0):this.view.setFloat32(t,n??0,!0)}};function ge(e,t,n=new Map){let r=new Map,i=new Map,a=0,o=0,s=0;for(let[c,l]of Object.entries(e)){if(!w(l))continue;let e=l.type??t[c]?.type;if(!e)throw Error(`Missing type for series channel "${c}".`);if(e!==`f32`&&e!==`u32`&&e!==`i32`)throw Error(`Packed series only supports f32/u32/i32 channels. "${c}" is ${e}.`);let u=l.inputComponents??l.components??1;if(u!==1&&u!==2&&u!==4)throw Error(`Packed series only supports 1, 2, or 4 components. "${c}" is ${u}.`);let d=n.get(c)??c,f=i.get(d);if(f){if(f.scalarType!==e||f.components!==u)throw Error(`Packed alias "${d}" must keep type/components consistent.`);r.set(c,f);continue}let p={name:c,scalarType:e,components:u,offset:e===`f32`?a:e===`u32`?o:s,stride:0};r.set(c,p),i.set(d,p),e===`f32`?a+=u:e===`u32`?o+=u:s+=u}for(let e of r.values())e.stride=e.scalarType===`f32`?a:e.scalarType===`u32`?o:s;return{entries:r,f32Stride:a,u32Stride:o,i32Stride:s}}function _e({channels:e,channelSpecs:t,layout:n,count:r}){let i=n.f32Stride>0?new Float32Array(r*n.f32Stride):null,a=n.u32Stride>0?new Uint32Array(r*n.u32Stride):null,o=n.i32Stride>0?new Int32Array(r*n.i32Stride):null,s=new Set;for(let t of n.entries.values()){if(s.has(t))continue;s.add(t);let n=e[t.name];if(!n||!w(n))throw Error(`Missing series data for "${t.name}".`);let c=n.inputComponents??n.components??t.components,l=r*c,u=n.data;if(!u)throw Error(`Missing data for "${t.name}".`);let d=n.scale?.type??`identity`;if(t.scalarType===`u32`&&d===`index`&&u instanceof Float64Array){if(c!==2)throw Error(`Channel "${t.name}" requires inputComponents: 2 when providing Float64Array data.`);let e=new Uint32Array(u.length*2);de(u,e),u=e}if(t.scalarType===`f32`&&!(u instanceof Float32Array))throw Error(`Channel "${t.name}" expects a Float32Array for f32 data`);if(t.scalarType===`u32`&&!(u instanceof Uint32Array))throw Error(`Channel "${t.name}" expects a Uint32Array for u32 data`);if(t.scalarType===`i32`&&!(u instanceof Int32Array))throw Error(`Channel "${t.name}" expects an Int32Array for i32 data`);if(u.length<l)throw Error(`Channel "${t.name}" length (${u.length}) is less than count (${r}).`);let f=t.scalarType===`f32`?i:t.scalarType===`u32`?a:o;if(f)for(let e=0;e<r;e++){let n=e*t.stride+t.offset,r=e*c;for(let e=0;e<t.components;e++)f[n+e]=u[r+e]}}return{f32:i,u32:a,i32:o}}var ve=(globalThis.GPUTextureUsage?.TEXTURE_BINDING??0)|(globalThis.GPUTextureUsage?.COPY_DST??0);function ye(e){let t=Se(e.format),n=e.width*t,r=Ce(n,256);if(r===n)return{...e,bytesPerRow:r};let i=Math.max(1,e.height),a=new Uint8Array(r*i),o=new Uint8Array(e.data.buffer,e.data.byteOffset,e.data.byteLength);for(let e=0;e<i;e++){let t=e*n,i=e*r;a.set(o.subarray(t,t+n),i)}return{...e,data:a,bytesPerRow:r}}function be(e,t,n=ve,r){let i=e.createTexture({label:r,size:{width:t.width,height:t.height,depthOrArrayLayers:1},format:t.format,usage:n});return xe(e,i,t),i}function xe(e,t,n){let r=ye(n);e.queue.writeTexture({texture:t},E(r.data),{bytesPerRow:r.bytesPerRow,rowsPerImage:r.height},{width:r.width,height:r.height,depthOrArrayLayers:1})}function E(e){return e}function Se(e){switch(e){case`r8uint`:return 1;case`r32float`:return 4;case`rg32float`:return 8;case`rgba8unorm`:case`rgba8unorm-srgb`:return 4;case`rgba16float`:return 8;default:return 4}}function Ce(e,t){return Math.ceil(e/t)*t}var D=`webgpu-renderer`;function O(e,t){return e+`: `+t}var we=class{constructor(e,t,n,r=`mark`){this._device=e,this._channels=t,this._channelSpecs=n,this._label=r,this._seriesBufferAliases=new Map,this._packedSeriesLayout=null,this._packedBuffers=new Map,this._initializeSeriesAliases()}get packedSeriesLayoutEntries(){return this._getPackedLayout()?.entries??null}getPackedSeriesInfo(){let e=this._getPackedLayout();if(!e)return new Map;let t=new Map;for(let[n,r]of e.entries){let e=r.scalarType===`f32`?`seriesF32`:r.scalarType===`u32`?`seriesU32`:`seriesI32`,i=this._seriesBufferAliases.get(n)??n,a=t.get(e);a||(a={stride:r.stride,channels:[]},t.set(e,a)),a.channels.push({name:n,alias:i,offset:r.offset,components:r.components,stride:r.stride})}return t}getBuffer(e){let t=this._packedBuffers.get(e);return t?t.buffer:null}inferCount(e){let t=null,n=!1;for(let[r,i]of Object.entries(this._channels)){if(!w(i))continue;n=!0;let a=e?.[r]??i.data;if(!a)throw Error(`Missing data for channel "${r}"`);let o=i.inputComponents??i.components??1,s=(i.scale?.type??`identity`)===`index`&&a instanceof Float64Array&&o===2?1:o;if(s<=0)throw Error(`Invalid input component count for "${r}"`);if(a.length%s!==0)throw Error(`Channel "${r}" length (${a.length}) must be divisible by ${s}.`);let c=a.length/s;if(t===null)t=c;else if(c!==t)throw Error(`Channel "${r}" count (${c}) does not match inferred count (${t}).`)}return n?t??0:null}_initializeSeriesAliases(){this._seriesBufferAliases.clear();let e=new Map;for(let[t,n]of Object.entries(this._channels)){if(!w(n))continue;let r=n.data;if(!r)continue;let i=e.get(r);i||(i=t,e.set(r,i)),this._seriesBufferAliases.set(t,i)}}updateSeries(e,t){return this._updatePackedSeries(e,t)}_updatePackedSeries(e,t){let n=this._getPackedLayout();if(!n)return!1;let r=new Map;for(let[t,n]of Object.entries(this._channels)){if(!w(n))continue;let i=e[t]??n.data;if(!i)throw Error(`Missing data for channel "${t}"`);let a=this._seriesBufferAliases.get(t)??t,o=r.get(a);if(o&&o!==i){let e=this._getAliasMembers(a);throw Error(`Series channels ${e.map(e=>`"${e}"`).join(`, `)} must share the same buffer.`)}r.set(a,i),n.data=i}let{f32:i,u32:a,i32:o}=_e({channels:this._channels,channelSpecs:this._channelSpecs,layout:n,count:t}),s=!1;return i&&(s=this._ensurePackedBuffer(`seriesF32`,i)||s),a&&(s=this._ensurePackedBuffer(`seriesU32`,a)||s),o&&(s=this._ensurePackedBuffer(`seriesI32`,o)||s),s}_getPackedLayout(){if(!this._packedSeriesLayout){let e=ge(this._channels,this._channelSpecs,this._seriesBufferAliases);this._packedSeriesLayout=e}return this._packedSeriesLayout}_getAliasMembers(e){let t=[];for(let[n,r]of this._seriesBufferAliases.entries())r===e&&t.push(n);return t.length>0?t:[e]}_ensurePackedBuffer(e,t){let n=this._packedBuffers.get(e),r=Math.max(4,t.byteLength),i=n?.buffer??null,a=!i||n.byteLength<r;if(a){let t=i;i=this._device.createBuffer({label:O(this._label,`series `+e.slice(6).toLowerCase()),size:r,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this._packedBuffers.set(e,{buffer:i,byteLength:r}),t?.destroy()}return t.byteLength>0&&this._device.queue.writeBuffer(i,0,E(t)),a}destroy(){for(let{buffer:e}of this._packedBuffers.values())e.destroy();this._packedBuffers.clear()}};function Te({device:e,label:t=`mark`,layout:n,uniformBuffer:r,resourceLayout:i,getSeriesBuffer:a,getScaleResources:o,extraTextures:s,extraBuffers:c}){let l=[{binding:0,resource:{buffer:r}}],u=1;for(let e of i){if(e.role===`series`){let t=a(e.name);if(!t)throw Error(`Missing buffer binding for "${e.name}".`);l.push({binding:u++,resource:{buffer:t}});continue}let n=o(e.name);if(e.role===`ordinalRange`){let t=n?.ordinalRange?.buffer;if(!t)throw Error(`Missing buffer binding for "${e.name}".`);l.push({binding:u++,resource:{buffer:t}});continue}if(e.role===`domainMap`){let t=n?.domainMap?.buffer;if(!t)throw Error(`Missing domain map buffer for "${e.name}".`);l.push({binding:u++,resource:{buffer:t}});continue}if(e.role===`rangeTexture`){let r=n?.rangeTexture?.texture;if(!r)throw Error(`Missing range texture for "${e.name}".`);l.push({binding:u++,resource:r.createView({label:O(t,`scale ${e.name} range texture view`)})});continue}if(e.role===`rangeSampler`){let t=n?.rangeTexture?.sampler;if(!t)throw Error(`Missing range sampler for "${e.name}".`);l.push({binding:u++,resource:t});continue}if(e.role===`extraTexture`){let n=s.get(e.name)?.texture;if(!n)throw Error(`Missing extra texture for "${e.name}".`);l.push({binding:u++,resource:n.createView({label:O(t,`${e.name} texture view`)})});continue}if(e.role===`extraSampler`){let t=s.get(e.name)?.sampler;if(!t)throw Error(`Missing extra sampler for "${e.name}".`);l.push({binding:u++,resource:t});continue}if(e.role===`extraBuffer`){let t=c.get(e.name)??null;if(!t)throw Error(`Missing extra buffer for "${e.name}".`);l.push({binding:u++,resource:{buffer:t}});continue}throw Error(`Unknown resource binding role "${e.role}".`)}return e.createBindGroup({label:O(t,`bind group`),layout:n,entries:l})}var k=`uDomain_`,A=`uRange_`,Ee=`uRangeCount_`,De=`domainMap_`,Oe=`uDomainMapCount_`,ke=`uRangeTexture_`,Ae=`uRangeSampler_`,je=`getScaled_`,Me=`uScaleBase_`,Ne=`uScaleExponent_`,Pe=`uScaleConstant_`,Fe=`uScalePaddingInner_`,Ie=`uScalePaddingOuter_`,Le=`uScaleAlign_`,Re=`uScaleBand_`,j=`uSelection_`,ze=`uSelectionCount_`,Be=`selection_`,Ve=`checkSelection_`,He=`isSelectionMember_`,Ue=`isSelectionEmpty_`;function We(e,t){return`${j}${e}_${t}_active`}function Ge(e,t){return`${j}${e}_${t}`}function Ke(e,t){return t===`f32`?e:`f32(${e})`}function qe(e){return e.replace(/^\n/,``).replace(/\n\s*$/,``)}function Je(e,t){let n=qe(t),r=e.body?`${e.body}\n${n}`:n;return{...e,body:r}}function Ye(e,t){return`
    let unitValue = clamp(${t}, 0.0, 1.0);
    let rgb = getInterpolatedColor(${`${ke}${e}`}, ${`${Ae}${e}`}, unitValue);
    return vec4<f32>(rgb, 1.0);
`}function Xe(e){let t={expr:e.rawValueExpr,body:``};for(let n of e.steps)t=n(t);let n=t.body?qe(t.body):``,r=e.functionName??e.name,i=qe(e.useRangeTexture?Ye(e.name,t.expr):`
    return ${t.expr};
`),a=n?`${n}\n${i}`:i;return`fn ${je}${r}(i: u32) -> ${e.returnType} {
${a}
}`}function Ze(e){return t=>({...t,expr:Ke(t.expr,e)})}function Qe(e){return t=>({...t,expr:`clampToDomain(${t.expr}, ${e})`})}function $e(e,t){return n=>({...n,expr:t({name:e,valueExpr:n.expr})})}function et(){return e=>({...e,expr:`roundLikeD3(${e.expr})`})}function tt({name:e,domainLength:t,outputComponents:n,outputScalarType:r,useRangeTexture:i}){let a=i||n===1?r:`vec4<f32>`,o=e=>i||n===1?`${e}.x`:e;return n=>({...Je(n,`
...
`),expr:`unit`})}function nt({name:e,domainLength:t,outputComponents:n,outputScalarType:r}){let i=n===1?r:`vec4<f32>`,a=n===1?`params.${A}${e}[slot].x`:`params.${A}${e}[slot]`;return n=>({...Je(n,`
    let value = ${n.expr};
    const DOMAIN_LEN: u32 = ${t}u;
    var slot: u32 = 0u;
    ...
    let out: ${i} = ${a};
`),expr:`out`})}function rt({name:e,rangeLength:t,outputComponents:n,outputScalarType:r}){let i=n===1?r:`vec4<f32>`,a=n===1?`params.${A}${e}[slot].x`:`params.${A}${e}[slot]`;return n=>({...Je(n,`
    let value = ${n.expr};
...
`;function $t(e){let t=new Set,n=new Set,r=[];function i(e){if(!n.has(e)){if(t.has(e))throw Error(`Scale WGSL dependency cycle: ${e.type}`);t.add(e);for(let t of e.wgslDeps??[])i(t);e.wgsl&&r.push(e.wgsl),t.delete(e),n.add(e)}}for(let t of e)i(t);return`${Qt}\n${r.join(`
`)}`}var en=`
...
`;function tn(e){return`hashLookup_${e}`}function nn(e){return`
fn ${tn(e)}(key: u32, maxProbes: u32) -> u32 {
...
`}function rn(e,t){let n=[],r=!0,i=[];for(let[a,o]of e.split(/\r?\n/).entries()){let e=o.trim();if(!e.startsWith(`#`)){r&&i.push(o);continue}let s=e.match(/^#([A-Za-z]+)\b(.*)$/);if(!s)throw F(a,`Malformed directive`);let[,c,l]=s,u=l.trim();if(c===`if`){let e=an(u,t);n.push({parentActive:r,condition:e,elseSeen:!1}),r&&=e}else if(c===`else`){if(u)throw F(a,`#else does not accept an argument`);let e=n.at(-1);if(!e)throw F(a,`#else has no matching #if`);if(e.elseSeen)throw F(a,`#if block contains more than one #else`);e.elseSeen=!0,r=e.parentActive&&!e.condition}else if(c===`endif`){if(u)throw F(a,`#endif does not accept an argument`);let e=n.pop();if(!e)throw F(a,`#endif has no matching #if`);r=e.parentActive}else throw F(a,`Unsupported directive #${c}`)}if(n.length)throw Error(`Unterminated shader #if block.`);return i.join(`
`)}function an(e,t){let n=on(e),r=0,i=()=>n[r],a=()=>n[r++];function o(){if(i()===`!`)return a(),!o();if(i()===`(`){a();let e=c();if(a()!==`)`)throw Error(`Expected ")" in shader condition.`);return e}if(a()!==`defined`||a()!==`(`)throw Error(`Expected defined(NAME) in shader condition.`);let e=a();if(!e||!/^[A-Za-z_][A-Za-z0-9_]*$/.test(e))throw Error(`Expected a symbol name in defined(NAME).`);if(a()!==`)`)throw Error(`Expected ")" after shader symbol name.`);return t.has(e)}function s(){let e=o();for(;i()===`&&`;){a();let t=o();e&&=t}return e}function c(){let e=s();for(;i()===`||`;){a();let t=s();e||=t}return e}if(!n.length)throw Error(`Shader #if requires a condition.`);let l=c();if(r!==n.length)throw Error(`Unexpected token "${n[r]}" in shader condition.`);return l}function on(e){let t=[],n=/defined|[A-Za-z_][A-Za-z0-9_]*|&&|\|\||!|\(|\)/gy,r=0;for(;r<e.length;){if(/\s/.test(e[r])){r+=1;continue}n.lastIndex=r;let i=n.exec(e);if(!i)throw Error(`Unexpected token near "${e.slice(r)}" in shader condition.`);t.push(i[0]),r=n.lastIndex}return t}function F(e,t){return Error(`${t} at shader line ${e+1}.`)}function sn(e,t,n){let r=e===`u32`?`u32`:e===`i32`?`i32`:`f32`,i=t=>{let n=Number(t??0);return e===`u32`?`u32(${Math.trunc(n)})`:e===`i32`?`i32(${Math.trunc(n)})`:Number.isInteger(n)?`${n}.0`:`${n}`};if(t===1)return i(Array.isArray(n)?n[0]:n);let a=(Array.isArray(n)?n:[n]).slice(0,t);for(;a.length<t;)a.push(0);return`vec${t}<${r}>(${a.map(i).join(`, `)})`}var I={BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1}.DEV??!1;function cn({name:e,scaleDef:t,functionName:n,rawValueExpr:r,scalarType:i,inputComponents:a,outputComponents:o,outputScalarType:s,scaleConfig:c,domainMapName:l=null,useRangeTexture:u=!1}){let d=Array.isArray(c?.domain)?c.domain.length:0,f=Array.isArray(c?.range)?c.range.length:0,p=Ct(c);if(u&&o!==4)throw Error(`Channel "${e}" requires vec4 output when using interpolate textures.`);let m=c?.round===!0&&o===1&&!u;return t.emit({name:e,functionName:n,scaleConfig:c,rawValueExpr:r,inputScalarType:i,inputComponents:a,outputComponents:o,outputScalarType:s,clamp:c?.clamp===!0,round:m,domainLength:d,rangeLength:f,isPiecewise:p,domainMapName:l,useRangeTexture:u})}function ln(e){return`u_scalar_${e}`}function un(e){if(e===void 0)return;function t(e){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`Visibility predicate nodes must be objects.`);let n=e,r=[`compare`,`selection`,`selectionUnion`,`all`,`any`].filter(e=>Object.hasOwn(n,e));if(r.length!==1)throw Error(`Visibility predicate nodes must specify exactly one of compare, selection, selectionUnion, all, or any.`);let i=r[0];if(i===`all`||i===`any`){let e=n[i];if(!Array.isArray(e)||e.length===0)throw Error(`Visibility predicate ${i} nodes must not be empty.`);e.forEach(t)}else if(i===`selectionUnion`){let e=n.selectionUnion;if(!Array.isArray(e)||e.length===0)throw Error(`Visibility selection unions must not be empty.`);if(n.empty!==void 0&&typeof n.empty!=`boolean`)throw Error(`Visibility selection union empty policy must be boolean.`);if(e.some(e=>!e||typeof e!=`object`||Array.isArray(e)||!Object.hasOwn(e,`selection`)||Object.hasOwn(e,`selectionUnion`)||Object.hasOwn(e,`empty`)))throw Error(`Visibility selection union leaves must be single selections without empty flags.`);e.forEach(t)}return e}return t(e)}function dn(e){let t=un(e);if(t!==void 0){if(!(`selection`in t)&&!(`selectionUnion`in t))throw Error(`Selection predicates must be a selection or selection union.`);return t}}function fn({predicate:e,channelIRs:t,channelNames:n,inputNames:r,scalarSlots:i,selectionDefs:a,functionName:o=`isInstanceVisible`}){let s=new Map(t.map(e=>[e.name,e])),c=new Set(a.map(e=>e.name));function l(e){if(!e||typeof e!=`object`)throw Error(`Visibility predicate operands must be objects.`);let t=Object.keys(e);if(t.length!==1)throw Error(`Visibility predicate operands must specify exactly one namespace.`);let a=t[0],o=e[a];if(typeof o!=`string`||o.length===0)throw Error(`Visibility predicate ${a} operands require a name.`);if(a===`channel`){if(!n.has(o))throw Error(`Visibility predicate references unknown channel "${o}".`);return u(o,s.get(o))}if(a===`input`){if(!r.has(o))throw Error(`Visibility predicate references unknown input "${o}".`);return u(o,s.get(o))}if(a===`slot`){let e=i[o];if(!e)throw Error(`Visibility predicate references unknown slot "${o}".`);return{expression:`params.${ln(o)}`,type:e.type}}throw Error(`Visibility predicate has unsupported operand namespace "${a}".`)}function u(e,t){if(!t)throw Error(`Visibility predicate references unavailable input "${e}".`);if(t.inputComponents!==1)throw Error(`Visibility predicate input "${e}" must be scalar, got ${t.inputComponents} components.`);return{expression:t.rawValueExpr,type:t.scalarType}}function d(e){if(`compare`in e){if(e.compare!==`<`&&e.compare!==`<=`&&e.compare!==`>`&&e.compare!==`>=`)throw Error(`Visibility predicate has unsupported comparison "${e.compare}".`);let t=l(e.left),n=l(e.right);if(t.type!==n.type)throw Error(`Visibility predicate comparison types must match: ${t.type} and ${n.type}.`);return`(${t.expression} ${e.compare} ${n.expression})`}if(`selection`in e){if(typeof e.selection!=`string`||!c.has(e.selection))throw Error(`Visibility predicate references unknown selection "${e.selection}".`);if(e.empty!==void 0&&typeof e.empty!=`boolean`)throw Error(`Visibility predicate selection "${e.selection}" empty policy must be boolean.`);return`${Ve}${e.selection}(i, ${e.empty===!0?`true`:`false`})`}if(`selectionUnion`in e){let t=e.selectionUnion.map(e=>{if(!c.has(e.selection))throw Error(`Visibility predicate references unknown selection "${e.selection}".`);return e.selection}),n=t.map(e=>`${He}${e}(i)`).join(` || `),r=t.map(e=>`${Ue}${e}(i)`).join(` && `);return`(${n}${e.empty===!0?` || (${r})`:``})`}if(`all`in e||`any`in e){let t=`all`in e?`&&`:`||`;return`(${(`all`in e?e.all:e.any).map(d).join(` ${t} `)})`}throw Error(`Visibility predicate has an unsupported node shape.`)}return`
fn ${o}(i: u32) -> bool {
    return ${e?d(e):`true`};
}
`}function pn({compiledChannels:e,uniformLayout:t,shaderBody:n,packedSeriesLayout:r,selectionDefs:i=[],visibleWhen:a,order:o,scalarSlots:s={},extraResources:c=[],placementIndex:l}){let{channels:u,channelIRs:d,channelNames:f,inputNames:p}=e,m=l&&`source`in l&&l.source===`draw`,h=[],g=[],_={},v=[],y=[],b=[],x=[],S=[];function ee(e,t=e.name){return`fn ${je}${t}(i: u32) -> ${e.outputComponents===1?e.outputScalarType:`vec${e.outputComponents}<f32>`} { return ${e.rawValueExpr}; }`}let C=1,te=GPUShaderStage.VERTEX|GPUShaderStage.COMPUTE,ne=d.filter(e=>e.sourceKind===`series`),re=d.filter(e=>e.sourceKind===`uniform`||e.sourceKind===`literal`),ie=d.filter(e=>e.needsOrdinalRange),ae=d.filter(e=>e.needsDomainMap),oe=d.filter(e=>e.useRangeTexture),se=new Set(t.map(({name:e})=>e)),ce=new Map(d.map(e=>[e.name,e])),le=new Map(i.map(e=>[e.name,e])),ue=fn({predicate:a,functionName:o?`isInstanceVisibleBase`:`isInstanceVisible`,channelIRs:d,channelNames:f,inputNames:p,scalarSlots:s,selectionDefs:i}),de=o?fn({predicate:o.when,functionName:`isInstanceOrderMatch`,channelIRs:d,channelNames:f,inputNames:p,scalarSlots:s,selectionDefs:i}):``,fe=o?`
...
`:``,w=e=>(_[e]||(_[e]={}),_[e]);function T(e){let t=`${Ve}${e.name}`,n=ce.get(`uniqueId`);if(I&&(e.type===`single`||e.type===`multi`)&&!n)throw Error(`Selection "${e.name}" requires a uniqueId channel.`);switch(e.type){case`single`:return`
fn ${t}(i: u32, allowEmpty: bool) -> bool {
    let selected = u32(params.${j}${e.name});
    if (allowEmpty && selected == 0u) { return true; }
    if (selected == 0u) { return false; }
    let id = ${n?.rawValueExpr??`0u`};
    return id == selected;
}
fn ${He}${e.name}(i: u32) -> bool {
    return ${t}(i, false);
}
fn ${Ue}${e.name}(i: u32) -> bool {
    return params.${j}${e.name} == 0u;
}
`;case`multi`:{let r=Be+e.name,i=tn(r);return`
fn ${t}(i: u32, allowEmpty: bool) -> bool {
...
fn ${Ue}${e.name}(i: u32) -> bool {
    return params.${ze}${e.name} == 0u;
}
`}case`interval`:{let n=e.targets??[];if(I&&n.length===0)throw Error(`Interval selection "${e.name}" must have at least one target.`);return`
fn ${t}(i: u32, allowEmpty: bool) -> bool {
    var matches = true;
${n.map((t,n)=>{let r=ce.get(t.input),i=t.secondaryInput?ce.get(t.secondaryInput):null;if(I&&!r)throw Error(`Selection "${e.name}" references missing input "${t.input}".`);if(I&&t.secondaryInput&&!i)throw Error(`Selection "${e.name}" references missing input "${t.secondaryInput}".`);if(I&&t.hitTest!==void 0&&t.hitTest!==`intersects`&&!t.secondaryInput)throw Error(`Selection "${e.name}" cannot specify a hit-test mode without a secondary input.`);let a=We(e.name,n),o=Ge(e.name,n),s=r?.rawValueExpr??`0.0`,c=i?.rawValueExpr??null,l=t.hitTest??`intersects`,u;if(!c)u=`${o}_lo <= ${s} && ${s} <= ${o}_hi`;else if(l===`encloses`)u=`${o}_lo <= ${o}_dLo && ${o}_dHi <= ${o}_hi`;else if(l===`endpoints`)u=`(${o}_lo <= ${o}_d0 && ${o}_d0 <= ${o}_hi) || (${o}_lo <= ${o}_d1 && ${o}_d1 <= ${o}_hi)`;else if(l===`intersects`)u=`${o}_dHi >= ${o}_lo && ${o}_dLo <= ${o}_hi`;else throw Error(`Selection "${e.name}" has unsupported hit-test mode "${l}".`);return`
    if (params.${a} == 0u) {
...
fn ${He}${e.name}(i: u32) -> bool {
    return !${Ue}${e.name}(i) && ${t}(i, true);
}
fn ${Ue}${e.name}(i: u32) -> bool {
    return ${n.map((t,n)=>`params.${We(e.name,n)} == 0u`).join(` && `)};
}
`}default:throw Error(`Selection "${e.name}" has unsupported type "${e.type}".`)}}function pe(e,t){let{name:n,outputComponents:r,outputScalarType:i}=e;return`
fn ${je}${n}(i: u32) -> ${r===1?i:`vec${r}<f32>`} {
${(e.channel.conditions??[]).map(e=>{let t=e.when,a=`selectionUnion`in t?t.selectionUnion:[t],o=`selectionUnion`in t?`(${a.map(e=>`${He}${e.selection}(i)`).join(` || `)}${t.empty===!0?` || (${a.map(e=>`${Ue}${e.selection}(i)`).join(` && `)})`:``})`:null,s=a[0].selection;if(I){for(let e of a)if(!le.has(e.selection))throw Error(`Channel "${n}" references unknown selection "${e.selection}".`)}let c=t.empty===!0?`true`:`false`;if(e.channelName)return`    if (${o??`checkSelection_${s}(i, ${c})`}) { return ${je}${e.channelName}(i); }`;let l=sn(r===1?i:`f32`,r,e.value);return`    if (${o??`checkSelection_${s}(i, ${c})`}) { return ${l}; }`}).join(`
`)}
    return ${je}${t}(i);
}
`}let me=new Set;for(let e of Object.keys(u))me.add(`${e}_DEFINED`);l&&(me.add(`PLACEMENT_ENABLED`),m&&me.add(`DRAW_PLACEMENT`));let he=new Set,ge=r??new Map;if(I&&ne.length>0&&ge.size===0)throw Error(`Packed series layout is required for series channels.`);for(let e of ge.values())if(e.scalarType===`f32`||e.scalarType===`u32`||e.scalarType===`i32`)he.add(e.scalarType);else if(I)throw Error(`Packed series only supports f32/u32/i32. Found "${e.scalarType}".`);if(he.has(`f32`)){let e=C++;h.push({binding:e,visibility:te,buffer:{type:`read-only-storage`}}),g.push({name:`seriesF32`,role:`series`}),v.push(`@group(1) @binding(${e}) var<storage, read> seriesF32: array<f32>;`)}if(he.has(`u32`)){let e=C++;h.push({binding:e,visibility:te,buffer:{type:`read-only-storage`}}),g.push({name:`seriesU32`,role:`series`}),v.push(`@group(1) @binding(${e}) var<storage, read> seriesU32: array<u32>;`)}if(he.has(`i32`)){let e=C++;h.push({binding:e,visibility:te,buffer:{type:`read-only-storage`}}),g.push({name:`seriesI32`,role:`series`}),v.push(`@group(1) @binding(${e}) var<storage, read> seriesI32: array<i32>;`)}for(let e of ne){let{name:t}=e;if(e.inputComponents>1&&e.scalarType!==`f32`&&!(e.scalarType===`u32`&&e.inputComponents===2&&e.scaleType===`index`))throw Error(`Channel "${t}" does not support non-f32 vector inputs.`);let n=ge.get(t);if(I&&!n)throw Error(`Packed series layout is missing entry for "${t}".`);if(I&&n.scalarType!==e.scalarType)throw Error(`Packed series type mismatch for "${t}". Expected ${e.scalarType}, got ${n.scalarType}.`);if(I&&n.components!==e.inputComponents)throw Error(`Packed series component mismatch for "${t}". Expected ${e.inputComponents}, got ${n.components}.`);let r=n.scalarType===`f32`?`seriesF32`:n.scalarType===`u32`?`seriesU32`:`seriesI32`,i=n.offset,a=n.stride;n.components===1?y.push(`fn read_${t}(i: u32) -> ${n.scalarType} {
    return ${r}[${i}u + i * ${a}u];
...
}`);let o=Array.isArray(e.channel.conditions)&&e.channel.conditions.length>0,s=o?`${t}_base`:t;e.needsScaleFunction?b.push(cn({name:t,functionName:s,scaleDef:e.scaleDef,rawValueExpr:e.rawValueExpr,scalarType:e.scalarType,inputComponents:e.inputComponents,outputComponents:e.outputComponents,outputScalarType:e.outputScalarType,scaleConfig:e.channel.scale,useRangeTexture:e.useRangeTexture,domainMapName:e.needsDomainMap?`${De}${t}`:null})):b.push(ee(e,s)),o&&b.push(pe(e,s))}if(i.length>0)for(let e of i)x.push(T(e));for(let e of ie){let{name:t}=e,n=w(t);n.ordinalRange=!0,n.rangeCountUniform=!0;let r=C++;h.push({binding:r,visibility:te,buffer:{type:`read-only-storage`}}),g.push({name:t,role:`ordinalRange`});let i=e.outputComponents===1?e.outputScalarType:`vec4<f32>`,a=`range_${t}`;v.push(`@group(1) @binding(${r}) var<storage, read> ${a}: array<${i}>;`)}for(let e of ae){let{name:t}=e,n=w(t);n.domainMap=!0,n.domainMapCountUniform=!0;let r=C++;h.push({binding:r,visibility:te,buffer:{type:`read-only-storage`}}),g.push({name:t,role:`domainMap`});let i=`${De}${t}`;v.push(`@group(1) @binding(${r}) var<storage, read> ${i}: array<HashEntry>;`)}for(let e of oe){let{name:t}=e,n=w(t);n.rangeTexture=!0,n.rangeSampler=!0;let r=C++;h.push({binding:r,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT|GPUShaderStage.COMPUTE,texture:{sampleType:`float`}}),g.push({name:t,role:`rangeTexture`}),v.push(`@group(1) @binding(${r}) var ${ke}${t}: texture_2d<f32>;`);let i=C++;h.push({binding:i,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT|GPUShaderStage.COMPUTE,sampler:{type:`filtering`}}),g.push({name:t,role:`rangeSampler`}),v.push(`@group(1) @binding(${i}) var ${Ae}${t}: sampler;`)}for(let e of c){let t=C++,n=e.visibility===`vertex`?GPUShaderStage.VERTEX:e.visibility===`fragment`?GPUShaderStage.FRAGMENT:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,r=e.wgslName??e.name;if(e.kind===`buffer`){h.push({binding:t,visibility:n,buffer:{type:e.bufferType??`read-only-storage`}}),g.push({name:e.name,role:e.role}),S.push(`@group(1) @binding(${t}) var<storage, read> ${r}: ${e.wgslType??`array<f32>`};`);continue}if(e.kind===`texture`){let i=e.dimension??`2d`,a=e.sampleType??`float`,o=a===`uint`?`u32`:a===`sint`?`i32`:`f32`,s=i===`2d-array`?`texture_2d_array<${o}>`:`texture_2d<${o}>`;h.push({binding:t,visibility:n,texture:{sampleType:a,viewDimension:i===`2d-array`?`2d-array`:`2d`}}),g.push({name:e.name,role:e.role}),S.push(`@group(1) @binding(${t}) var ${r}: ${s};`);continue}e.kind===`sampler`&&(h.push({binding:t,visibility:n,sampler:{type:e.samplerType??`filtering`}}),g.push({name:e.name,role:e.role}),S.push(`@group(1) @binding(${t}) var ${r}: sampler;`))}for(let e of re){let{name:t}=e,n=Array.isArray(e.channel.conditions)&&e.channel.conditions.length>0,r=n?`${t}_base`:t;e.needsScaleFunction?b.push(cn({name:t,functionName:r,scaleDef:e.scaleDef,rawValueExpr:e.rawValueExpr,scalarType:e.scalarType,inputComponents:e.inputComponents,outputComponents:e.outputComponents,outputScalarType:e.outputScalarType,scaleConfig:e.channel.scale,useRangeTexture:e.useRangeTexture,domainMapName:e.needsDomainMap?`${De}${t}`:null})):b.push(ee(e,r)),n&&b.push(pe(e,r))}if(I)for(let[e,t]of Object.entries(_)){if(t.rangeCountUniform&&!se.has(`uRangeCount_${e}`))throw Error(`Ordinal scale on "${e}" requires uniform "${Ee}${e}".`);if(t.domainMapCountUniform&&!se.has(`uDomainMapCount_${e}`))throw Error(`Scale on "${e}" requires uniform "${Oe}${e}".`)}let _e=t.map(({name:e,type:t,components:n,arrayLength:r})=>{let i=t===`u32`?`u32`:t===`i32`?`i32`:`f32`,a=n===1?i:n===2?`vec2<${i}>`:`vec4<${i}>`;return`    ${e}: ${r==null?a:`array<vec4<${i}>, ${r}>`},`}).join(`
`),ve=$t(new Set(d.filter(e=>e.needsScaleFunction).map(e=>e.scaleDef))),ye=[...ae.map(e=>De+e.name),...i.filter(e=>e.type===`multi`).map(e=>Be+e.name)],be=ye.map(nn).join(`
`);return{shaderCode:rn(`
struct Globals {
    width: f32,
    height: f32,
    dpr: f32,
...
`,er=class extends Mn{_resolveAntialiasing(){return Qn(this._channels)}get channelOrder(){return qn}get optionalChannels(){return Xn}get channelSpecs(){return Kn}get defaultChannelConfigs(){return Yn}get defaultValues(){return Jn}get shaderBody(){return`const USE_MULTISAMPLE_EDGE_COVERAGE = ${this.antialiasing===`multisample`};\n${$n}`}getDefaultScaleRange(e){if(this.renderer?._globals){if(e===`x`||e===`x2`)return[0,this.renderer._globals.width];if(e===`y`||e===`y2`)return[0,this.renderer._globals.height]}}},tr=Object.freeze({type:`rect`,createProgram(e,t,n){return new er(e,t,n)}}),nr=`
...
`,ur=class extends Mn{get channelOrder(){return ar}get optionalChannels(){return cr}get channelSpecs(){return ir}get defaultChannelConfigs(){return sr}get defaultValues(){return or}get shaderBody(){return lr}getExtraUniformLayout(){return[{name:`uDashPatternCount`,type:`u32`,components:1}]}getExtraResourceDefs(){return[{name:`dashAtlas`,role:`extraTexture`,kind:`texture`,sampleType:`uint`,dimension:`2d`,visibility:`fragment`,wgslName:`dashAtlas`}]}_initializeExtraResources(){let e=rr(this._markConfig?.dashPatterns??null);this._dashPatternCount=e.patternCount;let t=be(this.device,{format:`r8uint`,width:e.width,height:e.height,data:e.data},void 0,O(this.label,`dash atlas`));this._extraTextures.set(`dashAtlas`,{texture:t,width:e.width,height:e.height,format:`r8uint`});let n=this._channels.strokeDash;if(e.patternCount>0&&n&&n.value!==void 0){let t=Array.isArray(n.value)?n.value[0]:n.value;typeof t==`number`&&t>=e.patternCount&&console.warn(`[webgpu-renderer] strokeDash value ${t} exceeds pattern count ${e.patternCount}.`)}}_initializeExtraUniforms(){this._setUniformValue(`uDashPatternCount`,this._dashPatternCount??0)}},dr=Object.freeze({type:`rule`,createProgram(e,t,n){return new ur(e,t,n)}});function fr(e,t){let n=e.getSlotHandles().properties;for(let[r,i]of Object.entries(t)){if(i.uniform&&!e._uniformBufferState?.entries.has(i.uniform))throw Error(`Property slot "${r}" targets unavailable uniform "${i.uniform}".`);if(!i.uniform&&!i.set)throw Error(`Property slot "${r}" has no update target.`);let t=t=>{if(i.set)i.set(t);else{let n=i.encode?i.encode(t):t;if(typeof n!=`number`&&(!Array.isArray(n)||!n.every(e=>typeof e==`number`)))throw Error(`Property "${r}" must encode to numeric uniform data.`);e._setUniformValue(i.uniform,n)}},a=e._markConfig[r];t(a===void 0?i.getDefault?i.getDefault():i.default:a),n[r]={set:n=>{e._assertAlive(),t(n),e._queueSlotUpdate(!1)}}}}var pr=[`arc`,`dome`,`diagonal`,`line`],mr=[`vertical`,`horizontal`];function hr(e){let t=pr.indexOf(e);if(t<0)throw Error(`Unknown link shape: ${String(e)}`);return t}function gr(e){let t=mr.indexOf(e);if(t<0)throw Error(`Unknown link orientation: ${String(e)}`);return t}var _r={uniqueId:{type:`u32`,components:1,optional:!0},x:{type:`f32`,components:1},x2:{type:`f32`,components:1},y:{type:`f32`,components:1},y2:{type:`f32`,components:1},xOffset:{type:`f32`,components:1,default:0},x2Offset:{type:`f32`,components:1,default:0},yOffset:{type:`f32`,components:1,default:0},y2Offset:{type:`f32`,components:1,default:0},size:{type:`f32`,components:1,default:1},color:{type:`f32`,components:4,default:[0,0,0,1]},opacity:{type:`f32`,components:1,default:1}},{channels:vr,defaults:yr,defaultConfigs:br,optionalChannels:xr}=Nn(_r),Sr=`
...
`,Cr=class extends Mn{get propertySlotDefinitions(){return{arcFadingDistance:{uniform:`uArcFadingDistance`,default:[0,0]},noFadingOnSecondPass:{uniform:`uNoFadingOnSecondPass`,default:!1,encode:e=>+!!e},arcHeightFactor:{uniform:`uArcHeightFactor`,default:1},minArcHeight:{uniform:`uMinArcHeight`,default:1.5},linkShape:{uniform:`uShape`,default:`arc`,encode:hr},orient:{uniform:`uOrient`,default:`vertical`,encode:gr},clampApex:{uniform:`uClampApex`,default:!1,encode:e=>+!!e},maxChordLength:{uniform:`uMaxChordLength`,default:5e4},segments:{uniform:`uSegmentBreaks`,default:101,encode:e=>{let t=Math.round(Number(e));return this._segmentCount=t,t}}}}_initializeExtraUniforms(){fr(this,this.propertySlotDefinitions)}_setExtraUniformValue(e,t){super._setExtraUniformValue(e,t),e==`uSegmentBreaks`&&(this._segmentCount=Math.round(Number(t)))}get channelOrder(){return vr}get optionalChannels(){return xr}get channelSpecs(){return _r}get defaultChannelConfigs(){return br}get defaultValues(){return yr}get shaderBody(){return Sr}get primitiveTopology(){return`triangle-strip`}getExtraUniformLayout(){return[{name:`uArcFadingDistance`,type:`f32`,components:2},{name:`uNoFadingOnSecondPass`,type:`u32`,components:1},{name:`uArcHeightFactor`,type:`f32`,components:1},{name:`uMinArcHeight`,type:`f32`,components:1},{name:`uShape`,type:`u32`,components:1},{name:`uOrient`,type:`u32`,components:1},{name:`uClampApex`,type:`u32`,components:1},{name:`uMaxChordLength`,type:`f32`,components:1},{name:`uSegmentBreaks`,type:`f32`,components:1}]}draw(e,t){let n=(Math.max(1,this._segmentCount??1)+1)*2;e.draw(n,t.instanceCount,0,t.firstInstance)}drawPick(e,t){let n=(Math.max(1,this._segmentCount??1)+1)*2;e.draw(n,t.instanceCount,0,t.firstInstance)}},wr=Object.freeze({type:`link`,createProgram(e,t,n){return new Cr(e,t,n)}}),Tr=[`triangle`,`open`],Er=[`inside`,`outside`];function Dr(e){return 1/Math.max(Math.tan(Math.min(Math.max(e,1),90)*Math.PI/180),1e-6)}function Or(e){let t=Tr.indexOf(e);if(t<0)throw Error(`Unknown arrow head shape: ${String(e)}`);return t}function kr(e){let t=Er.indexOf(e);if(t<0)throw Error(`Unknown arrow head placement: ${String(e)}`);return t}var Ar={uniqueId:{type:`u32`,components:1,optional:!0},x:{type:`f32`,components:1},x2:{type:`f32`,components:1},y:{type:`f32`,components:1},y2:{type:`f32`,components:1},xOffset:{type:`f32`,components:1,default:0},x2Offset:{type:`f32`,components:1,default:0},yOffset:{type:`f32`,components:1,default:0},y2Offset:{type:`f32`,components:1,default:0},fill:{type:`f32`,components:4,default:[0,0,0,1]},stroke:{type:`f32`,components:4,default:[0,0,0,1]},fillOpacity:{type:`f32`,components:1,default:1},strokeOpacity:{type:`f32`,components:1,default:1},strokeWidth:{type:`f32`,components:1,default:1},size:{type:`f32`,components:1,default:8},direction:{type:`u32`,components:1,default:0}},{channels:jr,defaults:Mr,defaultConfigs:Nr,optionalChannels:Pr}=Nn(Ar),Fr=`
...
`,Ir=class extends Mn{get propertySlotDefinitions(){return{headAngle:{uniform:`uHeadSlope`,default:45,encode:Dr},headNotchAngle:{uniform:`uHeadNotchSlope`,default:90,encode:Dr},minSize:{uniform:`uMinSize`,default:1},headWidth:{uniform:`uHeadWidth`,default:3},startNotch:{uniform:`uStartNotch`,default:!1,encode:e=>+!!e},minStemLength:{uniform:`uMinStemLength`,default:0},headSpacing:{uniform:`uHeadSpacing`,default:null,encode:e=>e??-1},stem:{uniform:`uStem`,default:!0,encode:e=>e===!1?0:1},headShape:{uniform:`uHeadShape`,default:`triangle`,encode:Or},headPlacement:{uniform:`uHeadPlacement`,default:`inside`,encode:kr}}}_initializeExtraUniforms(){fr(this,this.propertySlotDefinitions)}get channelOrder(){return jr}get optionalChannels(){return Pr}get channelSpecs(){return Ar}get defaultChannelConfigs(){return Nr}get defaultValues(){return Mr}get shaderBody(){return Fr}get primitiveTopology(){return`triangle-list`}getExtraUniformLayout(){return[{name:`uHeadSlope`,type:`f32`,components:1},{name:`uHeadNotchSlope`,type:`f32`,components:1},{name:`uMinSize`,type:`f32`,components:1},{name:`uHeadWidth`,type:`f32`,components:1},{name:`uStartNotch`,type:`u32`,components:1},{name:`uMinStemLength`,type:`f32`,components:1},{name:`uHeadSpacing`,type:`f32`,components:1},{name:`uStem`,type:`u32`,components:1},{name:`uHeadShape`,type:`u32`,components:1},{name:`uHeadPlacement`,type:`u32`,components:1}]}draw(e,t){e.draw(6,t.instanceCount,0,t.firstInstance)}},Lr=Object.freeze({type:`arrow`,createProgram(e,t,n){return new Ir(e,t,n)}}),Rr=Object.freeze({thin:100,light:300,regular:400,normal:400,medium:500,bold:700,black:900}),zr=new Map,Br;function Vr(e){if(typeof e==`number`)return e;let t=Rr[e.toLowerCase()];if(!t)throw Error(`Unknown font weight: `+e);return t}function Hr(e,t=`normal`,n=`regular`){return`${e}\u0000${t}\u0000${Vr(n)}`}function Ur(){return zr}function Wr(){return Br===void 0?void 0:zr.get(Br)}var Gr=class{constructor(){this._fonts=new Map(Ur()),this._defaultFontEntry=Wr()}_getKey(e,t,n){return Hr(e,t,n)}registerFont({family:e,style:t=`normal`,weight:n=`regular`,metrics:r,bitmap:i}){let a=this._getKey(e,t,n);this._fonts.set(a,{metrics:r,bitmap:i})}getFont(e,t=`normal`,n=`regular`){let r=this._getKey(e,t,n),i=this._fonts.get(r);if(!i){if(!this._defaultFontEntry)throw Error(`Cannot find font: "${e}". Import a font preset or provide a font resource.`);return console.warn(`Cannot find font: "${e}". Using the registered default font.`),this._defaultFontEntry}return i}getDefaultFont(){if(!this._defaultFontEntry)throw Error(`No default font is registered. Import a font preset before using the default font.`);return this._defaultFontEntry}};async function Kr(e){let t=await fetch(e);if(!t.ok)throw Error(`Could not load BMFont bitmap: ${t.status}`);let n=await t.blob();return createImageBitmap(n)}function qr({strings:e,fontManager:t=new Gr,font:n={family:`Lato`,style:`normal`,weight:400},fontSize:r=12,lineHeight:i=1,letterSpacing:a=0}){let o=Array.isArray(e)?e:[e],s=n.style===`italic`?`italic`:`normal`,c=t.getFont(n.family,s,n.weight??400).metrics,l=r/c.common.base,u=c.common.lineHeight*l*i,d=c.common.base*l,f=c.descent*l,p=a/l,m=0,h=!1;for(let e of o){e.includes(`
...
`,resources:{stopKind:`continuous`,needsDomainMap:!0,needsOrdinalRange:!1},normalizeDomainMap:pi,normalizeStops:fi,validate:di,emit:ui};Object.freeze(li);function ui({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,domainMapName:i}){let a=ot(n,r),o=Oe+e;return i?`${it(e,`f32`,t)} {
    let raw = ${a};
    ...
    let mapped = ${tn(i)}(raw, arrayLength(&${i}));
    if (mapped == HASH_NOT_FOUND) { return ${N(e)}.x; }
    return scaleBand(
        mapped,
        ${M(e)},
        ${N(e)},
...
}`}function di({name:e,channel:t,inputComponents:n,needsDomainMap:r}){if(r){if(n!==1)return`Band scale on "${e}" requires scalar inputs when using an ordinal domain.`;if(T(t)&&typeof t.value==`number`&&!Number.isInteger(t.value))return`Band scale on "${e}" requires integer values when using an ordinal domain.`}return null}function fi({name:e,scale:t,getDefaultScaleRange:n}){let r=ci(e,`band`,Array.isArray(t.domain)||ArrayBuffer.isView(t.domain)?t.domain:void 0);if(!r)return;let i=Array.isArray(t.range)?t.range:n(e)??[0,1];if(typeof i[0]!=`number`||typeof i[1]!=`number`)throw Error(`Scale range for "${e}" must be numeric.`);let a=i;return{domain:[0,r.length],range:[a[0]??0,a[1]??1],domainLength:2,rangeLength:2}}function pi({name:e,domain:t}){let n=ci(e,`band`,t);return n?{domainMap:n,domainUniform:[0,n.length]}:null}var mi=li;function hi(e={}){return L(mi,e)}var gi=ct;function _i(e={}){return L(gi,e)}var vi={type:`index`,input:`u32`,output:`f32`,params:[{prefix:Fe,defaultValue:0,prop:`paddingInner`},{prefix:Ie,defaultValue:0,prop:`paddingOuter`},{prefix:Le,defaultValue:.5,prop:`align`},{prefix:Re,defaultValue:.5,prop:`band`}],continuous:!1,vectorOutput:`never`,allowsU32InputOverride:!0,allowsPackedScalarInput:!0,wgsl:`
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},getStopLengths:()=>({domainLength:3,rangeLength:2}),normalizeStops:bi,normalizeDomain:xi,emit:yi};Object.freeze(vi);function yi({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,inputComponents:i}){let a=i===2?n:ot(n,r),o=i===2?`scaleBandHpU`:`scaleBandHp`;return`${it(e,`f32`,t)} {
    let v = ${a};
    return ${o}(
        v,
        ${at(e)},
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:Ti};Object.freeze(wi);function Ti(e){return st(e,({name:e,valueExpr:t})=>`scaleLog(${t}, ${M(e)}, ${N(e)}, params.${Me}${e})`)}var Ei=wi;function Di(e={}){return L(Ei,e)}var Oi={type:`ordinal`,input:`u32`,output:`f32`,params:[],continuous:!1,vectorOutput:`always`,allowsU32InputOverride:!0,resources:{stopKind:null,needsDomainMap:!0,needsOrdinalRange:!0},normalizeDomainMap:ji,validate:Ai,emit:ki};Object.freeze(Oi);function ki({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,outputComponents:i,outputScalarType:a,domainMapName:o}){let s=i===1?a:`vec${i}<f32>`,c=`range_${e}`,l=i===1?a===`u32`?`0u`:a===`i32`?`0`:`0.0`:`vec4<f32>(0.0)`,u=ot(n,r),d=Oe+e;return o?`${it(e,s,t)} {
    let raw = ${u};
    let mapCount = u32(params.${d});
    if (mapCount == 0u) {
        let count = u32(params.${Ee}${e});
        if (count == 0u) { return ${l}; }
        let slot = raw % count;
        return ${c}[slot];
    }
    let idx = ${tn(o)}(raw, arrayLength(&${o}));
    ...
    let slot = idx % count;
    return ${c}[slot];
}`}function Ai({name:e,channel:t,outputComponents:n,inputComponents:r}){if(n!==1&&n!==4)return`Channel "${e}" uses ${n} components but ordinal scales only support scalars or vec4 outputs.`;let i=t.scale?.range;if(!Array.isArray(i)||i.length===0)return`Ordinal scale on "${e}" requires a non-empty range.`;if(r!==1)return`Ordinal scale on "${e}" requires scalar input values.`;if(T(t)){if(Array.isArray(t.value))return`Ordinal scale on "${e}" requires scalar integer values.`;if(typeof t.value==`number`&&!Number.isInteger(t.value))return`Ordinal scale on "${e}" requires integer values.`}return null}function ji({name:e,domain:t}){let n=ci(e,`ordinal`,t);return n?{domainMap:n}:null}var Mi=Oi;function Ni(e={}){return L(Mi,e)}var Pi={type:`pow`,input:`numeric`,output:`f32`,params:[{prefix:Ne,defaultValue:1,prop:`exponent`}],continuous:!0,vectorOutput:`interpolated`,wgslDeps:[Pn],wgsl:`
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:Fi};Object.freeze(Pi);function Fi(e){return st(e,({name:e,valueExpr:t})=>`scalePow(${t}, ${M(e)}, ${N(e)}, params.${Ne}${e})`)}var Ii=Pi;function Li(e={}){return L(Ii,e)}var Ri={type:`quantize`,input:`numeric`,output:`same`,params:[],continuous:!1,vectorOutput:`always`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},getStopLengths:Vi,normalizeStops:Hi,validate:Bi,emit:zi};Object.freeze(Ri);function zi({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,outputComponents:i,outputScalarType:a,rangeLength:o}){if(o<1)throw Error(`Quantize scale on "${e}" must define at least one range entry.`);let s=i===1?a:`vec${i}<f32>`,c=[];return r!==`f32`&&c.push(Ze(r)),c.push(rt({name:e,rangeLength:o,outputComponents:i,outputScalarType:a})),Xe({name:e,functionName:t,rawValueExpr:n,steps:c,returnType:s})}function Bi({name:e,channel:t,outputComponents:n,inputComponents:r}){if(n!==1&&n!==4)return`Channel "${e}" uses ${n} components but quantize scales only support scalars or vec4 outputs.`;if(r!==1)return`Quantize scale on "${e}" requires scalar input values.`;let i=t.scale?.domain;if(Array.isArray(i)&&i.length!==2)return`Quantize scale on "${e}" requires a domain with exactly two entries.`;let a=t.scale?.range;return a!==void 0&&!Array.isArray(a)?`Quantize scale on "${e}" requires an explicit array range.`:Array.isArray(a)&&a.length<1?`Quantize scale on "${e}" requires at least one range entry.`:null}function Vi({scale:e}){let t=Array.isArray(e.range)?e.range:[0,1];if(t.length<1)throw Error(`Quantize scale on "${e.type}" requires at least one range entry.`);return{domainLength:2,rangeLength:t.length}}function Hi({name:e,scale:t,channel:n,getDefaultScaleRange:r}){let i=Array.isArray(t.domain)?t.domain:[0,1];if(i.length!==2)throw Error(`Quantize scale on "${e}" requires a domain with exactly two entries.`);if(P(t.range))throw Error(`Quantize scale on "${e}" does not support interpolator ranges.`);let a=n.components??1,o=Array.isArray(t.range)?t.range:r(e)??[0,1];if(!Array.isArray(o)||o.length<1)throw Error(`Quantize scale on "${e}" requires at least one range entry.`);let s=o.map(t=>Ot(e,t,a,`Quantize`));return{domain:[i[0]??0,i[1]??1],range:s,domainLength:2,rangeLength:s.length}}var Ui=Ri;function Wi(e={}){return L(Ui,e)}var Gi={type:`sqrt`,input:`numeric`,output:`f32`,params:[{prefix:Ne,defaultValue:.5,prop:`exponent`}],continuous:!0,vectorOutput:`interpolated`,wgslDeps:[Pi],resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:Ki};Object.freeze(Gi);function Ki(e){return st(e,({name:e,valueExpr:t})=>`scalePow(${t}, ${M(e)}, ${N(e)}, params.${Ne}${e})`)}var qi=Gi;function Ji(e={}){return L(qi,e)}var Yi={type:`symlog`,input:`numeric`,output:`f32`,params:[{prefix:Pe,defaultValue:1,prop:`constant`}],continuous:!0,vectorOutput:`interpolated`,wgslDeps:[Pn],wgsl:`
...
`,resources:{stopKind:`continuous`,needsDomainMap:!1,needsOrdinalRange:!1},emit:Xi};Object.freeze(Yi);function Xi(e){return st(e,({name:e,valueExpr:t})=>`scaleSymlog(${t}, ${M(e)}, ${N(e)}, params.${Pe}${e})`)}var Zi=Yi;function Qi(e={}){return L(Zi,e)}var $i={type:`threshold`,input:`numeric`,output:`same`,params:[],continuous:!1,vectorOutput:`always`,allowsF32InputOverride:!0,resources:{stopKind:`threshold`,needsDomainMap:!1,needsOrdinalRange:!1},validate:ta,emit:ea};Object.freeze($i);function ea({name:e,functionName:t,rawValueExpr:n,inputScalarType:r,outputComponents:i,outputScalarType:a,domainLength:o,rangeLength:s}){if(o<1||s!==o+1)throw Error(`Threshold scale on "${e}" requires domain length N and range length N+1.`);let c=i===1?a:`vec${i}<f32>`,l=[];return r!==`f32`&&l.push(Ze(r)),l.push(nt({name:e,domainLength:o,outputComponents:i,outputScalarType:a})),Xe({name:e,functionName:t,rawValueExpr:n,steps:l,returnType:c})}function ta({name:e,channel:t,outputComponents:n,inputComponents:r}){if(n!==1&&n!==4)return`Channel "${e}" uses ${n} components but threshold scales only support scalars or vec4 outputs.`;let i=t.scale?.domain,a=t.scale?.range;return!Array.isArray(i)||i.length===0?`Threshold scale on "${e}" requires a non-empty domain.`:!Array.isArray(a)||a.length<2?`Threshold scale on "${e}" requires at least two range entries.`:a.length===i.length+1?r===1?null:`Threshold scale on "${e}" requires scalar input values.`:`Threshold scale on "${e}" requires range length of ${i.length+1}, got ${a.length}.`}var na=$i;function ra(e={}){return L(na,e)}var ia=new Map([`circle`,`square`,`cross`,`diamond`,`triangle-up`,`triangle-right`,`triangle-down`,`triangle-left`,`tick-up`,`tick-right`,`tick-down`,`tick-left`,`x`,`+`].map((e,t)=>[e,t])),aa=new Map([[`left`,0],[`center`,1],[`right`,2]]),oa=new Map([[`alphabetic`,0],[`baseline`,0],[`middle`,1],[`top`,2],[`bottom`,3]]),sa=new Map([[`butt`,0],[`square`,1],[`round`,2]]),ca=new Map([[`forward`,0],[`reverse`,1]]),la=new Map([`none`,`diagonal`,`antiDiagonal`,`cross`,`vertical`,`horizontal`,`grid`,`dots`,`rings`,`ringsLarge`].map((e,t)=>[e,t])),ua=[`viewportEdgeFadeWidthTop`,`viewportEdgeFadeWidthRight`,`viewportEdgeFadeWidthBottom`,`viewportEdgeFadeWidthLeft`],da=[`viewportEdgeFadeDistanceTop`,`viewportEdgeFadeDistanceRight`,`viewportEdgeFadeDistanceBottom`,`viewportEdgeFadeDistanceLeft`],fa=new WeakMap,pa=new WeakMap;function ma(e,t,n,r=1,i,a){va(e);let o=typeof r==`function`?r:()=>r,s=i??b(e,t);if(s.length==0)return;let c=e.encoders.facetIndex?{data:ba(e,s),type:`u32`}:a,l=e.getType();if(l==`point`)return ha(Gn,ya(Ea(e,s,n,o),c),e);if(l==`rect`)return ha(tr,ya(Ta(e,s,n,o,typeof r!=`function`),c),e);if(l==`rule`||l==`tick`)return ha(dr,ya(ka(e,s,n,o),c),e);if(l==`text`)return ha(si,ya(Aa(e,s,n,o),c),e);if(l==`link`)return ha(wr,ya(ja(e,s,n,o),c),e);if(l==`arrow`)return ha(Lr,ya(Ma(e,s,n,o),c),e);throw X(e,`Mark type "${l}" is not supported.`)}function ha(e,t,n){let r=n.getOrder?.();r&&(t.order={when:Ca(n,r.predicate.selection),matching:r.passes[0]===`matching`?`first`:`last`});let i=t.retainedProperties??{};return delete t.retainedProperties,{definition:e,config:t,properties:i}}function ga(e){return va(e),e.getRenderingRevision(`configuration`)}function _a(e){return va(e),e.getRenderingRevision(`resources`)}function va(e){e.initializeRenderingRevisions([])}function ya(e,t){return t?{...e,placementIndex:t}:e}function ba(e,t){let n=e.encoders.facetIndex,r=pa.get(e);if(r?.data===t&&r.encoder===n)return r.values;let i=new Uint32Array(t.length);for(let r=0;r<t.length;r++){let a=Number(n(t[r]));if(!Number.isInteger(a)||a<0||a>4294967295)throw X(e,`Facet indices must be non-negative integers.`);i[r]=a}return pa.set(e,{data:t,encoder:n,values:i}),i}function xa(e,t,n,r){let i=oo(e,t),a=i.branches,o=a.at(-1);if(!o)throw X(e,`Channel "${t}" has no fallback branch.`);let s=r(Sa(e,i,o),o);return a.length==1||(s.conditions=a.slice(0,-1).map(t=>{let n=r(Sa(e,i,t),t);return{when:Ca(e,t.predicate.selection),channel:n}})),s}function Sa(e,t,n){let r=n.accessor,i=r.scaleChannel?e.unitView.getScaleResolution(r.scaleChannel)?.getScale():t.scale;if(r.scaleChannel&&!i)throw X(e,`Missing scale for conditional channel "${r.channel}".`);return Object.assign(e=>r(e),{constant:r.constant??t.constant,branches:[n],scale:i,channelDef:r.channelDef??t.channelDef})}function Ca(e,t){let{params:n,empty:r,singleParam:a}=t,o=(t,n)=>{let r=e.unitView.paramRuntime.findValue(t);if(!r||![`single`,`multi`,`interval`].includes(r.type))throw X(e,`Selection "${t}" is not available for WebGPU.`);let a={selection:t,type:r.type};if(n!==void 0&&(a.empty=n),r.type==`interval`){let n=a;n.targets=Object.keys(r.intervals).map(n=>{if(n!=`x`&&n!=`y`)throw X(e,`Interval selection "${t}" has unsupported target "${String(n)}".`);wa(e,t,n);let r=i(n),a={input:n};return e.encoders[r]?(wa(e,t,r),{...a,secondaryInput:r,hitTest:e.defaultHitTestMode}):a})}return a};return a?o(n[0],r):{selectionUnion:n.map(e=>o(e)),empty:r}}function wa(e,t,n){let r=e.encoders[n]?.scale;if(r&&(r.type==`index`||r.type==`locus`)&&f(r.domain().map(Number)))throw X(e,`Interval selection "${t}" cannot target two-component channel "${n}".`)}function Ta(e,t,n,r,i){return e.initializeRenderingRevisions([`cornerRadius`,`cornerRadiusTopRight`,`cornerRadiusBottomRight`,`cornerRadiusTopLeft`,`cornerRadiusBottomLeft`,`minWidth`,`minHeight`,`minOpacity`,`shadowOffsetX`,`shadowOffsetY`,`shadowBlur`,`shadowOpacity`,`shadowColor`,`hatch`]),{count:t.length,channels:{...io(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),fill:H(e,`fill`,t),stroke:H(e,`stroke`,t),fillOpacity:V(e,`fillOpacity`,t,r),strokeOpacity:V(e,`strokeOpacity`,t,r),strokeWidth:B(e,`strokeWidth`,t,!0),cornerRadiusTopRight:yo(e,[`cornerRadius`,`cornerRadiusTopRight`],()=>_o(e).topRight),cornerRadiusBottomRight:yo(e,[`cornerRadius`,`cornerRadiusBottomRight`],()=>_o(e).bottomRight),cornerRadiusTopLeft:yo(e,[`cornerRadius`,`cornerRadiusTopLeft`],()=>_o(e).topLeft),cornerRadiusBottomLeft:yo(e,[`cornerRadius`,`cornerRadiusBottomLeft`],()=>_o(e).bottomLeft),minWidth:Y(()=>K(e,`minWidth`)),minHeight:Y(()=>K(e,`minHeight`)),minOpacity:Y(()=>K(e,`minOpacity`)),shadowOffsetX:Y(()=>q(e,`shadowOffsetX`,0)),shadowOffsetY:Y(()=>q(e,`shadowOffsetY`,0)),shadowBlur:Y(()=>q(e,`shadowBlur`,0)),shadowOpacity:yo(e,[`shadowOpacity`],()=>q(e,`shadowOpacity`,0)*r(),void 0,!i),shadowColor:Y(()=>wo(e,J(e,`shadowColor`)??`black`)),hatchPattern:yo(e,[`hatch`],()=>vo(e,`hatch`,la,`none`),`u32`)}}}function Ea(e,t,n,r){e.initializeRenderingRevisions([`fillGradientStrength`,`inwardStroke`,`semanticZoomFraction`]);let i=Da(e,t);return{count:t.length,channels:{...io(e,t),x:z(e,`x`,t,n),y:z(e,`y`,t,n),size:B(e,`size`,t),shape:Va(e,`shape`,t,ia),strokeWidth:B(e,`strokeWidth`,t),xOffset:B(e,`xOffset`,t),yOffset:B(e,`yOffset`,t),dx:Ja(e,`x`,t),dy:Ja(e,`y`,t),fill:H(e,`fill`,t),stroke:H(e,`stroke`,t),fillOpacity:V(e,`fillOpacity`,t,r),strokeOpacity:V(e,`strokeOpacity`,t,r),angle:B(e,`angle`,t),gradientStrength:Y(()=>K(e,`fillGradientStrength`)),inwardStroke:Y(()=>+!!J(e,`inwardStroke`),`u32`)},...i}}function Da(e,t){let n=e.encoders.semanticScore;if(!n||(so(e,`semanticScore`,n),n.constant))return{};let r=n.branches[0].accessor,i=W(e,`semanticScore`,t,r),a=Oa(e),o={compare:`>=`,left:{input:`semanticScoreInput`},right:{slot:`semanticThreshold`}},s=a.length>0?{any:[...a,o]}:o;return{inputs:{semanticScoreInput:{data:i,type:`f32`}},scalarSlots:{semanticThreshold:bo(()=>e.getSemanticThreshold(),`f32`)},visibleWhen:s}}function Oa(t){return t.encoders.uniqueId?Array.from(e(t.encoders),([e,n])=>Ca(t,{params:[e],empty:!1,singleParam:!n})):[]}function ka(e,t,n,r){e.initializeRenderingRevisions([`minLength`,`strokeCap`,`strokeDashOffset`]);let i=J(e,`strokeDash`);return{count:t.length,channels:{...io(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),size:B(e,`size`,t),color:H(e,`color`,t),opacity:V(e,`opacity`,t,r),minLength:Y(()=>K(e,`minLength`)),strokeCap:Y(()=>vo(e,`strokeCap`,sa),`u32`),strokeDashOffset:Y(()=>K(e,`strokeDashOffset`)),strokeDash:{value:0,type:`u32`}},dashPatterns:i==null?null:[i]}}function Aa(e,t,n,r){let i=Ya(e,`size`,t[0]),a=e.encoders,o=e.font;return{count:t.length,channels:{...io(e,t),x:z(e,`x`,t,n,Za),...e.encoders.x2?{x2:z(e,`x2`,t,n,Za)}:{},y:z(e,`y`,t,n,Za),...e.encoders.y2?{y2:z(e,`y2`,t,n,Za)}:{},text:qa(e,t),size:B(e,`size`,t),angle:B(e,`angle`,t),xOffset:B(e,`xOffset`,t),yOffset:B(e,`yOffset`,t),dx:Ja(e,`x`,t),dy:Ja(e,`y`,t),...a.x2Offset?{x2Offset:B(e,`x2Offset`,t)}:{},...a.y2Offset?{y2Offset:B(e,`y2Offset`,t)}:{},align:{value:vo(e,`align`,aa),type:`u32`},baseline:{value:vo(e,`baseline`,oa),type:`u32`},fill:H(e,`color`,t),opacity:V(e,`opacity`,t,r)},font:Na(e),...o?.metrics&&o.bitmapUrl?{fontResource:{metrics:o.metrics,bitmap:o.bitmapUrl}}:{},fontStyle:J(e,`fontStyle`),fontWeight:J(e,`fontWeight`),fontSize:i,viewport:[n.x,n.y,n.x2,n.y2],viewportEdgeFadeWidth:mo(e,ua,[0,0,0,0]),viewportEdgeFadeDistance:mo(e,da,[-1/0,-1/0,-1/0,-1/0]),paddingX:K(e,`paddingX`),paddingY:K(e,`paddingY`),flushX:!!J(e,`flushX`),flushY:!!J(e,`flushY`),squeeze:!!J(e,`squeeze`),logoLetters:!!J(e,`logoLetters`),retainedProperties:{viewport:xo(()=>[n.x,n.y,n.x2,n.y2]),...Co(e,`viewportEdgeFadeWidth`,ua,[0,0,0,0]),...Co(e,`viewportEdgeFadeDistance`,da,[-1/0,-1/0,-1/0,-1/0]),...So(e,{paddingX:e=>e,paddingY:e=>e,flushX:e=>!!e,flushY:e=>!!e,squeeze:e=>!!e,logoLetters:e=>!!e})}}}function ja(e,t,n,r){return{count:t.length,channels:{...io(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),size:B(e,`size`,t),color:H(e,`color`,t),opacity:V(e,`opacity`,t,r)},linkShape:J(e,`linkShape`)??`arc`,orient:J(e,`orient`)??`vertical`,arcFadingDistance:go(e,`arcFadingDistance`),noFadingOnSecondPass:!!J(e,`noFadingOnSecondPass`),arcHeightFactor:q(e,`arcHeightFactor`,1),minArcHeight:q(e,`minArcHeight`,1.5),clampApex:!!J(e,`clampApex`),maxChordLength:q(e,`maxChordLength`,5e4),segments:q(e,`segments`,101),retainedProperties:So(e,{arcFadingDistance:e=>e||[0,0],noFadingOnSecondPass:e=>!!e,arcHeightFactor:e=>e,minArcHeight:e=>e,linkShape:e=>e??`arc`,orient:e=>e??`vertical`,clampApex:e=>!!e,maxChordLength:e=>e,segments:e=>e})}}function Ma(e,t,n,r){let i=q(e,`headAngle`,45),a=q(e,`headNotchAngle`,90);return{count:t.length,channels:{...io(e,t),x:z(e,`x`,t,n),x2:z(e,`x2`,t,n),y:z(e,`y`,t,n),y2:z(e,`y2`,t,n),xOffset:B(e,`xOffset`,t),x2Offset:B(e,`x2Offset`,t),yOffset:B(e,`yOffset`,t),y2Offset:B(e,`y2Offset`,t),fill:H(e,`fill`,t),stroke:H(e,`stroke`,t),fillOpacity:V(e,`fillOpacity`,t,r),strokeOpacity:V(e,`strokeOpacity`,t,r),strokeWidth:B(e,`strokeWidth`,t),size:B(e,`size`,t),direction:Va(e,`direction`,t,ca)},headAngle:i,headNotchAngle:a,minSize:q(e,`minSize`,1),headWidth:q(e,`headWidth`,3),startNotch:!!J(e,`startNotch`),minStemLength:q(e,`minStemLength`,0),headSpacing:ho(e,`headSpacing`),stem:J(e,`stem`)!==!1,headShape:J(e,`headShape`)??`triangle`,headPlacement:J(e,`headPlacement`)??`inside`,retainedProperties:So(e,{headAngle:e=>e,headNotchAngle:e=>e,minSize:e=>e,headWidth:e=>e,startNotch:e=>!!e,minStemLength:e=>e,headSpacing:e=>e,stem:e=>e!==!1,headShape:e=>e??`triangle`,headPlacement:e=>e??`inside`})}}function Na(e){let t=J(e,`font`);if(t==null||t==`sans-serif`)return`Lato`;if(typeof t==`string`)return t;throw X(e,`Font "${String(t)}" is not supported.`)}function z(e,t,n,r,i=Xa){return xa(e,t,n,a=>Pa(e,t,n,r,a,i))}function Pa(e,n,r,i,a,o){let s=a.branches[0].accessor,c=t(a.channelDef)?void 0:a.scale,l=o(n,i,c),u=a.channelDef.band??.5;if(c?.type==`band`||c?.type==`point`||c?.type==`ordinal`){let{intern:t,readDomain:d}=po(e,n,c),f=a.constant?Y(()=>t(s(r[0])),`u32`):{data:G(e,n,r,s,()=>Uint32Array.from(r,e=>t(s(e)))),type:`u32`};return Object.assign(f,{scale:c.type==`ordinal`?Ia(c,o(n,i,void 0),d):Fa(c,l,d,u)})}else if(c?.type==`index`||c?.type==`locus`){let t=f(c.domain().map(Number)),i=a.constant?uo(e,n,()=>s(r[0]),t):{data:co(e,n,r,s,t),type:`u32`};return Object.assign(i,{...t?{inputComponents:2}:{},scale:La(c,l,u)})}let d=a.constant?Y(()=>{let t=Number(s(r[0]));if(!Number.isFinite(t))throw X(e,`Channel "${n}" is not finite.`);return t},`f32`):{data:W(e,n,r,s),type:`f32`};return Object.assign(d,{scale:Qa(e,n,c,l)})}function Fa(e,t,n,r){let i=e;return U(hi({domain:n(),range:t,paddingInner:e.type==`point`?1:i.paddingInner(),paddingOuter:i.paddingOuter(),align:i.align(),band:r}),n)}function Ia(e,t,n){let r=()=>e.range().map(e=>t[0]+Number(e)*(t[1]-t[0]));return U(Ni({domain:n(),range:r()}),n,r)}function La(e,t,n){let r=e;return U(Ci({domain:e.domain().map(Number),range:t,paddingInner:r.paddingInner(),paddingOuter:r.paddingOuter(),align:r.align(),band:n}),()=>e.domain().map(Number))}function B(e,t,n,r=!1){return xa(e,t,n,i=>r&&Ra(i)?{value:Number(i(n[0]))}:za(e,t,n,i))}function Ra(e){let n=e.channelDef;return e.constant&&!e.scale&&(t(n)&&!r(n.value)||c(n)&&!r(n.datum))}function za(e,t,n,r){if(r.constant)return Y(()=>Number(r(n[0])));let i=r.branches[0].accessor;if(r.scale?.type==`ordinal`||r.scale?.type==`band`||r.scale?.type==`point`){let{values:a,readDomain:o}=fo(e,t,n,i,r.scale);return{data:a,type:`u32`,scale:r.scale.type==`ordinal`?$a(e,t,r.scale,1,o):Fa(r.scale,r.scale.range(),o,r.channelDef.band??.5)}}let a={data:W(e,t,n,i),type:`f32`},o=$a(e,t,r.scale);return o?{...a,scale:o}:a}function V(e,t,n,r){return xa(e,t,n,i=>Ba(e,t,n,r,i))}function Ba(e,t,n,r,i){if(i.constant)return Y(()=>Number(i(n[0]))*r());let a=i.branches[0].accessor;if(i.scale?.type==`ordinal`){let{values:o,readDomain:s}=fo(e,t,n,a,i.scale);return{data:o,type:`u32`,scale:$a(e,t,i.scale,r,s)}}let o=i.scale?.type==`identity`?void 0:$a(e,t,i.scale,r);return o?{data:W(e,t,n,a),type:`f32`,scale:o}:{data:W(e,t,n,a),type:`f32`,scale:U(R({domain:[0,1],range:[0,r()]}),void 0,()=>[0,r()])}}function Va(e,t,n,r){return xa(e,t,n,i=>Ha(e,t,n,r,i))}function Ha(e,t,n,r,i){if(i.constant)return Y(()=>no(e,t,r,i(n[0])),`u32`);let a=i.branches[0].accessor;if(i.scale?.type==`ordinal`){let{values:o,readDomain:s}=fo(e,t,n,a,i.scale);return{data:o,type:`u32`,scale:U(Ni({domain:s(),range:i.scale.range().map(n=>no(e,t,r,n))}),s,()=>i.scale.range().map(n=>no(e,t,r,n)))}}return i.scale?.type==`threshold`?{data:W(e,t,n,a),type:`f32`,scale:U(ra({domain:i.scale.domain().map(Number),range:ro(e,t,r,i.scale)}),()=>i.scale.domain().map(Number),()=>ro(e,t,r,i.scale))}:{data:G(e,t,n,a,()=>Uint32Array.from(n,n=>no(e,t,r,a(n)))),type:`u32`}}function H(e,t,n){return xa(e,t,n,r=>Ua(e,t,n,r))}function Ua(e,t,n,r){if(r.constant)return Y(()=>wo(e,r(n[0])));let i=r.branches[0].accessor,a=r.scale;if(!a)return{data:G(e,t,n,i,()=>{let t=new Float32Array(n.length*4);return n.forEach((n,r)=>{t.set(wo(e,i(n)),r*4)}),t}),type:`f32`,inputComponents:4};if(a.type==`ordinal`){let{values:r,readDomain:o}=fo(e,t,n,i,a);return{data:r,type:`u32`,inputComponents:1,scale:Wa(e,t,a,o)}}return{data:W(e,t,n,i),type:`f32`,inputComponents:1,scale:Wa(e,t,a)}}function Wa(e,t,n,r){let i=n;if(n.type==`ordinal`)return U(Ni({domain:r?.(),range:n.range()}),r,()=>n.range());if(n.type==`sequential-linear`||n.type==`diverging-linear`)return U(R({domain:Ka(n),range:i.interpolator(),clamp:i.clamp()}),()=>Ka(n),()=>i.interpolator());if(n.type==`sequential-log`)return U(Di({domain:Ka(n),range:i.interpolator(),base:i.base(),clamp:i.clamp()}),()=>Ka(n),()=>i.interpolator());if(n.type==`linear`)return U(R({domain:n.domain().map(Number),range:n.range(),interpolate:i.interpolate(),clamp:i.clamp()}),()=>n.domain().map(Number),()=>n.range());if(n.type==`threshold`)return U(ra({domain:n.domain().map(Number),range:Ga(e,n.range())}),()=>n.domain().map(Number),()=>Ga(e,n.range()));if(n.type==`quantize`)return U(Wi({domain:n.domain().map(Number),range:Ga(e,n.range())}),()=>n.domain().map(Number),()=>Ga(e,n.range()));throw X(e,`Scale type "${n.type}" on channel "${t}" is not supported.`)}function Ga(e,t){return t.map(t=>typeof t==`string`?wo(e,t):t)}function Ka(e){let t=e.domain().map(Number);return[t[0],t.at(-1)]}function qa(e,t){let n=oo(e,`text`);so(e,`text`,n);let r=n.channelDef,i=`format`in r?o(r.format):e=>e,a=e=>{let t=i(n(e));return t==null?``:String(t)};return n.constant?{value:a(t[0])}:{data:G(e,`text`,t,n.branches[0].accessor,()=>t.map(a))}}function Ja(e,t,n){let r=t==`x`?`dx`:`dy`,i=e.encoders[r];if(!i)return Y(()=>K(e,r));so(e,r,i);let a=Sa(e,i,i.branches[0]),o=e=>Number(a(e));return a.constant?Y(()=>o(n[0])):{data:Float32Array.from(n,o),type:`f32`}}function Ya(e,t,n){let r=oo(e,t),i=Number(r(n));if(!Number.isFinite(i))throw X(e,`Channel "${t}" is not finite.`);return i}function Xa(e,t,n){let r=n?.props?.reverse;return e[0]==`x`?r?[t.x2,t.x]:[t.x,t.x2]:r?[t.y,t.y2]:[t.y2,t.y]}function Za(e,t,n){let r=n?.props?.reverse;return e[0]==`x`?r?[t.width,0]:[0,t.width]:r?[0,t.height]:[t.height,0]}function Qa(e,t,n,r){return!n||n.type==`null`?R({domain:[0,1],range:r}):eo(e,t,n,r)}function $a(e,t,n,r=1,i){if(!n||n.type==`null`)return;if(n.type==`identity`)return _i();let a=typeof r==`function`?r:()=>r;return eo(e,t,n,()=>n.range().map(e=>Number(e)*a()),i)}function eo(e,t,n,r,i){let a=n,o=typeof i==`function`?i:i?()=>i:()=>n.domain().map(Number),s=typeof r==`function`?r:()=>r,c={domain:o(),range:s(),clamp:to(a,`clamp`,!1)};to(a,`round`,!1)&&(c.round=!0);let l;switch(n.type){case`linear`:case`sequential-linear`:case`diverging-linear`:l=R(c);break;case`log`:l=Di({...c,base:to(a,`base`,10)});break;case`pow`:l=Li({...c,exponent:to(a,`exponent`,1)});break;case`sqrt`:l=Ji(c);break;case`symlog`:l=Qi({...c,constant:to(a,`constant`,1)});break;case`quantize`:l=Wi(c);break;case`threshold`:l=ra(c);break;case`ordinal`:l=Ni(c);break;default:throw X(e,`Scale type "${n.type}" on channel "${t}" is not supported.`)}return U(l,o,s)}function U(e,t,n){return Object.defineProperties(e,{...t?{domain:{enumerable:!0,get:t}}:{},...n?{range:{enumerable:!0,get:n}}:{}}),e}function to(e,t,n){let r=e[t];return typeof r==`function`?r():r??n}function no(e,t,n,r){let i=n.get(String(r));if(i===void 0)throw X(e,`Unsupported ${t}: ${String(r)}`);return i}function ro(e,t,n,r){let i=r.domain(),a=r.range().map(r=>no(e,t,n,r));for(;a.length<i.length+1;)a.push(a.at(-1));return a}function io(e,t){let n=e.encoders.uniqueId;if(!n)return{};if(so(e,`uniqueId`,n),n.constant)return{uniqueId:Y(()=>ao(e,`uniqueId`,n(t[0])),`u32`)};let r=n.branches[0].accessor;return{uniqueId:{data:G(e,`uniqueId`,t,r,()=>Uint32Array.from(t,t=>ao(e,`uniqueId`,r(t)))),type:`u32`}}}function ao(e,t,n){let r=Number(n);if(!Number.isSafeInteger(r)||r<0||r>4294967295)throw X(e,`Channel "${t}" must contain u32 integers.`);return r}function oo(e,t){let n=e.encoders[t];if(!n)throw X(e,`Missing encoder for channel "${t}".`);return n}function so(e,t,n){if(n.branches.length!=1)throw X(e,`Conditional channel "${t}" is not supported.`)}function W(e,t,n,r){return G(e,t,n,r,()=>Float32Array.from(n,n=>{let i=Number(r(n));if(!Number.isFinite(i)&&!Number.isNaN(i))throw X(e,`Channel "${t}" contains an infinite value.`);return i}))}function co(e,t,n,r,i){return G(e,`${t}:${i?`large`:`regular`}`,n,r,()=>{let a=Array.from(n,n=>lo(e,t,r(n)));return i?ue(a):Uint32Array.from(a)})}function lo(e,t,n){let r=Math.floor(Number(n));if(!Number.isSafeInteger(r)||r<0)throw X(e,`Channel "${t}" must contain finite non-negative values within the safe integer range.`);return r}function uo(e,t,n,r){if(!r)return Y(()=>lo(e,t,n()),`u32`);let i=[0],a=new Uint32Array(2),o=[0,0];return Y(()=>(i[0]=lo(e,t,n()),de(i,a),o[0]=a[0],o[1]=a[1],o),`u32`)}function fo(e,t,n,r,i){let{intern:a,readDomain:o}=po(e,t,i);return{values:G(e,t,n,r,()=>Uint32Array.from(n,e=>a(r(e)))),readDomain:o}}function po(e,t,n){let r=n.props?.domainIndexer,i=n=>ao(e,t,r?r(n):n);return{intern:i,readDomain:()=>n.domain().map(i)}}function G(e,t,n,r,i){if(!(`field`in r.channelDef))return i();let a=fa.get(e);(!a||a.data!==n)&&(a={data:n,channels:new Map},fa.set(e,a));let o=a.channels.get(t);if(o?.accessor===r)return o.series;let s=i();return a.channels.set(t,{accessor:r,series:s}),s}function K(e,t){let n=J(e,t);if(typeof n!=`number`)throw X(e,`Property "${t}" must be a number for the WebGPU renderer.`);return n}function mo(e,t,n){return t.map((t,r)=>q(e,t,n[r]))}function q(e,t,n){let r=J(e,t)??n;if(typeof r!=`number`)throw X(e,`Property "${t}" must be a number for the WebGPU renderer.`);return r}function ho(e,t){let n=J(e,t);if(n==null)return null;if(typeof n!=`number`)throw X(e,`Property "${t}" must be a number for the WebGPU renderer.`);return n}function go(e,t){let n=J(e,t);if(n==null||n===!1)return[0,0];if(!Array.isArray(n)||n.length!=2||!n.every(e=>typeof e==`number`))throw X(e,`Property "${t}" must be a pair.`);return n}function _o(e){let t=K(e,`cornerRadius`);return{topRight:q(e,`cornerRadiusTopRight`,t),bottomRight:q(e,`cornerRadiusBottomRight`,t),topLeft:q(e,`cornerRadiusTopLeft`,t),bottomLeft:q(e,`cornerRadiusBottomLeft`,t)}}function vo(e,t,n,r){let i=String(J(e,t)??r),a=n.get(i);if(a===void 0)throw X(e,`Unsupported ${t}: ${i}`);return a}function J(e,t){let n=e.properties[t];return x(e,n)}function Y(e,t){return Object.assign(bo(e,t),{dynamic:!0})}function yo(e,t,n,i,a=!1){let o=e.properties;return a||t.some(e=>r(o[e]))?Y(n,i):{value:n(),...i?{type:i}:{}}}function bo(e,t){return{get value(){return e()},...t?{type:t}:{}}}function xo(e){return{get value(){return e()}}}function So(e,t){e.initializeRenderingRevisions(Object.keys(t));let n={};for(let[i,a]of Object.entries(t)){let t=e.properties[i];r(t)&&(n[i]=xo(()=>a(J(e,i))))}return n}function Co(e,t,n,i){let a=e.properties,o=n.filter(e=>r(a[e]));return e.initializeRenderingRevisions(o),o.length==0?{}:{[t]:xo(()=>mo(e,n,i))}}function wo(e,t){if(t==null)return[0,0,0,0];let n=a(String(t));if(!n)throw X(e,`Invalid color: ${String(t)}`);let r=n.rgb();return[r.r/255,r.g/255,r.b/255,r.opacity]}function X(e,t){let n=Error(`${t} Mark: ${e.getType()}. View: ${e.unitView.getPathString()}`);return n.view=e.unitView,n}var To=new WeakMap;function Eo(e,t){let n=e.unitView.getCollector();if(!n)throw Error(`Cannot render an uninitialized mark. View: ${e.unitView.getPathString()}`);let r=t?.getSnapshot().topology,i=e.encoders?.x,a=e.encoders?.x2,o=i?e.unitView.getScaleResolution(`x`):void 0,s=o?.zoomExtent,c=To.get(e);if(c?.collector===n&&c.revision===n.dataRevision&&c.topology===r&&c.xEncoder===i&&c.x2Encoder===a&&c.xScaleResolution===o&&c.xIndexDomainStart===s?.[0]&&c.xIndexDomainEnd===s?.[1])return c;let l=n.facetBatches.get(void 0),u=S(e),d=new Map,f,p;if(l?.length)p=l,d.set(l,Do(u,p,0));else{let e=r?r.facetIds.map(e=>e?n.facetBatches.get(e)??[]:[]):Array.from(n.facetBatches.values());p=Array(e.reduce((e,t)=>e+t.length,0)),r&&(f=[]);let t=0;for(let n=0;n<e.length;n++){let r=e[n],i=Do(u,r,t);f?.push(i),d.set(r,i);for(let e of r)p[t++]=e}}let m={collector:n,revision:n.dataRevision,topology:r,xEncoder:i,x2Encoder:a,xScaleResolution:o,xIndexDomainStart:s?.[0],xIndexDomainEnd:s?.[1],xIndexSpec:u,data:p,ranges:d,placementRanges:f};return To.set(e,m),m}function Do(e,t,n){let r={firstInstance:n,instanceCount:t.length};if(!e||!t.length)return r;y(`webgpuXIndexBuilds`);let i=C(e,t,n);return i?(r.xIndex=i,r):(y(`webgpuXIndexRejectedBuilds`),r)}function Oo(e,t,n){let r=t.placement?.index;return(r===void 0?void 0:n.placementRanges?.[r])??n.ranges.get(b(e,t))??{firstInstance:0,instanceCount:0}}var ko=class extends h{#e=[];#t=new Set;#n=new Map;#r=[];#i=[];#a=0;#o=!1;#s;#c;constructor(e){if(super({}),this.surface=e.surface,e.target)this.#c=e.target;else{let t=e.surface.getLogicalCanvasSize();this.#c={width:t.width,height:t.height,dpr:e.surface.getDevicePixelRatio()}}this.#s=e.markPredicate}getDevicePixelRatio(){return this.#c.dpr}beginSampleFacetBatch(){if(this.#a)throw Error(`Nested sample facet batches are not supported.`);this.#a++,this.#r.push({type:`beginSampleFacetBatch`})}endSampleFacetBatch(){if(!this.#a)throw Error(`Unbalanced sample facet batch scope.`);this.#a--,this.#r.push({type:`endSampleFacetBatch`})}pushView(e,t){this.#t.add(e),this.#e.push({view:e,coords:t}),this.#r.push({type:`pushView`,view:e,coords:[t],localOpacity:!1,clipX:!1,clipY:!1,bounds:Lo()})}popView(e){if(this.#e.pop()?.view!==e)throw Error(`Unbalanced WebGPU view rendering context stack.`);this.#r.push({type:`popView`})}renderMark(e,t){if(this.#o)throw Error(`Cannot collect WebGPU marks after finishing.`);if(this.#s&&!this.#s(e))return;let n=this.currentCoords,r=n.translate(ae,ae),i=this.#n.get(e);i||(i={mark:e,occurrences:[],packed:void 0,source:void 0,generatedSource:!1,facetIndexed:e.encoders.facetIndex!==void 0,xQueryDomain:[0,0],xIndexedRange:[0,0],xQueryEnabled:!1,updated:!1,active:!1,ownerCoords:void 0,definition:void 0,config:void 0,properties:void 0,configRevision:-1,resourceRevision:-1,resourcesDirty:!0,configX:NaN,configY:NaN,configWidth:NaN,configHeight:NaN,viewport:void 0,generatedRectangles:void 0},this.#n.set(e,i));let a=s(t),o={state:i,options:t,coords:n,markCoords:r,clip:l(a,e.properties.clip,n),cullClip:a,cull:e.properties.cullByVisibleRange,range:{firstInstance:0,instanceCount:0},placementIndex:i.occurrences.length,draw:void 0};i.occurrences.push(o),this.#r.push({type:`occurrence`,occurrence:o}),y(`markOccurrences`)}finish(){if(this.#o)throw Error(`The WebGPU rendering context is already finished.`);if(this.#e.length)throw Error(`Cannot finish with an open WebGPU view scope.`);if(this.#a)throw Error(`Cannot finish with an open sample facet batch.`);this.#o=!0;let e=m.create(0,0,this.#c.width,this.#c.height);for(let t of this.#n.values())this.#f(t,e);this.#i=Ao(this.#r),this.#u()}render(){return this.#l(!1)}renderPicking(){return this.#l(!0)}#l(e){if(!this.#o)throw Error(`Cannot render an unfinished WebGPU frame plan.`);for(let e of this.#t)v(`onBeforeRender`,()=>e.onBeforeRender()),y(`viewsVisited`);e||this.#d();let t=this.#c;for(let n of this.#n.values())n.updated=!1,n.active=!1,this.#p(n,e,t);let n=[],r=[],i=n,a=0,o=0,s=0;for(let n of e?this.#r:this.#i)if(n.type===`occurrence`){let r=this.#h(n.occurrence,e,t,i);r!==void 0&&(a++,o+=+(r>0),s+=r)}else if(n.type===`pushView`)if(e)r.push(void 0);else{let e=Io(n);i.push(e),r.push(i),i=e.items}else if(n.type===`popView`){let e=r.pop();e&&(i=e)}return y(`retainedMarkSyncChecks`,a),y(`retainedMarkSyncChanges`,o),y(`retainedResourceWrites`,s),n}#u(){let e,t=``;for(let r of this.#i)if(r.type===`pushView`){r.view!==e&&(e=r.view,t=r.view.getPathString()),r.label=t;let i=n(r.view);r.localOpacity=r.view.hasLocalOpacity(),r.clipX=i.clipX,r.clipY=i.clipY}}#d(){for(let e of this.#i)e.type===`pushView`&&Wo(e,this.#c)}#f(e,t){let n=new Set(e.occurrences.map(t=>{let n=t.options.placement;return e.facetIndexed||n?.index!==void 0?n?.source:void 0}).filter(Boolean));if(n.size>1)throw Go(e.mark,`One logical mark cannot use several placement sources.`);let r=n.values().next().value;if(e.generatedSource=!r&&e.occurrences.length>1,e.generatedSource){let n=e.generatedRectangles=new Float32Array(e.occurrences.length*4);Ho(e,t,n),e.source=this.surface.updateOccurrencePlacements(e.mark,n),e.ownerCoords=t}else e.source=r,e.ownerCoords=e.occurrences[0].markCoords;if(e.facetIndexed&&!e.source)throw Go(e.mark,`Indexed placement requires a placement source.`);e.source&&(e.viewport=Lo());for(let t of e.occurrences)t.draw=Ro(t,e);this.#m(e)}#p(e,t,n){if(e.generatedRectangles&&(Ho(e,n,e.generatedRectangles),this.surface.updateOccurrencePlacements(e.mark,e.generatedRectangles)),e.viewport&&Vo(e.viewport,e.ownerCoords),e.mark.unitView.getEffectiveOpacity()<=0||t&&!e.mark.isPickingParticipant())return;this.#m(e);let r=Eo(e.mark,e.facetIndexed||!e.generatedSource?e.source:void 0);if(!r.data.length)return;e.xQueryEnabled=!e.facetIndexed&&!!r.xIndexSpec&&ee(r.xIndexSpec,e.xQueryDomain),e.xQueryEnabled||y(`webgpuXIndexFallbackQueries`);let i=ga(e.mark),a=e.packed!==r,o=e.configRevision!==i,s=e.source?0:e.ownerCoords.x,c=e.source?0:e.ownerCoords.y,l=e.ownerCoords.width,u=e.ownerCoords.height,d=e.configX!==s||e.configY!==c||e.configWidth!==l||e.configHeight!==u;if(a||o||d){y(a?`markConfigurationPackedMiss`:o?`markConfigurationExpressionMiss`:`markConfigurationGeometryMiss`);let t=e.occurrences[0],n=e.source?m.create(0,0,e.ownerCoords.width,e.ownerCoords.height):e.ownerCoords,d=v(`markConfiguration`,()=>ma(e.mark,t.options,n,1,r.data,zo(e)));e.packed=r,e.definition=d?.definition,e.config=d?.config,e.properties=d?.properties,e.configRevision=i,e.configX=s,e.configY=c,e.configWidth=l,e.configHeight=u}if(a)for(let t of e.occurrences)t.range=Oo(e.mark,t.options,r);let f=_a(e.mark);e.resourcesDirty||=f===void 0||a||o||d||e.resourceRevision!==f,e.resourceRevision=f??-1,e.active=!!e.config}#m(e){if(!e.source||e.generatedSource)return;let t=e.source.getSnapshot().topology.revision;for(let n of e.occurrences){let r=n.options.placement?.topologyRevision;if(r!==void 0&&r!==t)throw Go(e.mark,`Placement topology changed after layout completion.`)}}#h(e,t,n,r){let i=e.state;if(!i.active||!i.config||!i.definition||!i.packed)return;let a=e.range;if(!a.instanceCount)return;let o=e.draw;if(!o)throw Error(`Occurrence draw has not been compiled.`);Bo(e,i,o,n);let s=i.generatedSource?e.placementIndex:e.options.placement?.index,c=i.facetIndexed?void 0:s;if(i.source&&!i.facetIndexed&&c===void 0)throw Go(i.mark,`Draw-level placement requires a resolved placement index.`);if(i.source&&s!==void 0&&!Uo(i.source,s,i.viewport,o.scissor,n))return;let l=a.firstInstance,u=a.instanceCount;if(i.xQueryEnabled&&a.xIndex){if(a.xIndex(i.xQueryDomain[0],i.xQueryDomain[1],i.xIndexedRange),l=i.xIndexedRange[0],u=i.xIndexedRange[1]-l,y(`webgpuXIndexQueries`),y(`webgpuXIndexNativeItems`,a.instanceCount),y(`webgpuXIndexCandidateItems`,u),!u){y(`webgpuXIndexEmptyRanges`);return}}else i.xQueryEnabled&&y(`webgpuXIndexFallbackQueries`);let d;return i.updated||(i.updated=!0,i.resourcesDirty&&=(d=v(`retainedResourceSynchronization`,()=>this.surface.updateMark(i.mark,i.definition,i.config,i.properties??{})),!1)),o.firstInstance=l,o.instanceCount=u,o.placement&&(o.placement.index=c),this.surface.prepareDraw(i.mark,o,i.source),r.push(o),y(`drawCommands`),d}get currentCoords(){let e=u(this.#e);if(!e)throw Error(`No current view in WebGPU rendering context.`);return e.coords}};function Ao(e){let t=[],n,r=[];for(let i of e)i.type===`beginSampleFacetBatch`?n=jo():i.type===`endSampleFacetBatch`?(Fo(n,t),n=void 0):n?i.type===`occurrence`?No(n,i.occurrence.state.mark,i):i.type===`pushView`?(r.push(n),n=Po(n,i)):n=r.pop():t.push(i);return t}function jo(){return{slots:new Map,ordered:[]}}function Mo(e,t){let n=e.slots.get(t);return n||(n={items:[]},e.slots.set(t,n),e.ordered.push(n)),n}function No(e,t,n){Mo(e,t).items.push(n)}function Po(e,t){let n=Mo(e,t.view);return n.command?n.command.coords.push(...t.coords):(n.command=t,n.collector=jo()),n.collector}function Fo(e,t){for(let n of e.ordered)n.command&&n.collector?(t.push(n.command),Fo(n.collector,t),t.push({type:`popView`})):t.push(...n.items)}function Io(e){let t={bounds:e.bounds,items:[],label:e.label};return e.localOpacity&&(t.opacity=e.view.getOpacity()),t}function Lo(){return{x:0,y:0,width:0,height:0}}function Ro(e,t){let n={mark:{markId:-1},firstInstance:0,instanceCount:0};return t.viewport&&(n.viewport=t.viewport),e.clip&&(n.scissor=Lo()),e.cull&&(n.visibleRange={x1:0,y1:0,x2:0,y2:0,cullX:e.cull===!0||e.cull===`x`,cullY:e.cull===!0||e.cull===`y`}),t.source&&(n.placement={set:{placementSetId:-1},...e.options.placement?.clipToPlacement?{clipToPlacement:e.options.placement.clipToPlacement}:{}}),n}function zo(e){if(!e.facetIndexed&&e.source)return{source:`draw`}}function Bo(e,t,n,r){if(n.scissor){let t=e.clip;n.scissor.x=t.clipX?t.rect.x:0,n.scissor.y=t.clipY?t.rect.y:0,n.scissor.width=t.clipX?t.rect.width:r.width,n.scissor.height=t.clipY?t.rect.height:r.height}if(n.visibleRange){let r=e.coords,i=e.cullClip,a=r.x,o=r.y;if(n.visibleRange.x1=0,n.visibleRange.x2=a+r.width,n.visibleRange.y1=0,n.visibleRange.y2=o+r.height,n.visibleRange.cullX)if(i?.clipX){let e=i.rect.x;n.visibleRange.x1=e,n.visibleRange.x2=e+i.rect.width}else n.visibleRange.x1=a;if(n.visibleRange.cullY)if(i?.clipY){let e=i.rect.y;n.visibleRange.y1=e,n.visibleRange.y2=e+i.rect.height}else n.visibleRange.y1=o;t.viewport&&(n.visibleRange.x1-=t.viewport.x,n.visibleRange.x2-=t.viewport.x,n.visibleRange.y1-=t.viewport.y,n.visibleRange.y2-=t.viewport.y)}}function Vo(e,t){e.x=t.x,e.y=t.y,e.width=t.width,e.height=t.height}function Ho(e,t,n){for(let r of e.occurrences){let e=r.markCoords,i=r.placementIndex*4;n[i]=e.x/t.width,n[i+1]=e.y/t.height,n[i+2]=Math.max(e.width,1)/t.width,n[i+3]=Math.max(e.height,1)/t.height}}function Uo(e,t,n,r,i){let a=e.getSnapshot().rectangles,o=t*4;if(o+3>=a.length)return!1;let s=n.x+a[o]*n.width,c=n.y+a[o+1]*n.height,l=a[o+2]*n.width,u=a[o+3]*n.height;if(l<=0||u<=0)return!1;let d=Math.max(0,r?.x??0),f=Math.max(0,r?.y??0),p=Math.min(i.width,r?r.x+r.width:i.width),m=Math.min(i.height,r?r.y+r.height:i.height);return s<p&&c<m&&s+l>d&&c+u>f}function Wo(e,t){let n=e.coords[0],r=n.x,i=n.y,a=r+n.width,o=i+n.height;for(let t=1;t<e.coords.length;t++){let n=e.coords[t];r=Math.min(r,n.x),i=Math.min(i,n.y),a=Math.max(a,n.x+n.width),o=Math.max(o,n.y+n.height)}e.bounds.x=e.clipX?r:0,e.bounds.y=e.clipY?i:0,e.bounds.width=e.clipX?a-r:t.width,e.bounds.height=e.clipY?o-i:t.height}function Go(e,t){let n=Error(`${t} Mark: ${e.getType()}. View: ${e.unitView.getPathString()}`);return n.view=e.unitView,n}var Ko={r:0,g:0,b:0,a:0};function qo(e){if(e==null)return Ko;let t=a(e);if(!t)throw Error(`Invalid WebGPU canvas background color: ${e}`);let n=t.rgb();return{r:n.r/255,g:n.g/255,b:n.b/255,a:n.opacity}}var Jo=class{#e=!0;#t;constructor(e){this.viewRoot=e.viewRoot,this.surface=e.surface,this.getBackground=e.getBackground,this.broadcast=e.broadcast,this.onLayoutComputed=e.onLayoutComputed}computeLayout(){this.broadcast(`layout`),this.surface.invalidateSize();let e=5;for(;;){let t=this.#n();if(!t)return;if(!this.surface.invalidateSize()){this.#t=this.#r(t),this.#e=!0,this.onLayoutComputed(),this.broadcast(`layoutComputed`);return}if(e--,e==0)throw Error(`Layout did not settle: canvas size kept changing.`)}}renderAll(){let e=this.#t;if(!e)return;let t=_();t?.beginFrame(`webgpu`);let n=v(`markTranslation`,()=>e.render());v(`surfaceRender`,()=>this.surface.render(n,qo(this.getBackground()))),this.#e=!0,t?.endFrame()}renderPickingFramebuffer(){let e=this.#t;if(!e||!this.#e)return;let t=_();t?.beginFrame(`webgpu`,`picking`);let n=v(`markTranslation`,()=>e.renderPicking());v(`surfaceRender`,()=>this.surface.renderPicking(n)),this.#e=!1,t?.endFrame()}#n(){let e=this.surface.getLogicalCanvasSize();if(!(isNaN(e.width)||isNaN(e.height)))return v(`layout`,()=>g(this.viewRoot,m.create(0,0,e.width,e.height),{devicePixelRatio:this.surface.getDevicePixelRatio(),renderingOptions:{firstFacet:!0}}))}#r(e){let t=new ko({surface:this.surface});return v(`framePlanCompilation`,()=>{e.collectRenderCommands(t),t.finish()}),t}},Yo=class{constructor(e){this._count=e,this._templatesByShader=new Map,this._nextId=1}getOrCreate(e,t,n){let r=this._templatesByShader.get(e),i=r?.get(t);if(i)return this._count(`programTemplateCacheHits`),i;r||(r=new Map,this._templatesByShader.set(e,r));let a=n(this._nextId++);return r.set(t,a),this._count(`programTemplateCacheMisses`),a}},Xo=`
...
`,Zo=5e3,Qo=class{constructor(e,t){this.device=e,this.format=t,this.free=[],this.all=new Set,this.generation=0,this.idleTimer=void 0}beginFrame(){this.generation++,this.#n()}acquire(e,t,n){let r=`${e}x${t}:${n}`,i=this.free.findLastIndex(e=>e.key===r);if(i>=0){let e=this.free.splice(i,1)[0];return e.generation=this.generation,e}let a=this.device.createTexture({label:O(D,`transient ${e}x${t} ${n}x color`),size:{width:e,height:t},format:this.format,sampleCount:n,usage:GPUTextureUsage.RENDER_ATTACHMENT|(n===1?GPUTextureUsage.TEXTURE_BINDING:0)}),o={key:r,texture:a,view:a.createView({label:O(D,`transient color view`)}),generation:this.generation,compositeBinding:null};return this.all.add(o),o}release(e){this.free.push(e)}endFrame(){for(let e=this.free.length-1;e>=0;e--){let t=this.free[e];t.generation!==this.generation&&(this.free.splice(e,1),this.#e(t))}this.#t()}destroy(){this.#n();for(let e of this.all)e.texture.destroy();this.all.clear(),this.free.length=0}#e(e){this.all.delete(e),e.texture.destroy()}#t(){this.#n(),this.free.length!==0&&(this.idleTimer=setTimeout(()=>{this.idleTimer=void 0;for(let e of this.free)this.#e(e);this.free.length=0},Zo))}#n(){this.idleTimer!==void 0&&(clearTimeout(this.idleTimer),this.idleTimer=void 0)}},$o=class{constructor(e,t){this.device=e,this.stride=Math.max(16,e.limits.minUniformBufferOffsetAlignment),this.capacity=1,this.buffer=this.#e(this.capacity),this.staging=new Float32Array(this.capacity*this.stride/4),this.count=0;let n=e.createShaderModule({label:O(D,`composite shader`),code:Xo});this.layout=e.createBindGroupLayout({label:O(D,`composite bind group layout`),entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`,hasDynamicOffset:!0,minBindingSize:16}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`,viewDimension:`2d`,multisampled:!1}}]}),this.pipeline=e.createRenderPipeline({label:O(D,`composite pipeline`),layout:e.createPipelineLayout({label:O(D,`composite pipeline layout`),bindGroupLayouts:[this.layout]}),vertex:{module:n,entryPoint:`vs_main`},fragment:{module:n,entryPoint:`fs_main`,targets:[{format:t,blend:{color:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}})}prepare(e){if(e>this.capacity){let t=this.capacity;for(;t<e;)t*=2;let n=this.buffer;this.capacity=t,this.buffer=this.#e(t),this.staging=new Float32Array(t*this.stride/4),n.destroy()}this.count=0}bind(e,t,n){let r=this.count++;this.staging[r*this.stride/4]=n;let i=t.compositeBinding;(i===null||i.buffer!==this.buffer)&&(i={buffer:this.buffer,bindGroup:this.device.createBindGroup({label:O(D,`composite bind group`),layout:this.layout,entries:[{binding:0,resource:{buffer:this.buffer,size:16}},{binding:1,resource:t.view}]})},t.compositeBinding=i),e.setBindGroup(0,i.bindGroup,[r*this.stride])}flush(){this.count&&this.device.queue.writeBuffer(this.buffer,0,this.staging.buffer,0,this.count*this.stride)}destroy(){this.buffer.destroy()}#e(e){return this.device.createBuffer({label:O(D,`composite uniforms`),size:e*this.stride,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}},es=class{constructor(e){this.pass=e,this.pipeline=null,this.bindGroups=[],this.dynamicOffsets=[],this.viewport=[NaN,NaN,NaN,NaN,NaN,NaN],this.scissor=[NaN,NaN,NaN,NaN]}setPipeline(e){e!==this.pipeline&&(this.pass.setPipeline(e),this.pipeline=e)}setBindGroup(e,t,n){this.bindGroups[e]===t&&ts(this.dynamicOffsets[e],n)||(n?this.pass.setBindGroup(e,t,n):this.pass.setBindGroup(e,t),this.bindGroups[e]=t,this.dynamicOffsets[e]=n)}setViewport(e,t,n,r,i,a){let o=this.viewport;o[0]===e&&o[1]===t&&o[2]===n&&o[3]===r&&o[4]===i&&o[5]===a||(this.pass.setViewport(e,t,n,r,i,a),o[0]=e,o[1]=t,o[2]=n,o[3]=r,o[4]=i,o[5]=a)}setScissorRect(e,t,n,r){let i=this.scissor;i[0]===e&&i[1]===t&&i[2]===n&&i[3]===r||(this.pass.setScissorRect(e,t,n,r),i[0]=e,i[1]=t,i[2]=n,i[3]=r)}};function ts(e,t){if(e===t)return!0;if(!e||!t||e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}var ns={r:0,g:0,b:0,a:0},Z=class extends Error{},rs=Symbol.for(`genome-spy.performance-profiler`);function is(){return globalThis[rs]}function as(e,t){is()?.addPhase(e,t)}function Q(e,t){is()?.addCount(e,t)}function os(){return is()?.enabled?performance.now():0}function ss(e,t){t&&as(e,performance.now()-t)}var cs=class{constructor(e,t,n){this.renderer=e,this.placementSetId=t,this._labelOwner=`${D} placement set #${t}`,this._destroyed=!1,this._rectangles=ls(n),this._buffer=us(e.device,this._rectangles,this._labelOwner),this._bindGroup=this._createBindGroup()}get count(){return this._rectangles.length/4}get bindGroup(){if(this.renderer._assertAlive(),this._destroyed)throw new Z(`Placement set has been destroyed.`);return this._bindGroup}_createBindGroup(){return this.renderer.device.createBindGroup({label:O(this._labelOwner,`bind group`),layout:this.renderer._placementBindGroupLayout,entries:[{binding:0,resource:{buffer:this._buffer}}]})}replace(e){if(this.renderer._assertAlive(),this._destroyed)throw new Z(`Placement set has been destroyed.`);let t=ls(e);if(t.byteLength>this._buffer.size){Q(`placementBufferRecreations`);let e=this._buffer;this._buffer=us(this.renderer.device,t,this._labelOwner),this._bindGroup=this._createBindGroup(),e.destroy()}else t.byteLength&&(Q(`placementBufferReplacements`),Q(`placementUploadCalls`),Q(`placementUploadBytes`,t.byteLength),this.renderer.device.queue.writeBuffer(this._buffer,0,t));this._rectangles=t,this.renderer._renderFrame=null,this.renderer._pickingFrame=null,Q(`retainedNormalFrameInvalidations`),Q(`retainedPickingFrameInvalidations`),this.renderer.markPickingDirty()}destroy(){this._destroyed||(this._destroyed=!0,this._buffer.destroy(),this.renderer._placementSets.delete(this.placementSetId),this.renderer._renderFrame=null,this.renderer._pickingFrame=null,this.renderer.markPickingDirty())}};function ls(e){if(!e||!(e.rectangles instanceof Float32Array))throw new Z(`Placement data must contain Float32Array rectangles.`);if(e.rectangles.length%4!=0)throw new Z(`Placement rectangles must contain four values per entry.`);for(let t=0;t<e.rectangles.length;t+=4){let n=e.rectangles[t],r=e.rectangles[t+1],i=e.rectangles[t+2],a=e.rectangles[t+3];if(!Number.isFinite(n)||!Number.isFinite(r)||!Number.isFinite(i)||!Number.isFinite(a)||i<0||a<0)throw new Z(`Placement rectangles must contain finite coordinates and non-negative sizes.`)}if(!is()?.enabled)return new Float32Array(e.rectangles);let t=performance.now(),n=new Float32Array(e.rectangles);return Q(`placementValidationSnapshotBytes`,n.byteLength),as(`placementValidationSnapshot`,performance.now()-t),n}function us(e,t,n){let r=e.createBuffer({label:O(n,`rectangles`),size:Math.max(16,t.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});return t.byteLength&&(Q(`placementUploadCalls`),Q(`placementUploadBytes`,t.byteLength),e.queue.writeBuffer(r,0,t)),r}function ds(e){return e===`x`?1:e===`y`?2:e===`xy`?3:0}function fs(e){let t=new ArrayBuffer(e);return{buffer:t,floats:new Float32Array(t),integers:new Uint32Array(t)}}async function ps(e,t={}){if(!navigator.gpu)throw new Z(`WebGPU is not supported in this browser.`);let n=await navigator.gpu.requestAdapter();if(!n)throw new Z(`WebGPU adapter not available.`);let r=Math.min(10,n.limits.maxStorageBuffersPerShaderStage),i=await n.requestDevice({requiredLimits:{maxStorageBuffersPerShaderStage:r}});gs(i);let a=e.getContext(`webgpu`);if(!a)throw new Z(`Could not create a WebGPU context.`);return new ms({device:i,context:a,format:t.format??navigator.gpu.getPreferredCanvasFormat(),canvas:e,alphaMode:t.alphaMode??`premultiplied`,onInvalidate:t.onInvalidate,onDeviceLoss:t.onDeviceLoss})}var ms=class{constructor({device:e,context:t,format:n,canvas:r,alphaMode:i,onInvalidate:a,onDeviceLoss:o}){this.device=e,this.context=t,this.format=n,this.canvas=r,this.alphaMode=i,this._onInvalidate=a??(()=>{}),this._onDeviceLoss=o??(()=>{}),this._state=`alive`,this._deviceLossError=null,e.lost.then(e=>this._handleDeviceLoss(e)),t.configure({device:e,format:n,alphaMode:i}),this.pickFormat=`rgba8unorm`,this._marks=new Map,this._placementSets=new Map,this._detachedTargets=new Set,this._programTemplateCache=new Yo(Q),this._transientTextures=new Qo(e,n),this._textureCompositor=new $o(e,n),this._fontResourceCache=new Map,this._nextFontResourceId=1,this._renderFrame=null,this._pickingFrame=null,this._nextMarkId=1,this._nextPlacementSetId=1,this._pickingDirty=!0,this._pickTexture=null,this._pickTextureView=null,this._pickReadbackBuffer=null,this._pickTextureSize={width:0,height:0},this._pickQueue=[],this._activePick=null,this._globalUniformStride=Math.max(80,e.limits.minUniformBufferOffsetAlignment),this._globalUniformCapacity=1,this._globalUniformStaging=fs(this._globalUniformStride),this._globalUniformBuffer=e.createBuffer({label:O(D,`global uniforms`),size:this._globalUniformStride,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this._globalBindGroupLayout=e.createBindGroupLayout({label:O(D,`global bind group layout`),entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`,hasDynamicOffset:!0,minBindingSize:80}}]}),this._globalBindGroup=e.createBindGroup({label:O(D,`global bind group`),layout:this._globalBindGroupLayout,entries:[{binding:0,resource:{buffer:this._globalUniformBuffer,size:80}}]}),this._placementBindGroupLayout=e.createBindGroupLayout({label:O(D,`placement bind group layout`),entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:`read-only-storage`}}]});let s=window.devicePixelRatio??1;this.updateGlobals({width:(r.width||1)/s,height:(r.height||1)/s,dpr:s})}updateGlobals(e){this._assertAlive(),this._globals=hs(e),this.markPickingDirty()}createDetachedTarget(e,t){this._assertAlive();let n=e.getContext(`webgpu`);if(!n)throw new Z(`Could not create a detached WebGPU context.`);n.configure({device:this.device,format:this.format,alphaMode:this.alphaMode});let r=hs(t),i=!1,a=()=>{if(this._assertAlive(),i)throw new Z(`Detached render target has been destroyed.`)},o={canvas:e,render:(t={})=>{a(),this._renderTarget(n,e,r,t,!1)},onSubmittedWorkDone:async()=>{a(),await this.device.queue.onSubmittedWorkDone()},destroy:()=>{i||(i=!0,n.unconfigure(),this._detachedTargets.delete(o))}};return this._detachedTargets.add(o),o}_ensureGlobalUniformCapacity(e){if(e<=this._globalUniformCapacity)return;let t=this._globalUniformCapacity;for(;t<e;)t*=2;let n=this._globalUniformBuffer;this._globalUniformBuffer=this.device.createBuffer({label:O(D,`global uniforms`),size:t*this._globalUniformStride,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this._globalUniformStaging=fs(t*this._globalUniformStride),this._globalBindGroup=this.device.createBindGroup({label:O(D,`global bind group`),layout:this._globalBindGroupLayout,entries:[{binding:0,resource:{buffer:this._globalUniformBuffer,size:80}}]}),this._globalUniformCapacity=t,n.destroy()}_writeDrawGlobals(e,t=!1){let n=os();if(!e.length){ss(`drawGlobals`,n);return}this._ensureGlobalUniformCapacity(e.length);let{buffer:r,floats:i,integers:a}=this._globalUniformStaging;for(let n=0;n<e.length;n++){let r=n*this._globalUniformStride/4,o=e[n];i[r]=o.viewport.width,i[r+1]=o.viewport.height,i[r+2]=this._globals.dpr,i[r+4]=o.visibleRange.x1,i[r+5]=o.visibleRange.y1,i[r+6]=o.visibleRange.x2,i[r+7]=o.visibleRange.y2,i[r+8]=+!!o.visibleRange.cullX,i[r+9]=+!!o.visibleRange.cullY,i[r+12]=o.viewport.x,i[r+13]=o.viewport.y,i[r+14]=o.viewport.width,i[r+15]=o.viewport.height,a[r+16]=o.placement?.index??0,a[r+17]=o.placement?.clipMode??0,a[r+18]=o.placement?.count??0,a[r+19]=t?0:o.orderPass}this.device.queue.writeBuffer(this._globalUniformBuffer,0,r,0,e.length*this._globalUniformStride),Q(`drawGlobalWrites`),Q(`drawGlobalBytes`,e.length*this._globalUniformStride),ss(`drawGlobals`,n)}createMark(e,t,n={}){this._assertAlive();let r=this._nextMarkId++,i=n.label??`${e.type} #${r}`,a=e.createProgram(this,t,{label:i});this._marks.set(r,a),this.markPickingDirty();let o=a.getSlotHandles();return{markId:r,batchUpdates:o.batchUpdates,series:o.series,scales:o.scales,values:o.values,properties:o.properties,extraValues:o.extraValues,scalarSlots:o.scalarSlots,selections:o.selections}}createPlacementSet(e){this._assertAlive();let t=new cs(this,this._nextPlacementSetId++,e);return this._placementSets.set(t.placementSetId,t),t}markPickingDirty(){this._state===`alive`&&(this._pickingDirty=!0)}_invalidate(){this._state===`alive`&&(this.markPickingDirty(),this._onInvalidate())}_ensurePickTarget(){let e=Math.max(1,this.canvas.width),t=Math.max(1,this.canvas.height);(!this._pickTexture||this._pickTextureSize.width!==e||this._pickTextureSize.height!==t)&&(this._pickTexture?.destroy(),this._pickTexture=this.device.createTexture({label:O(D,`picking texture`),size:{width:e,height:t},format:this.pickFormat,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC}),this._pickTextureView=this._pickTexture.createView({label:O(D,`picking texture view`)}),this._pickTextureSize={width:e,height:t},this._pickReadbackBuffer?.destroy(),this._pickReadbackBuffer=this.device.createBuffer({label:O(D,`picking readback`),size:256,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}))}_renderPick(){Q(`pickingRenders`),this._ensurePickTarget();let e=this.device.createCommandEncoder({label:O(D,`picking command encoder`)}),t=e.beginRenderPass({label:O(D,`picking render pass`),colorAttachments:[{view:this._pickTextureView,loadOp:`clear`,storeOp:`store`,clearValue:{r:0,g:0,b:0,a:0}}]}),n=this._pickingFrame??this._renderFrame??this._normalizeDraws(this._marks.keys());this._writeDrawGlobals(n,!0),this._encodeDraws(t,n,!0),t.end(),this.device.queue.submit([e.finish()]),this._pickingDirty=!1}pick(e,t){return this._assertAlive(),new Promise((n,r)=>{this._pickQueue.push({x:e,y:t,resolve:n,reject:r}),this._startNextPick()})}_startNextPick(){if(this._activePick||!this._pickQueue.length)return;let e=this._pickQueue.shift();this._activePick=e,Promise.resolve().then(()=>(this._assertAlive(),this._pickSingle(e.x,e.y))).then(t=>this._finishPick(e,t,!1),t=>this._finishPick(e,t,!0))}_finishPick(e,t,n){this._activePick===e&&(this._activePick=null,n?e.reject(t):e.resolve(t),this._state===`alive`&&this._startNextPick())}_handleDeviceLoss(e){if(this._state!==`alive`)return;let t=e.message?`: ${e.message}`:``,n=new Z(`WebGPU device was lost (${e.reason})${t}`);this._state=`lost`,this._deviceLossError=n;let r=this._activePick;this._activePick=null,r?.reject(n);for(let e of this._pickQueue)e.reject(n);this._pickQueue.length=0,this._onInvalidate=()=>{},this._onDeviceLoss(e)}async _pickSingle(e,t){if(!this._marks.size)return null;this._ensurePickTarget(),this._pickingDirty&&this._renderPick();let n=this._globals?.dpr??1,r=Math.floor(e*n),i=Math.floor(t*n);if(r<0||i<0||r>=this._pickTextureSize.width||i>=this._pickTextureSize.height)return null;let a=this.device.createCommandEncoder({label:O(D,`pick readback command encoder`)});a.copyTextureToBuffer({texture:this._pickTexture,origin:{x:r,y:i}},{buffer:this._pickReadbackBuffer,bytesPerRow:256},{width:1,height:1,depthOrArrayLayers:1}),this.device.queue.submit([a.finish()]),await this._pickReadbackBuffer.mapAsync(GPUMapMode.READ,0,4);let o=new Uint8Array(this._pickReadbackBuffer.getMappedRange(0,4)),s=o[0]|o[1]<<8|o[2]<<16|o[3]<<24;return this._pickReadbackBuffer.unmap(),s===0?null:s-1>>>0}debugResources(e,t){this._assertAlive();let n=this._marks.get(e);if(!n)throw new Z(`No such mark: ${e}`);n.debugResources(t)}render(e={}){this._assertAlive(),this._renderTarget(this.context,this.canvas,this._globals,e,!0)}_renderTarget(e,t,n,r,i){let a=this._globals;this._globals=n;try{this._renderTargetFrame(e,t,r,i)}finally{this._globals=a}}_renderTargetFrame(e,t,n,r){let{items:i,draws:a,groupCount:o}=this._normalizeRenderItems(n.items??n.draws??this._marks.keys());Q(`renderDraws`,a.length),Q(`renderGroups`,o),this._writeDrawGlobals(a),this._textureCompositor.prepare(a.length+o+1);let s=this.device.createCommandEncoder({label:O(D,`main command encoder`)}),c=e.getCurrentTexture().createView({label:O(D,`canvas texture view`)});this._transientTextures.beginFrame();try{let e=os();this._encodeRenderItems(s,{view:c,width:t.width,height:t.height,logicalX:0,logicalY:0,label:D},i,1,n.clearColor??{r:1,g:1,b:1,a:1}),this._textureCompositor.flush(),ss(`commandEncoding`,e);let r=os();this.device.queue.submit([s.finish()]),ss(`submission`,r)}finally{this._transientTextures.endFrame()}r&&(this._renderFrame=a,this._pickingDirty=!0)}renderPicking(e={}){this._assertAlive(),this._pickingFrame=e.draws?this._normalizeDraws(e.draws):this._pickingFrame??this._renderFrame??this._normalizeDraws(this._marks.keys()),this._pickingDirty=!0}_normalizeDraws(e){let t=os(),n={x:0,y:0,width:this._globals.width,height:this._globals.height},r=[];for(let t of e){let e=this._normalizeDraw(t,n,r.length);e&&r.push(e)}return Q(`normalizedDraws`,r.length),ss(`drawNormalization`,t),r}_normalizeDraw(e,t,n){let r=typeof e==`number`?{mark:{markId:e}}:e,i=r.mark.markId,a=this._marks.get(i);if(!a)throw new Z(`No such mark: ${i}`);let o={...r.viewport??t};if(Ss(`viewport`,o),o.x<0||o.y<0||o.x+o.width>t.width||o.y+o.height>t.height)throw new Z(`Viewport must be contained within the logical canvas.`);let s=ws(r.scissor??t,t),c=r.firstInstance??0;xs(`firstInstance`,c);let l=r.instanceCount??a.drawCount-c;if(xs(`instanceCount`,l),c+l>a.drawCount)throw new Z(`Instance range exceeds mark count: ${a.drawCount}.`);let u=a.resolveDrawRange(c,l),d=a._placementIndex,f;if(d){if(!r.placement)throw new Z(`Placement-enabled marks require a placement binding.`);let e=this._placementSets.get(r.placement.set.placementSetId);if(!e)throw new Z(`No such placement set: ${r.placement.set.placementSetId}`);let n=r.placement.index;if(`source`in d&&d.source===`draw`){if(!Number.isInteger(n)||n<0)throw new Z(`Draw placement marks require a non-negative index.`);if(n>=e.count)throw new Z(`Placement index ${n} exceeds set count ${e.count}.`)}else if(n!==void 0)throw new Z(`Per-instance placement marks forbid a draw-level index.`);if(f={bindGroup:e.bindGroup,count:e.count,index:n,clipToPlacement:r.placement.clipToPlacement,clipMode:ds(r.placement.clipToPlacement)},n!==void 0&&f.clipToPlacement){let r=n*4,i=e._rectangles,a={x:o.x+i[r]*o.width,y:o.y+i[r+1]*o.height,width:i[r+2]*o.width,height:i[r+3]*o.height},c=f.clipToPlacement;s=ws(s,{x:c.includes(`x`)?a.x:t.x,y:c.includes(`y`)?a.y:t.y,width:c.includes(`x`)?a.width:t.width,height:c.includes(`y`)?a.height:t.height})}}else if(r.placement)throw new Z(`Placement bindings require a placement-enabled mark.`);if(!(s.width<=0||s.height<=0))return{type:`draw`,requiredSampleCount:a.antialiasing===`multisample`?4:1,uniformIndex:n,markId:i,viewport:o,scissor:s,visibleRange:Cs(r.visibleRange,t),firstInstance:u.firstInstance,instanceCount:u.instanceCount,orderPass:0,placement:f}}_normalizeRenderItems(e){let t=os(),n={x:0,y:0,width:this._globals.width,height:this._globals.height},r=[],i=0,a=e=>{let t=[];for(let i of e)if(_s(i)){let e=Math.min(1,Math.max(0,i.opacity??1));if(Number.isNaN(e))throw new Z(`Render scope opacity must be a number.`);if(Ss(`render scope bounds`,i.bounds,!0),e===0||i.bounds.width===0||i.bounds.height===0)continue;let n=a(i.items);if(!n.length)continue;t.push({type:`scope`,bounds:i.bounds,opacity:e,label:i.label,coverageOnly:n.every(vs),items:n})}else{let e=this._normalizeDraw(i,n,r.length);if(e){let n=this._marks.get(e.markId),i=n._order;if(r.push(e),t.push(e),i&&n._orderActive){let n=i.matching===`first`,a=n?1:2,o=(n?2:1)|4;e.orderPass=a;let s={...e,uniformIndex:r.length,orderPass:o};r.push(s),t.push(s)}}}return t},o=(e,t,n,r)=>{let a=[],s=[],c,l=()=>{s.length&&(i++,a.push({type:`group`,bounds:c,opacity:1,sampleCount:4,label:r,items:s}),s=[],c=void 0)};for(let u of e)if(u.type===`scope`){l();let e=ws(u.bounds,n);if(!e.width||!e.height)continue;let s=u.coverageOnly?4:1,c=u.label??r,d=o(u.items,s,e,c);if(!d.length)continue;u.opacity===1&&s===t?a.push(...d):(i++,a.push({type:`group`,bounds:e,opacity:u.opacity,sampleCount:s,label:c,items:d}))}else if(t===1&&u.requiredSampleCount===4){let e=ws(u.scissor,n);if(!e.width||!e.height)continue;s.push(u),c?ys(c,e):c=e}else l(),a.push(u);return l(),a},s=o(a(e),1,n,D);return Q(`normalizedDraws`,r.length),ss(`drawNormalization`,t),{items:s,draws:r,groupCount:i}}_encodeRenderItems(e,t,n,r,i){let a=!1,o=[],s=()=>{if(o.length){if(r===1)this._encodeDrawPass(e,t,o,a?void 0:i);else if(!a)this._encodeMultisampleDrawPass(e,t,o);else{let n=this._transientTextures.acquire(t.width,t.height,1),r={texture:n,...t,view:n.view};this._encodeMultisampleDrawPass(e,r,o),this._encodeCompositePass(e,t,r,1,a?void 0:i),this._transientTextures.release(r.texture)}a=!0,o=[]}};for(let r of n)if(r.type===`group`){s();let n=this._renderGroup(e,t,r);n&&(this._encodeCompositePass(e,t,n,r.opacity,a?void 0:i),this._transientTextures.release(n.texture),a=!0)}else o.push(r);s(),a||this._encodeDrawPass(e,t,[],i)}_renderGroup(e,t,n){let r=ws(n.bounds,{x:t.logicalX,y:t.logicalY,width:t.width/this._globals.dpr,height:t.height/this._globals.dpr}),i=this._globals.dpr,a=Ts(r,i,Math.floor(t.logicalX*i)+t.width,Math.floor(t.logicalY*i)+t.height);if(!a.width||!a.height)return;let o=this._transientTextures.acquire(a.width,a.height,1),s={view:o.view,width:a.width,height:a.height,logicalX:a.x/i,logicalY:a.y/i,label:n.label};return this._encodeRenderItems(e,s,n.items,n.sampleCount,ns),{texture:o,...s}}_encodeMultisampleDrawPass(e,t,n){let r=this._transientTextures.acquire(t.width,t.height,4),i=e.beginRenderPass({label:O(t.label,`multisample group pass`),colorAttachments:[{view:r.view,resolveTarget:t.view,clearValue:ns,loadOp:`clear`,storeOp:`discard`}]});this._encodeDraws(i,n,!1,t,4),i.end(),this._transientTextures.release(r)}_encodeDrawPass(e,t,n,r){let i=e.beginRenderPass({label:O(t.label,`main render pass`),colorAttachments:[{view:t.view,...r?{clearValue:r}:{},loadOp:r?`clear`:`load`,storeOp:`store`}]});this._encodeDraws(i,n,!1,t),i.end()}_encodeCompositePass(e,t,n,r,i){let a=e.beginRenderPass({label:O(n.label,`group composite pass`),colorAttachments:[{view:t.view,...i?{clearValue:i}:{},loadOp:i?`clear`:`load`,storeOp:`store`}]}),o=Math.round((n.logicalX-t.logicalX)*this._globals.dpr),s=Math.round((n.logicalY-t.logicalY)*this._globals.dpr);a.setViewport(o,s,n.width,n.height,0,1),a.setScissorRect(o,s,n.width,n.height),a.setPipeline(this._textureCompositor.pipeline),this._textureCompositor.bind(a,n.texture,r),a.draw(6),a.end()}_encodeDraws(e,t,n,r={view:void 0,width:this.canvas.width,height:this.canvas.height,logicalX:0,logicalY:0,label:D},i=1){let a=this._globals.dpr,o=new es(e);for(let s of t){if(n&&s.orderPass&4)continue;let t=this._marks.get(s.markId);if(!t)continue;o.setViewport((s.viewport.x-r.logicalX)*a,(s.viewport.y-r.logicalY)*a,s.viewport.width*a,s.viewport.height*a,0,1);let c=Ts(ws(s.scissor,{x:r.logicalX,y:r.logicalY,width:r.width/a,height:r.height/a}),a,Math.floor(r.logicalX*a)+r.width,Math.floor(r.logicalY*a)+r.height);o.setScissorRect(c.x-Math.floor(r.logicalX*a),c.y-Math.floor(r.logicalY*a),c.width,c.height),o.setBindGroup(0,this._globalBindGroup,[s.uniformIndex*this._globalUniformStride]);let l={firstInstance:s.firstInstance,instanceCount:s.instanceCount,sampleCount:i};s.placement&&(l.placement=s.placement),n?t.preparePick(o,l):t.prepareDraw(o,l),s.placement&&o.setBindGroup(2,s.placement.bindGroup),n?t.drawPick(e,l):t.draw(e,l)}}destroyMark(e){if(this._state===`destroyed`)return;let t=this._marks.get(e);t&&(t.destroy(),this._marks.delete(e),this.markPickingDirty())}destroy(){if(this._state===`destroyed`)return;this._state=`destroyed`;for(let e of this._marks.values())e.destroy();this._marks.clear();for(let e of this._placementSets?.values()??[])e.destroy();this._placementSets?.clear();for(let e of this._detachedTargets)e.destroy();for(let e of this._fontResourceCache.values())for(let t of e.values())t.destroy();this._fontResourceCache.clear(),this._renderFrame=null,this._globalUniformBuffer.destroy(),this._transientTextures.destroy(),this._textureCompositor.destroy(),this._pickTexture?.destroy(),this._pickTexture=null,this._pickTextureView=null,this._pickReadbackBuffer?.destroy(),this._pickReadbackBuffer=null;for(let e of this._pickQueue)e.resolve(null);this._pickQueue.length=0;let e=this._activePick;this._activePick=null,e?.resolve(null),this._onInvalidate=()=>{},this.context.unconfigure(),this.device.destroy()}_assertAlive(){if(this._state===`lost`)throw this._deviceLossError;if(this._state===`destroyed`)throw new Z(`Renderer has been destroyed.`)}_isAlive(){return this._state===`alive`}};function hs(e){let{width:t,height:n,dpr:r}=e;return bs(`width`,t),bs(`height`,n),bs(`dpr`,r),{width:t,height:n,dpr:r}}function gs(e){if(!is()?.enabled)return;let t=e.queue;$(t,`writeBuffer`,e=>{let t=e[2],n=typeof e[3]==`number`?e[3]:0,r=e[4],i=typeof r==`number`?r:Math.max(0,(t?.byteLength??0)-n);Q(`writeBufferCalls`),Q(`writeBufferBytes`,i)}),$(t,`submit`,()=>Q(`queueSubmissions`)),$(e,`createBuffer`,()=>Q(`gpuBuffersCreated`)),$(e,`createTexture`,()=>Q(`gpuTexturesCreated`)),$(e,`createShaderModule`,()=>Q(`shaderModulesCreated`)),$(e,`createBindGroup`,()=>Q(`bindGroupsCreated`)),$(e,`createRenderPipeline`,()=>Q(`pipelinesCreated`)),$(e,`createCommandEncoder`,()=>Q(`commandEncodersCreated`))}function $(e,t,n){let r=e,i=r[t];if(typeof i==`function`)try{r[t]=function(...e){return n(e),i.apply(this,e)}}catch{}}function _s(e){return typeof e==`object`&&!!e&&`items`in e}function vs(e){return e.type===`scope`?e.coverageOnly:e.requiredSampleCount===4}function ys(e,t){let n=Math.max(e.x+e.width,t.x+t.width),r=Math.max(e.y+e.height,t.y+t.height);e.x=Math.min(e.x,t.x),e.y=Math.min(e.y,t.y),e.width=n-e.x,e.height=r-e.y}function bs(e,t){if(!Number.isFinite(t)||t<=0)throw new Z(`${e} must be a positive finite number.`)}function xs(e,t){if(!Number.isInteger(t)||t<0)throw new Z(`${e} must be a non-negative integer.`)}function Ss(e,t,n=!1){if(!Number.isFinite(t.x)||!Number.isFinite(t.y)||!Number.isFinite(t.width)||!Number.isFinite(t.height)||(n?t.width<0:t.width<=0)||(n?t.height<0:t.height<=0))throw new Z(`${e} must have finite coordinates and ${n?`non-negative`:`positive`} dimensions.`)}function Cs(e,t){if(!e)return{x1:t.x,y1:t.y,x2:t.x+t.width,y2:t.y+t.height,cullX:!1,cullY:!1};let{x1:n,y1:r,x2:i,y2:a,cullX:o,cullY:s}=e;if(!Number.isFinite(n)||!Number.isFinite(r)||!Number.isFinite(i)||!Number.isFinite(a)||n>i||r>a||typeof o!=`boolean`||typeof s!=`boolean`)throw new Z(`visibleRange must have finite ordered bounds and boolean flags.`);return e}function ws(e,t){if(!Number.isFinite(e.x)||!Number.isFinite(e.y)||!Number.isFinite(e.width)||!Number.isFinite(e.height))throw new Z(`scissor must have finite coordinates and positive dimensions.`);if(e.width<=0||e.height<=0)return{x:e.x,y:e.y,width:0,height:0};let n=Math.max(e.x,t.x),r=Math.max(e.y,t.y),i=Math.min(e.x+e.width,t.x+t.width),a=Math.min(e.y+e.height,t.y+t.height);return{x:n,y:r,width:Math.max(0,i-n),height:Math.max(0,a-r)}}function Ts(e,t,n,r){let i=Math.floor(e.x*t),a=Math.floor(e.y*t),o=Math.min(n,Math.ceil((e.x+e.width)*t)),s=Math.min(r,Math.ceil((e.y+e.height)*t));return{x:i,y:a,width:o-i,height:s-a}}var Es=class{#e={revision:0,facetIds:[]};#t={topology:this.#e,geometryRevision:0,rectangles:new Float32Array,overlap:`disjoint`};#n=new Set;#r=!1;getSnapshot(){if(this.#r)throw Error(`Cannot read a disposed placement source.`);return this.#t}replaceTopology(e,t,n=`disjoint`){this.#i(),Ds(t,e.length);let r=Object.freeze({revision:this.#e.revision+1,facetIds:Object.freeze(e.map(e=>e?Object.freeze(Array.from(e)):void 0))});this.#e=r,this.#t=Object.freeze({topology:r,geometryRevision:this.#t.geometryRevision+1,rectangles:v(`placementSourceSnapshot`,()=>(y(`placementSourceSnapshotBytes`,t.byteLength),new Float32Array(t))),overlap:n})}replaceGeometry(e,t=this.#t.overlap){this.#i(),Ds(e,this.#e.facetIds.length),this.#t=Object.freeze({topology:this.#e,geometryRevision:this.#t.geometryRevision+1,rectangles:v(`placementSourceSnapshot`,()=>(y(`placementSourceSnapshotBytes`,e.byteLength),new Float32Array(e))),overlap:t})}onDispose(e){return this.#i(),this.#n.add(e),()=>this.#n.delete(e)}dispose(){if(!this.#r){this.#r=!0;for(let e of this.#n)e();this.#n.clear()}}#i(){if(this.#r)throw Error(`Placement source has been disposed.`)}};function Ds(e,t){if(!(e instanceof Float32Array)||e.length!==t*4)throw Error(`Placement rectangles must contain four values per entry.`);for(let t=0;t<e.length;t+=4){let n=e[t],r=e[t+1],i=e[t+2],a=e[t+3];if(!Number.isFinite(n)||!Number.isFinite(r)||!Number.isFinite(i)||!Number.isFinite(a)||i<0||a<0)throw Error(`Placement rectangles must contain finite coordinates and non-negative sizes.`)}}var Os=Object.freeze({});function ks(e){return`${e.unitView.getPathString()} [${e.getType()}]`}var As=class{#e;#t;#n=!1;#r=new Map;#i=new WeakMap;#a=new Map;#o=new WeakSet;#s;constructor(e){this.options=e,this.canvas=document.createElement(`canvas`),e.container.appendChild(this.canvas),this.#e=new te(e.container,this.canvas,e.sizeSource,()=>{this.#c()&&e.onCanvasResize()}),this.#c()}async initialize(){this.#t=await ps(this.canvas,{onInvalidate:()=>{this.#t&&this.options.onRenderInvalidated?.()},onDeviceLoss:e=>{if(!this.#n){let t=e.message?`: ${e.message}`:``;this.options.onError?.(Error(`WebGPU device was lost (${e.reason})${t}`))}}}),this.#l()}invalidateSize(){return this.#e.invalidate(),this.#c()}#c(){let e=this.getLogicalCanvasSize(),t=this.#e.getPhysicalCanvasSize(e);return this.#s?.logicalWidth==e.width&&this.#s.logicalHeight==e.height&&this.#s.physicalWidth==t.width&&this.#s.physicalHeight==t.height?!1:(this.canvas.style.width=`${e.width}px`,this.canvas.style.height=`${e.height}px`,this.canvas.width=t.width,this.canvas.height=t.height,this.#s={logicalWidth:e.width,logicalHeight:e.height,physicalWidth:t.width,physicalHeight:t.height},this.#l(),!0)}#l(){!this.#t||!this.#s||this.#s.logicalWidth<=0||this.#s.logicalHeight<=0||this.#t.updateGlobals({width:this.#s.logicalWidth,height:this.#s.logicalHeight,dpr:this.getDevicePixelRatio()})}getLogicalCanvasSize(){return this.#e.getLogicalCanvasSize()}getDevicePixelRatio(){return this.#e.getDevicePixelRatio()}createExportTarget(e,t,n){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);let r=document.createElement(`canvas`);return r.width=Math.ceil(e*n),r.height=Math.ceil(t*n),{handle:this.#t.createDetachedTarget(r,{width:e,height:t,dpr:n}),canvas:r,logicalWidth:e,logicalHeight:t,pixelRatio:n}}renderLayoutToTarget(e,t,n,r){let i=new ko({surface:this,target:{width:t.logicalWidth,height:t.logicalHeight,dpr:t.pixelRatio},markPredicate:r});e.collectRenderCommands(i),i.finish(),t.handle.render({items:i.render(),clearColor:n})}getPlacementSet(e){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);let t=e.getSnapshot(),n=this.#i.get(e);if(!n){let n=this.#t.createPlacementSet({rectangles:t.rectangles}),r={set:n,topologyRevision:t.topology.revision,geometryRevision:t.geometryRevision};return this.#i.set(e,r),e.onDispose(()=>{let t=this.#i.get(e);t&&(t.set.destroy(),this.#i.delete(e))}),n}return(n.topologyRevision!==t.topology.revision||n.geometryRevision!==t.geometryRevision)&&(n.set.replace({rectangles:t.rectangles}),n.topologyRevision=t.topology.revision,n.geometryRevision=t.geometryRevision),n.set}updateOccurrencePlacements(e,t){this.#u(e);let n=this.#a.get(e);if(!n)n=new Es,n.replaceTopology(Array.from({length:t.length/4},(e,t)=>[t]),t),this.#a.set(e,n);else{let e=n.getSnapshot();e.rectangles.length===t.length?js(e.rectangles,t)||n.replaceGeometry(t):n.replaceTopology(Array.from({length:t.length/4},(e,t)=>[t]),t)}return n}updateMark(e,t,n,r=Os){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);this.#u(e);let i=this.#r.get(e);if(!i||i.definition!==t){i&&this.#t.destroyMark(i.handle.markId);let a=this.#t.createMark(t,n,{label:ks(e)});i={definition:t,handle:a,config:n,properties:r,bindings:Ms(a,n,r),series:Bs(n),count:n.count,selections:new Map},this.#r.set(e,i)}let a=0;return i.handle.batchUpdates(()=>{let t=i.config!==n;t&&zs(i,n)&&(i.series=Bs(n),i.count=n.count,i.handle.series.replace(i.series,i.count),a++),(t||i.properties!==r)&&(i.bindings=Ms(i.handle,n,r,i.bindings),i.config=n,i.properties=r),a+=Ps(i.bindings),a+=Ls(i,e)}),a}prepareDraw(e,t,n){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);let r=this.#r.get(e);if(!r)throw Error(`Cannot draw a WebGPU mark before updating it.`);if(t.mark=r.handle,n){if(!t.placement)throw Error(`Placement source requires a materialized draw placement.`);t.placement.set=this.getPlacementSet(n)}}render(e,t){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);this.#t.render({items:e,...t?{clearColor:t}:{}})}renderPicking(e){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);this.#t.renderPicking({draws:e})}pick(e,t){if(!this.#t)throw Error(`The WebGPU surface has not been initialized.`);return this.#t.pick(e,t)}finalize(){if(!this.#n){this.#n=!0;for(let e of this.#a.values())e.dispose();this.#t?.destroy(),this.#t=void 0,this.#r.clear(),this.#i=new WeakMap,this.#a.clear(),this.#o=new WeakSet,this.#e.finalize(),this.canvas.remove()}}#u(e){this.#o.has(e)||(this.#o.add(e),e.unitView?.registerDisposer?.(()=>this.#d(e)))}#d(e){let t=this.#r.get(e);t&&(this.#t?.destroyMark(t.handle.markId),this.#r.delete(e));let n=this.#a.get(e);n&&(n.dispose(),this.#a.delete(e))}};function js(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}function Ms(e,t,n,r=[]){let i=new Map(r.map(e=>[e.key,e.value])),a=[],o=(e,t,n,r=!1)=>{a.push({key:e,read:t,write:n,value:i.has(e)?i.get(e):Fs(t()),skipUndefined:r})};for(let[n,r]of Object.entries(t.channels)){Ns(o,`channel:${n}:default`,e.scales[n]?.default,e.values[n]?.default,r);for(let[t,i]of(r.conditions??[]).entries())i.channel&&Ns(o,`channel:${n}:condition:${t}`,e.scales[n]?.conditions?.[t],e.values[n]?.conditions?.[t],i.channel)}for(let[t,r]of Object.entries(n)){let n=e.properties?.[t];if(!n)throw Error(`Renderer mark has no property slot "${t}".`);o(`property:${t}`,()=>r.value,e=>n.set(e))}for(let[n,r]of Object.entries(t.scalarSlots??{})){let t=e.scalarSlots?.[n];t&&o(`scalar:${n}`,()=>r.value,e=>t.set(e))}return a}function Ns(e,t,n,r,i){n&&i.scale&&(`domain`in i.scale&&e(t+`:domain`,()=>i.scale.domain,e=>n.setDomain(e),!0),`range`in i.scale&&e(t+`:range`,()=>i.scale.range,e=>n.setRange(e),!0)),r&&`value`in i&&e(t+`:value`,()=>i.value,e=>r.set(e),!0)}function Ps(e){let t=0;for(let n of e){let e=n.read();n.skipUndefined&&e===void 0||Is(n.value,e)||(n.write(e),t++,n.value=Fs(e))}return t}function Fs(e){return Array.isArray(e)?e.map(Fs):e}function Is(e,t){return e===t?!0:Array.isArray(e)&&Array.isArray(t)?e.length==t.length&&e.every((e,n)=>Is(e,t[n])):!1}function Ls(e,t){let n=t.unitView?.paramRuntime;if(!n)return 0;let r=0;for(let[t,i]of Object.entries(e.handle.selections??{})){let a=n.findValue(t);if(a){if(i.type==`single`){let n=a.uniqueId??0;e.selections.get(t)!==n&&(i.set(n),r++,e.selections.set(t,n))}else if(i.type==`multi`){let n=Uint32Array.from(a.data.keys());Rs(e.selections.get(t),n)||(i.set(n),r++,e.selections.set(t,n))}else if(i.type==`interval`){let n=e.selections.get(t);if(!n||n.type!=`interval`){let r={};for(let e of i.targets)r[e]=null;n={type:`interval`,intervals:r},e.selections.set(t,n)}let o=!1;for(let e of i.targets){let t=a.intervals?.[e]??null,r=n.intervals[e];(t==null?r!=null:r==null||r[0]!=t[0]||r[1]!=t[1])&&(n.intervals[e]=t?[t[0],t[1]]:null,o=!0)}o&&(i.set(n.intervals),r++)}}}return r}function Rs(e,t){return!(e instanceof Uint32Array)||e.length!=t.length?!1:e.every((e,n)=>e==t[n])}function zs(e,t){if(e.count!=t.count)return!0;for(let[n,r]of Object.entries(t.channels)){let t=Hs(r);if(t!==void 0&&e.series[n]!==t)return!0}for(let[n,r]of Object.entries(t.inputs??{}))if(e.series[n]!==r.data)return!0;return!!(t.placementIndex?.data&&e.series.__placementIndex!==t.placementIndex.data)}function Bs(e){let t={};for(let[n,r]of Object.entries(e.channels)){let e=Hs(r);e!==void 0&&(t[n]=e)}for(let[n,r]of Object.entries(e.inputs??{}))t[n]=r.data;return e.placementIndex?.data&&(t.__placementIndex=e.placementIndex.data),t}function Vs(e){if(e){if(ArrayBuffer.isView(e.data)||Array.isArray(e.data))return e.data;if(typeof e.value==`string`)return e.value}}function Hs(e){let t=Vs(e);if(t!==void 0)return t;for(let t of e.conditions??[]){if(!t.channel)continue;let e=Vs(t.channel);if(e!==void 0)return e}}async function Us(e,t){let n=t.mimeType??`image/png`;if(n!=`image/png`)throw Error(`Unsupported raster export MIME type: ${n}`);let r=e.getLogicalCanvasSize(),i=t.logicalWidth??r.width,a=t.logicalHeight??r.height,o=t.pixelRatio??e.getDevicePixelRatio(),s=Gs(e,i,a,o);try{let r=Ks(t.viewRoot,i,a,o);return e.renderLayoutToTarget(r,s,qo(t.clearColor)),await s.handle.onSubmittedWorkDone(),qs(s.canvas,n)}finally{s.handle.destroy()}}async function Ws(e,t){let n=Gs(e,t.logicalWidth,t.logicalHeight,t.pixelRatio);try{let r=document.createElement(`canvas`),i=r.getContext(`2d`);if(!i)throw new p(`Unable to initialize a WebGPU SVG crop context.`);let a=t.layoutResult&&t.pixelRatio==1?t.layoutResult:Ks(t.viewRoot,t.logicalWidth,t.logicalHeight,t.pixelRatio);for(let o of t.runs){e.renderLayoutToTarget(a,n,Ko,e=>o.marks.has(e)),await n.handle.onSubmittedWorkDone();let s=re(o.bounds,t.pixelRatio,n.canvas.width,n.canvas.height);r.width=s.width,r.height=s.height,i.resetTransform(),i.clearRect(0,0,s.width,s.height),i.drawImage(n.canvas,s.x,s.y,s.width,s.height,0,0,s.width,s.height),ne(o,s,t.pixelRatio,r.toDataURL(`image/png`))}}finally{n.handle.destroy()}}function Gs(e,t,n,r){try{return e.createExportTarget(t,n,r)}catch(e){throw new p(`Unable to initialize a detached WebGPU export target.`,{cause:e})}}function Ks(e,t,n,r){return g(e,m.create(0,0,t,n),{devicePixelRatio:r,renderingOptions:{firstFacet:!0}})}function qs(e,t){return new Promise((n,r)=>{e.toBlob(e=>{e?n(e):r(Error(`WebGPU could not encode the raster export.`))},t)})}async function Js(e){let t=new As(e);try{await t.initialize()}catch(e){throw t.finalize(),e}let n=Promise.resolve(),r=e=>{let t=n.then(e);return n=t.catch(()=>{}),t};return{surface:t,glHelper:void 0,defaultFontBitmapUrl:ie,createRenderCoordinator:e=>new Jo({...e,surface:t}),readPickingId:(e,n)=>t.pick(e,n),exportCanvas:()=>{throw Error(`Synchronous canvas export is unavailable with WebGPU. Use imageExport.raster() instead.`)},exportRaster:e=>r(()=>Us(t,e)),rasterizeSvgRuns:e=>r(()=>Ws(t,e))}}export{Js as createWebGpuRenderingBackend};